...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/pointers7.c -bpl ./pointers7.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/pointers7.c", 15, 12} true;
  ...
  assume {:sourceloc "test/c/bits/pointers7.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/bits/pointers7.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/bits/pointers7.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/bits/pointers7.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, 2);
  assume {:sourceloc "test/c/bits/pointers7.c", 18, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p3, 1);
  assume {:sourceloc "test/c/bits/pointers7.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/pointers7.c", 19, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/pointers7.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
