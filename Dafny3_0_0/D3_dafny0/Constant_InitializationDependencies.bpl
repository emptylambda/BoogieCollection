...
procedure CheckWellformed$$InitializationDependencies.C.a();
...
// C.a: Type axiom
axiom 2 < $FunctionContextHeight ==> $Is(InitializationDependencies.C.a(), TInt);
...
procedure CheckWellformed$$InitializationDependencies.C.b();
...
// C.b: Type axiom
axiom 1 < $FunctionContextHeight ==> $Is(InitializationDependencies.C.b(), TInt);
...
procedure CheckWellformed$$InitializationDependencies.C.c();
...
// C.c: Type axiom
axiom 3 < $FunctionContextHeight ==> $Is(InitializationDependencies.C.c(), TInt);
...
procedure CheckWellformed$$InitializationDependencies.D.m();
...
// D.m: Type axiom
axiom 0 < $FunctionContextHeight ==> $Is(InitializationDependencies.D.m(), TInt);
...
procedure CheckWellformed$$InitializationDependencies.R.a(this: ref
       where this != null
         && 
        $Is(this, Tclass.InitializationDependencies.R())
         && $IsAlloc(this, Tclass.InitializationDependencies.R(), $Heap));
...
procedure CheckWellformed$$InitializationDependencies.R.b(this: ref
       where this != null
         && 
        $Is(this, Tclass.InitializationDependencies.R())
         && $IsAlloc(this, Tclass.InitializationDependencies.R(), $Heap));
...
procedure CheckWellformed$$InitializationDependencies.R.c(this: ref
       where this != null
         && 
        $Is(this, Tclass.InitializationDependencies.R())
         && $IsAlloc(this, Tclass.InitializationDependencies.R(), $Heap));
...
procedure CheckWellformed$$InitializationDependencies.R.m(this: ref
       where this != null
         && 
        $Is(this, Tclass.InitializationDependencies.R())
         && $IsAlloc(this, Tclass.InitializationDependencies.R(), $Heap));
...
procedure CheckWellformed$$InitializationDependencies.R.n(this: ref
       where this != null
         && 
        $Is(this, Tclass.InitializationDependencies.R())
         && $IsAlloc(this, Tclass.InitializationDependencies.R(), $Heap));
...
implementation CheckWellformed$$InitializationDependencies.R.n(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##nn#0: int;

    // AddWellformednessCheck for const field n
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(203,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##nn#0 := InitializationDependencies.R.b(this);
    // assume allocatedness for argument to function
    assume $IsAlloc(##nn#0, TInt, $Heap);
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    assume InitializationDependencies.R.F#canCall(this, InitializationDependencies.R.b(this));
    assume InitializationDependencies.R.F#canCall(this, InitializationDependencies.R.b(this));
}
...
procedure CheckWellformed$$InitializationDependencies.R.F(this: ref
       where this != null
         && 
        $Is(this, Tclass.InitializationDependencies.R())
         && $IsAlloc(this, Tclass.InitializationDependencies.R(), $Heap), 
...
procedure Impl$$InitializationDependencies.__default.PrintEm() returns ($_reverifyPost: bool);
  free requires 11 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$InitializationDependencies.__default.PrintEm() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var r#0: ref
     where $Is(r#0, Tclass.InitializationDependencies.R())
       && $IsAlloc(r#0, Tclass.InitializationDependencies.R(), $Heap);
  var $nw: ref;

    // AddMethodImpl: PrintEm, Impl$$InitializationDependencies.__default.PrintEm
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(210,2): initial state"} true;
    $_reverifyPost := false;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(211,5)
    assume true;
    assume true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(212,5)
    assume true;
    assume true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(213,5)
    assume true;
    assume true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(214,5)
    assume true;
    assume true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(215,11)
    assume true;
    havoc $nw;
    assume $nw != null && dtype($nw) == Tclass.InitializationDependencies.R?();
    assume !read($Heap, $nw, alloc);
    $Heap := update($Heap, $nw, alloc, true);
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    r#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(215,18)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(216,5)
    assert {:subsumption 0} r#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(217,5)
    assert {:subsumption 0} r#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(218,5)
    assert {:subsumption 0} r#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(219,5)
    assert {:subsumption 0} r#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(220,5)
    assert {:subsumption 0} r#0 != null;
    assume true;
    assume true;
}
