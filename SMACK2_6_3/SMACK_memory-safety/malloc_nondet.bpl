...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/malloc_nondet.c -bpl ./malloc_nondet.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 7, 11} true;
  ...
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 8, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 9, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sext.i32.i64($i0);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 9, 21} true;
  assume {:verifier.code 0} true;
  call $p3 := malloc($i2);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 10, 14} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i32.i8($i0);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 10, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i0, 1);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p3, $mul.ref($i6, 1));
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 10, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p7, $i4);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call free_($p3);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
