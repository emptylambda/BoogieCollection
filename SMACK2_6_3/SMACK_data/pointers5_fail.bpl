...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/pointers5_fail.c -bpl ./pointers5_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/pointers5_fail.c", 8, 19} true;
  ...
  assume {:verifier.code 0} true;
  call $p1 := malloc(4);
  assume {:sourceloc "test/c/data/pointers5_fail.c", 8, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume true;
  assume {:sourceloc "test/c/data/pointers5_fail.c", 11, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $p2i.ref.i64($p2);
  assume {:sourceloc "test/c/data/pointers5_fail.c", 11, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p0, $i3);
  assume {:sourceloc "test/c/data/pointers5_fail.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/pointers5_fail.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.0, $p4);
  assume {:sourceloc "test/c/data/pointers5_fail.c", 12, 15} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p5, 1);
  assume {:sourceloc "test/c/data/pointers5_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/pointers5_fail.c", 13, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/pointers5_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/data/pointers5_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call free_($p8);
  assume {:sourceloc "test/c/data/pointers5_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
