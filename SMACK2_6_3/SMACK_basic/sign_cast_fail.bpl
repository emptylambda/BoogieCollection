...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/sign_cast_fail.c -bpl ./sign_cast_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/sign_cast_fail.c", 7, 16} true;
  ...
  assume {:sourceloc "test/c/basic/sign_cast_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/sign_cast_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $ult.i32($i0, 4294967294);
  assume {:sourceloc "test/c/basic/sign_cast_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/sign_cast_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/basic/sign_cast_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i0, 4294967293);
  assume {:sourceloc "test/c/basic/sign_cast_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/basic/sign_cast_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
