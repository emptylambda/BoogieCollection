...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/equal.c -bpl ./equal.bpl
...
const worker: ref;
axiom (worker == $sub.ref(0, 1028));
const pthread_self: ref;
axiom (pthread_self == $sub.ref(0, 2060));
procedure {:inline 1} pthread_self()
  returns ($r: i32);
const pthread_equal: ref;
axiom (pthread_equal == $sub.ref(0, 3092));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/equal.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/pthread/equal.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call $i0 := pthread_create(worker, $0.ref, $0.ref, $0.ref);
  assume {:sourceloc "test/c/pthread/equal.c", 16, 16} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "test/c/pthread/equal.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_join($i1, $0.ref);
  assume {:sourceloc "test/c/pthread/equal.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/equal.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_self();
  assume {:sourceloc "test/c/pthread/equal.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $M.0;
  assume {:sourceloc "test/c/pthread/equal.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_equal($i3, $i4);
  assume {:sourceloc "test/c/pthread/equal.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/pthread/equal.c", 17, 3} true;
...
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/pthread/equal.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_join == $sub.ref(0, 6188));
...
$bb0:
  $M.0 := 0;
  call {:cexpr "worker"} boogie_si_record_i32(0);
  $exn := false;
  return;
}
