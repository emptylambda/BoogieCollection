...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/sqrt_fail.c -bpl ./sqrt_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 15, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call $f0 := sqrt($fp(4, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrt_fail.c:15:3: warning: over-approximating floating-point arithmetic fsub; */
  $f1 := $fsub.float($fp(2, 0, 0), $f0);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrt_fail.c:15:3: warning: over-approximating call to llvm.fabs.f64; */
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $f4 := sqrt($fp(0, 3, 0));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrt_fail.c:16:3: warning: over-approximating floating-point arithmetic fsub; */
  $f5 := $fsub.float($fp(0, 3, 5555555555555), $f4);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrt_fail.c:16:3: warning: over-approximating call to llvm.fabs.f64; */
  call $f6 := llvm.fabs.f64($f5);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i7 := (if $folt.float.bool($f6, $fp(1, 0, 8)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call $f8 := sqrt($fp(-1, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := __isnan($f8);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 17, 3} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call $f11 := sqrt($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i12 := (if $foeq.float.bool($f11, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call $f13 := sqrt($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 21, 25} true;
  assume {:verifier.code 0} true;
  call $f15 := sqrt($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 21, 15} true;
  assume {:verifier.code 0} true;
  call $i16 := __signbit($f15);
  call {:cexpr "isNeg"} boogie_si_record_i32($i16);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 22, 3} true;
...
$bb29:
  ...
  goto $bb28;
$bb30:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $f18 := sqrt($fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i19 := (if $foeq.float.bool($f18, $fp(0, 7, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $f20 := sqrt($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $i21 := __isnan($f20);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i21, 0);
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 25, 3} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $f23 := sqrt($fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/sqrt_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const sqrt: ref;
axiom (sqrt == $sub.ref(0, 2064));
procedure {:inline 1} sqrt($f0: float)
  returns ($r: float);
...
procedure {:inline 1} __isnan($f0: float)
  returns ($r: i32);
const __signbit: ref;
axiom (__signbit == $sub.ref(0, 5160));
