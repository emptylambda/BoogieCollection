...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/array2.c -bpl ./array2.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/array2.c", 14, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/array2.c", 14, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(40);
  assume {:sourceloc "test/c/data/array2.c", 14, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/array2.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array2.c", 16, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, 10);
  assume {:sourceloc "test/c/data/array2.c", 16, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/array2.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i2);
  assume {:sourceloc "test/c/data/array2.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p1, $mul.ref($i4, 4));
  assume {:sourceloc "test/c/data/array2.c", 17, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, 0);
  assume {:sourceloc "test/c/data/array2.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/array2.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/data/array2.c", 16, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i2, 1);
...
$bb8:
  ...
  goto $bb7;
$bb9:
  assume {:sourceloc "test/c/data/array2.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/array2.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call free_($p10);
  assume {:sourceloc "test/c/data/array2.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
