...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/account.c -bpl ./account.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/account.c", 24, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "create:arg:b"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/pthread/account.c", 24, 28} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(32);
  assume {:sourceloc "test/c/pthread/account.c", 24, 18} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/account.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account.c", 25, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, $i0);
  assume {:sourceloc "test/c/pthread/account.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/account.c", 26, 18} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, 0);
  assume {:sourceloc "test/c/pthread/account.c", 27, 28} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_init($p5, $0.ref);
  assume {:sourceloc "test/c/pthread/account.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $r := $p2;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/account.c", 32, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/account.c", 32, 21} true;
  assume {:verifier.code 0} true;
  $p0 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 32, 26} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account.c", 32, 26} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "test/c/pthread/account.c", 32, 14} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i14: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/account.c", 35, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/account.c", 35, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/account.c", 36, 23} true;
  assume {:verifier.code 0} true;
  $p2 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 36, 28} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_lock($p3);
  assume {:sourceloc "test/c/pthread/account.c", 37, 18} true;
  assume {:verifier.code 0} true;
  $p5 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 37, 23} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p5, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account.c", 37, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "test/c/pthread/account.c", 37, 33} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.3, $p1);
  assume {:sourceloc "test/c/pthread/account.c", 37, 31} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i7, $i8);
  assume {:sourceloc "test/c/pthread/account.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p10 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p10, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account.c", 37, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p11, $i9);
  assume {:sourceloc "test/c/pthread/account.c", 38, 25} true;
  assume {:verifier.code 0} true;
  $p12 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 38, 30} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p12, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_mutex_unlock($p13);
  assume {:sourceloc "test/c/pthread/account.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p21: ref;
$bb0:
  assume {:sourceloc "test/c/pthread/account.c", 44, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/account.c", 44, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/account.c", 46, 23} true;
  assume {:verifier.code 0} true;
  $p2 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 46, 28} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account.c", 46, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_lock($p3);
  assume {:sourceloc "test/c/pthread/account.c", 47, 7} true;
  assume {:verifier.code 0} true;
  call $i5 := read();
  call {:cexpr "r"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/pthread/account.c", 48, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.4, $p1);
  assume {:sourceloc "test/c/pthread/account.c", 48, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $sge.i32($i5, $i6);
  assume {:sourceloc "test/c/pthread/account.c", 48, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "test/c/pthread/account.c", 49, 24} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.4, $p1);
  assume {:sourceloc "test/c/pthread/account.c", 49, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i5, $i8);
  assume {:sourceloc "test/c/pthread/account.c", 49, 5} true;
  assume {:verifier.code 0} true;
  $p10 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 49, 10} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p10, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account.c", 49, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p11, $i9);
  assume {:sourceloc "test/c/pthread/account.c", 50, 27} true;
  assume {:verifier.code 0} true;
  $p12 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 50, 32} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p12, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account.c", 50, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_mutex_unlock($p13);
  assume {:sourceloc "test/c/pthread/account.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $p15 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 51, 10} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p15, $mul.ref(0, 32)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/account.c", 51, 20} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p16, 1);
  assume {:sourceloc "test/c/pthread/account.c", 52, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/pthread/account.c", 54, 25} true;
  assume {:verifier.code 0} true;
  $p17 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 54, 30} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p17, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account.c", 54, 3} true;
  assume {:verifier.code 0} true;
  call $i19 := pthread_mutex_unlock($p18);
  assume {:sourceloc "test/c/pthread/account.c", 55, 3} true;
  assume {:verifier.code 0} true;
  $p20 := $M.2;
  assume {:sourceloc "test/c/pthread/account.c", 55, 8} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p20, $mul.ref(0, 32)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/account.c", 55, 18} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p21, 0);
  assume {:sourceloc "test/c/pthread/account.c", 56, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/pthread/account.c", 57, 1} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/account.c", 64, 7} true;
  ...
  assume {:sourceloc "test/c/pthread/account.c", 65, 7} true;
  assume {:verifier.code 1} true;
  call $i5 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/pthread/account.c", 65, 5} true;
  assume {:verifier.code 0} true;
  $M.5 := $store.i32($M.5, $p2, $i5);
  assume {:sourceloc "test/c/pthread/account.c", 66, 7} true;
  assume {:verifier.code 1} true;
  call $i6 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/pthread/account.c", 66, 5} true;
  assume {:verifier.code 0} true;
  $M.6 := $store.i32($M.6, $p3, $i6);
  assume {:sourceloc "test/c/pthread/account.c", 67, 9} true;
  assume {:verifier.code 0} true;
  call $p7 := create($i4);
  assume {:sourceloc "test/c/pthread/account.c", 67, 7} true;
  assume {:verifier.code 0} true;
  $M.2 := $p7;
  assume {:sourceloc "test/c/pthread/account.c", 70, 37} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/pthread/account.c", 70, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p0, $0.ref, deposit, $p8);
  assume {:sourceloc "test/c/pthread/account.c", 71, 38} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/pthread/account.c", 71, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p1, $0.ref, withdraw, $p10);
  assume {:sourceloc "test/c/pthread/account.c", 73, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.7, $p0);
  assume {:sourceloc "test/c/pthread/account.c", 73, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "test/c/pthread/account.c", 74, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.8, $p1);
  assume {:sourceloc "test/c/pthread/account.c", 74, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "test/c/pthread/account.c", 76, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/account.c", 76, 3} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "test/c/pthread/account.c", 77, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
