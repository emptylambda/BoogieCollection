...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/simd/add_fail.c -bpl ./add_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/simd/add_fail.c", 7, 15} true;
  ...
  assume {:sourceloc "test/c/simd/add_fail.c", 8, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/simd/add_fail.c", 9, 15} true;
  assume {:verifier.code 0} true;
  $v4 := $add.vec.2xi64($v1, $v3);
  call {:cexpr "c"} boogie_si_record_vec.2xi64($v4);
  assume {:sourceloc "test/c/simd/add_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/simd/add_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/simd/add_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
