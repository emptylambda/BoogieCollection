...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/nearbyintf_fail.c -bpl ./nearbyintf_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call $i0 := fesetround(0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:19:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f1 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i2 := (if $foeq.float.bool($f1, $fp(-4, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:20:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f3 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i4 := (if $foeq.float.bool($f3, $fp(-3, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:21:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f5 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i6 := (if $foeq.float.bool($f5, $fp(-4, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:22:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f7 := llvm.nearbyint.f32($fp(0, 401, 33340000000));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i8 := (if $foeq.float.bool($f7, $fp(7, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := fesetround(2048);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:25:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f10 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i11 := (if $foeq.float.bool($f10, $fp(-3, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:26:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f12 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $i13 := (if $foeq.float.bool($f12, $fp(-2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb28;
$bb30:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:27:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f14 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i15 := (if $foeq.float.bool($f14, $fp(-3, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:28:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f16 := llvm.nearbyint.f32($fp(0, 401, 33340000000));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $i17 := (if $foeq.float.bool($f16, $fp(8, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call $i18 := fesetround(1024);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:31:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f19 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $i20 := (if $foeq.float.bool($f19, $fp(-4, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb46;
$bb46:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:32:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f21 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(-4, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb48;
$bb50:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb51;
$bb51:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:33:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f23 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $i24 := (if $foeq.float.bool($f23, $fp(-4, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb54:
  ...
  goto $bb53;
$bb55:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb56;
$bb56:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:34:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f25 := llvm.nearbyint.f32($fp(0, 401, 33340000000));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $i26 := (if $foeq.float.bool($f25, $fp(7, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
...
$bb59:
  ...
  goto $bb58;
$bb60:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i27 := fesetround(3072);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb61;
$bb61:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:37:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f28 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $i29 := (if $foeq.float.bool($f28, $fp(-3, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
...
$bb64:
  ...
  goto $bb63;
$bb65:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  goto $bb66;
$bb66:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:38:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f30 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $i31 := (if $foeq.float.bool($f30, $fp(-3, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
...
$bb69:
  ...
  goto $bb68;
$bb70:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb71;
$bb71:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:39:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f32 := llvm.nearbyint.f32($fp(-3, 500000, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $i33 := (if $foeq.float.bool($f32, $fp(-3, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
...
$bb74:
  ...
  goto $bb73;
$bb75:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb76;
$bb76:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:40:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f34 := llvm.nearbyint.f32($fp(0, 401, 33340000000));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  $i35 := (if $foeq.float.bool($f34, $fp(7, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
...
$bb79:
  ...
  goto $bb78;
$bb80:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb81;
$bb81:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:42:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f36 := llvm.nearbyint.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $i37 := (if $foeq.float.bool($f36, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
...
$bb84:
  ...
  goto $bb83;
$bb85:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb86;
$bb86:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:43:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f38 := llvm.nearbyint.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $i39 := (if $foeq.float.bool($f38, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
...
$bb89:
  ...
  goto $bb88;
$bb90:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 44, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:44:26: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f40 := llvm.nearbyint.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 44, 15} true;
  assume {:verifier.code 0} true;
  call $i41 := __signbitf($f40);
  call {:cexpr "isNeg"} boogie_si_record_i32($i41);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 45, 3} true;
  assume {:verifier.code 0} true;
  goto $bb91;
$bb91:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 45, 3} true;
...
$bb94:
  ...
  goto $bb93;
$bb95:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
  goto $bb96;
$bb96:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:47:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f43 := llvm.nearbyint.f32($fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
  $i44 := (if $foeq.float.bool($f43, $fp(0, 7, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
...
$bb99:
  ...
  goto $bb98;
$bb100:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 48, 3} true;
  assume {:verifier.code 0} true;
  goto $bb101;
$bb101:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 48, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:48:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f45 := llvm.nearbyint.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 48, 3} true;
  assume {:verifier.code 0} true;
  $i46 := (if $foeq.float.bool($f45, $fp(0, 0, 25867680)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 48, 3} true;
  assume {:verifier.code 0} true;
...
$bb104:
  ...
  goto $bb103;
$bb105:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
  goto $bb106;
$bb106:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/nearbyintf_fail.c:50:3: warning: over-approximating call to llvm.nearbyint.f32; */
  call $f47 := llvm.nearbyint.f32($fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call $i48 := __isnanf($f47);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $i49 := $ne.i32($i48, 0);
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 50, 3} true;
...
$bb109:
  ...
  goto $bb108;
$bb110:
  assume {:sourceloc "test/c/mathc/nearbyintf_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure {:inline 1} fesetround($i0: i32)
  returns ($r: i32);
const llvm.nearbyint.f32: ref;
axiom (llvm.nearbyint.f32 == $sub.ref(0, 3096));
procedure {:inline 1} llvm.nearbyint.f32($f0: float)
  returns ($r: float);
const __signbitf: ref;
axiom (__signbitf == $sub.ref(0, 4128));
procedure {:inline 1} __signbitf($f0: float)
  returns ($r: i32);
const __isnanf: ref;
axiom (__isnanf == $sub.ref(0, 5160));
procedure {:inline 1} __isnanf($f0: float)
  returns ($r: i32);
