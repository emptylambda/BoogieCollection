...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/lroundl.c -bpl ./lroundl.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/lroundl.c", 16, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/lroundl.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/mathc/lroundl.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := lroundl($fp(0, 0, 140652697145712));
  assume {:sourceloc "test/c/mathc/lroundl.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i64($i2, $sub.i64(0, 1));
  assume {:sourceloc "test/c/mathc/lroundl.c", 17, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/mathc/lroundl.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/mathc/lroundl.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := lroundl($fp(0, 0, 140652697145712));
  assume {:sourceloc "test/c/mathc/lroundl.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i64($i4, 4);
  assume {:sourceloc "test/c/mathc/lroundl.c", 18, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/mathc/lroundl.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/mathc/lroundl.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := lroundl($fp(0, 0, 140652697145712));
  assume {:sourceloc "test/c/mathc/lroundl.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i64($i6, 2);
  assume {:sourceloc "test/c/mathc/lroundl.c", 19, 3} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/mathc/lroundl.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/mathc/lroundl.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := lroundl($fp(0, 0, 140652697145712));
  assume {:sourceloc "test/c/mathc/lroundl.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i64($i8, 0);
  assume {:sourceloc "test/c/mathc/lroundl.c", 21, 3} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/lroundl.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/lroundl.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := lroundl($fp(0, 0, 140652697145712));
  assume {:sourceloc "test/c/mathc/lroundl.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i64($i10, 0);
  assume {:sourceloc "test/c/mathc/lroundl.c", 22, 3} true;
...
$bb29:
  ...
  goto $bb28;
$bb30:
  assume {:sourceloc "test/c/mathc/lroundl.c", 23, 26} true;
  assume {:verifier.code 0} true;
  call $i12 := lroundl($fp(0, 0, 140652697145712));
  assume {:sourceloc "test/c/mathc/lroundl.c", 23, 26} true;
  assume {:verifier.code 0} true;
  $f13 := $si2fp.i64.float($i12);
  assume {:sourceloc "test/c/mathc/lroundl.c", 23, 15} true;
  assume {:verifier.code 0} true;
  call $i14 := __signbitl($f13);
  call {:cexpr "isNeg"} boogie_si_record_i32($i14);
  assume {:sourceloc "test/c/mathc/lroundl.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/lroundl.c", 24, 3} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/lroundl.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
