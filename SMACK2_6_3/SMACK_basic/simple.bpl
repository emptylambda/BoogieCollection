...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/simple.c -bpl ./simple.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/simple.c", 14, 3} true;
...
$bb4:
  ...
  assume {:sourceloc "test/c/basic/simple.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($sub.i32(0, 1), $sub.i32(0, 1));
  assume {:sourceloc "test/c/basic/simple.c", 14, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb3;
$bb9:
  assume {:sourceloc "test/c/basic/simple.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $sub.i32(0, 1);
  $exn := false;
  return;
