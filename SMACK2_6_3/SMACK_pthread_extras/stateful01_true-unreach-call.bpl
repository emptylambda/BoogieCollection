...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/stateful01_true-unreach-call.c -bpl ./stateful01_true-unreach-call.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 10, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 11, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_lock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 15, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 21, 9} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $i3;
  call {:cexpr "data1"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_lock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 25, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 25, 9} true;
  assume {:verifier.code 0} true;
  ...
  $M.1 := $i7;
  call {:cexpr "data2"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 32, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 33, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_init(mb, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := 10;
  call {:cexpr "data1"} boogie_si_record_i32(10);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := 10;
  call {:cexpr "data2"} boogie_si_record_i32(10);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread1, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 39, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 41, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.2, $p0);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 42, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.3, $p1);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 44, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 44, 3} true;
...
$bb6:
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "test/c/pthread_extras/stateful01_true-unreach-call.c", 46, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
