...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strcpy.c -bpl ./strcpy.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24765));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strcpy.c", 10, 10} true;
  ...
  assume {:sourceloc "test/c/strings/strcpy.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strcpy.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := strcpy($p1, .str);
  assume $isExternal($p2);
  assume {:sourceloc "test/c/strings/strcpy.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strcpy.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strcpy.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := strlen($p3);
  assume {:sourceloc "test/c/strings/strcpy.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strcpy.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/strings/strcpy.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 5)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strcpy.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := strcmp($p6, .str);
  assume {:sourceloc "test/c/strings/strcpy.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i7, 0);
  assume {:sourceloc "test/c/strings/strcpy.c", 12, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/strings/strcpy.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assert == $sub.ref(0, 10317));
...
axiom (__SMACK_decls == $sub.ref(0, 20637));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 21669));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 22701));
...
axiom (llvm.dbg.value == $sub.ref(0, 23733));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 24765));
