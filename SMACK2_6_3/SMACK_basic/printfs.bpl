...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/printfs.c -bpl ./printfs.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24823));
...
const .str: ref;
axiom (.str == $sub.ref(0, 1037));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 2077));
const {:count 19} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 3120));
const {:count 22} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 4166));
const {:count 25} .str.4: ref;
axiom (.str.4 == $sub.ref(0, 5215));
const main: ref;
axiom (main == $sub.ref(0, 6247));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/printfs.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/printfs.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call $i0 := printf.ref(.str);
  assume {:sourceloc "test/c/basic/printfs.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := printf.ref.i32(.str.1, 10);
  assume {:sourceloc "test/c/basic/printfs.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := printf.ref.i32.i32(.str.2, 10, 20);
  assume {:sourceloc "test/c/basic/printfs.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := printf.ref.i32.i32.i32(.str.3, 10, 20, 30);
  assume {:sourceloc "test/c/basic/printfs.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := printf.ref.i32.i32.i32(.str.3, 10, 20, 30);
  assume {:sourceloc "test/c/basic/printfs.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := printf.ref.i32.i32.i32.i32(.str.4, 10, 20, 30, 40);
  assume {:sourceloc "test/c/basic/printfs.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const printf: ref;
axiom (printf == $sub.ref(0, 7279));
procedure {:inline 1} printf.ref.i32.i32.i32.i32($p0: ref, p.1: i32, p.2: i32, p.3: i32, p.4: i32)
  returns ($r: i32);
procedure {:inline 1} printf.ref.i32.i32.i32($p0: ref, p.1: i32, p.2: i32, p.3: i32)
  returns ($r: i32);
...
axiom (__SMACK_dummy == $sub.ref(0, 10375));
...
axiom (__SMACK_and32 == $sub.ref(0, 11407));
...
axiom (__SMACK_and64 == $sub.ref(0, 12439));
...
axiom (__SMACK_and16 == $sub.ref(0, 13471));
...
axiom (__SMACK_and8 == $sub.ref(0, 14503));
...
axiom (__SMACK_or32 == $sub.ref(0, 15535));
...
axiom (__SMACK_or64 == $sub.ref(0, 16567));
...
axiom (__SMACK_or16 == $sub.ref(0, 17599));
...
axiom (__SMACK_or8 == $sub.ref(0, 18631));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19663));
...
axiom (__SMACK_decls == $sub.ref(0, 20695));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 21727));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 22759));
...
axiom (llvm.dbg.value == $sub.ref(0, 23791));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 24823));
