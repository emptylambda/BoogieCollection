...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/left_shift_overflow_fail.c -bpl ./left_shift_overflow_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/left_shift_overflow_fail.c", 7, 11} true;
  ...
  assume {:sourceloc "test/c/bits/left_shift_overflow_fail.c", 8, 11} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i1);
  call {:cexpr "z"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/bits/left_shift_overflow_fail.c", 9, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/left_shift_overflow_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/bits/left_shift_overflow_fail.c", 10, 3} true;
...
$bb12:
  ...
  goto $bb9;
$bb13:
  assume {:sourceloc "test/c/bits/left_shift_overflow_fail.c", 11, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/left_shift_overflow_fail.c:11:12: warning: over-approximating bitwise operation shl; */
  $i5 := $shl.i32($i0, $i1);
  assume {:sourceloc "test/c/bits/left_shift_overflow_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
axiom (__SMACK_and32 == $sub.ref(0, 5160));
...
axiom (__SMACK_and64 == $sub.ref(0, 6192));
...
axiom (__SMACK_and16 == $sub.ref(0, 7224));
...
axiom (__SMACK_and8 == $sub.ref(0, 8256));
...
axiom (__SMACK_or32 == $sub.ref(0, 9288));
...
axiom (__SMACK_or64 == $sub.ref(0, 10320));
...
axiom (__SMACK_or16 == $sub.ref(0, 11352));
...
axiom (__SMACK_or8 == $sub.ref(0, 12384));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 13416));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 14448));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 15480));
