...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/sigma_false_GREAT-unreach-call.c -bpl ./sigma_false_GREAT-unreach-call.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 29940));
...
const array_index: ref;
axiom (array_index == $sub.ref(0, 1028));
const lock: ref;
axiom (lock == $sub.ref(0, 2076));
const array: ref;
axiom (array == $sub.ref(0, 3108));
const thread: ref;
axiom (thread == $sub.ref(0, 4140));
procedure {:inline 1} thread($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $p2: ref;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 22, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 24, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 24, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p2, $mul.ref($i4, 4));
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 24, 22} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p5, 1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call $i0 := pthread_mutex_init(lock, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 36, 20} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(20);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 36, 7} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 37, 18} true;
  assume {:verifier.code 0} true;
  call $p3 := malloc(20);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 37, 11} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 37, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $p3;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 42, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $slt.i32($i5, 5);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 42, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 43, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 44, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i5);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 44, 21} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p2, $mul.ref($i8, 4));
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 44, 5} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p9, $0.ref, thread, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 45, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 45, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.1 := $i12;
  call {:cexpr "array_index"} boogie_si_record_i32($i12);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 46, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 47, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 49, 8} true;
  assume {:verifier.code 0} true;
  $i15 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 42, 33} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i5, 1);
  call {:cexpr "tid"} boogie_si_record_i32($i14);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i14;
  goto $bb1;
$bb5:
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 49, 21} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.i32($i15, 5);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 49, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i16 == 1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 50, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 50, 5} true;
  assume {:verifier.code 0} true;
  call $i20 := pthread_join($i19, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 51, 3} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !(($i16 == 1));
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 53, 8} true;
  assume {:verifier.code 0} true;
  $i22, $i23 := 0, 0;
  goto $bb9;
$bb8:
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 49, 33} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i15, 1);
  call {:cexpr "tid"} boogie_si_record_i32($i21);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 49, 3} true;
  assume {:verifier.code 0} true;
  $i15 := $i21;
  goto $bb5;
$bb9:
  ...
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 53, 27} true;
  assume {:verifier.code 0} true;
  $i24 := $slt.i32($i22, 5);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 53, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i24 == 1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 54, 12} true;
  assume {:verifier.code 0} true;
  $p25 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 54, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 54, 9} true;
  assume {:verifier.code 0} true;
  $i29 := $add.i32($i23, $i28);
  call {:cexpr "sum"} boogie_si_record_i32($i29);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 55, 3} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !(($i24 == 1));
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 57, 3} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 53, 39} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i32($i22, 1);
  call {:cexpr "tid"} boogie_si_record_i32($i30);
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 53, 3} true;
  assume {:verifier.code 0} true;
  $i22, $i23 := $i30, $i29;
  goto $bb9;
...
$bb16:
  ...
  goto $bb15;
$bb17:
  assume {:sourceloc "test/c/pthread_extras/sigma_false_GREAT-unreach-call.c", 60, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_mutex_init == $sub.ref(0, 8268));
procedure {:inline 1} pthread_mutex_init($p0: ref, $p1: ref)
  returns ($r: i32);
const malloc: ref;
axiom (malloc == $sub.ref(0, 9300));
...
axiom (__SMACK_dummy == $sub.ref(0, 14460));
...
axiom (__VERIFIER_assert == $sub.ref(0, 15492));
...
axiom (__SMACK_and32 == $sub.ref(0, 16524));
...
axiom (__SMACK_and64 == $sub.ref(0, 17556));
...
axiom (__SMACK_and16 == $sub.ref(0, 18588));
...
axiom (__SMACK_and8 == $sub.ref(0, 19620));
...
axiom (__SMACK_or32 == $sub.ref(0, 20652));
...
axiom (__SMACK_or64 == $sub.ref(0, 21684));
...
axiom (__SMACK_or16 == $sub.ref(0, 22716));
...
axiom (__SMACK_or8 == $sub.ref(0, 23748));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 24780));
...
axiom (__SMACK_decls == $sub.ref(0, 25812));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 26844));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 27876));
...
axiom (llvm.dbg.value == $sub.ref(0, 28908));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 29940));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.1 := $sub.i32(0, 1);
  call {:cexpr "array_index"} boogie_si_record_i32($sub.i32(0, 1));
  $M.0 := $0.ref;
  $exn := false;
  return;
}
