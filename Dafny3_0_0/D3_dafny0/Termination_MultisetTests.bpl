...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, a#0: MultiSet Box, n#0: int :: 
    ...
    MultisetTests.__default.F#canCall(a#0, n#0)
         || (1 != $FunctionContextHeight && $Is(a#0, TMultiSet(TInt)) && LitInt(0) <= n#0)
       ==> true);
...
procedure CheckWellformed$$MultisetTests.__default.F(a#0: MultiSet Box where $Is(a#0, TMultiSet(TInt)), 
...
implementation CheckWellformed$$MultisetTests.__default.F(a#0: MultiSet Box, n#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##a#0: MultiSet Box;
  var ##n#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy(384,11): initial state"} true;
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume MultisetTests.__default.F($LS($LZ), a#0, n#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(MultisetTests.__default.F($LS($LZ), a#0, n#0), TInt);
        }
        else
        {
            ##a#0 := a#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##a#0, TMultiSet(TInt), $Heap);
            ...
            assert 0 <= n#0
               || (MultiSet#Subset(##a#0, a#0) && !MultiSet#Equal(##a#0, a#0))
               || ##n#0 == n#0;
            assert (MultiSet#Subset(##a#0, a#0) && !MultiSet#Equal(##a#0, a#0))
               || (MultiSet#Equal(##a#0, a#0) && ##n#0 < n#0);
            assume MultisetTests.__default.F#canCall(a#0, n#0 - 1);
            assume MultisetTests.__default.F($LS($LZ), a#0, n#0)
               == MultisetTests.__default.F($LS($LZ), a#0, n#0 - 1);
            assume MultisetTests.__default.F#canCall(a#0, n#0 - 1);
            // CheckWellformedWithResult: any expression
            assume $Is(MultisetTests.__default.F($LS($LZ), a#0, n#0), TInt);
        }
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, a#0: MultiSet Box, n#0: int :: 
    ...
    MultisetTests.__default.F_k#canCall(a#0, n#0)
         || (2 != $FunctionContextHeight && $Is(a#0, TMultiSet(TInt)) && LitInt(0) <= n#0)
       ==> true);
...
procedure CheckWellformed$$MultisetTests.__default.F_k(a#0: MultiSet Box where $Is(a#0, TMultiSet(TInt)), 
    n#0: int where LitInt(0) <= n#0);
...
implementation CheckWellformed$$MultisetTests.__default.F_k(a#0: MultiSet Box, n#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##a#0: MultiSet Box;
  var ##n#0: int;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function F'
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy(390,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume MultisetTests.__default.F_k($LS($LZ), a#0, n#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(MultisetTests.__default.F_k($LS($LZ), a#0, n#0), TInt);
        }
        else
        {
            ##a#0 := a#0;
            ...
            assert (MultiSet#Subset(##a#0, a#0) && !MultiSet#Equal(##a#0, a#0))
               || (MultiSet#Equal(##a#0, a#0) && ##n#0 < n#0);
            assume MultisetTests.__default.F_k#canCall(a#0, n#0 - 1);
            assume MultisetTests.__default.F_k($LS($LZ), a#0, n#0)
               == MultisetTests.__default.F_k($LS($LZ), a#0, n#0 - 1);
            assume MultisetTests.__default.F_k#canCall(a#0, n#0 - 1);
            // CheckWellformedWithResult: any expression
            assume $Is(MultisetTests.__default.F_k($LS($LZ), a#0, n#0), TInt);
        }
...
procedure {:_induction n#0, b#0} CheckWellformed$$MultisetTests.__default.M(n#0: int where LitInt(0) <= n#0, 
    b#0: MultiSet Box
...
procedure {:_induction n#0, b#0} Call$$MultisetTests.__default.M(n#0: int where LitInt(0) <= n#0, 
    b#0: MultiSet Box
       where $Is(b#0, TMultiSet(TInt)) && $IsAlloc(b#0, TMultiSet(TInt), $Heap));
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures MultisetTests.__default.F#canCall(b#0, n#0);
  ensures MultisetTests.__default.F($LS($LS($LZ)), b#0, n#0) == LitInt(0);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:_induction n#0, b#0} Impl$$MultisetTests.__default.M(n#0: int where LitInt(0) <= n#0, 
    b#0: MultiSet Box
       where $Is(b#0, TMultiSet(TInt)) && $IsAlloc(b#0, TMultiSet(TInt), $Heap))
...
implementation {:_induction n#0, b#0} Impl$$MultisetTests.__default.M(n#0: int, b#0: MultiSet Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;

    // AddMethodImpl: M, Impl$$MultisetTests.__default.M
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy(397,2): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#n0#0: int, $ih#b0#0: MultiSet Box :: 
      LitInt(0) <= $ih#n0#0
           && $Is($ih#b0#0, TMultiSet(TInt))
           && Lit(true)
           && ((0 <= $ih#n0#0 && $ih#n0#0 < n#0)
             || ($ih#n0#0 == n#0
               && 
              MultiSet#Subset($ih#b0#0, b#0)
               && !MultiSet#Equal($ih#b0#0, b#0)))
         ==> MultisetTests.__default.F($LS($LZ), $ih#b0#0, $ih#n0#0) == LitInt(0));
    $_reverifyPost := false;
}
