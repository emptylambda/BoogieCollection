...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_assign_fail.c -bpl ./struct_assign_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_assign_fail.c", 11, 12} true;
  ...
  assume {:sourceloc "test/c/data/struct_assign_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_assign_fail.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/struct_assign_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
