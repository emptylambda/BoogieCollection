...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/malloc_nondet_fail.c -bpl ./malloc_nondet_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 7, 11} true;
  ...
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 8, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 9, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sext.i32.i64($i0);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 9, 21} true;
  assume {:verifier.code 0} true;
  call $p3 := malloc($i2);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i32.i8($i0);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i0);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p3, $mul.ref($i5, 1));
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 10, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p6, $i4);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call free_($p3);
  assume {:sourceloc "test/c/memory-safety/malloc_nondet_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
