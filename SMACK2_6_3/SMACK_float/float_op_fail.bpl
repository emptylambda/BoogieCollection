...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/float_op_fail.c -bpl ./float_op_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/float_op_fail.c", 14, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/float/float_op_fail.c", 14, 14} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/float_op_fail.c:14:14: warning: over-approximating floating-point arithmetic fdiv; */
  $f0 := $fdiv.float($fp(2, 250000, 0), $fp(1, 500000, 0));
  assume {:sourceloc "test/c/float/float_op_fail.c", 14, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/float_op_fail.c:14:9: warning: over-approximating floating-point arithmetic fmul; */
  $f1 := $fmul.float($fp(1, 500000, 0), $f0);
  call {:cexpr "c"} boogie_si_record_float($f1);
  assume {:sourceloc "test/c/float/float_op_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/float_op_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i2 := (if $foeq.float.bool($f1, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/float_op_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/float_op_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
