...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/fmod_fail.c -bpl ./fmod_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 17, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 17, 14} true;
  assume {:verifier.code 0} true;
  call $f0 := fmod($fp(5, 100000, 0), $fp(-3, 0, 0));
  call {:cexpr "c"} boogie_si_record_float($f0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmod_fail.c:18:3: warning: over-approximating floating-point arithmetic fsub; */
  $f1 := $fsub.float($f0, $fp(2, 100000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmod_fail.c:18:3: warning: over-approximating call to llvm.fabs.f64; */
  call $f2 := llvm.fabs.f64($f1);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i3 := (if $foeq.float.bool($f2, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 20, 8} true;
  assume {:verifier.code 0} true;
  call $i4 := __isnan($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 20, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  call $i12 := __isnan($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb19, $bb21;
$bb8:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call $f6 := fmod($fp(0, 7, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := __isnan($f6);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 21, 5} true;
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call $f9 := fmod($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call $i10 := __isnan($f9);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 22, 5} true;
...
$bb17:
  ...
  goto $bb16;
$bb18:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb19:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 25, 7} true;
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 30, 8} true;
  assume {:verifier.code 0} true;
  call $i20 := __isnan($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i21 := $ne.i32($i20, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 30, 19} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb32, $bb34;
$bb21:
  assume !(($i13 == 1));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $f14 := fmod($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $i15 := __isnan($f14);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $i16 := $ne.i32($i15, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 26, 5} true;
...
$bb25:
  ...
  goto $bb24;
$bb26:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb27:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $f17 := fmod($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $i18 := __isnan($f17);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.i32($i18, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 27, 5} true;
...
$bb30:
  ...
  goto $bb29;
$bb31:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb32:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 30, 19} true;
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 35, 8} true;
  assume {:verifier.code 0} true;
  call $i28 := __isnan($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 35, 8} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.i32($i28, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 35, 19} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb47, $bb49;
$bb34:
  assume !(($i21 == 1));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 30, 23} true;
  assume {:verifier.code 0} true;
  call $i22 := __isinf($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 30, 23} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i22, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 30, 7} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i23 == 1));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  goto $bb37;
$bb37:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  call $f24 := fmod($fp(2, 0, 0), $fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i25 := (if $foeq.float.bool($f24, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
...
$bb40:
  ...
  goto $bb39;
$bb41:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  goto $bb42;
$bb42:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  call $f26 := fmod($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
...
$bb45:
  ...
  goto $bb44;
$bb46:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb47:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 35, 19} true;
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb67;
$bb49:
  assume !(($i29 == 1));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 35, 23} true;
  assume {:verifier.code 0} true;
  call $i30 := __iszero($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 35, 23} true;
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i30, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 35, 7} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume !(($i31 == 1));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
  goto $bb52;
$bb52:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
  call $f32 := fmod($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i33 := (if $foeq.float.bool($f32, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb54;
$bb56:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 37, 5} true;
  assume {:verifier.code 0} true;
  goto $bb57;
$bb57:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call $f34 := fmod($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 37, 5} true;
  assume {:verifier.code 0} true;
...
$bb60:
  ...
  goto $bb59;
$bb61:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 38, 27} true;
  assume {:verifier.code 0} true;
  call $f36 := fmod($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 38, 17} true;
  assume {:verifier.code 0} true;
  call $i37 := __signbit($f36);
  call {:cexpr "isNeg"} boogie_si_record_i32($i37);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 39, 5} true;
  assume {:verifier.code 0} true;
  goto $bb62;
$bb62:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 39, 5} true;
...
$bb65:
  ...
  goto $bb64;
$bb66:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb48;
$bb67:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $f39 := fmod($fp(0, 7, 8000000000000), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $i40 := __isnan($f39);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $i41 := $ne.i32($i40, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 42, 3} true;
...
$bb70:
  ...
  goto $bb69;
$bb71:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb72;
$bb72:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $f42 := fmod($fp(2, 0, 0), $fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $i43 := __isnan($f42);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i43, 0);
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 43, 3} true;
...
$bb75:
  ...
  goto $bb74;
$bb76:
  assume {:sourceloc "test/c/mathc/fmod_fail.c", 45, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const fmod: ref;
axiom (fmod == $sub.ref(0, 2064));
procedure {:inline 1} fmod($f0: float, $f1: float)
  returns ($r: float);
const llvm.fabs.f64: ref;
axiom (llvm.fabs.f64 == $sub.ref(0, 3096));
procedure {:inline 1} llvm.fabs.f64($f0: float)
  returns ($r: float);
const __isnan: ref;
axiom (__isnan == $sub.ref(0, 4128));
procedure {:inline 1} __isnan($f0: float)
  returns ($r: i32);
const __isinf: ref;
axiom (__isinf == $sub.ref(0, 5160));
procedure {:inline 1} __isinf($f0: float)
  returns ($r: i32);
const __iszero: ref;
axiom (__iszero == $sub.ref(0, 6192));
procedure {:inline 1} __iszero($f0: float)
  returns ($r: i32);
const __signbit: ref;
axiom (__signbit == $sub.ref(0, 7224));
