...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/jain_2_true.c -bpl ./jain_2_true.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/jain_2_true.c", 8, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/jain_2_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/jain_2_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/jain_2_true.c", 9, 17} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/basic/jain_2_true.c", 9, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $mul.i32(2, $i2);
  assume {:sourceloc "test/c/basic/jain_2_true.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i0, $i3);
  call {:cexpr "x"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/basic/jain_2_true.c", 10, 17} true;
  assume {:verifier.code 1} true;
  call $i5 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/basic/jain_2_true.c", 10, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32(2, $i5);
  assume {:sourceloc "test/c/basic/jain_2_true.c", 10, 11} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, $i6);
  call {:cexpr "y"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/basic/jain_2_true.c", 11, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/basic/jain_2_true.c", 11, 5} true;
