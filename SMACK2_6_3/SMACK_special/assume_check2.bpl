...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/special/assume_check2.c -bpl ./assume_check2.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/special/assume_check2.c", 8, 20} true;
  ...
  assume {:sourceloc "test/c/special/assume_check2.c", 11, 23} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check2.c:11:23: warning: over-approximating bitwise operation xor; */
  $i1 := $xor.i32($i0, $i0);
  assume {:sourceloc "test/c/special/assume_check2.c", 11, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "test/c/special/assume_check2.c", 11, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/special/assume_check2.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/special/assume_check2.c", 12, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check2.c:12:3: warning: over-approximating bitwise operation xor; */
  $i3 := $xor.i32($i0, $i0);
  assume {:sourceloc "test/c/special/assume_check2.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/special/assume_check2.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
