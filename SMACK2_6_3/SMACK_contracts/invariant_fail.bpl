...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/contracts/invariant_fail.c -bpl ./invariant_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 21704));
...
const {:count 10} g: ref;
axiom (g == $sub.ref(0, 1064));
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 12, 8} true;
  ...
  goto $bb1;
$bb1:
  assert {:loopinvariant} $expr($i0, $M.0);
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 12, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 4);
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 13, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 13, 5} true;
...
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i0);
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(g, $mul.ref(0, 40)), $mul.ref($i3, 4));
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, $i0);
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/contracts/invariant_fail.c", 12, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i0, 1);
...
axiom (__SMACK_dummy == $sub.ref(0, 6224));
...
axiom (__SMACK_and32 == $sub.ref(0, 7256));
...
axiom (__SMACK_and64 == $sub.ref(0, 8288));
...
axiom (__SMACK_and16 == $sub.ref(0, 9320));
...
axiom (__SMACK_and8 == $sub.ref(0, 10352));
...
axiom (__SMACK_or32 == $sub.ref(0, 11384));
...
axiom (__SMACK_or64 == $sub.ref(0, 12416));
...
axiom (__SMACK_or16 == $sub.ref(0, 13448));
...
axiom (__SMACK_or8 == $sub.ref(0, 14480));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 15512));
...
axiom (__SMACK_decls == $sub.ref(0, 16544));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 17576));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 18608));
...
axiom (llvm.dbg.value == $sub.ref(0, 19640));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const $expr: ref;
axiom ($expr == $sub.ref(0, 20672));
...
function {:inline} $expr(.0: i32, $M.0: [ref] i32) returns (bool) { |{
  var $i0: i1;
  var $exn: bool;
  var $r: i1;
$bb0:
