...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/calloc.c -bpl ./calloc.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/calloc.c", 7, 21} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/memory-safety/calloc.c", 7, 21} true;
  assume {:verifier.code 0} true;
  call $p0 := calloc(5, 4);
  assume {:sourceloc "test/c/memory-safety/calloc.c", 7, 14} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/memory-safety/calloc.c", 8, 13} true;
  ...
  assume {:sourceloc "test/c/memory-safety/calloc.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/memory-safety/calloc.c", 9, 3} true;
...
$bb7:
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "test/c/memory-safety/calloc.c", 10, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.ref($p1, $0.ref);
  assume {:sourceloc "test/c/memory-safety/calloc.c", 10, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb9, $bb10;
$bb9:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/memory-safety/calloc.c", 11, 5} true;
  assume {:verifier.code 0} true;
  $i6 := 1;
  goto $bb11;
$bb10:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/memory-safety/calloc.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume {:sourceloc "test/c/memory-safety/calloc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/memory-safety/calloc.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
...
$bb15:
  ...
  goto $bb14;
$bb16:
  assume {:sourceloc "test/c/memory-safety/calloc.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/calloc.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call free_($p11);
  assume {:sourceloc "test/c/memory-safety/calloc.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
  goto $bb11;
}
