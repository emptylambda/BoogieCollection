...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/globals_fail.c -bpl ./globals_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 22696));
...
const g1: ref;
axiom (g1 == $sub.ref(0, 1028));
const g2: ref;
axiom (g2 == $sub.ref(0, 2056));
const main: ref;
axiom (main == $sub.ref(0, 3088));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/globals_fail.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/globals_fail.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/basic/globals_fail.c", 10, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/basic/globals_fail.c", 12, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := 3;
  call {:cexpr "g1"} boogie_si_record_i32(3);
  assume {:sourceloc "test/c/basic/globals_fail.c", 13, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, 4);
  assume {:sourceloc "test/c/basic/globals_fail.c", 14, 6} true;
  assume {:verifier.code 0} true;
  $M.2 := 5;
  call {:cexpr "g2"} boogie_si_record_i32(5);
  assume {:sourceloc "test/c/basic/globals_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/globals_fail.c", 15, 3} true;
...
$bb8:
  ...
  goto $bb3;
$bb9:
  assume {:sourceloc "test/c/basic/globals_fail.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 7216));
...
axiom (__SMACK_and32 == $sub.ref(0, 9280));
...
axiom (__SMACK_and64 == $sub.ref(0, 10312));
...
axiom (__SMACK_and16 == $sub.ref(0, 11344));
...
axiom (__SMACK_and8 == $sub.ref(0, 12376));
...
axiom (__SMACK_or32 == $sub.ref(0, 13408));
...
axiom (__SMACK_or64 == $sub.ref(0, 14440));
...
axiom (__SMACK_or16 == $sub.ref(0, 15472));
...
axiom (__SMACK_or8 == $sub.ref(0, 16504));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17536));
...
axiom (__SMACK_decls == $sub.ref(0, 18568));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 19600));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 20632));
...
axiom (llvm.dbg.value == $sub.ref(0, 21664));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 22696));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := 0;
  call {:cexpr "g1"} boogie_si_record_i32(0);
  $M.2 := 0;
  call {:cexpr "g2"} boogie_si_record_i32(0);
  $exn := false;
  return;
}
