...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock.c -bpl ./lock.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock.c", 10, 27} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock.c", 10, 27} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/lock.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_lock($p1);
  assume {:sourceloc "test/c/pthread/lock.c", 12, 4} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "test/c/pthread/lock.c", 12, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_unlock($p1);
  assume {:sourceloc "test/c/pthread/lock.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock.c", 19, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_init($p0, $0.ref);
  assume {:sourceloc "test/c/pthread/lock.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/lock.c", 20, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lock.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/lock.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 24)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/lock.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.2, $p6);
  assume {:sourceloc "test/c/pthread/lock.c", 21, 3} true;
...
$bb10:
  assume true;
  assume {:sourceloc "test/c/pthread/lock.c", 25, 32} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/lock.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p1, $0.ref, t1, $p9);
  assume {:sourceloc "test/c/pthread/lock.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_mutex_lock($p0);
  assume {:sourceloc "test/c/pthread/lock.c", 27, 4} true;
  assume {:verifier.code 0} true;
  $i12 := $M.0;
  assume {:sourceloc "test/c/pthread/lock.c", 27, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $i13;
  call {:cexpr "z"} boogie_si_record_i32($i13);
  assume {:sourceloc "test/c/pthread/lock.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_mutex_unlock($p0);
  assume {:sourceloc "test/c/pthread/lock.c", 29, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.3, $p1);
  assume {:sourceloc "test/c/pthread/lock.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_join($i15, $0.ref);
  assume {:sourceloc "test/c/pthread/lock.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/pthread/lock.c", 30, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/pthread/lock.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_mutex_init == $sub.ref(0, 7220));
...
axiom (pthread_join == $sub.ref(0, 9284));
