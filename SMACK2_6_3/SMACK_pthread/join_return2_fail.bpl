...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/join_return2_fail.c -bpl ./join_return2_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 11, 4} true;
  ...
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($i2p.i64.ref(5));
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (pthread_exit == $sub.ref(0, 4124));
procedure {:inline 1} pthread_exit($p0: ref);
const t2: ref;
axiom (t2 == $sub.ref(0, 5156));
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 17, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  ...
  $M.0 := $i2;
  call {:cexpr "x"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($i2p.i64.ref(6));
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, t2, $0.ref);
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 29, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $p2);
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 30, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.2, $p1);
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $p3);
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 31, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 32, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/pthread/join_return2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 11348));
...
axiom (__VERIFIER_assert == $sub.ref(0, 12380));
...
axiom (__SMACK_and32 == $sub.ref(0, 13412));
...
axiom (__SMACK_and64 == $sub.ref(0, 14444));
...
axiom (__SMACK_and16 == $sub.ref(0, 15476));
...
axiom (__SMACK_and8 == $sub.ref(0, 16508));
...
axiom (__SMACK_or32 == $sub.ref(0, 17540));
...
axiom (__SMACK_or64 == $sub.ref(0, 18572));
...
axiom (__SMACK_or16 == $sub.ref(0, 19604));
...
axiom (__SMACK_or8 == $sub.ref(0, 20636));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 21668));
