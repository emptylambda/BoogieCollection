...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/switch4.c -bpl ./switch4.bpl
...
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/reach/switch4.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/switch4.c", 10, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i2, $sub.i32(0, 1));
  call {:cexpr "a"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/reach/switch4.c", 10, 5} true;
  assume {:verifier.code 0} true;
  $i6 := $i5;
  goto $bb10;
$bb6:
...
$bb8:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/reach/switch4.c", 8, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32(0, 1);
  call {:cexpr "a"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/reach/switch4.c", 8, 5} true;
  assume {:verifier.code 0} true;
  $i2 := $i4;
  goto $bb5;
$bb9:
...
$bb10:
  assume {:sourceloc "test/c/reach/switch4.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/switch4.c", 12, 7} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i32($i6, 2);
  call {:cexpr "a"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/reach/switch4.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/reach/switch4.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
