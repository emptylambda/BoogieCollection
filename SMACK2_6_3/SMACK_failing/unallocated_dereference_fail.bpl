...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/failing/unallocated_dereference_fail.c -bpl ./unallocated_dereference_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/failing/unallocated_dereference_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/failing/unallocated_dereference_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $p0 := $add.ref($u0, $mul.ref(0, 4));
  assume {:sourceloc "test/c/failing/unallocated_dereference_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, $p0);
  call {:cexpr "b"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/failing/unallocated_dereference_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
