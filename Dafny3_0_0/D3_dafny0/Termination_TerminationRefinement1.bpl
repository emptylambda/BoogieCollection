...
procedure CheckWellformed$$TerminationRefinement1.__default.M(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$TerminationRefinement1.__default.M(x#0: int);
  modifies $Heap, $Tick;
...
procedure Impl$$TerminationRefinement1.__default.M(x#0: int) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$TerminationRefinement1.__default.M(x#0: int) returns ($_reverifyPost: bool)
{
  ...
  var x##0: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy(449,2): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy[TerminationRefinement1](441,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := x#0;
    assume (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    assert 0 <= LitInt(4) || LitInt(4) == LitInt(4);
    assert LitInt(4) < LitInt(4);
    // ProcessCallStmt: Make the call
    call Call$$TerminationRefinement1.__default.M(x##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy[TerminationRefinement1](441,8)"} true;
}
