...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/simple_float_fail.c -bpl ./simple_float_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/simple_float_fail.c", 12, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/float/simple_float_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $f0 := $fpext.float.float($fp(1, 500000, 0));
  assume {:sourceloc "test/c/float/simple_float_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i1 := (if $foeq.float.bool($f0, $fp(1, 400000, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/simple_float_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/simple_float_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
