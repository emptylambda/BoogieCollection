...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/func_ptr_vararg_fail.c -bpl ./func_ptr_vararg_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24759));
...
const dprintf: ref;
axiom (dprintf == $sub.ref(0, 2060));
const .str: ref;
axiom (.str == $sub.ref(0, 3087));
const no_printf: ref;
axiom (no_printf == $sub.ref(0, 4119));
procedure {:inline 1} no_printf.ref($p0: ref)
{
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 8, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 8, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "g"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
procedure {:inline 1} no_printf.ref.ref.i32($p0: ref, p.1: ref, p.2: i32)
{
$bb1:
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 8, 5} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $p0 := $M.1;
  call devirtbounce($p0, .str, 10);
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 16, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/func_ptr_vararg_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 8247));
...
axiom (__VERIFIER_assert == $sub.ref(0, 9279));
...
axiom (__SMACK_and32 == $sub.ref(0, 10311));
...
axiom (__SMACK_and64 == $sub.ref(0, 11343));
...
axiom (__SMACK_and16 == $sub.ref(0, 12375));
...
axiom (__SMACK_and8 == $sub.ref(0, 13407));
...
axiom (__SMACK_or32 == $sub.ref(0, 14439));
...
axiom (__SMACK_or64 == $sub.ref(0, 15471));
...
axiom (__SMACK_or16 == $sub.ref(0, 16503));
...
axiom (__SMACK_or8 == $sub.ref(0, 17535));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18567));
...
axiom (__SMACK_decls == $sub.ref(0, 19599));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 20631));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21663));
...
axiom (llvm.dbg.value == $sub.ref(0, 22695));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 23727));
...
axiom (devirtbounce == $sub.ref(0, 24759));
procedure {:inline 1} devirtbounce(funcPtr: ref, arg: ref, arg1: i32)
{
  var $p0: ref;
  var $i1: i1;
$bb0:
