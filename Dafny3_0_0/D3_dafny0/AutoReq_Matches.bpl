...
axiom (forall a#14#0#0: int :: 
  { #Matches.TheType.TheType_builder(a#14#0#0) } 
  DatatypeCtorId(#Matches.TheType.TheType_builder(a#14#0#0))
...
axiom (forall d: DatatypeType :: 
  { Matches.TheType.TheType__builder_q(d) } 
  Matches.TheType.TheType__builder_q(d)
     ==> (exists a#15#0#0: int :: d == #Matches.TheType.TheType_builder(a#15#0#0)));
...
axiom (forall a#16#0#0: int :: 
  { $Is(#Matches.TheType.TheType_builder(a#16#0#0), Tclass.Matches.TheType()) } 
  $Is(#Matches.TheType.TheType_builder(a#16#0#0), Tclass.Matches.TheType())
     <==> $Is(a#16#0#0, TInt));

// Constructor $IsAlloc
axiom (forall a#17#0#0: int, $h: Heap :: 
  { $IsAlloc(#Matches.TheType.TheType_builder(a#17#0#0), Tclass.Matches.TheType(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#Matches.TheType.TheType_builder(a#17#0#0), Tclass.Matches.TheType(), $h)
...
axiom (forall a#18#0#0: int :: 
  { #Matches.TheType.TheType_builder(LitInt(a#18#0#0)) } 
  #Matches.TheType.TheType_builder(LitInt(a#18#0#0))
     == Lit(#Matches.TheType.TheType_builder(a#18#0#0)));

function Matches.TheType.x(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#19#0#0: int :: 
  { #Matches.TheType.TheType_builder(a#19#0#0) } 
  Matches.TheType.x(#Matches.TheType.TheType_builder(a#19#0#0)) == a#19#0#0);
...
axiom (forall a#20#0#0: DatatypeType :: 
  { #Matches.TheType.TheType_copier(a#20#0#0) } 
  DatatypeCtorId(#Matches.TheType.TheType_copier(a#20#0#0))
...
axiom (forall d: DatatypeType :: 
  ...
  Matches.TheType.TheType__copier_q(d)
     ==> (exists a#21#0#0: DatatypeType :: 
      d == #Matches.TheType.TheType_copier(a#21#0#0)));

// Constructor $Is
axiom (forall a#22#0#0: DatatypeType :: 
  { $Is(#Matches.TheType.TheType_copier(a#22#0#0), Tclass.Matches.TheType()) } 
  $Is(#Matches.TheType.TheType_copier(a#22#0#0), Tclass.Matches.TheType())
     <==> $Is(a#22#0#0, Tclass.Matches.TheType()));

// Constructor $IsAlloc
axiom (forall a#23#0#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#Matches.TheType.TheType_copier(a#23#0#0), Tclass.Matches.TheType(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#Matches.TheType.TheType_copier(a#23#0#0), Tclass.Matches.TheType(), $h)
       <==> $IsAlloc(a#23#0#0, Tclass.Matches.TheType(), $h)));
...
axiom (forall a#24#0#0: DatatypeType :: 
  { #Matches.TheType.TheType_copier(Lit(a#24#0#0)) } 
  #Matches.TheType.TheType_copier(Lit(a#24#0#0))
     == Lit(#Matches.TheType.TheType_copier(a#24#0#0)));

function Matches.TheType.t(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#25#0#0: DatatypeType :: 
  { #Matches.TheType.TheType_copier(a#25#0#0) } 
  Matches.TheType.t(#Matches.TheType.TheType_copier(a#25#0#0)) == a#25#0#0);

// Inductive rank
axiom (forall a#26#0#0: DatatypeType :: 
  { #Matches.TheType.TheType_copier(a#26#0#0) } 
  DtRank(a#26#0#0) < DtRank(#Matches.TheType.TheType_copier(a#26#0#0)));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    Matches.__default.f1#canCall(x#0) || (1 != $FunctionContextHeight && x#0 > 3)
       ==> true);
...
procedure CheckWellformed$$Matches.__default.f1(x#0: int);
         ...
         || (2 != $FunctionContextHeight
          ...
          $Is(t#0, Tclass.Matches.TheType())
           && (if Matches.TheType.TheType__builder_q(t#0)
             then (var x#0 := Matches.TheType.x(t#0); x#0 > 3)
             else true))
       ==> true);
...
axiom (forall t#0: DatatypeType :: 
  ...
  $Is(t#0, Tclass.Matches.TheType())
     ==> Matches.__default.basic__test#requires(t#0)
       == (if Matches.TheType.TheType__builder_q(t#0)
         then (var x#1 := Matches.TheType.x(t#0); x#1 > 3)
         else true));
   ...
   ==> (forall t#0: DatatypeType :: 
    ...
    Matches.__default.basic__test#canCall(t#0)
       ...
       ==> (Matches.TheType.TheType__builder_q(t#0)
           ==> (var x#3 := Matches.TheType.x(t#0); Matches.__default.f1#canCall(x#3)))
         && Matches.__default.basic__test(t#0)
           == (if Matches.TheType.TheType__builder_q(t#0)
             then (var x#2 := Matches.TheType.x(t#0); Matches.__default.f1(x#2))
             else (var t#1 := Matches.TheType.t(t#0); Lit(true))));
         ...
         || (2 != $FunctionContextHeight
          ...
          $Is(t#0, Tclass.Matches.TheType())
           && (if Matches.TheType.TheType__builder_q(Lit(t#0))
             then (var x#4 := LitInt(Matches.TheType.x(Lit(t#0))); Lit(x#4 > 3))
             else true))
       ==> (Lit(Matches.TheType.TheType__builder_q(Lit(t#0)))
           ==> (var x#6 := LitInt(Matches.TheType.x(Lit(t#0))); 
            Matches.__default.f1#canCall(x#6)))
         && Matches.__default.basic__test(Lit(t#0))
           == (if Matches.TheType.TheType__builder_q(Lit(t#0))
             then (var x#5 := LitInt(Matches.TheType.x(Lit(t#0))); Matches.__default.f1(x#5))
             else (var t#3 := Lit(Matches.TheType.t(Lit(t#0))); Lit(true))));

procedure {:autoReq} CheckWellformed$$Matches.__default.basic__test(t#0: DatatypeType where $Is(t#0, Tclass.Matches.TheType()));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$Matches.__default.basic__test(t#0: DatatypeType)
{
  ...
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function basic_test
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(263,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (t#0 == #Matches.TheType.TheType_builder(_mcc#0#0))
    {
        havoc x#Z#0;
        assume true;
    ...
    else if (t#0 == #Matches.TheType.TheType_copier(_mcc#1#0))
    {
        assume $Is(_mcc#1#0, Tclass.Matches.TheType());
    }
    else
    {
        assume false;
    ...
    assume (if Matches.TheType.TheType__builder_q(t#0)
       then (var x#7 := Matches.TheType.x(t#0); x#7 > 3)
       else true);
    if (*)
    {
        assume false;
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        if (t#0 == #Matches.TheType.TheType_builder(_mcc#0#1))
        {
            havoc x#Z#1;
            assume true;
            assume let#2#0#0 == _mcc#0#1;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, TInt);
            assume x#Z#1 == let#2#0#0;
            ##x#0 := x#Z#1;
            ...
            assume Matches.__default.f1#canCall(x#Z#1);
            assume Matches.__default.basic__test(t#0) == Matches.__default.f1(x#Z#1);
            assume Matches.__default.f1#canCall(x#Z#1);
            // CheckWellformedWithResult: any expression
            assume $Is(Matches.__default.basic__test(t#0), TBool);
        }
        else if (t#0 == #Matches.TheType.TheType_copier(_mcc#1#1))
        {
            assume $Is(_mcc#1#1, Tclass.Matches.TheType());
            havoc t#Z#0;
            assume $Is(t#Z#0, Tclass.Matches.TheType());
            assume let#1#0#0 == _mcc#1#1;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, Tclass.Matches.TheType());
            assume t#Z#0 == let#1#0#0;
            assume Matches.__default.basic__test(t#0) == Lit(true);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(Matches.__default.basic__test(t#0), TBool);
        }
