...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/negative_numbers.c -bpl ./negative_numbers.bpl
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/basic/negative_numbers.c", 5, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "incr:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/negative_numbers.c", 5, 28} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  assume {:sourceloc "test/c/basic/negative_numbers.c", 5, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/negative_numbers.c", 9, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/negative_numbers.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/negative_numbers.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, $sub.i32(0, 10));
  assume {:sourceloc "test/c/basic/negative_numbers.c", 10, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/negative_numbers.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
