...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/contracts/array_fail.c -bpl ./array_fail.bpl
...
procedure {:entrypoint} main()
  returns ($r: i32)
  ensures $expr($M.0, $M.1, $M.2, $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9);
{
  var $i0: i1;
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/contracts/array_fail.c", 11, 3} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/contracts/array_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__CONTRACT_ensures == $sub.ref(0, 3128));
...
function {:inline} $expr($M.0: i32, $M.1: i32, $M.2: i32, $M.3: i32, $M.4: i32, $M.5: i32, $M.6: i32, $M.7: i32, $M.8: i32, $M.9: i32) returns (bool) { |{
  var $i0: i32;
  var $i1: i1;
  var $exn: bool;
  var $r: i1;
