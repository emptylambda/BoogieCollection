...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/change_rm_fail.c -bpl ./change_rm_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/change_rm_fail.c", 7, 12} true;
  ...
  assume {:sourceloc "test/c/float/change_rm_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/change_rm_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := fesetround($i0);
  assume {:sourceloc "test/c/float/change_rm_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/float/change_rm_fail.c", 8, 3} true;
...
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/float/change_rm_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
