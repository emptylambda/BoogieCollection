...
procedure CheckWellformed$$B.__default._default_Main();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$B.__default._default_Main();
  modifies $Heap, $Tick;
...
procedure Impl$$B.__default._default_Main() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$B.__default._default_Main() returns ($_reverifyPost: bool)
{
  ...
  var $rhs#0: int;
    ...
    // AddMethodImpl: Main, Impl$$B.__default._default_Main
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(65,16): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(66,11)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(66,14)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$B.X.Abs.C.__ctor();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(66,22)"} true;
    c#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(66,22)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(67,8)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$B.X.Abs.C.M(c#0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(67,9)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(68,9)
    assert c#0 != null;
    assume true;
    assert $_Frame[c#0, B.X.Abs.C.x];
    assert c#0 != null;
    assume true;
    $rhs#0 := read($Heap, c#0, B.X.Abs.C.x) + 1;
    $Heap := update($Heap, c#0, B.X.Abs.C.x, $rhs#0);
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(68,18)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(69,8)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    ...
    call Call$$B.X.Abs.C.M(c#0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(69,9)"} true;
}



procedure CheckWellformed$$B.__default.L(c#0: ref
       where $Is(c#0, Tclass.B.X.Abs.C()) && $IsAlloc(c#0, Tclass.B.X.Abs.C(), $Heap));
...
procedure Call$$B.__default.L(c#0: ref
       where $Is(c#0, Tclass.B.X.Abs.C()) && $IsAlloc(c#0, Tclass.B.X.Abs.C(), $Heap));
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure Impl$$B.__default.L(c#0: ref
       where $Is(c#0, Tclass.B.X.Abs.C()) && $IsAlloc(c#0, Tclass.B.X.Abs.C(), $Heap))
...
implementation Impl$$B.__default.L(c#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $rhs#1_0: int;
  var $rhs#0: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(74,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(75,5)
    assert {:subsumption 0} c#0 != null;
    assume B.X.Abs.C.Get#canCall($Heap, c#0);
    assert {:subsumption 0} c#0 != null;
    assume B.X.Abs.C.Get#canCall($Heap, c#0);
    assert B.X.Abs.C.Get($Heap, c#0) == read($Heap, c#0, B.X.Abs.C.x);
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(76,5)
    if (*)
    {
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(77,7)
        assert {:subsumption 0} c#0 != null;
        assume B.X.Abs.C.Valid#canCall($Heap, c#0);
        assume B.X.Abs.C.Valid#canCall($Heap, c#0);
        assert B.X.Abs.C.Valid($Heap, c#0);
    }
    else
    {
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(78,12)
        if (*)
        {
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(79,11)
            assert c#0 != null;
            assume true;
            assert $_Frame[c#0, B.X.Abs.C.x];
            assume true;
            $rhs#1_0 := LitInt(7);
            $Heap := update($Heap, c#0, B.X.Abs.C.x, $rhs#1_0);
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(79,14)"} true;
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(80,7)
            assert {:subsumption 0} c#0 != null;
            assume B.X.Abs.C.Valid#canCall($Heap, c#0);
            assume B.X.Abs.C.Valid#canCall($Heap, c#0);
            assert B.X.Abs.C.Valid($Heap, c#0);
        ...
        {
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(82,11)
            assert c#0 != null;
            assume true;
            assert $_Frame[c#0, B.X.Abs.C.x];
            assume true;
            ...
            $Heap := update($Heap, c#0, B.X.Abs.C.x, $rhs#0);
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(82,14)"} true;
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(83,7)
            assert {:subsumption 0} c#0 != null;
            assume B.X.Abs.C.Valid#canCall($Heap, c#0);
            assume B.X.Abs.C.Valid#canCall($Heap, c#0);
            assert B.X.Abs.C.Valid($Heap, c#0);
...
procedure CheckWellformed$$B.X.Abs.C.__ctor(this: ref
       where this != null
         && 
        $Is(this, Tclass.B.X.Abs.C())
         && $IsAlloc(this, Tclass.B.X.Abs.C(), $Heap));
...
procedure Call$$B.X.Abs.C.__ctor()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass.B.X.Abs.C())
  ...
  ensures B.X.Abs.C.Valid($Heap, this);
...
procedure CheckWellformed$$B.X.Abs.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.B.X.Abs.C())
         && $IsAlloc(this, Tclass.B.X.Abs.C(), $Heap));
...
procedure Call$$B.X.Abs.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.B.X.Abs.C())
         && $IsAlloc(this, Tclass.B.X.Abs.C(), $Heap));
  // user-defined preconditions
  requires B.X.Abs.C.Valid($Heap, this);
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
