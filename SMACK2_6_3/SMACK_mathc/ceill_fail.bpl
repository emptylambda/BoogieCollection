...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/ceill_fail.c -bpl ./ceill_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 11, 21} true;
  ...
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __isnanl($f0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 22} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 26} true;
  assume {:verifier.code 0} true;
  call $i3 := __isinfl($f0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 26} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 40} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 44} true;
  assume {:verifier.code 0} true;
  call $i5 := __iszerol($f0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 44} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 14, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 14, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:14:5: warning: over-approximating call to llvm.ceil.f80; */
  call $f7 := llvm.ceil.f80($f0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $i8 := (if $foge.float.bool($f7, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 14, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb10;
$bb12:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:15:5: warning: over-approximating call to llvm.ceil.f80; */
  call $f9 := llvm.ceil.f80($f0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:15:5: warning: over-approximating floating-point arithmetic fadd; */
  $f10 := $fadd.float($f0, $fp(0, 0, 5193739));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $i11 := (if $fole.float.bool($f9, $f10) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb15;
$bb17:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb18:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:18:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f12 := llvm.ceil.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i13 := (if $foeq.float.bool($f12, $fp(0, 0, 29577008)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  goto $bb20;
$bb22:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb23:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:19:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f14 := llvm.ceil.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i15 := (if $foeq.float.bool($f14, $fp(0, 0, 28721136)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb25;
$bb27:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 20, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:20:26: warning: over-approximating call to llvm.ceil.f80; */
  call $f16 := llvm.ceil.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 20, 15} true;
  assume {:verifier.code 0} true;
  call $i17 := __signbitl($f16);
  call {:cexpr "isNeg"} boogie_si_record_i32($i17);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb28:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 21, 3} true;
...
$bb31:
  ...
  goto $bb30;
$bb32:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:23:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f19 := llvm.ceil.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $i20 := (if $foeq.float.bool($f19, $fp(0, 0, 29055136)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  goto $bb35;
$bb37:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb38:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:24:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f21 := llvm.ceil.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(0, 0, 28705856)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb40;
$bb42:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb43:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill_fail.c:26:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f23 := llvm.ceil.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
...
$bb46:
  ...
  goto $bb45;
$bb47:
  assume {:sourceloc "test/c/mathc/ceill_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.ceil.f80 == $sub.ref(0, 6192));
