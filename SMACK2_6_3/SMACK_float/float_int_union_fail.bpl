...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/float_int_union_fail.c -bpl ./float_int_union_fail.bpl
...
const sum_to_int: ref;
axiom (sum_to_int == $sub.ref(0, 1032));
procedure {:inline 1} sum_to_int($f0: float, $f1: float)
  returns ($r: i32)
{
  var $p2: ref;
  var $f3: float;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 12, 17} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(4, $zext.i32.i64(1)));
  call {:cexpr "sum_to_int:arg:a"} boogie_si_record_float($f0);
  call {:cexpr "sum_to_int:arg:b"} boogie_si_record_float($f1);
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 12, 17} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/float_int_union_fail.c:12:17: warning: over-approximating floating-point arithmetic fadd; */
  $f3 := $fadd.float($f0, $f1);
  call {:cexpr "sum"} boogie_si_record_float($f3);
  assume true;
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.unsafe.float($M.0, $p4, $f3);
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 15, 12} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 15, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p5);
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  call $i0 := sum_to_int($fp(0, 41, 0), $fp(0, 41, 0));
  call {:cexpr "i"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 21, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/float_int_union_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
