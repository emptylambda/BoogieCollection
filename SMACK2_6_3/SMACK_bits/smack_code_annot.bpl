...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/smack_code_annot.c -bpl ./smack_code_annot.bpl
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 10, 13} true;
  ...
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 11, 51} true;
  assume {:verifier.code 1} true;
  $i2 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 11, 3} true;
  assume {:verifier.code 1} true;
  $i1 := $zext.bv16.bv32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 12, 3} true;
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 16, 13} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_int"} boogie_si_record_i32($i1);
  call {:cexpr "ret"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 17, 50} true;
  assume {:verifier.code 1} true;
  $i2 := $zext.i8.i32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 17, 3} true;
  assume {:verifier.code 1} true;
  $i1 := $zext.bv8.bv32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i16)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 22, 13} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 23, 29} true;
  assume {:verifier.code 1} true;
  $i2 := $zext.i16.i32($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 23, 34} true;
  assume {:verifier.code 1} true;
  $i3 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 23, 3} true;
  assume {:verifier.code 1} true;
  $i1 := $i0;
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i8)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 28, 12} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 29, 29} true;
  assume {:verifier.code 1} true;
  $i2 := $zext.i8.i32($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 29, 34} true;
  assume {:verifier.code 1} true;
  $i3 := $zext.i8.i32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 29, 3} true;
  assume {:verifier.code 1} true;
  $i1 := $i0;
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 34, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 35, 11} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_unsigned_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_char"} boogie_si_record_i8($i1);
  call {:cexpr "y8"} boogie_si_record_i8($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 36, 13} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 37, 13} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 38, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 38, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 39, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 40, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 41, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 41, 3} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/bits/smack_code_annot.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
