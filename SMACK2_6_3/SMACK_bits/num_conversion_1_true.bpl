...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/num_conversion_1_true.c -bpl ./num_conversion_1_true.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 8, 21} true;
  ...
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i1, $i2 := 0, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i8.i32($i2);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 15, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, 8);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 16, 45} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i8.i32($i2);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 16, 42} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/num_conversion_1_true.c:16:42: warning: over-approximating bitwise operation shl; */
  $i6 := $shl.i32(1, $i5);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 16, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i32.i8($i6);
  call {:cexpr "i"} boogie_si_record_i8($i7);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 17, 25} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i8.i32(37);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 17, 29} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i8.i32($i7);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 17, 27} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/num_conversion_1_true.c:17:27: warning: over-approximating bitwise operation and; */
  $i10 := $and.i32($i8, $i9);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 17, 25} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i32.i8($i10);
  call {:cexpr "bit"} boogie_si_record_i8($i11);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i8.i32($i11);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 18, 13} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 18, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb4:
  assume ($i13 == 1);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i8.i32($i1);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 19, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i8.i32($i7);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 19, 13} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32($i15, $i16);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 19, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $i14 := $i18;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i8.i32($i2);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i32($i19, 1);
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 21, 9} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  goto $bb9;
$bb11:
  assume {:sourceloc "test/c/bits/num_conversion_1_true.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
