...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/fdiml_fail.c -bpl ./fdiml_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 12, 19} true;
  ...
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 13, 19} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  call $i2 := __isnanl($f0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 15, 20} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 26, 8} true;
  assume {:verifier.code 0} true;
  call $i15 := __isnanl($f0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $i16 := $ne.i32($i15, 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 26, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb24, $bb26;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 15, 24} true;
  assume {:verifier.code 0} true;
  call $i4 := __isinfl($f0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 15, 24} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 16, 10} true;
  assume {:verifier.code 0} true;
  call $i6 := __isnanl($f1);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 16, 22} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb8:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 16, 26} true;
  assume {:verifier.code 0} true;
  call $i8 := __isinfl($f1);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 16, 9} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 17, 25} true;
  assume {:verifier.code 0} true;
  call $f10 := fdiml($f0, $f1);
  call {:cexpr "dim"} boogie_si_record_float($f10);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 18, 13} true;
  assume {:verifier.code 0} true;
  $i11 := (if $fogt.float.bool($f0, $f1) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 18, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  goto $bb11, $bb12;
$bb11:
  assume ($i11 == 1);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 19, 9} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !(($i11 == 1));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb13:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 19, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fdiml_fail.c:19:9: warning: over-approximating floating-point arithmetic fsub; */
  $f12 := $fsub.float($f0, $f1);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 19, 9} true;
  assume {:verifier.code 0} true;
  $i13 := (if $foeq.float.bool($f10, $f12) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 19, 9} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb15;
$bb17:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb18:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 23, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb19:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i14 := (if $folt.float.bool($f10, $fp(0, 0, 34878848)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb25;
$bb25:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 30, 8} true;
  assume {:verifier.code 0} true;
  call $i19 := __isnanl($f1);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i20 := $ne.i32($i19, 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 30, 20} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb32, $bb34;
$bb26:
  assume !(($i16 == 1));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb27:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $f17 := fdiml($f0, $fp(0, 0, 4294967344));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $i18 := (if $foeq.float.bool($f17, $fp(0, 0, 35095296)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
...
$bb30:
  ...
  goto $bb29;
$bb31:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb32:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 30, 20} true;
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb42;
$bb34:
  assume !(($i20 == 1));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 30, 25} true;
  assume {:verifier.code 0} true;
  $i21 := (if $folt.float.bool($f1, $fp(0, 0, 34774048)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 30, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb35, $bb36;
$bb35:
  assume ($i21 == 1);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  goto $bb37;
$bb36:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 30, 7} true;
...
$bb37:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  call $f22 := fdiml($fp(0, 0, 48), $f1);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i23 := (if $foeq.float.bool($f22, $fp(0, 0, 35357616)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
...
$bb40:
  ...
  goto $bb39;
$bb41:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb42:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call $f24 := fdiml($f0, $fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
...
$bb45:
  ...
  goto $bb44;
$bb46:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb47;
$bb47:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $f27 := fdiml($fp(0, 0, 48), $f1);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $i28 := __isnanl($f27);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.i32($i28, 0);
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 35, 3} true;
...
$bb50:
  ...
  goto $bb49;
$bb51:
  assume {:sourceloc "test/c/mathc/fdiml_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure {:inline 1} __isinfl($f0: float)
  returns ($r: i32);
const fdiml: ref;
axiom (fdiml == $sub.ref(0, 5160));
procedure {:inline 1} fdiml($f0: float, $f1: float)
  returns ($r: float);
