...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/init_funcs_example_fail.c -bpl ./init_funcs_example_fail.bpl
...
const __SMACK_init_func_defineProcessStates: ref;
axiom (__SMACK_init_func_defineProcessStates == $sub.ref(0, 1032));
procedure {:inline 1} __SMACK_init_func_defineProcessStates()
{
$bb0:
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 17, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 17, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 18, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 19, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 20, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 21, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 22, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 23, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const unique $process_uninitialized: int;
const unique $process_initialized: int;
const unique $process_running: int;
const unique $process_waiting: int;
const unique $process_stopped: int;
var $processStatus: [ref]int;
const __SMACK_top_decl: ref;
axiom (__SMACK_top_decl == $sub.ref(0, 2064));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_initializeProcessStates: ref;
axiom (__SMACK_init_func_initializeProcessStates == $sub.ref(0, 3096));
procedure {:inline 1} __SMACK_init_func_initializeProcessStates()
{
$bb0:
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 29, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 29, 3} true;
  assume {:verifier.code 1} true;
  assume (forall x:ref :: $processStatus[x] == $process_uninitialized);
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure {:inline 1} __SMACK_code.ref.ref($p0: ref, p.1: ref);
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 34, 15} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 35, 3} true;
  assume {:verifier.code 1} true;
  assert($processStatus[$p0] != $process_uninitialized);
  assume {:sourceloc "test/c/basic/init_funcs_example_fail.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_pointer == $sub.ref(0, 17544));
...
axiom (__VERIFIER_nondet == $sub.ref(0, 18576));
...
procedure {:inline 1} $initialize()
{
  ...
  call __SMACK_init_func_defineProcessStates();
  call __SMACK_init_func_initializeProcessStates();
