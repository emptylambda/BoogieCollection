...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/absolute_fail.c -bpl ./absolute_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/absolute_fail.c", 7, 11} true;
  ...
  call {:cexpr "v"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/bits/absolute_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/absolute_fail.c", 11, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/absolute_fail.c:11:12: warning: over-approximating bitwise operation ashr; */
  $i2 := $ashr.i32($i0, 31);
  call {:cexpr "mask"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/bits/absolute_fail.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, $i2);
  assume {:sourceloc "test/c/bits/absolute_fail.c", 13, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/absolute_fail.c:13:18: warning: over-approximating bitwise operation xor; */
  $i4 := $xor.i32($i3, $i2);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/bits/absolute_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/bits/absolute_fail.c", 14, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/bits/absolute_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
