...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock5_fail.c -bpl ./lock5_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock5_fail.c", 9, 3} true;
  ...
  assume {:sourceloc "test/c/pthread/lock5_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock($p0);
  assume {:sourceloc "test/c/pthread/lock5_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_unlock($p0);
  assume {:sourceloc "test/c/pthread/lock5_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_mutex_lock == $sub.ref(0, 3096));
procedure {:inline 1} pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 4128));
