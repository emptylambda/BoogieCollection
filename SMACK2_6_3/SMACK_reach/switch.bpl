...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/switch.c -bpl ./switch.bpl
...
$bb4:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/reach/switch.c", 11, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32(1, $sub.i32(0, 1));
  call {:cexpr "a"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/reach/switch.c", 12, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i5;
  goto $bb9;
$bb5:
...
$bb7:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/reach/switch.c", 8, 6} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32(1, 1);
  call {:cexpr "a"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/reach/switch.c", 9, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  goto $bb9;
$bb8:
  ...
  goto $bb6;
$bb9:
  assume {:sourceloc "test/c/reach/switch.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/switch.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
$bb10:
  assume {:sourceloc "test/c/reach/switch.c", 14, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32(1, 2);
  call {:cexpr "a"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/reach/switch.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i6;
  goto $bb9;
}
