...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/bitreverse_fail.c -bpl ./bitreverse_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 27864));
...
const bitreverse16: ref;
axiom (bitreverse16 == $sub.ref(0, 1032));
procedure {:inline 1} bitreverse16($i0: i16)
  returns ($r: i16)
{
  var $i1: i32;
  var $i2: i32;
  ...
  var $i96: i16;
$bb0:
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 8, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "bitreverse16:arg:x"} boogie_si_record_i16($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 8, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 8, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:8:16: warning: over-approximating bitwise operation and; */
  $i2 := $and.i32($i1, 1);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 8, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:8:26: warning: over-approximating bitwise operation shl; */
  $i3 := $shl.i32($i2, 15);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 8, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i16.i32(0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 8, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:8:10: warning: over-approximating bitwise operation or; */
  $i5 := $or.i32($i4, $i3);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 8, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i32.i16($i5);
  call {:cexpr "result"} boogie_si_record_i16($i6);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 9, 14} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 9, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:9:16: warning: over-approximating bitwise operation and; */
  $i8 := $and.i32($i7, 2);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 9, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:9:26: warning: over-approximating bitwise operation shl; */
  $i9 := $shl.i32($i8, 13);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 9, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i16.i32($i6);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 9, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:9:10: warning: over-approximating bitwise operation or; */
  $i11 := $or.i32($i10, $i9);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 9, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i32.i16($i11);
  call {:cexpr "result"} boogie_si_record_i16($i12);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 10, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 10, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:10:16: warning: over-approximating bitwise operation and; */
  $i14 := $and.i32($i13, 4);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 10, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:10:26: warning: over-approximating bitwise operation shl; */
  $i15 := $shl.i32($i14, 11);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i16.i32($i12);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 10, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:10:10: warning: over-approximating bitwise operation or; */
  $i17 := $or.i32($i16, $i15);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $i18 := $trunc.i32.i16($i17);
  call {:cexpr "result"} boogie_si_record_i16($i18);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 11, 14} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 11, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:11:16: warning: over-approximating bitwise operation and; */
  $i20 := $and.i32($i19, 8);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 11, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:11:26: warning: over-approximating bitwise operation shl; */
  $i21 := $shl.i32($i20, 9);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 11, 10} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i16.i32($i18);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 11, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:11:10: warning: over-approximating bitwise operation or; */
  $i23 := $or.i32($i22, $i21);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 11, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i32.i16($i23);
  call {:cexpr "result"} boogie_si_record_i16($i24);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 12, 14} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 12, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:12:16: warning: over-approximating bitwise operation and; */
  $i26 := $and.i32($i25, 16);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 12, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:12:26: warning: over-approximating bitwise operation shl; */
  $i27 := $shl.i32($i26, 7);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i16.i32($i24);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 12, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:12:10: warning: over-approximating bitwise operation or; */
  $i29 := $or.i32($i28, $i27);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i32.i16($i29);
  call {:cexpr "result"} boogie_si_record_i16($i30);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 13, 14} true;
  assume {:verifier.code 0} true;
  $i31 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 13, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:13:16: warning: over-approximating bitwise operation and; */
  $i32 := $and.i32($i31, 32);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 13, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:13:26: warning: over-approximating bitwise operation shl; */
  $i33 := $shl.i32($i32, 5);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i16.i32($i30);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 13, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:13:10: warning: over-approximating bitwise operation or; */
  $i35 := $or.i32($i34, $i33);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i32.i16($i35);
  call {:cexpr "result"} boogie_si_record_i16($i36);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 14, 14} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 14, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:14:16: warning: over-approximating bitwise operation and; */
  $i38 := $and.i32($i37, 64);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 14, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:14:26: warning: over-approximating bitwise operation shl; */
  $i39 := $shl.i32($i38, 3);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i16.i32($i36);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 14, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:14:10: warning: over-approximating bitwise operation or; */
  $i41 := $or.i32($i40, $i39);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i32.i16($i41);
  call {:cexpr "result"} boogie_si_record_i16($i42);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 15, 14} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 15, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:15:16: warning: over-approximating bitwise operation and; */
  $i44 := $and.i32($i43, 128);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 15, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:15:26: warning: over-approximating bitwise operation shl; */
  $i45 := $shl.i32($i44, 1);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i16.i32($i42);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:15:10: warning: over-approximating bitwise operation or; */
  $i47 := $or.i32($i46, $i45);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i48 := $trunc.i32.i16($i47);
  call {:cexpr "result"} boogie_si_record_i16($i48);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 16, 14} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 16, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:16:16: warning: over-approximating bitwise operation and; */
  $i50 := $and.i32($i49, 256);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 16, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:16:26: warning: over-approximating bitwise operation ashr; */
  $i51 := $ashr.i32($i50, 1);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $i52 := $zext.i16.i32($i48);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 16, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:16:10: warning: over-approximating bitwise operation or; */
  $i53 := $or.i32($i52, $i51);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $i54 := $trunc.i32.i16($i53);
  call {:cexpr "result"} boogie_si_record_i16($i54);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 17, 14} true;
  assume {:verifier.code 0} true;
  $i55 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 17, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:17:16: warning: over-approximating bitwise operation and; */
  $i56 := $and.i32($i55, 512);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 17, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:17:26: warning: over-approximating bitwise operation ashr; */
  $i57 := $ashr.i32($i56, 3);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 17, 10} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i16.i32($i54);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 17, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:17:10: warning: over-approximating bitwise operation or; */
  $i59 := $or.i32($i58, $i57);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 17, 10} true;
  assume {:verifier.code 0} true;
  $i60 := $trunc.i32.i16($i59);
  call {:cexpr "result"} boogie_si_record_i16($i60);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 18, 14} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 18, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:18:16: warning: over-approximating bitwise operation and; */
  $i62 := $and.i32($i61, 1024);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 18, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:18:26: warning: over-approximating bitwise operation ashr; */
  $i63 := $ashr.i32($i62, 5);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 18, 10} true;
  assume {:verifier.code 0} true;
  $i64 := $zext.i16.i32($i60);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 18, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:18:10: warning: over-approximating bitwise operation or; */
  $i65 := $or.i32($i64, $i63);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 18, 10} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i32.i16($i65);
  call {:cexpr "result"} boogie_si_record_i16($i66);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $i67 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 19, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:19:16: warning: over-approximating bitwise operation and; */
  $i68 := $and.i32($i67, 2048);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 19, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:19:26: warning: over-approximating bitwise operation ashr; */
  $i69 := $ashr.i32($i68, 7);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 19, 10} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i16.i32($i66);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 19, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:19:10: warning: over-approximating bitwise operation or; */
  $i71 := $or.i32($i70, $i69);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 19, 10} true;
  assume {:verifier.code 0} true;
  $i72 := $trunc.i32.i16($i71);
  call {:cexpr "result"} boogie_si_record_i16($i72);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 20, 14} true;
  assume {:verifier.code 0} true;
  $i73 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 20, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:20:16: warning: over-approximating bitwise operation and; */
  $i74 := $and.i32($i73, 4096);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 20, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:20:26: warning: over-approximating bitwise operation ashr; */
  $i75 := $ashr.i32($i74, 9);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i16.i32($i72);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 20, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:20:10: warning: over-approximating bitwise operation or; */
  $i77 := $or.i32($i76, $i75);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i78 := $trunc.i32.i16($i77);
  call {:cexpr "result"} boogie_si_record_i16($i78);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $i79 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 21, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:21:16: warning: over-approximating bitwise operation and; */
  $i80 := $and.i32($i79, 8192);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 21, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:21:26: warning: over-approximating bitwise operation ashr; */
  $i81 := $ashr.i32($i80, 11);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i82 := $zext.i16.i32($i78);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 21, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:21:10: warning: over-approximating bitwise operation or; */
  $i83 := $or.i32($i82, $i81);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 21, 10} true;
  assume {:verifier.code 0} true;
  $i84 := $trunc.i32.i16($i83);
  call {:cexpr "result"} boogie_si_record_i16($i84);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i85 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 22, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:22:16: warning: over-approximating bitwise operation and; */
  $i86 := $and.i32($i85, 16384);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 22, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:22:26: warning: over-approximating bitwise operation ashr; */
  $i87 := $ashr.i32($i86, 13);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i88 := $zext.i16.i32($i84);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 22, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:22:10: warning: over-approximating bitwise operation or; */
  $i89 := $or.i32($i88, $i87);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i90 := $trunc.i32.i16($i89);
  call {:cexpr "result"} boogie_si_record_i16($i90);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $i91 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 23, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:23:16: warning: over-approximating bitwise operation and; */
  $i92 := $and.i32($i91, 32768);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 23, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:23:26: warning: over-approximating bitwise operation ashr; */
  $i93 := $ashr.i32($i92, 15);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 23, 10} true;
  assume {:verifier.code 0} true;
  $i94 := $zext.i16.i32($i90);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 23, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:23:10: warning: over-approximating bitwise operation or; */
  $i95 := $or.i32($i94, $i93);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 23, 10} true;
  assume {:verifier.code 0} true;
  $i96 := $trunc.i32.i16($i95);
  call {:cexpr "result"} boogie_si_record_i16($i96);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := $i96;
  $exn := false;
  return;
}
const bitreverse32: ref;
axiom (bitreverse32 == $sub.ref(0, 2064));
procedure {:inline 1} bitreverse32($i0: i32)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i32;
  ...
  var $i55: i32;
$bb0:
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 29, 16} true;
  assume {:verifier.code 0} true;
  call {:cexpr "bitreverse32:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 29, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:29:16: warning: over-approximating bitwise operation and; */
  $i1 := $and.i32($i0, 1);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 29, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:29:24: warning: over-approximating bitwise operation shl; */
  $i2 := $shl.i32($i1, 31);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 29, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:29:10: warning: over-approximating bitwise operation or; */
  $i3 := $or.i32(0, $i2);
  call {:cexpr "result"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 30, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:30:16: warning: over-approximating bitwise operation and; */
  $i4 := $and.i32($i0, 2);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 30, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:30:24: warning: over-approximating bitwise operation shl; */
  $i5 := $shl.i32($i4, 29);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 30, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:30:10: warning: over-approximating bitwise operation or; */
  $i6 := $or.i32($i3, $i5);
  call {:cexpr "result"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 31, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:31:16: warning: over-approximating bitwise operation and; */
  $i7 := $and.i32($i0, 4);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 31, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:31:24: warning: over-approximating bitwise operation shl; */
  $i8 := $shl.i32($i7, 27);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 31, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:31:10: warning: over-approximating bitwise operation or; */
  $i9 := $or.i32($i6, $i8);
  call {:cexpr "result"} boogie_si_record_i32($i9);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 32, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:32:16: warning: over-approximating bitwise operation and; */
  $i10 := $and.i32($i0, 8);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 32, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:32:24: warning: over-approximating bitwise operation shl; */
  $i11 := $shl.i32($i10, 25);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 32, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:32:10: warning: over-approximating bitwise operation or; */
  $i12 := $or.i32($i9, $i11);
  call {:cexpr "result"} boogie_si_record_i32($i12);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 33, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:33:16: warning: over-approximating bitwise operation and; */
  $i13 := $and.i32($i0, 16);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 33, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:33:24: warning: over-approximating bitwise operation shl; */
  $i14 := $shl.i32($i13, 23);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 33, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:33:10: warning: over-approximating bitwise operation or; */
  $i15 := $or.i32($i12, $i14);
  call {:cexpr "result"} boogie_si_record_i32($i15);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 34, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:34:16: warning: over-approximating bitwise operation and; */
  $i16 := $and.i32($i0, 32);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 34, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:34:24: warning: over-approximating bitwise operation shl; */
  $i17 := $shl.i32($i16, 21);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 34, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:34:10: warning: over-approximating bitwise operation or; */
  $i18 := $or.i32($i15, $i17);
  call {:cexpr "result"} boogie_si_record_i32($i18);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 35, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:35:16: warning: over-approximating bitwise operation and; */
  $i19 := $and.i32($i0, 64);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 35, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:35:24: warning: over-approximating bitwise operation shl; */
  $i20 := $shl.i32($i19, 19);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 35, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:35:10: warning: over-approximating bitwise operation or; */
  $i21 := $or.i32($i18, $i20);
  call {:cexpr "result"} boogie_si_record_i32($i21);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 36, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:36:16: warning: over-approximating bitwise operation and; */
  $i22 := $and.i32($i0, 128);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 36, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:36:24: warning: over-approximating bitwise operation shl; */
  $i23 := $shl.i32($i22, 17);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 36, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:36:10: warning: over-approximating bitwise operation or; */
  $i24 := $or.i32($i21, $i23);
  call {:cexpr "result"} boogie_si_record_i32($i24);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 37, 29} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:37:29: warning: over-approximating bitwise operation lshr; */
  $i25 := $lshr.i32($i0, 8);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 37, 35} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:37:35: warning: over-approximating bitwise operation and; */
  $i26 := $and.i32($i25, 65535);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 37, 26} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i32.i16($i26);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 37, 13} true;
  assume {:verifier.code 0} true;
  call $i28 := bitreverse16($i27);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 37, 13} true;
  assume {:verifier.code 0} true;
  $i29 := $zext.i16.i32($i28);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 37, 45} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:37:45: warning: over-approximating bitwise operation shl; */
  $i30 := $shl.i32($i29, 8);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 37, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:37:10: warning: over-approximating bitwise operation or; */
  $i31 := $or.i32($i24, $i30);
  call {:cexpr "result"} boogie_si_record_i32($i31);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 38, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:38:16: warning: over-approximating bitwise operation and; */
  $i32 := $and.i32($i0, 16777216);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 38, 30} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:38:30: warning: over-approximating bitwise operation lshr; */
  $i33 := $lshr.i32($i32, 17);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 38, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:38:10: warning: over-approximating bitwise operation or; */
  $i34 := $or.i32($i31, $i33);
  call {:cexpr "result"} boogie_si_record_i32($i34);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 39, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:39:16: warning: over-approximating bitwise operation and; */
  $i35 := $and.i32($i0, 33554432);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 39, 30} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:39:30: warning: over-approximating bitwise operation lshr; */
  $i36 := $lshr.i32($i35, 19);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 39, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:39:10: warning: over-approximating bitwise operation or; */
  $i37 := $or.i32($i34, $i36);
  call {:cexpr "result"} boogie_si_record_i32($i37);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 40, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:40:16: warning: over-approximating bitwise operation and; */
  $i38 := $and.i32($i0, 67108864);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 40, 30} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:40:30: warning: over-approximating bitwise operation lshr; */
  $i39 := $lshr.i32($i38, 21);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 40, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:40:10: warning: over-approximating bitwise operation or; */
  $i40 := $or.i32($i37, $i39);
  call {:cexpr "result"} boogie_si_record_i32($i40);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 41, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:41:16: warning: over-approximating bitwise operation and; */
  $i41 := $and.i32($i0, 134217728);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 41, 30} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:41:30: warning: over-approximating bitwise operation lshr; */
  $i42 := $lshr.i32($i41, 23);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 41, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:41:10: warning: over-approximating bitwise operation or; */
  $i43 := $or.i32($i40, $i42);
  call {:cexpr "result"} boogie_si_record_i32($i43);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 42, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:42:16: warning: over-approximating bitwise operation and; */
  $i44 := $and.i32($i0, 268435456);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 42, 30} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:42:30: warning: over-approximating bitwise operation lshr; */
  $i45 := $lshr.i32($i44, 25);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 42, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:42:10: warning: over-approximating bitwise operation or; */
  $i46 := $or.i32($i43, $i45);
  call {:cexpr "result"} boogie_si_record_i32($i46);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 43, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:43:16: warning: over-approximating bitwise operation and; */
  $i47 := $and.i32($i0, 536870912);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 43, 30} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:43:30: warning: over-approximating bitwise operation lshr; */
  $i48 := $lshr.i32($i47, 27);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 43, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:43:10: warning: over-approximating bitwise operation or; */
  $i49 := $or.i32($i46, $i48);
  call {:cexpr "result"} boogie_si_record_i32($i49);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 44, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:44:16: warning: over-approximating bitwise operation and; */
  $i50 := $and.i32($i0, 1073741824);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 44, 30} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:44:30: warning: over-approximating bitwise operation lshr; */
  $i51 := $lshr.i32($i50, 29);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 44, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:44:10: warning: over-approximating bitwise operation or; */
  $i52 := $or.i32($i49, $i51);
  call {:cexpr "result"} boogie_si_record_i32($i52);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 45, 16} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:45:16: warning: over-approximating bitwise operation and; */
  $i53 := $and.i32($i0, 2147483648);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 45, 30} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:45:30: warning: over-approximating bitwise operation lshr; */
  $i54 := $lshr.i32($i53, 31);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 45, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:45:10: warning: over-approximating bitwise operation or; */
  $i55 := $or.i32($i52, $i54);
  call {:cexpr "result"} boogie_si_record_i32($i55);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 46, 3} true;
  assume {:verifier.code 0} true;
  $r := $i55;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 50, 16} true;
  ...
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 51, 16} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:52:3: warning: over-approximating call to llvm.bitreverse.i16; */
  call $i2 := llvm.bitreverse.i16($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i16.i32($i2);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := bitreverse16($i0);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i16.i32($i4);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
...
$bb4:
  ...
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bitreverse_fail.c:52:3: warning: over-approximating call to llvm.bitreverse.i32; */
  call $i7 := llvm.bitreverse.i32($i1);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := bitreverse32($i1);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i7, $i8);
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 52, 3} true;
...
$bb6:
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "test/c/bits/bitreverse_fail.c", 54, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const llvm.bitreverse.i16: ref;
axiom (llvm.bitreverse.i16 == $sub.ref(0, 4128));
procedure {:inline 1} llvm.bitreverse.i16($i0: i16)
  returns ($r: i16);
const llvm.bitreverse.i32: ref;
axiom (llvm.bitreverse.i32 == $sub.ref(0, 5160));
procedure {:inline 1} llvm.bitreverse.i32($i0: i32)
  returns ($r: i32);
...
axiom (__VERIFIER_assert == $sub.ref(0, 9288));
...
axiom (__VERIFIER_nondet_unsigned_short == $sub.ref(0, 19608));
...
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 20640));
procedure {:inline 1} __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 21672));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 22704));
procedure {:inline 1} __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 23736));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 24768));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 25800));
...
axiom (llvm.dbg.value == $sub.ref(0, 26832));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 27864));
