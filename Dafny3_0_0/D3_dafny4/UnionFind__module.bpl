...
implementation Impl$$_module.__default._default_Main() returns ($_reverifyPost: bool)
{
  ...
  var uf#0: ref
     where $Is(uf#0, Tclass.M3.UnionFind()) && $IsAlloc(uf#0, Tclass.M3.UnionFind(), $Heap);
  var $nw: ref;
  var a#0: ref
     where $Is(a#0, Tclass.M3.Element()) && $IsAlloc(a#0, Tclass.M3.Element(), $Heap);
  var $rhs##0: ref
     where $Is($rhs##0, Tclass.M3.Element())
       && $IsAlloc($rhs##0, Tclass.M3.Element(), $Heap);
  var b#0: ref
     where $Is(b#0, Tclass.M3.Element()) && $IsAlloc(b#0, Tclass.M3.Element(), $Heap);
  var $rhs##1: ref
     where $Is($rhs##1, Tclass.M3.Element())
       && $IsAlloc($rhs##1, Tclass.M3.Element(), $Heap);
  var c#0: ref
     where $Is(c#0, Tclass.M3.Element()) && $IsAlloc(c#0, Tclass.M3.Element(), $Heap);
  var $rhs##2: ref
     where $Is($rhs##2, Tclass.M3.Element())
       && $IsAlloc($rhs##2, Tclass.M3.Element(), $Heap);
  var f0#0: ref
     where $Is(f0#0, Tclass.M3.Element()) && $IsAlloc(f0#0, Tclass.M3.Element(), $Heap);
  var $rhs##3: ref
     where $Is($rhs##3, Tclass.M3.Element())
       && $IsAlloc($rhs##3, Tclass.M3.Element(), $Heap);
  var e##0: ref;
  var f1#0: ref
     where $Is(f1#0, Tclass.M3.Element()) && $IsAlloc(f1#0, Tclass.M3.Element(), $Heap);
  var $rhs##4: ref
     where $Is($rhs##4, Tclass.M3.Element())
       && $IsAlloc($rhs##4, Tclass.M3.Element(), $Heap);
  var e##1: ref;
  var _v5#0: ref
     where $Is(_v5#0, Tclass.M3.Element()) && $IsAlloc(_v5#0, Tclass.M3.Element(), $Heap);
  var $rhs##5: ref
     where $Is($rhs##5, Tclass.M3.Element())
       && $IsAlloc($rhs##5, Tclass.M3.Element(), $Heap);
  var e0##0: ref;
  var e1##0: ref;
  var g0#0: ref
     where $Is(g0#0, Tclass.M3.Element()) && $IsAlloc(g0#0, Tclass.M3.Element(), $Heap);
  var $rhs##6: ref
     where $Is($rhs##6, Tclass.M3.Element())
       && $IsAlloc($rhs##6, Tclass.M3.Element(), $Heap);
  var e##2: ref;
  var g1#0: ref
     where $Is(g1#0, Tclass.M3.Element()) && $IsAlloc(g1#0, Tclass.M3.Element(), $Heap);
  var $rhs##7: ref
     where $Is($rhs##7, Tclass.M3.Element())
       && $IsAlloc($rhs##7, Tclass.M3.Element(), $Heap);
  var e##3: ref;
  var g2#0: ref
     where $Is(g2#0, Tclass.M3.Element()) && $IsAlloc(g2#0, Tclass.M3.Element(), $Heap);
  var $rhs##8: ref
     where $Is($rhs##8, Tclass.M3.Element())
       && $IsAlloc($rhs##8, Tclass.M3.Element(), $Heap);
  var e##4: ref;

    // AddMethodImpl: Main, Impl$$_module.__default._default_Main
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(339,14): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(340,10)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(340,13)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$M3.UnionFind.__ctor();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(340,30)"} true;
    uf#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(340,30)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(341,18)
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
           && read($Heap, $o, alloc)
           && read($Heap, uf#0, M3.UnionFind.Repr)[$Box($o)]
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##0 := Call$$M3.UnionFind.New(uf#0);
    // TrCallStmt: After ProcessCallStmt
    a#0 := $rhs##0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(341,19)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(342,18)
    assume true;
    // TrCallStmt: Adding lhs with type Element
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##1 := Call$$M3.UnionFind.New(uf#0);
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##1;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(342,19)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(343,18)
    assume true;
    // TrCallStmt: Adding lhs with type Element
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##2 := Call$$M3.UnionFind.New(uf#0);
    // TrCallStmt: After ProcessCallStmt
    c#0 := $rhs##2;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(343,19)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(344,3)
    assume true;
    assume true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(346,20)
    assume true;
    // TrCallStmt: Adding lhs with type Element
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##3 := Call$$M3.UnionFind.Find(uf#0, e##0);
    // TrCallStmt: After ProcessCallStmt
    f0#0 := $rhs##3;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(346,22)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(347,20)
    assume true;
    // TrCallStmt: Adding lhs with type Element
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##4 := Call$$M3.UnionFind.Find(uf#0, e##1);
    // TrCallStmt: After ProcessCallStmt
    f1#0 := $rhs##4;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(347,22)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(348,3)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(350,20)
    assume true;
    // TrCallStmt: Adding lhs with type Element
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##5 := Call$$M3.UnionFind.Union(uf#0, e0##0, e1##0);
    // TrCallStmt: After ProcessCallStmt
    _v5#0 := $rhs##5;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(350,25)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(351,20)
    assume true;
    // TrCallStmt: Adding lhs with type Element
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##6 := Call$$M3.UnionFind.Find(uf#0, e##2);
    // TrCallStmt: After ProcessCallStmt
    g0#0 := $rhs##6;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(351,22)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(352,20)
    assume true;
    // TrCallStmt: Adding lhs with type Element
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##7 := Call$$M3.UnionFind.Find(uf#0, e##3);
    // TrCallStmt: After ProcessCallStmt
    g1#0 := $rhs##7;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(352,22)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(353,20)
    assume true;
    // TrCallStmt: Adding lhs with type Element
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##8 := Call$$M3.UnionFind.Find(uf#0, e##4);
    // TrCallStmt: After ProcessCallStmt
    g2#0 := $rhs##8;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(353,22)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/UnionFind.dfy(354,3)
    assume true;
    assume true;
    assume true;
    assume true;
...
axiom (forall $o: ref, $h: Heap :: 
  ...
  $IsAlloc($o, Tclass.M0.Element?(), $h) <==> $o == null || read($h, $o, alloc));
...
// M0.Element: subset type $Is
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass.M0.Element()) } 
  $Is(c#0, Tclass.M0.Element()) <==> $Is(c#0, Tclass.M0.Element?()) && c#0 != null);

// M0.Element: subset type $IsAlloc
axiom (forall c#0: ref, $h: Heap :: 
...
axiom (forall $o: ref, $h: Heap :: 
  ...
  $IsAlloc($o, Tclass.M0.UnionFind?(), $h) <==> $o == null || read($h, $o, alloc));

axiom FDim(M0.UnionFind.M) == 0
   && FieldOfDecl(class.M0.UnionFind?, field$M) == M0.UnionFind.M
   && $IsGhostField(M0.UnionFind.M);

const M0.UnionFind.M: Field (Map Box Box);

// UnionFind.M: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, M0.UnionFind.M) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.M0.UnionFind?()
     ==> $Is(read($h, $o, M0.UnionFind.M), TMap(Tclass.M0.Element(), Tclass.M0.Element())));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       ...
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, M0.UnionFind.M), TMap(Tclass.M0.Element(), Tclass.M0.Element()), $h));
...
axiom (forall $h0: Heap, $h1: Heap, this: ref :: 
  ...
  $IsGoodHeap($h0)
     ...
     ==> 
    (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null && ($o == this || read($h0, this, M0.UnionFind.Repr)[$Box($o)])
...
axiom true
   ==> (forall $Heap: Heap, this: ref :: 
    ...
    M0.UnionFind.Valid#canCall($Heap, this)
       ...
       ==> 
      M0.UnionFind.Valid($Heap, this)
       ==> read($Heap, this, M0.UnionFind.Repr)[$Box(this)]);
...
axiom true
   ==> (forall $Heap: Heap, this: ref :: 
    ...
    M0.UnionFind.Valid#canCall($Heap, this)
       ...
       ==> (read($Heap, this, M0.UnionFind.Repr)[$Box(this)]
           ==> 
          !read($Heap, this, M0.UnionFind.Repr)[$Box(null)]
    ...
    M0.UnionFind.ValidM1#canCall($Heap, this)
         || ($IsGoodHeap($Heap)
          ...
          $Is(this, Tclass.M0.UnionFind())
           && $IsAlloc(this, Tclass.M0.UnionFind(), $Heap))
       ==> 
      Map#Equal(read($Heap, this, M0.UnionFind.M), Map#Empty(): Map Box Box)
       ==> M0.UnionFind.ValidM1($Heap, this));
...
const M0.UnionFind.Repr: Field (Set Box);

// UnionFind.Repr: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, M0.UnionFind.Repr) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.M0.UnionFind?()
     ==> $Is(read($h, $o, M0.UnionFind.Repr), TSet(Tclass._System.object?())));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass.M0.UnionFind?()
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, M0.UnionFind.Repr), TSet(Tclass._System.object?()), $h));

// M0.UnionFind: subset type $Is
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass.M0.UnionFind()) } 
  $Is(c#0, Tclass.M0.UnionFind())
     <==> $Is(c#0, Tclass.M0.UnionFind?()) && c#0 != null);

// M0.UnionFind: subset type $IsAlloc
axiom (forall c#0: ref, $h: Heap :: 
...
axiom (forall a#3#0#0: int, $h: Heap :: 
  { $IsAlloc(#M1.Contents.Root(a#3#0#0), Tclass.M1.Contents(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#M1.Contents.Root(a#3#0#0), Tclass.M1.Contents(), $h)
...
axiom (forall a#4#0#0: int :: 
  { #M1.Contents.Root(LitInt(a#4#0#0)) } 
  #M1.Contents.Root(LitInt(a#4#0#0)) == Lit(#M1.Contents.Root(a#4#0#0)));

function M1.Contents.depth(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#5#0#0: int :: 
  { #M1.Contents.Root(a#5#0#0) } 
  M1.Contents.depth(#M1.Contents.Root(a#5#0#0)) == a#5#0#0);
...
axiom (forall a#6#0#0: ref :: 
  { #M1.Contents.Link(a#6#0#0) } 
  DatatypeCtorId(#M1.Contents.Link(a#6#0#0)) == ##M1.Contents.Link);
...
axiom (forall d: DatatypeType :: 
  { M1.Contents.Link_q(d) } 
  M1.Contents.Link_q(d)
     ==> (exists a#7#0#0: ref :: d == #M1.Contents.Link(a#7#0#0)));
...
axiom (forall a#8#0#0: ref :: 
  { $Is(#M1.Contents.Link(a#8#0#0), Tclass.M1.Contents()) } 
  $Is(#M1.Contents.Link(a#8#0#0), Tclass.M1.Contents())
     <==> $Is(a#8#0#0, Tclass.M1.Element()));

// Constructor $IsAlloc
axiom (forall a#9#0#0: ref, $h: Heap :: 
  { $IsAlloc(#M1.Contents.Link(a#9#0#0), Tclass.M1.Contents(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#M1.Contents.Link(a#9#0#0), Tclass.M1.Contents(), $h)
       <==> $IsAlloc(a#9#0#0, Tclass.M1.Element(), $h)));
...
axiom (forall a#10#0#0: ref :: 
  { #M1.Contents.Link(Lit(a#10#0#0)) } 
  #M1.Contents.Link(Lit(a#10#0#0)) == Lit(#M1.Contents.Link(a#10#0#0)));

function M1.Contents.next(DatatypeType) : ref;

// Constructor injectivity
axiom (forall a#11#0#0: ref :: 
  { #M1.Contents.Link(a#11#0#0) } 
  M1.Contents.next(#M1.Contents.Link(a#11#0#0)) == a#11#0#0);
   ...
   ==> (forall $Heap: Heap, this: ref :: 
    ...
    M1.UnionFind.ValidM1#canCall($Heap, this)
       ...
       ==> (Set#Subset(Map#Domain(read($Heap, this, M1.UnionFind.M)), 
           ...
           ==> 
          (forall e#10: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M1.UnionFind.M))[$Box(e#10)]): ref } 
            $Is(e#10, Tclass.M1.Element?())
               ==> 
              Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(e#10)]
               ==> Map#Domain(read($Heap, this, M1.UnionFind.M))[Map#Elements(read($Heap, this, M1.UnionFind.M))[$Box(e#10)]])
           ==> 
          (forall e#11: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M1.UnionFind.M))[Map#Elements(read($Heap, this, M1.UnionFind.M))[$Box(e#11)]]): ref } 
              { Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(e#11)] } 
            $Is(e#11, Tclass.M1.Element?())
               ==> 
              Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(e#11)]
               ==> $Unbox(Map#Elements(read($Heap, this, M1.UnionFind.M))[Map#Elements(read($Heap, this, M1.UnionFind.M))[$Box(e#11)]]): ref
                 == $Unbox(Map#Elements(read($Heap, this, M1.UnionFind.M))[$Box(e#11)]): ref)
           ==> 
          (forall e#12: ref :: 
            { read($Heap, e#12, M1.Element.c) } 
            $Is(e#12, Tclass.M1.Element())
               ==> 
              Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(e#12)]
                 && M1.Contents.Link_q(read($Heap, e#12, M1.Element.c))
               ==> Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(M1.Contents.next(read($Heap, e#12, M1.Element.c)))])
           ==> (forall e#13: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M1.UnionFind.M))[$Box(e#13)]): ref } 
              { Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(e#13)] } 
    ...
    M1.UnionFind.Collect#canCall($Heap, this)
         || (
          ...
          $Is(this, Tclass.M1.UnionFind())
           && $IsAlloc(this, Tclass.M1.UnionFind(), $Heap)
           && (forall f#6: ref :: 
            { read($Heap, f#6, M1.Element.c) } 
            $Is(f#6, Tclass.M1.Element())
               ==> 
              Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(f#6)]
                 && M1.Contents.Link_q(read($Heap, f#6, M1.Element.c))
               ==> Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(M1.Contents.next(read($Heap, f#6, M1.Element.c)))]))
...
axiom (forall $Heap: Heap, this: ref :: 
  ...
  $IsGoodHeap($Heap)
     ...
     ==> M1.UnionFind.Collect#requires($Heap, this)
       == (forall f#7: ref :: 
        { read($Heap, f#7, M1.Element.c) } 
        $Is(f#7, Tclass.M1.Element())
           ==> 
          Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(f#7)]
             && M1.Contents.Link_q(read($Heap, f#7, M1.Element.c))
           ==> Map#Domain(read($Heap, this, M1.UnionFind.M))[$Box(M1.Contents.next(read($Heap, f#7, M1.Element.c)))]));
       ...
       ==> M1.UnionFind.Collect($Heap, this)
         == Map#Glue((lambda $w#2: Box :: 
            $Is($Unbox($w#2): ref, Tclass.M1.Element())
               && Map#Domain(read($Heap, this, M1.UnionFind.M))[$w#2]), 
          (lambda $w#2: Box :: $Box(read($Heap, $Unbox($w#2): ref, M1.Element.c))), 
          TMap(Tclass.M1.Element(), Tclass.M1.Contents())));
         ...
         == (forall f#5: ref :: 
          ...
          $Is(f#5, Tclass.M1.Element?())
            ...
            Map#Domain(C#0)[$Box(f#5)]
             ...
             ==> Map#Domain(C#0)[$Box(M1.Contents.next($Unbox(Map#Elements(Lit(C#0))[$Box(f#5)]): DatatypeType))]));
   ...
   ==> (forall $Heap: Heap, this: ref :: 
    ...
    M2.UnionFind.ValidM1#canCall($Heap, this)
       ...
       ==> (Set#Subset(Map#Domain(read($Heap, this, M2.UnionFind.M)), 
           ...
           ==> 
          (forall e#10: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M2.UnionFind.M))[$Box(e#10)]): ref } 
            $Is(e#10, Tclass.M2.Element?())
               ==> 
              Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(e#10)]
               ==> Map#Domain(read($Heap, this, M2.UnionFind.M))[Map#Elements(read($Heap, this, M2.UnionFind.M))[$Box(e#10)]])
           ==> 
          (forall e#11: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M2.UnionFind.M))[Map#Elements(read($Heap, this, M2.UnionFind.M))[$Box(e#11)]]): ref } 
              { Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(e#11)] } 
            $Is(e#11, Tclass.M2.Element?())
               ==> 
              Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(e#11)]
               ==> $Unbox(Map#Elements(read($Heap, this, M2.UnionFind.M))[Map#Elements(read($Heap, this, M2.UnionFind.M))[$Box(e#11)]]): ref
                 == $Unbox(Map#Elements(read($Heap, this, M2.UnionFind.M))[$Box(e#11)]): ref)
           ==> 
          (forall e#12: ref :: 
            { read($Heap, e#12, M2.Element.c) } 
            $Is(e#12, Tclass.M2.Element())
               ==> 
              Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(e#12)]
                 && M2.Contents.Link_q(read($Heap, e#12, M2.Element.c))
               ==> Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(M2.Contents.next(read($Heap, e#12, M2.Element.c)))])
           ==> (forall e#13: ref :: 
    ...
    M2.UnionFind.Collect#canCall($Heap, this)
         || (
          ...
          $Is(this, Tclass.M2.UnionFind())
           && $IsAlloc(this, Tclass.M2.UnionFind(), $Heap)
           && (forall f#6: ref :: 
            { read($Heap, f#6, M2.Element.c) } 
            $Is(f#6, Tclass.M2.Element())
               ==> 
              Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(f#6)]
                 && M2.Contents.Link_q(read($Heap, f#6, M2.Element.c))
               ==> Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(M2.Contents.next(read($Heap, f#6, M2.Element.c)))]))
...
axiom (forall $Heap: Heap, this: ref :: 
  ...
  $IsGoodHeap($Heap)
     ...
     ==> M2.UnionFind.Collect#requires($Heap, this)
       == (forall f#7: ref :: 
        { read($Heap, f#7, M2.Element.c) } 
        $Is(f#7, Tclass.M2.Element())
           ==> 
          Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(f#7)]
             && M2.Contents.Link_q(read($Heap, f#7, M2.Element.c))
           ==> Map#Domain(read($Heap, this, M2.UnionFind.M))[$Box(M2.Contents.next(read($Heap, f#7, M2.Element.c)))]));
       ...
       ==> M2.UnionFind.Collect($Heap, this)
         == Map#Glue((lambda $w#2: Box :: 
            $Is($Unbox($w#2): ref, Tclass.M2.Element())
               && Map#Domain(read($Heap, this, M2.UnionFind.M))[$w#2]), 
          (lambda $w#2: Box :: $Box(read($Heap, $Unbox($w#2): ref, M2.Element.c))), 
          TMap(Tclass.M2.Element(), Tclass.M2.Contents())));
         ...
         == (forall f#5: ref :: 
          ...
          $Is(f#5, Tclass.M2.Element?())
            ...
            Map#Domain(C#0)[$Box(f#5)]
             ...
             ==> Map#Domain(C#0)[$Box(M2.Contents.next($Unbox(Map#Elements(Lit(C#0))[$Box(f#5)]): DatatypeType))]));
           ...
           || (forall e#17: ref :: 
            ...
            $Is(e#17, Tclass.M3.Element?())
              ...
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#17)]
               ==> Map#Domain(read($Heap, this, M3.UnionFind.M))[Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#17)]]));
  requires M3.UnionFind.Valid#canCall($Heap, this)
     ==> M3.UnionFind.Valid($Heap, this)
       || (M3.UnionFind.ValidM1#canCall($Heap, this)
         ==> M3.UnionFind.ValidM1($Heap, this)
           || (forall e#18: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#18)]]): ref } 
  ...
  requires M3.UnionFind.Valid#canCall($Heap, this)
     ==> M3.UnionFind.Valid($Heap, this)
       || (M3.UnionFind.ValidM1#canCall($Heap, this)
         ==> M3.UnionFind.ValidM1($Heap, this)
           || (forall e#19: ref :: 
            { read($Heap, e#19, M3.Element.c) } 
            $Is(e#19, Tclass.M3.Element())
               ==> 
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#19)]
                 && M3.Contents.Link_q(read($Heap, e#19, M3.Element.c))
               ==> Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(M3.Contents.next(read($Heap, e#19, M3.Element.c)))]));
  requires M3.UnionFind.Valid#canCall($Heap, this)
     ==> M3.UnionFind.Valid($Heap, this)
       || (M3.UnionFind.ValidM1#canCall($Heap, this)
         ==> M3.UnionFind.ValidM1($Heap, this)
           || (forall e#20: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#20)]): ref } 
              { Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#20)] } 
   ...
   ==> (forall $Heap: Heap, this: ref :: 
    ...
    M3.UnionFind.ValidM1#canCall($Heap, this)
       ...
       ==> (Set#Subset(Map#Domain(read($Heap, this, M3.UnionFind.M)), 
           ...
           ==> 
          (forall e#10: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#10)]): ref } 
            $Is(e#10, Tclass.M3.Element?())
               ==> 
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#10)]
               ==> Map#Domain(read($Heap, this, M3.UnionFind.M))[Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#10)]])
           ==> 
          (forall e#11: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#11)]]): ref } 
              { Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#11)] } 
            $Is(e#11, Tclass.M3.Element?())
               ==> 
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#11)]
               ==> $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#11)]]): ref
                 == $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#11)]): ref)
           ==> 
          (forall e#12: ref :: 
            { read($Heap, e#12, M3.Element.c) } 
            $Is(e#12, Tclass.M3.Element())
               ==> 
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#12)]
                 && M3.Contents.Link_q(read($Heap, e#12, M3.Element.c))
               ==> Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(M3.Contents.next(read($Heap, e#12, M3.Element.c)))])
           ==> (forall e#13: ref :: 
    ...
    M3.UnionFind.Collect#canCall($Heap, this)
         || (
          ...
          $Is(this, Tclass.M3.UnionFind())
           && $IsAlloc(this, Tclass.M3.UnionFind(), $Heap)
           && (forall f#6: ref :: 
            { read($Heap, f#6, M3.Element.c) } 
            $Is(f#6, Tclass.M3.Element())
               ==> 
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(f#6)]
                 && M3.Contents.Link_q(read($Heap, f#6, M3.Element.c))
               ==> Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(M3.Contents.next(read($Heap, f#6, M3.Element.c)))]))
...
axiom (forall $Heap: Heap, this: ref :: 
  ...
  $IsGoodHeap($Heap)
     ...
     ==> M3.UnionFind.Collect#requires($Heap, this)
       == (forall f#7: ref :: 
        { read($Heap, f#7, M3.Element.c) } 
        $Is(f#7, Tclass.M3.Element())
           ==> 
          Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(f#7)]
             && M3.Contents.Link_q(read($Heap, f#7, M3.Element.c))
           ==> Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(M3.Contents.next(read($Heap, f#7, M3.Element.c)))]));
       ...
       ==> M3.UnionFind.Collect($Heap, this)
         == Map#Glue((lambda $w#2: Box :: 
            $Is($Unbox($w#2): ref, Tclass.M3.Element())
               && Map#Domain(read($Heap, this, M3.UnionFind.M))[$w#2]), 
          (lambda $w#2: Box :: $Box(read($Heap, $Unbox($w#2): ref, M3.Element.c))), 
          TMap(Tclass.M3.Element(), Tclass.M3.Contents())));
         ...
         ==> M3.UnionFind.ValidM1($Heap, this)
           || (forall e#18: ref :: 
            ...
            $Is(e#18, Tclass.M3.Element?())
               ==> 
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#18)]
               ==> Map#Domain(read($Heap, this, M3.UnionFind.M))[Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#18)]]));
  requires M3.UnionFind.Valid#canCall($Heap, this)
     ==> M3.UnionFind.Valid($Heap, this)
       || (M3.UnionFind.ValidM1#canCall($Heap, this)
         ==> M3.UnionFind.ValidM1($Heap, this)
           || (forall e#19: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#19)]]): ref } 
              { Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#19)] } 
            $Is(e#19, Tclass.M3.Element?())
               ==> 
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#19)]
               ==> $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#19)]]): ref
                 == $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#19)]): ref));
  requires M3.UnionFind.Valid#canCall($Heap, this)
     ==> M3.UnionFind.Valid($Heap, this)
       || (M3.UnionFind.ValidM1#canCall($Heap, this)
         ==> M3.UnionFind.ValidM1($Heap, this)
           || (forall e#20: ref :: 
            { read($Heap, e#20, M3.Element.c) } 
            $Is(e#20, Tclass.M3.Element())
               ==> 
              Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#20)]
                 && M3.Contents.Link_q(read($Heap, e#20, M3.Element.c))
               ==> Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(M3.Contents.next(read($Heap, e#20, M3.Element.c)))]));
  requires M3.UnionFind.Valid#canCall($Heap, this)
     ==> M3.UnionFind.Valid($Heap, this)
       || (M3.UnionFind.ValidM1#canCall($Heap, this)
         ==> M3.UnionFind.ValidM1($Heap, this)
           || (forall e#21: ref :: 
            { $Unbox(Map#Elements(read($Heap, this, M3.UnionFind.M))[$Box(e#21)]): ref } 
              { Map#Domain(read($Heap, this, M3.UnionFind.M))[$Box(e#21)] } 
  ...
  ensures Map#Equal(read($Heap, this, M3.UnionFind.M), 
    Map#Glue((lambda $w#3: Box :: 
        $Is($Unbox($w#3): ref, Tclass.M3.Element?())
           && Map#Domain(read(old($Heap), this, M3.UnionFind.M))[$w#3]), 
      (lambda $w#3: Box :: 
        $Box((if $Unbox(Map#Elements(read(old($Heap), this, M3.UnionFind.M))[$w#3]): ref
                 == $Unbox(Map#Elements(read(old($Heap), this, M3.UnionFind.M))[$Box(e0#0)]): ref
               || $Unbox(Map#Elements(read(old($Heap), this, M3.UnionFind.M))[$w#3]): ref
                 == $Unbox(Map#Elements(read(old($Heap), this, M3.UnionFind.M))[$Box(e1#0)]): ref
             then r#0
             else $Unbox(Map#Elements(read(old($Heap), this, M3.UnionFind.M))[$w#3]): ref))), 
         ...
         == (forall f#5: ref :: 
          ...
          $Is(f#5, Tclass.M3.Element?())
            ...
            Map#Domain(C#0)[$Box(f#5)]
             ...
             ==> Map#Domain(C#0)[$Box(M3.Contents.next($Unbox(Map#Elements(Lit(C#0))[$Box(f#5)]): DatatypeType))]));
