...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/contracts/invariant.c -bpl ./invariant.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/contracts/invariant.c", 12, 8} true;
...
$bb1:
  ...
  assume {:sourceloc "test/c/contracts/invariant.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/invariant.c", 12, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 4);
  assume {:sourceloc "test/c/contracts/invariant.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/contracts/invariant.c", 13, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/invariant.c", 13, 5} true;
...
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/contracts/invariant.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/contracts/invariant.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i0);
  assume {:sourceloc "test/c/contracts/invariant.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(g, $mul.ref(0, 40)), $mul.ref($i3, 4));
  assume {:sourceloc "test/c/contracts/invariant.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, $i0);
  assume {:sourceloc "test/c/contracts/invariant.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/contracts/invariant.c", 12, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i0, 1);
