...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/func_ptr_alias_fail.c -bpl ./func_ptr_alias_fail.bpl
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_alias_fail.c", 5, 30} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__incr:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/data/func_ptr_alias_fail.c", 5, 30} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 2);
  assume {:sourceloc "test/c/data/func_ptr_alias_fail.c", 5, 21} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/func_ptr_alias_fail.c", 14, 11} true;
  ...
  assume {:sourceloc "test/c/data/func_ptr_alias_fail.c", 16, 7} true;
  assume {:verifier.code 0} true;
  call $i1 := __incr($i0);
  call {:cexpr "x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/data/func_ptr_alias_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/func_ptr_alias_fail.c", 17, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/func_ptr_alias_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
