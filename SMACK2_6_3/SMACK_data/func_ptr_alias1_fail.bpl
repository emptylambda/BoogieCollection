...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/func_ptr_alias1_fail.c -bpl ./func_ptr_alias1_fail.bpl
...
const __incr: ref;
axiom (__incr == $sub.ref(0, 1032));
procedure {:inline 1} __incr($i0: i32)
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 5, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__incr:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 5, 28} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  call {:cexpr "x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 5, 21} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
const __decr: ref;
axiom (__decr == $sub.ref(0, 2064));
procedure {:inline 1} __decr($i0: i32)
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 7, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__decr:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 7, 28} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, $sub.i32(0, 1));
  call {:cexpr "x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 7, 21} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $sgt.i32(1, 0);
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i0} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i0 == 1);
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $p1 := __incr;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  call $i2 := devirtbounce($p1, 1);
  call {:cexpr "x"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 28, 3} true;
...
$bb9:
  ...
  goto $bb6;
$bb10:
  assume {:sourceloc "test/c/data/func_ptr_alias1_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (devirtbounce == $sub.ref(0, 22704));
