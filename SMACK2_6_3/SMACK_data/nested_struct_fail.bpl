...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/nested_struct_fail.c -bpl ./nested_struct_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 24, 8} true;
  ...
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 2);
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1));
  $p4 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 26, 17} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, 100);
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 27, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 27, 13} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i16($M.2, $p5, 5);
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 28, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1));
  $p7 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 28, 17} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i32($M.3, $p7, 200);
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p8);
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
...
$bb4:
  ...
  $p12 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1));
  $p20 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  goto $bb3;
$bb11:
  assume {:sourceloc "test/c/data/nested_struct_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
