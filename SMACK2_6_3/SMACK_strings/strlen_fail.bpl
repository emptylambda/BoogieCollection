...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strlen_fail.c -bpl ./strlen_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 23731));
...
const {:count 3} __const.main.word: ref;
axiom (__const.main.word == $sub.ref(0, 1027));
const main: ref;
axiom (main == $sub.ref(0, 2059));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strlen_fail.c", 8, 8} true;
  ...
  assume {:sourceloc "test/c/strings/strlen_fail.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const.main.word, 3, false);
  assume {:sourceloc "test/c/strings/strlen_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strlen_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strlen_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 8251));
...
axiom (__VERIFIER_assert == $sub.ref(0, 9283));
...
axiom (__SMACK_and32 == $sub.ref(0, 10315));
...
axiom (__SMACK_and64 == $sub.ref(0, 11347));
...
axiom (__SMACK_and16 == $sub.ref(0, 12379));
...
axiom (__SMACK_and8 == $sub.ref(0, 13411));
...
axiom (__SMACK_or32 == $sub.ref(0, 14443));
...
axiom (__SMACK_or64 == $sub.ref(0, 15475));
...
axiom (__SMACK_or16 == $sub.ref(0, 16507));
...
axiom (__SMACK_or8 == $sub.ref(0, 17539));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18571));
...
axiom (__SMACK_decls == $sub.ref(0, 19603));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 20635));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21667));
...
axiom (llvm.dbg.value == $sub.ref(0, 22699));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 23731));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i8($M.0, __const.main.word, 72);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word, $mul.ref(0, 3)), $mul.ref(1, 1)), 105);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word, $mul.ref(0, 3)), $mul.ref(2, 1)), 0);
  $exn := false;
  return;
}
