...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/strings1_fail.c -bpl ./strings1_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/strings1_fail.c", 7, 3} true;
  ...
  goto $bb1;
$bb1:
  $p0 := $add.ref($add.ref(.str, $mul.ref(0, 8)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/basic/strings1_fail.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "test/c/basic/strings1_fail.c", 7, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/strings1_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
