...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/double_ops.c -bpl ./double_ops.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/double_ops.c", 14, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/float/double_ops.c", 14, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/double_ops.c:14:9: warning: over-approximating floating-point arithmetic fadd; */
  $f0 := $fadd.float($fp(1, 500000, 0), $fp(2, 250000, 0));
  call {:cexpr "c"} boogie_si_record_float($f0);
  assume {:sourceloc "test/c/float/double_ops.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/double_ops.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i1 := (if $foeq.float.bool($f0, $fp(3, 750000, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/double_ops.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/double_ops.c", 19, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/double_ops.c:19:9: warning: over-approximating floating-point arithmetic fsub; */
  $f2 := $fsub.float($fp(1, 500000, 0), $fp(2, 250000, 0));
  call {:cexpr "c"} boogie_si_record_float($f2);
  assume {:sourceloc "test/c/float/double_ops.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/float/double_ops.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i3 := (if $foeq.float.bool($f2, $fp(-7, 500000, 1)) then 1 else 0);
  assume {:sourceloc "test/c/float/double_ops.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/float/double_ops.c", 24, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/double_ops.c:24:9: warning: over-approximating floating-point arithmetic fmul; */
  $f4 := $fmul.float($fp(1, 500000, 0), $fp(3, 0, 0));
  call {:cexpr "c"} boogie_si_record_float($f4);
  assume {:sourceloc "test/c/float/double_ops.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/float/double_ops.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i5 := (if $foeq.float.bool($f4, $fp(4, 500000, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/double_ops.c", 25, 3} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/float/double_ops.c", 29, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/double_ops.c:29:9: warning: over-approximating floating-point arithmetic fdiv; */
  $f6 := $fdiv.float($fp(3, 0, 0), $fp(1, 500000, 0));
  call {:cexpr "c"} boogie_si_record_float($f6);
  assume {:sourceloc "test/c/float/double_ops.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/float/double_ops.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $i7 := (if $foeq.float.bool($f6, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/double_ops.c", 30, 3} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/float/double_ops.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
