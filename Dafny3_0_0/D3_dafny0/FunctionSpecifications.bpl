// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy -print:./FunctionSpecifications.bpl
...
const BaseFuel__module._default.secret: LayerType;

const StartFuel__module._default.secret: LayerType;

const StartFuelAssert__module._default.secret: LayerType;

const BaseFuel__module._default.recursive_f: LayerType;

const StartFuel__module._default.recursive_f: LayerType;

const StartFuelAssert__module._default.recursive_f: LayerType;

const BaseFuel__module._default.bad_ensures: LayerType;

const StartFuel__module._default.bad_ensures: LayerType;

const StartFuelAssert__module._default.bad_ensures: LayerType;

const BaseFuel__module._default.f: LayerType;

const StartFuel__module._default.f: LayerType;

const StartFuelAssert__module._default.f: LayerType;

const BaseFuel__module._default.g: LayerType;

const StartFuel__module._default.g: LayerType;

const StartFuelAssert__module._default.g: LayerType;

const BaseFuel__module._default.B: LayerType;

const StartFuel__module._default.B: LayerType;

const StartFuelAssert__module._default.B: LayerType;
...
axiom (forall a#21#0#0: int, a#21#1#0: DatatypeType :: 
  ...
  $Is(#_module.List.Cons(a#21#0#0, a#21#1#0), Tclass._module.List())
     <==> $Is(a#21#0#0, TInt) && $Is(a#21#1#0, Tclass._module.List()));
...
axiom (forall a#22#0#0: int, a#22#1#0: DatatypeType, $h: Heap :: 
  ...
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.List.Cons(a#22#0#0, a#22#1#0), Tclass._module.List(), $h)
       <==> $IsAlloc(a#22#0#0, TInt, $h) && $IsAlloc(a#22#1#0, Tclass._module.List(), $h)));
...
axiom (forall a#23#0#0: int, a#23#1#0: DatatypeType :: 
  { #_module.List.Cons(LitInt(a#23#0#0), Lit(a#23#1#0)) } 
  #_module.List.Cons(LitInt(a#23#0#0), Lit(a#23#1#0))
...
axiom (forall a#25#0#0: int, a#25#1#0: DatatypeType :: 
  ...
  _module.List._h1(#_module.List.Cons(a#25#0#0, a#25#1#0)) == a#25#1#0);

// Inductive rank
axiom (forall a#26#0#0: int, a#26#1#0: DatatypeType :: 
  { #_module.List.Cons(a#26#0#0, a#26#1#0) } 
  DtRank(a#26#1#0) < DtRank(#_module.List.Cons(a#26#0#0, a#26#1#0)));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int :: 
    ...
    _module.__default.Fib#canCall(LitInt(n#0))
         || (1 != $FunctionContextHeight && LitInt(0) <= LitInt(n#0))
       ==> (!Lit(n#0 < 2)
...
procedure CheckWellformed$$_module.__default.Fib(n#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures LitInt(0) <= _module.__default.Fib($LS($LS($LZ)), n#0);
...
implementation CheckWellformed$$_module.__default.Fib(n#0: int)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(4,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
       == StartFuel__module._default.secret;
    assume AsFuelBottom(StartFuelAssert__module._default.secret)
       == StartFuelAssert__module._default.secret;
    assume AsFuelBottom(StartFuel__module._default.recursive_f)
       == StartFuel__module._default.recursive_f;
    assume AsFuelBottom(StartFuelAssert__module._default.recursive_f)
       == StartFuelAssert__module._default.recursive_f;
    assume AsFuelBottom(StartFuel__module._default.bad_ensures)
       == StartFuel__module._default.bad_ensures;
    assume AsFuelBottom(StartFuelAssert__module._default.bad_ensures)
       == StartFuelAssert__module._default.bad_ensures;
    assume AsFuelBottom(StartFuel__module._default.f) == StartFuel__module._default.f;
    assume AsFuelBottom(StartFuelAssert__module._default.f)
       == StartFuelAssert__module._default.f;
    assume AsFuelBottom(StartFuel__module._default.g) == StartFuel__module._default.g;
    assume AsFuelBottom(StartFuelAssert__module._default.g)
       == StartFuelAssert__module._default.g;
    assume AsFuelBottom(StartFuel__module._default.B) == StartFuel__module._default.B;
    assume AsFuelBottom(StartFuelAssert__module._default.B)
       == StartFuelAssert__module._default.B;
    assume LitInt(0) <= n#0;
    if (*)
    {
        ##n#0 := n#0;
...
procedure CheckWellformed$$_module.__default.Sum(a#0: DatatypeType where $Is(a#0, Tclass._module.List()));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures LitInt(0) <= _module.__default.Sum(a#0);



implementation CheckWellformed$$_module.__default.Sum(a#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(14,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        ...
        assert a#0 == a#0 || DtRank(##a#0) < DtRank(a#0);
        assume a#0 == a#0 || _module.__default.Sum#canCall(a#0);
        assume LitInt(0) <= _module.__default.Sum(a#0);
        assume false;
    }
    else
    {
        ...
        {
            assume _module.__default.Sum(a#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else if (a#0 == #_module.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            ...
            else
            {
                ...
                assume _module.__default.Sum(a#0) == _module.__default.Fib($LS($LZ), x#Z#0);
                assume _module.__default.Fib#canCall(x#Z#0);
                // CheckWellformedWithResult: any expression
                assume $Is(_module.__default.Sum(a#0), TInt);
            }
...
// consequence axiom for _module.__default.FibWithoutPost
...
axiom 3 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int :: 
    ...
    _module.__default.FibWithoutPost#canCall(LitInt(n#0))
         || (3 != $FunctionContextHeight && LitInt(0) <= LitInt(n#0))
       ==> (!Lit(n#0 < 2)
...
procedure CheckWellformed$$_module.__default.FibWithoutPost(n#0: int);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.FibWithoutPost(n#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##n#0: int;
  var ##n#1: int;
  ...
  var b$reqreads#1: bool;
    ...
    // AddWellformednessCheck for function FibWithoutPost
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(22,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    else
    {
        ...
        if (n#0 < 2)
        {
            assume _module.__default.FibWithoutPost($LS($LZ), n#0) == n#0;
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else
        {
            ...
            assume _module.__default.FibWithoutPost($LS($LZ), n#0)
...
axiom 4 <= $FunctionContextHeight
   ==> (forall a#0: DatatypeType :: 
    ...
    _module.__default.SumBad#canCall(a#0)
         || (4 != $FunctionContextHeight && $Is(a#0, Tclass._module.List()))
       ==> LitInt(0) <= _module.__default.Sum(a#0)
...
procedure CheckWellformed$$_module.__default.SumBad(a#0: DatatypeType where $Is(a#0, Tclass._module.List()));
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures LitInt(0) <= _module.__default.Sum(a#0);
  ensures LitInt(0) <= _module.__default.SumBad(a#0);



implementation CheckWellformed$$_module.__default.SumBad(a#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##a#0: DatatypeType;
  ...
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function SumBad
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(29,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        ...
        assert a#0 == a#0 || DtRank(##a#1) < DtRank(a#0);
        assume a#0 == a#0 || _module.__default.SumBad#canCall(a#0);
        assume LitInt(0) <= _module.__default.SumBad(a#0);
        assume false;
    }
    else
    {
        ...
        if (a#0 == #_module.List.Nil())
        {
            assume _module.__default.SumBad(a#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else if (a#0 == #_module.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            ...
            else
            {
                ...
                assume _module.__default.SumBad(a#0)
...
axiom 9 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int :: 
    { _module.__default.FibWithExtraPost($ly, n#0) } 
    _module.__default.FibWithExtraPost#canCall(n#0) || 9 != $FunctionContextHeight
       ==> (LitInt(2) <= n#0
...
procedure CheckWellformed$$_module.__default.FibWithExtraPost(n#0: int);
  free requires 9 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures LitInt(2) <= n#0
     ==> LitInt(0) <= _module.__default.FibWithExtraPost($LS($LS($LZ)), n#0 - 1);
  ensures LitInt(1) <= n#0
     ==> LitInt(0) <= _module.__default.FibWithExtraPost($LS($LS($LZ)), n#0 - 1);
  ensures LitInt(0) <= _module.__default.FibWithExtraPost($LS($LS($LZ)), n#0);



implementation CheckWellformed$$_module.__default.FibWithExtraPost(n#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##n#0: int;
  var ##n#1: int;
  ...
  var b$reqreads#1: bool;
    ...
    // AddWellformednessCheck for function FibWithExtraPost
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(38,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        if (*)
        {
            ...
            assume $IsAlloc(##n#0, TInt, $Heap);
            assert 0 <= n#0 || ##n#0 == n#0;
            assert n#0 - 1 == n#0 || ##n#0 < n#0;
            assume n#0 - 1 == n#0 || _module.__default.FibWithExtraPost#canCall(n#0 - 1);
            assume LitInt(0) <= _module.__default.FibWithExtraPost($LS($LZ), n#0 - 1);
        }
        else
        {
            assume LitInt(2) <= n#0
        ...
        assume $IsAlloc(##n#2, TInt, $Heap);
        assert 0 <= n#0 || ##n#2 == n#0;
        assert n#0 == n#0 || ##n#2 < n#0;
        assume n#0 == n#0 || _module.__default.FibWithExtraPost#canCall(n#0);
        assume LitInt(0) <= _module.__default.FibWithExtraPost($LS($LZ), n#0);
        assume false;
    }
    else
    {
        ...
        if (n#0 < 0)
        {
            assume _module.__default.FibWithExtraPost($LS($LZ), n#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else
        {
            if (n#0 < 2)
            {
                assume _module.__default.FibWithExtraPost($LS($LZ), n#0) == n#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(_module.__default.FibWithExtraPost($LS($LZ), n#0), TInt);
            }
            else
            {
                ...
                b$reqreads#1 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
                assert 0 <= n#0 || ##n#4 == n#0;
                assert ##n#4 < n#0;
                assume _module.__default.FibWithExtraPost#canCall(n#0 - 1);
                assume _module.__default.FibWithExtraPost($LS($LZ), n#0)
...
axiom 10 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int :: 
    ...
    _module.__default.DivergentPost#canCall(n#0)
         || (10 != $FunctionContextHeight && LitInt(0) <= n#0)
       ==> (LitInt(1) <= n#0
           ==> _module.__default.DivergentPost($ly, n#0 - 1)
             == _module.__default.DivergentPost($ly, n#0 - 1))
         && _module.__default.DivergentPost($ly, Mul(LitInt(2), n#0) - n#0)
           == _module.__default.DivergentPost($ly, Mul(LitInt(2), n#0 + 5) - 10 - n#0)
         && _module.__default.DivergentPost($ly, n#0 + 1)
           == _module.__default.DivergentPost($ly, n#0 + 1));
...
axiom 10 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int :: 
    ...
    _module.__default.DivergentPost#canCall(LitInt(n#0))
         || (10 != $FunctionContextHeight && LitInt(0) <= LitInt(n#0))
       ==> (!Lit(n#0 < 2)
...
procedure CheckWellformed$$_module.__default.DivergentPost(n#0: int);
  free requires 10 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures LitInt(1) <= n#0
     ==> _module.__default.DivergentPost($LS($LS($LZ)), n#0 - 1)
       == _module.__default.DivergentPost($LS($LS($LZ)), n#0 - 1);
  ensures _module.__default.DivergentPost($LS($LS($LZ)), Mul(LitInt(2), n#0) - n#0)
     == _module.__default.DivergentPost($LS($LS($LZ)), Mul(LitInt(2), n#0 + 5) - 10 - n#0);
  ensures _module.__default.DivergentPost($LS($LS($LZ)), n#0 + 1)
     == _module.__default.DivergentPost($LS($LS($LZ)), n#0 + 1);



implementation CheckWellformed$$_module.__default.DivergentPost(n#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##n#0: int;
  var ##n#1: int;
  ...
  var b$reqreads#1: bool;
    ...
    // AddWellformednessCheck for function DivergentPost
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(49,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        if (*)
        {
            ...
            assert n#0 - 1 == n#0 || ##n#1 < n#0;
            assume n#0 - 1 == n#0 || _module.__default.DivergentPost#canCall(n#0 - 1);
            assume _module.__default.DivergentPost($LS($LZ), n#0 - 1)
        ...
        assume LitInt(0) <= ##n#2;
        assert 0 <= n#0 || ##n#2 == n#0;
        assert Mul(LitInt(2), n#0) - n#0 == n#0 || ##n#2 < n#0;
        assume Mul(LitInt(2), n#0) - n#0 == n#0
           || _module.__default.DivergentPost#canCall(Mul(LitInt(2), n#0) - n#0);
        ...
        assume LitInt(0) <= ##n#3;
        assert 0 <= n#0 || ##n#3 == n#0;
        assert Mul(LitInt(2), n#0 + 5) - 10 - n#0 == n#0 || ##n#3 < n#0;
        assume Mul(LitInt(2), n#0 + 5) - 10 - n#0 == n#0
           || _module.__default.DivergentPost#canCall(Mul(LitInt(2), n#0 + 5) - 10 - n#0);
        assume _module.__default.DivergentPost($LS($LZ), Mul(LitInt(2), n#0) - n#0)
           == _module.__default.DivergentPost($LS($LZ), Mul(LitInt(2), n#0 + 5) - 10 - n#0);
        ##n#4 := n#0 + 1;
        // assume allocatedness for argument to function
        assume $IsAlloc(##n#4, TInt, $Heap);
        ...
        assume LitInt(0) <= ##n#4;
        assert 0 <= n#0 || ##n#4 == n#0;
        assert n#0 + 1 == n#0 || ##n#4 < n#0;
        assume n#0 + 1 == n#0 || _module.__default.DivergentPost#canCall(n#0 + 1);
        ##n#5 := n#0 + 1;
        // assume allocatedness for argument to function
        assume $IsAlloc(##n#5, TInt, $Heap);
        assert {:subsumption 0} LitInt(0) <= ##n#5;
        assume LitInt(0) <= ##n#5;
        assert 0 <= n#0 || ##n#5 == n#0;
        assert n#0 + 1 == n#0 || ##n#5 < n#0;
        assume n#0 + 1 == n#0 || _module.__default.DivergentPost#canCall(n#0 + 1);
        assume _module.__default.DivergentPost($LS($LZ), n#0 + 1)
           == _module.__default.DivergentPost($LS($LZ), n#0 + 1);
        assume false;
    ...
    else
    {
        ...
        if (n#0 < 2)
        {
            assume _module.__default.DivergentPost($LS($LZ), n#0) == n#0;
            assume true;
            // CheckWellformedWithResult: any expression
...
axiom 11 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    _module.__default.HoldsAtLeastForZero#canCall(x#0)
...
procedure CheckWellformed$$_module.__default.HoldsAtLeastForZero(x#0: int);
  free requires 11 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures x#0 == LitInt(0) ==> _module.__default.HoldsAtLeastForZero(x#0);



implementation CheckWellformed$$_module.__default.HoldsAtLeastForZero(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;


    // AddWellformednessCheck for function HoldsAtLeastForZero
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(59,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        if (*)
        {
            ...
            assume _module.__default.HoldsAtLeastForZero(x#0);
        }
        else
        {
            assume x#0 == LitInt(0) ==> _module.__default.HoldsAtLeastForZero(x#0);
        }
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        assume _module.__default.HoldsAtLeastForZero(x#0) == (x#0 < -2);
        assume true;
        // CheckWellformedWithResult: any expression
...
axiom 6 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    _module.__default.IncA#canCall(x#0)
         || (6 != $FunctionContextHeight && LitInt(0) <= x#0)
...
axiom 6 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, x#0: int :: 
    ...
    _module.__default.IncA#canCall(x#0)
         || (6 != $FunctionContextHeight && $IsGoodHeap($Heap) && LitInt(0) <= x#0)
...
procedure CheckWellformed$$_module.__default.IncA(x#0: int where LitInt(0) <= x#0);
  free requires 6 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures x#0 < _module.__default.IncA(x#0);



implementation CheckWellformed$$_module.__default.IncA(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var y#2: int;
    ...
    // AddWellformednessCheck for function IncA
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(68,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        ...
        assume x#0 < _module.__default.IncA(x#0);
        assume false;
    }
    else
    {
        ...
        if (x#0 == LitInt(17))
        {
            assert $Is(LitInt(18), Tclass._System.nat());
            assume _module.__default.IncA(x#0) == LitInt(18);
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else
        {
            ...
            assert ($Is(x#0 + 1, TInt) && x#0 < x#0 + 1)
               || 
            ...
            assert $Is(y#2, Tclass._System.nat());
            assume _module.__default.IncA(x#0) == y#2;
            assume true;
...
implementation Impl$$_module.__default.M() returns ($_reverifyPost: bool)
{
  ...
  var ##x#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(78,17): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(79,9)
    assume true;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(79,19)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(80,3)
    assume true;
    assert z#0 != 0;
}
...
axiom 7 <= $FunctionContextHeight
   ==> (forall i#0: int :: 
    ...
    _module.__default.IncB#canCall(i#0)
         || (7 != $FunctionContextHeight && LitInt(0) <= i#0)
...
axiom 7 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, i#0: int :: 
    ...
    _module.__default.IncB#canCall(i#0)
         || (7 != $FunctionContextHeight && $IsGoodHeap($Heap) && LitInt(0) <= i#0)
       ==> $let#3$canCall(i#0)
...
procedure CheckWellformed$$_module.__default.IncB(i#0: int where LitInt(0) <= i#0);
  free requires 7 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.IncB(i#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var n#2: int;


    // AddWellformednessCheck for function IncB
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(83,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    else
    {
        ...
        assert ($Is(i#0 + 1, TInt) && i#0 + 1 > i#0)
           || 
        ...
        assert $Is(n#2, Tclass._System.nat());
        assume _module.__default.IncB(i#0) == n#2;
        assume true;
        // CheckWellformedWithResult: Let expression
...
axiom 8 <= $FunctionContextHeight
   ==> (forall i#0: int :: 
    ...
    _module.__default.IncC#canCall(i#0)
         || (8 != $FunctionContextHeight && LitInt(0) <= i#0)
...
axiom 8 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, i#0: int :: 
    ...
    _module.__default.IncC#canCall(i#0)
         || (8 != $FunctionContextHeight && $IsGoodHeap($Heap) && LitInt(0) <= i#0)
       ==> $let#6$canCall(i#0)
...
procedure CheckWellformed$$_module.__default.IncC(i#0: int where LitInt(0) <= i#0);
  free requires 8 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures _module.__default.IncC(i#0) >= LitInt(0);



implementation CheckWellformed$$_module.__default.IncC(i#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##i#0: int;
  var n#2: int;
    ...
    // AddWellformednessCheck for function IncC
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(88,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        ...
        assert 0 <= i#0 || ##i#0 == i#0;
        assert i#0 == i#0 || ##i#0 < i#0;
        assume i#0 == i#0 || _module.__default.IncC#canCall(i#0);
        assume _module.__default.IncC(i#0) >= LitInt(0);
        assume false;
    }
    else
    {
        ...
        assume _module.__default.IncC(i#0) == n#2;
        assume true;
        // CheckWellformedWithResult: Let expression
...
function _module.__default.secret($ly: LayerType, x#0: int, y#0: int) : int;

function _module.__default.secret#canCall(x#0: int, y#0: int) : bool;

// layer synonym axiom
axiom (forall $ly: LayerType, x#0: int, y#0: int :: 
  { _module.__default.secret($LS($ly), x#0, y#0) } 
  _module.__default.secret($LS($ly), x#0, y#0)
     == _module.__default.secret($ly, x#0, y#0));

// fuel synonym axiom
axiom (forall $ly: LayerType, x#0: int, y#0: int :: 
  { _module.__default.secret(AsFuelBottom($ly), x#0, y#0) } 
  _module.__default.secret($ly, x#0, y#0)
     == _module.__default.secret($LZ, x#0, y#0));
   ...
   ==> (forall $ly: LayerType, x#0: int, y#0: int :: 
    ...
    _module.__default.secret#canCall(x#0, y#0)
         || (13 != $FunctionContextHeight
          ...
          LitInt(0) <= y#0
           && y#0 < 5)
       ==> _module.__default.secret($ly, x#0, y#0) < 10);

function _module.__default.secret#requires(LayerType, int, int) : bool;

// #requires axiom for _module.__default.secret
axiom (forall $ly: LayerType, x#0: int, y#0: int :: 
  { _module.__default.secret#requires($ly, x#0, y#0) } 
  _module.__default.secret#requires($ly, x#0, y#0)
   ...
   ==> (forall $ly: LayerType, x#0: int, y#0: int :: 
    ...
    _module.__default.secret#canCall(x#0, y#0)
         || (13 != $FunctionContextHeight
          ...
          LitInt(0) <= y#0
           && y#0 < 5)
       ==> _module.__default.secret($LS($ly), x#0, y#0) == x#0 + y#0);

// definition axiom for _module.__default.secret for all literals (revealed)
axiom 13 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int, y#0: int :: 
    {:weight 3} { _module.__default.secret($LS($ly), LitInt(x#0), LitInt(y#0)) } 
    _module.__default.secret#canCall(LitInt(x#0), LitInt(y#0))
         || (13 != $FunctionContextHeight
          ...
          LitInt(0) <= LitInt(y#0)
           && y#0 < 5)
       ==> _module.__default.secret($LS($ly), LitInt(x#0), LitInt(y#0))
         == LitInt(x#0 + y#0));

procedure {:opaque} CheckWellformed$$_module.__default.secret(x#0: int, y#0: int);
  free requires 13 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures _module.__default.secret(StartFuelAssert__module._default.secret, x#0, y#0) < 10;



implementation {:opaque} CheckWellformed$$_module.__default.secret(x#0: int, y#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var ##y#0: int;
    ...
    // AddWellformednessCheck for function secret
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(100,19): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        ...
        assert {:subsumption 0} ##x#0 < 5;
        assume LitInt(0) <= ##x#0 && ##x#0 < 5;
        assert {:subsumption 0} LitInt(0) <= ##y#0;
        assert {:subsumption 0} ##y#0 < 5;
        assume LitInt(0) <= ##y#0 && ##y#0 < 5;
        assert 0 <= x#0 || ##x#0 == x#0;
        assert 0 <= y#0 || ##x#0 < x#0 || ##y#0 == y#0;
        assert (x#0 == x#0 && y#0 == y#0) || ##x#0 < x#0 || (##x#0 == x#0 && ##y#0 < y#0);
        assume (x#0 == x#0 && y#0 == y#0) || _module.__default.secret#canCall(x#0, y#0);
        assume _module.__default.secret(StartFuel__module._default.secret, x#0, y#0) < 10;
        assume false;
    }
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        assume _module.__default.secret(StartFuel__module._default.secret, x#0, y#0)
           == x#0 + y#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(_module.__default.secret(StartFuel__module._default.secret, x#0, y#0), TInt);
    }
}



procedure CheckWellformed$$_module.__default.test__secret();
  free requires 15 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.test__secret();
  modifies $Heap, $Tick;
...
procedure Impl$$_module.__default.test__secret() returns ($_reverifyPost: bool);
  free requires 15 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$_module.__default.test__secret() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var ##y#0: int;
  ...
  var ##y#2: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(107,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(108,3)
    ##x#0 := LitInt(2);
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    ##y#0 := LitInt(3);
    ...
    assume _module.__default.secret#canCall(LitInt(2), LitInt(3));
    assert {:subsumption 0} _module.__default.secret(StartFuelAssert__module._default.secret, LitInt(2), LitInt(3))
       >= LitInt(5);
    assume _module.__default.secret(StartFuel__module._default.secret, LitInt(2), LitInt(3))
       >= LitInt(5);
    // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(109,3)
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(109,16)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.__default.reveal__secret();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(109,17)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(110,3)
    ##x#1 := LitInt(2);
    // assume allocatedness for argument to function
    ...
    assert {:subsumption 0} ##x#1 < 5;
    assert {:subsumption 0} LitInt(0) <= ##y#1;
    assert {:subsumption 0} ##y#1 < 5;
    assume _module.__default.secret#canCall(LitInt(2), LitInt(3));
    assume _module.__default.secret#canCall(LitInt(2), LitInt(3));
    assert {:subsumption 0} _module.__default.secret(StartFuelAssert__module._default.secret, LitInt(2), LitInt(3))
       == LitInt(5);
    assume _module.__default.secret(StartFuel__module._default.secret, LitInt(2), LitInt(3))
       == LitInt(5);
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(111,3)
    ##x#2 := LitInt(4);
    // assume allocatedness for argument to function
    ...
    assert {:subsumption 0} ##x#2 < 5;
    assert {:subsumption 0} LitInt(0) <= ##y#2;
    assert {:subsumption 0} ##y#2 < 5;
    assume _module.__default.secret#canCall(LitInt(4), LitInt(1));
    assume _module.__default.secret#canCall(LitInt(4), LitInt(1));
    assert {:subsumption 0} _module.__default.secret(StartFuelAssert__module._default.secret, LitInt(4), LitInt(1))
       == LitInt(7);
    assume _module.__default.secret(StartFuel__module._default.secret, LitInt(4), LitInt(1))
       == LitInt(7);
}
...
function _module.__default.recursive__f($ly: LayerType, x#0: int) : int;

function _module.__default.recursive__f#canCall(x#0: int) : bool;

// layer synonym axiom
axiom (forall $ly: LayerType, x#0: int :: 
  { _module.__default.recursive__f($LS($ly), x#0) } 
  _module.__default.recursive__f($LS($ly), x#0)
     == _module.__default.recursive__f($ly, x#0));

// fuel synonym axiom
axiom (forall $ly: LayerType, x#0: int :: 
  { _module.__default.recursive__f(AsFuelBottom($ly), x#0) } 
  _module.__default.recursive__f($ly, x#0)
     == _module.__default.recursive__f($LZ, x#0));

// consequence axiom for _module.__default.recursive__f
axiom 16 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    { _module.__default.recursive__f($ly, x#0) } 
    _module.__default.recursive__f#canCall(x#0)
         || (16 != $FunctionContextHeight && x#0 >= LitInt(0))
       ==> true);
    ...
    _module.__default.recursive__f#canCall(x#0)
       ...
       ==> (x#0 != LitInt(0) ==> _module.__default.recursive__f#canCall(x#0 - 1))
         && _module.__default.recursive__f($LS($ly), x#0)
           == (if x#0 == LitInt(0)
             then 0
             else 1 + _module.__default.recursive__f($ly, x#0 - 1)));

// definition axiom for _module.__default.recursive__f for all literals (revealed)
axiom 16 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    {:weight 3} { _module.__default.recursive__f($LS($ly), LitInt(x#0)) } 
    _module.__default.recursive__f#canCall(LitInt(x#0))
         || (16 != $FunctionContextHeight && LitInt(x#0) >= LitInt(0))
       ==> (LitInt(x#0) != LitInt(0)
           ==> _module.__default.recursive__f#canCall(LitInt(x#0 - 1)))
         && _module.__default.recursive__f($LS($ly), LitInt(x#0))
           == (if LitInt(x#0) == LitInt(0)
             then 0
             else 1 + _module.__default.recursive__f($LS($ly), LitInt(x#0 - 1))));

procedure {:opaque} CheckWellformed$$_module.__default.recursive__f(x#0: int);
  free requires 16 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:opaque} CheckWellformed$$_module.__default.recursive__f(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function recursive_f
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(116,19): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    else
    {
        ...
        if (x#0 == LitInt(0))
        {
            assume _module.__default.recursive__f(StartFuel__module._default.recursive_f, x#0)
               == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.recursive__f(StartFuel__module._default.recursive_f, x#0), 
              TInt);
        }
        else
        {
            ...
            // assume allocatedness for argument to function
            assume $IsAlloc(##x#0, TInt, $Heap);
            assert {:subsumption 0} ##x#0 >= LitInt(0);
            assume ##x#0 >= LitInt(0);
            b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assert 0 <= x#0 || ##x#0 == x#0;
            assert ##x#0 < x#0;
            ...
            assume _module.__default.recursive__f(StartFuel__module._default.recursive_f, x#0)
               == 1
                 + _module.__default.recursive__f(StartFuel__module._default.recursive_f, x#0 - 1);
            assume _module.__default.recursive__f#canCall(x#0 - 1);
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.recursive__f(StartFuel__module._default.recursive_f, x#0), 
              TInt);
...
procedure CheckWellformed$$_module.__default.test__recursive__f();
  free requires 18 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.test__recursive__f();
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure Impl$$_module.__default.test__recursive__f() returns ($_reverifyPost: bool);
  free requires 18 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$_module.__default.test__recursive__f() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0_0: int;
  var ##x#0: int;
  var ##x#1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(124,0): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(125,3)
    if (*)
    {
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(126,5)
        ##x#0_0 := LitInt(4);
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0_0, TInt, $Heap);
        assert {:subsumption 0} ##x#0_0 >= LitInt(0);
        assume _module.__default.recursive__f#canCall(LitInt(4));
        assume _module.__default.recursive__f#canCall(LitInt(4));
        assert {:subsumption 0} _module.__default.recursive__f(StartFuelAssert__module._default.recursive_f, LitInt(4))
           == LitInt(4);
        assume _module.__default.recursive__f(StartFuel__module._default.recursive_f, LitInt(4))
           == LitInt(4);
    }
    else
    {
        // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(128,5)
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(128,23)
        // TrCallStmt: Before ProcessCallStmt
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        // ProcessCallStmt: Make the call
        call Call$$_module.__default.reveal__recursive__f();
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(128,24)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(129,5)
        ##x#0 := LitInt(4);
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assert {:subsumption 0} ##x#0 >= LitInt(0);
        ...
        assume _module.__default.recursive__f(StartFuel__module._default.recursive_f, LitInt(4))
           == LitInt(4);
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(130,5)
        ##x#1 := LitInt(3);
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#1, TInt, $Heap);
        assert {:subsumption 0} ##x#1 >= LitInt(0);
        assume _module.__default.recursive__f#canCall(LitInt(3));
        assume _module.__default.recursive__f#canCall(LitInt(3));
        assert {:subsumption 0} _module.__default.recursive__f(StartFuelAssert__module._default.recursive_f, LitInt(3))
           == LitInt(5);
        assume _module.__default.recursive__f(StartFuel__module._default.recursive_f, LitInt(3))
           == LitInt(5);
    }
}
...
function _module.__default.bad__ensures($ly: LayerType, x#0: int, y#0: int) : int;

function _module.__default.bad__ensures#canCall(x#0: int, y#0: int) : bool;

// layer synonym axiom
axiom (forall $ly: LayerType, x#0: int, y#0: int :: 
  { _module.__default.bad__ensures($LS($ly), x#0, y#0) } 
  _module.__default.bad__ensures($LS($ly), x#0, y#0)
     == _module.__default.bad__ensures($ly, x#0, y#0));

// fuel synonym axiom
axiom (forall $ly: LayerType, x#0: int, y#0: int :: 
  { _module.__default.bad__ensures(AsFuelBottom($ly), x#0, y#0) } 
  _module.__default.bad__ensures($ly, x#0, y#0)
     == _module.__default.bad__ensures($LZ, x#0, y#0));
...
axiom 19 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int, y#0: int :: 
    ...
    _module.__default.bad__ensures#canCall(x#0, y#0)
         || (19 != $FunctionContextHeight && x#0 >= LitInt(0) && y#0 >= LitInt(0))
       ==> _module.__default.bad__ensures($ly, x#0, y#0) > 0);

function _module.__default.bad__ensures#requires(LayerType, int, int) : bool;

// #requires axiom for _module.__default.bad__ensures
axiom (forall $ly: LayerType, x#0: int, y#0: int :: 
  { _module.__default.bad__ensures#requires($ly, x#0, y#0) } 
  _module.__default.bad__ensures#requires($ly, x#0, y#0)
...
axiom 19 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int, y#0: int :: 
    ...
    _module.__default.bad__ensures#canCall(x#0, y#0)
         || (19 != $FunctionContextHeight && x#0 >= LitInt(0) && y#0 >= LitInt(0))
       ==> _module.__default.bad__ensures($LS($ly), x#0, y#0) == x#0 + y#0);

// definition axiom for _module.__default.bad__ensures for all literals (revealed)
axiom 19 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int, y#0: int :: 
    {:weight 3} { _module.__default.bad__ensures($LS($ly), LitInt(x#0), LitInt(y#0)) } 
    _module.__default.bad__ensures#canCall(LitInt(x#0), LitInt(y#0))
         || (19 != $FunctionContextHeight
           && 
          LitInt(x#0) >= LitInt(0)
           && LitInt(y#0) >= LitInt(0))
       ==> _module.__default.bad__ensures($LS($ly), LitInt(x#0), LitInt(y#0))
         == LitInt(x#0 + y#0));

procedure {:opaque} CheckWellformed$$_module.__default.bad__ensures(x#0: int, y#0: int);
  free requires 19 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures _module.__default.bad__ensures(StartFuelAssert__module._default.bad_ensures, x#0, y#0)
     > 0;



implementation {:opaque} CheckWellformed$$_module.__default.bad__ensures(x#0: int, y#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var ##y#0: int;
    ...
    // AddWellformednessCheck for function bad_ensures
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(135,19): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        ...
        assume $IsAlloc(##y#0, TInt, $Heap);
        assert {:subsumption 0} ##x#0 >= LitInt(0);
        assert {:subsumption 0} ##y#0 >= LitInt(0);
        assume ##x#0 >= LitInt(0) && ##y#0 >= LitInt(0);
        assert 0 <= x#0 || ##x#0 == x#0;
        assert 0 <= y#0 || ##x#0 < x#0 || ##y#0 == y#0;
        assert (x#0 == x#0 && y#0 == y#0) || ##x#0 < x#0 || (##x#0 == x#0 && ##y#0 < y#0);
        assume (x#0 == x#0 && y#0 == y#0) || _module.__default.bad__ensures#canCall(x#0, y#0);
        assume _module.__default.bad__ensures(StartFuel__module._default.bad_ensures, x#0, y#0)
           > 0;
        assume false;
    }
    else
    {
        ...
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(_module.__default.bad__ensures(StartFuel__module._default.bad_ensures, x#0, y#0), 
          TInt);
    }
}
...
function _module.__default.f($ly: LayerType, i#0: int) : int;

function _module.__default.f#canCall(i#0: int) : bool;

// layer synonym axiom
axiom (forall $ly: LayerType, i#0: int :: 
  { _module.__default.f($LS($ly), i#0) } 
  _module.__default.f($LS($ly), i#0) == _module.__default.f($ly, i#0));

// fuel synonym axiom
axiom (forall $ly: LayerType, i#0: int :: 
  { _module.__default.f(AsFuelBottom($ly), i#0) } 
  _module.__default.f($ly, i#0) == _module.__default.f($LZ, i#0));

// consequence axiom for _module.__default.f
axiom 20 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    { _module.__default.f($ly, i#0) } 
    _module.__default.f#canCall(i#0) || 20 != $FunctionContextHeight ==> true);
...
axiom 20 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    { _module.__default.f($LS($ly), i#0) } 
    _module.__default.f#canCall(i#0) || 20 != $FunctionContextHeight
       ==> _module.__default.f#canCall(i#0)
         && _module.__default.f($LS($ly), i#0) == _module.__default.f($ly, i#0) + 1);

// definition axiom for _module.__default.f for all literals (revealed)
axiom 20 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    {:weight 3} { _module.__default.f($LS($ly), LitInt(i#0)) } 
    _module.__default.f#canCall(LitInt(i#0)) || 20 != $FunctionContextHeight
       ==> _module.__default.f#canCall(LitInt(i#0))
         && _module.__default.f($LS($ly), LitInt(i#0))
           == _module.__default.f($LS($ly), LitInt(i#0)) + 1);

procedure {:opaque} CheckWellformed$$_module.__default.f(i#0: int);
  free requires 20 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:opaque} CheckWellformed$$_module.__default.f(i#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##i#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(143,19): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    else
    {
        ...
        assume _module.__default.f(StartFuel__module._default.f, i#0)
           == _module.__default.f(StartFuel__module._default.f, i#0) + 1;
        assume _module.__default.f#canCall(i#0);
        // CheckWellformedWithResult: any expression
        assume $Is(_module.__default.f(StartFuel__module._default.f, i#0), TInt);
        assert b$reqreads#0;
    }
}
...
function _module.__default.g($ly: LayerType, i#0: int) : int;

function _module.__default.g#canCall(i#0: int) : bool;

// layer synonym axiom
axiom (forall $ly: LayerType, i#0: int :: 
  { _module.__default.g($LS($ly), i#0) } 
  _module.__default.g($LS($ly), i#0) == _module.__default.g($ly, i#0));

// fuel synonym axiom
axiom (forall $ly: LayerType, i#0: int :: 
  { _module.__default.g(AsFuelBottom($ly), i#0) } 
  _module.__default.g($ly, i#0) == _module.__default.g($LZ, i#0));

// consequence axiom for _module.__default.g
axiom 21 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    { _module.__default.g($ly, i#0) } 
    _module.__default.g#canCall(i#0) || 21 != $FunctionContextHeight ==> true);
...
axiom 21 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    { _module.__default.g($LS($ly), i#0) } 
    _module.__default.g#canCall(i#0) || 21 != $FunctionContextHeight
       ==> _module.__default.h#canCall(i#0)
         && _module.__default.g($LS($ly), i#0) == _module.__default.h($ly, i#0) + 1);

// definition axiom for _module.__default.g for all literals (revealed)
axiom 21 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    {:weight 3} { _module.__default.g($LS($ly), LitInt(i#0)) } 
    _module.__default.g#canCall(LitInt(i#0)) || 21 != $FunctionContextHeight
       ==> _module.__default.h#canCall(LitInt(i#0))
         && _module.__default.g($LS($ly), LitInt(i#0))
           == LitInt(_module.__default.h($LS($ly), LitInt(i#0)) + 1));

procedure {:opaque} CheckWellformed$$_module.__default.g(i#0: int);
  free requires 21 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:opaque} CheckWellformed$$_module.__default.g(i#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##i#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(150,19): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    else
    {
        ...
        assume _module.__default.g(StartFuel__module._default.g, i#0)
           == _module.__default.h($LS($LZ), i#0) + 1;
        assume _module.__default.h#canCall(i#0);
        // CheckWellformedWithResult: any expression
        assume $Is(_module.__default.g(StartFuel__module._default.g, i#0), TInt);
        assert b$reqreads#0;
    }
}
...
axiom 21 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    { _module.__default.h($ly, i#0) } 
    _module.__default.h#canCall(i#0) || 21 != $FunctionContextHeight ==> true);
...
axiom 21 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    { _module.__default.h($LS($ly), i#0) } 
    _module.__default.h#canCall(i#0) || 21 != $FunctionContextHeight
       ==> _module.__default.g#canCall(i#0)
         && _module.__default.h($LS($ly), i#0) == _module.__default.g($ly, i#0));

// definition axiom for _module.__default.h for all literals (revealed)
axiom 21 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, i#0: int :: 
    {:weight 3} { _module.__default.h($LS($ly), LitInt(i#0)) } 
    _module.__default.h#canCall(LitInt(i#0)) || 21 != $FunctionContextHeight
       ==> _module.__default.g#canCall(LitInt(i#0))
         && _module.__default.h($LS($ly), LitInt(i#0))
           == _module.__default.g($LS($ly), LitInt(i#0)));

procedure CheckWellformed$$_module.__default.h(i#0: int);
  free requires 21 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.h(i#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##i#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(156,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    else
    {
        ...
        assume _module.__default.h($LS($LZ), i#0)
           == _module.__default.g(StartFuel__module._default.g, i#0);
        assume _module.__default.g#canCall(i#0);
        // CheckWellformedWithResult: any expression
...
axiom 23 <= $FunctionContextHeight
   ==> 
  _module.__default.A#canCall() || 23 != $FunctionContextHeight
...
const MoreFuel__module._default.B0: LayerType;

// definition axiom for _module.__default.A (revealed)
axiom 23 <= $FunctionContextHeight
   ==> 
  _module.__default.A#canCall() || 23 != $FunctionContextHeight
   ==> StartFuel__module._default.B == $LS(MoreFuel__module._default.B0)
     && StartFuelAssert__module._default.B == $LS($LS(MoreFuel__module._default.B0))
     && AsFuelBottom(MoreFuel__module._default.B0) == MoreFuel__module._default.B0
     && _module.__default.A() == LitInt(6);

const MoreFuel__module._default.B1: LayerType;

// definition axiom for _module.__default.A for all literals (revealed)
axiom 23 <= $FunctionContextHeight
   ==> 
  _module.__default.A#canCall() || 23 != $FunctionContextHeight
   ==> StartFuel__module._default.B == $LS(MoreFuel__module._default.B1)
     && StartFuelAssert__module._default.B == $LS($LS(MoreFuel__module._default.B1))
     && AsFuelBottom(MoreFuel__module._default.B1) == MoreFuel__module._default.B1
     && _module.__default.A() == LitInt(6);

procedure CheckWellformed$$_module.__default.A();
  free requires 23 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures LitInt(_module.__default.A()) == LitInt(5);



implementation CheckWellformed$$_module.__default.A()
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for function A
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(164,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        assert true;
        assume true;
        assume LitInt(_module.__default.A()) == LitInt(5);
        assume false;
    }
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(167,11)
        // TrCallStmt: Before ProcessCallStmt
        // ProcessCallStmt: Make the call
        call Call$$_module.__default.reveal__B();
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(167,12)"} true;
        assume _module.__default.A() == LitInt(6);
        assume true;
        // CheckWellformedWithResult: any expression
...
function _module.__default.B($ly: LayerType) : int;

function _module.__default.B#canCall() : bool;

// layer synonym axiom
axiom (forall $ly: LayerType :: 
  { _module.__default.B($LS($ly)) } 
  _module.__default.B($LS($ly)) == _module.__default.B($ly));

// fuel synonym axiom
axiom (forall $ly: LayerType :: 
  { _module.__default.B(AsFuelBottom($ly)) } 
  _module.__default.B($ly) == _module.__default.B($LZ));

// consequence axiom for _module.__default.B
axiom 24 <= $FunctionContextHeight
   ==> (forall $ly: LayerType :: 
    { _module.__default.B($ly) } 
    _module.__default.B#canCall() || 24 != $FunctionContextHeight
       ==> _module.__default.B($ly) == LitInt(5));

function _module.__default.B#requires(LayerType) : bool;

// #requires axiom for _module.__default.B
axiom (forall $ly: LayerType :: 
  { _module.__default.B#requires($ly) } 
  _module.__default.B#requires($ly) == true);
   ...
   ==> (forall $ly: LayerType :: 
    ...
    _module.__default.B#canCall() || 24 != $FunctionContextHeight
       ==> _module.__default.A#canCall()
         && _module.__default.B($LS($ly)) == LitInt(_module.__default.A()));

// definition axiom for _module.__default.B for all literals (revealed)
axiom 24 <= $FunctionContextHeight
   ==> (forall $ly: LayerType :: 
    {:weight 3} { _module.__default.B($LS($ly)) } 
    _module.__default.B#canCall() || 24 != $FunctionContextHeight
       ==> _module.__default.A#canCall()
         && _module.__default.B($LS($ly)) == LitInt(_module.__default.A()));

procedure {:opaque} CheckWellformed$$_module.__default.B();
  free requires 24 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures _module.__default.B(StartFuelAssert__module._default.B) == LitInt(5);



implementation {:opaque} CheckWellformed$$_module.__default.B()
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function B
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/FunctionSpecifications.dfy(171,19): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume AsFuelBottom(StartFuel__module._default.secret)
    ...
    if (*)
    {
        assert true;
        assume true;
        assume _module.__default.B(StartFuel__module._default.B) == LitInt(5);
        assume false;
    }
    else
    {
        ...
        assume _module.__default.B(StartFuel__module._default.B)
           == LitInt(_module.__default.A());
        assume _module.__default.A#canCall();
        // CheckWellformedWithResult: any expression
        assume $Is(_module.__default.B(StartFuel__module._default.B), TInt);
        assert b$reqreads#0;
    }
}
...
procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$_module.__default.reveal__secret();
  free requires 14 == $FunctionContextHeight;
  modifies $Heap, $Tick;



const MoreFuel__module._default.secret0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$_module.__default.reveal__secret();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel__module._default.secret == $LS(MoreFuel__module._default.secret0);
  free ensures StartFuelAssert__module._default.secret
     == $LS($LS(MoreFuel__module._default.secret0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel__module._default.secret0)
     == MoreFuel__module._default.secret0;



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$_module.__default.reveal__recursive__f();
  free requires 17 == $FunctionContextHeight;
  modifies $Heap, $Tick;



const MoreFuel__module._default.recursive_f0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$_module.__default.reveal__recursive__f();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel__module._default.recursive_f
     == $LS(MoreFuel__module._default.recursive_f0);
  free ensures StartFuelAssert__module._default.recursive_f
     == $LS($LS(MoreFuel__module._default.recursive_f0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel__module._default.recursive_f0)
     == MoreFuel__module._default.recursive_f0;



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$_module.__default.reveal__bad__ensures();
  free requires 25 == $FunctionContextHeight;
  modifies $Heap, $Tick;



const MoreFuel__module._default.bad_ensures0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$_module.__default.reveal__bad__ensures();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel__module._default.bad_ensures
     == $LS(MoreFuel__module._default.bad_ensures0);
  free ensures StartFuelAssert__module._default.bad_ensures
     == $LS($LS(MoreFuel__module._default.bad_ensures0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel__module._default.bad_ensures0)
     == MoreFuel__module._default.bad_ensures0;



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$_module.__default.reveal__f();
  free requires 26 == $FunctionContextHeight;
  modifies $Heap, $Tick;



const MoreFuel__module._default.f0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$_module.__default.reveal__f();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel__module._default.f == $LS(MoreFuel__module._default.f0);
  free ensures StartFuelAssert__module._default.f == $LS($LS(MoreFuel__module._default.f0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel__module._default.f0) == MoreFuel__module._default.f0;



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$_module.__default.reveal__g();
  free requires 27 == $FunctionContextHeight;
  modifies $Heap, $Tick;



const MoreFuel__module._default.g0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$_module.__default.reveal__g();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel__module._default.g == $LS(MoreFuel__module._default.g0);
  free ensures StartFuelAssert__module._default.g == $LS($LS(MoreFuel__module._default.g0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel__module._default.g0) == MoreFuel__module._default.g0;



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$_module.__default.reveal__B();
  free requires 22 == $FunctionContextHeight;
  modifies $Heap, $Tick;



const MoreFuel__module._default.B2: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$_module.__default.reveal__B();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel__module._default.B == $LS(MoreFuel__module._default.B2);
  free ensures StartFuelAssert__module._default.B == $LS($LS(MoreFuel__module._default.B2));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel__module._default.B2) == MoreFuel__module._default.B2;
