...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strncmp_toolong.c -bpl ./strncmp_toolong.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 21667));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strncmp_toolong.c", 9, 20} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strncmp_toolong.c", 9, 20} true;
  assume {:verifier.code 0} true;
  call $i0 := strncmp(.str, .str, 5);
  call {:cexpr "comparison"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/strings/strncmp_toolong.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strncmp_toolong.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strncmp_toolong.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strncmp: ref;
axiom (strncmp == $sub.ref(0, 3091));
procedure {:inline 1} strncmp($p0: ref, $p1: ref, $i2: i64)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 4123));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 5155));
...
axiom (__SMACK_dummy == $sub.ref(0, 6187));
...
axiom (__VERIFIER_assert == $sub.ref(0, 7219));
...
axiom (__SMACK_and32 == $sub.ref(0, 8251));
...
axiom (__SMACK_and64 == $sub.ref(0, 9283));
...
axiom (__SMACK_and16 == $sub.ref(0, 10315));
...
axiom (__SMACK_and8 == $sub.ref(0, 11347));
...
axiom (__SMACK_or32 == $sub.ref(0, 12379));
...
axiom (__SMACK_or64 == $sub.ref(0, 13411));
...
axiom (__SMACK_or16 == $sub.ref(0, 14443));
...
axiom (__SMACK_or8 == $sub.ref(0, 15475));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 16507));
...
axiom (__SMACK_decls == $sub.ref(0, 17539));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 18571));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 19603));
...
axiom (llvm.dbg.value == $sub.ref(0, 20635));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 21667));
