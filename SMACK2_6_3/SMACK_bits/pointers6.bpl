...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/pointers6.c -bpl ./pointers6.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/pointers6.c", 11, 12} true;
  ...
  assume {:sourceloc "test/c/bits/pointers6.c", 12, 13} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/bits/pointers6.c", 12, 24} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2, $mul.ref(1, 1));
  assume {:sourceloc "test/c/bits/pointers6.c", 13, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p3, 1);
  assume {:sourceloc "test/c/bits/pointers6.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/pointers6.c", 14, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/pointers6.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
