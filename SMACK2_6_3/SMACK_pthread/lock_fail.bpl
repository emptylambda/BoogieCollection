...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock_fail.c -bpl ./lock_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock_fail.c", 10, 27} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock_fail.c", 10, 27} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_lock($p1);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 12, 4} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "test/c/pthread/lock_fail.c", 12, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $i4;
  call {:cexpr "z"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_unlock($p1);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (pthread_mutex_lock == $sub.ref(0, 4124));
procedure {:inline 1} pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 5156));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock_fail.c", 21, 32} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, t1, $p2);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_lock($p0);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 23, 4} true;
  assume {:verifier.code 0} true;
  $i5 := $M.0;
  assume {:sourceloc "test/c/pthread/lock_fail.c", 23, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_unlock($p0);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 25, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.1, $p1);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "test/c/pthread/lock_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/lock_fail.c", 26, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lock_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
