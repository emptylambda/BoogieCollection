...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strtok.c -bpl ./strtok.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strtok.c", 9, 20} true;
  ...
  assume {:sourceloc "test/c/strings/strtok.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call $p1 := strtok($0.ref, .str.1);
  assume $isExternal($p1);
  assume {:sourceloc "test/c/strings/strtok.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strtok.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strtok.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/strings/strtok.c", 13, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/strings/strtok.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
