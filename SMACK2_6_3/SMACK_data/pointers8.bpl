...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/pointers8.c -bpl ./pointers8.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/pointers8.c", 11, 12} true;
  ...
  assume {:sourceloc "test/c/data/pointers8.c", 12, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/pointers8.c", 12, 34} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(1, 1));
  assume {:sourceloc "test/c/data/pointers8.c", 12, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/data/pointers8.c", 13, 25} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/pointers8.c", 13, 38} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p4, $mul.ref(2, 1));
  assume {:sourceloc "test/c/data/pointers8.c", 13, 15} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p5);
  assume {:sourceloc "test/c/data/pointers8.c", 14, 23} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/pointers8.c", 14, 36} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p7, $mul.ref(3, 1));
  assume {:sourceloc "test/c/data/pointers8.c", 15, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 0);
  assume {:sourceloc "test/c/data/pointers8.c", 16, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i16($M.0, $p6, 0);
  assume {:sourceloc "test/c/data/pointers8.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p8, 0);
  assume {:sourceloc "test/c/data/pointers8.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/pointers8.c", 18, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/pointers8.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
