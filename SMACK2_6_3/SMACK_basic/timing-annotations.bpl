...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/timing-annotations.c -bpl ./timing-annotations.bpl
...
procedure {:inline 1} foo($i0: i32, $i1: i32)
  returns ($r: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/basic/timing-annotations.c", 14, 34} true;
  assume {:verifier.code 0} true;
  call {:cexpr "foo:arg:a"} boogie_si_record_i32($i0);
  call {:cexpr "foo:arg:b"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/basic/timing-annotations.c", 14, 34} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, $i1);
  assume {:sourceloc "test/c/basic/timing-annotations.c", 14, 25} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/timing-annotations.c", 19, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/timing-annotations.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/timing-annotations.c", 20, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/timing-annotations.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
