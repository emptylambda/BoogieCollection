...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_cast1_fail.c -bpl ./struct_cast1_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 17, 18} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 17, 18} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(8);
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 17, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 3);
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, 5);
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p2, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, 4);
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 24, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/struct_cast1_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
