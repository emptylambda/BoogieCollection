...
procedure Impl$$T.C.__ctor()
   returns (this: ref where this != null && $Is(this, Tclass.T.C()), $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$T.C.m(this: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(26,4): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(27,7)
    assume true;
    assert read($Heap, this, T.C.k) == read($Heap, this, T.C.k);
}
