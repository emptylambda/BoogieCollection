...
procedure CheckWellformed$$ConstantFieldReceiverNonNull.Six(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$ConstantFieldReceiverNonNull.Six(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for newtype Six
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(881,10): initial state"} true;
...
procedure CheckWellformed$$ConstantFieldReceiverNonNull.Trait.x1(this: ref
       where this != null
         && 
...
implementation CheckWellformed$$ConstantFieldReceiverNonNull.Trait.x1(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var newtype$check#0: int;

    // AddWellformednessCheck for const field x1
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(885,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
...
procedure CheckWellformed$$ConstantFieldReceiverNonNull.Trait.y();
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



implementation CheckWellformed$$ConstantFieldReceiverNonNull.Trait.y()
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var newtype$check#0: int;

    // AddWellformednessCheck for const field y
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(887,17): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    newtype$check#0 := LitInt(7);
    assert LitInt(6) <= newtype$check#0;
...
procedure CheckWellformed$$ConstantFieldReceiverNonNull.Class.Test(this: ref
       where this != null
         && 
...
procedure Call$$ConstantFieldReceiverNonNull.Class.Test(this: ref
       where this != null
         && 
        $Is(this, Tclass.ConstantFieldReceiverNonNull.Class())
         && $IsAlloc(this, Tclass.ConstantFieldReceiverNonNull.Class(), $Heap));
...
procedure Impl$$ConstantFieldReceiverNonNull.Class.Test(this: ref
       where this != null
         && 
        $Is(this, Tclass.ConstantFieldReceiverNonNull.Class())
         && $IsAlloc(this, Tclass.ConstantFieldReceiverNonNull.Class(), $Heap))
...
implementation Impl$$ConstantFieldReceiverNonNull.Class.Test(this: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(891,18): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(892,7)
    newtype$check#0 := LitInt(7);
    assert LitInt(6) <= newtype$check#0;
    ...
    assume true;
    assert {:subsumption 0} ConstantFieldReceiverNonNull.Trait.x1(this) == LitInt(7);
    assert {:subsumption 0} ConstantFieldReceiverNonNull.Trait.y() == LitInt(7);
    assume ConstantFieldReceiverNonNull.Trait.x1(this) == LitInt(7)
       && ConstantFieldReceiverNonNull.Trait.y() == LitInt(7);
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(893,7)
    assume true;
    assume true;
    assume true;
    assume true;
...
procedure CheckWellformed$$ConstantFieldReceiverNonNull.AnotherClass.M(ac#0: ref
...
procedure Call$$ConstantFieldReceiverNonNull.AnotherClass.M(ac#0: ref
       where $Is(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?())
         && $IsAlloc(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?(), $Heap))
   returns (v#0: int);
  modifies $Heap, $Tick;
...
procedure Impl$$ConstantFieldReceiverNonNull.AnotherClass.M(ac#0: ref
       where $Is(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?())
         && $IsAlloc(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?(), $Heap))
...
implementation Impl$$ConstantFieldReceiverNonNull.AnotherClass.M(ac#0: ref) returns (v#0: int, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(908,4): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(909,9)
    assume true;
    assert ac#0 != null;
    assume true;
    v#0 := ConstantFieldReceiverNonNull.AnotherClass.u(ac#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(909,15)"} true;
}
...
procedure CheckWellformed$$ConstantFieldReceiverNonNull.__default.MMethod(tr#0: ref
...
procedure Call$$ConstantFieldReceiverNonNull.__default.MMethod(tr#0: ref
       where $Is(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?())
         && $IsAlloc(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?(), $Heap));
  modifies $Heap, $Tick;
  // frame condition: object granularity
...
procedure Impl$$ConstantFieldReceiverNonNull.__default.MMethod(tr#0: ref
       where $Is(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?())
         && $IsAlloc(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?(), $Heap))
   returns ($_reverifyPost: bool);
  free requires 7 == $FunctionContextHeight;
...
implementation Impl$$ConstantFieldReceiverNonNull.__default.MMethod(tr#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
  ...
  var newtype$check#3: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(897,29): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(898,5)
    newtype$check#0 := LitInt(7);
    assert LitInt(6) <= newtype$check#0;
    assume true;
    assert ConstantFieldReceiverNonNull.Trait.y() == LitInt(7);
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(899,5)
    newtype$check#1 := LitInt(7);
    assert LitInt(6) <= newtype$check#1;
    assume true;
    assert ConstantFieldReceiverNonNull.Trait.y() == LitInt(7);
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(900,5)
    if (tr#0 != null)
    {
    ...
    assume true;
    assert tr#0 == null || ConstantFieldReceiverNonNull.Trait.x1(tr#0) == LitInt(7);
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(901,5)
    assert {:subsumption 0} tr#0 != null;
    newtype$check#3 := LitInt(7);
    assert LitInt(6) <= newtype$check#3;
    assume true;
    assert ConstantFieldReceiverNonNull.Trait.x1(tr#0) == LitInt(7);
}
