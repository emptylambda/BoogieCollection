...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/join_return2.c -bpl ./join_return2.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/join_return2.c", 11, 4} true;
  ...
  assume {:sourceloc "test/c/pthread/join_return2.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($i2p.i64.ref(5));
  assume {:sourceloc "test/c/pthread/join_return2.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/join_return2.c", 17, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/join_return2.c", 17, 4} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  ...
  $M.0 := $i2;
  call {:cexpr "x"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/pthread/join_return2.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($i2p.i64.ref(6));
  assume {:sourceloc "test/c/pthread/join_return2.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/join_return2.c", 27, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join_return2.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, t2, $0.ref);
  assume {:sourceloc "test/c/pthread/join_return2.c", 29, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread/join_return2.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $p2);
  assume {:sourceloc "test/c/pthread/join_return2.c", 30, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.2, $p1);
  assume {:sourceloc "test/c/pthread/join_return2.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $p3);
  assume {:sourceloc "test/c/pthread/join_return2.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/join_return2.c", 31, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/join_return2.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/join_return2.c", 32, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/pthread/join_return2.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
