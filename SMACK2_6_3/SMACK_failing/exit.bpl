...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/failing/exit.c -bpl ./exit.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i4: i1;
$bb0:
  assume {:sourceloc "test/c/failing/exit.c", 10, 4} true;
  ...
  assume {:sourceloc "test/c/failing/exit.c", 11, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "test/c/failing/exit.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 2);
  assume {:sourceloc "test/c/failing/exit.c", 11, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/failing/exit.c", 12, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/failing/exit.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($i2p.i64.ref(6));
  assume {:sourceloc "test/c/failing/exit.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/failing/exit.c", 23, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/failing/exit.c", 24, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/failing/exit.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_join($i3, $p1);
  assume {:sourceloc "test/c/failing/exit.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/failing/exit.c", 25, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/failing/exit.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
