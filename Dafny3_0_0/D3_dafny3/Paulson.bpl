// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy -print:./Paulson.bpl
...
axiom (forall a#18#0#0: Box, a#18#1#0: DatatypeType :: 
  { #_module.LList.Cons(a#18#0#0, a#18#1#0) } 
  DatatypeCtorId(#_module.LList.Cons(a#18#0#0, a#18#1#0)) == ##_module.LList.Cons);
...
axiom (forall d: DatatypeType :: 
  ...
  _module.LList.Cons_q(d)
     ==> (exists a#19#0#0: Box, a#19#1#0: DatatypeType :: 
      d == #_module.LList.Cons(a#19#0#0, a#19#1#0)));

// Constructor $Is
axiom (forall _module.LList$T: Ty, a#20#0#0: Box, a#20#1#0: DatatypeType :: 
  { $Is(#_module.LList.Cons(a#20#0#0, a#20#1#0), Tclass._module.LList(_module.LList$T)) } 
  $Is(#_module.LList.Cons(a#20#0#0, a#20#1#0), Tclass._module.LList(_module.LList$T))
     <==> $IsBox(a#20#0#0, _module.LList$T)
       && $Is(a#20#1#0, Tclass._module.LList(_module.LList$T)));

// Constructor $IsAlloc
axiom (forall _module.LList$T: Ty, a#21#0#0: Box, a#21#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.LList.Cons(a#21#0#0, a#21#1#0), 
      Tclass._module.LList(_module.LList$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.LList.Cons(a#21#0#0, a#21#1#0), 
        Tclass._module.LList(_module.LList$T), 
        $h)
       <==> $IsAllocBox(a#21#0#0, _module.LList$T, $h)
         && $IsAlloc(a#21#1#0, Tclass._module.LList(_module.LList$T), $h)));
...
axiom (forall a#22#0#0: Box, a#22#1#0: DatatypeType :: 
  { #_module.LList.Cons(a#22#0#0, a#22#1#0) } 
  _module.LList.head(#_module.LList.Cons(a#22#0#0, a#22#1#0)) == a#22#0#0);

function _module.LList.tail(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#23#0#0: Box, a#23#1#0: DatatypeType :: 
  { #_module.LList.Cons(a#23#0#0, a#23#1#0) } 
  _module.LList.tail(#_module.LList.Cons(a#23#0#0, a#23#1#0)) == a#23#1#0);
...
axiom (forall a#24#0#0: Box :: 
  { #_module.FunctionHandle.FH(a#24#0#0) } 
  DatatypeCtorId(#_module.FunctionHandle.FH(a#24#0#0))
...
axiom (forall d: DatatypeType :: 
  { _module.FunctionHandle.FH_q(d) } 
  _module.FunctionHandle.FH_q(d)
     ==> (exists a#25#0#0: Box :: d == #_module.FunctionHandle.FH(a#25#0#0)));
...
// Constructor $Is
axiom (forall _module.FunctionHandle$T: Ty, a#26#0#0: Box :: 
  { $Is(#_module.FunctionHandle.FH(a#26#0#0), 
      Tclass._module.FunctionHandle(_module.FunctionHandle$T)) } 
  $Is(#_module.FunctionHandle.FH(a#26#0#0), 
      Tclass._module.FunctionHandle(_module.FunctionHandle$T))
     <==> $IsBox(a#26#0#0, _module.FunctionHandle$T));

// Constructor $IsAlloc
axiom (forall _module.FunctionHandle$T: Ty, a#27#0#0: Box, $h: Heap :: 
  { $IsAlloc(#_module.FunctionHandle.FH(a#27#0#0), 
      Tclass._module.FunctionHandle(_module.FunctionHandle$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.FunctionHandle.FH(a#27#0#0), 
        Tclass._module.FunctionHandle(_module.FunctionHandle$T), 
        $h)
       <==> $IsAllocBox(a#27#0#0, _module.FunctionHandle$T, $h)));
...
axiom (forall a#28#0#0: Box :: 
  { #_module.FunctionHandle.FH(Lit(a#28#0#0)) } 
  #_module.FunctionHandle.FH(Lit(a#28#0#0))
     == Lit(#_module.FunctionHandle.FH(a#28#0#0)));

function _module.FunctionHandle._h0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#29#0#0: Box :: 
  { #_module.FunctionHandle.FH(a#29#0#0) } 
  _module.FunctionHandle._h0(#_module.FunctionHandle.FH(a#29#0#0)) == a#29#0#0);

// Inductive rank
axiom (forall a#30#0#0: Box :: 
  { #_module.FunctionHandle.FH(a#30#0#0) } 
  BoxRank(a#30#0#0) < DtRank(#_module.FunctionHandle.FH(a#30#0#0)));
...
procedure CheckWellformed$$_module.__default.Apply(_module._default.Apply$T: Ty, 
    f#0: DatatypeType
...
procedure CheckWellformed$$_module.__default.After(_module._default.After$_T0: Ty, 
    f#0: DatatypeType
...
procedure CheckWellformed$$_module.__default.Definition__After(_module._default.Definition_After$T: Ty, 
    f#0: DatatypeType
...
procedure Call$$_module.__default.Definition__After(_module._default.Definition_After$T: Ty, 
    f#0: DatatypeType
       where $Is(f#0, Tclass._module.FunctionHandle(_module._default.Definition_After$T))
         && $IsAlloc(f#0, Tclass._module.FunctionHandle(_module._default.Definition_After$T), $Heap)
         && $IsA#_module.FunctionHandle(f#0), 
  ...
  ensures _module.__default.Apply(_module._default.Definition_After$T, 
      _module.__default.After(_module._default.Definition_After$T, f#0, g#0), 
      arg#0)
...
procedure CheckWellformed$$_module.__default.Lmap(_module._default.Lmap$_T0: Ty, 
    f#0: DatatypeType
...
implementation CheckWellformed$$_module.__default.Lmap(_module._default.Lmap$_T0: Ty, f#0: DatatypeType, a#0: DatatypeType)
{
  ...
  var b$reqreads#1: bool;
    ...
    // AddWellformednessCheck for function Lmap
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(19,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        assume $Is(_module.__default.Lmap(_module._default.Lmap$_T0, $LS($LZ), f#0, a#0), 
          Tclass._module.LList(_module._default.Lmap$_T0));
        assume false;
    }
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        if (a#0 == #_module.LList.Nil())
        {
            assume _module.__default.Lmap(_module._default.Lmap$_T0, $LS($LZ), f#0, a#0)
               == Lit(#_module.LList.Nil());
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.Lmap(_module._default.Lmap$_T0, $LS($LZ), f#0, a#0), 
              Tclass._module.LList(_module._default.Lmap$_T0));
        }
        else if (a#0 == #_module.LList.Cons(_mcc#0#0, _mcc#1#0))
        {
            assume $IsBox(_mcc#0#0, _module._default.Lmap$_T0);
            assume $Is(_mcc#1#0, Tclass._module.LList(_module._default.Lmap$_T0));
            havoc xs#Z#0;
            assume $Is(xs#Z#0, Tclass._module.LList(_module._default.Lmap$_T0));
            assume let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass._module.LList(_module._default.Lmap$_T0));
            assume xs#Z#0 == let#0#0#0;
            havoc x#Z#0;
            assume $IsBox(x#Z#0, _module._default.Lmap$_T0);
            assume let#1#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(let#1#0#0, _module._default.Lmap$_T0);
            assume x#Z#0 == let#1#0#0;
            ##f#0 := f#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#0, Tclass._module.FunctionHandle(_module._default.Lmap$_T0), $Heap);
            ##argument#0 := x#Z#0;
            // assume allocatedness for argument to function
            assume $IsAllocBox(##argument#0, _module._default.Lmap$_T0, $Heap);
            b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assume _module.__default.Apply#canCall(_module._default.Lmap$_T0, f#0, x#Z#0);
            ##f#1 := f#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#1, Tclass._module.FunctionHandle(_module._default.Lmap$_T0), $Heap);
            ##a#0 := xs#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##a#0, Tclass._module.LList(_module._default.Lmap$_T0), $Heap);
            b$reqreads#1 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assume _module.__default.Lmap#canCall(_module._default.Lmap$_T0, f#0, xs#Z#0);
            assume _module.__default.Lmap(_module._default.Lmap$_T0, $LS($LZ), f#0, a#0)
               == #_module.LList.Cons(_module.__default.Apply(_module._default.Lmap$_T0, f#0, x#Z#0), 
                _module.__default.Lmap(_module._default.Lmap$_T0, $LS($LZ), f#0, xs#Z#0));
            assume _module.__default.Apply#canCall(_module._default.Lmap$_T0, f#0, x#Z#0)
               && _module.__default.Lmap#canCall(_module._default.Lmap$_T0, f#0, xs#Z#0);
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.Lmap(_module._default.Lmap$_T0, $LS($LZ), f#0, a#0), 
              Tclass._module.LList(_module._default.Lmap$_T0));
        }
...
procedure CheckWellformed$$_module.__default.Lappend(_module._default.Lappend$_T0: Ty, 
    a#0: DatatypeType
...
implementation CheckWellformed$$_module.__default.Lappend(_module._default.Lappend$_T0: Ty, a#0: DatatypeType, b#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var _mcc#0#0: Box;
  var _mcc#1#0: DatatypeType;
  ...
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function Lappend
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(26,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        assume $Is(_module.__default.Lappend(_module._default.Lappend$_T0, $LS($LZ), a#0, b#0), 
          Tclass._module.LList(_module._default.Lappend$_T0));
        assume false;
    }
    else
    {
        ...
        if (a#0 == #_module.LList.Nil())
        {
            assume _module.__default.Lappend(_module._default.Lappend$_T0, $LS($LZ), a#0, b#0)
               == b#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.Lappend(_module._default.Lappend$_T0, $LS($LZ), a#0, b#0), 
        ...
        {
            assume $IsBox(_mcc#0#0, _module._default.Lappend$_T0);
            assume $Is(_mcc#1#0, Tclass._module.LList(_module._default.Lappend$_T0));
            havoc xs#Z#0;
            assume $Is(xs#Z#0, Tclass._module.LList(_module._default.Lappend$_T0));
            assume let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass._module.LList(_module._default.Lappend$_T0));
            assume xs#Z#0 == let#0#0#0;
            havoc x#Z#0;
            assume $IsBox(x#Z#0, _module._default.Lappend$_T0);
            assume let#1#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(let#1#0#0, _module._default.Lappend$_T0);
            assume x#Z#0 == let#1#0#0;
            ##a#0 := xs#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##a#0, Tclass._module.LList(_module._default.Lappend$_T0), $Heap);
            ##b#0 := b#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##b#0, Tclass._module.LList(_module._default.Lappend$_T0), $Heap);
            b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assume _module.__default.Lappend#canCall(_module._default.Lappend$_T0, xs#Z#0, b#0);
            assume _module.__default.Lappend(_module._default.Lappend$_T0, $LS($LZ), a#0, b#0)
               == #_module.LList.Cons(x#Z#0, 
                _module.__default.Lappend(_module._default.Lappend$_T0, $LS($LZ), xs#Z#0, b#0));
            assume _module.__default.Lappend#canCall(_module._default.Lappend$_T0, xs#Z#0, b#0);
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.Lappend(_module._default.Lappend$_T0, $LS($LZ), a#0, b#0), 
              Tclass._module.LList(_module._default.Lappend$_T0));
...
procedure CheckWellformed$$_module.__default.Example6(_module._default.Example6$_T0: Ty, 
    f#0: DatatypeType
...
procedure Call$$_module.__default.Example6(_module._default.Example6$_T0: Ty, 
    f#0: DatatypeType
       where $Is(f#0, Tclass._module.FunctionHandle(_module._default.Example6$_T0))
         && $IsAlloc(f#0, Tclass._module.FunctionHandle(_module._default.Example6$_T0), $Heap)
         && $IsA#_module.FunctionHandle(f#0), 
  ...
  free ensures $IsA#_module.LList(_module.__default.Lmap(_module._default.Example6$_T0, 
    ...
    _module.__default.Lmap#canCall(_module._default.Example6$_T0, g#0, M#0)
     && _module.__default.Lmap#canCall(_module._default.Example6$_T0, 
      f#0, 
      _module.__default.Lmap(_module._default.Example6$_T0, $LS($LZ), g#0, M#0));
  ensures $Eq#_module.LList(_module._default.Example6$_T0, 
...
procedure {:_induction _k#0, f#1, g#1, M#1} CoCall$$_module.__default.Example6_h(_module._default.Example6#$_T0: Ty, 
    _k#0: Box, 
    f#1: DatatypeType
  ...
  free ensures $PrefixEq#_module.LList(_module._default.Example6#$_T0, 
    _module._default.Example6#$_T0, 
    _k#0, 
    $LS($LS($LZ)), 
    _module.__default.Lmap(_module._default.Example6#$_T0, 
...
procedure {:_induction _k#0, f#1, g#1, M#1} Impl$$_module.__default.Example6_h(_module._default.Example6#$_T0: Ty, 
    _k#0: Box, 
    f#1: DatatypeType
       where $Is(f#1, Tclass._module.FunctionHandle(_module._default.Example6#$_T0))
         && $IsAlloc(f#1, Tclass._module.FunctionHandle(_module._default.Example6#$_T0), $Heap)
  ...
  free ensures _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
    ...
    _module.__default.Lmap#canCall(_module._default.Example6#$_T0, g#1, M#1)
     && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
      f#1, 
      _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, M#1));
  ensures $PrefixEq#_module.LList(_module._default.Example6#$_T0, 
      _module._default.Example6#$_T0, 
      _k#0, 
      $LS($LS($LZ)), 
      _module.__default.Lmap(_module._default.Example6#$_T0, 
...
implementation {:_induction _k#0, f#1, g#1, M#1} Impl$$_module.__default.Example6_h(_module._default.Example6#$_T0: Ty, 
    _k#0: Box, 
    f#1: DatatypeType, 
    g#1: DatatypeType, 
    M#1: DatatypeType)
   returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#1: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(35,15): initial state"} true;
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(37,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        ...
        else if (M#1 == #_module.LList.Cons(_mcc#0#0, _mcc#1#0))
        {
            ...
            // ----- calc statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
            // Assume Fuel Constant
            if (*)
            {
                // ----- assert wf[initial] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                ##f#46 := f#1;
                // assume allocatedness for argument to function
                ...
                ##f#47 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
            ...
            {
                // ----- assume wf[lhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                ##f#42 := f#1;
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#43 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    _module.__default.After(_module._default.Example6#$_T0, f#1, g#1), 
                    M#1);
                // ----- Hint0 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                ##f#44 := f#1;
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#45 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    _module.__default.After(_module._default.Example6#$_T0, f#1, g#1), 
                    #_module.LList.Cons(x#0, xs#0));
                // ----- assert line0 == line1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                assert {:subsumption 0} $Eq#_module.LList(_module._default.Example6#$_T0, 
                  _module._default.Example6#$_T0, 
                  $LS($LS($LZ)), 
                  _module.__default.Lmap(_module._default.Example6#$_T0, 
                    $LS($LS($LZ)), 
            ...
            else if (*)
            {
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#37 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    _module.__default.After(_module._default.Example6#$_T0, f#1, g#1), 
                    #_module.LList.Cons(x#0, xs#0));
                // ----- Hint1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                ##f#38 := f#1;
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#39 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#41 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                  ...
                  _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    _module.__default.After(_module._default.Example6#$_T0, f#1, g#1), 
                    xs#0);
                // ----- assert line1 == line2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                assert {:subsumption 0} $Eq#_module.LList(_module._default.Example6#$_T0, 
                  _module._default.Example6#$_T0, 
                  $LS($LS($LZ)), 
                  _module.__default.Lmap(_module._default.Example6#$_T0, 
            ...
            else if (*)
            {
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#29 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#31 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                  ...
                  _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    _module.__default.After(_module._default.Example6#$_T0, f#1, g#1), 
                    xs#0);
                // ----- Hint2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(46,25)
                ...
                call Call$$_module.__default.Definition__After(_module._default.Example6#$_T0, f##0, g##0, arg##0);
                // TrCallStmt: After ProcessCallStmt
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(46,33)"} true;
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                ##f#32 := g#1;
                // assume allocatedness for argument to function
                ...
                ##argument#10 := _module.__default.Apply(_module._default.Example6#$_T0, g#1, x#0);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#35 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Apply#canCall(_module._default.Example6#$_T0, g#1, x#0)
                  ...
                  _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    _module.__default.After(_module._default.Example6#$_T0, f#1, g#1), 
                    xs#0);
                // ----- assert line2 == line3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                assert {:subsumption 0} $Eq#_module.LList(_module._default.Example6#$_T0, 
                  _module._default.Example6#$_T0, 
                  $LS($LS($LZ)), 
                  #_module.LList.Cons(_module.__default.Apply(_module._default.Example6#$_T0, 
            ...
            else if (*)
            {
                ...
                ##argument#5 := _module.__default.Apply(_module._default.Example6#$_T0, g#1, x#0);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1);
                assume _module.FunctionHandle.FH_q(_module.__default.After(_module._default.Example6#$_T0, f#1, g#1));
                ##f#23 := _module.__default.After(_module._default.Example6#$_T0, f#1, g#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Apply#canCall(_module._default.Example6#$_T0, g#1, x#0)
                  ...
                  _module.__default.After#canCall(_module._default.Example6#$_T0, f#1, g#1)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    _module.__default.After(_module._default.Example6#$_T0, f#1, g#1), 
                    xs#0);
                // ----- Hint3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                assume true;
                ##f#24 := g#1;
                // assume allocatedness for argument to function
                ...
                ##argument#7 := _module.__default.Apply(_module._default.Example6#$_T0, g#1, x#0);
                // assume allocatedness for argument to function
                ...
                ##a#17 := _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, xs#0);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Apply#canCall(_module._default.Example6#$_T0, g#1, x#0)
                  ...
                  _module.__default.Lmap#canCall(_module._default.Example6#$_T0, g#1, xs#0)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    f#1, 
                    _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, xs#0));
                // ----- assert line3 ==# line4 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                assert {:subsumption 0} $PrefixEq#_module.LList(_module._default.Example6#$_T0, 
                    _module._default.Example6#$_T0, 
                    _k#0, 
                    $LS($LS($LZ)), 
                    #_module.LList.Cons(_module.__default.Apply(_module._default.Example6#$_T0, 
            ...
            else if (*)
            {
                ...
                ##argument#2 := _module.__default.Apply(_module._default.Example6#$_T0, g#1, x#0);
                // assume allocatedness for argument to function
                ...
                ##a#12 := _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, xs#0);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Apply#canCall(_module._default.Example6#$_T0, g#1, x#0)
                  ...
                  _module.__default.Lmap#canCall(_module._default.Example6#$_T0, g#1, xs#0)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    f#1, 
                    _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, xs#0));
                // ----- Hint4 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                ##f#17 := g#1;
                // assume allocatedness for argument to function
                ...
                ##a#14 := #_module.LList.Cons(_module.__default.Apply(_module._default.Example6#$_T0, g#1, x#0), 
                  _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, xs#0));
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Apply#canCall(_module._default.Example6#$_T0, g#1, x#0)
                   ...
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    ...
                    #_module.LList.Cons(_module.__default.Apply(_module._default.Example6#$_T0, g#1, x#0), 
                      _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, xs#0)));
                // ----- assert line4 == line5 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                assert {:subsumption 0} $Eq#_module.LList(_module._default.Example6#$_T0, 
                  _module._default.Example6#$_T0, 
                  $LS($LS($LZ)), 
                  #_module.LList.Cons(_module.__default.Apply(_module._default.Example6#$_T0, 
            ...
            else if (*)
            {
                ...
                ##a#8 := #_module.LList.Cons(_module.__default.Apply(_module._default.Example6#$_T0, g#1, x#0), 
                  _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, xs#0));
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Apply#canCall(_module._default.Example6#$_T0, g#1, x#0)
                   ...
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    ...
                    #_module.LList.Cons(_module.__default.Apply(_module._default.Example6#$_T0, g#1, x#0), 
                      _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, xs#0)));
                // ----- Hint5 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                ##f#11 := g#1;
                // assume allocatedness for argument to function
                assume $IsAlloc(##f#11, Tclass._module.FunctionHandle(_module._default.Example6#$_T0), $Heap);
                ##a#9 := #_module.LList.Cons(x#0, xs#0);
                // assume allocatedness for argument to function
                ...
                ##a#10 := _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, #_module.LList.Cons(x#0, xs#0));
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Lmap#canCall(_module._default.Example6#$_T0, g#1, #_module.LList.Cons(x#0, xs#0))
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    f#1, 
                    _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, #_module.LList.Cons(x#0, xs#0)));
                // ----- assert line5 == line6 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                assert {:subsumption 0} $Eq#_module.LList(_module._default.Example6#$_T0, 
                  _module._default.Example6#$_T0, 
                  $LS($LS($LZ)), 
                  _module.__default.Lmap(_module._default.Example6#$_T0, 
            ...
            else if (*)
            {
                ...
                ##a#3 := #_module.LList.Cons(x#0, xs#0);
                // assume allocatedness for argument to function
                ...
                ##a#4 := _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, #_module.LList.Cons(x#0, xs#0));
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Lmap#canCall(_module._default.Example6#$_T0, g#1, #_module.LList.Cons(x#0, xs#0))
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    f#1, 
                    _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, #_module.LList.Cons(x#0, xs#0)));
                // ----- Hint6 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                ##f#6 := g#1;
                // assume allocatedness for argument to function
                ...
                ##a#6 := _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, M#1);
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Lmap#canCall(_module._default.Example6#$_T0, g#1, M#1)
                   && _module.__default.Lmap#canCall(_module._default.Example6#$_T0, 
                    f#1, 
                    _module.__default.Lmap(_module._default.Example6#$_T0, $LS($LZ), g#1, M#1));
                // ----- assert line6 == line7 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(41,5)
                assert {:subsumption 0} $Eq#_module.LList(_module._default.Example6#$_T0, 
                  _module._default.Example6#$_T0, 
                  $LS($LS($LZ)), 
                  _module.__default.Lmap(_module._default.Example6#$_T0, 
            ...
            assume $PrefixEq#_module.LList(_module._default.Example6#$_T0, 
              _module._default.Example6#$_T0, 
              _k#0, 
              $LS($LS($LZ)), 
              _module.__default.Lmap(_module._default.Example6#$_T0, 
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(35,16)
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(35,15)"} true;
    }
}
...
procedure CheckWellformed$$_module.__default.Iterates(_module._default.Iterates$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
        Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Iterates$A))), 
    M#0: DatatypeType
...
implementation CheckWellformed$$_module.__default.Iterates(_module._default.Iterates$A: Ty, f#0: DatatypeType, M#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##f#0: DatatypeType;
  var ##argument#0: DatatypeType;
  var ##f#1: DatatypeType;
  ...
  var b$reqreads#1: bool;
    ...
    // AddWellformednessCheck for function Iterates
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(62,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        assume $Is(_module.__default.Iterates(_module._default.Iterates$A, $LS($LZ), f#0, M#0), 
          Tclass._module.LList(Tclass._module.LList(_module._default.Iterates$A)));
        assume false;
    }
    else
    {
        ...
        ##argument#0 := M#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##argument#0, Tclass._module.LList(_module._default.Iterates$A), $Heap);
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Iterates$A), f#0, $Box(M#0));
        ##f#1 := f#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##f#1, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Iterates$A)), 
          $Heap);
        ##M#0 := $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Iterates$A), f#0, $Box(M#0))): DatatypeType;
        // assume allocatedness for argument to function
        assume $IsAlloc(##M#0, Tclass._module.LList(_module._default.Iterates$A), $Heap);
        b$reqreads#1 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume _module.__default.Iterates#canCall(_module._default.Iterates$A, 
          f#0, 
          $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Iterates$A), f#0, $Box(M#0))): DatatypeType);
        assume _module.__default.Iterates(_module._default.Iterates$A, $LS($LZ), f#0, M#0)
           == #_module.LList.Cons($Box(M#0), 
            _module.__default.Iterates(_module._default.Iterates$A, 
              $LS($LZ), 
              f#0, 
...
procedure CheckWellformed$$_module.__default.Eq24(_module._default.Eq24$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
...
procedure Call$$_module.__default.Eq24(_module._default.Eq24$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24$A)))
         && $IsAlloc(f#0, 
  ...
  free ensures $IsA#_module.LList(_module.__default.Lmap(Tclass._module.LList(_module._default.Eq24$A), 
    ...
    _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24$A), f#0, $Box(M#0))
     && _module.__default.Iterates#canCall(_module._default.Eq24$A, 
      f#0, 
      $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24$A), f#0, $Box(M#0))): DatatypeType);
  ensures $Eq#_module.LList(Tclass._module.LList(_module._default.Eq24$A), 
...
procedure {:_induction _k#0, f#1, M#1} CoCall$$_module.__default.Eq24_h(_module._default.Eq24#$A: Ty, 
    _k#0: Box, 
    f#1: DatatypeType
       where $Is(f#1, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)))
  ...
  free ensures $PrefixEq#_module.LList(Tclass._module.LList(_module._default.Eq24#$A), 
    Tclass._module.LList(_module._default.Eq24#$A), 
    _k#0, 
    $LS($LS($LZ)), 
    _module.__default.Lmap(Tclass._module.LList(_module._default.Eq24#$A), 
...
procedure {:_induction _k#0, f#1, M#1} Impl$$_module.__default.Eq24_h(_module._default.Eq24#$A: Ty, 
    _k#0: Box, 
    f#1: DatatypeType
       where $Is(f#1, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)))
  ...
  free ensures _module.__default.Iterates#canCall(_module._default.Eq24#$A, f#1, M#1)
    ...
    _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))
     && _module.__default.Iterates#canCall(_module._default.Eq24#$A, 
      f#1, 
      $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType);
  ensures $PrefixEq#_module.LList(Tclass._module.LList(_module._default.Eq24#$A), 
      Tclass._module.LList(_module._default.Eq24#$A), 
      _k#0, 
      $LS($LS($LZ)), 
      _module.__default.Lmap(Tclass._module.LList(_module._default.Eq24#$A), 
...
implementation {:_induction _k#0, f#1, M#1} Impl$$_module.__default.Eq24_h(_module._default.Eq24#$A: Ty, _k#0: Box, f#1: DatatypeType, M#1: DatatypeType)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  ...
  var $initHeapForallStmt#1: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(67,15): initial state"} true;
    assume $IsA#_module.FunctionHandle(f#1);
    assume $IsA#_module.LList(M#1);
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(69,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- calc statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
        // Assume Fuel Constant
        if (*)
        {
            // ----- assert wf[initial] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            ##f#40 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#40, 
              Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)), 
        ...
        {
            // ----- assume wf[lhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            ##f#35 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#35, 
              Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)), 
            ...
            assume _module.__default.Iterates#canCall(_module._default.Eq24#$A, f#1, M#1)
               && _module.__default.Lmap#canCall(Tclass._module.LList(_module._default.Eq24#$A), 
                f#1, 
                _module.__default.Iterates(_module._default.Eq24#$A, $LS($LZ), f#1, M#1));
            // ----- Hint0 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            ##f#37 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#37, 
              Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)), 
               ...
               && _module.__default.Lmap#canCall(Tclass._module.LList(_module._default.Eq24#$A), 
                ...
                #_module.LList.Cons($Box(M#1), 
                  _module.__default.Iterates(_module._default.Eq24#$A, 
                    ...
                    f#1, 
                    $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType)));
            // ----- assert line0 == line1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.Eq24#$A), 
              Tclass._module.LList(_module._default.Eq24#$A), 
              $LS($LS($LZ)), 
              _module.__default.Lmap(Tclass._module.LList(_module._default.Eq24#$A), 
                $LS($LS($LZ)), 
               ...
               && _module.__default.Lmap#canCall(Tclass._module.LList(_module._default.Eq24#$A), 
                ...
                #_module.LList.Cons($Box(M#1), 
                  _module.__default.Iterates(_module._default.Eq24#$A, 
                    ...
                    f#1, 
                    $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType)));
            // ----- Hint1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            ##f#31 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#31, 
              ...
              _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))
               ...
               && _module.__default.Lmap#canCall(Tclass._module.LList(_module._default.Eq24#$A), 
                ...
                _module.__default.Iterates(_module._default.Eq24#$A, 
                  ...
                  f#1, 
                  $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType));
            // ----- assert line1 == line2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.Eq24#$A), 
              Tclass._module.LList(_module._default.Eq24#$A), 
              $LS($LS($LZ)), 
              _module.__default.Lmap(Tclass._module.LList(_module._default.Eq24#$A), 
        ...
        else if (*)
        {
              ...
              _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))
               ...
               && _module.__default.Lmap#canCall(Tclass._module.LList(_module._default.Eq24#$A), 
                ...
                _module.__default.Iterates(_module._default.Eq24#$A, 
                  ...
                  f#1, 
                  $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType));
            // ----- Hint2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            // ----- calc statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(75,7)
            // Assume Fuel Constant
            if (*)
            {
                // ----- assert wf[initial] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(75,7)
                ##f#21 := f#1;
                // assume allocatedness for argument to function
                assume $IsAlloc(##f#21, 
                  Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)), 
            ...
            {
                // ----- assume wf[lhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(75,7)
                ##f#14 := f#1;
                // assume allocatedness for argument to function
                assume $IsAlloc(##f#14, 
                  Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)), 
                ...
                assume _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))
                   ...
                   && _module.__default.Lmap#canCall(Tclass._module.LList(_module._default.Eq24#$A), 
                    ...
                    _module.__default.Iterates(_module._default.Eq24#$A, 
                      ...
                      f#1, 
                      $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType));
                // ----- Hint0 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(75,7)
                // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(77,23)
                // TrCallStmt: Before ProcessCallStmt
                ...
                assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
                // ProcessCallStmt: Make the call
                call CoCall$$_module.__default.Eq24_h(_module._default.Eq24#$A, _k##0, f##0, M##0);
                // TrCallStmt: After ProcessCallStmt
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(77,38)"} true;
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(75,7)
                assert ORD#IsNat(Lit(ORD#FromNat(1)));
                assert ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
                assume true;
                ##f#18 := f#1;
                ...
                assume $IsAlloc(##f#19, 
                  Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)), 
                  $Heap);
                ##argument#10 := $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType;
                // assume allocatedness for argument to function
                ...
                assume _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))
                   ...
                   && _module.__default.Iterates#canCall(_module._default.Eq24#$A, 
                    ...
                    $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), 
                        f#1, 
                        _module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1)))): DatatypeType);
                // ----- assert line0 ==# line1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(75,7)
                assert {:subsumption 0} $PrefixEq#_module.LList(Tclass._module.LList(_module._default.Eq24#$A), 
                    Tclass._module.LList(_module._default.Eq24#$A), 
                    ORD#Minus(_k#0, ORD#FromNat(1)), 
                    $LS($LS($LZ)), 
                    _module.__default.Lmap(Tclass._module.LList(_module._default.Eq24#$A), 
            ...
            assume $PrefixEq#_module.LList(Tclass._module.LList(_module._default.Eq24#$A), 
              Tclass._module.LList(_module._default.Eq24#$A), 
              ORD#Minus(_k#0, ORD#FromNat(1)), 
              $LS($LS($LZ)), 
              _module.__default.Lmap(Tclass._module.LList(_module._default.Eq24#$A), 
            ...
            assume $IsAlloc(##f#26, 
              Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)), 
              $Heap);
            ##argument#14 := $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType;
            // assume allocatedness for argument to function
              ...
              _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))
               ...
               && _module.__default.Iterates#canCall(_module._default.Eq24#$A, 
                ...
                $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), 
                    f#1, 
                    _module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1)))): DatatypeType);
            // ----- assert line2 ==# line3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            assert {:subsumption 0} $PrefixEq#_module.LList(Tclass._module.LList(_module._default.Eq24#$A), 
                Tclass._module.LList(_module._default.Eq24#$A), 
                _k#0, 
                $LS($LS($LZ)), 
        ...
        else if (*)
        {
            ...
            assume $IsAlloc(##f#6, 
              Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Eq24#$A)), 
              $Heap);
            ##argument#3 := $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType;
            // assume allocatedness for argument to function
              ...
              _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))
               ...
               && _module.__default.Iterates#canCall(_module._default.Eq24#$A, 
                ...
                $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), 
                    f#1, 
                    _module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1)))): DatatypeType);
            // ----- Hint3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            ##f#8 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#8, 
            ...
            assume _module.__default.Apply#canCall(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))
               && _module.__default.Iterates#canCall(_module._default.Eq24#$A, 
                f#1, 
                $Unbox(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1))): DatatypeType);
            // ----- assert line3 == line4 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(70,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.Eq24#$A), 
              Tclass._module.LList(_module._default.Eq24#$A), 
              $LS($LS($LZ)), 
              #_module.LList.Cons(_module.__default.Apply(Tclass._module.LList(_module._default.Eq24#$A), f#1, $Box(M#1)), 
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(67,16)
        $initHeapForallStmt#1 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#1 == $Heap;
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(67,15)"} true;
    }
}



procedure {:_induction f#0, M#0} CheckWellformed$$_module.__default.CorollaryEq24(_module._default.CorollaryEq24$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
...
procedure {:_induction f#0, M#0} Call$$_module.__default.CorollaryEq24(_module._default.CorollaryEq24$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.CorollaryEq24$A)))
         && $IsAlloc(f#0, 
  ...
  ensures $Eq#_module.LList(Tclass._module.LList(_module._default.CorollaryEq24$A), 
...
procedure {:_induction f#0, M#0} Impl$$_module.__default.CorollaryEq24(_module._default.CorollaryEq24$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.CorollaryEq24$A)))
         && $IsAlloc(f#0, 
...
implementation {:_induction f#0, M#0} Impl$$_module.__default.CorollaryEq24(_module._default.CorollaryEq24$A: Ty, f#0: DatatypeType, M#0: DatatypeType)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  ...
  var M##0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(88,0): initial state"} true;
         ...
         ==> $Eq#_module.LList(Tclass._module.LList(_module._default.CorollaryEq24$A), 
          ...
          #_module.LList.Cons($Box($ih#M0#0), 
            _module.__default.Lmap(Tclass._module.LList(_module._default.CorollaryEq24$A), 
              ...
              _module.__default.Iterates(_module._default.CorollaryEq24$A, $LS($LZ), $ih#f0#0, $ih#M0#0)))));
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(89,7)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    f##0 := f#0;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.__default.Eq24(_module._default.CorollaryEq24$A, f##0, M##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(89,12)"} true;
}
...
procedure CheckWellformed$$_module.__default.h(_module._default.h$A: Ty, 
    f#0: DatatypeType
...
procedure CheckWellformed$$_module.__default.Definition__h(_module._default.Definition_h$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
...
procedure Call$$_module.__default.Definition__h(_module._default.Definition_h$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Definition_h$A)))
         && $IsAlloc(f#0, 
  ...
  ensures $Eq#_module.LList(Tclass._module.LList(_module._default.Definition_h$A), 
...
procedure CheckWellformed$$_module.__default.Iter(_module._default.Iter$A: Ty, 
...
implementation CheckWellformed$$_module.__default.Iter(_module._default.Iter$A: Ty, n#0: int, f#0: DatatypeType, arg#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##n#0: int;
  var ##f#0: DatatypeType;
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(103,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume _module.__default.Iter(_module._default.Iter$A, $LS($LZ), n#0, f#0, arg#0)
               == arg#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(_module.__default.Iter(_module._default.Iter$A, $LS($LZ), n#0, f#0, arg#0), 
        ...
        else
        {
            ...
            assert ##n#0 < n#0 || (##n#0 == n#0 && DtRank(##f#0) < DtRank(f#0));
...
procedure CheckWellformed$$_module.__default.LmapIter(_module._default.LmapIter$_T0: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
...
implementation CheckWellformed$$_module.__default.LmapIter(_module._default.LmapIter$_T0: Ty, 
    n#0: int, 
    f#0: DatatypeType, 
    arg#0: DatatypeType)
{
  ...
  var b$reqreads#1: bool;
    ...
    // AddWellformednessCheck for function LmapIter
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(108,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume _module.__default.LmapIter(_module._default.LmapIter$_T0, $LS($LZ), n#0, f#0, arg#0)
               == arg#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.LmapIter(_module._default.LmapIter$_T0, $LS($LZ), n#0, f#0, arg#0), 
...
procedure {:_induction n#0, f#0, M#0} CheckWellformed$$_module.__default.Lemma25(_module._default.Lemma25$A: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
...
procedure {:_induction n#0, f#0, M#0} Call$$_module.__default.Lemma25(_module._default.Lemma25$A: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
       where $Is(f#0, Tclass._module.FunctionHandle(_module._default.Lemma25$A))
         && $IsAlloc(f#0, Tclass._module.FunctionHandle(_module._default.Lemma25$A), $Heap)
  ...
  ensures $Eq#_module.LList(_module._default.Lemma25$A, 
...
procedure {:_induction n#0, f#0, M#0} Impl$$_module.__default.Lemma25(_module._default.Lemma25$A: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
       where $Is(f#0, Tclass._module.FunctionHandle(_module._default.Lemma25$A))
         && $IsAlloc(f#0, Tclass._module.FunctionHandle(_module._default.Lemma25$A), $Heap)
...
implementation {:_induction n#0, f#0, M#0} Impl$$_module.__default.Lemma25(_module._default.Lemma25$A: Ty, 
    n#0: int, 
    f#0: DatatypeType, 
    b#0: Box, 
    M#0: DatatypeType)
   returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#0: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(115,0): initial state"} true;
    assume $IsA#_module.FunctionHandle(f#0);
    assume $IsA#_module.LList(M#0);
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
...
procedure {:_induction n#0, f#0, x#0} CheckWellformed$$_module.__default.Lemma26(_module._default.Lemma26$A: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
...
implementation {:_induction n#0, f#0, x#0} CheckWellformed$$_module.__default.Lemma26(_module._default.Lemma26$A: Ty, n#0: int, f#0: DatatypeType, x#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##f#0: DatatypeType;
  var ##a#0: DatatypeType;
  ...
  var ##arg#1: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(119,6): initial state"} true;
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(120,37): post-state"} true;
    ##f#0 := f#0;
    // assume allocatedness for argument to function
    ...
    assume $Eq#_module.LList(_module._default.Lemma26$A, 
...
procedure {:_induction n#0, f#0, x#0} Call$$_module.__default.Lemma26(_module._default.Lemma26$A: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
       where $Is(f#0, Tclass._module.FunctionHandle(_module._default.Lemma26$A))
         && $IsAlloc(f#0, Tclass._module.FunctionHandle(_module._default.Lemma26$A), $Heap)
  ...
  ensures $Eq#_module.LList(_module._default.Lemma26$A, 
    _module._default.Lemma26$A, 
    $LS($LS($LZ)), 
    _module.__default.LmapIter(_module._default.Lemma26$A, 
      $LS($LS($LZ)), 
...
procedure {:_induction n#0, f#0, x#0} Impl$$_module.__default.Lemma26(_module._default.Lemma26$A: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
       where $Is(f#0, Tclass._module.FunctionHandle(_module._default.Lemma26$A))
         && $IsAlloc(f#0, Tclass._module.FunctionHandle(_module._default.Lemma26$A), $Heap)
...
implementation {:_induction n#0, f#0, x#0} Impl$$_module.__default.Lemma26(_module._default.Lemma26$A: Ty, n#0: int, f#0: DatatypeType, x#0: DatatypeType)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(121,0): initial state"} true;
    assume $IsA#_module.FunctionHandle(f#0);
...
procedure CheckWellformed$$_module.__default.BisimulationLemma(_module._default.BisimulationLemma$A: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
       where $Is(f#0, 
...
procedure Call$$_module.__default.BisimulationLemma(_module._default.BisimulationLemma$A: Ty, 
    n#0: int where LitInt(0) <= n#0, 
    f#0: DatatypeType
       where $Is(f#0, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.BisimulationLemma$A)))
  ...
  free ensures $IsA#_module.LList(_module.__default.LmapIter(Tclass._module.LList(_module._default.BisimulationLemma$A), 
    ...
    _module.__default.Iterates#canCall(_module._default.BisimulationLemma$A, f#0, u#0)
     && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma$A), 
      ...
      f#0, 
      _module.__default.Iterates(_module._default.BisimulationLemma$A, $LS($LZ), f#0, u#0));
  ensures $Eq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma$A), 
...
procedure {:_induction _k#0, n#1, f#1, u#1} CoCall$$_module.__default.BisimulationLemma_h(_module._default.BisimulationLemma#$A: Ty, 
    _k#0: Box, 
  ...
  free ensures $PrefixEq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
    Tclass._module.LList(_module._default.BisimulationLemma#$A), 
    _k#0, 
    $LS($LS($LZ)), 
    _module.__default.LmapIter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
...
procedure {:_induction _k#0, n#1, f#1, u#1} Impl$$_module.__default.BisimulationLemma_h(_module._default.BisimulationLemma#$A: Ty, 
    _k#0: Box, 
    n#1: int where LitInt(0) <= n#1, 
    f#1: DatatypeType
       where $Is(f#1, 
  ...
  free ensures _module.__default.h#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
    ...
    _module.__default.Iterates#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
     && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
      ...
      f#1, 
      _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1));
  ensures $PrefixEq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
      Tclass._module.LList(_module._default.BisimulationLemma#$A), 
      _k#0, 
      $LS($LS($LZ)), 
      _module.__default.LmapIter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
...
implementation {:_induction _k#0, n#1, f#1, u#1} Impl$$_module.__default.BisimulationLemma_h(_module._default.BisimulationLemma#$A: Ty, 
    _k#0: Box, 
    n#1: int, 
    f#1: DatatypeType, 
    u#1: DatatypeType)
   returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#1: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(125,15): initial state"} true;
    assume $IsA#_module.FunctionHandle(f#1);
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(127,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- calc statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
        // Assume Fuel Constant
        if (*)
        {
            // ----- assert wf[initial] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            ##f#60 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#60, 
              Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.BisimulationLemma#$A)), 
        ...
        {
            // ----- assume wf[lhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            ##f#55 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#55, 
              Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.BisimulationLemma#$A)), 
            ...
            assume _module.__default.h#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                f#1, 
                _module.__default.h(_module._default.BisimulationLemma#$A, f#1, u#1));
            // ----- Hint0 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(130,19)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            f##5 := f#1;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Definition__h(_module._default.BisimulationLemma#$A, f##5, M##3);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(130,24)"} true;
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            ##f#57 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#57, 
              Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.BisimulationLemma#$A)), 
               ...
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                #_module.LList.Cons($Box(u#1), 
                  _module.__default.Lmap(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                    ...
                    f#1, 
                    _module.__default.h(_module._default.BisimulationLemma#$A, f#1, u#1))));
            // ----- assert line0 == line1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              $LS($LS($LZ)), 
              _module.__default.LmapIter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                $LS($LS($LZ)), 
        ...
        else if (*)
        {
               ...
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                #_module.LList.Cons($Box(u#1), 
                  _module.__default.Lmap(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                    ...
                    f#1, 
                    _module.__default.h(_module._default.BisimulationLemma#$A, f#1, u#1))));
            // ----- Hint1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(132,14)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            n##3 := n#1;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Lemma25(Tclass._module.LList(_module._default.BisimulationLemma#$A), n##3, f##4, $Box(b##1), M##2);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(132,40)"} true;
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            ##n#23 := n#1;
            // assume allocatedness for argument to function
              ...
              _module.__default.h#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               ...
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                _module.__default.Lmap(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                  ...
                  f#1, 
                  _module.__default.h(_module._default.BisimulationLemma#$A, f#1, u#1)));
            // ----- assert line1 == line2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              $LS($LS($LZ)), 
              _module.__default.LmapIter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
        ...
        else if (*)
        {
              ...
              _module.__default.h#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               ...
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                _module.__default.Lmap(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                  ...
                  f#1, 
                  _module.__default.h(_module._default.BisimulationLemma#$A, f#1, u#1)));
            // ----- Hint2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(134,14)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            n##2 := n#1;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Lemma26(Tclass._module.LList(_module._default.BisimulationLemma#$A), n##2, f##3, x##1);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(134,28)"} true;
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            ##n#20 := n#1;
            // assume allocatedness for argument to function
            ...
            assume _module.__default.Iter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), n#1, f#1, $Box(u#1))
              ...
              _module.__default.h#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                f#1, 
                _module.__default.h(_module._default.BisimulationLemma#$A, f#1, u#1));
            // ----- assert line2 == line3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              $LS($LS($LZ)), 
              #_module.LList.Cons(_module.__default.Iter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
        ...
        else if (*)
        {
            ...
            assume _module.__default.Iter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), n#1, f#1, $Box(u#1))
              ...
              _module.__default.h#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                f#1, 
                _module.__default.h(_module._default.BisimulationLemma#$A, f#1, u#1));
            // ----- Hint3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            // ----- calc statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(137,5)
            // Assume Fuel Constant
            if (*)
            {
                // ----- assert wf[initial] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(137,5)
                ##f#33 := f#1;
                // assume allocatedness for argument to function
                assume $IsAlloc(##f#33, 
                  Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.BisimulationLemma#$A)), 
            ...
            {
                // ----- assume wf[lhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(137,5)
                ##f#29 := f#1;
                // assume allocatedness for argument to function
                assume $IsAlloc(##f#29, 
                  Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.BisimulationLemma#$A)), 
                ...
                assume _module.__default.h#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
                   && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                    ...
                    f#1, 
                    _module.__default.h(_module._default.BisimulationLemma#$A, f#1, u#1));
                // ----- Hint0 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(137,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(137,5)
                assert ORD#IsNat(Lit(ORD#FromNat(1)));
                assert ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
                assume true;
                ##f#31 := f#1;
                ...
                assume _module.__default.Iterates#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
                   && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                    ...
                    f#1, 
                    _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1));
                // ----- assert line0 ==# line1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(137,5)
                assert {:subsumption 0} $PrefixEq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                    Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                    ORD#Minus(_k#0, ORD#FromNat(1)), 
                    $LS($LS($LZ)), 
                    _module.__default.LmapIter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
            ...
            assume $PrefixEq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              ORD#Minus(_k#0, ORD#FromNat(1)), 
              $LS($LS($LZ)), 
              _module.__default.LmapIter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
            ...
            assume _module.__default.Iter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), n#1, f#1, $Box(u#1))
              ...
              _module.__default.Iterates#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                f#1, 
                _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1));
            // ----- assert line3 ==# line4 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            assert {:subsumption 0} $PrefixEq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                _k#0, 
                $LS($LS($LZ)), 
        ...
        else if (*)
        {
            ...
            assume _module.__default.Iter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), n#1, f#1, $Box(u#1))
              ...
              _module.__default.Iterates#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                f#1, 
                _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1));
            // ----- Hint4 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(143,14)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            n##1 := n#1;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Lemma26(Tclass._module.LList(_module._default.BisimulationLemma#$A), n##1, f##2, x##0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(143,35)"} true;
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            ##n#9 := n#1;
            // assume allocatedness for argument to function
              ...
              _module.__default.Iterates#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               ...
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                _module.__default.Lmap(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                  ...
                  f#1, 
                  _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1)));
            // ----- assert line4 == line5 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              $LS($LS($LZ)), 
              #_module.LList.Cons(_module.__default.Iter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
        ...
        else if (*)
        {
              ...
              _module.__default.Iterates#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               ...
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                _module.__default.Lmap(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                  ...
                  f#1, 
                  _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1)));
            // ----- Hint5 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(145,14)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            n##0 := n#1;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Lemma25(Tclass._module.LList(_module._default.BisimulationLemma#$A), n##0, f##1, $Box(b##0), M##1);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(145,47)"} true;
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            ##f#15 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#15, 
               ...
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                #_module.LList.Cons($Box(u#1), 
                  _module.__default.Lmap(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                    ...
                    f#1, 
                    _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1))));
            // ----- assert line5 == line6 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              $LS($LS($LZ)), 
              #_module.LList.Cons(_module.__default.Iter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
        ...
        else if (*)
        {
               ...
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                #_module.LList.Cons($Box(u#1), 
                  _module.__default.Lmap(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                    ...
                    f#1, 
                    _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1))));
            // ----- Hint6 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(147,20)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            f##0 := f#1;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.CorollaryEq24(_module._default.BisimulationLemma#$A, f##0, M##0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(147,25)"} true;
            // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            ##f#7 := f#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#7, 
            ...
            assume _module.__default.Iterates#canCall(_module._default.BisimulationLemma#$A, f#1, u#1)
               && _module.__default.LmapIter#canCall(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
                ...
                f#1, 
                _module.__default.Iterates(_module._default.BisimulationLemma#$A, $LS($LZ), f#1, u#1));
            // ----- assert line6 == line7 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(128,3)
            assert {:subsumption 0} $Eq#_module.LList(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              Tclass._module.LList(_module._default.BisimulationLemma#$A), 
              $LS($LS($LZ)), 
              _module.__default.LmapIter(Tclass._module.LList(_module._default.BisimulationLemma#$A), 
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(125,16)
        $initHeapForallStmt#1 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#1 == $Heap;
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(125,15)"} true;
    }
}



procedure {:_induction f#0} CheckWellformed$$_module.__default.Example7(_module._default.Example7$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
...
procedure {:_induction f#0} Call$$_module.__default.Example7(_module._default.Example7$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Example7$A)))
         && $IsAlloc(f#0, 
...
procedure {:_induction f#0} Impl$$_module.__default.Example7(_module._default.Example7$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, 
          Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Example7$A)))
         && $IsAlloc(f#0, 
...
implementation {:_induction f#0} Impl$$_module.__default.Example7(_module._default.Example7$A: Ty, f#0: DatatypeType)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  ...
  var $initHeapForallStmt#1: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(155,0): initial state"} true;
    assume $IsA#_module.FunctionHandle(f#0);
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#f0#0: DatatypeType :: 
      $Is($ih#f0#0, 
            Tclass._module.FunctionHandle(Tclass._module.LList(_module._default.Example7$A)))
           && Lit(true)
           && DtRank($ih#f0#0) < DtRank(f#0)
         ==> (forall M#2: DatatypeType :: 
          { _module.__default.Iterates(_module._default.Example7$A, $LS($LZ), $ih#f0#0, M#2) } 
            { _module.__default.h(_module._default.Example7$A, $ih#f0#0, M#2) } 
          $Is(M#2, Tclass._module.LList(_module._default.Example7$A))
             ==> $Eq#_module.LList(Tclass._module.LList(_module._default.Example7$A), 
              Tclass._module.LList(_module._default.Example7$A), 
              $LS($LS($LZ)), 
              _module.__default.h(_module._default.Example7$A, $ih#f0#0, M#2), 
              _module.__default.Iterates(_module._default.Example7$A, $LS($LZ), $ih#f0#0, M#2))));
    $_reverifyPost := false;
    // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(156,3)
    if (*)
    {
        // Assume Fuel Constant
        havoc M#3;
        assume $Is(M#3, Tclass._module.LList(_module._default.Example7$A));
        assume true;
        assume true;
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(157,22)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        ...
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        // ProcessCallStmt: Make the call
        call Call$$_module.__default.BisimulationLemma(_module._default.Example7$A, n##0, f##0, u##0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(157,30)"} true;
        assume false;
    }
    else
    {
        ...
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#1 == $Heap;
        assume (forall M#4: DatatypeType :: 
          { _module.__default.Iterates(_module._default.Example7$A, $LS($LZ), f#0, M#4) } 
            { _module.__default.h(_module._default.Example7$A, f#0, M#4) } 
          $Is(M#4, Tclass._module.LList(_module._default.Example7$A)) && Lit(true)
             ==> $Eq#_module.LList(Tclass._module.LList(_module._default.Example7$A), 
              Tclass._module.LList(_module._default.Example7$A), 
              $LS($LS($LZ)), 
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(158,2)"} true;
}



procedure CheckWellformed$$_module.__default.Example8(_module._default.Example8$A: Ty, 
    f#0: DatatypeType
...
procedure Call$$_module.__default.Example8(_module._default.Example8$A: Ty, 
    f#0: DatatypeType
       where $Is(f#0, Tclass._module.FunctionHandle(_module._default.Example8$A))
         && $IsAlloc(f#0, Tclass._module.FunctionHandle(_module._default.Example8$A), $Heap)
         && $IsA#_module.FunctionHandle(f#0), 
  ...
  free ensures $IsA#_module.LList(_module.__default.Lmap(_module._default.Example8$A, 
    ...
    _module.__default.Lmap#canCall(_module._default.Example8$A, f#0, M#0)
     ...
     && _module.__default.Lappend#canCall(_module._default.Example8$A, 
      _module.__default.Lmap(_module._default.Example8$A, $LS($LZ), f#0, M#0), 
      _module.__default.Lmap(_module._default.Example8$A, $LS($LZ), f#0, N#0));
  ensures $Eq#_module.LList(_module._default.Example8$A, 
...
procedure {:_induction _k#0, f#1, M#1, N#1} CoCall$$_module.__default.Example8_h(_module._default.Example8#$A: Ty, 
    _k#0: Box, 
    f#1: DatatypeType
  ...
  free ensures $PrefixEq#_module.LList(_module._default.Example8#$A, 
    _module._default.Example8#$A, 
    _k#0, 
    $LS($LS($LZ)), 
    _module.__default.Lmap(_module._default.Example8#$A, 
...
procedure {:_induction _k#0, f#1, M#1, N#1} Impl$$_module.__default.Example8_h(_module._default.Example8#$A: Ty, 
    _k#0: Box, 
    f#1: DatatypeType
       where $Is(f#1, Tclass._module.FunctionHandle(_module._default.Example8#$A))
         && $IsAlloc(f#1, Tclass._module.FunctionHandle(_module._default.Example8#$A), $Heap)
  ...
  free ensures _module.__default.Lappend#canCall(_module._default.Example8#$A, M#1, N#1)
    ...
    _module.__default.Lmap#canCall(_module._default.Example8#$A, f#1, M#1)
     ...
     && _module.__default.Lappend#canCall(_module._default.Example8#$A, 
      _module.__default.Lmap(_module._default.Example8#$A, $LS($LZ), f#1, M#1), 
      _module.__default.Lmap(_module._default.Example8#$A, $LS($LZ), f#1, N#1));
  ensures $PrefixEq#_module.LList(_module._default.Example8#$A, 
      _module._default.Example8#$A, 
      _k#0, 
      $LS($LS($LZ)), 
      _module.__default.Lmap(_module._default.Example8#$A, 
...
implementation {:_induction _k#0, f#1, M#1, N#1} Impl$$_module.__default.Example8_h(_module._default.Example8#$A: Ty, 
    _k#0: Box, 
    f#1: DatatypeType, 
    M#1: DatatypeType, 
    N#1: DatatypeType)
   returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#1: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(163,15): initial state"} true;
    assume $IsA#_module.FunctionHandle(f#1);
    assume $IsA#_module.LList(M#1);
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(165,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
    }
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(163,16)
        $initHeapForallStmt#1 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#1 == $Heap;
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(163,15)"} true;
    }
}



procedure CheckWellformed$$_module.__default.Associativity(_module._default.Associativity$_T0: Ty, 
    a#0: DatatypeType
...
procedure Call$$_module.__default.Associativity(_module._default.Associativity$_T0: Ty, 
    a#0: DatatypeType
       where $Is(a#0, Tclass._module.LList(_module._default.Associativity$_T0))
         && $IsAlloc(a#0, Tclass._module.LList(_module._default.Associativity$_T0), $Heap)
         && $IsA#_module.LList(a#0), 
  ...
  free ensures $IsA#_module.LList(_module.__default.Lappend(_module._default.Associativity$_T0, 
    ...
    _module.__default.Lappend#canCall(_module._default.Associativity$_T0, b#0, c#0)
     && _module.__default.Lappend#canCall(_module._default.Associativity$_T0, 
      a#0, 
      _module.__default.Lappend(_module._default.Associativity$_T0, $LS($LZ), b#0, c#0));
  ensures $Eq#_module.LList(_module._default.Associativity$_T0, 
...
procedure {:_induction _k#0, a#1, b#1, c#1} CoCall$$_module.__default.Associativity_h(_module._default.Associativity#$_T0: Ty, 
    _k#0: Box, 
    a#1: DatatypeType
  ...
  free ensures $PrefixEq#_module.LList(_module._default.Associativity#$_T0, 
    _module._default.Associativity#$_T0, 
    _k#0, 
    $LS($LS($LZ)), 
    _module.__default.Lappend(_module._default.Associativity#$_T0, 
...
procedure {:_induction _k#0, a#1, b#1, c#1} Impl$$_module.__default.Associativity_h(_module._default.Associativity#$_T0: Ty, 
    _k#0: Box, 
    a#1: DatatypeType
       where $Is(a#1, Tclass._module.LList(_module._default.Associativity#$_T0))
         && $IsAlloc(a#1, Tclass._module.LList(_module._default.Associativity#$_T0), $Heap)
  ...
  free ensures _module.__default.Lappend#canCall(_module._default.Associativity#$_T0, a#1, b#1)
    ...
    _module.__default.Lappend#canCall(_module._default.Associativity#$_T0, b#1, c#1)
     && _module.__default.Lappend#canCall(_module._default.Associativity#$_T0, 
      a#1, 
      _module.__default.Lappend(_module._default.Associativity#$_T0, $LS($LZ), b#1, c#1));
  ensures $PrefixEq#_module.LList(_module._default.Associativity#$_T0, 
      _module._default.Associativity#$_T0, 
      _k#0, 
      $LS($LS($LZ)), 
      _module.__default.Lappend(_module._default.Associativity#$_T0, 
...
implementation {:_induction _k#0, a#1, b#1, c#1} Impl$$_module.__default.Associativity_h(_module._default.Associativity#$_T0: Ty, 
    _k#0: Box, 
    a#1: DatatypeType, 
    b#1: DatatypeType, 
    c#1: DatatypeType)
   returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#1: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(169,15): initial state"} true;
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(171,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
    }
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(169,16)
        $initHeapForallStmt#1 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#1 == $Heap;
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/Paulson.dfy(169,15)"} true;
    }
}
