...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/simple_pre3_fail.c -bpl ./simple_pre3_fail.bpl
...
const returnOne: ref;
axiom (returnOne == $sub.ref(0, 1032));
procedure {:inline 1} returnOne()
  returns ($r: i32)
{
$bb0:
  assume {:sourceloc "test/c/basic/simple_pre3_fail.c", 7, 19} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/simple_pre3_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/simple_pre3_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/simple_pre3_fail.c", 14, 3} true;
...
$bb6:
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "test/c/basic/simple_pre3_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
