// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy -print:./Bug159.bpl
...
procedure CheckWellformed$$_module.__default.ArrayInit(n#0: int where LitInt(0) <= n#0)
   returns (a#0: ref
...
implementation CheckWellformed$$_module.__default.ArrayInit(n#0: int) returns (a#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#0: int;

    // AddMethodImpl: ArrayInit, CheckWellformed$$_module.__default.ArrayInit
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(4,7): initial state"} true;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
    ...
    havoc a#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(5,19): post-state"} true;
    assert a#0 != null;
    ...
    if (*)
    {
        ...
        assume $Unbox(read($Heap, a#0, IndexField(i#0))): int == i#0;
    }
    else
    {
        assume LitInt(0) <= i#0 && i#0 < n#0
           ==> $Unbox(read($Heap, a#0, IndexField(i#0))): int == i#0;
    }
    ...
    assume (forall i#1: int :: 
      ...
      true
        ...
        LitInt(0) <= i#1 && i#1 < n#0
         ==> $Unbox(read($Heap, a#0, IndexField(i#1))): int == i#1);
}



procedure Call$$_module.__default.ArrayInit(n#0: int where LitInt(0) <= n#0)
   returns (a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap));
  modifies $Heap, $Tick;
...
procedure Impl$$_module.__default.ArrayInit(n#0: int where LitInt(0) <= n#0)
   returns (a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap), 
    $_reverifyPost: bool);
...
implementation Impl$$_module.__default.ArrayInit(n#0: int) returns (a#0: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $nw: ref;
  var i#2: int;
  ...
  var $prevHeap: Heap;
    ...
    // AddMethodImpl: ArrayInit, Impl$$_module.__default.ArrayInit
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(7,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(8,5)
    assume true;
    assert 0 <= n#0;
    havoc $nw;
    ...
    a#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(8,17)"} true;
    // ----- forall statement (assign) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(9,3)
    if (*)
    {
        ...
        assume i#2 != i#3;
        assert a#0 != a#0 || IndexField(i#2) != IndexField(i#3) || i#2 == i#3;
        assume false;
    }
    else
    {
        ...
        assume (forall<alpha> $o: ref, $f: Field alpha :: 
          ...
          read($Heap, $o, $f) == read($prevHeap, $o, $f)
             || (exists i#4: int :: 
              LitInt(0) <= i#4 && i#4 < n#0 && $o == a#0 && $f == IndexField(i#4)));
        assume (forall i#inv#0: int :: 
          { read($Heap, a#0, IndexField(i#inv#0)) } 
          LitInt(0) <= i#inv#0 && i#inv#0 < n#0
             ==> read($Heap, a#0, IndexField(i#inv#0)) == $Box(i#inv#0));
    }

    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(11,2)"} true;
}



procedure CheckWellformed$$_module.__default.Init(m#0: ref
...
implementation CheckWellformed$$_module.__default.Init(m#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#0: int;
  var j#0: int;

    // AddMethodImpl: Init, CheckWellformed$$_module.__default.Init
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> $o == m#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(14,7): initial state"} true;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && read(old($Heap), $o, alloc)
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(16,10): post-state"} true;
    havoc i#0;
    havoc j#0;
    assume true;
    if (*)
    {
        ...
        assume $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#0), j#0))): int
           == LitInt(0);
    }
    else
    {
        assume LitInt(0) <= i#0
           ...
           ==> $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#0), j#0))): int
             == LitInt(0);
    }

    assume (forall i#1: int, j#1: int :: 
      { $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int } 
      true
         ==> 
        LitInt(0) <= i#1
...
procedure Call$$_module.__default.Init(m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap));
  modifies $Heap, $Tick;
  // user-defined postconditions
...
procedure Impl$$_module.__default.Init(m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap))
...
implementation Impl$$_module.__default.Init(m#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#2: int;
  var j#2: int;
  ...
  var $prevHeap: Heap;
    ...
    // AddMethodImpl: Init, Impl$$_module.__default.Init
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> $o == m#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(17,0): initial state"} true;
    $_reverifyPost := false;
    // ----- forall statement (assign) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(18,3)
    if (*)
    {
        // Assume Fuel Constant
        havoc i#2;
        ...
        if (LitInt(0) <= i#2 && i#2 < _System.array2.Length0(m#0))
        {
            if (LitInt(0) <= j#2)
            {
                assert {:subsumption 0} m#0 != null;
        ...
        assume true;
        assert $_Frame[m#0, MultiIndexField(IndexField(i#2), j#2)];
        assume true;
        havoc i#3;
        havoc j#3;
        assume true;
        assume LitInt(0) <= i#3
           && i#3 < _System.array2.Length0(m#0)
           && 
          LitInt(0) <= j#3
           && j#3 < _System.array2.Length1(m#0);
        assume !(i#2 == i#3 && j#2 == j#3);
        assert m#0 != m#0
           || MultiIndexField(IndexField(i#2), j#2) != MultiIndexField(IndexField(i#3), j#3)
           || LitInt(0) == LitInt(0);
        assume false;
    }
    else
             ...
             || (exists i#4: int, j#4: int :: 
              LitInt(0) <= i#4
                ...
                LitInt(0) <= j#4
                 ...
                 && $o == m#0
                 && $f == MultiIndexField(IndexField(i#4), j#4)));
        assume (forall i#4: int, j#4: int :: 
          LitInt(0) <= i#4
               && i#4 < _System.array2.Length0(m#0)
               && 
              LitInt(0) <= j#4
               && j#4 < _System.array2.Length1(m#0)
             ==> read($Heap, m#0, MultiIndexField(IndexField(i#4), j#4)) == $Box(LitInt(0)));
    }

    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(20,2)"} true;
}



procedure CheckWellformed$$_module.__default.Gradient(n#0: int where LitInt(0) <= n#0)
   returns (m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap));
...
implementation CheckWellformed$$_module.__default.Gradient(n#0: int) returns (m#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#0: int;
  var j#0: int;

    // AddMethodImpl: Gradient, CheckWellformed$$_module.__default.Gradient
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(23,7): initial state"} true;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && read(old($Heap), $o, alloc) ==> $Heap[$o] == old($Heap)[$o]);
    assume $HeapSucc(old($Heap), $Heap);
    havoc m#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(24,20): post-state"} true;
    assert m#0 != null;
    assert m#0 != null;
    if (_System.array2.Length0(m#0) == _System.array2.Length1(m#0))
    {
        assert m#0 != null;
    }

    assume _System.array2.Length0(m#0) == _System.array2.Length1(m#0)
       && _System.array2.Length1(m#0) == n#0;
    havoc i#0;
    havoc j#0;
    assume true;
    if (*)
    ...
    {
        assume LitInt(0) <= i#0 && i#0 < n#0 && LitInt(0) <= j#0 && j#0 < n#0
           ==> $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#0), j#0))): int
             == j#0 + i#0;
    }
    ...
    assume (forall i#1: int, j#1: int :: 
      ...
      true
         ==> 
        LitInt(0) <= i#1 && i#1 < n#0 && LitInt(0) <= j#1 && j#1 < n#0
         ==> $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int
           == j#1 + i#1);
}
...
procedure Call$$_module.__default.Gradient(n#0: int where LitInt(0) <= n#0)
   returns (m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap));
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
  ensures _System.array2.Length0(m#0) == _System.array2.Length1(m#0);
  ensures _System.array2.Length1(m#0) == n#0;
  free ensures true;
  ensures (forall i#1: int, j#1: int :: 
    { $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int } 
    true
...
procedure Impl$$_module.__default.Gradient(n#0: int where LitInt(0) <= n#0)
   returns (m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap), 
    $_reverifyPost: bool);
...
implementation Impl$$_module.__default.Gradient(n#0: int) returns (m#0: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $nw: ref;
  var i#2: int;
  ...
  var $prevHeap: Heap;
    ...
    // AddMethodImpl: Gradient, Impl$$_module.__default.Gradient
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(26,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(27,5)
    assume true;
    assert 0 <= n#0;
    assert 0 <= n#0;
    havoc $nw;
    ...
    assume $IsHeapAnchor($Heap);
    m#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(27,19)"} true;
    // ----- forall statement (assign) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(28,3)
    if (*)
    {
        // Assume Fuel Constant
        havoc i#2;
        ...
        assume true;
        assume LitInt(0) <= i#2 && i#2 < n#0 && LitInt(0) <= j#2 && j#2 < n#0;
        assert m#0 != null;
        assert {:subsumption 0} 0 <= i#2 && i#2 < _System.array2.Length0(m#0);
        assert {:subsumption 0} 0 <= j#2 && j#2 < _System.array2.Length1(m#0);
        assume true;
        ...
        havoc j#3;
        assume true;
        assume LitInt(0) <= i#3 && i#3 < n#0 && LitInt(0) <= j#3 && j#3 < n#0;
        assume !(i#2 == i#3 && j#2 == j#3);
        assert m#0 != m#0
           || MultiIndexField(IndexField(i#2), j#2) != MultiIndexField(IndexField(i#3), j#3)
           || i#2 + j#2 == i#3 + j#3;
             ...
             || (exists i#4: int, j#4: int :: 
              LitInt(0) <= i#4
                ...
                LitInt(0) <= j#4
                 ...
                 && $f == MultiIndexField(IndexField(i#4), j#4)));
        assume (forall i#4: int, j#4: int :: 
          LitInt(0) <= i#4 && i#4 < n#0 && LitInt(0) <= j#4 && j#4 < n#0
             ==> read($Heap, m#0, MultiIndexField(IndexField(i#4), j#4)) == $Box(i#4 + j#4));
    }

    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(30,2)"} true;
}



procedure CheckWellformed$$_module.__default.M3(C#0: ref
       where $Is(C#0, Tclass._System.array3(TReal))
         && $IsAlloc(C#0, Tclass._System.array3(TReal), $Heap));
  free requires 7 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.M3(C#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#0: int;
  var j#0: int;
  var k#0: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(33,7): initial state"} true;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && read(old($Heap), $o, alloc)
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(35,10): post-state"} true;
    havoc i#0;
    havoc j#0;
    havoc k#0;
    assume true;
    if (*)
    {
        assume LitInt(0) <= i#0;
        assert C#0 != null;
        assume i#0 < _System.array3.Length0(C#0);
        assume LitInt(0) <= j#0;
        assert C#0 != null;
        assume j#0 < _System.array3.Length1(C#0);
        assume LitInt(0) <= k#0;
        assert C#0 != null;
        assume k#0 < _System.array3.Length2(C#0);
        assert C#0 != null;
        assert 0 <= i#0 && i#0 < _System.array3.Length0(C#0);
        assert 0 <= j#0 && j#0 < _System.array3.Length1(C#0);
        assert 0 <= k#0 && k#0 < _System.array3.Length2(C#0);
        assume $Unbox(read($Heap, C#0, MultiIndexField(MultiIndexField(IndexField(i#0), j#0), k#0))): real
           == LitReal(0e0);
    }
    else
    {
        assume LitInt(0) <= i#0
             && i#0 < _System.array3.Length0(C#0)
             && 
            LitInt(0) <= j#0
             && j#0 < _System.array3.Length1(C#0)
             && 
            LitInt(0) <= k#0
             && k#0 < _System.array3.Length2(C#0)
           ==> $Unbox(read($Heap, C#0, MultiIndexField(MultiIndexField(IndexField(i#0), j#0), k#0))): real
             == LitReal(0e0);
    }

    assume (forall i#1: int, j#1: int, k#1: int :: 
      { $Unbox(read($Heap, C#0, MultiIndexField(MultiIndexField(IndexField(i#1), j#1), k#1))): real } 
      true
         ==> 
        LitInt(0) <= i#1
           && i#1 < _System.array3.Length0(C#0)
           && 
          LitInt(0) <= j#1
           && j#1 < _System.array3.Length1(C#0)
           && 
          LitInt(0) <= k#1
           && k#1 < _System.array3.Length2(C#0)
         ==> $Unbox(read($Heap, C#0, MultiIndexField(MultiIndexField(IndexField(i#1), j#1), k#1))): real
           == LitReal(0e0));
}
...
procedure Call$$_module.__default.M3(C#0: ref
  ...
  // user-defined postconditions
  free ensures true;
  ensures (forall i#1: int, j#1: int, k#1: int :: 
    { $Unbox(read($Heap, C#0, MultiIndexField(MultiIndexField(IndexField(i#1), j#1), k#1))): real } 
    true
       ==> 
      LitInt(0) <= i#1
...
implementation Impl$$_module.__default.M3(C#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#2: int;
  var j#2: int;
  ...
  var $prevHeap: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> $o == C#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(38,0): initial state"} true;
    $_reverifyPost := false;
    // ----- forall statement (assign) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(39,3)
    if (*)
    {
        // Assume Fuel Constant
        havoc i#2;
        ...
        if (LitInt(0) <= i#2 && i#2 < _System.array3.Length0(C#0))
        {
            if (LitInt(0) <= j#2)
            {
                assert {:subsumption 0} C#0 != null;
        ...
        if (LitInt(0) <= i#2
           && i#2 < _System.array3.Length0(C#0)
           && 
          LitInt(0) <= j#2
           && j#2 < _System.array3.Length1(C#0))
        {
            if (LitInt(0) <= k#2)
            {
                assert {:subsumption 0} C#0 != null;
        ...
        assume LitInt(0) <= i#2
          ...
          LitInt(0) <= j#2
           ...
           && 
          LitInt(0) <= k#2
           && k#2 < _System.array3.Length2(C#0);
        assert C#0 != null;
        assert {:subsumption 0} 0 <= i#2 && i#2 < _System.array3.Length0(C#0);
        assert {:subsumption 0} 0 <= j#2 && j#2 < _System.array3.Length1(C#0);
        assert {:subsumption 0} 0 <= k#2 && k#2 < _System.array3.Length2(C#0);
        assume true;
        assert $_Frame[C#0, MultiIndexField(MultiIndexField(IndexField(i#2), j#2), k#2)];
        assume true;
        havoc i#3;
        havoc j#3;
        havoc k#3;
        assume true;
        assume LitInt(0) <= i#3
           && i#3 < _System.array3.Length0(C#0)
           && 
          LitInt(0) <= j#3
           && j#3 < _System.array3.Length1(C#0)
           && 
          LitInt(0) <= k#3
           && k#3 < _System.array3.Length2(C#0);
        assume !(i#2 == i#3 && j#2 == j#3 && k#2 == k#3);
        assert C#0 != C#0
           || MultiIndexField(MultiIndexField(IndexField(i#2), j#2), k#2)
             != MultiIndexField(MultiIndexField(IndexField(i#3), j#3), k#3)
           || LitReal(0e0) == LitReal(0e0);
        assume false;
    }
    else
    {
        ...
        assume (forall<alpha> $o: ref, $f: Field alpha :: 
          { read($Heap, $o, $f) } 
          read($Heap, $o, $f) == read($prevHeap, $o, $f)
             || (exists i#4: int, j#4: int, k#4: int :: 
              LitInt(0) <= i#4
                 && i#4 < _System.array3.Length0(C#0)
                 && 
                LitInt(0) <= j#4
                 && j#4 < _System.array3.Length1(C#0)
                 && 
                LitInt(0) <= k#4
                 && k#4 < _System.array3.Length2(C#0)
                 && $o == C#0
                 && $f == MultiIndexField(MultiIndexField(IndexField(i#4), j#4), k#4)));
        assume (forall i#4: int, j#4: int, k#4: int :: 
          LitInt(0) <= i#4
               && i#4 < _System.array3.Length0(C#0)
               && 
              LitInt(0) <= j#4
              ...
              LitInt(0) <= k#4
               && k#4 < _System.array3.Length2(C#0)
             ==> read($Heap, C#0, MultiIndexField(MultiIndexField(IndexField(i#4), j#4), k#4))
               == $Box(LitReal(0e0)));
    }

    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug159.dfy(42,2)"} true;
}
