...
axiom 2 <= $FunctionContextHeight
   ==> (forall TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Static$G: Ty :: 
    ...
    TypeInstantiations.GenCl.Static#canCall(TypeInstantiations.GenCl$U, TypeInstantiations.GenCl.Static$G)
...
procedure CheckWellformed$$TypeInstantiations.GenCl.Static(TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Static$G: Ty);
...
procedure CheckWellformed$$TypeInstantiations.GenCl.Inst(TypeInstantiations.GenCl$U: Ty, 
    TypeInstantiations.GenCl.Inst$G: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TypeInstantiations.GenCl(TypeInstantiations.GenCl$U))
         && $IsAlloc(this, Tclass.TypeInstantiations.GenCl(TypeInstantiations.GenCl$U), $Heap));
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure CheckWellformed$$TypeInstantiations.GenCl.Ms(TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Ms$G: Ty)
   returns (r#0: int);
...
procedure Call$$TypeInstantiations.GenCl.Ms(TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Ms$G: Ty)
   returns (r#0: int);
  modifies $Heap, $Tick;
...
procedure Impl$$TypeInstantiations.GenCl.Ms(TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Ms$G: Ty)
...
procedure CheckWellformed$$TypeInstantiations.GenCl.Mi(TypeInstantiations.GenCl$U: Ty, 
    TypeInstantiations.GenCl.Mi$G: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TypeInstantiations.GenCl(TypeInstantiations.GenCl$U))
...
procedure Call$$TypeInstantiations.GenCl.Mi(TypeInstantiations.GenCl$U: Ty, 
    TypeInstantiations.GenCl.Mi$G: Ty, 
    this: ref
       where this != null
         && 
...
procedure Impl$$TypeInstantiations.GenCl.Mi(TypeInstantiations.GenCl$U: Ty, 
    TypeInstantiations.GenCl.Mi$G: Ty, 
    this: ref
       where this != null
         && 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall TypeInstantiations._default.F$G: Ty :: 
    ...
    TypeInstantiations.__default.F#canCall(TypeInstantiations._default.F$G)
...
procedure CheckWellformed$$TypeInstantiations.__default.F(TypeInstantiations._default.F$G: Ty);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall TypeInstantiations._default.H$G: Ty, g#0: Box :: 
    ...
    TypeInstantiations.__default.H#canCall(TypeInstantiations._default.H$G, g#0)
         || (1 != $FunctionContextHeight && $IsBox(g#0, TypeInstantiations._default.H$G))
       ==> true);
...
procedure CheckWellformed$$TypeInstantiations.__default.H(TypeInstantiations._default.H$G: Ty, 
    g#0: Box where $IsBox(g#0, TypeInstantiations._default.H$G));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure CheckWellformed$$TypeInstantiations.__default.M(TypeInstantiations._default.M$G: Ty) returns (r#0: int);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$TypeInstantiations.__default.M(TypeInstantiations._default.M$G: Ty) returns (r#0: int);
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure Impl$$TypeInstantiations.__default.M(TypeInstantiations._default.M$G: Ty) returns (r#0: int, $_reverifyPost: bool);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure CheckWellformed$$TypeInstantiations.__default.N(TypeInstantiations._default.N$G: Ty, 
    g#0: Box
       where $IsBox(g#0, TypeInstantiations._default.N$G)
         && $IsAllocBox(g#0, TypeInstantiations._default.N$G, $Heap))
   returns (r#0: int);
...
procedure Call$$TypeInstantiations.__default.N(TypeInstantiations._default.N$G: Ty, 
    g#0: Box
       where $IsBox(g#0, TypeInstantiations._default.N$G)
         && $IsAllocBox(g#0, TypeInstantiations._default.N$G, $Heap))
   returns (r#0: int);
...
procedure Impl$$TypeInstantiations.__default.N(TypeInstantiations._default.N$G: Ty, 
    g#0: Box
       where $IsBox(g#0, TypeInstantiations._default.N$G)
         && $IsAllocBox(g#0, TypeInstantiations._default.N$G, $Heap))
   returns (r#0: int, $_reverifyPost: bool);
...
procedure Impl$$TypeInstantiations.__default.TestMain() returns ($_reverifyPost: bool);
  free requires 9 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$TypeInstantiations.__default.TestMain() returns ($_reverifyPost: bool)
{
  ...
  var a0#0: int;
  var cl#0: ref
     where $Is(cl#0, Tclass.TypeInstantiations.GenCl(TChar))
       && $IsAlloc(cl#0, Tclass.TypeInstantiations.GenCl(TChar), $Heap);
  var $nw: ref;
  var a1#0: int;
  var $rhs##0: int;
  var $rhs##1: int;
  ...
  var $rhs##3: int;
    ...
    // AddMethodImpl: TestMain, Impl$$TypeInstantiations.__default.TestMain
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(406,20): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(407,11)
    assume true;
    assume TypeInstantiations.__default.F#canCall(TChar);
    assume TypeInstantiations.__default.F#canCall(TChar);
    x#0 := LitInt(TypeInstantiations.__default.F(TChar));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(407,22)"} true;
    havoc ch#0 /* where $Is(ch#0, TChar) */;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(409,11)
    assume true;
    ##g#0 := ch#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##g#0, TChar, $Heap);
    assume TypeInstantiations.__default.H#canCall(TChar, $Box(ch#0));
    assume TypeInstantiations.__default.H#canCall(TChar, $Box(ch#0));
    y#0 := TypeInstantiations.__default.H(TChar, $Box(ch#0));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(409,18)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(410,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(412,12)
    assume true;
    assume TypeInstantiations.GenCl.Static#canCall(TChar, TReal);
    assume TypeInstantiations.GenCl.Static#canCall(TChar, TReal);
    a0#0 := LitInt(TypeInstantiations.GenCl.Static(TChar, TReal));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(412,40)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(413,12)
    assume true;
    havoc $nw;
    assume $nw != null && dtype($nw) == Tclass.TypeInstantiations.GenCl?(TChar);
    assume !read($Heap, $nw, alloc);
    $Heap := update($Heap, $nw, alloc, true);
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    cl#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(413,29)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(414,12)
    assume true;
    assert cl#0 != null;
    assume TypeInstantiations.GenCl.Inst#canCall(TChar, TReal, cl#0);
    assume TypeInstantiations.GenCl.Inst#canCall(TChar, TReal, cl#0);
    a1#0 := LitInt(TypeInstantiations.GenCl.Inst(TChar, TReal, cl#0));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(414,29)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(415,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(417,17)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##0 := Call$$TypeInstantiations.__default.M(TChar);
    // TrCallStmt: After ProcessCallStmt
    x#0 := $rhs##0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(417,18)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(418,11)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##1 := Call$$TypeInstantiations.__default.N(TChar, $Box(g##0));
    // TrCallStmt: After ProcessCallStmt
    y#0 := $rhs##1;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(418,14)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(419,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(421,31)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##2 := Call$$TypeInstantiations.GenCl.Ms(TChar, TReal);
    // TrCallStmt: After ProcessCallStmt
    a0#0 := $rhs##2;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(421,32)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(422,22)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##3 := Call$$TypeInstantiations.GenCl.Mi(TChar, TReal, cl#0);
    // TrCallStmt: After ProcessCallStmt
    a1#0 := $rhs##3;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(422,23)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(423,5)
    assume true;
    assume true;
    assume true;
    assume true;
