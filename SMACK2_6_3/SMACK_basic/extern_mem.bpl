...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/extern_mem.c -bpl ./extern_mem.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/extern_mem.c", 10, 12} true;
  ...
  assume {:sourceloc "test/c/basic/extern_mem.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call foo();
  assume {:sourceloc "test/c/basic/extern_mem.c", 14, 7} true;
  assume {:verifier.code 0} true;
  call $p2 := bar();
  assume $isExternal($p2);
  assume {:sourceloc "test/c/basic/extern_mem.c", 16, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, 1);
  assume {:sourceloc "test/c/basic/extern_mem.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 2);
  assume {:sourceloc "test/c/basic/extern_mem.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/extern_mem.c", 19, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/extern_mem.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
