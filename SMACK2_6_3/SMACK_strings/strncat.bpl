...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strncat.c -bpl ./strncat.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 26818));
...
axiom (.str.2 == $sub.ref(0, 3082));
const main: ref;
axiom (main == $sub.ref(0, 4114));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strncat.c", 8, 10} true;
  ...
  assume {:sourceloc "test/c/strings/strncat.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := strcpy($p1, .str);
  assume $isExternal($p2);
  assume {:sourceloc "test/c/strings/strncat.c", 11, 11} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 40)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strncat.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $p4 := strncat($p3, .str.1, 2);
  assume $isExternal($p4);
  assume {:sourceloc "test/c/strings/strncat.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strncat.c", 13, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strncat.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 11338));
...
axiom (__VERIFIER_assert == $sub.ref(0, 12370));
...
axiom (__SMACK_and32 == $sub.ref(0, 13402));
...
axiom (__SMACK_and64 == $sub.ref(0, 14434));
...
axiom (__SMACK_and16 == $sub.ref(0, 15466));
...
axiom (__SMACK_and8 == $sub.ref(0, 16498));
...
axiom (__SMACK_or32 == $sub.ref(0, 17530));
...
axiom (__SMACK_or64 == $sub.ref(0, 18562));
...
axiom (__SMACK_or16 == $sub.ref(0, 19594));
...
axiom (__SMACK_or8 == $sub.ref(0, 20626));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 21658));
...
axiom (__SMACK_decls == $sub.ref(0, 22690));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 23722));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 24754));
...
axiom (llvm.dbg.value == $sub.ref(0, 25786));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 26818));
