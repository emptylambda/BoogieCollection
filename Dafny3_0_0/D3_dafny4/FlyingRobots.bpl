// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy -print:./FlyingRobots.bpl
...
axiom (forall _System._tuple#3$T0: Ty, 
    ...
    a#3#2#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#_System._tuple#3._#Make3(a#3#0#0, a#3#1#0, a#3#2#0), 
      Tclass._System.Tuple3(_System._tuple#3$T0, _System._tuple#3$T1, _System._tuple#3$T2), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_System._tuple#3._#Make3(a#3#0#0, a#3#1#0, a#3#2#0), 
        Tclass._System.Tuple3(_System._tuple#3$T0, _System._tuple#3$T1, _System._tuple#3$T2), 
        $h)
       <==> $IsAllocBox(a#3#0#0, _System._tuple#3$T0, $h)
         && $IsAllocBox(a#3#1#0, _System._tuple#3$T1, $h)
         && $IsAllocBox(a#3#2#0, _System._tuple#3$T2, $h)));
...
axiom (forall a#4#0#0: Box, a#4#1#0: Box, a#4#2#0: Box :: 
  { #_System._tuple#3._#Make3(Lit(a#4#0#0), Lit(a#4#1#0), Lit(a#4#2#0)) } 
  #_System._tuple#3._#Make3(Lit(a#4#0#0), Lit(a#4#1#0), Lit(a#4#2#0))
     == Lit(#_System._tuple#3._#Make3(a#4#0#0, a#4#1#0, a#4#2#0)));
...
axiom (forall a#5#0#0: Box, a#5#1#0: Box, a#5#2#0: Box :: 
  ...
  _System.Tuple3._0(#_System._tuple#3._#Make3(a#5#0#0, a#5#1#0, a#5#2#0))
     == a#5#0#0);

// Inductive rank
axiom (forall a#6#0#0: Box, a#6#1#0: Box, a#6#2#0: Box :: 
  { #_System._tuple#3._#Make3(a#6#0#0, a#6#1#0, a#6#2#0) } 
  BoxRank(a#6#0#0) < DtRank(#_System._tuple#3._#Make3(a#6#0#0, a#6#1#0, a#6#2#0)));
...
axiom (forall a#7#0#0: Box, a#7#1#0: Box, a#7#2#0: Box :: 
  ...
  _System.Tuple3._1(#_System._tuple#3._#Make3(a#7#0#0, a#7#1#0, a#7#2#0))
     == a#7#1#0);

// Inductive rank
axiom (forall a#8#0#0: Box, a#8#1#0: Box, a#8#2#0: Box :: 
  { #_System._tuple#3._#Make3(a#8#0#0, a#8#1#0, a#8#2#0) } 
  BoxRank(a#8#1#0) < DtRank(#_System._tuple#3._#Make3(a#8#0#0, a#8#1#0, a#8#2#0)));
...
axiom (forall a#9#0#0: Box, a#9#1#0: Box, a#9#2#0: Box :: 
  ...
  _System.Tuple3._2(#_System._tuple#3._#Make3(a#9#0#0, a#9#1#0, a#9#2#0))
     == a#9#2#0);

// Inductive rank
axiom (forall a#10#0#0: Box, a#10#1#0: Box, a#10#2#0: Box :: 
  { #_System._tuple#3._#Make3(a#10#0#0, a#10#1#0, a#10#2#0) } 
  BoxRank(a#10#2#0)
     < DtRank(#_System._tuple#3._#Make3(a#10#0#0, a#10#1#0, a#10#2#0)));
...
axiom (forall a#11#0#0: Box, a#11#1#0: Box :: 
  ...
  DatatypeCtorId(#_System._tuple#2._#Make2(a#11#0#0, a#11#1#0))
...
axiom (forall d: DatatypeType :: 
  { _System.Tuple2.___hMake2_q(d) } 
  _System.Tuple2.___hMake2_q(d)
     ==> (exists a#12#0#0: Box, a#12#1#0: Box :: 
      d == #_System._tuple#2._#Make2(a#12#0#0, a#12#1#0)));
...
// Constructor $Is
axiom (forall _System._tuple#2$T0: Ty, _System._tuple#2$T1: Ty, a#13#0#0: Box, a#13#1#0: Box :: 
  { $Is(#_System._tuple#2._#Make2(a#13#0#0, a#13#1#0), 
      Tclass._System.Tuple2(_System._tuple#2$T0, _System._tuple#2$T1)) } 
  $Is(#_System._tuple#2._#Make2(a#13#0#0, a#13#1#0), 
      Tclass._System.Tuple2(_System._tuple#2$T0, _System._tuple#2$T1))
     <==> $IsBox(a#13#0#0, _System._tuple#2$T0) && $IsBox(a#13#1#0, _System._tuple#2$T1));
...
axiom (forall _System._tuple#2$T0: Ty, 
    ...
    a#14#1#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#_System._tuple#2._#Make2(a#14#0#0, a#14#1#0), 
      Tclass._System.Tuple2(_System._tuple#2$T0, _System._tuple#2$T1), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_System._tuple#2._#Make2(a#14#0#0, a#14#1#0), 
        Tclass._System.Tuple2(_System._tuple#2$T0, _System._tuple#2$T1), 
        $h)
       <==> $IsAllocBox(a#14#0#0, _System._tuple#2$T0, $h)
         && $IsAllocBox(a#14#1#0, _System._tuple#2$T1, $h)));
...
axiom (forall a#15#0#0: Box, a#15#1#0: Box :: 
  { #_System._tuple#2._#Make2(Lit(a#15#0#0), Lit(a#15#1#0)) } 
  #_System._tuple#2._#Make2(Lit(a#15#0#0), Lit(a#15#1#0))
     == Lit(#_System._tuple#2._#Make2(a#15#0#0, a#15#1#0)));

// Constructor injectivity
axiom (forall a#16#0#0: Box, a#16#1#0: Box :: 
  { #_System._tuple#2._#Make2(a#16#0#0, a#16#1#0) } 
  _System.Tuple2._0(#_System._tuple#2._#Make2(a#16#0#0, a#16#1#0)) == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box, a#17#1#0: Box :: 
  { #_System._tuple#2._#Make2(a#17#0#0, a#17#1#0) } 
  BoxRank(a#17#0#0) < DtRank(#_System._tuple#2._#Make2(a#17#0#0, a#17#1#0)));

// Constructor injectivity
axiom (forall a#18#0#0: Box, a#18#1#0: Box :: 
  { #_System._tuple#2._#Make2(a#18#0#0, a#18#1#0) } 
  _System.Tuple2._1(#_System._tuple#2._#Make2(a#18#0#0, a#18#1#0)) == a#18#1#0);

// Inductive rank
axiom (forall a#19#0#0: Box, a#19#1#0: Box :: 
  { #_System._tuple#2._#Make2(a#19#0#0, a#19#1#0) } 
  BoxRank(a#19#1#0) < DtRank(#_System._tuple#2._#Make2(a#19#0#0, a#19#1#0)));
...
procedure CheckWellformed$$_module.Cell.__ctor(this: ref
       where this != null
         && 
...
procedure Call$$_module.Cell.__ctor(v#0: int)
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Cell())
...
procedure Impl$$_module.Cell.__ctor(v#0: int)
...
implementation Impl$$_module.Cell.__ctor(v#0: int) returns (this: ref, $_reverifyPost: bool)
{
  ...
  var this.val: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(11,2): initial state"} true;
    $_reverifyPost := false;
    // ----- divided block before new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(11,3)
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(12,9)
    assume true;
    assume true;
    this.val := v#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(12,12)"} true;
    // ----- new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(11,3)
    assume !read($Heap, this, alloc);
    assume read($Heap, this, _module.Cell.val) == this.val;
    $Heap := update($Heap, this, alloc, true);
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- divided block after new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(11,3)
}
...
procedure CheckWellformed$$_module.Point.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Point())
         && $IsAlloc(this, Tclass._module.Point(), $Heap));
...
implementation CheckWellformed$$_module.Point.Valid(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var b$reqreads#18: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(20,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
...
procedure CheckWellformed$$_module.Point.__ctor(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Point())
         && $IsAlloc(this, Tclass._module.Point(), $Heap), 
...
procedure Call$$_module.Point.__ctor(a#0: int, b#0: int, c#0: int)
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Point())
...
procedure Impl$$_module.Point.__ctor(a#0: int, b#0: int, c#0: int)
...
implementation Impl$$_module.Point.__ctor(a#0: int, b#0: int, c#0: int) returns (this: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var v##2: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(35,2): initial state"} true;
    $_reverifyPost := false;
    // ----- divided block before new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(35,3)
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(36,7)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(36,10)
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(36,20)"} true;
    this.x := $nw;
    defass#this.x := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(36,20)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(37,7)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(37,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    v##1 := b#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(37,20)"} true;
    this.y := $nw;
    defass#this.y := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(37,20)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(38,7)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(38,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    v##2 := c#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(38,20)"} true;
    this.z := $nw;
    defass#this.z := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(38,20)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(39,10)
    assume true;
    ...
    this.Repr := Set#UnionOne(Set#UnionOne(Set#UnionOne(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), $Box(this.x)), 
        $Box(this.y)), 
      $Box(this.z));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(39,27)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(40,11)
    assume true;
    assume true;
    this.Value := #_System._tuple#3._#Make3($Box(a#0), $Box(b#0), $Box(c#0));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(40,22)"} true;
    // ----- new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(35,3)
    assert defass#this.x;
    assert defass#this.y;
    assert defass#this.z;
    assume !read($Heap, this, alloc);
    ...
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- divided block after new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(35,3)
}



procedure CheckWellformed$$_module.Point.Mutate(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Point())
         && $IsAlloc(this, Tclass._module.Point(), $Heap), 
...
implementation CheckWellformed$$_module.Point.Mutate(this: ref, a#0: int, b#0: int, c#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Point.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(43,9): initial state"} true;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(46,20): post-state"} true;
    assume _module.Point.Valid#canCall($Heap, this);
    assume _module.Point.Valid($Heap, this);
...
procedure Call$$_module.Point.Mutate(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Point())
         && $IsAlloc(this, Tclass._module.Point(), $Heap), 
...
procedure Impl$$_module.Point.Mutate(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Point())
         && $IsAlloc(this, Tclass._module.Point(), $Heap), 
...
implementation Impl$$_module.Point.Mutate(this: ref, a#0: int, b#0: int, c#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $obj0: ref;
  var $obj1: ref;
  ...
  var $rhs#1: int;
  var $rhs#2: int;
  var $rhs#3: DatatypeType where $Is($rhs#3, Tclass._System.Tuple3(TInt, TInt, TInt));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Point.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(48,2): initial state"} true;
    $_reverifyPost := false;
    // ----- update statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(49,25)
    assert read($Heap, this, _module.Point.x) != null;
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(49,34)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(50,11)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(50,22)"} true;
}



// _module.Point: subset type $Is
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass._module.Point()) } 
  $Is(c#0, Tclass._module.Point())
     <==> $Is(c#0, Tclass._module.Point?()) && c#0 != null);

// _module.Point: subset type $IsAlloc
axiom (forall c#0: ref, $h: Heap :: 
...
procedure CheckWellformed$$_module.Arm.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Arm())
         && $IsAlloc(this, Tclass._module.Arm(), $Heap));
...
implementation CheckWellformed$$_module.Arm.Valid(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b$reqreads#0: bool;
  var b$reqreads#1: bool;
  ...
  var b$reqreads#11: bool;
    ...
    // AddWellformednessCheck for function Valid
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(58,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
...
procedure CheckWellformed$$_module.Arm.__ctor(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Arm())
         && $IsAlloc(this, Tclass._module.Arm(), $Heap), 
...
procedure Call$$_module.Arm.__ctor(polar_in#0: int, azim_in#0: int)
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Arm())
...
procedure Impl$$_module.Arm.__ctor(polar_in#0: int, azim_in#0: int)
...
implementation Impl$$_module.Arm.__ctor(polar_in#0: int, azim_in#0: int) returns (this: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var this.Value: DatatypeType;
  var this.Repr: Set Box;
  ...
  var v##1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(74,2): initial state"} true;
    $_reverifyPost := false;
    // ----- divided block before new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(74,3)
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(75,11)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(75,14)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    v##0 := polar_in#0;
    ...
    call $nw := Call$$_module.Cell.__ctor(v##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(75,31)"} true;
    this.polar := $nw;
    defass#this.polar := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(75,31)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(76,10)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(76,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    v##1 := azim_in#0;
    ...
    call $nw := Call$$_module.Cell.__ctor(v##1);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(76,29)"} true;
    this.azim := $nw;
    defass#this.azim := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(76,29)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(77,10)
    assume true;
    ...
    this.Repr := Set#UnionOne(Set#UnionOne(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), $Box(this.polar)), 
      $Box(this.azim));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(77,31)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(78,11)
    assume true;
    assume true;
    this.Value := #_System._tuple#2._#Make2($Box(polar_in#0), $Box(azim_in#0));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(78,32)"} true;
    // ----- new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(74,3)
    assert defass#this.polar;
    assert defass#this.azim;
    assume !read($Heap, this, alloc);
    ...
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- divided block after new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(74,3)
}



procedure CheckWellformed$$_module.Arm.Mutate(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Arm())
         && $IsAlloc(this, Tclass._module.Arm(), $Heap), 
...
implementation CheckWellformed$$_module.Arm.Mutate(this: ref, polar_in#0: int, azim_in#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Arm.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(81,9): initial state"} true;
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(84,20): post-state"} true;
    assume _module.Arm.Valid#canCall($Heap, this);
    assume _module.Arm.Valid($Heap, this);
...
procedure Call$$_module.Arm.Mutate(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Arm())
         && $IsAlloc(this, Tclass._module.Arm(), $Heap), 
...
procedure Impl$$_module.Arm.Mutate(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Arm())
         && $IsAlloc(this, Tclass._module.Arm(), $Heap), 
...
implementation Impl$$_module.Arm.Mutate(this: ref, polar_in#0: int, azim_in#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $obj0: ref;
  var $obj1: ref;
  var $rhs#0: int;
  var $rhs#1: int;
  var $rhs#2: DatatypeType where $Is($rhs#2, Tclass._System.Tuple2(TInt, TInt));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Arm.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(86,2): initial state"} true;
    $_reverifyPost := false;
    // ----- update statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(87,25)
    assert read($Heap, this, _module.Arm.polar) != null;
    assume true;
    ...
    $Heap := update($Heap, $obj1, _module.Cell.val, $rhs#1);
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(87,44)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(88,11)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(88,32)"} true;
}



// _module.Arm: subset type $Is
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass._module.Arm()) } 
  $Is(c#0, Tclass._module.Arm())
     <==> $Is(c#0, Tclass._module.Arm?()) && c#0 != null);

// _module.Arm: subset type $IsAlloc
axiom (forall c#0: ref, $h: Heap :: 
...
procedure {:opaque} CheckWellformed$$_module.Bot.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
implementation {:opaque} CheckWellformed$$_module.Bot.Valid(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b$reqreads#0: bool;
  var b$reqreads#1: bool;
  ...
  var b$reqreads#37: bool;
    ...
    // AddWellformednessCheck for function Valid
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(94,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
...
procedure CheckWellformed$$_module.Bot.__ctor(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
procedure Call$$_module.Bot.__ctor()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
...
procedure Impl$$_module.Bot.__ctor()
...
implementation Impl$$_module.Bot.__ctor() returns (this: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var this.Repr: Set Box;
  var this.pos: ref;
  ...
  var $rhs#0: Set Box where $Is($rhs#0, TSet(Tclass._System.object()));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(112,2): initial state"} true;
    $_reverifyPost := false;
    // ----- divided block before new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(112,3)
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(113,9)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(113,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##0 := LitInt(0);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(113,29)"} true;
    this.pos := $nw;
    defass#this.pos := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(113,29)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(114,10)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(114,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    polar_in##0 := LitInt(0);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(114,25)"} true;
    this.left := $nw;
    defass#this.left := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(114,25)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(115,11)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(115,14)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    polar_in##1 := LitInt(0);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(115,26)"} true;
    this.right := $nw;
    defass#this.right := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(115,26)"} true;
    // ----- new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(112,3)
    ...
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- divided block after new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(112,3)
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(117,10)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(117,54)"} true;
    // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(118,5)
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(118,17)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(118,18)"} true;
}
...
procedure CheckWellformed$$_module.Bot.flying(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
implementation CheckWellformed$$_module.Bot.flying(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b$reqreads#0: bool;
  var b$reqreads#1: bool;
  ...
  var b$reqreads#4: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(121,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Bot.Repr)[$Box($o)]);
    // initialize fuel constant
    ...
    assume AsFuelBottom(StartFuelAssert__module.Bot.Valid)
       == StartFuelAssert__module.Bot.Valid;
    // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(122,15)
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(122,27)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: Make the call
    call Call$$_module.Bot.reveal__Valid(this);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(122,28)"} true;
...
procedure CheckWellformed$$_module.Bot.arms__up(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
implementation CheckWellformed$$_module.Bot.arms__up(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b$reqreads#0: bool;
  var b$reqreads#1: bool;
  ...
  var b$reqreads#10: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(128,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Bot.Repr)[$Box($o)]);
    // initialize fuel constant
    ...
    assume AsFuelBottom(StartFuelAssert__module.Bot.Valid)
       == StartFuelAssert__module.Bot.Valid;
    // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(129,15)
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(129,27)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: Make the call
    call Call$$_module.Bot.reveal__Valid(this);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(129,28)"} true;
    b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
           && read($Heap, $o, alloc)
           && ($o == this || read($Heap, this, _module.Bot.Repr)[$Box($o)])
...
procedure CheckWellformed$$_module.Bot.robot__inv(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
implementation CheckWellformed$$_module.Bot.robot__inv(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b$reqreads#0: bool;
  var b$reqreads#1: bool;
  ...
  var b$reqreads#3: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(135,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Bot.Repr)[$Box($o)]);
    // initialize fuel constant
    ...
    assume AsFuelBottom(StartFuelAssert__module.Bot.Valid)
       == StartFuelAssert__module.Bot.Valid;
    // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(136,15)
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(136,27)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: Make the call
    call Call$$_module.Bot.reveal__Valid(this);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(136,28)"} true;
    b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
           && read($Heap, $o, alloc)
           && ($o == this || read($Heap, this, _module.Bot.Repr)[$Box($o)])
...
procedure CheckWellformed$$_module.Bot.Fly(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
implementation CheckWellformed$$_module.Bot.Fly(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Bot.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(142,9): initial state"} true;
    assume _module.Bot.Valid#canCall($Heap, this);
    assume _module.Bot.Valid(StartFuel__module.Bot.Valid, $Heap, this);
    havoc $Heap;
    assume (forall $o: ref :: 
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(145,20): post-state"} true;
    assume _module.Bot.Valid#canCall($Heap, this);
    assume _module.Bot.Valid(StartFuel__module.Bot.Valid, $Heap, this);
...
procedure Call$$_module.Bot.Fly(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
procedure Impl$$_module.Bot.Fly(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap))
...
implementation Impl$$_module.Bot.Fly(this: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $obj0: ref;
  var $obj1: ref;
  ...
  var $rhs#2: int;
  var $rhs#3: int;
  var $rhs#4: DatatypeType where $Is($rhs#4, Tclass._System.Tuple3(TInt, TInt, TInt));
  var $rhs#5: DatatypeType where $Is($rhs#5, Tclass._System.Tuple2(TInt, TInt));
  var $rhs#6: DatatypeType where $Is($rhs#6, Tclass._System.Tuple2(TInt, TInt));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Bot.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(147,2): initial state"} true;
    $_reverifyPost := false;
    // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(148,5)
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(148,17)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.Bot.reveal__Valid(this);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(148,18)"} true;
    // ----- update statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(149,37)
    assert read($Heap, this, _module.Bot.left) != null;
    assert read($Heap, read($Heap, this, _module.Bot.left), _module.Arm.polar) != null;
    assume true;
    ...
    $Heap := update($Heap, $obj1, _module.Cell.val, $rhs#1);
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(149,43)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(150,15)
    assert read($Heap, this, _module.Bot.pos) != null;
    assert read($Heap, read($Heap, this, _module.Bot.pos), _module.Point.z) != null;
    assume true;
    ...
    $Heap := update($Heap, 
      ...
      $rhs#2);
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(150,20)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(151,20)
    assert read($Heap, this, _module.Bot.right) != null;
    ...
    $Heap := update($Heap, 
      ...
      $rhs#3);
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(151,24)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(152,15)
    assert read($Heap, this, _module.Bot.pos) != null;
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(152,48)"} true;
    // ----- update statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(153,29)
    assert read($Heap, this, _module.Bot.left) != null;
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(153,57)"} true;
    // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(154,5)
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(154,17)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.Bot.reveal__Valid(this);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(154,18)"} true;
}



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$_module.Bot.reveal__Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$_module.Bot.reveal__Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Bot())
         && $IsAlloc(this, Tclass._module.Bot(), $Heap));
...
procedure CheckWellformed$$_module.__default.FlyRobots(b0#0: ref
...
implementation CheckWellformed$$_module.__default.FlyRobots(b0#0: ref, b1#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(159,7): initial state"} true;
    assert b0#0 != null;
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(164,21): post-state"} true;
    assert b0#0 != null;
    assume _module.Bot.Valid#canCall($Heap, b0#0);
    assume _module.Bot.Valid(StartFuel__module.Bot.Valid, $Heap, b0#0);
    assert b0#0 != null;
...
procedure Call$$_module.__default.FlyRobots(b0#0: ref
       where $Is(b0#0, Tclass._module.Bot()) && $IsAlloc(b0#0, Tclass._module.Bot(), $Heap), 
    b1#0: ref
       where $Is(b1#0, Tclass._module.Bot()) && $IsAlloc(b1#0, Tclass._module.Bot(), $Heap));
  // user-defined preconditions
...
procedure Impl$$_module.__default.FlyRobots(b0#0: ref
       where $Is(b0#0, Tclass._module.Bot()) && $IsAlloc(b0#0, Tclass._module.Bot(), $Heap), 
    b1#0: ref
       where $Is(b1#0, Tclass._module.Bot()) && $IsAlloc(b1#0, Tclass._module.Bot(), $Heap))
   returns ($_reverifyPost: bool);
...
implementation Impl$$_module.__default.FlyRobots(b0#0: ref, b1#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, b0#0, _module.Bot.Repr)[$Box($o)]
           || read($Heap, b1#0, _module.Bot.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(169,0): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(170,9)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert b0#0 != null;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(170,10)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(171,9)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert b1#0 != null;
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(171,10)"} true;
}
...
procedure CheckWellformed$$_module.__default.ArmyRepr(bots#0: Seq Box where $Is(bots#0, TSeq(Tclass._module.Bot())));
  free requires 11 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.ArmyRepr(bots#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b#1: ref;
  var b#2: ref;
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(177,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
    ...
    else
    {
        ...
        havoc b#3;
        havoc o#1;
        if ($Is(b#3, Tclass._module.Bot()) && $Is(o#1, Tclass._System.object()))
        {
...
procedure CheckWellformed$$_module.__default.ValidArmy(bots#0: Seq Box where $Is(bots#0, TSeq(Tclass._module.Bot())));
  free requires 12 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.ValidArmy(bots#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b#0: ref;
  var ##bots#0: Seq Box;
  ...
  var b$reqreads#3: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(184,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> ($Is($o, Tclass._module.Bot()) && Seq#Contains(bots#0, $Box($o)))
...
procedure CheckWellformed$$_module.__default.FlyRobotArmy(bots#0: Seq Box
...
implementation CheckWellformed$$_module.__default.FlyRobotArmy(bots#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##bots#0: Seq Box;
  var ##bots#1: Seq Box;
  ...
  var b#0: ref;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> _module.__default.ArmyRepr($Heap, bots#0)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(192,7): initial state"} true;
    ##bots#0 := bots#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##bots#0, TSeq(Tclass._module.Bot()), $Heap);
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(195,26): post-state"} true;
    ##bots#2 := bots#0;
    // assume allocatedness for argument to function
    ...
    assume (forall $o: ref :: 
      ...
      _module.__default.ArmyRepr($Heap, bots#0)[$Box($o)]
         ...
         ==> $o != null && !read(old($Heap), $o, alloc));
    havoc b#0;
    assume $Is(b#0, Tclass._module.Bot());
    if (*)
    {
...
procedure Call$$_module.__default.FlyRobotArmy(bots#0: Seq Box
       where $Is(bots#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(bots#0, TSeq(Tclass._module.Bot()), $Heap));
  // user-defined preconditions
...
procedure Impl$$_module.__default.FlyRobotArmy(bots#0: Seq Box
       where $Is(bots#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(bots#0, TSeq(Tclass._module.Bot()), $Heap))
   returns ($_reverifyPost: bool);
  free requires 15 == $FunctionContextHeight;
...
implementation Impl$$_module.__default.FlyRobotArmy(bots#0: Seq Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var n##1_0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> _module.__default.ArmyRepr($Heap, bots#0)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(197,0): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(198,3)
    if (*)
    {
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(200,29)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        bots##0_0 := bots#0;
        ...
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(200,34)"} true;
    }
    else
    {
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(203,11)
        assume true;
        assume true;
        n#0 := LitInt(0);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(203,14)"} true;
        // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(204,5)
        // Assume Fuel Constant
        $PreLoopHeap$loop#0 := $Heap;
        $decr_init$loop#00 := Seq#Length(bots#0) - n#0;
        havoc $w$loop#0;
        while (true)
          free invariant $w$loop#0 ==> true;
          invariant $w$loop#0 ==> LitInt(0) <= n#0;
          invariant $w$loop#0 ==> n#0 <= Seq#Length(bots#0);
          free invariant $w$loop#0 ==> _module.__default.ValidArmy#canCall($Heap, bots#0);
          invariant $w$loop#0
             ==> 
            _module.__default.ValidArmy#canCall($Heap, bots#0)
             ==> _module.__default.ValidArmy($Heap, bots#0)
          ...
          invariant $w$loop#0
            ...
            _module.__default.ValidArmy#canCall($Heap, bots#0)
             ==> _module.__default.ValidArmy($Heap, bots#0)
               || (forall i#9: int, j#4: int :: 
                { $Unbox(Seq#Index(bots#0, j#4)): ref, $Unbox(Seq#Index(bots#0, i#9)): ref } 
                true
                   ==> 
                  LitInt(0) <= i#9 && i#9 < j#4 && j#4 < Seq#Length(bots#0)
                   ==> Set#Disjoint(read($Heap, $Unbox(Seq#Index(bots#0, i#9)): ref, _module.Bot.Repr), 
                    read($Heap, $Unbox(Seq#Index(bots#0, j#4)): ref, _module.Bot.Repr)));
             ...
             ==> _module.__default.ValidArmy#canCall($Heap, bots#0)
              ...
              (forall i#8: int :: 
                ...
                true
                   ==> 
                  LitInt(0) <= i#8 && i#8 < Seq#Length(bots#0)
                   ==> _module.Bot.Valid(StartFuel__module.Bot.Valid, $Heap, $Unbox(Seq#Index(bots#0, i#8)): ref))
               && (forall i#9: int, j#4: int :: 
                { $Unbox(Seq#Index(bots#0, j#4)): ref, $Unbox(Seq#Index(bots#0, i#9)): ref } 
                true
                   ==> 
          ...
          free invariant $w$loop#0
             ==> (forall j#6: int :: 
              { $Unbox(Seq#Index(bots#0, j#6)): ref } 
              (LitInt(0) <= j#6 && j#6 < n#0
                   ==> _module.Bot.Valid#canCall($Heap, $Unbox(Seq#Index(bots#0, j#6)): ref))
                 && (
                  (LitInt(0) <= j#6 && j#6 < n#0
                   ==> _module.Bot.Valid(StartFuel__module.Bot.Valid, $Heap, $Unbox(Seq#Index(bots#0, j#6)): ref))
                   ==> (LitInt(0) <= j#6 && j#6 < n#0
                       ==> _module.Bot.robot__inv#canCall($Heap, $Unbox(Seq#Index(bots#0, j#6)): ref))
                     && (
                      (LitInt(0) <= j#6 && j#6 < n#0
                       ==> _module.Bot.robot__inv($Heap, $Unbox(Seq#Index(bots#0, j#6)): ref))
                       ==> 
                      LitInt(0) <= j#6 && j#6 < n#0
                       ==> _module.Bot.flying#canCall($Heap, $Unbox(Seq#Index(bots#0, j#6)): ref))));
          invariant $w$loop#0
             ==> (forall j#6: int :: 
              { $Unbox(Seq#Index(bots#0, j#6)): ref } 
              true
                 ==> (LitInt(0) <= j#6 && j#6 < n#0
                     ==> _module.Bot.Valid(StartFuelAssert__module.Bot.Valid, $Heap, $Unbox(Seq#Index(bots#0, j#6)): ref))
                   && (LitInt(0) <= j#6 && j#6 < n#0
                     ==> _module.Bot.robot__inv($Heap, $Unbox(Seq#Index(bots#0, j#6)): ref))
                   && (LitInt(0) <= j#6 && j#6 < n#0
                     ==> _module.Bot.flying($Heap, $Unbox(Seq#Index(bots#0, j#6)): ref)));
          free invariant $w$loop#0
             ==> (forall j#6: int :: 
              { $Unbox(Seq#Index(bots#0, j#6)): ref } 
              true
          ...
          invariant $w$loop#0
             ==> (forall i#11: int :: 
              { $Unbox(Seq#Index(bots#0, i#11)): ref } 
                { $Unbox(Seq#Index(bots#0, i#11)): ref } 
              true
                 ==> 
                LitInt(0) <= i#11 && i#11 < Seq#Length(bots#0)
                 ==> (forall $o: ref :: 
                  { read(old($Heap), $o, alloc) } 
                  read($Heap, $Unbox(Seq#Index(bots#0, i#11)): ref, _module.Bot.Repr)[$Box($o)]
                       && !read(old($Heap), $Unbox(Seq#Index(bots#0, i#11)): ref, _module.Bot.Repr)[$Box($o)]
                     ==> $o != null && !read(old($Heap), $o, alloc)));
          ...
          free invariant Seq#Length(bots#0) - n#0 <= $decr_init$loop#00
             && (Seq#Length(bots#0) - n#0 == $decr_init$loop#00 ==> true);
        {
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(204,4): after some loop iterations"} true;
            if (!$w$loop#0)
            {
                if (LitInt(0) <= n#0)
                {
                ...
                ##bots#5 := bots#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##bots#5, TSeq(Tclass._module.Bot()), $Heap);
                assume _module.__default.ValidArmy#canCall($Heap, bots#0);
                assume _module.__default.ValidArmy#canCall($Heap, bots#0);
                assume _module.__default.ValidArmy($Heap, bots#0);
                // Begin Comprehension WF check
                ...
                if (true)
                {
                    ...
                    if (LitInt(0) <= j#5 && j#5 < n#0)
                    {
                        assert {:subsumption 0} 0 <= j#5 && j#5 < Seq#Length(bots#0);
                        assert {:subsumption 0} $Unbox(Seq#Index(bots#0, j#5)): ref != null;
                        assume _module.Bot.Valid#canCall($Heap, $Unbox(Seq#Index(bots#0, j#5)): ref);
                        if (_module.Bot.Valid(StartFuel__module.Bot.Valid, $Heap, $Unbox(Seq#Index(bots#0, j#5)): ref))
                        {
                            assert {:subsumption 0} 0 <= j#5 && j#5 < Seq#Length(bots#0);
                            assert {:subsumption 0} $Unbox(Seq#Index(bots#0, j#5)): ref != null;
                            assert {:subsumption 0} Lit(true)
                               ==> _module.Bot.Valid(StartFuelAssert__module.Bot.Valid, $Heap, $Unbox(Seq#Index(bots#0, j#5)): ref);
                            assume _module.Bot.robot__inv#canCall($Heap, $Unbox(Seq#Index(bots#0, j#5)): ref);
                        }
                           ...
                           && _module.Bot.robot__inv($Heap, $Unbox(Seq#Index(bots#0, j#5)): ref))
                        {
                            ...
                            assert {:subsumption 0} Lit(true)
                               ==> _module.Bot.Valid(StartFuelAssert__module.Bot.Valid, $Heap, $Unbox(Seq#Index(bots#0, j#5)): ref);
                            assume _module.Bot.flying#canCall($Heap, $Unbox(Seq#Index(bots#0, j#5)): ref);
                        }
                    }
                }

                // End Comprehension WF check
                assume (forall j#6: int :: 
                  { $Unbox(Seq#Index(bots#0, j#6)): ref } 
                  (LitInt(0) <= j#6 && j#6 < n#0
                       ==> _module.Bot.Valid#canCall($Heap, $Unbox(Seq#Index(bots#0, j#6)): ref))
                     && (
                ...
                if (true)
                {
                    ...
                    if (LitInt(0) <= i#10 && i#10 < Seq#Length(bots#0))
                    {
                        assert {:subsumption 0} 0 <= i#10 && i#10 < Seq#Length(bots#0);
                        assert {:subsumption 0} $Unbox(Seq#Index(bots#0, i#10)): ref != null;
                        assert {:subsumption 0} 0 <= i#10 && i#10 < Seq#Length(bots#0);
                        assert {:subsumption 0} $Unbox(Seq#Index(bots#0, i#10)): ref != null;
                        assert $IsAlloc($Unbox(Seq#Index(bots#0, i#10)): ref, Tclass._module.Bot(), old($Heap));
                    }
                }
            ...
            assume true;
            if (Seq#Length(bots#0) <= n#0)
            {
                break;
            }

            $decr$loop#00 := Seq#Length(bots#0) - n#0;
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(210,13)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            bots##1_0 := bots#0;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: 
              $o != null
                   && read($Heap, $o, alloc)
                   && read($Heap, $Unbox(Seq#Index(bots##1_0, n##1_0)): ref, _module.Bot.Repr)[$Box($o)]
                 ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.FlyOne(bots##1_0, n##1_0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(210,21)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(211,9)
            assume true;
            assume true;
            n#0 := n#0 + 1;
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(211,16)"} true;
            // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(204,5)
            assert 0 <= $decr$loop#00 || Seq#Length(bots#0) - n#0 == $decr$loop#00;
            assert Seq#Length(bots#0) - n#0 < $decr$loop#00;
            assume true;
            assume _module.__default.ValidArmy#canCall($Heap, bots#0);
            assume (forall j#6: int :: 
              { $Unbox(Seq#Index(bots#0, j#6)): ref } 
...
procedure CheckWellformed$$_module.__default.FlyRobotArmy__Recursively(bots#0: Seq Box
       where $Is(bots#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(bots#0, TSeq(Tclass._module.Bot()), $Heap));
...
implementation CheckWellformed$$_module.__default.FlyRobotArmy__Recursively(bots#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##bots#0: Seq Box;
  var ##bots#1: Seq Box;
  ...
  var b#0: ref;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> _module.__default.ArmyRepr($Heap, bots#0)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(216,7): initial state"} true;
    ##bots#0 := bots#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##bots#0, TSeq(Tclass._module.Bot()), $Heap);
    assume _module.__default.ValidArmy#canCall($Heap, bots#0);
    ...
    assume (forall $o: ref :: 
      ...
      $o != null && read(old($Heap), $o, alloc)
         ==> $Heap[$o] == old($Heap)[$o]
           || _module.__default.ArmyRepr(old($Heap), bots#0)[$Box($o)]);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(219,19): post-state"} true;
    ##bots#2 := bots#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##bots#2, TSeq(Tclass._module.Bot()), $Heap);
    assume _module.__default.ValidArmy#canCall($Heap, bots#0);
...
procedure Call$$_module.__default.FlyRobotArmy__Recursively(bots#0: Seq Box
       where $Is(bots#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(bots#0, TSeq(Tclass._module.Bot()), $Heap));
  // user-defined preconditions
  requires _module.__default.ValidArmy#canCall($Heap, bots#0)
...
procedure Impl$$_module.__default.FlyRobotArmy__Recursively(bots#0: Seq Box
       where $Is(bots#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(bots#0, TSeq(Tclass._module.Bot()), $Heap))
   returns ($_reverifyPost: bool);
  free requires 14 == $FunctionContextHeight;
...
implementation Impl$$_module.__default.FlyRobotArmy__Recursively(bots#0: Seq Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var bots##0_0: Seq Box;
  var n##0_0: int;
  var bots##0_1: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> _module.__default.ArmyRepr($Heap, bots#0)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(222,0): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(223,3)
    assume true;
    if (!Seq#Equal(bots#0, Seq#Empty(): Seq Box))
    {
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(224,11)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        bots##0_0 := bots#0;
        ...
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(224,19)"} true;
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(225,29)
        // TrCallStmt: Before ProcessCallStmt
        ...
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(225,39)"} true;
    }
    else
    {
    }
...
procedure CheckWellformed$$_module.__default.FlyOne(bots#0: Seq Box
       where $Is(bots#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(bots#0, TSeq(Tclass._module.Bot()), $Heap), 
    n#0: int);
...
implementation CheckWellformed$$_module.__default.FlyOne(bots#0: Seq Box, n#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var j#0: int;
  var i#0: int;
  ...
  var j#10: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(230,7): initial state"} true;
    if (LitInt(0) <= n#0)
    {
    }
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(236,10): post-state"} true;
    havoc j#6;
    assume true;
    if (*)
    {
...
procedure Call$$_module.__default.FlyOne(bots#0: Seq Box
       where $Is(bots#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(bots#0, TSeq(Tclass._module.Bot()), $Heap), 
    n#0: int);
  // user-defined preconditions
...
procedure Impl$$_module.__default.FlyOne(bots#0: Seq Box
       where $Is(bots#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(bots#0, TSeq(Tclass._module.Bot()), $Heap), 
    n#0: int)
   returns ($_reverifyPost: bool);
...
implementation Impl$$_module.__default.FlyOne(bots#0: Seq Box, n#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, $Unbox(Seq#Index(bots#0, n#0)): ref, _module.Bot.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(241,0): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(242,14)
    // TrCallStmt: Before ProcessCallStmt
    assert 0 <= n#0 && n#0 < Seq#Length(bots#0);
    assume true;
    assert $Unbox(Seq#Index(bots#0, n#0)): ref != null;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(242,15)"} true;
}



procedure CheckWellformed$$_module.__default.FormArmy(b0#0: ref
       where $Is(b0#0, Tclass._module.Bot()) && $IsAlloc(b0#0, Tclass._module.Bot(), $Heap), 
    b1#0: ref
       where $Is(b1#0, Tclass._module.Bot()) && $IsAlloc(b1#0, Tclass._module.Bot(), $Heap), 
    b2#0: ref
...
implementation CheckWellformed$$_module.__default.FormArmy(b0#0: ref, b1#0: ref, b2#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(246,7): initial state"} true;
    assert b0#0 != null;
    assume _module.Bot.Valid#canCall($Heap, b0#0);
    assume _module.Bot.Valid(StartFuel__module.Bot.Valid, $Heap, b0#0);
    assert b1#0 != null;
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(250,35): post-state"} true;
    assert b0#0 != null;
    assume _module.Bot.Valid#canCall($Heap, b0#0);
    assume _module.Bot.Valid(StartFuel__module.Bot.Valid, $Heap, b0#0);
    assert b1#0 != null;
...
procedure Call$$_module.__default.FormArmy(b0#0: ref
       where $Is(b0#0, Tclass._module.Bot()) && $IsAlloc(b0#0, Tclass._module.Bot(), $Heap), 
    b1#0: ref
       where $Is(b1#0, Tclass._module.Bot()) && $IsAlloc(b1#0, Tclass._module.Bot(), $Heap), 
    b2#0: ref
...
procedure Impl$$_module.__default.FormArmy(b0#0: ref
       where $Is(b0#0, Tclass._module.Bot()) && $IsAlloc(b0#0, Tclass._module.Bot(), $Heap), 
    b1#0: ref
       where $Is(b1#0, Tclass._module.Bot()) && $IsAlloc(b1#0, Tclass._module.Bot(), $Heap), 
    b2#0: ref
...
implementation Impl$$_module.__default.FormArmy(b0#0: ref, b1#0: ref, b2#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var army#0: Seq Box
  ...
  var army##1: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, b0#0, _module.Bot.Repr)[$Box($o)]
           || read($Heap, b1#0, _module.Bot.Repr)[$Box($o)]
           || read($Heap, b2#0, _module.Bot.Repr)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(253,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(254,12)
    assume true;
    assume true;
    army#0 := Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(b0#0)), $Box(b1#0)), $Box(b2#0));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(254,26)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(255,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    army##0 := army#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(255,17)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(256,15)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    bots##0 := army#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(256,20)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(257,15)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    bots##1 := army#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(257,20)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(258,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    army##1 := army#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(258,17)"} true;
}



procedure CheckWellformed$$_module.__default.ArmyRepr3(army#0: Seq Box
       where $Is(army#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(army#0, TSeq(Tclass._module.Bot()), $Heap));
...
implementation CheckWellformed$$_module.__default.ArmyRepr3(army#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##bots#0: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(261,6): initial state"} true;
    assume Seq#Length(army#0) == LitInt(3);
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(263,25): post-state"} true;
    ##bots#0 := army#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##bots#0, TSeq(Tclass._module.Bot()), $Heap);
...
procedure Call$$_module.__default.ArmyRepr3(army#0: Seq Box
       where $Is(army#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(army#0, TSeq(Tclass._module.Bot()), $Heap));
  // user-defined preconditions
...
procedure Impl$$_module.__default.ArmyRepr3(army#0: Seq Box
       where $Is(army#0, TSeq(Tclass._module.Bot()))
         && $IsAlloc(army#0, TSeq(Tclass._module.Bot()), $Heap))
   returns ($_reverifyPost: bool);
  free requires 16 == $FunctionContextHeight;
...
implementation Impl$$_module.__default.ArmyRepr3(army#0: Seq Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(264,0): initial state"} true;
    $_reverifyPost := false;
}
...
implementation Impl$$_module.__default._default_Main() returns ($_reverifyPost: bool)
{
  ...
  var b2##1: ref;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(270,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(271,10)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(271,13)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$_module.Bot.__ctor();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(271,21)"} true;
    b0#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(271,21)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(272,10)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(272,13)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$_module.Bot.__ctor();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(272,21)"} true;
    b1#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(272,21)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(273,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    b0##0 := b0#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(273,19)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(274,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    b0##1 := b0#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(274,19)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(275,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    b0##2 := b1#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(275,19)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(277,10)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(277,13)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$_module.Bot.__ctor();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(277,21)"} true;
    b2#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(277,21)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(278,11)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    b0##3 := b0#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(278,22)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(279,11)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    b0##4 := b2#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/FlyingRobots.dfy(279,22)"} true;
}
