...
// Constructor $Is
axiom (forall ListLibrary.List$T: Ty, a#21#0#0: Box, a#21#1#0: DatatypeType :: 
  { $Is(#ListLibrary.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.ListLibrary.List(ListLibrary.List$T)) } 
  $Is(#ListLibrary.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.ListLibrary.List(ListLibrary.List$T))
     <==> $IsBox(a#21#0#0, ListLibrary.List$T)
       && $Is(a#21#1#0, Tclass.ListLibrary.List(ListLibrary.List$T)));

// Constructor $IsAlloc
axiom (forall ListLibrary.List$T: Ty, a#22#0#0: Box, a#22#1#0: DatatypeType, $h: Heap :: 
  ...
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ListLibrary.List.Cons(a#22#0#0, a#22#1#0), 
        Tclass.ListLibrary.List(ListLibrary.List$T), 
        $h)
       <==> $IsAllocBox(a#22#0#0, ListLibrary.List$T, $h)
         && $IsAlloc(a#22#1#0, Tclass.ListLibrary.List(ListLibrary.List$T), $h)));
...
axiom (forall a#24#0#0: Box, a#24#1#0: DatatypeType :: 
  ...
  ListLibrary.List._h3(#ListLibrary.List.Cons(a#24#0#0, a#24#1#0)) == a#24#0#0);
...
axiom (forall a#26#0#0: Box, a#26#1#0: DatatypeType :: 
  ...
  ListLibrary.List._h4(#ListLibrary.List.Cons(a#26#0#0, a#26#1#0)) == a#26#1#0);
