...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/global_structs_fail.c -bpl ./global_structs_fail.bpl
...
const m_inode: ref;
axiom (m_inode == $sub.ref(0, 1032));
const m_busy: ref;
axiom (m_busy == $sub.ref(0, 2064));
const mutex_lock: ref;
axiom (mutex_lock == $sub.ref(0, 3096));
procedure {:inline 1} mutex_lock($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
$bb0:
  assume {:sourceloc "test/c/data/global_structs_fail.c", 14, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/global_structs_fail.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/global_structs_fail.c", 14, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "test/c/data/global_structs_fail.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/global_structs_fail.c", 15, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p2, 2);
  assume {:sourceloc "test/c/data/global_structs_fail.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/global_structs_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/global_structs_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call mutex_lock(m_inode);
  assume {:sourceloc "test/c/data/global_structs_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call mutex_lock(m_busy);
  assume {:sourceloc "test/c/data/global_structs_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/global_structs_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i32($M.0, $add.ref($add.ref(m_inode, $mul.ref(0, 8)), $mul.ref(4, 1)));
  assume {:sourceloc "test/c/data/global_structs_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "test/c/data/global_structs_fail.c", 21, 3} true;
...
$bb6:
  ...
  assume {:sourceloc "test/c/data/global_structs_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $add.ref($add.ref(m_busy, $mul.ref(0, 8)), $mul.ref(4, 1)));
  assume {:sourceloc "test/c/data/global_structs_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "test/c/data/global_structs_fail.c", 21, 3} true;
...
$bb10:
  ...
  goto $bb3;
$bb11:
  assume {:sourceloc "test/c/data/global_structs_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
{
$bb0:
  $M.1 := $store.i32($M.1, m_inode, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(m_inode, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  $M.1 := $store.i32($M.1, m_busy, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(m_busy, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  $exn := false;
  return;
}
