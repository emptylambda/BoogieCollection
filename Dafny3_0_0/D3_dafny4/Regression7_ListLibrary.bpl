...
axiom (forall a#19#0#0: Box, a#19#1#0: DatatypeType :: 
  { #ListLibrary.List.Cons(a#19#0#0, a#19#1#0) } 
  DatatypeCtorId(#ListLibrary.List.Cons(a#19#0#0, a#19#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  ListLibrary.List.Cons_q(d)
     ==> (exists a#20#0#0: Box, a#20#1#0: DatatypeType :: 
      d == #ListLibrary.List.Cons(a#20#0#0, a#20#1#0)));

// Constructor $Is
axiom (forall ListLibrary.List$B: Ty, a#21#0#0: Box, a#21#1#0: DatatypeType :: 
  { $Is(#ListLibrary.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.ListLibrary.List(ListLibrary.List$B)) } 
  $Is(#ListLibrary.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.ListLibrary.List(ListLibrary.List$B))
     <==> $IsBox(a#21#0#0, ListLibrary.List$B)
       && $Is(a#21#1#0, Tclass.ListLibrary.List(ListLibrary.List$B)));

// Constructor $IsAlloc
axiom (forall ListLibrary.List$B: Ty, a#22#0#0: Box, a#22#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#ListLibrary.List.Cons(a#22#0#0, a#22#1#0), 
      Tclass.ListLibrary.List(ListLibrary.List$B), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ListLibrary.List.Cons(a#22#0#0, a#22#1#0), 
        Tclass.ListLibrary.List(ListLibrary.List$B), 
        $h)
       <==> $IsAllocBox(a#22#0#0, ListLibrary.List$B, $h)
         && $IsAlloc(a#22#1#0, Tclass.ListLibrary.List(ListLibrary.List$B), $h)));
...
axiom (forall a#23#0#0: Box, a#23#1#0: DatatypeType :: 
  { #ListLibrary.List.Cons(Lit(a#23#0#0), Lit(a#23#1#0)) } 
  #ListLibrary.List.Cons(Lit(a#23#0#0), Lit(a#23#1#0))
     == Lit(#ListLibrary.List.Cons(a#23#0#0, a#23#1#0)));

function ListLibrary.List.head(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#24#0#0: Box, a#24#1#0: DatatypeType :: 
  { #ListLibrary.List.Cons(a#24#0#0, a#24#1#0) } 
  ListLibrary.List.head(#ListLibrary.List.Cons(a#24#0#0, a#24#1#0)) == a#24#0#0);

// Inductive rank
axiom (forall a#25#0#0: Box, a#25#1#0: DatatypeType :: 
  { #ListLibrary.List.Cons(a#25#0#0, a#25#1#0) } 
  BoxRank(a#25#0#0) < DtRank(#ListLibrary.List.Cons(a#25#0#0, a#25#1#0)));

function ListLibrary.List.tail(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#26#0#0: Box, a#26#1#0: DatatypeType :: 
  { #ListLibrary.List.Cons(a#26#0#0, a#26#1#0) } 
  ListLibrary.List.tail(#ListLibrary.List.Cons(a#26#0#0, a#26#1#0)) == a#26#1#0);

// Inductive rank
axiom (forall a#27#0#0: Box, a#27#1#0: DatatypeType :: 
  { #ListLibrary.List.Cons(a#27#0#0, a#27#1#0) } 
  DtRank(a#27#1#0) < DtRank(#ListLibrary.List.Cons(a#27#0#0, a#27#1#0)));
