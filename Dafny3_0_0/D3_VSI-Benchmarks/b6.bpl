// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy -print:./b6.bpl
...
axiom (forall _module.Collection$T: Ty :: 
  ...
  Tag(Tclass._module.Collection?(_module.Collection$T))
     ...
     && TagFamily(Tclass._module.Collection?(_module.Collection$T))
       == tytagFamily$Collection);

// Tclass._module.Collection? injectivity 0
axiom (forall _module.Collection$T: Ty :: 
  { Tclass._module.Collection?(_module.Collection$T) } 
  Tclass._module.Collection?_0(Tclass._module.Collection?(_module.Collection$T))
     == _module.Collection$T);

function Tclass._module.Collection?_0(Ty) : Ty;
...
// Collection.footprint: Type axiom
...
// Collection.elements: Type axiom
axiom (forall _module.Collection$T: Ty, $h: Heap, $o: ref :: 
...
axiom (forall _module.Collection$T: Ty, $Heap: Heap, this: ref :: 
  { _module.Collection.Valid#requires(_module.Collection$T, $Heap, this), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap)
       && 
      this != null
       && 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall _module.Collection$T: Ty, $Heap: Heap, this: ref :: 
    { _module.Collection.Valid(_module.Collection$T, $Heap, this), $IsGoodHeap($Heap) } 
    _module.Collection.Valid#canCall(_module.Collection$T, $Heap, this)
         || (1 != $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
...
implementation CheckWellformed$$_module.Collection.Valid(_module.Collection$T: Ty, this: ref)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(8,12): initial state"} true;
...
procedure CheckWellformed$$_module.Collection.GetCount(_module.Collection$T: Ty, 
    this: ref
       where this != null
        ...
        $Is(this, Tclass._module.Collection(_module.Collection$T))
         && $IsAlloc(this, Tclass._module.Collection(_module.Collection$T), $Heap))
   returns (c#0: int where LitInt(0) <= c#0);
...
procedure Impl$$_module.Collection.GetCount(_module.Collection$T: Ty, 
    this: ref
       where this != null
        ...
        $Is(this, Tclass._module.Collection(_module.Collection$T))
         && $IsAlloc(this, Tclass._module.Collection(_module.Collection$T), $Heap))
   returns (c#0: int where LitInt(0) <= c#0, $_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  // user-defined preconditions
...
implementation Impl$$_module.Collection.GetCount(_module.Collection$T: Ty, this: ref) returns (c#0: int, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(16,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(17,6)
    assume true;
    assume true;
    assert $Is(Seq#Length(read($Heap, this, _module.Collection.elements)), Tclass._System.nat());
    c#0 := Seq#Length(read($Heap, this, _module.Collection.elements));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(17,17)"} true;
}
...
implementation Impl$$_module.Collection.Init(_module.Collection$T: Ty, this: ref) returns ($_reverifyPost: bool)
{
  ...
  var $rhs#1: Set Box where $Is($rhs#1, TSet(Tclass._System.object()));
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(23,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(24,14)
    assume true;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(24,18)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(25,15)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(25,23)"} true;
}
...
implementation CheckWellformed$$_module.Collection.GetItem(_module.Collection$T: Ty, this: ref, i#0: int) returns (x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(28,9): initial state"} true;
    ...
    assume LitInt(0) <= i#0
       && i#0 < Seq#Length(read($Heap, this, _module.Collection.elements));
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && read(old($Heap), $o, alloc) ==> $Heap[$o] == old($Heap)[$o]);
    ...
    havoc x#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(31,24): post-state"} true;
...
procedure Impl$$_module.Collection.GetItem(_module.Collection$T: Ty, 
   ...
   returns (defass#x#0: bool, 
    x#0: Box
       where defass#x#0
         ==> $IsBox(x#0, _module.Collection$T)
           && $IsAllocBox(x#0, _module.Collection$T, $Heap), 
    $_reverifyPost: bool);
  free requires 9 == $FunctionContextHeight;
  // user-defined preconditions
   ...
   returns (defass#x#0: bool, x#0: Box, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(32,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(33,6)
    assume true;
    assert 0 <= i#0 && i#0 < Seq#Length(read($Heap, this, _module.Collection.elements));
    assume true;
    x#0 := Seq#Index(read($Heap, this, _module.Collection.elements), i#0);
    defass#x#0 := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(33,18)"} true;
    assert defass#x#0;
}
...
implementation CheckWellformed$$_module.Collection.Add(_module.Collection$T: Ty, this: ref, x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(36,9): initial state"} true;
    assume _module.Collection.Valid#canCall(_module.Collection$T, $Heap, this);
    assume _module.Collection.Valid(_module.Collection$T, $Heap, this);
    havoc $Heap;
    assume (forall $o: ref :: 
    ...
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(39,20): post-state"} true;
    assume _module.Collection.Valid#canCall(_module.Collection$T, $Heap, this);
    assume _module.Collection.Valid(_module.Collection$T, $Heap, this);
...
implementation Impl$$_module.Collection.Add(_module.Collection$T: Ty, this: ref, x#0: Box) returns ($_reverifyPost: bool)
{
  ...
  var $rhs#0: Seq Box where $Is($rhs#0, TSeq(_module.Collection$T));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Collection.footprint)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(41,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(42,13)
    assume true;
    assert $_Frame[this, _module.Collection.elements];
    assume true;
    ...
    $Heap := update($Heap, this, _module.Collection.elements, $rhs#0);
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(42,29)"} true;
}
...
axiom (forall _module.Iterator$T: Ty :: 
  ...
  Tag(Tclass._module.Iterator(_module.Iterator$T)) == Tagclass._module.Iterator
     && TagFamily(Tclass._module.Iterator(_module.Iterator$T)) == tytagFamily$Iterator);
...
implementation CheckWellformed$$_module.Collection.GetIterator(_module.Collection$T: Ty, this: ref) returns (iter#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(45,9): initial state"} true;
    assume _module.Collection.Valid#canCall(_module.Collection$T, $Heap, this);
    assume _module.Collection.Valid(_module.Collection$T, $Heap, this);
    havoc $Heap;
    assume (forall $o: ref :: 
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc iter#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(47,22): post-state"} true;
    assert iter#0 != null;
    ...
    assume (forall $o: ref :: 
      ...
      read($Heap, iter#0, _module.Iterator.footprint)[$Box($o)]
         ==> $o != null && !read(old($Heap), $o, alloc));
    assert iter#0 != null;
    assume read($Heap, iter#0, _module.Iterator.pos) == LitInt(-1);
    assert iter#0 != null;
...
procedure Call$$_module.Collection.GetIterator(_module.Collection$T: Ty, 
  ...
  free ensures _module.Iterator.Valid#canCall(_module.Collection$T, $Heap, iter#0)
    ...
    read($Heap, iter#0, _module.Iterator.footprint)[$Box(iter#0)]
     && LitInt(-1) <= read($Heap, iter#0, _module.Iterator.pos);
  free ensures true;
  ensures (forall $o: ref :: 
    { read($Heap, iter#0, _module.Iterator.footprint)[$Box($o)] } 
    read($Heap, iter#0, _module.Iterator.footprint)[$Box($o)]
       ==> $o != null && !read(old($Heap), $o, alloc));
  ensures read($Heap, iter#0, _module.Iterator.pos) == LitInt(-1);
  free ensures true;
...
procedure Impl$$_module.Collection.GetIterator(_module.Collection$T: Ty, 
   ...
   returns (defass#iter#0: bool, 
    iter#0: ref
       where defass#iter#0
         ==> $Is(iter#0, Tclass._module.Iterator(_module.Collection$T))
           && $IsAlloc(iter#0, Tclass._module.Iterator(_module.Collection$T), $Heap), 
    $_reverifyPost: bool);
  free requires 7 == $FunctionContextHeight;
  // user-defined preconditions
...
implementation Impl$$_module.Collection.GetIterator(_module.Collection$T: Ty, this: ref)
   returns (defass#iter#0: bool, iter#0: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $nw: ref;
  var coll##0: ref;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(50,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(51,9)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(51,28)
    ...
    call $nw := Call$$_module.Iterator.Init(_module.Collection$T, coll##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(51,37)"} true;
    iter#0 := $nw;
    defass#iter#0 := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(51,37)"} true;
    assert defass#iter#0;
}



// _module.Collection: subset type $Is
axiom (forall _module.Collection$T: Ty, c#0: ref :: 
  { $Is(c#0, Tclass._module.Collection(_module.Collection$T)) } 
  $Is(c#0, Tclass._module.Collection(_module.Collection$T))
     <==> $Is(c#0, Tclass._module.Collection?(_module.Collection$T)) && c#0 != null);

// _module.Collection: subset type $IsAlloc
axiom (forall _module.Collection$T: Ty, c#0: ref, $h: Heap :: 
  { $IsAlloc(c#0, Tclass._module.Collection(_module.Collection$T), $h) } 
  $IsAlloc(c#0, Tclass._module.Collection(_module.Collection$T), $h)
     <==> $IsAlloc(c#0, Tclass._module.Collection?(_module.Collection$T), $h));
...
axiom (forall _module.Iterator$T: Ty :: 
  { Tclass._module.Iterator?(_module.Iterator$T) } 
  Tclass._module.Iterator?_0(Tclass._module.Iterator?(_module.Iterator$T))
     == _module.Iterator$T);

function Tclass._module.Iterator?_0(Ty) : Ty;
...
axiom (forall _module.Iterator$T: Ty, $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass._module.Iterator?(_module.Iterator$T)
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, _module.Iterator.pos), TInt, $h));

const _module.Iterator.footprint: Field (Set Box);

// Iterator.footprint: Type axiom
axiom (forall _module.Iterator$T: Ty, $h: Heap, $o: ref :: 
...
axiom (forall _module.Iterator$T: Ty, $Heap: Heap, this: ref :: 
  { _module.Iterator.Valid#requires(_module.Iterator$T, $Heap, this), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap)
       && 
      this != null
       && 
...
axiom 4 <= $FunctionContextHeight
   ==> (forall _module.Iterator$T: Ty, $Heap: Heap, this: ref :: 
    { _module.Iterator.Valid(_module.Iterator$T, $Heap, this), $IsGoodHeap($Heap) } 
    _module.Iterator.Valid#canCall(_module.Iterator$T, $Heap, this)
         || (4 != $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
       ...
       ==> _module.Iterator.Valid(_module.Iterator$T, $Heap, this)
         == (read($Heap, this, _module.Iterator.footprint)[$Box(this)]
           && LitInt(-1) <= read($Heap, this, _module.Iterator.pos)));
...
implementation CheckWellformed$$_module.Iterator.Valid(_module.Iterator$T: Ty, this: ref)
{
  ...
  var b$reqreads#2: bool;
    ...
    // AddWellformednessCheck for function Valid
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(63,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
    ...
    else
    {
        ...
        {
            b$reqreads#2 := $_Frame[this, _module.Iterator.pos];
        }
...
procedure Call$$_module.Iterator.Init(_module.Iterator$T: Ty, 
  ...
  ensures (forall $o: ref :: 
    ...
    read($Heap, this, _module.Iterator.footprint)[$Box($o)] && $o != this
       ==> $o != null && !read(old($Heap), $o, alloc));
  ensures read($Heap, this, _module.Iterator.pos) == LitInt(-1);
  free ensures true;
...
procedure Impl$$_module.Iterator.Init(_module.Iterator$T: Ty, 
    coll#0: ref
       where $Is(coll#0, Tclass._module.Collection(_module.Iterator$T))
         && $IsAlloc(coll#0, Tclass._module.Collection(_module.Iterator$T), $Heap))
   returns (this: ref
       where this != null && $Is(this, Tclass._module.Iterator(_module.Iterator$T)), 
    $_reverifyPost: bool);
  free requires 6 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // user-defined postconditions
...
implementation Impl$$_module.Iterator.Init(_module.Iterator$T: Ty, coll#0: ref) returns (this: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var this.c: ref;
  var this.pos: int;
  ...
  var defass#this.c: bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(72,2): initial state"} true;
    $_reverifyPost := false;
    // ----- divided block before new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(72,3)
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(73,7)
    assume true;
    assume true;
    this.c := coll#0;
    defass#this.c := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(73,13)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(74,9)
    assume true;
    assume true;
    this.pos := LitInt(-1);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(74,13)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(75,15)
    assume true;
    assume true;
    assert $Is(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), TSet(Tclass._System.object()));
    this.footprint := Set#UnionOne(Set#Empty(): Set Box, $Box(this));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(75,23)"} true;
    // ----- new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(72,3)
    assert defass#this.c;
    assume !read($Heap, this, alloc);
    assume read($Heap, this, _module.Iterator.c) == this.c;
    assume read($Heap, this, _module.Iterator.pos) == this.pos;
    assume read($Heap, this, _module.Iterator.footprint) == this.footprint;
    $Heap := update($Heap, this, alloc, true);
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- divided block after new; ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(72,3)
}
...
implementation CheckWellformed$$_module.Iterator.MoveNext(_module.Iterator$T: Ty, this: ref) returns (b#0: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(78,9): initial state"} true;
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc b#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(81,57): post-state"} true;
...
implementation Impl$$_module.Iterator.MoveNext(_module.Iterator$T: Ty, this: ref) returns (b#0: bool, $_reverifyPost: bool)
{
  ...
  var $rhs#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.Iterator.footprint)[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(83,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(84,9)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(84,16)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(85,7)
    assume true;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(85,27)"} true;
}
...
axiom (forall _module.Iterator$T: Ty, $Heap: Heap, this: ref :: 
  { _module.Iterator.HasCurrent#requires(_module.Iterator$T, $Heap, this), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap)
       && 
      this != null
       && 
...
axiom 11 <= $FunctionContextHeight
   ==> (forall _module.Iterator$T: Ty, $Heap: Heap, this: ref :: 
    { _module.Iterator.HasCurrent(_module.Iterator$T, $Heap, this), $IsGoodHeap($Heap) } 
    _module.Iterator.HasCurrent#canCall(_module.Iterator$T, $Heap, this)
         || (11 != $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
...
implementation CheckWellformed$$_module.Iterator.HasCurrent(_module.Iterator$T: Ty, this: ref)
{
  ...
  var b$reqreads#6: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(88,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> $o == this
...
implementation CheckWellformed$$_module.Iterator.GetCurrent(_module.Iterator$T: Ty, this: ref) returns (x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(95,9): initial state"} true;
    assume _module.Iterator.Valid#canCall(_module.Iterator$T, $Heap, this);
    assume _module.Iterator.Valid(_module.Iterator$T, $Heap, this);
    assert {:subsumption 0} _module.Iterator.Valid#canCall(_module.Iterator$T, $Heap, this)
       ==> _module.Iterator.Valid(_module.Iterator$T, $Heap, this)
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc x#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(97,28): post-state"} true;
    assert read($Heap, this, _module.Iterator.c) != null;
...
procedure Impl$$_module.Iterator.GetCurrent(_module.Iterator$T: Ty, 
   ...
   returns (defass#x#0: bool, 
    x#0: Box
       where defass#x#0
         ==> $IsBox(x#0, _module.Iterator$T) && $IsAllocBox(x#0, _module.Iterator$T, $Heap), 
    $_reverifyPost: bool);
  free requires 13 == $FunctionContextHeight;
  // user-defined preconditions
  free requires _module.Iterator.Valid#canCall(_module.Iterator$T, $Heap, this)
...
implementation Impl$$_module.Iterator.GetCurrent(_module.Iterator$T: Ty, this: ref)
   returns (defass#x#0: bool, x#0: Box, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(98,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(99,7)
    assume true;
    assert read($Heap, this, _module.Iterator.c) != null;
    assert 0 <= read($Heap, this, _module.Iterator.pos)
       && read($Heap, this, _module.Iterator.pos)
    ...
    x#0 := Seq#Index(read($Heap, read($Heap, this, _module.Iterator.c), _module.Collection.elements), 
      read($Heap, this, _module.Iterator.pos));
    defass#x#0 := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(99,24)"} true;
    assert defass#x#0;
}



// _module.Iterator: subset type $Is
axiom (forall _module.Iterator$T: Ty, c#0: ref :: 
  { $Is(c#0, Tclass._module.Iterator(_module.Iterator$T)) } 
  $Is(c#0, Tclass._module.Iterator(_module.Iterator$T))
     <==> $Is(c#0, Tclass._module.Iterator?(_module.Iterator$T)) && c#0 != null);

// _module.Iterator: subset type $IsAlloc
axiom (forall _module.Iterator$T: Ty, c#0: ref, $h: Heap :: 
  { $IsAlloc(c#0, Tclass._module.Iterator(_module.Iterator$T), $h) } 
  $IsAlloc(c#0, Tclass._module.Iterator(_module.Iterator$T), $h)
     <==> $IsAlloc(c#0, Tclass._module.Iterator?(_module.Iterator$T), $h));
...
implementation Impl$$_module.Client.Main(this: ref) returns ($_reverifyPost: bool)
{
  ...
  var x##3: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(106,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(107,11)
    assume true;
    havoc $nw;
    assume $nw != null && dtype($nw) == Tclass._module.Collection?(TInt);
    assume !read($Heap, $nw, alloc);
    $Heap := update($Heap, $nw, alloc, true);
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(107,34)
    // TrCallStmt: Before ProcessCallStmt
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(107,39)"} true;
    c#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(107,39)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(108,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.Collection.Add(TInt, c#0, $Box(x##0));
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(108,13)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(109,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.Collection.Add(TInt, c#0, $Box(x##1));
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(109,13)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(110,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.Collection.Add(TInt, c#0, $Box(x##2));
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(110,13)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(112,11)
    assume true;
    assume true;
    s#0 := Lit(Seq#Empty(): Seq Box);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(112,15)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(114,30)
    assume true;
    // TrCallStmt: Adding lhs with type Iterator<int>
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    ...
    // TrCallStmt: After ProcessCallStmt
    iter#0 := $rhs##0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(114,31)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(115,27)
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##1;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(115,28)"} true;
    // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(117,5)
    ...
    while (true)
      ...
      free invariant Seq#Length(read($Heap, c#0, _module.Collection.elements))
         ...
         && (Seq#Length(read($Heap, c#0, _module.Collection.elements))
           ...
           ==> true);
    {
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(117,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
        ...
        $decr$loop#00 := Seq#Length(read($Heap, c#0, _module.Collection.elements))
           - read($Heap, iter#0, _module.Iterator.pos);
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(124,31)
        assume true;
        ...
        // TrCallStmt: After ProcessCallStmt
        x#0_0 := $rhs##0_0;
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(124,32)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(125,9)
        assume true;
        assume true;
        s#0 := Seq#Append(s#0, Seq#Build(Seq#Empty(): Seq Box, $Box(x#0_0)));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(125,18)"} true;
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(126,25)
        assume true;
        // TrCallStmt: Adding lhs with type bool
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        ...
        // TrCallStmt: After ProcessCallStmt
        b#0 := $rhs##0_1;
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(126,26)"} true;
        // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(117,5)
    ...
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(129,5)
    assert {:subsumption 0} c#0 != null;
    assume true;
    assert Seq#Equal(s#0, read($Heap, c#0, _module.Collection.elements));
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(130,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
         ...
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.Collection.Add(TInt, c#0, $Box(x##3));
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VSI-Benchmarks/b6.dfy(130,14)"} true;
}



// _module.Client: subset type $Is
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass._module.Client()) } 
  $Is(c#0, Tclass._module.Client())
     <==> $Is(c#0, Tclass._module.Client?()) && c#0 != null);

// _module.Client: subset type $IsAlloc
axiom (forall c#0: ref, $h: Heap :: 
...
const unique tytagFamily$Collection: TyTagFamily;
