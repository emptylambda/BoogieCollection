...
axiom (forall a#19#0#0: Box, a#19#1#0: DatatypeType :: 
  { #ParseGenerics.List.Cons(a#19#0#0, a#19#1#0) } 
  DatatypeCtorId(#ParseGenerics.List.Cons(a#19#0#0, a#19#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  ParseGenerics.List.Cons_q(d)
     ==> (exists a#20#0#0: Box, a#20#1#0: DatatypeType :: 
      d == #ParseGenerics.List.Cons(a#20#0#0, a#20#1#0)));

// Constructor $Is
axiom (forall ParseGenerics.List$Y: Ty, a#21#0#0: Box, a#21#1#0: DatatypeType :: 
  { $Is(#ParseGenerics.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.ParseGenerics.List(ParseGenerics.List$Y)) } 
  $Is(#ParseGenerics.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.ParseGenerics.List(ParseGenerics.List$Y))
     <==> $IsBox(a#21#0#0, ParseGenerics.List$Y)
       && $Is(a#21#1#0, Tclass.ParseGenerics.List(ParseGenerics.List$Y)));

// Constructor $IsAlloc
axiom (forall ParseGenerics.List$Y: Ty, a#22#0#0: Box, a#22#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#ParseGenerics.List.Cons(a#22#0#0, a#22#1#0), 
      Tclass.ParseGenerics.List(ParseGenerics.List$Y), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ParseGenerics.List.Cons(a#22#0#0, a#22#1#0), 
        Tclass.ParseGenerics.List(ParseGenerics.List$Y), 
        $h)
       <==> $IsAllocBox(a#22#0#0, ParseGenerics.List$Y, $h)
         && $IsAlloc(a#22#1#0, Tclass.ParseGenerics.List(ParseGenerics.List$Y), $h)));
...
axiom (forall a#23#0#0: Box, a#23#1#0: DatatypeType :: 
  { #ParseGenerics.List.Cons(Lit(a#23#0#0), Lit(a#23#1#0)) } 
  #ParseGenerics.List.Cons(Lit(a#23#0#0), Lit(a#23#1#0))
     == Lit(#ParseGenerics.List.Cons(a#23#0#0, a#23#1#0)));

function ParseGenerics.List._h22(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#24#0#0: Box, a#24#1#0: DatatypeType :: 
  { #ParseGenerics.List.Cons(a#24#0#0, a#24#1#0) } 
  ParseGenerics.List._h22(#ParseGenerics.List.Cons(a#24#0#0, a#24#1#0))
     == a#24#0#0);

// Inductive rank
axiom (forall a#25#0#0: Box, a#25#1#0: DatatypeType :: 
  { #ParseGenerics.List.Cons(a#25#0#0, a#25#1#0) } 
  BoxRank(a#25#0#0) < DtRank(#ParseGenerics.List.Cons(a#25#0#0, a#25#1#0)));

function ParseGenerics.List._h23(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#26#0#0: Box, a#26#1#0: DatatypeType :: 
  { #ParseGenerics.List.Cons(a#26#0#0, a#26#1#0) } 
  ParseGenerics.List._h23(#ParseGenerics.List.Cons(a#26#0#0, a#26#1#0))
     == a#26#1#0);

// Inductive rank
axiom (forall a#27#0#0: Box, a#27#1#0: DatatypeType :: 
  { #ParseGenerics.List.Cons(a#27#0#0, a#27#1#0) } 
  DtRank(a#27#1#0) < DtRank(#ParseGenerics.List.Cons(a#27#0#0, a#27#1#0)));
...
axiom 2 <= $FunctionContextHeight
   ==> (forall ParseGenerics._default.F$X: Ty, x#0: Box :: 
    ...
    ParseGenerics.__default.F#canCall(ParseGenerics._default.F$X, x#0)
         || (2 != $FunctionContextHeight && $IsBox(x#0, ParseGenerics._default.F$X))
       ==> true);
...
procedure CheckWellformed$$ParseGenerics.__default.F(ParseGenerics._default.F$X: Ty, 
    x#0: Box where $IsBox(x#0, ParseGenerics._default.F$X));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure CheckWellformed$$ParseGenerics.__default.M();
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$ParseGenerics.__default.M();
  modifies $Heap, $Tick;
  // frame condition
...
procedure Impl$$ParseGenerics.__default.M() returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
...
function ParseGenerics.__default.F#Handle(Ty) : HandleType;

axiom (forall ParseGenerics._default.F$X: Ty, $heap: Heap, $fh$0x#0: Box :: 
  { Apply1(ParseGenerics._default.F$X, 
      TInt, 
      $heap, 
      ParseGenerics.__default.F#Handle(ParseGenerics._default.F$X), 
      $fh$0x#0) } 
  Apply1(ParseGenerics._default.F$X, 
      TInt, 
      $heap, 
      ParseGenerics.__default.F#Handle(ParseGenerics._default.F$X), 
      $fh$0x#0)
     == $Box(ParseGenerics.__default.F(ParseGenerics._default.F$X, $fh$0x#0)));

axiom (forall ParseGenerics._default.F$X: Ty, $heap: Heap, $fh$0x#0: Box :: 
  { Requires1(ParseGenerics._default.F$X, 
      TInt, 
      $heap, 
      ParseGenerics.__default.F#Handle(ParseGenerics._default.F$X), 
      $fh$0x#0) } 
  Requires1(ParseGenerics._default.F$X, 
      ...
      ParseGenerics.__default.F#Handle(ParseGenerics._default.F$X), 
      $fh$0x#0)
     == ParseGenerics.__default.F#requires(ParseGenerics._default.F$X, $fh$0x#0));

axiom (forall $bx: Box, ParseGenerics._default.F$X: Ty, $heap: Heap, $fh$0x#0: Box :: 
  { Reads1(ParseGenerics._default.F$X, 
      TInt, 
      $heap, 
      ParseGenerics.__default.F#Handle(ParseGenerics._default.F$X), 
      $fh$0x#0)[$bx] } 
...
axiom (forall ParseGenerics._default.F$X: Ty, $heap: Heap, $fh$0x#0: Box :: 
  { ParseGenerics.__default.F(ParseGenerics._default.F$X, $fh$0x#0), $IsGoodHeap($heap) } 
  ParseGenerics.__default.F(ParseGenerics._default.F$X, $fh$0x#0)
     == $Unbox(Apply1(ParseGenerics._default.F$X, 
        TInt, 
        $heap, 
        ParseGenerics.__default.F#Handle(ParseGenerics._default.F$X), 
        $fh$0x#0)): int);

implementation Impl$$ParseGenerics.__default.M() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var pair#0: DatatypeType
     where $Is(pair#0, 
        Tclass._System.Tuple2(Tclass._System.___hTotalFunc1(#$MyType, TInt), TInt))
       && $IsAlloc(pair#0, 
        Tclass._System.Tuple2(Tclass._System.___hTotalFunc1(#$MyType, TInt), TInt), 
        $Heap);
  var pair'#0: DatatypeType
    ...
    // AddMethodImpl: M, Impl$$ParseGenerics.__default.M
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(360,19): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(361,14)
    assume true;
    assert 2 != $FunctionContextHeight;
    assume true;
    pair#0 := #_System._tuple#2._#Make2($Box(ParseGenerics.__default.F#Handle(#$MyType)), $Box(LitInt(5)));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(361,30)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(362,15)
    assume true;
    assert 2 != $FunctionContextHeight;
    assume true;
    pair'#0 := #_System._tuple#2._#Make2($Box(ParseGenerics.__default.F#Handle(#$MyType)), $Box(LitInt(5)));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(362,33)"} true;
}
   ...
   ==> (forall ParseGenerics._default.Many$_T0: Ty, $ly: LayerType, n#0: DatatypeType :: 
    ...
    ParseGenerics.__default.Many#canCall(ParseGenerics._default.Many$_T0, n#0)
       ...
       ==> (!ParseGenerics.List.Nil_q(n#0)
           ==> (var tail#1 := ParseGenerics.List._h23(n#0); 
            ParseGenerics.__default.Many#canCall(ParseGenerics._default.Many$_T0, tail#1)))
         && ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, $LS($ly), n#0)
           == (if ParseGenerics.List.Nil_q(n#0)
             then 18
             else (var tail#0 := ParseGenerics.List._h23(n#0); 
              ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, $ly, tail#0))));
   ...
   ==> (forall ParseGenerics._default.Many$_T0: Ty, $ly: LayerType, n#0: DatatypeType :: 
    ...
    ParseGenerics.__default.Many#canCall(ParseGenerics._default.Many$_T0, Lit(n#0))
       ...
       ==> (!Lit(ParseGenerics.List.Nil_q(Lit(n#0)))
           ==> (var tail#3 := Lit(ParseGenerics.List._h23(Lit(n#0))); 
            ParseGenerics.__default.Many#canCall(ParseGenerics._default.Many$_T0, tail#3)))
         && ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, $LS($ly), Lit(n#0))
           == (if ParseGenerics.List.Nil_q(Lit(n#0))
             then 18
             else (var tail#2 := Lit(ParseGenerics.List._h23(Lit(n#0))); 
              LitInt(ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, $LS($ly), tail#2)))));

procedure CheckWellformed$$ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0: Ty, 
    n#0: DatatypeType
       where $Is(n#0, Tclass.ParseGenerics.List(ParseGenerics._default.Many$_T0)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0: Ty, n#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var _mcc#0#0: Box;
  ...
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function Many
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(367,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    // initialize fuel constant
    assume StartFuel_ParseGenerics._default.Many
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        if (n#0 == #ParseGenerics.List.Nil())
        {
            assume ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, StartFuel_ParseGenerics._default.Many, n#0)
               == LitInt(18);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, StartFuel_ParseGenerics._default.Many, n#0), 
              TInt);
        }
        else if (n#0 == #ParseGenerics.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            assume $IsBox(_mcc#0#0, ParseGenerics._default.Many$_T0);
            assume $Is(_mcc#1#0, Tclass.ParseGenerics.List(ParseGenerics._default.Many$_T0));
            havoc tail#Z#0;
            assume $Is(tail#Z#0, Tclass.ParseGenerics.List(ParseGenerics._default.Many$_T0));
            assume let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass.ParseGenerics.List(ParseGenerics._default.Many$_T0));
            assume tail#Z#0 == let#0#0#0;
            ##n#0 := tail#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##n#0, Tclass.ParseGenerics.List(ParseGenerics._default.Many$_T0), $Heap);
            b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assert DtRank(##n#0) < DtRank(n#0);
            assume ParseGenerics.__default.Many#canCall(ParseGenerics._default.Many$_T0, tail#Z#0);
            assume ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, StartFuel_ParseGenerics._default.Many, n#0)
               == ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, StartFuel_ParseGenerics._default.Many, tail#Z#0);
            assume ParseGenerics.__default.Many#canCall(ParseGenerics._default.Many$_T0, tail#Z#0);
            // CheckWellformedWithResult: any expression
            assume $Is(ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, StartFuel_ParseGenerics._default.Many, n#0), 
              TInt);
...
procedure CheckWellformed$$ParseGenerics.__default.TestA(u#0: real);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$ParseGenerics.__default.TestA(u#0: real);
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure Impl$$ParseGenerics.__default.TestA(u#0: real) returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
...
implementation Impl$$ParseGenerics.__default.TestA(u#0: real) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var xs#0: DatatypeType
     where $Is(xs#0, Tclass.ParseGenerics.List(TReal))
       && $IsAlloc(xs#0, Tclass.ParseGenerics.List(TReal), $Heap);
  var ##n#0: DatatypeType;

    // AddMethodImpl: TestA, Impl$$ParseGenerics.__default.TestA
    // initialize fuel constant
    assume StartFuel_ParseGenerics._default.Many
       == $LS(BaseFuel_ParseGenerics._default.Many);
    assume StartFuelAssert_ParseGenerics._default.Many
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(374,23): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(375,12)
    assume true;
    assume true;
    xs#0 := #ParseGenerics.List.Cons($Box(u#0), 
      #ParseGenerics.List.Cons($Box(u#0), 
        #ParseGenerics.List.Cons($Box(u#0), #ParseGenerics.List.Cons($Box(u#0), Lit(#ParseGenerics.List.Nil())))));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(375,53)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(376,5)
    ##n#0 := xs#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#0, Tclass.ParseGenerics.List(TReal), $Heap);
    assume ParseGenerics.__default.Many#canCall(TReal, xs#0);
    assume ParseGenerics.__default.Many#canCall(TReal, xs#0);
    assert {:subsumption 0} ParseGenerics.__default.Many(TReal, StartFuelAssert_ParseGenerics._default.Many, xs#0)
       == LitInt(18);
    assume ParseGenerics.__default.Many(TReal, StartFuel_ParseGenerics._default.Many, xs#0)
       == LitInt(18);
}



procedure CheckWellformed$$ParseGenerics.__default.TestB(u#0: real);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$ParseGenerics.__default.TestB(u#0: real);
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure Impl$$ParseGenerics.__default.TestB(u#0: real) returns ($_reverifyPost: bool);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
...
const MoreFuel_ParseGenerics._default.Many0: LayerType;

implementation Impl$$ParseGenerics.__default.TestB(u#0: real) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var xs#0: DatatypeType
     where $Is(xs#0, Tclass.ParseGenerics.List(TReal))
  ...
  var ##n#0: DatatypeType;
    ...
    // AddMethodImpl: TestB, Impl$$ParseGenerics.__default.TestB
    // initialize fuel constant
    assume StartFuel_ParseGenerics._default.Many
       == $LS(BaseFuel_ParseGenerics._default.Many);
    assume StartFuelAssert_ParseGenerics._default.Many
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(379,23): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(380,12)
    assume true;
    assume true;
    xs#0 := #ParseGenerics.List.Cons($Box(u#0), 
      #ParseGenerics.List.Cons($Box(u#0), 
        #ParseGenerics.List.Cons($Box(u#0), #ParseGenerics.List.Cons($Box(u#0), Lit(#ParseGenerics.List.Nil())))));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(380,53)"} true;
    if (*)
    {
        // Assume Fuel Constant
        assume StartFuel_ParseGenerics._default.Many
           == $LS($LS($LS($LS($LS($LS($LS($LS($LS($LS(MoreFuel_ParseGenerics._default.Many0))))))))));
        assume StartFuelAssert_ParseGenerics._default.Many
           == $LS($LS($LS($LS($LS($LS($LS($LS($LS($LS($LS(MoreFuel_ParseGenerics._default.Many0)))))))))));
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(382,5)
        ##n#0 := xs#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##n#0, Tclass.ParseGenerics.List(TReal), $Heap);
        assume ParseGenerics.__default.Many#canCall(TReal, xs#0);
    ...
    assume ParseGenerics.__default.Many(TReal, StartFuelAssert_ParseGenerics._default.Many, xs#0)
       == LitInt(18);
}
