...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/llvm_intrinsic_fail.c -bpl ./llvm_intrinsic_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 7, 14} true;
  ...
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
...
$bb2:
  ...
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/llvm_intrinsic_fail.c:8:3: warning: over-approximating call to llvm.fabs.f80; */
  call $f2 := llvm.fabs.f80($f1);
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i3 := (if $fone.float.bool($f2, $fp(0, 0, 140731024460624)) then 1 else 0);
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/llvm_intrinsic_fail.c:8:3: warning: over-approximating call to llvm.fabs.f64; */
  call $f4 := llvm.fabs.f64($f0);
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i5 := (if $fone.float.bool($f4, $fp(0, 7, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $f6 := $fptrunc.float.float($f0);
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/llvm_intrinsic_fail.c:8:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f7 := llvm.fabs.f32($f6);
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i8 := (if $fone.float.bool($f7, $fp(0, 7, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb7;
$bb14:
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/llvm_intrinsic_fail.c:9:3: warning: over-approximating floating-point arithmetic fadd; */
  $f9 := $fadd.float($f0, $fp(0, 0, 0));
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i10 := (if $fune.float.bool($f9, $f0) then 1 else 0);
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb17;
$bb19:
  assume {:sourceloc "test/c/float/llvm_intrinsic_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.fabs.f64 == $sub.ref(0, 4128));
procedure {:inline 1} llvm.fabs.f64($f0: float)
  returns ($r: float);
const llvm.fabs.f32: ref;
axiom (llvm.fabs.f32 == $sub.ref(0, 5160));
