...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strpbrk_fail.c -bpl ./strpbrk_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strpbrk_fail.c", 8, 25} true;
  ...
  assume {:sourceloc "test/c/strings/strpbrk_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strpbrk_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strpbrk_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
