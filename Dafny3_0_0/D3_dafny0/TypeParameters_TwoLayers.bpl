...
axiom (forall a#14#0#0: DatatypeType :: 
  { #TwoLayers.wrap2.Wrap2(a#14#0#0) } 
  DatatypeCtorId(#TwoLayers.wrap2.Wrap2(a#14#0#0)) == ##TwoLayers.wrap2.Wrap2);
...
axiom (forall d: DatatypeType :: 
  { TwoLayers.wrap2.Wrap2_q(d) } 
  TwoLayers.wrap2.Wrap2_q(d)
     ==> (exists a#15#0#0: DatatypeType :: d == #TwoLayers.wrap2.Wrap2(a#15#0#0)));
...
// Constructor $Is
axiom (forall TwoLayers.wrap2$T: Ty, a#16#0#0: DatatypeType :: 
  { $Is(#TwoLayers.wrap2.Wrap2(a#16#0#0), Tclass.TwoLayers.wrap2(TwoLayers.wrap2$T)) } 
  $Is(#TwoLayers.wrap2.Wrap2(a#16#0#0), Tclass.TwoLayers.wrap2(TwoLayers.wrap2$T))
     <==> $Is(a#16#0#0, Tclass.OneLayer.wrap(TwoLayers.wrap2$T)));

// Constructor $IsAlloc
axiom (forall TwoLayers.wrap2$T: Ty, a#17#0#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#TwoLayers.wrap2.Wrap2(a#17#0#0), Tclass.TwoLayers.wrap2(TwoLayers.wrap2$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#TwoLayers.wrap2.Wrap2(a#17#0#0), Tclass.TwoLayers.wrap2(TwoLayers.wrap2$T), $h)
       <==> $IsAlloc(a#17#0#0, Tclass.OneLayer.wrap(TwoLayers.wrap2$T), $h)));
...
axiom (forall a#18#0#0: DatatypeType :: 
  { #TwoLayers.wrap2.Wrap2(Lit(a#18#0#0)) } 
  #TwoLayers.wrap2.Wrap2(Lit(a#18#0#0)) == Lit(#TwoLayers.wrap2.Wrap2(a#18#0#0)));

function TwoLayers.wrap2.get(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#19#0#0: DatatypeType :: 
  { #TwoLayers.wrap2.Wrap2(a#19#0#0) } 
  TwoLayers.wrap2.get(#TwoLayers.wrap2.Wrap2(a#19#0#0)) == a#19#0#0);

// Inductive rank
axiom (forall a#20#0#0: DatatypeType :: 
  { #TwoLayers.wrap2.Wrap2(a#20#0#0) } 
  DtRank(a#20#0#0) < DtRank(#TwoLayers.wrap2.Wrap2(a#20#0#0)));
   ...
   ==> (forall TwoLayers._default.F$U: Ty, w#0: DatatypeType :: 
    ...
    TwoLayers.__default.F#canCall(TwoLayers._default.F$U, w#0)
       ...
       ==> TwoLayers.wrap2.Wrap2_q(w#0)
         && TwoLayers.__default.F(TwoLayers._default.F$U, w#0)
           == (var a#0 := TwoLayers.wrap2.get(w#0); a#0));
    ...
    TwoLayers.__default.F#canCall(TwoLayers._default.F$U, Lit(w#0))
       ...
       ==> TwoLayers.wrap2.Wrap2_q(Lit(w#0))
         && TwoLayers.__default.F(TwoLayers._default.F$U, Lit(w#0))
           == (var a#2 := Lit(TwoLayers.wrap2.get(Lit(w#0))); a#2));

procedure CheckWellformed$$TwoLayers.__default.F(TwoLayers._default.F$U: Ty, 
    w#0: DatatypeType where $Is(w#0, Tclass.TwoLayers.wrap2(TwoLayers._default.F$U)));
   ...
   ==> (forall TwoLayers._default.G$U: Ty, w#0: DatatypeType :: 
    ...
    TwoLayers.__default.G#canCall(TwoLayers._default.G$U, w#0)
       ...
       ==> TwoLayers.wrap2.Wrap2_q(w#0)
         && TwoLayers.wrap2.Wrap2_q(w#0)
         && TwoLayers.__default.G(TwoLayers._default.G$U, w#0)
           == (var a#0 := TwoLayers.wrap2.get(w#0); TwoLayers.wrap2.get(w#0)));
    ...
    TwoLayers.__default.G#canCall(TwoLayers._default.G$U, Lit(w#0))
       ...
       ==> TwoLayers.wrap2.Wrap2_q(Lit(w#0))
         ...
         && TwoLayers.__default.G(TwoLayers._default.G$U, Lit(w#0))
           == (var a#2 := Lit(TwoLayers.wrap2.get(Lit(w#0))); 
            Lit(TwoLayers.wrap2.get(Lit(w#0)))));

procedure CheckWellformed$$TwoLayers.__default.G(TwoLayers._default.G$U: Ty, 
    w#0: DatatypeType where $Is(w#0, Tclass.TwoLayers.wrap2(TwoLayers._default.G$U)));
...
procedure CheckWellformed$$TwoLayers.__default.H(TwoLayers._default.H$U: Ty, 
    w#0: DatatypeType where $Is(w#0, Tclass.TwoLayers.wrap2(TwoLayers._default.H$U)));
