...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/array_free_fail.c -bpl ./array_free_fail.bpl
...
procedure {:inline 1} free_array()
{
  ...
  var $i34: i32;
$bb0:
  assume {:sourceloc "test/c/data/array_free_fail.c", 20, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array_free_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array_free_fail.c", 20, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 9);
  assume {:sourceloc "test/c/data/array_free_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/array_free_fail.c", 21, 21} true;
  assume {:verifier.code 0} true;
  call $p3 := malloc(4);
  assume {:sourceloc "test/c/data/array_free_fail.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/data/array_free_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/array_free_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i5, 8));
  $p7 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i5, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/array_free_fail.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p7, $p3);
  assume {:sourceloc "test/c/data/array_free_fail.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/array_free_fail.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i8, 8));
  $p10 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i8, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/array_free_fail.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $p11 := $load.ref($M.0, $p10);
  assume {:sourceloc "test/c/data/array_free_fail.c", 22, 15} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p11, 1);
  assume {:sourceloc "test/c/data/array_free_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/array_free_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/data/array_free_fail.c", 20, 33} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i1, 1);
...
$bb5:
  assume {:sourceloc "test/c/data/array_free_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array_free_fail.c", 25, 17} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.i32($i13, 10);
  assume {:sourceloc "test/c/data/array_free_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i14} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i14 == 1);
  assume {:sourceloc "test/c/data/array_free_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !(($i14 == 1));
  assume {:sourceloc "test/c/data/array_free_fail.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb8:
  ...
  assume {:sourceloc "test/c/data/array_free_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i15, 8));
  $p17 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i15, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/array_free_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb10;
$bb12:
  assume {:sourceloc "test/c/data/array_free_fail.c", 27, 9} true;
  assume {:verifier.code 0} true;
  $i21 := $sext.i32.i64($i13);
  assume {:sourceloc "test/c/data/array_free_fail.c", 27, 9} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i21, 8));
  $p23 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i21, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/array_free_fail.c", 27, 14} true;
  assume {:verifier.code 0} true;
  $p24 := $load.ref($M.0, $p23);
  assume {:sourceloc "test/c/data/array_free_fail.c", 27, 16} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i25 == 1);
  assume {:sourceloc "test/c/data/array_free_fail.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $i26 := $sext.i32.i64($i13);
  assume {:sourceloc "test/c/data/array_free_fail.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i26, 8));
  $p28 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i26, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/array_free_fail.c", 28, 17} true;
  assume {:verifier.code 0} true;
  $p29 := $load.ref($M.0, $p28);
  assume {:sourceloc "test/c/data/array_free_fail.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $p30 := $bitcast.ref.ref($p29);
  assume {:sourceloc "test/c/data/array_free_fail.c", 28, 7} true;
  assume {:verifier.code 0} true;
  call free_($p30);
  assume {:sourceloc "test/c/data/array_free_fail.c", 29, 7} true;
  assume {:verifier.code 0} true;
  $i31 := $sext.i32.i64($i13);
  assume {:sourceloc "test/c/data/array_free_fail.c", 29, 7} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i31, 8));
  $p33 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i31, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/array_free_fail.c", 29, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p33, $0.ref);
  assume {:sourceloc "test/c/data/array_free_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume {:sourceloc "test/c/data/array_free_fail.c", 27, 9} true;
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/data/array_free_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/data/array_free_fail.c", 25, 29} true;
  assume {:verifier.code 0} true;
  $i34 := $add.i32($i13, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/array_free_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/array_free_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call free_array();
  assume {:sourceloc "test/c/data/array_free_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
