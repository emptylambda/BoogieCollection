...
procedure CheckWellformed$$IteratorClient__Reveals.__default.M();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$IteratorClient__Reveals.__default.M();
  modifies $Heap, $Tick;
...
procedure Impl$$IteratorClient__Reveals.__default.M() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$IteratorClient__Reveals.__default.M() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var iter#0: ref
     where $Is(iter#0, Tclass.ModuleWithIterator.Iter())
       && $IsAlloc(iter#0, Tclass.ModuleWithIterator.Iter(), $Heap);
  var $nw: ref;
  var x##0: int;

    // AddMethodImpl: M, Impl$$IteratorClient__Reveals.__default.M
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(394,13): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(395,14)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(395,17)
    ...
    call $nw := Call$$ModuleWithIterator.Iter.__ctor(x##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(395,46)"} true;
    iter#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(395,46)"} true;
}
