...
procedure Impl$$M.public.__ctor()
   returns (this: ref where this != null && $Is(this, Tclass.M.public()), 
    $_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
...
axiom 3 < $FunctionContextHeight
   ==> (forall $o: ref :: { M.public.namespace($o) } $Is(M.public.namespace($o), TInt));
...
axiom 5 < $FunctionContextHeight
   ==> (forall $o: ref :: { M.public.try($o) } $Is(M.public.try($o), TInt));
...
axiom 1 <= $FunctionContextHeight
   ==> 
  M.__default.F#canCall() || 1 != $FunctionContextHeight
   ==> $Is(M.__default.F(), Tclass.M.fixed());
...
procedure CheckWellformed$$M.__default.F();
