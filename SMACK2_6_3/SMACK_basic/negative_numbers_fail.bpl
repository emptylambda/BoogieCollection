...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/negative_numbers_fail.c -bpl ./negative_numbers_fail.bpl
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/basic/negative_numbers_fail.c", 5, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "incr:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/negative_numbers_fail.c", 5, 28} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  assume {:sourceloc "test/c/basic/negative_numbers_fail.c", 5, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/negative_numbers_fail.c", 9, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/negative_numbers_fail.c", 9, 7} true;
  assume {:verifier.code 0} true;
  call $i0 := incr($sub.i32(0, 11));
  call {:cexpr "a"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/negative_numbers_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/negative_numbers_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/negative_numbers_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
