...
procedure CheckWellformed$$TwoLayersOfRequires.__default.f(x#0: int);
...
procedure CheckWellformed$$TwoLayersOfRequires.__default.g(y#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$TwoLayersOfRequires.__default.g(y#0: int)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(57,11): initial state"} true;
...
procedure CheckWellformed$$TwoLayersOfRequires.__default.h(z#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$TwoLayersOfRequires.__default.h(z#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##y#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(63,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume z#0 < 50;
    assume z#0 > 4;
    ...
    else
    {
        ...
        assert {:subsumption 0} ##y#0 < 50;
        assume ##y#0 < 50;
        assert {:subsumption 0} ##y#0 > 4;
        assume ##y#0 > 4;
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume TwoLayersOfRequires.__default.g#canCall(z#0);
        assume TwoLayersOfRequires.__default.h(z#0) == TwoLayersOfRequires.__default.g(z#0);
        assume TwoLayersOfRequires.__default.g#canCall(z#0);
        // CheckWellformedWithResult: any expression
