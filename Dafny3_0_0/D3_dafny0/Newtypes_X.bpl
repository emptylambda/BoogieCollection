...
procedure CheckWellformed$$X.Int(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$X.Int(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for newtype Int
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Newtypes.dfy(143,10): initial state"} true;
...
procedure CheckWellformed$$X.Real(r#0: real);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$X.Real(r#0: real)
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for newtype Real
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Newtypes.dfy(144,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        ...
        assume LitReal(0e0) <= r#0 && r#0 <= LitReal(1e2);
    }
    else
    {
        assume true;
        assert {:subsumption 0} LitReal(0e0) <= LitReal(0e0);
        assert {:subsumption 0} LitReal(0e0) <= LitReal(1e2);
    }
}
...
procedure CheckWellformed$$X.__default.M()
...
implementation Impl$$X.__default.M() returns (i#0: int, r#0: real, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var newtype$check#1: real;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Newtypes.dfy(147,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Newtypes.dfy(148,7)
    assume true;
    newtype$check#0 := LitInt(4);
    assert LitInt(0) <= newtype$check#0 && newtype$check#0 < 100;
    assume true;
    i#0 := LitInt(4);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Newtypes.dfy(148,10)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Newtypes.dfy(149,7)
    assume true;
    newtype$check#1 := LitReal(4e0);
    assert LitReal(0e0) <= newtype$check#1 && newtype$check#1 <= LitReal(1e2);
    assume true;
    r#0 := LitReal(4e0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Newtypes.dfy(149,12)"} true;
}



procedure CheckWellformed$$X.__default.N();
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$X.__default.N();
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure Impl$$X.__default.N() returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
