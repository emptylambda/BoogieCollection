...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/failing/extern_mem_fail.c -bpl ./extern_mem_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/failing/extern_mem_fail.c", 11, 12} true;
  ...
  assume {:sourceloc "test/c/failing/extern_mem_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call foo($p1);
  assume {:sourceloc "test/c/failing/extern_mem_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  call $p2 := bar();
  assume $isExternal($p2);
  assume {:sourceloc "test/c/failing/extern_mem_fail.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, 1);
  assume {:sourceloc "test/c/failing/extern_mem_fail.c", 18, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 2);
  assume {:sourceloc "test/c/failing/extern_mem_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/failing/extern_mem_fail.c", 20, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/failing/extern_mem_fail.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
