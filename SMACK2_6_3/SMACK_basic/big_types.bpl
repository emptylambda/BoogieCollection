...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/big_types.c -bpl ./big_types.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/big_types.c", 23, 6} true;
  ...
  assume {:sourceloc "test/c/basic/big_types.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i96($M.0, $p2);
  assume {:sourceloc "test/c/basic/big_types.c", 23, 8} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/basic/big_types.c:23:8: warning: over-approximating bitwise operation and; */
  $i4 := $and.i96($i3, 79228162514264337589248983040);
  assume {:sourceloc "test/c/basic/big_types.c", 23, 8} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/basic/big_types.c:23:8: warning: over-approximating bitwise operation or; */
  $i5 := $or.i96($i4, 1);
  assume {:sourceloc "test/c/basic/big_types.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i96($M.0, $p2, $i5);
  assume {:sourceloc "test/c/basic/big_types.c", 24, 6} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/basic/big_types.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i128($M.1, $p6);
  assume {:sourceloc "test/c/basic/big_types.c", 24, 8} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/basic/big_types.c:24:8: warning: over-approximating bitwise operation and; */
  $i8 := $and.i128($i7, 340282366920938463463374607427473244160);
  assume {:sourceloc "test/c/basic/big_types.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i128($M.1, $p6, $i8);
  assume {:sourceloc "test/c/basic/big_types.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/big_types.c", 25, 3} true;
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/basic/big_types.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
