...
procedure CheckWellformed$$DtypeRegression.__default.array__equal(a#0: ref where $Is(a#0, Tclass._System.array(TInt)), 
    b#0: ref where $Is(b#0, Tclass._System.array(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$DtypeRegression.__default.array__equal(a#0: ref, b#0: ref)
{
  ...
  var b$reqreads#1: bool;
    ...
    // AddWellformednessCheck for function array_equal
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(304,12): initial state"} true;
    ...
    else
    {
        ...
        b$reqreads#1 := (forall $i: int :: 
          { $_Frame[b#0, IndexField($i)] } 
          0 <= $i && $i < _System.array.Length(b#0) ==> $_Frame[b#0, IndexField($i)]);
        assume DtypeRegression.__default.array__equal($Heap, a#0, b#0)
           == Seq#Equal(Seq#FromArray($Heap, a#0), Seq#FromArray($Heap, b#0));
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(DtypeRegression.__default.array__equal($Heap, a#0, b#0), TBool);
        assert b$reqreads#0;
        assert b$reqreads#1;
    }
}
...
procedure CheckWellformed$$DtypeRegression.__default.duplicate__array(input#0: ref
...
implementation CheckWellformed$$DtypeRegression.__default.duplicate__array(input#0: ref, len#0: int) returns (output#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##a#0: ref;
  var ##b#0: ref;

    // AddMethodImpl: duplicate_array, CheckWellformed$$DtypeRegression.__default.duplicate__array
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(310,9): initial state"} true;
    assert input#0 != null;
    ...
    havoc output#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(312,23): post-state"} true;
    ##a#0 := input#0;
    ...
    assume DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0);
    assume DtypeRegression.__default.array__equal($Heap, input#0, output#0);
}



procedure Call$$DtypeRegression.__default.duplicate__array(input#0: ref
       where $Is(input#0, Tclass._System.array(TInt))
         && $IsAlloc(input#0, Tclass._System.array(TInt), $Heap), 
    len#0: int)
   returns (output#0: ref
  ...
  free ensures DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0);
  free ensures DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0)
     && 
    DtypeRegression.__default.array__equal($Heap, input#0, output#0)
     && Seq#Equal(Seq#FromArray($Heap, input#0), Seq#FromArray($Heap, output#0));
...
procedure Impl$$DtypeRegression.__default.duplicate__array(input#0: ref
       where $Is(input#0, Tclass._System.array(TInt))
         && $IsAlloc(input#0, Tclass._System.array(TInt), $Heap), 
    len#0: int)
   returns (output#0: ref
  ...
  // user-defined postconditions
  free ensures DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0);
  ensures DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0)
     ==> DtypeRegression.__default.array__equal($Heap, input#0, output#0)
       || Seq#Equal(Seq#FromArray($Heap, input#0), Seq#FromArray($Heap, output#0));
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$DtypeRegression.__default.duplicate__array(input#0: ref, len#0: int) returns (output#0: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $nw: ref;
  var i#0: int;
  ...
  var $rhs#0_0: int;
    ...
    // AddMethodImpl: duplicate_array, Impl$$DtypeRegression.__default.duplicate__array
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(313,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(314,12)
    assume true;
    assert 0 <= len#0;
    havoc $nw;
    ...
    output#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(314,26)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(315,11)
    assume true;
    assume true;
    i#0 := LitInt(0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(315,14)"} true;
    // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(316,5)
    ...
    {
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(316,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            if (LitInt(0) <= i#0)
            {
        ...
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(320,17)
        assert output#0 != null;
        ...
        assume $IsGoodHeap($Heap);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(320,27)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(321,9)
        assume true;
        assume true;
        i#0 := i#0 + 1;
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(321,16)"} true;
        // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Array.dfy(316,5)
