...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/simple_double_fail.c -bpl ./simple_double_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/simple_double_fail.c", 12, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/float/simple_double_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i0 := (if $foeq.float.bool($fp(1, 500000, 0), $fp(1, 400000, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/simple_double_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/simple_double_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
