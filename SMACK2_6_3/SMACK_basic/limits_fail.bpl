...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/limits_fail.c -bpl ./limits_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 74304));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/limits_fail.c", 7, 13} true;
  assume {:verifier.code 1} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/limits_fail.c", 7, 13} true;
  assume {:verifier.code 1} true;
  call $i0 := __VERIFIER_nondet_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_char"} boogie_si_record_i8($i0);
  call {:cexpr "x1"} boogie_si_record_i8($i0);
  assume {:sourceloc "test/c/basic/limits_fail.c", 8, 3} true;
...
$bb7:
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "test/c/basic/limits_fail.c", 10, 20} true;
  assume {:verifier.code 1} true;
  call $i5 := __VERIFIER_nondet_signed_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_signed_char"} boogie_si_record_i8($i5);
  call {:cexpr "x2"} boogie_si_record_i8($i5);
  assume {:sourceloc "test/c/basic/limits_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/basic/limits_fail.c", 11, 3} true;
...
$bb15:
  ...
  goto $bb12;
$bb16:
  assume {:sourceloc "test/c/basic/limits_fail.c", 13, 22} true;
  assume {:verifier.code 1} true;
  call $i10 := __VERIFIER_nondet_unsigned_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_char"} boogie_si_record_i8($i10);
  call {:cexpr "x3"} boogie_si_record_i8($i10);
  assume {:sourceloc "test/c/basic/limits_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb17:
  assume {:sourceloc "test/c/basic/limits_fail.c", 14, 3} true;
...
$bb23:
  ...
  goto $bb20;
$bb24:
  assume {:sourceloc "test/c/basic/limits_fail.c", 16, 14} true;
  assume {:verifier.code 1} true;
  call $i15 := __VERIFIER_nondet_short();
  call {:cexpr "smack:ext:__VERIFIER_nondet_short"} boogie_si_record_i16($i15);
  call {:cexpr "x4"} boogie_si_record_i16($i15);
  assume {:sourceloc "test/c/basic/limits_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb25:
  assume {:sourceloc "test/c/basic/limits_fail.c", 17, 3} true;
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i17 := $sge.i32($i16, $sub.i32(0, 32768));
  assume {:sourceloc "test/c/basic/limits_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $sext.i16.i32($i15);
  assume {:sourceloc "test/c/basic/limits_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i19 := $sle.i32($i18, 32767);
  assume {:sourceloc "test/c/basic/limits_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
...
$bb31:
  ...
  goto $bb28;
$bb32:
  assume {:sourceloc "test/c/basic/limits_fail.c", 19, 21} true;
  assume {:verifier.code 1} true;
  call $i20 := __VERIFIER_nondet_signed_short();
  call {:cexpr "smack:ext:__VERIFIER_nondet_signed_short"} boogie_si_record_i16($i20);
  call {:cexpr "x5"} boogie_si_record_i16($i20);
  assume {:sourceloc "test/c/basic/limits_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/basic/limits_fail.c", 20, 3} true;
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i22 := $sge.i32($i21, $sub.i32(0, 32768));
  assume {:sourceloc "test/c/basic/limits_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb34:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i23 := $sext.i16.i32($i20);
  assume {:sourceloc "test/c/basic/limits_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $sle.i32($i23, 32767);
  assume {:sourceloc "test/c/basic/limits_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb36;
$bb40:
  assume {:sourceloc "test/c/basic/limits_fail.c", 22, 25} true;
  assume {:verifier.code 1} true;
  call $i25 := __VERIFIER_nondet_signed_short_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_signed_short_int"} boogie_si_record_i16($i25);
  call {:cexpr "x6"} boogie_si_record_i16($i25);
  assume {:sourceloc "test/c/basic/limits_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/basic/limits_fail.c", 23, 3} true;
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $sge.i32($i26, $sub.i32(0, 32768));
  assume {:sourceloc "test/c/basic/limits_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
...
$bb47:
  ...
  goto $bb44;
$bb48:
  assume {:sourceloc "test/c/basic/limits_fail.c", 25, 23} true;
  assume {:verifier.code 1} true;
  call $i30 := __VERIFIER_nondet_unsigned_short();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_short"} boogie_si_record_i16($i30);
  call {:cexpr "x7"} boogie_si_record_i16($i30);
  assume {:sourceloc "test/c/basic/limits_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb49;
$bb49:
  assume {:sourceloc "test/c/basic/limits_fail.c", 26, 3} true;
...
$bb55:
  ...
  goto $bb52;
$bb56:
  assume {:sourceloc "test/c/basic/limits_fail.c", 28, 27} true;
  assume {:verifier.code 1} true;
  call $i35 := __VERIFIER_nondet_unsigned_short_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_short_int"} boogie_si_record_i16($i35);
  call {:cexpr "x8"} boogie_si_record_i16($i35);
  assume {:sourceloc "test/c/basic/limits_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  goto $bb57;
$bb57:
  assume {:sourceloc "test/c/basic/limits_fail.c", 29, 3} true;
...
$bb63:
  ...
  goto $bb60;
$bb64:
  assume {:sourceloc "test/c/basic/limits_fail.c", 31, 12} true;
  assume {:verifier.code 1} true;
  call $i40 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i40);
  call {:cexpr "x9"} boogie_si_record_i32($i40);
  assume {:sourceloc "test/c/basic/limits_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb65;
$bb65:
  assume {:sourceloc "test/c/basic/limits_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $i41 := $sge.i32($i40, $sub.i32(0, 2147483648));
  assume {:sourceloc "test/c/basic/limits_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
...
$bb71:
  ...
  goto $bb68;
$bb72:
  assume {:sourceloc "test/c/basic/limits_fail.c", 34, 20} true;
  assume {:verifier.code 1} true;
  call $i43 := __VERIFIER_nondet_signed_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_signed_int"} boogie_si_record_i32($i43);
  call {:cexpr "x10"} boogie_si_record_i32($i43);
  assume {:sourceloc "test/c/basic/limits_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb73;
$bb73:
  assume {:sourceloc "test/c/basic/limits_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $i44 := $sge.i32($i43, $sub.i32(0, 2147483648));
  assume {:sourceloc "test/c/basic/limits_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
...
$bb79:
  ...
  goto $bb76;
$bb80:
  assume {:sourceloc "test/c/basic/limits_fail.c", 37, 18} true;
  assume {:verifier.code 1} true;
  call $i46 := __VERIFIER_nondet_unsigned();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned"} boogie_si_record_i32($i46);
  call {:cexpr "x11"} boogie_si_record_i32($i46);
  assume {:sourceloc "test/c/basic/limits_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  goto $bb81;
$bb81:
  assume {:sourceloc "test/c/basic/limits_fail.c", 38, 3} true;
...
$bb87:
  ...
  goto $bb84;
$bb88:
  assume {:sourceloc "test/c/basic/limits_fail.c", 40, 22} true;
  assume {:verifier.code 1} true;
  call $i49 := __VERIFIER_nondet_unsigned_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_int"} boogie_si_record_i32($i49);
  call {:cexpr "x12"} boogie_si_record_i32($i49);
  assume {:sourceloc "test/c/basic/limits_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  goto $bb89;
$bb89:
  assume {:sourceloc "test/c/basic/limits_fail.c", 41, 3} true;
...
$bb95:
  ...
  goto $bb92;
$bb96:
  assume {:sourceloc "test/c/basic/limits_fail.c", 43, 14} true;
  assume {:verifier.code 1} true;
  call $i52 := __VERIFIER_nondet_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long"} boogie_si_record_i64($i52);
  call {:cexpr "x13"} boogie_si_record_i64($i52);
  assume {:sourceloc "test/c/basic/limits_fail.c", 44, 3} true;
  assume {:verifier.code 0} true;
  goto $bb97;
$bb97:
  assume {:sourceloc "test/c/basic/limits_fail.c", 44, 3} true;
  assume {:verifier.code 0} true;
  $i53 := $sge.i64($i52, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "test/c/basic/limits_fail.c", 44, 3} true;
  assume {:verifier.code 0} true;
...
$bb98:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 44, 3} true;
  assume {:verifier.code 0} true;
  $i54 := $sle.i64($i52, 9223372036854775807);
  assume {:sourceloc "test/c/basic/limits_fail.c", 44, 3} true;
  assume {:verifier.code 0} true;
...
$bb103:
  ...
  goto $bb100;
$bb104:
  assume {:sourceloc "test/c/basic/limits_fail.c", 46, 18} true;
  assume {:verifier.code 1} true;
  call $i55 := __VERIFIER_nondet_long_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long_int"} boogie_si_record_i64($i55);
  call {:cexpr "x14"} boogie_si_record_i64($i55);
  assume {:sourceloc "test/c/basic/limits_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
  goto $bb105;
$bb105:
  assume {:sourceloc "test/c/basic/limits_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
  $i56 := $sge.i64($i55, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "test/c/basic/limits_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
...
$bb106:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
  $i57 := $sle.i64($i55, 9223372036854775807);
  assume {:sourceloc "test/c/basic/limits_fail.c", 47, 3} true;
  assume {:verifier.code 0} true;
...
$bb111:
  ...
  goto $bb108;
$bb112:
  assume {:sourceloc "test/c/basic/limits_fail.c", 49, 21} true;
  assume {:verifier.code 1} true;
  call $i58 := __VERIFIER_nondet_signed_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_signed_long"} boogie_si_record_i64($i58);
  call {:cexpr "x15"} boogie_si_record_i64($i58);
  assume {:sourceloc "test/c/basic/limits_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
  goto $bb113;
$bb113:
  assume {:sourceloc "test/c/basic/limits_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $i59 := $sge.i64($i58, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "test/c/basic/limits_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
...
$bb114:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $i60 := $sle.i64($i58, 9223372036854775807);
  assume {:sourceloc "test/c/basic/limits_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
...
$bb119:
  ...
  goto $bb116;
$bb120:
  assume {:sourceloc "test/c/basic/limits_fail.c", 52, 25} true;
  assume {:verifier.code 1} true;
  call $i61 := __VERIFIER_nondet_signed_long_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_signed_long_int"} boogie_si_record_i64($i61);
  call {:cexpr "x16"} boogie_si_record_i64($i61);
  assume {:sourceloc "test/c/basic/limits_fail.c", 53, 3} true;
  assume {:verifier.code 0} true;
  goto $bb121;
$bb121:
  assume {:sourceloc "test/c/basic/limits_fail.c", 53, 3} true;
  assume {:verifier.code 0} true;
  $i62 := $sge.i64($i61, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "test/c/basic/limits_fail.c", 53, 3} true;
  assume {:verifier.code 0} true;
...
$bb122:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 53, 3} true;
  assume {:verifier.code 0} true;
  $i63 := $sle.i64($i61, 9223372036854775807);
  assume {:sourceloc "test/c/basic/limits_fail.c", 53, 3} true;
  assume {:verifier.code 0} true;
...
$bb127:
  ...
  goto $bb124;
$bb128:
  assume {:sourceloc "test/c/basic/limits_fail.c", 55, 23} true;
  assume {:verifier.code 1} true;
  call $i64 := __VERIFIER_nondet_unsigned_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_long"} boogie_si_record_i64($i64);
  call {:cexpr "x17"} boogie_si_record_i64($i64);
  assume {:sourceloc "test/c/basic/limits_fail.c", 56, 3} true;
  assume {:verifier.code 0} true;
  goto $bb129;
$bb129:
  assume {:sourceloc "test/c/basic/limits_fail.c", 56, 3} true;
...
$bb130:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 56, 3} true;
  assume {:verifier.code 0} true;
  $i66 := $ule.i64($i64, 18446744073709551615);
  assume {:sourceloc "test/c/basic/limits_fail.c", 56, 3} true;
  assume {:verifier.code 0} true;
...
$bb135:
  ...
  goto $bb132;
$bb136:
  assume {:sourceloc "test/c/basic/limits_fail.c", 58, 27} true;
  assume {:verifier.code 1} true;
  call $i67 := __VERIFIER_nondet_unsigned_long_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_long_int"} boogie_si_record_i64($i67);
  call {:cexpr "x18"} boogie_si_record_i64($i67);
  assume {:sourceloc "test/c/basic/limits_fail.c", 59, 3} true;
  assume {:verifier.code 0} true;
  goto $bb137;
$bb137:
  assume {:sourceloc "test/c/basic/limits_fail.c", 59, 3} true;
...
$bb138:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 59, 3} true;
  assume {:verifier.code 0} true;
  $i69 := $ule.i64($i67, 18446744073709551615);
  assume {:sourceloc "test/c/basic/limits_fail.c", 59, 3} true;
  assume {:verifier.code 0} true;
...
$bb143:
  ...
  goto $bb140;
$bb144:
  assume {:sourceloc "test/c/basic/limits_fail.c", 61, 19} true;
  assume {:verifier.code 1} true;
  call $i70 := __VERIFIER_nondet_long_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long_long"} boogie_si_record_i64($i70);
  call {:cexpr "x19"} boogie_si_record_i64($i70);
  assume {:sourceloc "test/c/basic/limits_fail.c", 62, 3} true;
  assume {:verifier.code 0} true;
  goto $bb145;
$bb145:
  assume {:sourceloc "test/c/basic/limits_fail.c", 62, 3} true;
  assume {:verifier.code 0} true;
  $i71 := $sge.i64($i70, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "test/c/basic/limits_fail.c", 62, 3} true;
  assume {:verifier.code 0} true;
...
$bb146:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 62, 3} true;
  assume {:verifier.code 0} true;
  $i72 := $sle.i64($i70, 9223372036854775807);
  assume {:sourceloc "test/c/basic/limits_fail.c", 62, 3} true;
  assume {:verifier.code 0} true;
...
$bb151:
  ...
  goto $bb148;
$bb152:
  assume {:sourceloc "test/c/basic/limits_fail.c", 64, 23} true;
  assume {:verifier.code 1} true;
  call $i73 := __VERIFIER_nondet_long_long_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long_long_int"} boogie_si_record_i64($i73);
  call {:cexpr "x20"} boogie_si_record_i64($i73);
  assume {:sourceloc "test/c/basic/limits_fail.c", 65, 3} true;
  assume {:verifier.code 0} true;
  goto $bb153;
$bb153:
  assume {:sourceloc "test/c/basic/limits_fail.c", 65, 3} true;
  assume {:verifier.code 0} true;
  $i74 := $sge.i64($i73, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "test/c/basic/limits_fail.c", 65, 3} true;
  assume {:verifier.code 0} true;
...
$bb154:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 65, 3} true;
  assume {:verifier.code 0} true;
  $i75 := $sle.i64($i73, 9223372036854775807);
  assume {:sourceloc "test/c/basic/limits_fail.c", 65, 3} true;
  assume {:verifier.code 0} true;
...
$bb159:
  ...
  goto $bb156;
$bb160:
  assume {:sourceloc "test/c/basic/limits_fail.c", 67, 26} true;
  assume {:verifier.code 1} true;
  call $i76 := __VERIFIER_nondet_signed_long_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_signed_long_long"} boogie_si_record_i64($i76);
  call {:cexpr "x21"} boogie_si_record_i64($i76);
  assume {:sourceloc "test/c/basic/limits_fail.c", 68, 3} true;
  assume {:verifier.code 0} true;
  goto $bb161;
$bb161:
  assume {:sourceloc "test/c/basic/limits_fail.c", 68, 3} true;
  assume {:verifier.code 0} true;
  $i77 := $sge.i64($i76, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "test/c/basic/limits_fail.c", 68, 3} true;
  assume {:verifier.code 0} true;
...
$bb162:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 68, 3} true;
  assume {:verifier.code 0} true;
  $i78 := $sle.i64($i76, 9223372036854775807);
  assume {:sourceloc "test/c/basic/limits_fail.c", 68, 3} true;
  assume {:verifier.code 0} true;
...
$bb167:
  ...
  goto $bb164;
$bb168:
  assume {:sourceloc "test/c/basic/limits_fail.c", 70, 30} true;
  assume {:verifier.code 1} true;
  call $i79 := __VERIFIER_nondet_signed_long_long_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_signed_long_long_int"} boogie_si_record_i64($i79);
  call {:cexpr "x22"} boogie_si_record_i64($i79);
  assume {:sourceloc "test/c/basic/limits_fail.c", 71, 3} true;
  assume {:verifier.code 0} true;
  goto $bb169;
$bb169:
  assume {:sourceloc "test/c/basic/limits_fail.c", 71, 3} true;
  assume {:verifier.code 0} true;
  $i80 := $sge.i64($i79, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "test/c/basic/limits_fail.c", 71, 3} true;
  assume {:verifier.code 0} true;
...
$bb170:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 71, 3} true;
  assume {:verifier.code 0} true;
  $i81 := $sle.i64($i79, 9223372036854775807);
  assume {:sourceloc "test/c/basic/limits_fail.c", 71, 3} true;
  assume {:verifier.code 0} true;
...
$bb175:
  ...
  goto $bb172;
$bb176:
  assume {:sourceloc "test/c/basic/limits_fail.c", 73, 28} true;
  assume {:verifier.code 1} true;
  call $i82 := __VERIFIER_nondet_unsigned_long_long();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_long_long"} boogie_si_record_i64($i82);
  call {:cexpr "x23"} boogie_si_record_i64($i82);
  assume {:sourceloc "test/c/basic/limits_fail.c", 74, 3} true;
  assume {:verifier.code 0} true;
  goto $bb177;
$bb177:
  assume {:sourceloc "test/c/basic/limits_fail.c", 74, 3} true;
...
$bb178:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 74, 3} true;
  assume {:verifier.code 0} true;
  $i84 := $ule.i64($i82, 18446744073709551615);
  assume {:sourceloc "test/c/basic/limits_fail.c", 74, 3} true;
  assume {:verifier.code 0} true;
...
$bb183:
  ...
  goto $bb180;
$bb184:
  assume {:sourceloc "test/c/basic/limits_fail.c", 76, 32} true;
  assume {:verifier.code 1} true;
  call $i85 := __VERIFIER_nondet_unsigned_long_long_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_long_long_int"} boogie_si_record_i64($i85);
  call {:cexpr "x24"} boogie_si_record_i64($i85);
  assume {:sourceloc "test/c/basic/limits_fail.c", 77, 3} true;
  assume {:verifier.code 0} true;
  goto $bb185;
$bb185:
  assume {:sourceloc "test/c/basic/limits_fail.c", 77, 3} true;
...
$bb186:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 77, 3} true;
  assume {:verifier.code 0} true;
  $i87 := $ule.i64($i85, 18446744073709551615);
  assume {:sourceloc "test/c/basic/limits_fail.c", 77, 3} true;
  assume {:verifier.code 0} true;
...
$bb191:
  ...
  goto $bb188;
$bb192:
  assume {:sourceloc "test/c/basic/limits_fail.c", 80, 15} true;
  assume {:verifier.code 1} true;
  call $i88 := __VERIFIER_nondet_bool();
  call {:cexpr "smack:ext:__VERIFIER_nondet_bool"} boogie_si_record_i1($i88);
  assume {:sourceloc "test/c/basic/limits_fail.c", 80, 9} true;
  assume {:verifier.code 0} true;
  $i89 := $zext.i1.i8($i88);
  call {:cexpr "x25"} boogie_si_record_i8($i89);
  assume {:sourceloc "test/c/basic/limits_fail.c", 81, 3} true;
  assume {:verifier.code 0} true;
  goto $bb193;
$bb193:
  assume {:sourceloc "test/c/basic/limits_fail.c", 81, 3} true;
...
$bb198:
  ...
  goto $bb195;
$bb199:
  assume {:sourceloc "test/c/basic/limits_fail.c", 83, 23} true;
  assume {:verifier.code 1} true;
  call $i96 := __VERIFIER_nondet_uchar();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uchar"} boogie_si_record_i8($i96);
  call {:cexpr "x26"} boogie_si_record_i8($i96);
  assume {:sourceloc "test/c/basic/limits_fail.c", 84, 3} true;
  assume {:verifier.code 0} true;
  goto $bb200;
$bb200:
  assume {:sourceloc "test/c/basic/limits_fail.c", 84, 3} true;
...
$bb206:
  ...
  goto $bb203;
$bb207:
  assume {:sourceloc "test/c/basic/limits_fail.c", 86, 24} true;
  assume {:verifier.code 1} true;
  call $i101 := __VERIFIER_nondet_ushort();
  call {:cexpr "smack:ext:__VERIFIER_nondet_ushort"} boogie_si_record_i16($i101);
  call {:cexpr "x27"} boogie_si_record_i16($i101);
  assume {:sourceloc "test/c/basic/limits_fail.c", 87, 3} true;
  assume {:verifier.code 0} true;
  goto $bb208;
$bb208:
  assume {:sourceloc "test/c/basic/limits_fail.c", 87, 3} true;
...
$bb209:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 87, 3} true;
  assume {:verifier.code 0} true;
  $i104 := $zext.i16.i32($i101);
  assume {:sourceloc "test/c/basic/limits_fail.c", 87, 3} true;
  assume {:verifier.code 0} true;
  $i105 := $sle.i32($i104, 65535);
  assume {:sourceloc "test/c/basic/limits_fail.c", 87, 3} true;
  assume {:verifier.code 0} true;
...
$bb214:
  ...
  goto $bb211;
$bb215:
  assume {:sourceloc "test/c/basic/limits_fail.c", 89, 22} true;
  assume {:verifier.code 1} true;
  call $i106 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i106);
  call {:cexpr "x28"} boogie_si_record_i32($i106);
  assume {:sourceloc "test/c/basic/limits_fail.c", 90, 3} true;
  assume {:verifier.code 0} true;
  goto $bb216;
$bb216:
  assume {:sourceloc "test/c/basic/limits_fail.c", 90, 3} true;
...
$bb222:
  ...
  goto $bb219;
$bb223:
  assume {:sourceloc "test/c/basic/limits_fail.c", 92, 23} true;
  assume {:verifier.code 1} true;
  call $i109 := __VERIFIER_nondet_ulong();
  call {:cexpr "smack:ext:__VERIFIER_nondet_ulong"} boogie_si_record_i64($i109);
  call {:cexpr "x29"} boogie_si_record_i64($i109);
  assume {:sourceloc "test/c/basic/limits_fail.c", 93, 3} true;
  assume {:verifier.code 0} true;
  goto $bb224;
$bb224:
  assume {:sourceloc "test/c/basic/limits_fail.c", 93, 3} true;
...
$bb225:
  ...
  assume {:sourceloc "test/c/basic/limits_fail.c", 93, 3} true;
  assume {:verifier.code 0} true;
  $i111 := $ule.i64($i109, 18446744073709551615);
  assume {:sourceloc "test/c/basic/limits_fail.c", 93, 3} true;
  assume {:verifier.code 0} true;
...
$bb230:
  ...
  goto $bb227;
$bb231:
  assume {:sourceloc "test/c/basic/limits_fail.c", 95, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_char == $sub.ref(0, 15480));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 16512));
procedure {:inline 1} __SMACK_nondet_char()
  returns ($r: i8);
const __VERIFIER_nondet_signed_char: ref;
axiom (__VERIFIER_nondet_signed_char == $sub.ref(0, 17544));
procedure {:inline 1} __VERIFIER_nondet_signed_char()
  returns ($r: i8)
{
  var $i0: i8;
  var $i1: i32;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1419, 19} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1419, 19} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_signed_char();
  call {:cexpr "smack:ext:__SMACK_nondet_signed_char"} boogie_si_record_i8($i0);
  call {:cexpr "x"} boogie_si_record_i8($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1420, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $sext.i8.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1420, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, $sub.i32(0, 128));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1420, 36} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1420, 39} true;
  assume {:verifier.code 1} true;
  $i4 := $sext.i8.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1420, 41} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 127);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i3);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1420, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i6);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1421, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 18576));
procedure {:inline 1} __SMACK_nondet_signed_char()
  returns ($r: i8);
const __VERIFIER_nondet_unsigned_char: ref;
axiom (__VERIFIER_nondet_unsigned_char == $sub.ref(0, 19608));
  ...
  returns ($r: i8)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1425, 21} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1425, 21} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i8($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1426, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i8.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1426, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1426, 28} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1426, 31} true;
  assume {:verifier.code 1} true;
  $i4 := $zext.i8.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1426, 33} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 255);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i3);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1426, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i6);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1427, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 20640));
procedure {:inline 1} __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __VERIFIER_nondet_short: ref;
axiom (__VERIFIER_nondet_short == $sub.ref(0, 21672));
procedure {:inline 1} __VERIFIER_nondet_short()
  returns ($r: i16)
{
  var $i0: i16;
  var $i1: i32;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1431, 13} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1431, 13} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_short();
  call {:cexpr "smack:ext:__SMACK_nondet_short"} boogie_si_record_i16($i0);
  call {:cexpr "x"} boogie_si_record_i16($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1432, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $sext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1432, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, $sub.i32(0, 32768));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1432, 35} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1432, 38} true;
  assume {:verifier.code 1} true;
  $i4 := $sext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1432, 40} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 32767);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i3);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1432, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i6);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1433, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_short == $sub.ref(0, 22704));
procedure {:inline 1} __SMACK_nondet_short()
  returns ($r: i16);
const __VERIFIER_nondet_signed_short: ref;
axiom (__VERIFIER_nondet_signed_short == $sub.ref(0, 23736));
procedure {:inline 1} __VERIFIER_nondet_signed_short()
  returns ($r: i16)
{
  var $i0: i16;
  var $i1: i32;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1437, 20} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1437, 20} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_signed_short();
  call {:cexpr "smack:ext:__SMACK_nondet_signed_short"} boogie_si_record_i16($i0);
  call {:cexpr "x"} boogie_si_record_i16($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1438, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $sext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1438, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, $sub.i32(0, 32768));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1438, 35} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1438, 38} true;
  assume {:verifier.code 1} true;
  $i4 := $sext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1438, 40} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 32767);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i3);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1438, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i6);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1439, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 24768));
procedure {:inline 1} __SMACK_nondet_signed_short()
  returns ($r: i16);
const __VERIFIER_nondet_signed_short_int: ref;
axiom (__VERIFIER_nondet_signed_short_int == $sub.ref(0, 25800));
procedure {:inline 1} __VERIFIER_nondet_signed_short_int()
  returns ($r: i16)
{
  var $i0: i16;
  var $i1: i32;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1443, 24} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1443, 24} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_signed_short_int();
  call {:cexpr "smack:ext:__SMACK_nondet_signed_short_int"} boogie_si_record_i16($i0);
  call {:cexpr "x"} boogie_si_record_i16($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1444, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $sext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1444, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, $sub.i32(0, 32768));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1444, 35} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1444, 38} true;
  assume {:verifier.code 1} true;
  $i4 := $sext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1444, 40} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 32767);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i3);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1444, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i6);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1445, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 26832));
procedure {:inline 1} __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_unsigned_short: ref;
axiom (__VERIFIER_nondet_unsigned_short == $sub.ref(0, 27864));
  ...
  returns ($r: i16)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1449, 22} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1449, 22} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i16($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1450, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1450, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1450, 28} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1450, 31} true;
  assume {:verifier.code 1} true;
  $i4 := $zext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1450, 33} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 65535);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i3);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1450, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i6);
...
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 28896));
procedure {:inline 1} __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __VERIFIER_nondet_unsigned_short_int: ref;
axiom (__VERIFIER_nondet_unsigned_short_int == $sub.ref(0, 29928));
procedure {:inline 1} __VERIFIER_nondet_unsigned_short_int()
  returns ($r: i16)
{
  var $i0: i16;
  var $i1: i32;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1455, 26} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1455, 26} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_unsigned_short_int();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_short_int"} boogie_si_record_i16($i0);
  call {:cexpr "x"} boogie_si_record_i16($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1456, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1456, 23} true;
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1456, 28} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1456, 31} true;
  assume {:verifier.code 1} true;
  $i4 := $zext.i16.i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1456, 33} true;
  assume {:verifier.code 1} true;
  $i5 := $sle.i32($i4, 65535);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i6 := $zext.i1.i32($i3);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1456, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i6);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1457, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 30960));
...
procedure {:inline 1} __SMACK_nondet_int()
  returns ($r: i32);
const __VERIFIER_nondet_signed_int: ref;
axiom (__VERIFIER_nondet_signed_int == $sub.ref(0, 34056));
procedure {:inline 1} __VERIFIER_nondet_signed_int()
  returns ($r: i32)
{
  var $i0: i32;
  var $i1: i1;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1467, 18} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1467, 18} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_signed_int();
  call {:cexpr "smack:ext:__SMACK_nondet_signed_int"} boogie_si_record_i32($i0);
  call {:cexpr "x"} boogie_si_record_i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1468, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i32($i0, $sub.i32(0, 2147483648));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1468, 34} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1468, 39} true;
  assume {:verifier.code 1} true;
  $i3 := $sle.i32($i0, 2147483647);
  assume {:verifier.code 0} true;
  $i2 := $i3;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1468, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1469, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 35088));
procedure {:inline 1} __SMACK_nondet_signed_int()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned: ref;
axiom (__VERIFIER_nondet_unsigned == $sub.ref(0, 36120));
procedure {:inline 1} __VERIFIER_nondet_unsigned()
  returns ($r: i32)
{
  var $i0: i32;
  var $i1: i32;
  ...
  var $i11: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1473, 16} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1473, 16} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_unsigned();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned"} boogie_si_record_i32($i0);
  call {:cexpr "x"} boogie_si_record_i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1474, 18} true;
  assume {:verifier.code 1} true;
  call $i1 := __SMACK_nondet_unsigned();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned"} boogie_si_record_i32($i1);
  call {:cexpr "min"} boogie_si_record_i32($i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1475, 18} true;
  assume {:verifier.code 1} true;
  call $i2 := __SMACK_nondet_unsigned();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned"} boogie_si_record_i32($i2);
  call {:cexpr "max"} boogie_si_record_i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1476, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1476, 30} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1476, 37} true;
  assume {:verifier.code 0} true;
  $i5 := $uge.i32($i2, 4294967295);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1476, 49} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i7 := $zext.i1.i32($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1476, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i7);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1477, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $uge.i32($i0, $i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1477, 30} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
...
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1476, 56} true;
  assume {:verifier.code 1} true;
...
$bb6:
  assume ($i8 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1477, 35} true;
  assume {:verifier.code 1} true;
  $i10 := $ule.i32($i0, $i2);
  assume {:verifier.code 0} true;
  $i9 := $i10;
...
$bb8:
  ...
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i9);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1477, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i11);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1478, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 37152));
procedure {:inline 1} __SMACK_nondet_unsigned()
  returns ($r: i32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 38184));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 39216));
procedure {:inline 1} __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __VERIFIER_nondet_long: ref;
axiom (__VERIFIER_nondet_long == $sub.ref(0, 40248));
...
axiom (__SMACK_nondet_long == $sub.ref(0, 41280));
procedure {:inline 1} __SMACK_nondet_long()
  returns ($r: i64);
const __VERIFIER_nondet_long_int: ref;
axiom (__VERIFIER_nondet_long_int == $sub.ref(0, 42312));
procedure {:inline 1} __VERIFIER_nondet_long_int()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i1;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1497, 16} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1497, 16} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_long_int"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1498, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i64($i0, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1498, 35} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1498, 40} true;
  assume {:verifier.code 1} true;
  $i3 := $sle.i64($i0, 9223372036854775807);
  assume {:verifier.code 0} true;
  $i2 := $i3;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1498, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1499, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_long_int == $sub.ref(0, 43344));
procedure {:inline 1} __SMACK_nondet_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_signed_long: ref;
axiom (__VERIFIER_nondet_signed_long == $sub.ref(0, 44376));
procedure {:inline 1} __VERIFIER_nondet_signed_long()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i1;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1503, 19} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1503, 19} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_signed_long();
  call {:cexpr "smack:ext:__SMACK_nondet_signed_long"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1504, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i64($i0, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1504, 35} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1504, 40} true;
  assume {:verifier.code 1} true;
  $i3 := $sle.i64($i0, 9223372036854775807);
  assume {:verifier.code 0} true;
  $i2 := $i3;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1504, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1505, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 45408));
procedure {:inline 1} __SMACK_nondet_signed_long()
  returns ($r: i64);
const __VERIFIER_nondet_signed_long_int: ref;
axiom (__VERIFIER_nondet_signed_long_int == $sub.ref(0, 46440));
procedure {:inline 1} __VERIFIER_nondet_signed_long_int()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i1;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1509, 23} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1509, 23} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_signed_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_signed_long_int"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1510, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i64($i0, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1510, 35} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1510, 40} true;
  assume {:verifier.code 1} true;
  $i3 := $sle.i64($i0, 9223372036854775807);
  assume {:verifier.code 0} true;
  $i2 := $i3;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1510, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1511, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 47472));
procedure {:inline 1} __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_unsigned_long: ref;
axiom (__VERIFIER_nondet_unsigned_long == $sub.ref(0, 48504));
  ...
  returns ($r: i64)
{
  ...
  var $i11: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1515, 21} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1515, 21} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1516, 23} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1517, 23} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1518, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i64($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1518, 30} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1518, 37} true;
  assume {:verifier.code 0} true;
  $i5 := $uge.i64($i2, 18446744073709551615);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1518, 50} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i7 := $zext.i1.i32($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1518, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i7);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1519, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $uge.i64($i0, $i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1519, 30} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  assume {:branchcond $i8} true;
  goto $bb6, $bb7;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1518, 57} true;
  assume {:verifier.code 1} true;
...
$bb6:
  assume ($i8 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1519, 35} true;
  assume {:verifier.code 1} true;
  $i10 := $ule.i64($i0, $i2);
  assume {:verifier.code 0} true;
  $i9 := $i10;
...
$bb8:
  ...
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i9);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1519, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i11);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1520, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 49536));
procedure {:inline 1} __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __VERIFIER_nondet_unsigned_long_int: ref;
axiom (__VERIFIER_nondet_unsigned_long_int == $sub.ref(0, 50568));
procedure {:inline 1} __VERIFIER_nondet_unsigned_long_int()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i64;
  ...
  var $i11: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1524, 25} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1524, 25} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_unsigned_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_int"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1525, 27} true;
  assume {:verifier.code 1} true;
  call $i1 := __SMACK_nondet_unsigned_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_int"} boogie_si_record_i64($i1);
  call {:cexpr "min"} boogie_si_record_i64($i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1526, 27} true;
  assume {:verifier.code 1} true;
  call $i2 := __SMACK_nondet_unsigned_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_int"} boogie_si_record_i64($i2);
  call {:cexpr "max"} boogie_si_record_i64($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1527, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i64($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1527, 30} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1527, 37} true;
  assume {:verifier.code 0} true;
  $i5 := $uge.i64($i2, 18446744073709551615);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1527, 50} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i7 := $zext.i1.i32($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1527, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i7);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1528, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $uge.i64($i0, $i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1528, 30} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  assume {:branchcond $i8} true;
  goto $bb6, $bb7;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1527, 57} true;
  assume {:verifier.code 1} true;
  $i6 := $ule.i64($i2, 18446744073709551615);
  assume {:verifier.code 0} true;
  $i4 := $i6;
...
$bb6:
  assume ($i8 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1528, 35} true;
  assume {:verifier.code 1} true;
  $i10 := $ule.i64($i0, $i2);
  assume {:verifier.code 0} true;
  $i9 := $i10;
...
$bb8:
  ...
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i9);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1528, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i11);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1529, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 51600));
procedure {:inline 1} __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_long_long: ref;
axiom (__VERIFIER_nondet_long_long == $sub.ref(0, 52632));
procedure {:inline 1} __VERIFIER_nondet_long_long()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i1;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1533, 17} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1533, 17} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_long_long();
  call {:cexpr "smack:ext:__SMACK_nondet_long_long"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1534, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i64($i0, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1534, 36} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1534, 41} true;
  assume {:verifier.code 1} true;
  $i3 := $sle.i64($i0, 9223372036854775807);
  assume {:verifier.code 0} true;
  $i2 := $i3;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1534, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1535, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_long_long == $sub.ref(0, 53664));
procedure {:inline 1} __SMACK_nondet_long_long()
  returns ($r: i64);
const __VERIFIER_nondet_long_long_int: ref;
axiom (__VERIFIER_nondet_long_long_int == $sub.ref(0, 54696));
procedure {:inline 1} __VERIFIER_nondet_long_long_int()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i1;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1539, 21} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1539, 21} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_long_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_long_long_int"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1540, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i64($i0, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1540, 36} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1540, 41} true;
  assume {:verifier.code 1} true;
  $i3 := $sle.i64($i0, 9223372036854775807);
  assume {:verifier.code 0} true;
  $i2 := $i3;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1540, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1541, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 55728));
procedure {:inline 1} __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_signed_long_long: ref;
axiom (__VERIFIER_nondet_signed_long_long == $sub.ref(0, 56760));
procedure {:inline 1} __VERIFIER_nondet_signed_long_long()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i1;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1545, 24} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1545, 24} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_signed_long_long();
  call {:cexpr "smack:ext:__SMACK_nondet_signed_long_long"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1546, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i64($i0, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1546, 36} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1546, 41} true;
  assume {:verifier.code 1} true;
  $i3 := $sle.i64($i0, 9223372036854775807);
  assume {:verifier.code 0} true;
  $i2 := $i3;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1546, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1547, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 57792));
procedure {:inline 1} __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __VERIFIER_nondet_signed_long_long_int: ref;
axiom (__VERIFIER_nondet_signed_long_long_int == $sub.ref(0, 58824));
procedure {:inline 1} __VERIFIER_nondet_signed_long_long_int()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i1;
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1551, 28} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1551, 28} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_signed_long_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_signed_long_long_int"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1552, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i64($i0, $sub.i64(0, 9223372036854775808));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1552, 36} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1552, 41} true;
  assume {:verifier.code 1} true;
  $i3 := $sle.i64($i0, 9223372036854775807);
  assume {:verifier.code 0} true;
  $i2 := $i3;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1552, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1553, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 59856));
procedure {:inline 1} __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_unsigned_long_long: ref;
axiom (__VERIFIER_nondet_unsigned_long_long == $sub.ref(0, 60888));
procedure {:inline 1} __VERIFIER_nondet_unsigned_long_long()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i64;
  ...
  var $i11: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1557, 26} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1557, 26} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_unsigned_long_long();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_long"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1558, 28} true;
  assume {:verifier.code 1} true;
  call $i1 := __SMACK_nondet_unsigned_long_long();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_long"} boogie_si_record_i64($i1);
  call {:cexpr "min"} boogie_si_record_i64($i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1559, 28} true;
  assume {:verifier.code 1} true;
  call $i2 := __SMACK_nondet_unsigned_long_long();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_long"} boogie_si_record_i64($i2);
  call {:cexpr "max"} boogie_si_record_i64($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1560, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i64($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1560, 30} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1560, 37} true;
  assume {:verifier.code 0} true;
  $i5 := $uge.i64($i2, 18446744073709551615);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1560, 51} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i7 := $zext.i1.i32($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1560, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i7);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1561, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $uge.i64($i0, $i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1561, 30} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  assume {:branchcond $i8} true;
  goto $bb6, $bb7;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1560, 58} true;
  assume {:verifier.code 1} true;
  $i6 := $ule.i64($i2, 18446744073709551615);
  assume {:verifier.code 0} true;
  $i4 := $i6;
...
$bb6:
  assume ($i8 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1561, 35} true;
  assume {:verifier.code 1} true;
  $i10 := $ule.i64($i0, $i2);
  assume {:verifier.code 0} true;
  $i9 := $i10;
...
$bb8:
  ...
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i9);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1561, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i11);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1562, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 61920));
procedure {:inline 1} __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __VERIFIER_nondet_unsigned_long_long_int: ref;
axiom (__VERIFIER_nondet_unsigned_long_long_int == $sub.ref(0, 62952));
procedure {:inline 1} __VERIFIER_nondet_unsigned_long_long_int()
  returns ($r: i64)
{
  var $i0: i64;
  var $i1: i64;
  ...
  var $i11: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1566, 30} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1566, 30} true;
  assume {:verifier.code 1} true;
  call $i0 := __SMACK_nondet_unsigned_long_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_long_int"} boogie_si_record_i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1567, 32} true;
  assume {:verifier.code 1} true;
  call $i1 := __SMACK_nondet_unsigned_long_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_long_int"} boogie_si_record_i64($i1);
  call {:cexpr "min"} boogie_si_record_i64($i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1568, 32} true;
  assume {:verifier.code 1} true;
  call $i2 := __SMACK_nondet_unsigned_long_long_int();
  call {:cexpr "smack:ext:__SMACK_nondet_unsigned_long_long_int"} boogie_si_record_i64($i2);
  call {:cexpr "max"} boogie_si_record_i64($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1569, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i64($i1, 0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1569, 30} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1569, 37} true;
  assume {:verifier.code 0} true;
  $i5 := $uge.i64($i2, 18446744073709551615);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1569, 51} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i7 := $zext.i1.i32($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1569, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i7);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1570, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $uge.i64($i0, $i1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1570, 30} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  assume {:branchcond $i8} true;
  goto $bb6, $bb7;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1569, 58} true;
  assume {:verifier.code 1} true;
  $i6 := $ule.i64($i2, 18446744073709551615);
  assume {:verifier.code 0} true;
  $i4 := $i6;
...
$bb6:
  assume ($i8 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1570, 35} true;
  assume {:verifier.code 1} true;
  $i10 := $ule.i64($i0, $i2);
  assume {:verifier.code 0} true;
  $i9 := $i10;
...
$bb8:
  ...
  assume {:verifier.code 1} true;
  $i11 := $zext.i1.i32($i9);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1570, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i11);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1571, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 63984));
procedure {:inline 1} __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __VERIFIER_nondet_bool: ref;
axiom (__VERIFIER_nondet_bool == $sub.ref(0, 65016));
...
axiom (__VERIFIER_nondet_uchar == $sub.ref(0, 66048));
procedure {:inline 1} __VERIFIER_nondet_uchar()
  returns ($r: i8)
{
  var $i0: i8;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1583, 21} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1583, 21} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i8($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1584, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_ushort == $sub.ref(0, 67080));
procedure {:inline 1} __VERIFIER_nondet_ushort()
  returns ($r: i16)
{
  var $i0: i16;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1588, 22} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1588, 22} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i16($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1589, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 68112));
...
axiom (__VERIFIER_nondet_ulong == $sub.ref(0, 69144));
procedure {:inline 1} __VERIFIER_nondet_ulong()
  returns ($r: i64)
{
  var $i0: i64;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1598, 21} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1598, 21} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1599, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_decls == $sub.ref(0, 70176));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 71208));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 72240));
...
axiom (llvm.dbg.value == $sub.ref(0, 73272));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 74304));
...
procedure {:inline 1} boogie_si_record_i1(x: i1);
