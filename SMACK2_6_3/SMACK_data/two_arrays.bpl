...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/two_arrays.c -bpl ./two_arrays.bpl
...
procedure {:inline 1} resetArray($p0: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays.c", 16, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/two_arrays.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays.c", 16, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "test/c/data/two_arrays.c", 16, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/two_arrays.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0, $mul.ref($i3, 4));
  assume {:sourceloc "test/c/data/two_arrays.c", 17, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 0);
  assume {:sourceloc "test/c/data/two_arrays.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/two_arrays.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays.c", 16, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
...
procedure {:inline 1} setArray($p0: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays.c", 24, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/data/two_arrays.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays.c", 24, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "test/c/data/two_arrays.c", 24, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/two_arrays.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0, $mul.ref($i3, 4));
  assume {:sourceloc "test/c/data/two_arrays.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 1);
  assume {:sourceloc "test/c/data/two_arrays.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/two_arrays.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays.c", 24, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/data/two_arrays.c", 24, 3} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/two_arrays.c", 31, 26} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/two_arrays.c", 31, 26} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(40);
  assume {:sourceloc "test/c/data/two_arrays.c", 31, 19} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/two_arrays.c", 32, 26} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(40);
  assume {:sourceloc "test/c/data/two_arrays.c", 32, 19} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/data/two_arrays.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call resetArray($p1);
  assume {:sourceloc "test/c/data/two_arrays.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call setArray($p3);
  assume {:sourceloc "test/c/data/two_arrays.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/two_arrays.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays.c", 37, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, 10);
  assume {:sourceloc "test/c/data/two_arrays.c", 37, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/data/two_arrays.c", 38, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/data/two_arrays.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call setArray($p1);
  assume {:sourceloc "test/c/data/two_arrays.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call resetArray($p3);
  assume {:sourceloc "test/c/data/two_arrays.c", 45, 8} true;
  assume {:verifier.code 0} true;
  $i15 := 0;
  goto $bb15;
$bb4:
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/data/two_arrays.c", 39, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/data/two_arrays.c", 39, 5} true;
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "test/c/data/two_arrays.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "test/c/data/two_arrays.c", 37, 29} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i4, 1);
...
$bb15:
  assume {:sourceloc "test/c/data/two_arrays.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays.c", 45, 17} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.i32($i15, 10);
  assume {:sourceloc "test/c/data/two_arrays.c", 45, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i16 == 1);
  assume {:sourceloc "test/c/data/two_arrays.c", 46, 5} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb17:
  assume !(($i16 == 1));
  assume {:sourceloc "test/c/data/two_arrays.c", 50, 8} true;
  assume {:verifier.code 0} true;
  $p26 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/two_arrays.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call free_($p26);
  assume {:sourceloc "test/c/data/two_arrays.c", 51, 8} true;
  assume {:verifier.code 0} true;
  $p27 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/data/two_arrays.c", 51, 3} true;
  assume {:verifier.code 0} true;
  call free_($p27);
  assume {:sourceloc "test/c/data/two_arrays.c", 52, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb21:
  ...
  goto $bb20;
$bb22:
  assume {:sourceloc "test/c/data/two_arrays.c", 47, 5} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb23:
  assume {:sourceloc "test/c/data/two_arrays.c", 47, 5} true;
...
$bb26:
  ...
  goto $bb25;
$bb27:
  assume {:sourceloc "test/c/data/two_arrays.c", 48, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb28:
  assume {:sourceloc "test/c/data/two_arrays.c", 45, 29} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i15, 1);
