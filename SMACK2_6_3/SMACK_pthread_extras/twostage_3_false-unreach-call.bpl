...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/twostage_3_false-unreach-call.c -bpl ./twostage_3_false-unreach-call.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 46545));
...
const data1Lock: ref;
axiom (data1Lock == $sub.ref(0, 1032));
const data2Lock: ref;
axiom (data2Lock == $sub.ref(0, 2064));
const data1Value: ref;
axiom (data1Value == $sub.ref(0, 3092));
const data2Value: ref;
axiom (data2Value == $sub.ref(0, 4120));
const stderr: ref;
axiom (stderr == $add.ref($GLOBALS_BOTTOM, $sub.ref(0, 32776)));
const .str: ref;
axiom (.str == $sub.ref(0, 5174));
const {:count 3} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 6201));
const iTThreads: ref;
axiom (iTThreads == $sub.ref(0, 7229));
const iRThreads: ref;
axiom (iRThreads == $sub.ref(0, 8257));
const {:count 30} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 9311));
const {:count 42} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 10377));
const {:count 40} .str.4: ref;
axiom (.str.4 == $sub.ref(0, 11441));
const {:count 24} .str.5: ref;
axiom (.str.5 == $sub.ref(0, 12489));
const funcA: ref;
axiom (funcA == $sub.ref(0, 13521));
procedure {:inline 1} funcA($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $i2: i32;
  ...
  var $i10: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 22, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 22, 22} true;
  assume {:verifier.code 0} true;
  $p1 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_lock($p1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "data1Value"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 24, 24} true;
  assume {:verifier.code 0} true;
  $p3 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock($p3);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 26, 22} true;
  assume {:verifier.code 0} true;
  $p5 := $M.2;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_lock($p5);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 27, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 27, 27} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i7, 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 27, 14} true;
  assume {:verifier.code 0} true;
  $M.3 := $i8;
  call {:cexpr "data2Value"} boogie_si_record_i32($i8);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 28, 24} true;
  assume {:verifier.code 0} true;
  $p9 := $M.2;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_mutex_unlock($p9);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 14553));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_mutex_lock: ref;
axiom (pthread_mutex_lock == $sub.ref(0, 15585));
procedure {:inline 1} pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 16617));
procedure {:inline 1} pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const funcB: ref;
axiom (funcB == $sub.ref(0, 17649));
procedure {:inline 1} funcB($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $i2: i32;
  ...
  var $i16: i1;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 37, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 37, 22} true;
  assume {:verifier.code 0} true;
  $p1 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 37, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_lock($p1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 38, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 38, 18} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 38, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 39, 26} true;
  assume {:verifier.code 0} true;
  $p5 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 39, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_unlock($p5);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 40, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $M.1;
  call {:cexpr "t1"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 43, 24} true;
  assume {:verifier.code 0} true;
  $p8 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_mutex_unlock($p8);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 45, 22} true;
  assume {:verifier.code 0} true;
  $p10 := $M.2;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 45, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_mutex_lock($p10);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 46, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $M.3;
  call {:cexpr "t2"} boogie_si_record_i32($i12);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 47, 24} true;
  assume {:verifier.code 0} true;
  $p13 := $M.2;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 47, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_mutex_unlock($p13);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 49, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 52, 1} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 51, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const main: ref;
axiom (main == $sub.ref(0, 18681));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 57, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i0, 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 57, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 58, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i0, 3);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 58, 9} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 67, 34} true;
  assume {:verifier.code 0} true;
  call $p12 := malloc(24);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 67, 15} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 67, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $p12;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 68, 34} true;
  assume {:verifier.code 0} true;
  call $p14 := malloc(24);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 68, 15} true;
  assume {:verifier.code 0} true;
  $p15 := $bitcast.ref.ref($p14);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 68, 13} true;
  assume {:verifier.code 0} true;
  $M.2 := $p14;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 69, 38} true;
  assume {:verifier.code 0} true;
  $p16 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 69, 19} true;
  assume {:verifier.code 0} true;
  call $i17 := pthread_mutex_init($p16, $0.ref);
  call {:cexpr "err"} boogie_si_record_i32($i17);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 69, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $ne.i32(0, $i17);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 69, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 59, 15} true;
  assume {:verifier.code 0} true;
  $p4 := $M.4;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 59, 7} true;
  assume {:verifier.code 0} true;
  call $i5 := fprintf.ref.ref($p4, .str);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 60, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 62, 14} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p1, $mul.ref(1, 8));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 62, 14} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.5, $p6);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 62, 7} true;
  assume {:verifier.code 0} true;
  call $i8 := __isoc99_sscanf.ref.ref.ref($p7, .str.1, iTThreads);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 63, 14} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p1, $mul.ref(2, 8));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 63, 14} true;
  assume {:verifier.code 0} true;
  $p10 := $load.ref($M.6, $p9);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 63, 7} true;
  assume {:verifier.code 0} true;
  call $i11 := __isoc99_sscanf.ref.ref.ref($p10, .str.1, iRThreads);
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 65, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume ($i18 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 70, 13} true;
  assume {:verifier.code 0} true;
  $p19 := $M.4;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 70, 5} true;
  assume {:verifier.code 0} true;
  call $i20 := fprintf.ref.ref.i32($p19, .str.2, $i17);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 71, 5} true;
  assume {:verifier.code 0} true;
  call exit($sub.i32(0, 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 71, 5} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i18 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 73, 38} true;
  assume {:verifier.code 0} true;
  $p21 := $M.2;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 73, 19} true;
  assume {:verifier.code 0} true;
  call $i22 := pthread_mutex_init($p21, $0.ref);
  call {:cexpr "err"} boogie_si_record_i32($i22);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 73, 9} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32(0, $i22);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 73, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb9, $bb10;
$bb9:
  assume ($i23 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 74, 13} true;
  assume {:verifier.code 0} true;
  $p24 := $M.4;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 74, 5} true;
  assume {:verifier.code 0} true;
  call $i25 := fprintf.ref.ref.i32($p24, .str.2, $i22);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 75, 5} true;
  assume {:verifier.code 0} true;
  call exit($sub.i32(0, 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 75, 5} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i23 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 78, 19} true;
  assume {:verifier.code 0} true;
  $i26 := $M.7;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 78, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i32.i64($i26);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 78, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/pthread_extras/twostage_3_false-unreach-call.c:78:3: warning: over-approximating unmodeled operation llvm.stacksave; */
  call $p28 := llvm.stacksave();
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 78, 3} true;
  assume {:verifier.code 0} true;
  call $p29 := $alloc($mul.ref(4, $i27));
  assume true;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 79, 19} true;
  assume {:verifier.code 0} true;
  $i30 := $M.9;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 79, 3} true;
  assume {:verifier.code 0} true;
  $i31 := $zext.i32.i64($i30);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 79, 3} true;
  assume {:verifier.code 0} true;
  call $p32 := $alloc($mul.ref(4, $i31));
  assume true;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 81, 8} true;
  assume {:verifier.code 0} true;
  $i33 := 0;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 81, 19} true;
  assume {:verifier.code 0} true;
  $i34 := $M.7;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 81, 17} true;
  assume {:verifier.code 0} true;
  $i35 := $slt.i32($i33, $i34);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 81, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i35} true;
  goto $bb12, $bb13;
$bb12:
  assume ($i35 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 82, 37} true;
  assume {:verifier.code 0} true;
  $i36 := $sext.i32.i64($i33);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 82, 37} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p29, $mul.ref($i36, 4));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 82, 21} true;
  assume {:verifier.code 0} true;
  call $i38 := pthread_create($p37, $0.ref, funcA, $0.ref);
  call {:cexpr "err"} boogie_si_record_i32($i38);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 82, 11} true;
  assume {:verifier.code 0} true;
  $i39 := $ne.i32(0, $i38);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 82, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb14, $bb15;
$bb13:
  assume !(($i35 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 88, 8} true;
  assume {:verifier.code 0} true;
  $i43 := 0;
  goto $bb17;
$bb14:
  assume ($i39 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 83, 15} true;
  assume {:verifier.code 0} true;
  $p40 := $M.4;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 83, 7} true;
  assume {:verifier.code 0} true;
  call $i41 := fprintf.ref.ref.i32($p40, .str.3, $i38);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 84, 7} true;
  assume {:verifier.code 0} true;
  call exit($sub.i32(0, 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 84, 7} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume !(($i39 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 86, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 81, 31} true;
  assume {:verifier.code 0} true;
  $i42 := $add.i32($i33, 1);
...
$bb17:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 88, 19} true;
  assume {:verifier.code 0} true;
  $i44 := $M.9;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 88, 17} true;
  assume {:verifier.code 0} true;
  $i45 := $slt.i32($i43, $i44);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 88, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  goto $bb18, $bb19;
$bb18:
  assume ($i45 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 89, 37} true;
  assume {:verifier.code 0} true;
  $i46 := $sext.i32.i64($i43);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 89, 37} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($p32, $mul.ref($i46, 4));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 89, 21} true;
  assume {:verifier.code 0} true;
  call $i48 := pthread_create($p47, $0.ref, funcB, $0.ref);
  call {:cexpr "err"} boogie_si_record_i32($i48);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 89, 11} true;
  assume {:verifier.code 0} true;
  $i49 := $ne.i32(0, $i48);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 89, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i49} true;
  goto $bb20, $bb21;
$bb19:
  assume !(($i45 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 95, 8} true;
  assume {:verifier.code 0} true;
  $i53 := 0;
  goto $bb23;
$bb20:
  assume ($i49 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 90, 15} true;
  assume {:verifier.code 0} true;
  $p50 := $M.4;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 90, 7} true;
  assume {:verifier.code 0} true;
  call $i51 := fprintf.ref.ref.i32($p50, .str.4, $i48);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 91, 7} true;
  assume {:verifier.code 0} true;
  call exit($sub.i32(0, 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 91, 7} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume !(($i49 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 93, 3} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 88, 31} true;
  assume {:verifier.code 0} true;
  $i52 := $add.i32($i43, 1);
...
$bb23:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 95, 19} true;
  assume {:verifier.code 0} true;
  $i54 := $M.7;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 95, 17} true;
  assume {:verifier.code 0} true;
  $i55 := $slt.i32($i53, $i54);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 95, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i55} true;
  goto $bb24, $bb25;
$bb24:
  assume ($i55 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 96, 34} true;
  assume {:verifier.code 0} true;
  $i56 := $sext.i32.i64($i53);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 96, 34} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($p29, $mul.ref($i56, 4));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 96, 34} true;
  assume {:verifier.code 0} true;
  $i58 := $load.i32($M.10, $p57);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 96, 21} true;
  assume {:verifier.code 0} true;
  call $i59 := pthread_join($i58, $0.ref);
  call {:cexpr "err"} boogie_si_record_i32($i59);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 96, 11} true;
  assume {:verifier.code 0} true;
  $i60 := $ne.i32(0, $i59);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 96, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i60} true;
  goto $bb26, $bb27;
$bb25:
  assume !(($i55 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 102, 8} true;
  assume {:verifier.code 0} true;
  $i64 := 0;
  goto $bb29;
$bb26:
  assume ($i60 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 97, 15} true;
  assume {:verifier.code 0} true;
  $p61 := $M.4;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 97, 7} true;
  assume {:verifier.code 0} true;
  call $i62 := fprintf.ref.ref.i32($p61, .str.5, $i59);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 98, 7} true;
  assume {:verifier.code 0} true;
  call exit($sub.i32(0, 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 98, 7} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume !(($i60 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 100, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb28:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 95, 31} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i53, 1);
...
$bb29:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 102, 19} true;
  assume {:verifier.code 0} true;
  $i65 := $M.9;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 102, 17} true;
  assume {:verifier.code 0} true;
  $i66 := $slt.i32($i64, $i65);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 102, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i66} true;
  goto $bb30, $bb31;
$bb30:
  assume ($i66 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 103, 34} true;
  assume {:verifier.code 0} true;
  $i67 := $sext.i32.i64($i64);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 103, 34} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($p32, $mul.ref($i67, 4));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 103, 34} true;
  assume {:verifier.code 0} true;
  $i69 := $load.i32($M.11, $p68);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 103, 21} true;
  assume {:verifier.code 0} true;
  call $i70 := pthread_join($i69, $0.ref);
  call {:cexpr "err"} boogie_si_record_i32($i70);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 103, 11} true;
  assume {:verifier.code 0} true;
  $i71 := $ne.i32(0, $i70);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 103, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb32, $bb33;
$bb31:
  assume !(($i66 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 110, 1} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/pthread_extras/twostage_3_false-unreach-call.c:110:1: warning: unsoundly ignoring unmodeled operation llvm.stackrestore; */
  call llvm.stackrestore($p28);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 110, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
...
$bb32:
  assume ($i71 == 1);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 104, 15} true;
  assume {:verifier.code 0} true;
  $p72 := $M.4;
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 104, 7} true;
  assume {:verifier.code 0} true;
  call $i73 := fprintf.ref.ref.i32($p72, .str.5, $i70);
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 105, 7} true;
  assume {:verifier.code 0} true;
  call exit($sub.i32(0, 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 105, 7} true;
  assume {:verifier.code 0} true;
...
$bb33:
  assume !(($i71 == 1));
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 107, 3} true;
  assume {:verifier.code 0} true;
  goto $bb34;
$bb34:
  assume {:sourceloc "test/c/pthread_extras/twostage_3_false-unreach-call.c", 102, 31} true;
  assume {:verifier.code 0} true;
  $i74 := $add.i32($i64, 1);
...
const fprintf: ref;
axiom (fprintf == $sub.ref(0, 19713));
procedure {:inline 1} fprintf.ref.ref.i32($p0: ref, $p1: ref, p.2: i32)
  returns ($r: i32);
procedure {:inline 1} fprintf.ref.ref($p0: ref, $p1: ref)
  returns ($r: i32);
const __isoc99_sscanf: ref;
axiom (__isoc99_sscanf == $sub.ref(0, 20745));
procedure {:inline 1} __isoc99_sscanf.ref.ref.ref($p0: ref, $p1: ref, p.2: ref)
  returns ($r: i32);
const malloc: ref;
axiom (malloc == $sub.ref(0, 21777));
...
axiom (pthread_mutex_init == $sub.ref(0, 22809));
procedure {:inline 1} pthread_mutex_init($p0: ref, $p1: ref)
  returns ($r: i32);
const llvm.stacksave: ref;
axiom (llvm.stacksave == $sub.ref(0, 23841));
procedure {:inline 1} llvm.stacksave()
  returns ($r: ref);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 24873));
procedure {:inline 1} pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 25905));
procedure {:inline 1} pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const llvm.stackrestore: ref;
axiom (llvm.stackrestore == $sub.ref(0, 26937));
procedure {:inline 1} llvm.stackrestore($p0: ref);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 27969));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 29001));
...
axiom (__SMACK_dummy == $sub.ref(0, 30033));
...
axiom (__VERIFIER_assert == $sub.ref(0, 31065));
...
axiom (__SMACK_and32 == $sub.ref(0, 32097));
...
axiom (__SMACK_and64 == $sub.ref(0, 33129));
...
axiom (__SMACK_and16 == $sub.ref(0, 34161));
...
axiom (__SMACK_and8 == $sub.ref(0, 35193));
...
axiom (__SMACK_or32 == $sub.ref(0, 36225));
...
axiom (__SMACK_or64 == $sub.ref(0, 37257));
...
axiom (__SMACK_or16 == $sub.ref(0, 38289));
...
axiom (__SMACK_or8 == $sub.ref(0, 39321));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 40353));
...
axiom (__SMACK_decls == $sub.ref(0, 41385));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 42417));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 43449));
...
const exit: ref;
axiom (exit == $sub.ref(0, 44481));
procedure {:inline 1} exit($i0: i32)
{
$bb0:
...
axiom (llvm.dbg.value == $sub.ref(0, 45513));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 46545));
...
$bb0:
  ...
  $M.2 := $0.ref;
  $M.1 := 0;
  call {:cexpr "data1Value"} boogie_si_record_i32(0);
  $M.3 := 0;
  call {:cexpr "data2Value"} boogie_si_record_i32(0);
  $M.7 := 2;
  call {:cexpr "iTThreads"} boogie_si_record_i32(2);
  $M.9 := 1;
  call {:cexpr "iRThreads"} boogie_si_record_i32(1);
  $exn := false;
  return;
}
