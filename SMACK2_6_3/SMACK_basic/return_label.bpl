...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/return_label.c -bpl ./return_label.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/return_label.c", 6, 11} true;
  ...
  assume {:sourceloc "test/c/basic/return_label.c", 8, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "test/c/basic/return_label.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/basic/return_label.c", 9, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/basic/return_label.c", 11, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume true;
  assume {:sourceloc "test/c/basic/return_label.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume true;
  assume {:sourceloc "test/c/basic/return_label.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/basic/return_label.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
