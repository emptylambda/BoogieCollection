...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strcat.c -bpl ./strcat.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strcat.c", 8, 10} true;
  ...
  assume {:sourceloc "test/c/strings/strcat.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := strcpy($p1, .str);
  assume $isExternal($p2);
  assume {:sourceloc "test/c/strings/strcat.c", 10, 28} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 10)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strcat.c", 10, 21} true;
  assume {:verifier.code 0} true;
  call $p4 := strcat($p3, .str.1);
  assume $isExternal($p4);
  assume {:sourceloc "test/c/strings/strcat.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strcat.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := strcmp($p4, .str.2);
  assume {:sourceloc "test/c/strings/strcat.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5, 0);
  assume {:sourceloc "test/c/strings/strcat.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strcat.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
