...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/sigma_false-unreach-call.c -bpl ./sigma_false-unreach-call.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 25796));
...
const array: ref;
axiom (array == $sub.ref(0, 2060));
const thread: ref;
axiom (thread == $sub.ref(0, 3092));
  ...
  returns ($r: ref)
{
  ...
  var $p4: ref;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 15, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 15, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p1, $mul.ref($i3, 4));
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 15, 22} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p4, 1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 23, 20} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 23, 20} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(20);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 23, 7} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 24, 18} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(20);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 24, 11} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 24, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $p2;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 29, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, 5);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 29, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 30, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i4);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 30, 21} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p1, $mul.ref($i6, 4));
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 30, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p7, $0.ref, thread, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 31, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 31, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.1 := $i10;
  call {:cexpr "array_index"} boogie_si_record_i32($i10);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 34, 8} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 29, 33} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i4, 1);
  call {:cexpr "tid"} boogie_si_record_i32($i11);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $i11;
  goto $bb1;
$bb5:
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 34, 21} true;
  assume {:verifier.code 0} true;
  $i13 := $slt.i32($i12, 5);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 34, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i13 == 1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 35, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 35, 5} true;
  assume {:verifier.code 0} true;
  call $i17 := pthread_join($i16, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 36, 3} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !(($i13 == 1));
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 38, 8} true;
  assume {:verifier.code 0} true;
  $i19, $i20 := 0, 0;
  goto $bb9;
$bb8:
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 34, 33} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i12, 1);
  call {:cexpr "tid"} boogie_si_record_i32($i18);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $i12 := $i18;
  goto $bb5;
$bb9:
  ...
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 38, 27} true;
  assume {:verifier.code 0} true;
  $i21 := $slt.i32($i19, 5);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 38, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i21 == 1);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 39, 12} true;
  assume {:verifier.code 0} true;
  $p22 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 39, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 39, 9} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i32($i20, $i25);
  call {:cexpr "sum"} boogie_si_record_i32($i26);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !(($i21 == 1));
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 38, 39} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i19, 1);
  call {:cexpr "tid"} boogie_si_record_i32($i27);
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $i19, $i20 := $i27, $i26;
  goto $bb9;
...
$bb16:
  ...
  goto $bb15;
$bb17:
  assume {:sourceloc "test/c/pthread_extras/sigma_false-unreach-call.c", 45, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_join == $sub.ref(0, 7220));
...
axiom (__SMACK_decls == $sub.ref(0, 21668));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 22700));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 23732));
...
axiom (llvm.dbg.value == $sub.ref(0, 24764));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 25796));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.1 := 0;
  call {:cexpr "array_index"} boogie_si_record_i32(0);
  $M.0 := $0.ref;
  $exn := false;
  return;
}
