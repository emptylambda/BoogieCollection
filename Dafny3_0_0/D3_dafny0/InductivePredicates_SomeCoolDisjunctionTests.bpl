...
axiom 0 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.P($ly, x#0) } 
    SomeCoolDisjunctionTests.__default.P#canCall(x#0) || 0 != $FunctionContextHeight
       ==> true);
...
procedure CheckWellformed$$SomeCoolDisjunctionTests.__default.P(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$SomeCoolDisjunctionTests.__default.P(x#0: int)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(252,18): initial state"} true;
    ...
    else
    {
        ...
        assume SomeCoolDisjunctionTests.__default.Q#canCall(x#0);
        assume SomeCoolDisjunctionTests.__default.P($LS($LZ), x#0)
           == SomeCoolDisjunctionTests.__default.Q($LS($LZ), x#0);
        assume SomeCoolDisjunctionTests.__default.Q#canCall(x#0);
        // CheckWellformedWithResult: any expression
        assume $Is(SomeCoolDisjunctionTests.__default.P($LS($LZ), x#0), TBool);
        assert b$reqreads#0;
    }
}
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.P_h($ly, _k#0, x#0) } 
    SomeCoolDisjunctionTests.__default.P_h#canCall(_k#0, x#0)
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int :: 
    ...
    SomeCoolDisjunctionTests.__default.P_h#canCall(Lit(_k#0), x#0)
         || 1 != $FunctionContextHeight
       ==> (0 < ORD#Offset(_k#0)
           ==> SomeCoolDisjunctionTests.__default.Q_h#canCall(ORD#Minus(_k#0, ORD#FromNat(1)), x#0))
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#1: Box :: 
            { SomeCoolDisjunctionTests.__default.P_h($LS($ly), _k'#1, x#0) } 
            ORD#LessThanLimit(_k'#1, _k#0)
               ==> SomeCoolDisjunctionTests.__default.P_h#canCall(_k'#1, x#0)))
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int :: 
    ...
    SomeCoolDisjunctionTests.__default.P_h#canCall(Lit(_k#0), LitInt(x#0))
         || 1 != $FunctionContextHeight
       ==> (0 < ORD#Offset(_k#0)
           ==> SomeCoolDisjunctionTests.__default.Q_h#canCall(ORD#Minus(_k#0, ORD#FromNat(1)), x#0))
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
            { SomeCoolDisjunctionTests.__default.P_h($LS($ly), _k'#2, x#0) } 
            ORD#LessThanLimit(_k'#2, _k#0)
               ==> SomeCoolDisjunctionTests.__default.P_h#canCall(_k'#2, x#0)))
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Q($ly, x#0) } 
    SomeCoolDisjunctionTests.__default.Q#canCall(x#0) || 0 != $FunctionContextHeight
       ==> true);
...
procedure CheckWellformed$$SomeCoolDisjunctionTests.__default.Q(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$SomeCoolDisjunctionTests.__default.Q(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(257,18): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        assume $IsAlloc(##x#0, TInt, $Heap);
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume SomeCoolDisjunctionTests.__default.P#canCall(x#0);
        assume SomeCoolDisjunctionTests.__default.Q($LS($LZ), x#0)
           == SomeCoolDisjunctionTests.__default.P($LS($LZ), x#0);
        assume SomeCoolDisjunctionTests.__default.P#canCall(x#0);
        // CheckWellformedWithResult: any expression
        assume $Is(SomeCoolDisjunctionTests.__default.Q($LS($LZ), x#0), TBool);
        assert b$reqreads#0;
    }
}
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Q_h($ly, _k#0, x#0) } 
    SomeCoolDisjunctionTests.__default.Q_h#canCall(_k#0, x#0)
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int :: 
    ...
    SomeCoolDisjunctionTests.__default.Q_h#canCall(Lit(_k#0), x#0)
         || 2 != $FunctionContextHeight
       ==> (0 < ORD#Offset(_k#0)
           ==> SomeCoolDisjunctionTests.__default.P_h#canCall(ORD#Minus(_k#0, ORD#FromNat(1)), x#0))
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#1: Box :: 
            { SomeCoolDisjunctionTests.__default.Q_h($LS($ly), _k'#1, x#0) } 
            ORD#LessThanLimit(_k'#1, _k#0)
               ==> SomeCoolDisjunctionTests.__default.Q_h#canCall(_k'#1, x#0)))
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int :: 
    ...
    SomeCoolDisjunctionTests.__default.Q_h#canCall(Lit(_k#0), LitInt(x#0))
         || 2 != $FunctionContextHeight
       ==> (0 < ORD#Offset(_k#0)
           ==> SomeCoolDisjunctionTests.__default.P_h#canCall(ORD#Minus(_k#0, ORD#FromNat(1)), x#0))
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
            { SomeCoolDisjunctionTests.__default.Q_h($LS($ly), _k'#2, x#0) } 
            ORD#LessThanLimit(_k'#2, _k#0)
               ==> SomeCoolDisjunctionTests.__default.Q_h#canCall(_k'#2, x#0)))
...
procedure CheckWellformed$$SomeCoolDisjunctionTests.__default.L(x#0: int);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$SomeCoolDisjunctionTests.__default.L(x#0: int);
  // user-defined preconditions
  requires SomeCoolDisjunctionTests.__default.P($LS($LS($LZ)), x#0)
     || SomeCoolDisjunctionTests.__default.Q($LS($LS($LZ)), x#0);
  modifies $Heap, $Tick;
...
procedure {:_induction _k#0, x#1} CoCall$$SomeCoolDisjunctionTests.__default.L_h(_k#0: Box, x#1: int);
  // user-defined preconditions
  requires SomeCoolDisjunctionTests.__default.P_h($LS($LS($LZ)), _k#0, x#1)
     || SomeCoolDisjunctionTests.__default.Q_h($LS($LS($LZ)), _k#0, x#1);
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
  ensures Lit(false);
...
procedure {:_induction _k#0, x#1} Impl$$SomeCoolDisjunctionTests.__default.L_h(_k#0: Box, x#1: int) returns ($_reverifyPost: bool);
...
implementation {:_induction _k#0, x#1} Impl$$SomeCoolDisjunctionTests.__default.L_h(_k#0: Box, x#1: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  var $initHeapForallStmt#1: Heap;

    // AddMethodImpl: L#, Impl$$SomeCoolDisjunctionTests.__default.L_h
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(262,14): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#_k0#0: Box, $ih#x0#0: int :: 
      (SomeCoolDisjunctionTests.__default.P_h($LS($LZ), $ih#_k0#0, $ih#x0#0)
             || SomeCoolDisjunctionTests.__default.Q_h($LS($LZ), $ih#_k0#0, $ih#x0#0))
           && (ORD#Less($ih#_k0#0, _k#0)
             || ($ih#_k0#0 == _k#0 && 0 <= $ih#x0#0 && $ih#x0#0 < x#1))
         ==> Lit(false));
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(265,3)
    assume true;
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(262,15)
        $initHeapForallStmt#1 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#1 == $Heap;
        assume (forall _k'#0: Box, x#2: int :: 
          ORD#Less(_k'#0, _k#0)
               && (SomeCoolDisjunctionTests.__default.P_h($LS($LZ), _k'#0, x#2)
                 || SomeCoolDisjunctionTests.__default.Q_h($LS($LZ), _k'#0, x#2))
             ==> Lit(false));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(262,14)"} true;
    }
}
...
procedure CheckWellformed$$SomeCoolDisjunctionTests.__default.Pn(x#0: int);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$SomeCoolDisjunctionTests.__default.Pn(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function Pn
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(268,18): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        assume $IsAlloc(##x#0, TInt, $Heap);
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume SomeCoolDisjunctionTests.__default.Qn#canCall(x#0);
        assume SomeCoolDisjunctionTests.__default.Pn($LS($LZ), x#0)
           == SomeCoolDisjunctionTests.__default.Qn($LS($LZ), x#0);
        assume SomeCoolDisjunctionTests.__default.Qn#canCall(x#0);
        // CheckWellformedWithResult: any expression
        assume $Is(SomeCoolDisjunctionTests.__default.Pn($LS($LZ), x#0), TBool);
        assert b$reqreads#0;
    }
}
...
axiom 7 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: int, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Pn_h($ly, _k#0, x#0) } 
    SomeCoolDisjunctionTests.__default.Pn_h#canCall(_k#0, x#0)
         || (7 != $FunctionContextHeight && LitInt(0) <= _k#0)
       ==> true);
...
procedure CheckWellformed$$SomeCoolDisjunctionTests.__default.Qn(x#0: int);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$SomeCoolDisjunctionTests.__default.Qn(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function Qn
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(273,18): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        assume $IsAlloc(##x#0, TInt, $Heap);
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume SomeCoolDisjunctionTests.__default.Pn#canCall(x#0);
        assume SomeCoolDisjunctionTests.__default.Qn($LS($LZ), x#0)
           == SomeCoolDisjunctionTests.__default.Pn($LS($LZ), x#0);
        assume SomeCoolDisjunctionTests.__default.Pn#canCall(x#0);
        // CheckWellformedWithResult: any expression
        assume $Is(SomeCoolDisjunctionTests.__default.Qn($LS($LZ), x#0), TBool);
        assert b$reqreads#0;
    }
}
...
axiom 8 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: int, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Qn_h($ly, _k#0, x#0) } 
    SomeCoolDisjunctionTests.__default.Qn_h#canCall(_k#0, x#0)
         || (8 != $FunctionContextHeight && LitInt(0) <= _k#0)
       ==> true);
...
procedure CheckWellformed$$SomeCoolDisjunctionTests.__default.Ln(x#0: int);
  free requires 9 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$SomeCoolDisjunctionTests.__default.Ln(x#0: int);
  // user-defined preconditions
  requires SomeCoolDisjunctionTests.__default.Pn($LS($LS($LZ)), x#0)
     || SomeCoolDisjunctionTests.__default.Qn($LS($LS($LZ)), x#0);
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
  ensures Lit(false);
...
procedure {:_induction _k#0, x#1} CoCall$$SomeCoolDisjunctionTests.__default.Ln_h(_k#0: int where LitInt(0) <= _k#0, x#1: int);
  // user-defined preconditions
  requires SomeCoolDisjunctionTests.__default.Pn_h($LS($LS($LZ)), _k#0, x#1)
     || SomeCoolDisjunctionTests.__default.Qn_h($LS($LS($LZ)), _k#0, x#1);
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
  ensures Lit(false);
...
procedure {:_induction _k#0, x#1} Impl$$SomeCoolDisjunctionTests.__default.Ln_h(_k#0: int where LitInt(0) <= _k#0, x#1: int) returns ($_reverifyPost: bool);
...
implementation {:_induction _k#0, x#1} Impl$$SomeCoolDisjunctionTests.__default.Ln_h(_k#0: int, x#1: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;

    // AddMethodImpl: Ln#, Impl$$SomeCoolDisjunctionTests.__default.Ln_h
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(278,14): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#_k0#0: int, $ih#x0#0: int :: 
      LitInt(0) <= $ih#_k0#0
           && (SomeCoolDisjunctionTests.__default.Pn_h($LS($LZ), $ih#_k0#0, $ih#x0#0)
             || SomeCoolDisjunctionTests.__default.Qn_h($LS($LZ), $ih#_k0#0, $ih#x0#0))
           && ((0 <= $ih#_k0#0 && $ih#_k0#0 < _k#0)
             || ($ih#_k0#0 == _k#0 && 0 <= $ih#x0#0 && $ih#x0#0 < x#1))
         ==> Lit(false));
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(281,3)
    assume true;
    if (0 < _k#0)
    {
    }
