...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/smack_code_annot.c -bpl ./smack_code_annot.bpl
  ...
  returns ($r: float)
{
  ...
  var $f2: float;
$bb0:
  assume {:sourceloc "test/c/float/smack_code_annot.c", 6, 16} true;
  ...
  assume {:sourceloc "test/c/float/smack_code_annot.c", 7, 63} true;
  assume {:verifier.code 1} true;
  $f2 := $fpext.float.float($f0);
  assume {:sourceloc "test/c/float/smack_code_annot.c", 7, 3} true;
  assume {:verifier.code 1} true;
  $f1 := $fpext.bvfloat.bvdouble(RNE, $f0);
  assume {:sourceloc "test/c/float/smack_code_annot.c", 8, 3} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/smack_code_annot.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/smack_code_annot.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
