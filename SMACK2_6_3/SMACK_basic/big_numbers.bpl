...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/big_numbers.c -bpl ./big_numbers.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/big_numbers.c", 6, 11} true;
  ...
  assume {:sourceloc "test/c/basic/big_numbers.c", 7, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/big_numbers.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
