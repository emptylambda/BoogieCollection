...
procedure {:opaque} CheckWellformed$$TypeMembers.Tr.IsFavorite(this: ref
       where this != null
         && 
        $Is(this, Tclass.TypeMembers.Tr())
         && $IsAlloc(this, Tclass.TypeMembers.Tr(), $Heap));
...
axiom 11 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    ...
    TypeMembers.Tr.IsFive#canCall(x#0) || 11 != $FunctionContextHeight ==> true);
...
axiom 11 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    { TypeMembers.Tr.IsFive($LS($ly), x#0) } 
    TypeMembers.Tr.IsFive#canCall(x#0) || 11 != $FunctionContextHeight
       ==> TypeMembers.Tr.IsFive($LS($ly), x#0) == (x#0 == LitInt(5)));

// definition axiom for TypeMembers.Tr.IsFive for all literals (revealed)
axiom 11 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    {:weight 3} { TypeMembers.Tr.IsFive($LS($ly), LitInt(x#0)) } 
    TypeMembers.Tr.IsFive#canCall(LitInt(x#0)) || 11 != $FunctionContextHeight
       ==> TypeMembers.Tr.IsFive($LS($ly), LitInt(x#0)) == (LitInt(x#0) == LitInt(5)));

procedure {:opaque} CheckWellformed$$TypeMembers.Tr.IsFive(x#0: int);
  free requires 11 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$TypeMembers.Tr.reveal__IsFavorite(this: ref
       where this != null
         && 
        $Is(this, Tclass.TypeMembers.Tr())
         && $IsAlloc(this, Tclass.TypeMembers.Tr(), $Heap));
...
const MoreFuel_TypeMembers.Tr.IsFavorite0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$TypeMembers.Tr.reveal__IsFavorite(this: ref
       where this != null
         && 
        $Is(this, Tclass.TypeMembers.Tr())
         && $IsAlloc(this, Tclass.TypeMembers.Tr(), $Heap));
  ...
  free ensures StartFuel_TypeMembers.Tr.IsFavorite == $LS(MoreFuel_TypeMembers.Tr.IsFavorite0);
  free ensures StartFuelAssert_TypeMembers.Tr.IsFavorite
     == $LS($LS(MoreFuel_TypeMembers.Tr.IsFavorite0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel_TypeMembers.Tr.IsFavorite0)
     == MoreFuel_TypeMembers.Tr.IsFavorite0;



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$TypeMembers.Tr.reveal__IsFive();
  free requires 14 == $FunctionContextHeight;
  modifies $Heap, $Tick;



const MoreFuel_TypeMembers.Tr.IsFive0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$TypeMembers.Tr.reveal__IsFive();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel_TypeMembers.Tr.IsFive == $LS(MoreFuel_TypeMembers.Tr.IsFive0);
  free ensures StartFuelAssert_TypeMembers.Tr.IsFive
     == $LS($LS(MoreFuel_TypeMembers.Tr.IsFive0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel_TypeMembers.Tr.IsFive0) == MoreFuel_TypeMembers.Tr.IsFive0;
...
axiom 5 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, this: DatatypeType :: 
    ...
    TypeMembers.Color.IsFavorite#canCall(this)
         || (5 != $FunctionContextHeight && $Is(this, Tclass.TypeMembers.Color()))
       ==> true);
...
procedure {:opaque} CheckWellformed$$TypeMembers.Color.IsFavorite(this: DatatypeType
...
axiom 12 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    ...
    TypeMembers.Color.IsFive#canCall(x#0) || 12 != $FunctionContextHeight ==> true);
...
axiom 12 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    { TypeMembers.Color.IsFive($LS($ly), x#0) } 
    TypeMembers.Color.IsFive#canCall(x#0) || 12 != $FunctionContextHeight
       ==> TypeMembers.Color.IsFive($LS($ly), x#0) == (x#0 == LitInt(5)));
...
axiom 12 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    ...
    TypeMembers.Color.IsFive#canCall(LitInt(x#0)) || 12 != $FunctionContextHeight
       ==> TypeMembers.Color.IsFive($LS($ly), LitInt(x#0)) == (LitInt(x#0) == LitInt(5)));

procedure {:opaque} CheckWellformed$$TypeMembers.Color.IsFive(x#0: int);
...
const MoreFuel_TypeMembers.Color.IsFavorite0: LayerType;
...
procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$TypeMembers.Color.reveal__IsFavorite(this: DatatypeType
  ...
  free ensures StartFuel_TypeMembers.Color.IsFavorite
     == $LS(MoreFuel_TypeMembers.Color.IsFavorite0);
  free ensures StartFuelAssert_TypeMembers.Color.IsFavorite
     == $LS($LS(MoreFuel_TypeMembers.Color.IsFavorite0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel_TypeMembers.Color.IsFavorite0)
     == MoreFuel_TypeMembers.Color.IsFavorite0;
...
const MoreFuel_TypeMembers.Color.IsFive0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$TypeMembers.Color.reveal__IsFive();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel_TypeMembers.Color.IsFive == $LS(MoreFuel_TypeMembers.Color.IsFive0);
  free ensures StartFuelAssert_TypeMembers.Color.IsFive
     == $LS($LS(MoreFuel_TypeMembers.Color.IsFive0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel_TypeMembers.Color.IsFive0)
     == MoreFuel_TypeMembers.Color.IsFive0;



procedure CheckWellformed$$TypeMembers.Small(x#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$TypeMembers.Small(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for newtype Small
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(313,10): initial state"} true;
    ...
    if (*)
    {
        ...
        assume LitInt(30) <= x#0 && x#0 < 40;
    }
    else
    {
        assume true;
        assert {:subsumption 0} LitInt(30) <= LitInt(30);
        assert {:subsumption 0} 30 < 40;
    }
}
...
axiom 6 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, this: int :: 
    ...
    TypeMembers.Small.IsFavorite#canCall(this)
         || (6 != $FunctionContextHeight && LitInt(30) <= this && this < 40)
       ==> true);
...
procedure {:opaque} CheckWellformed$$TypeMembers.Small.IsFavorite(this: int where LitInt(30) <= this && this < 40);
  free requires 6 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:opaque} CheckWellformed$$TypeMembers.Small.IsFavorite(this: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var newtype$check#0: int;


    // AddWellformednessCheck for function IsFavorite
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(315,31): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ...
    else
    {
        ...
        assert LitInt(30) <= newtype$check#0 && newtype$check#0 < 40;
        assume TypeMembers.Small.IsFavorite(StartFuel_TypeMembers.Small.IsFavorite, this)
           == 
          (this
           == LitInt(34));
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(TypeMembers.Small.IsFavorite(StartFuel_TypeMembers.Small.IsFavorite, this), 
          TBool);
    }
}
...
axiom 13 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    ...
    TypeMembers.Small.IsFive#canCall(x#0) || 13 != $FunctionContextHeight ==> true);
...
axiom 13 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    { TypeMembers.Small.IsFive($LS($ly), x#0) } 
    TypeMembers.Small.IsFive#canCall(x#0) || 13 != $FunctionContextHeight
       ==> TypeMembers.Small.IsFive($LS($ly), x#0) == (x#0 == LitInt(5)));
...
axiom 13 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    ...
    TypeMembers.Small.IsFive#canCall(LitInt(x#0)) || 13 != $FunctionContextHeight
       ==> TypeMembers.Small.IsFive($LS($ly), LitInt(x#0)) == (LitInt(x#0) == LitInt(5)));

procedure {:opaque} CheckWellformed$$TypeMembers.Small.IsFive(x#0: int);
...
const MoreFuel_TypeMembers.Small.IsFavorite0: LayerType;
...
procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$TypeMembers.Small.reveal__IsFavorite(this: int where LitInt(30) <= this && this < 40);
  ...
  free ensures StartFuel_TypeMembers.Small.IsFavorite
     == $LS(MoreFuel_TypeMembers.Small.IsFavorite0);
  free ensures StartFuelAssert_TypeMembers.Small.IsFavorite
     == $LS($LS(MoreFuel_TypeMembers.Small.IsFavorite0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel_TypeMembers.Small.IsFavorite0)
     == MoreFuel_TypeMembers.Small.IsFavorite0;
...
const MoreFuel_TypeMembers.Small.IsFive0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$TypeMembers.Small.reveal__IsFive();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel_TypeMembers.Small.IsFive == $LS(MoreFuel_TypeMembers.Small.IsFive0);
  free ensures StartFuelAssert_TypeMembers.Small.IsFive
     == $LS($LS(MoreFuel_TypeMembers.Small.IsFive0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel_TypeMembers.Small.IsFive0)
     == MoreFuel_TypeMembers.Small.IsFive0;
...
procedure CheckWellformed$$TypeMembers.__default.Test(tr#0: ref
...
procedure Call$$TypeMembers.__default.Test(tr#0: ref
       where $Is(tr#0, Tclass.TypeMembers.Tr())
         && $IsAlloc(tr#0, Tclass.TypeMembers.Tr(), $Heap), 
    c#0: DatatypeType
       where $Is(c#0, Tclass.TypeMembers.Color())
...
procedure Impl$$TypeMembers.__default.Test(tr#0: ref
       where $Is(tr#0, Tclass.TypeMembers.Tr())
         && $IsAlloc(tr#0, Tclass.TypeMembers.Tr(), $Heap), 
    c#0: DatatypeType
       where $Is(c#0, Tclass.TypeMembers.Color())
...
implementation Impl$$TypeMembers.__default.Test(tr#0: ref, c#0: DatatypeType, s#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var newtype$check#4_0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(323,42): initial state"} true;
    $_reverifyPost := false;
    // ----- alternative statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(324,5)
    if (*)
    {
        assert tr#0 != null;
        assume TypeMembers.Tr.IsFavorite#canCall(tr#0);
        assume TypeMembers.Tr.IsFavorite#canCall(tr#0);
        assume TypeMembers.Tr.IsFavorite(StartFuel_TypeMembers.Tr.IsFavorite, tr#0);
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(326,7)
        assert {:subsumption 0} tr#0 != null;
        assume true;
        assert TypeMembers.Tr.fav(tr#0);
    }
    else if (*)
    {
        assume TypeMembers.Color.IsFavorite#canCall(c#0);
        assume TypeMembers.Color.IsFavorite#canCall(c#0);
        assume TypeMembers.Color.IsFavorite(StartFuel_TypeMembers.Color.IsFavorite, c#0);
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(328,7)
        assume $IsA#TypeMembers.Color(c#0);
        assert TypeMembers.Color#Equal(c#0, #TypeMembers.Color.Pumpkin());
    }
    else if (*)
    {
        assume TypeMembers.Small.IsFavorite#canCall(s#0);
        assume TypeMembers.Small.IsFavorite#canCall(s#0);
        assume TypeMembers.Small.IsFavorite(StartFuel_TypeMembers.Small.IsFavorite, s#0);
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(330,7)
        newtype$check#4_0 := LitInt(34);
        assert LitInt(30) <= newtype$check#4_0 && newtype$check#4_0 < 40;
        assume true;
        assert s#0 == LitInt(34);
    }
    else if (*)
    {
        assert tr#0 != null;
        ...
        assume TypeMembers.Tr.IsFavorite#canCall(tr#0);
        assume TypeMembers.Tr.IsFavorite(StartFuel_TypeMembers.Tr.IsFavorite, tr#0);
        // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(332,7)
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(332,27)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        assert tr#0 != null;
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        // ProcessCallStmt: Make the call
        call Call$$TypeMembers.Tr.reveal__IsFavorite(tr#0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(332,28)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(333,7)
        assert {:subsumption 0} tr#0 != null;
        assume true;
        assert TypeMembers.Tr.fav(tr#0);
    }
    else if (*)
    {
        ...
        assume TypeMembers.Color.IsFavorite#canCall(c#0);
        assume TypeMembers.Color.IsFavorite(StartFuel_TypeMembers.Color.IsFavorite, c#0);
        // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(335,7)
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(335,26)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        // ProcessCallStmt: Make the call
        call Call$$TypeMembers.Color.reveal__IsFavorite(c#0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(335,27)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(336,7)
        assume $IsA#TypeMembers.Color(c#0);
        assert TypeMembers.Color#Equal(c#0, #TypeMembers.Color.Pumpkin());
    }
    else if (*)
    {
        ...
        assume TypeMembers.Small.IsFavorite#canCall(s#0);
        assume TypeMembers.Small.IsFavorite(StartFuel_TypeMembers.Small.IsFavorite, s#0);
        // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(338,7)
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(338,26)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        // ProcessCallStmt: Make the call
        call Call$$TypeMembers.Small.reveal__IsFavorite(s#0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(338,27)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(339,7)
        newtype$check#1_0 := LitInt(34);
        assert LitInt(30) <= newtype$check#1_0 && newtype$check#1_0 < 40;
        assume true;
        assert s#0 == LitInt(34);
    }
    else if (*)
    {
        assume true;
        assume Lit(true);
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(341,7)
        assert tr#0 != null;
        assume TypeMembers.Tr.IsFavorite#canCall(tr#0);
        if (TypeMembers.Tr.IsFavorite(StartFuel_TypeMembers.Tr.IsFavorite, tr#0))
        {
            assume TypeMembers.Color.IsFavorite#canCall(c#0);
        }

        if (TypeMembers.Tr.IsFavorite(StartFuel_TypeMembers.Tr.IsFavorite, tr#0)
           && TypeMembers.Color.IsFavorite(StartFuel_TypeMembers.Color.IsFavorite, c#0))
        {
            assume TypeMembers.Small.IsFavorite#canCall(s#0);
        }

        assume TypeMembers.Tr.IsFavorite#canCall(tr#0)
           && (TypeMembers.Tr.IsFavorite(StartFuel_TypeMembers.Tr.IsFavorite, tr#0)
             ==> TypeMembers.Color.IsFavorite#canCall(c#0)
               && (TypeMembers.Color.IsFavorite(StartFuel_TypeMembers.Color.IsFavorite, c#0)
                 ==> TypeMembers.Small.IsFavorite#canCall(s#0)));
        if (TypeMembers.Tr.IsFavorite(StartFuel_TypeMembers.Tr.IsFavorite, tr#0)
           && TypeMembers.Color.IsFavorite(StartFuel_TypeMembers.Color.IsFavorite, c#0)
           && TypeMembers.Small.IsFavorite(StartFuel_TypeMembers.Small.IsFavorite, s#0))
        {
            // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(342,9)
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(342,29)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert tr#0 != null;
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            ...
            call Call$$TypeMembers.Tr.reveal__IsFavorite(tr#0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(342,62)"} true;
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(342,45)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            ...
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(342,62)"} true;
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(342,61)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            ...
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(342,62)"} true;
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(343,9)
            assert {:subsumption 0} tr#0 != null;
            ...
            {
                newtype$check#0_0_0 := LitInt(55);
                assert LitInt(30) <= newtype$check#0_0_0 && newtype$check#0_0_0 < 40;
            }
...
procedure CheckWellformed$$TypeMembers.__default.StaticTest(x#0: int);
  free requires 17 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$TypeMembers.__default.StaticTest(x#0: int);
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure Impl$$TypeMembers.__default.StaticTest(x#0: int) returns ($_reverifyPost: bool);
  free requires 17 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$TypeMembers.__default.StaticTest(x#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0_0: int;
  var ##x#0_1: int;
  ...
  var ##x#6_0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(347,28): initial state"} true;
    $_reverifyPost := false;
    // ----- alternative statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(348,5)
    if (*)
    {
        ##x#6_0 := x#0;
        ...
        assume TypeMembers.Tr.IsFive#canCall(x#0);
        assume TypeMembers.Tr.IsFive(StartFuel_TypeMembers.Tr.IsFive, x#0);
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(350,7)
        assume true;
        assert x#0 == LitInt(5);
    }
    else if (*)
    {
        ...
        assume TypeMembers.Color.IsFive#canCall(x#0);
        assume TypeMembers.Color.IsFive(StartFuel_TypeMembers.Color.IsFive, x#0);
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(352,7)
        assume true;
        assert x#0 == LitInt(5);
    }
    else if (*)
    {
        ...
        assume TypeMembers.Small.IsFive#canCall(x#0);
        assume TypeMembers.Small.IsFive(StartFuel_TypeMembers.Small.IsFive, x#0);
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(354,7)
        assume true;
        assert x#0 == LitInt(5);
    }
    else if (*)
    {
        ...
        assume TypeMembers.Tr.IsFive#canCall(x#0);
        assume TypeMembers.Tr.IsFive(StartFuel_TypeMembers.Tr.IsFive, x#0);
        // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(356,7)
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(356,23)
        // TrCallStmt: Before ProcessCallStmt
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        // ProcessCallStmt: Make the call
        call Call$$TypeMembers.Tr.reveal__IsFive();
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(356,24)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(357,7)
        assume true;
        assert x#0 == LitInt(5);
    }
    else if (*)
    {
        ...
        assume TypeMembers.Color.IsFive#canCall(x#0);
        assume TypeMembers.Color.IsFive(StartFuel_TypeMembers.Color.IsFive, x#0);
        // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(359,7)
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(359,26)
        // TrCallStmt: Before ProcessCallStmt
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        // ProcessCallStmt: Make the call
        call Call$$TypeMembers.Color.reveal__IsFive();
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(359,27)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(360,7)
        assume true;
        assert x#0 == LitInt(5);
    }
    else if (*)
    {
        ...
        assume TypeMembers.Small.IsFive#canCall(x#0);
        assume TypeMembers.Small.IsFive(StartFuel_TypeMembers.Small.IsFive, x#0);
        // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(362,7)
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(362,26)
        // TrCallStmt: Before ProcessCallStmt
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        // ProcessCallStmt: Make the call
        call Call$$TypeMembers.Small.reveal__IsFive();
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(362,27)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(363,7)
        assume true;
        assert x#0 == LitInt(5);
    }
    else if (*)
    {
        assume true;
        assume Lit(true);
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(365,7)
        ##x#0_0 := x#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0_0, TInt, $Heap);
        assume TypeMembers.Tr.IsFive#canCall(x#0);
        if (TypeMembers.Tr.IsFive(StartFuel_TypeMembers.Tr.IsFive, x#0))
        {
            ##x#0_1 := x#0;
            // assume allocatedness for argument to function
        ...
        if (TypeMembers.Tr.IsFive(StartFuel_TypeMembers.Tr.IsFive, x#0)
           && TypeMembers.Color.IsFive(StartFuel_TypeMembers.Color.IsFive, x#0))
        {
            ##x#0_2 := x#0;
            // assume allocatedness for argument to function
        ...
        assume TypeMembers.Tr.IsFive#canCall(x#0)
           && (TypeMembers.Tr.IsFive(StartFuel_TypeMembers.Tr.IsFive, x#0)
             ==> TypeMembers.Color.IsFive#canCall(x#0)
               && (TypeMembers.Color.IsFive(StartFuel_TypeMembers.Color.IsFive, x#0)
                 ==> TypeMembers.Small.IsFive#canCall(x#0)));
        if (TypeMembers.Tr.IsFive(StartFuel_TypeMembers.Tr.IsFive, x#0)
           && TypeMembers.Color.IsFive(StartFuel_TypeMembers.Color.IsFive, x#0)
           && TypeMembers.Small.IsFive(StartFuel_TypeMembers.Small.IsFive, x#0))
        {
            // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(366,9)
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(366,25)
            // TrCallStmt: Before ProcessCallStmt
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$TypeMembers.Tr.reveal__IsFive();
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(366,58)"} true;
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(366,41)
            // TrCallStmt: Before ProcessCallStmt
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$TypeMembers.Color.reveal__IsFive();
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(366,58)"} true;
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(366,57)
            // TrCallStmt: Before ProcessCallStmt
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$TypeMembers.Small.reveal__IsFive();
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(366,58)"} true;
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(367,9)
            assume true;
            assert x#0 != 5;
        }
        else
