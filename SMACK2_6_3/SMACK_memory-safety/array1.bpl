...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/array1.c -bpl ./array1.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/array1.c", 7, 12} true;
  ...
  assume {:sourceloc "test/c/memory-safety/array1.c", 8, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/memory-safety/array1.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/array1.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call free_($p4);
  assume {:sourceloc "test/c/memory-safety/array1.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
