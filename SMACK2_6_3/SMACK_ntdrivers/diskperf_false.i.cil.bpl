...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/ntdrivers/diskperf_false.i.cil.c -bpl ./diskperf_false.i.cil.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 90823));
...
const UNLOADED: ref;
axiom (UNLOADED == $sub.ref(0, 1028));
const NP: ref;
axiom (NP == $sub.ref(0, 2056));
const DC: ref;
axiom (DC == $sub.ref(0, 3084));
const SKIP1: ref;
axiom (SKIP1 == $sub.ref(0, 4112));
const SKIP2: ref;
axiom (SKIP2 == $sub.ref(0, 5140));
const MPR1: ref;
axiom (MPR1 == $sub.ref(0, 6168));
const MPR3: ref;
axiom (MPR3 == $sub.ref(0, 7196));
const IPC: ref;
axiom (IPC == $sub.ref(0, 8224));
const s: ref;
axiom (s == $sub.ref(0, 9252));
const pended: ref;
axiom (pended == $sub.ref(0, 10280));
const compFptr: ref;
axiom (compFptr == $sub.ref(0, 11312));
const compRegistered: ref;
axiom (compRegistered == $sub.ref(0, 12340));
const lowerDriverReturn: ref;
axiom (lowerDriverReturn == $sub.ref(0, 13368));
const setEventCalled: ref;
axiom (setEventCalled == $sub.ref(0, 14396));
const customIrp: ref;
axiom (customIrp == $sub.ref(0, 15424));
const KeNumberProcessors: ref;
axiom (KeNumberProcessors == $sub.ref(0, 16456));
const myStatus: ref;
axiom (myStatus == $sub.ref(0, 17484));
const routine: ref;
axiom (routine == $sub.ref(0, 18512));
const pirp: ref;
axiom (pirp == $sub.ref(0, 19544));
const .str: ref;
axiom (.str == $sub.ref(0, 20629));
const {:count 17} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 21670));
const {:count 17} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 22711));
const errorFn: ref;
axiom (errorFn == $sub.ref(0, 23743));
procedure {:inline 1} errorFn()
{
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2025, 3} true;
...
$bb1:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2027, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2027, 5} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2028, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
}
const llvm.dbg.label: ref;
axiom (llvm.dbg.label == $sub.ref(0, 24775));
procedure {:inline 1} llvm.dbg.label($p0: ref);
const _BLAST_init: ref;
axiom (_BLAST_init == $sub.ref(0, 25807));
procedure {:inline 1} _BLAST_init()
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2051, 14} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2051, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := 0;
  call {:cexpr "UNLOADED"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2052, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "NP"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2053, 8} true;
  assume {:verifier.code 0} true;
  $M.2 := 2;
  call {:cexpr "DC"} boogie_si_record_i32(2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2054, 11} true;
  assume {:verifier.code 0} true;
  $M.3 := 3;
  call {:cexpr "SKIP1"} boogie_si_record_i32(3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2055, 11} true;
  assume {:verifier.code 0} true;
  $M.4 := 4;
  call {:cexpr "SKIP2"} boogie_si_record_i32(4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2056, 10} true;
  assume {:verifier.code 0} true;
  $M.5 := 5;
  call {:cexpr "MPR1"} boogie_si_record_i32(5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2057, 10} true;
  assume {:verifier.code 0} true;
  $M.6 := 6;
  call {:cexpr "MPR3"} boogie_si_record_i32(6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2058, 9} true;
  assume {:verifier.code 0} true;
  $M.7 := 7;
  call {:cexpr "IPC"} boogie_si_record_i32(7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2059, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2059, 7} true;
  assume {:verifier.code 0} true;
  $M.8 := $i0;
  call {:cexpr "s"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2060, 12} true;
  assume {:verifier.code 0} true;
  $M.9 := 0;
  call {:cexpr "pended"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2061, 14} true;
  assume {:verifier.code 0} true;
  $M.10 := $0.ref;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2062, 20} true;
  assume {:verifier.code 0} true;
  $M.11 := 0;
  call {:cexpr "compRegistered"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2063, 23} true;
  assume {:verifier.code 0} true;
  $M.12 := 0;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2064, 20} true;
  assume {:verifier.code 0} true;
  $M.13 := 0;
  call {:cexpr "setEventCalled"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2065, 15} true;
  assume {:verifier.code 0} true;
  $M.14 := 0;
  call {:cexpr "customIrp"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2066, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 26839));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const ExAllocatePoolWithTag: ref;
axiom (ExAllocatePoolWithTag == $sub.ref(0, 27871));
procedure {:inline 1} ExAllocatePoolWithTag($i0: i32, $i1: i64, $i2: i64)
  returns ($r: ref)
{
  var $p3: ref;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3443, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $p3 := malloc($i1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3446, 5} true;
  assume {:verifier.code 0} true;
  $r := $p3;
  $exn := false;
  return;
}
const DiskPerfSendToNextDriver: ref;
axiom (DiskPerfSendToNextDriver == $sub.ref(0, 28903));
procedure {:inline 1} DiskPerfSendToNextDriver($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $i2: i32;
  var $i3: i32;
  ...
  var $i24: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2343, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2343, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2343, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2343, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i2, $i3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2343, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2344, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $M.3;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2344, 9} true;
  assume {:verifier.code 0} true;
  $M.8 := $i5;
  call {:cexpr "s"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2345, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2346, 9} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2349, 47} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(67, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2349, 47} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.15, $p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2349, 37} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i8.i32($i7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2349, 63} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i8, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2349, 30} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i32.i8($i9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2349, 12} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(67, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2349, 28} true;
  assume {:verifier.code 0} true;
  $M.15 := $store.i8($M.15, $p11, $i10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2350, 12} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2350, 17} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2350, 25} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p13, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p15 := $add.ref($add.ref($add.ref($p13, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2351, 12} true;
  assume {:verifier.code 0} true;
  $p16 := $bitcast.ref.ref($p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2351, 33} true;
  assume {:verifier.code 0} true;
  $p17 := $load.ref($M.16, $p16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2351, 33} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p17, $mul.ref(1, 68));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2351, 33} true;
  assume {:verifier.code 0} true;
  $M.16 := $store.ref($M.16, $p16, $p18);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2353, 53} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 368)), $mul.ref(80, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2353, 53} true;
  assume {:verifier.code 0} true;
  $p20 := $load.ref($M.17, $p19);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2353, 11} true;
  assume {:verifier.code 0} true;
  $p21 := $bitcast.ref.ref($p20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2354, 44} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p21, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2354, 44} true;
  assume {:verifier.code 0} true;
  $p23 := $load.ref($M.18, $p22);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2354, 13} true;
  assume {:verifier.code 0} true;
  call $i24 := IofCallDriver($p23, $p1);
  call {:cexpr "tmp"} boogie_si_record_i64($i24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2356, 5} true;
  assume {:verifier.code 0} true;
  $r := $i24;
  $exn := false;
  return;
}
const DiskPerfCreate: ref;
axiom (DiskPerfCreate == $sub.ref(0, 29935));
procedure {:inline 1} DiskPerfCreate($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $p2: ref;
  var $p3: ref;
  var $p4: ref;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2445, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2445, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p3 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2445, 39} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2445, 46} true;
  assume {:verifier.code 0} true;
  $M.19 := $store.i64($M.19, $p4, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2446, 16} true;
  assume {:verifier.code 0} true;
  $M.20 := 0;
  call {:cexpr "myStatus"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2447, 7} true;
  assume {:verifier.code 0} true;
  call IofCompleteRequest($p1, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2449, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const DiskPerfDeviceControl: ref;
axiom (DiskPerfDeviceControl == $sub.ref(0, 30967));
procedure {:inline 1} DiskPerfDeviceControl($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i35: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2636, 37} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.17, $p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2636, 23} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2637, 28} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2637, 33} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2637, 41} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p10, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p12 := $add.ref($add.ref($add.ref($p10, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2638, 28} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2638, 28} true;
  assume {:verifier.code 0} true;
  $p14 := $load.ref($M.16, $p13);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2639, 26} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p14, $mul.ref(0, 68)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2639, 37} true;
  assume {:verifier.code 0} true;
  $p16 := $bitcast.ref.ref($p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2639, 53} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p16, $mul.ref(0, 32)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2639, 53} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i64($M.21, $p17);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2639, 67} true;
  assume {:verifier.code 0} true;
  $i19 := $eq.i64($i18, 458784);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2639, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i19 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2641, 28} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p14, $mul.ref(0, 68)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2641, 39} true;
  assume {:verifier.code 0} true;
  $p21 := $bitcast.ref.ref($p20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2641, 55} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p21, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2641, 55} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i64($M.21, $p22);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2641, 74} true;
  assume {:verifier.code 0} true;
  $i24 := $ult.i64($i23, 152);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2641, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb3, $bb4;
$bb2:
  assume !(($i19 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2710, 49} true;
  assume {:verifier.code 0} true;
  $p108 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(67, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2710, 49} true;
  assume {:verifier.code 0} true;
  $i109 := $load.i8($M.15, $p108);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2710, 39} true;
  assume {:verifier.code 0} true;
  $i110 := $sext.i8.i32($i109);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2710, 65} true;
  assume {:verifier.code 0} true;
  $i111 := $add.i32($i110, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2710, 32} true;
  assume {:verifier.code 0} true;
  $i112 := $trunc.i32.i8($i111);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2710, 14} true;
  assume {:verifier.code 0} true;
  $p113 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(67, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2710, 30} true;
  assume {:verifier.code 0} true;
  $M.15 := $store.i8($M.15, $p113, $i112);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2711, 14} true;
  assume {:verifier.code 0} true;
  $p114 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2711, 19} true;
  assume {:verifier.code 0} true;
  $p115 := $bitcast.ref.ref($p114);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2711, 27} true;
  assume {:verifier.code 0} true;
  $p116 := $add.ref($add.ref($p115, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p117 := $add.ref($add.ref($add.ref($p115, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2712, 14} true;
  assume {:verifier.code 0} true;
  $p118 := $bitcast.ref.ref($p117);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2712, 35} true;
  assume {:verifier.code 0} true;
  $p119 := $load.ref($M.16, $p118);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2712, 35} true;
  assume {:verifier.code 0} true;
  $p120 := $add.ref($p119, $mul.ref(1, 68));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2712, 35} true;
  assume {:verifier.code 0} true;
  $M.16 := $store.ref($M.16, $p118, $p120);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2713, 46} true;
  assume {:verifier.code 0} true;
  $p121 := $add.ref($add.ref($p8, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2713, 46} true;
  assume {:verifier.code 0} true;
  $p122 := $load.ref($M.18, $p121);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2713, 15} true;
  assume {:verifier.code 0} true;
  call $i123 := IofCallDriver($p122, $p1);
  call {:cexpr "tmp"} boogie_si_record_i64($i123);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2715, 7} true;
  assume {:verifier.code 0} true;
  $i35 := $i123;
  goto $bb8;
$bb3:
  assume ($i24 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2644, 14} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p26 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2644, 35} true;
  assume {:verifier.code 0} true;
  $M.22 := $store.i64($M.22, $p26, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2645, 7} true;
  assume {:verifier.code 0} true;
  $i27 := $sub.i64(0, 1073741789);
  goto $bb5;
$bb4:
  assume !(($i24 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2646, 41} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p8, $mul.ref(0, 344)), $mul.ref(56, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2646, 41} true;
  assume {:verifier.code 0} true;
  $p29 := $load.ref($M.23, $p28);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2647, 13} true;
  assume {:verifier.code 0} true;
  $i30 := $p2i.ref.i32($p29);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2647, 40} true;
  assume {:verifier.code 0} true;
  $i31 := $eq.i32($i30, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2647, 13} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb6, $bb7;
$bb5:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2703, 14} true;
  assume {:verifier.code 0} true;
  $p104 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p105 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2703, 41} true;
  assume {:verifier.code 0} true;
  $p106 := $bitcast.ref.ref($p105);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2703, 48} true;
  assume {:verifier.code 0} true;
  $M.19 := $store.i64($M.19, $p106, $i27);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2704, 20} true;
  assume {:verifier.code 0} true;
  $i107 := $trunc.i64.i32($i27);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2704, 18} true;
  assume {:verifier.code 0} true;
  $M.20 := $i107;
  call {:cexpr "myStatus"} boogie_si_record_i32($i107);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2705, 9} true;
  assume {:verifier.code 0} true;
  call IofCompleteRequest($p1, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2707, 7} true;
  assume {:verifier.code 0} true;
  $i35 := $i27;
  goto $bb8;
$bb6:
  assume ($i31 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2649, 18} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p33 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2649, 45} true;
  assume {:verifier.code 0} true;
  $p34 := $bitcast.ref.ref($p33);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2649, 52} true;
  assume {:verifier.code 0} true;
  $M.19 := $store.i64($M.19, $p34, $sub.i64(0, 1073741823));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2650, 22} true;
  assume {:verifier.code 0} true;
  $M.20 := $sub.i32(0, 1073741823);
  call {:cexpr "myStatus"} boogie_si_record_i32($sub.i32(0, 1073741823));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2651, 13} true;
  assume {:verifier.code 0} true;
  call IofCompleteRequest($p1, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2653, 11} true;
  assume {:verifier.code 0} true;
  $i35 := $sub.i64(0, 1073741823);
  goto $bb8;
$bb7:
  assume !(($i31 == 1));
  assume {:verifier.code 0} true;
...
$bb8:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2718, 1} true;
  assume {:verifier.code 0} true;
  $r := $i35;
  $exn := false;
  return;
$bb9:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2658, 48} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(24, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2658, 62} true;
  assume {:verifier.code 0} true;
  $p37 := $bitcast.ref.ref($p36);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2658, 62} true;
  assume {:verifier.code 0} true;
  $p38 := $load.ref($M.24, $p37);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2658, 15} true;
  assume {:verifier.code 0} true;
  $p39 := $bitcast.ref.ref($p38);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2659, 18} true;
  assume {:verifier.code 0} true;
  $p40 := $bitcast.ref.ref($p39);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2659, 11} true;
  assume {:verifier.code 0} true;
  call $p41 := memset($p40, 0, 152);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  call $p42 := KeQueryPerformanceCounter($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  $i46 := $extractvalue.i64($p42, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  $M.26 := $store.i64($M.26, $p45, $i46);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p44, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  $i48 := $extractvalue.i64($p42, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  $M.26 := $store.i64($M.26, $p47, $i48);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2660, 21} true;
  assume {:verifier.code 0} true;
  call $M.27 := $memcpy.i8($M.27, $M.26, $p49, $p50, 16, false);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2661, 45} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($add.ref($p39, $mul.ref(0, 152)), $mul.ref(112, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2661, 11} true;
  assume {:verifier.code 0} true;
  call KeQuerySystemTime($p51);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2665, 11} true;
  assume {:verifier.code 0} true;
  $i52, $p53 := 0, $p29;
  goto $bb10;
$bb10:
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2665, 21} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2667, 38} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($add.ref($p8, $mul.ref(0, 344)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2667, 38} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i64($M.28, $p54);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2667, 19} true;
  assume {:verifier.code 0} true;
  $i56 := $ult.i64($i52, $i55);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2667, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i56} true;
  goto $bb12, $bb13;
$bb12:
  assume ($i56 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2669, 13} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  assume !(($i56 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2670, 15} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2673, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2673, 15} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i64($M.29, $p58);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2673, 15} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($add.ref($p57, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2673, 15} true;
  assume {:verifier.code 0} true;
  $i61 := $load.i64($M.30, $p60);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2673, 15} true;
  assume {:verifier.code 0} true;
  call DiskPerfAddCounters($p39, $p53, $i59, $i61);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2675, 48} true;
  assume {:verifier.code 0} true;
  $p62 := $bitcast.ref.ref($p53);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2675, 69} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($p62, $mul.ref($p2i.ref.i64($add.ref($add.ref($0.ref, $mul.ref(0, 152)), $mul.ref(112, 1))), 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2675, 19} true;
  assume {:verifier.code 0} true;
  $p64 := $bitcast.ref.ref($p63);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2678, 17} true;
  assume {:verifier.code 0} true;
  $i65 := $add.i64($i52, 1);
  call {:cexpr "i"} boogie_si_record_i64($i65);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2665, 11} true;
  assume {:verifier.code 0} true;
  $i52, $p53 := $i65, $p63;
  goto $bb10;
$bb15:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2683, 54} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($add.ref($p8, $mul.ref(0, 344)), $mul.ref(80, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2683, 54} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i64($M.31, $p66);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2683, 24} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p39, $mul.ref(0, 152)), $mul.ref(96, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2683, 35} true;
  assume {:verifier.code 0} true;
  $M.32 := $store.i64($M.32, $p68, $i67);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2684, 28} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($add.ref($p39, $mul.ref(0, 152)), $mul.ref(96, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2684, 28} true;
  assume {:verifier.code 0} true;
  $i70 := $load.i64($M.32, $p69);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2684, 39} true;
  assume {:verifier.code 0} true;
  $i71 := $eq.i64($i70, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2684, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i71} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i71 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2686, 23} true;
  assume {:verifier.code 0} true;
  $p72 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2686, 23} true;
  assume {:verifier.code 0} true;
  $i73 := $load.i64($M.27, $p72);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2686, 51} true;
  assume {:verifier.code 0} true;
  $p74 := $add.ref($add.ref($p8, $mul.ref(0, 344)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2686, 65} true;
  assume {:verifier.code 0} true;
  $p75 := $bitcast.ref.ref($p74);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2686, 65} true;
  assume {:verifier.code 0} true;
  $i76 := $load.i64($M.33, $p75);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2686, 32} true;
  assume {:verifier.code 0} true;
  $i77 := $sub.i64($i73, $i76);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2685, 22} true;
  assume {:verifier.code 0} true;
  $p78 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2685, 31} true;
  assume {:verifier.code 0} true;
  $M.34 := $store.i64($M.34, $p78, $i77);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2687, 26} true;
  assume {:verifier.code 0} true;
  $p79 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2687, 26} true;
  assume {:verifier.code 0} true;
  $i80 := $load.i64($M.34, $p79);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2687, 35} true;
  assume {:verifier.code 0} true;
  $i81 := $sgt.i64($i80, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2687, 15} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i81 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2689, 42} true;
  assume {:verifier.code 0} true;
  $p82 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2689, 42} true;
  assume {:verifier.code 0} true;
  $i83 := $load.i64($M.34, $p82);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2689, 29} true;
  assume {:verifier.code 0} true;
  $i84 := $mul.i64(10000000, $i83);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2689, 64} true;
  assume {:verifier.code 0} true;
  $p85 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2689, 64} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i64($M.29, $p85);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2689, 52} true;
  assume {:verifier.code 0} true;
  $i87 := $sdiv.i64($i84, $i86);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2688, 28} true;
  assume {:verifier.code 0} true;
  $p88 := $add.ref($add.ref($p39, $mul.ref(0, 152)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2688, 37} true;
  assume {:verifier.code 0} true;
  $p89 := $bitcast.ref.ref($p88);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2688, 46} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i64($M.35, $p89);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2688, 46} true;
  assume {:verifier.code 0} true;
  $i91 := $add.i64($i90, $i87);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2688, 46} true;
  assume {:verifier.code 0} true;
  $M.35 := $store.i64($M.35, $p89, $i91);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2690, 11} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb19:
  assume !(($i81 == 1));
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2692, 9} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2695, 65} true;
  assume {:verifier.code 0} true;
  $p92 := $add.ref($add.ref($p8, $mul.ref(0, 344)), $mul.ref(24, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2695, 65} true;
  assume {:verifier.code 0} true;
  $i93 := $load.i64($M.36, $p92);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2695, 26} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($add.ref($p39, $mul.ref(0, 152)), $mul.ref(128, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2695, 46} true;
  assume {:verifier.code 0} true;
  $M.37 := $store.i64($M.37, $p94, $i93);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2696, 34} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($add.ref($p39, $mul.ref(0, 152)), $mul.ref(136, 1));
  $p96 := $add.ref($add.ref($add.ref($p39, $mul.ref(0, 152)), $mul.ref(136, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2696, 18} true;
  assume {:verifier.code 0} true;
  $p97 := $bitcast.ref.ref($p96);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2697, 36} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($add.ref($p8, $mul.ref(0, 344)), $mul.ref(32, 1));
  $p99 := $add.ref($add.ref($add.ref($p8, $mul.ref(0, 344)), $mul.ref(32, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2697, 18} true;
  assume {:verifier.code 0} true;
  $p100 := $bitcast.ref.ref($p99);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2696, 11} true;
  assume {:verifier.code 0} true;
  call $p101 := memcpy($p97, $p100, 16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2699, 16} true;
  assume {:verifier.code 0} true;
  $p102 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p103 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2699, 37} true;
  assume {:verifier.code 0} true;
  $M.22 := $store.i64($M.22, $p103, 152);
  assume {:verifier.code 0} true;
  $i27 := 0;
  goto $bb5;
}
const DiskPerfShutdownFlush: ref;
axiom (DiskPerfShutdownFlush == $sub.ref(0, 31999));
procedure {:inline 1} DiskPerfShutdownFlush($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i20: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2779, 39} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2779, 39} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p3 := $load.ref($M.17, $p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2779, 25} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2780, 47} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(67, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2780, 47} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.15, $p5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2780, 37} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i8.i32($i6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2780, 63} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i7, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2780, 30} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i32.i8($i8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2780, 12} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(67, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2780, 28} true;
  assume {:verifier.code 0} true;
  $M.15 := $store.i8($M.15, $p10, $i9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2781, 12} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2781, 17} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2781, 25} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p12, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p14 := $add.ref($add.ref($add.ref($p12, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2782, 12} true;
  assume {:verifier.code 0} true;
  $p15 := $bitcast.ref.ref($p14);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2782, 33} true;
  assume {:verifier.code 0} true;
  $p16 := $load.ref($M.16, $p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2782, 33} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p16, $mul.ref(1, 68));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2782, 33} true;
  assume {:verifier.code 0} true;
  $M.16 := $store.ref($M.16, $p15, $p17);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2783, 44} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p4, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2783, 44} true;
  assume {:verifier.code 0} true;
  $p19 := $load.ref($M.18, $p18);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2783, 13} true;
  assume {:verifier.code 0} true;
  call $i20 := IofCallDriver($p19, $p1);
  call {:cexpr "tmp"} boogie_si_record_i64($i20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2785, 5} true;
  assume {:verifier.code 0} true;
  $r := $i20;
  $exn := false;
  return;
}
const DiskPerfDispatchPnp: ref;
axiom (DiskPerfDispatchPnp == $sub.ref(0, 33031));
procedure {:inline 1} DiskPerfDispatchPnp($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i20: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2249, 18} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2249, 18} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2249, 23} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2249, 31} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p3, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p5 := $add.ref($add.ref($add.ref($p3, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2250, 18} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2250, 18} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.16, $p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2251, 16} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p7, $mul.ref(0, 68)), $mul.ref(1, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2251, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.21, $p8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2251, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i8.i32($i9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2251, 30} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2251, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2252, 7} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i11 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2254, 18} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p7, $mul.ref(0, 68)), $mul.ref(1, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2254, 18} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.21, $p12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2254, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i8.i32($i13);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2254, 32} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i14, 2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2254, 11} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2262, 22} true;
  assume {:verifier.code 0} true;
  call $i16 := DiskPerfStartDevice($p0, $p1);
  call {:cexpr "status"} boogie_si_record_i64($i16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2264, 13} true;
  assume {:verifier.code 0} true;
  $i17 := $i16;
  goto $bb11;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2255, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume !(($i15 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2258, 11} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2267, 22} true;
  assume {:verifier.code 0} true;
  call $i18 := DiskPerfRemoveDevice($p0, $p1);
  call {:cexpr "status"} boogie_si_record_i64($i18);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2269, 13} true;
  assume {:verifier.code 0} true;
  $i17 := $i18;
  goto $bb11;
$bb7:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2272, 19} true;
  assume {:verifier.code 0} true;
  call $i19 := DiskPerfSendToNextDriver($p0, $p1);
  call {:cexpr "tmp"} boogie_si_record_i64($i19);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2274, 13} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  goto $bb12;
$bb8:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2259, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 0} true;
  goto $bb9, $bb10;
$bb9:
  assume (0 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2259, 18} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb10:
  assume !((0 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2275, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $u0;
  goto $bb11;
$bb11:
...
$bb12:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2283, 1} true;
  assume {:verifier.code 0} true;
  $r := $i20;
  $exn := false;
  return;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2281, 5} true;
  assume {:verifier.code 0} true;
  $i20 := $i17;
  goto $bb12;
}
const DiskPerfDispatchPower: ref;
axiom (DiskPerfDispatchPower == $sub.ref(0, 34063));
procedure {:inline 1} DiskPerfDispatchPower($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $i2: i32;
  var $i3: i32;
  ...
  var $i24: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2366, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2366, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2366, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2366, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i2, $i3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2366, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2367, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $M.3;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2367, 9} true;
  assume {:verifier.code 0} true;
  $M.8 := $i5;
  call {:cexpr "s"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2368, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2369, 9} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2372, 47} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(67, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2372, 47} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.15, $p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2372, 37} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i8.i32($i7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2372, 63} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i8, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2372, 30} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i32.i8($i9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2372, 12} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(67, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2372, 28} true;
  assume {:verifier.code 0} true;
  $M.15 := $store.i8($M.15, $p11, $i10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2373, 12} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2373, 17} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2373, 25} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p13, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p15 := $add.ref($add.ref($add.ref($p13, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2374, 12} true;
  assume {:verifier.code 0} true;
  $p16 := $bitcast.ref.ref($p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2374, 33} true;
  assume {:verifier.code 0} true;
  $p17 := $load.ref($M.16, $p16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2374, 33} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.16 := $store.ref($M.16, $p16, $p18);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2376, 53} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 368)), $mul.ref(80, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2376, 53} true;
  assume {:verifier.code 0} true;
  $p20 := $load.ref($M.17, $p19);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2376, 11} true;
  assume {:verifier.code 0} true;
  $p21 := $bitcast.ref.ref($p20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2377, 43} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p21, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2377, 43} true;
  assume {:verifier.code 0} true;
  $p23 := $load.ref($M.18, $p22);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2377, 13} true;
  assume {:verifier.code 0} true;
  call $i24 := PoCallDriver($p23, $p1);
  call {:cexpr "tmp"} boogie_si_record_i64($i24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2379, 5} true;
  assume {:verifier.code 0} true;
  $r := $i24;
  $exn := false;
  return;
...
const memset: ref;
axiom (memset == $sub.ref(0, 35095));
procedure {:inline 1} memset($p0: ref, $i1: i32, $i2: i32)
  returns ($r: ref);
const KeQueryPerformanceCounter: ref;
axiom (KeQueryPerformanceCounter == $sub.ref(0, 36127));
procedure {:inline 1} KeQueryPerformanceCounter($p0: ref)
  returns ($r: ref);
const llvm.memcpy.p0i8.p0i8.i64: ref;
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0, 37159));
procedure {:inline 1} llvm.memcpy.p0i8.p0i8.i64($p0: ref, $p1: ref, $i2: i64, $i3: i1);
const DiskPerfLogError: ref;
axiom (DiskPerfLogError == $sub.ref(0, 38191));
procedure {:inline 1} DiskPerfLogError($p0: ref, $i1: i64, $i2: i64, $i3: i64)
{
  var $p4: ref;
  var $p5: ref;
  var $p6: ref;
  ...
  var $p20: ref;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3002, 11} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(8, $zext.i32.i64(1)));
  assume {:verifier.code 0} true;
  $M.38 := $store.ref($M.38, $p4, $p0);
  assume true;
  call {:cexpr "DiskPerfLogError:arg:UniqueId"} boogie_si_record_i64($i1);
  call {:cexpr "DiskPerfLogError:arg:ErrorCode"} boogie_si_record_i64($i2);
  call {:cexpr "DiskPerfLogError:arg:Status"} boogie_si_record_i64($i3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3002, 11} true;
  assume {:verifier.code 0} true;
  $p5 := $load.ref($M.38, $p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3002, 11} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3001, 13} true;
  assume {:verifier.code 0} true;
  call $p7 := IoAllocateErrorLogEntry($p6, $sub.i8(0, 64));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3004, 23} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3006, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $p2i.ref.i32($p8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3006, 37} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3006, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3008, 24} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p8, $mul.ref(0, 80)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3008, 34} true;
  assume {:verifier.code 0} true;
  $M.25 := $store.i64($M.25, $p11, $i2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3009, 24} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p8, $mul.ref(0, 80)), $mul.ref(24, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3009, 41} true;
  assume {:verifier.code 0} true;
  $M.25 := $store.i64($M.25, $p12, $i1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3010, 24} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p8, $mul.ref(0, 80)), $mul.ref(32, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3010, 36} true;
  assume {:verifier.code 0} true;
  $M.25 := $store.i64($M.25, $p13, $i3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3011, 32} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p8, $mul.ref(0, 80)), $mul.ref(72, 1));
  $p15 := $add.ref($add.ref($add.ref($p8, $mul.ref(0, 80)), $mul.ref(72, 1)), $mul.ref(0, 8));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3011, 16} true;
  assume {:verifier.code 0} true;
  $p16 := $bitcast.ref.ref($p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3011, 45} true;
  assume {:verifier.code 0} true;
  $p17 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3011, 9} true;
  assume {:verifier.code 0} true;
  call $p18 := memcpy($p16, $p17, 368);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3013, 24} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p8, $mul.ref(0, 80)), $mul.ref(2, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3013, 37} true;
  assume {:verifier.code 0} true;
  $M.25 := $store.i16($M.25, $p19, 368);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3014, 30} true;
  assume {:verifier.code 0} true;
  $p20 := $bitcast.ref.ref($p8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3014, 9} true;
  assume {:verifier.code 0} true;
  call IoWriteErrorLogEntry($p20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3016, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i10 == 1));
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3018, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const InterlockedIncrement: ref;
axiom (InterlockedIncrement == $sub.ref(0, 39223));
procedure {:inline 1} InterlockedIncrement($p0: ref)
  returns ($r: i64);
const InterlockedDecrement: ref;
axiom (InterlockedDecrement == $sub.ref(0, 40255));
procedure {:inline 1} InterlockedDecrement($p0: ref)
  returns ($r: i64);
const KeQuerySystemTime: ref;
axiom (KeQuerySystemTime == $sub.ref(0, 41287));
procedure {:inline 1} KeQuerySystemTime($p0: ref);
const DiskPerfAddCounters: ref;
axiom (DiskPerfAddCounters == $sub.ref(0, 42319));
procedure {:inline 1} DiskPerfAddCounters($p0: ref, $p1: ref, $i2: i64, $i3: i64)
{
  var $p4: ref;
  var $p5: ref;
  var $p6: ref;
  ...
  var $i93: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 55} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(16, $zext.i32.i64(1)));
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.39 := $store.i64($M.39, $p6, $i2);
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p5, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:verifier.code 0} true;
  $M.40 := $store.i64($M.40, $p7, $i3);
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 55} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 65} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 65} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i64($M.41, $p9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 20} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 30} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 39} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.42, $p12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 39} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i64($i13, $i10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3202, 39} true;
  assume {:verifier.code 0} true;
  $M.42 := $store.i64($M.42, $p12, $i14);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3203, 58} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3203, 71} true;
  assume {:verifier.code 0} true;
  $p16 := $bitcast.ref.ref($p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3203, 71} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i64($M.41, $p16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3203, 20} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3203, 33} true;
  assume {:verifier.code 0} true;
  $p19 := $bitcast.ref.ref($p18);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3203, 42} true;
  assume {:verifier.code 0} true;
  $i20 := $load.i64($M.43, $p19);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3203, 42} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i64($i20, $i17);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3203, 42} true;
  assume {:verifier.code 0} true;
  $M.43 := $store.i64($M.43, $p19, $i21);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3204, 46} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(80, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3204, 46} true;
  assume {:verifier.code 0} true;
  $i23 := $load.i64($M.41, $p22);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3204, 20} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(80, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3204, 30} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3204, 30} true;
  assume {:verifier.code 0} true;
  $M.44 := $store.i64($M.44, $p24, $i26);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3205, 47} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(88, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3205, 47} true;
  assume {:verifier.code 0} true;
  $i28 := $load.i64($M.41, $p27);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3205, 20} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(88, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3205, 31} true;
  assume {:verifier.code 0} true;
  $i30 := $load.i64($M.45, $p29);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3205, 31} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i64($i30, $i28);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3205, 31} true;
  assume {:verifier.code 0} true;
  $M.45 := $store.i64($M.45, $p29, $i31);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3206, 47} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(104, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3206, 47} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i64($M.41, $p32);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3206, 20} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(104, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3206, 31} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i64($M.46, $p34);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3206, 31} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i64($i35, $i33);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3206, 31} true;
  assume {:verifier.code 0} true;
  $M.46 := $store.i64($M.46, $p34, $i36);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3207, 19} true;
  assume {:verifier.code 0} true;
  $p37 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3207, 19} true;
  assume {:verifier.code 0} true;
  $i38 := $load.i64($M.39, $p37);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3207, 28} true;
  assume {:verifier.code 0} true;
  $i39 := $sgt.i64($i38, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3207, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i39} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i39 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3209, 25} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(32, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3209, 34} true;
  assume {:verifier.code 0} true;
  $p41 := $bitcast.ref.ref($p40);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3209, 34} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i64($M.41, $p41);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3209, 43} true;
  assume {:verifier.code 0} true;
  $i43 := $mul.i64($i42, 10000000);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3209, 69} true;
  assume {:verifier.code 0} true;
  $p44 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3209, 69} true;
  assume {:verifier.code 0} true;
  $i45 := $load.i64($M.39, $p44);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3209, 57} true;
  assume {:verifier.code 0} true;
  $i46 := $sdiv.i64($i43, $i45);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3208, 22} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(32, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3208, 31} true;
  assume {:verifier.code 0} true;
  $p48 := $bitcast.ref.ref($p47);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3208, 40} true;
  assume {:verifier.code 0} true;
  $i49 := $load.i64($M.47, $p48);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3208, 40} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i64($i49, $i46);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3208, 40} true;
  assume {:verifier.code 0} true;
  $M.47 := $store.i64($M.47, $p48, $i50);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3211, 25} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3211, 35} true;
  assume {:verifier.code 0} true;
  $p52 := $bitcast.ref.ref($p51);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3211, 35} true;
  assume {:verifier.code 0} true;
  $i53 := $load.i64($M.41, $p52);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3211, 44} true;
  assume {:verifier.code 0} true;
  $i54 := $mul.i64($i53, 10000000);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3211, 70} true;
  assume {:verifier.code 0} true;
  $p55 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3211, 70} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i64($M.39, $p55);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3211, 58} true;
  assume {:verifier.code 0} true;
  $i57 := $sdiv.i64($i54, $i56);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3210, 22} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3210, 32} true;
  assume {:verifier.code 0} true;
  $p59 := $bitcast.ref.ref($p58);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3210, 41} true;
  assume {:verifier.code 0} true;
  $i60 := $load.i64($M.48, $p59);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3210, 41} true;
  assume {:verifier.code 0} true;
  $i61 := $add.i64($i60, $i57);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3210, 41} true;
  assume {:verifier.code 0} true;
  $M.48 := $store.i64($M.48, $p59, $i61);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3213, 25} true;
  assume {:verifier.code 0} true;
  $p62 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3213, 34} true;
  assume {:verifier.code 0} true;
  $p63 := $bitcast.ref.ref($p62);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3213, 34} true;
  assume {:verifier.code 0} true;
  $i64 := $load.i64($M.41, $p63);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3213, 43} true;
  assume {:verifier.code 0} true;
  $i65 := $mul.i64($i64, 10000000);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3213, 69} true;
  assume {:verifier.code 0} true;
  $p66 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3213, 69} true;
  assume {:verifier.code 0} true;
  $i67 := $load.i64($M.39, $p66);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3213, 57} true;
  assume {:verifier.code 0} true;
  $i68 := $sdiv.i64($i65, $i67);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3212, 22} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3212, 31} true;
  assume {:verifier.code 0} true;
  $p70 := $bitcast.ref.ref($p69);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3212, 40} true;
  assume {:verifier.code 0} true;
  $i71 := $load.i64($M.35, $p70);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3212, 40} true;
  assume {:verifier.code 0} true;
  $i72 := $add.i64($i71, $i68);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3212, 40} true;
  assume {:verifier.code 0} true;
  $M.35 := $store.i64($M.35, $p70, $i72);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3214, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i39 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3215, 56} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(32, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3215, 65} true;
  assume {:verifier.code 0} true;
  $p74 := $bitcast.ref.ref($p73);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3215, 65} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i64($M.41, $p74);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3215, 22} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(32, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3215, 31} true;
  assume {:verifier.code 0} true;
  $p77 := $bitcast.ref.ref($p76);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3215, 40} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i64($M.47, $p77);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3215, 40} true;
  assume {:verifier.code 0} true;
  $i79 := $add.i64($i78, $i75);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3215, 40} true;
  assume {:verifier.code 0} true;
  $M.47 := $store.i64($M.47, $p77, $i79);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3216, 57} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3216, 67} true;
  assume {:verifier.code 0} true;
  $p81 := $bitcast.ref.ref($p80);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3216, 67} true;
  assume {:verifier.code 0} true;
  $i82 := $load.i64($M.41, $p81);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3216, 22} true;
  assume {:verifier.code 0} true;
  $p83 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3216, 32} true;
  assume {:verifier.code 0} true;
  $p84 := $bitcast.ref.ref($p83);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3216, 41} true;
  assume {:verifier.code 0} true;
  $i85 := $load.i64($M.48, $p84);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3216, 41} true;
  assume {:verifier.code 0} true;
  $i86 := $add.i64($i85, $i82);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3216, 41} true;
  assume {:verifier.code 0} true;
  $M.48 := $store.i64($M.48, $p84, $i86);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3217, 56} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($add.ref($p1, $mul.ref(0, 152)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3217, 65} true;
  assume {:verifier.code 0} true;
  $p88 := $bitcast.ref.ref($p87);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3217, 65} true;
  assume {:verifier.code 0} true;
  $i89 := $load.i64($M.41, $p88);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3217, 22} true;
  assume {:verifier.code 0} true;
  $p90 := $add.ref($add.ref($p0, $mul.ref(0, 152)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3217, 31} true;
  assume {:verifier.code 0} true;
  $p91 := $bitcast.ref.ref($p90);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3217, 40} true;
  assume {:verifier.code 0} true;
  $i92 := $load.i64($M.35, $p91);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3217, 40} true;
  assume {:verifier.code 0} true;
  $i93 := $add.i64($i92, $i89);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3217, 40} true;
  assume {:verifier.code 0} true;
  $M.35 := $store.i64($M.35, $p91, $i93);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3219, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const memcpy: ref;
axiom (memcpy == $sub.ref(0, 43351));
procedure {:inline 1} memcpy($p0: ref, $p1: ref, $i2: i32)
  returns ($r: ref);
const IoAllocateErrorLogEntry: ref;
axiom (IoAllocateErrorLogEntry == $sub.ref(0, 44383));
procedure {:inline 1} IoAllocateErrorLogEntry($p0: ref, $i1: i8)
  returns ($r: ref);
const IoWriteErrorLogEntry: ref;
axiom (IoWriteErrorLogEntry == $sub.ref(0, 45415));
procedure {:inline 1} IoWriteErrorLogEntry($p0: ref);
const malloc: ref;
axiom (malloc == $sub.ref(0, 46447));
...
axiom (PoCallDriver == $sub.ref(0, 47479));
  ...
  returns ($r: i64)
{
  ...
  var $i38: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4131, 28} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4131, 28} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  call {:cexpr "__BLAST_NONDET___0"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4134, 20} true;
  assume {:verifier.code 1} true;
  call $p3 := __VERIFIER_nondet_pointer();
  call {:cexpr "smack:ext:__VERIFIER_nondet_pointer"} boogie_si_record_ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4139, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.11;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4139, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4140, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $M.49;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4140, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4140, 11} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i7 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4142, 17} true;
  assume {:verifier.code 0} true;
  call $i8 := DiskPerfIrpCompletion($p0, $p1, $p3);
  call {:cexpr "tmp"} boogie_si_record_i64($i8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4143, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i64.i32($i8);
  call {:cexpr "compRetStatus"} boogie_si_record_i32($i9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4145, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $i9;
  goto $bb5;
$bb4:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4146, 13} true;
  assume {:verifier.code 0} true;
  $i11 := $M.49;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4146, 21} true;
  assume {:verifier.code 0} true;
  $i12 := $eq.i32($i11, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4146, 13} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4154, 11} true;
  assume {:verifier.code 0} true;
  $i16 := $sext.i32.i64($i10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4154, 31} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i64($i16, $sub.i64(0, 1073741802));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4154, 11} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i12 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4148, 23} true;
  assume {:verifier.code 0} true;
  call $i13 := DiskPerfIoCompletion($p0, $p1, $p3);
  call {:cexpr "tmp___0"} boogie_si_record_i64($i13);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4149, 29} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i64.i32($i13);
  call {:cexpr "compRetStatus"} boogie_si_record_i32($i14);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4151, 9} true;
  assume {:verifier.code 0} true;
  $i15 := $i14;
  goto $bb8;
$bb7:
...
$bb9:
  assume ($i17 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4156, 11} true;
  assume {:verifier.code 0} true;
  call stubMoreProcessingRequired();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4158, 7} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume !(($i17 == 1));
  ...
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4160, 5} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb12:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4162, 28} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i2, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4162, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  goto $bb13, $bb14;
$bb13:
  assume ($i18 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4163, 7} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume !(($i18 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4165, 30} true;
  assume {:verifier.code 0} true;
  $i19 := $eq.i32($i2, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4165, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb16, $bb17;
$bb15:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4173, 13} true;
  assume {:verifier.code 0} true;
  $i20 := 0;
  goto $bb23;
$bb16:
  assume ($i19 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4166, 9} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb17:
  assume !(($i19 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4169, 11} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4176, 13} true;
  assume {:verifier.code 0} true;
  $i20 := $sub.i64(0, 1073741823);
  goto $bb23;
$bb19:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4179, 13} true;
  assume {:verifier.code 0} true;
  $i20 := 259;
  goto $bb23;
$bb20:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4170, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 0} true;
  goto $bb21, $bb22;
$bb21:
  assume (0 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4170, 18} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb22:
  assume !((0 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4180, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $u0;
  goto $bb23;
$bb23:
...
$bb25:
  ...
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4186, 9} true;
  assume {:verifier.code 0} true;
  $i21 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4186, 14} true;
  assume {:verifier.code 0} true;
  $i22 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4186, 11} true;
  assume {:verifier.code 0} true;
  $i23 := $eq.i32($i21, $i22);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4186, 9} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i23 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4187, 11} true;
  assume {:verifier.code 0} true;
  $i24 := $M.7;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4187, 9} true;
  assume {:verifier.code 0} true;
  $M.8 := $i24;
  call {:cexpr "s"} boogie_si_record_i32($i24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4188, 27} true;
  assume {:verifier.code 0} true;
  $i25 := $trunc.i64.i32($i20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4188, 25} true;
  assume {:verifier.code 0} true;
  $M.12 := $i25;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i25);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4189, 5} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb28:
  assume !(($i23 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4190, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4190, 16} true;
  assume {:verifier.code 0} true;
  $i27 := $M.5;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4190, 13} true;
  assume {:verifier.code 0} true;
  $i28 := $eq.i32($i26, $i27);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4190, 11} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb30, $bb31;
$bb29:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4207, 5} true;
  assume {:verifier.code 0} true;
  $r := $i20;
  $exn := false;
  return;
$bb30:
  assume ($i28 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4191, 23} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.i64($i20, 259);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4191, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb32, $bb33;
$bb31:
  assume !(($i28 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4199, 13} true;
  assume {:verifier.code 0} true;
  $i34 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4199, 18} true;
  assume {:verifier.code 0} true;
  $i35 := $M.3;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4199, 15} true;
  assume {:verifier.code 0} true;
  $i36 := $eq.i32($i34, $i35);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4199, 13} true;
  assume {:verifier.code 0} true;
...
$bb32:
  assume ($i29 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4192, 15} true;
  assume {:verifier.code 0} true;
  $i30 := $M.6;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4192, 13} true;
  assume {:verifier.code 0} true;
  $M.8 := $i30;
  call {:cexpr "s"} boogie_si_record_i32($i30);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4193, 31} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i64.i32($i20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4193, 29} true;
  assume {:verifier.code 0} true;
  $M.12 := $i31;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i31);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4194, 9} true;
  assume {:verifier.code 0} true;
  goto $bb34;
$bb33:
  assume !(($i29 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4195, 15} true;
  assume {:verifier.code 0} true;
  $i32 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4195, 13} true;
  assume {:verifier.code 0} true;
  $M.8 := $i32;
  call {:cexpr "s"} boogie_si_record_i32($i32);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4196, 31} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i64.i32($i20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4196, 29} true;
  assume {:verifier.code 0} true;
  $M.12 := $i33;
  ...
  goto $bb34;
$bb34:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4198, 7} true;
  assume {:verifier.code 0} true;
  goto $bb35;
$bb35:
  assume {:verifier.code 0} true;
...
$bb36:
  assume ($i36 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4200, 15} true;
  assume {:verifier.code 0} true;
  $i37 := $M.4;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4200, 13} true;
  assume {:verifier.code 0} true;
  $M.8 := $i37;
  call {:cexpr "s"} boogie_si_record_i32($i37);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4201, 31} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i64.i32($i20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4201, 29} true;
  assume {:verifier.code 0} true;
  $M.12 := $i38;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i38);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4202, 9} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb37:
  assume !(($i36 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4203, 13} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:verifier.code 0} true;
  goto $bb38;
...
const DiskPerfIrpCompletion: ref;
axiom (DiskPerfIrpCompletion == $sub.ref(0, 48511));
procedure {:inline 1} DiskPerfIrpCompletion($p0: ref, $p1: ref, $p2: ref)
  returns ($r: i64)
{
  var $p3: ref;
  var $i4: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2290, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2290, 15} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2291, 7} true;
  assume {:verifier.code 0} true;
  call $i4 := KeSetEvent($p3, 0, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2293, 5} true;
  assume {:verifier.code 0} true;
  $r := $sub.i64(0, 1073741802);
  $exn := false;
  return;
}
const DiskPerfIoCompletion: ref;
axiom (DiskPerfIoCompletion == $sub.ref(0, 49543));
procedure {:inline 1} DiskPerfIoCompletion($p0: ref, $p1: ref, $p2: ref)
  returns ($r: i64)
{
  var $p3: ref;
  var $p4: ref;
  ...
  var $p115: ref;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2561, 39} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(16, $zext.i32.i64(1)));
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.50, $p5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2561, 25} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2562, 23} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2562, 28} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2562, 36} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p9, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p11 := $add.ref($add.ref($add.ref($p9, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2563, 23} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2563, 23} true;
  assume {:verifier.code 0} true;
  $p13 := $load.ref($M.16, $p12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2566, 65} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(56, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2566, 65} true;
  assume {:verifier.code 0} true;
  $p15 := $load.ref($M.51, $p14);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2566, 40} true;
  assume {:verifier.code 0} true;
  $p16 := $bitcast.ref.ref($p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2567, 44} true;
  assume {:verifier.code 0} true;
  $i17 := $mul.i64(0, $p2i.ref.i64($add.ref($add.ref($0.ref, $mul.ref(0, 152)), $mul.ref(112, 1))));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2566, 78} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p16, $mul.ref($i17, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2566, 11} true;
  assume {:verifier.code 0} true;
  $p19 := $bitcast.ref.ref($p18);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2571, 9} true;
  assume {:verifier.code 0} true;
  $i20 := $p2i.ref.i32($p19);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2571, 41} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.i32($i20, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2571, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i21 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2572, 7} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i21 == 1));
  ...
  goto $bb4;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2622, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2576, 49} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p13, $mul.ref(0, 68)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2576, 60} true;
  assume {:verifier.code 0} true;
  $p23 := $bitcast.ref.ref($p22);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2576, 20} true;
  assume {:verifier.code 0} true;
  $p24 := $bitcast.ref.ref($p23);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  call $p25 := KeQueryPerformanceCounter($0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  $i29 := $extractvalue.i64($p25, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  $M.52 := $store.i64($M.52, $p28, $i29);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p27, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  $i31 := $extractvalue.i64($p25, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  $M.52 := $store.i64($M.52, $p30, $i31);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2577, 27} true;
  assume {:verifier.code 0} true;
  call $M.53 := $memcpy.i8($M.53, $M.52, $p32, $p33, 16, false);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2578, 48} true;
  assume {:verifier.code 0} true;
  $p34 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2578, 48} true;
  assume {:verifier.code 0} true;
  $i35 := $load.i64($M.53, $p34);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2578, 71} true;
  assume {:verifier.code 0} true;
  $p36 := $bitcast.ref.ref($p24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2578, 71} true;
  assume {:verifier.code 0} true;
  $i37 := $load.i64($M.21, $p36);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2578, 57} true;
  assume {:verifier.code 0} true;
  $i38 := $sub.i64($i35, $i37);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2578, 19} true;
  assume {:verifier.code 0} true;
  $p39 := $bitcast.ref.ref($p24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2578, 28} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.i64($M.21, $p39, $i38);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2579, 57} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(80, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2579, 18} true;
  assume {:verifier.code 0} true;
  call $i41 := InterlockedDecrement($p40);
  call {:cexpr "queueLen"} boogie_si_record_i64($i41);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2581, 18} true;
  assume {:verifier.code 0} true;
  $i42 := $slt.i64($i41, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2581, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i42 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2583, 59} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(80, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2583, 20} true;
  assume {:verifier.code 0} true;
  call $i44 := InterlockedIncrement($p43);
  call {:cexpr "queueLen"} boogie_si_record_i64($i44);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2585, 5} true;
  assume {:verifier.code 0} true;
  $i45 := $i44;
  goto $bb7;
$bb6:
...
$bb7:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2587, 18} true;
  assume {:verifier.code 0} true;
  $i46 := $eq.i64($i45, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2587, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i46 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2588, 24} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2588, 40} true;
  assume {:verifier.code 0} true;
  $p48 := $bitcast.ref.ref($p47);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2588, 40} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2588, 40} true;
  assume {:verifier.code 0} true;
  call $M.54 := $memcpy.i8($M.54, $M.53, $p48, $p49, 16, false);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2589, 5} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i46 == 1));
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2591, 24} true;
  assume {:verifier.code 0} true;
  $p50 := $add.ref($add.ref($p13, $mul.ref(0, 68)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2591, 24} true;
  assume {:verifier.code 0} true;
  $i51 := $load.i8($M.21, $p50);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2591, 9} true;
  assume {:verifier.code 0} true;
  $i52 := $zext.i8.i32($i51);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2591, 38} true;
  assume {:verifier.code 0} true;
  $i53 := $eq.i32($i52, 3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2591, 9} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i53 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2593, 26} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p55 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2593, 35} true;
  assume {:verifier.code 0} true;
  $i56 := $load.i64($M.22, $p55);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2592, 26} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($add.ref($p19, $mul.ref(0, 152)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2592, 36} true;
  assume {:verifier.code 0} true;
  $p58 := $bitcast.ref.ref($p57);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2592, 45} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i64($M.55, $p58);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2592, 45} true;
  assume {:verifier.code 0} true;
  $i60 := $add.i64($i59, $i56);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2592, 45} true;
  assume {:verifier.code 0} true;
  $M.55 := $store.i64($M.55, $p58, $i60);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2594, 26} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($add.ref($p19, $mul.ref(0, 152)), $mul.ref(80, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2594, 36} true;
  assume {:verifier.code 0} true;
  $i62 := $load.i64($M.55, $p61);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2594, 36} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i64($i62, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2594, 36} true;
  assume {:verifier.code 0} true;
  $M.55 := $store.i64($M.55, $p61, $i63);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2595, 59} true;
  assume {:verifier.code 0} true;
  $p64 := $bitcast.ref.ref($p24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2595, 59} true;
  assume {:verifier.code 0} true;
  $i65 := $load.i64($M.21, $p64);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2595, 26} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($add.ref($p19, $mul.ref(0, 152)), $mul.ref(32, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2595, 35} true;
  assume {:verifier.code 0} true;
  $p67 := $bitcast.ref.ref($p66);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2595, 44} true;
  assume {:verifier.code 0} true;
  $i68 := $load.i64($M.55, $p67);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2595, 44} true;
  assume {:verifier.code 0} true;
  $i69 := $add.i64($i68, $i65);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2595, 44} true;
  assume {:verifier.code 0} true;
  $M.55 := $store.i64($M.55, $p67, $i69);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2596, 5} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !(($i53 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2598, 26} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p71 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2598, 35} true;
  assume {:verifier.code 0} true;
  $i72 := $load.i64($M.22, $p71);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2597, 26} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($add.ref($p19, $mul.ref(0, 152)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2597, 39} true;
  assume {:verifier.code 0} true;
  $p74 := $bitcast.ref.ref($p73);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2597, 48} true;
  assume {:verifier.code 0} true;
  $i75 := $load.i64($M.55, $p74);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2597, 48} true;
  assume {:verifier.code 0} true;
  $i76 := $add.i64($i75, $i72);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2597, 48} true;
  assume {:verifier.code 0} true;
  $M.55 := $store.i64($M.55, $p74, $i76);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2599, 26} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p19, $mul.ref(0, 152)), $mul.ref(88, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2599, 37} true;
  assume {:verifier.code 0} true;
  $i78 := $load.i64($M.55, $p77);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2599, 37} true;
  assume {:verifier.code 0} true;
  $i79 := $add.i64($i78, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2599, 37} true;
  assume {:verifier.code 0} true;
  $M.55 := $store.i64($M.55, $p77, $i79);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2600, 60} true;
  assume {:verifier.code 0} true;
  $p80 := $bitcast.ref.ref($p24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2600, 60} true;
  assume {:verifier.code 0} true;
  $i81 := $load.i64($M.21, $p80);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2600, 26} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p19, $mul.ref(0, 152)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2600, 36} true;
  assume {:verifier.code 0} true;
  $p83 := $bitcast.ref.ref($p82);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2600, 45} true;
  assume {:verifier.code 0} true;
  $i84 := $load.i64($M.55, $p83);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2600, 45} true;
  assume {:verifier.code 0} true;
  $i85 := $add.i64($i84, $i81);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2600, 45} true;
  assume {:verifier.code 0} true;
  $M.55 := $store.i64($M.55, $p83, $i85);
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2602, 14} true;
  assume {:verifier.code 0} true;
  $p86 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2602, 14} true;
  assume {:verifier.code 0} true;
  $i87 := $load.i64($M.56, $p86);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2602, 20} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/ntdrivers/diskperf_false.i.cil.c:2602:20: warning: over-approximating bitwise operation and; */
  $i88 := $and.i64($i87, 8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2602, 20} true;
  assume {:verifier.code 0} true;
  $i89 := $ne.i64($i88, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2602, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i89} true;
  goto $bb14, $bb15;
$bb14:
  assume ($i89 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2603, 26} true;
  assume {:verifier.code 0} true;
  $p90 := $add.ref($add.ref($p19, $mul.ref(0, 152)), $mul.ref(104, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2603, 37} true;
  assume {:verifier.code 0} true;
  $i91 := $load.i64($M.55, $p90);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2603, 37} true;
  assume {:verifier.code 0} true;
  $i92 := $add.i64($i91, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2603, 37} true;
  assume {:verifier.code 0} true;
  $M.55 := $store.i64($M.55, $p90, $i92);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2604, 5} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb15:
  assume !(($i89 == 1));
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2606, 14} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(65, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2606, 14} true;
  assume {:verifier.code 0} true;
  $i94 := $load.i8($M.57, $p93);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2606, 9} true;
  assume {:verifier.code 0} true;
  $i95 := $ne.i8($i94, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2606, 9} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i95 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2607, 11} true;
  assume {:verifier.code 0} true;
  $i96 := $M.9;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2607, 18} true;
  assume {:verifier.code 0} true;
  $i97 := $eq.i32($i96, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2607, 11} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i97 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2608, 16} true;
  assume {:verifier.code 0} true;
  $M.9 := 1;
  call {:cexpr "pended"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2609, 7} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb20:
  assume !(($i97 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2610, 11} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2614, 34} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2614, 39} true;
  assume {:verifier.code 0} true;
  $p99 := $bitcast.ref.ref($p98);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2614, 47} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($add.ref($p99, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p101 := $add.ref($add.ref($add.ref($p99, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2615, 53} true;
  assume {:verifier.code 0} true;
  $p102 := $bitcast.ref.ref($p101);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2615, 53} true;
  assume {:verifier.code 0} true;
  $p103 := $load.ref($M.16, $p102);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2616, 29} true;
  assume {:verifier.code 0} true;
  $p104 := $add.ref($add.ref($p103, $mul.ref(0, 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2616, 29} true;
  assume {:verifier.code 0} true;
  $i105 := $load.i8($M.21, $p104);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2614, 23} true;
  assume {:verifier.code 0} true;
  $i106 := $zext.i8.i32($i105);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2616, 37} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/ntdrivers/diskperf_false.i.cil.c:2616:37: warning: over-approximating bitwise operation or; */
  $i107 := $or.i32($i106, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2614, 23} true;
  assume {:verifier.code 0} true;
  $i108 := $trunc.i32.i8($i107);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2612, 13} true;
  assume {:verifier.code 0} true;
  $p109 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2612, 18} true;
  assume {:verifier.code 0} true;
  $p110 := $bitcast.ref.ref($p109);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2612, 26} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($add.ref($p110, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p112 := $add.ref($add.ref($add.ref($p110, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2613, 13} true;
  assume {:verifier.code 0} true;
  $p113 := $bitcast.ref.ref($p112);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2613, 13} true;
  assume {:verifier.code 0} true;
  $p114 := $load.ref($M.16, $p113);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2614, 13} true;
  assume {:verifier.code 0} true;
  $p115 := $add.ref($add.ref($p114, $mul.ref(0, 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2614, 21} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.i8($M.21, $p115, $i108);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2618, 5} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2620, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const stubMoreProcessingRequired: ref;
axiom (stubMoreProcessingRequired == $sub.ref(0, 50575));
procedure {:inline 1} stubMoreProcessingRequired()
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3820, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3820, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3820, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3820, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i0, $i1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3820, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3821, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $M.5;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3821, 9} true;
  assume {:verifier.code 0} true;
  $M.8 := $i3;
  call {:cexpr "s"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3822, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3823, 9} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3825, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const KeSetEvent: ref;
axiom (KeSetEvent == $sub.ref(0, 51607));
procedure {:inline 1} KeSetEvent($p0: ref, $i1: i64, $i2: i8)
  returns ($r: i64)
{
  var $i3: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3977, 12} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3980, 20} true;
  assume {:verifier.code 0} true;
  $M.13 := 1;
  call {:cexpr "setEventCalled"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3981, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
}
const DiskPerfStartDevice: ref;
axiom (DiskPerfStartDevice == $sub.ref(0, 52639));
procedure {:inline 1} DiskPerfStartDevice($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i12: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2303, 53} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2303, 53} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 368)), $mul.ref(80, 1));
  ...
  assume {:verifier.code 0} true;
  $p3 := $load.ref($M.17, $p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2303, 11} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2304, 16} true;
  assume {:verifier.code 0} true;
  call $i5 := DiskPerfForwardIrpSynchronous($p0, $p1);
  call {:cexpr "status"} boogie_si_record_i64($i5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2306, 53} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p4, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2306, 53} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.18, $p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2305, 7} true;
  assume {:verifier.code 0} true;
  call DiskPerfSyncFilterWithTarget($p0, $p7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2307, 7} true;
  assume {:verifier.code 0} true;
  call $i8 := DiskPerfRegisterDevice($p0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2308, 12} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p10 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2308, 39} true;
  assume {:verifier.code 0} true;
  $p11 := $bitcast.ref.ref($p10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2308, 46} true;
  assume {:verifier.code 0} true;
  $M.19 := $store.i64($M.19, $p11, $i5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2309, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i64.i32($i5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2309, 16} true;
  assume {:verifier.code 0} true;
  $M.20 := $i12;
  call {:cexpr "myStatus"} boogie_si_record_i32($i12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2310, 7} true;
  assume {:verifier.code 0} true;
  call IofCompleteRequest($p1, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2312, 5} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
}
const DiskPerfRemoveDevice: ref;
axiom (DiskPerfRemoveDevice == $sub.ref(0, 53671));
procedure {:inline 1} DiskPerfRemoveDevice($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i15: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2323, 53} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2323, 53} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 368)), $mul.ref(80, 1));
  ...
  assume {:verifier.code 0} true;
  $p3 := $load.ref($M.17, $p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2323, 11} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2324, 7} true;
  assume {:verifier.code 0} true;
  call $i5 := IoWMIRegistrationControl($p0, 2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2325, 41} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p4, $mul.ref(0, 344)), $mul.ref(280, 1));
  $p7 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 344)), $mul.ref(280, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2326, 7} true;
  assume {:verifier.code 0} true;
  call $i8 := InterlockedExchange($p7, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2327, 14} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2327, 7} true;
  assume {:verifier.code 0} true;
  call $p10 := memset($p9, 0, 64);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2328, 16} true;
  assume {:verifier.code 0} true;
  call $i11 := DiskPerfForwardIrpSynchronous($p0, $p1);
  call {:cexpr "status"} boogie_si_record_i64($i11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2331, 12} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p13 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2331, 39} true;
  assume {:verifier.code 0} true;
  $p14 := $bitcast.ref.ref($p13);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2331, 46} true;
  assume {:verifier.code 0} true;
  $M.19 := $store.i64($M.19, $p14, $i11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2332, 18} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i64.i32($i11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2332, 16} true;
  assume {:verifier.code 0} true;
  $M.20 := $i15;
  call {:cexpr "myStatus"} boogie_si_record_i32($i15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2333, 7} true;
  assume {:verifier.code 0} true;
  call IofCompleteRequest($p1, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2335, 5} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $exn := false;
  return;
...
axiom (IoWMIRegistrationControl == $sub.ref(0, 54703));
procedure {:inline 1} IoWMIRegistrationControl($p0: ref, $i1: i64)
  returns ($r: i64);
const InterlockedExchange: ref;
axiom (InterlockedExchange == $sub.ref(0, 55735));
procedure {:inline 1} InterlockedExchange($p0: ref, $i1: i64)
  returns ($r: i64);
const DiskPerfForwardIrpSynchronous: ref;
axiom (DiskPerfForwardIrpSynchronous == $sub.ref(0, 56767));
procedure {:inline 1} DiskPerfForwardIrpSynchronous($p0: ref, $p1: ref)
  returns ($r: i64)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i61: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2394, 53} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.17, $p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2394, 11} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2395, 20} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2395, 25} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2395, 33} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p7, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p9 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2396, 20} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2396, 20} true;
  assume {:verifier.code 0} true;
  $p11 := $load.ref($M.16, $p10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2397, 24} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2397, 29} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2397, 37} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p13, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p15 := $add.ref($add.ref($add.ref($p13, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2398, 24} true;
  assume {:verifier.code 0} true;
  $p16 := $bitcast.ref.ref($p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2398, 24} true;
  assume {:verifier.code 0} true;
  $p17 := $load.ref($M.16, $p16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2398, 45} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p17, $mul.ref($sub.ref(0, 1), 68));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2400, 14} true;
  assume {:verifier.code 0} true;
  $p19 := $bitcast.ref.ref($p18);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2400, 25} true;
  assume {:verifier.code 0} true;
  $p20 := $bitcast.ref.ref($p11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2400, 7} true;
  assume {:verifier.code 0} true;
  call $p21 := memcpy($p19, $p20, $p2i.ref.i32($add.ref($add.ref($0.ref, $mul.ref(0, 68)), $mul.ref(52, 1))));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2402, 18} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p17, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2402, 26} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.i8($M.21, $p22, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2404, 9} true;
  assume {:verifier.code 0} true;
  $i23 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2404, 14} true;
  assume {:verifier.code 0} true;
  $i24 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2404, 11} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.i32($i23, $i24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2404, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i25 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2406, 9} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2408, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i25 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2409, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $M.11;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2409, 26} true;
  assume {:verifier.code 0} true;
  $i27 := $ne.i32($i26, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2409, 11} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2420, 24} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p1, $mul.ref(0, 216)), $mul.ref(120, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2420, 29} true;
  assume {:verifier.code 0} true;
  $p29 := $bitcast.ref.ref($p28);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2420, 37} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p29, $mul.ref(0, 80)), $mul.ref(48, 1));
  $p31 := $add.ref($add.ref($add.ref($p29, $mul.ref(0, 80)), $mul.ref(48, 1)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2421, 24} true;
  assume {:verifier.code 0} true;
  $p32 := $bitcast.ref.ref($p31);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2421, 24} true;
  assume {:verifier.code 0} true;
  $p33 := $load.ref($M.16, $p32);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2421, 45} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($p33, $mul.ref($sub.ref(0, 1), 68));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2423, 18} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p33, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(52, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2423, 18} true;
  assume {:verifier.code 0} true;
  $p36 := $bitcast.ref.ref($p35);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2423, 36} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.ref($M.21, $p36, DiskPerfIrpCompletion);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2424, 28} true;
  assume {:verifier.code 0} true;
  $p37 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2424, 18} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($add.ref($p33, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(60, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2424, 26} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.ref($M.21, $p38, $p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2425, 18} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($add.ref($p33, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2425, 26} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.i8($M.21, $p39, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2426, 18} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($add.ref($p33, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2426, 26} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.i8($M.21, $p40, 64);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2427, 44} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($add.ref($p33, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2427, 44} true;
  assume {:verifier.code 0} true;
  $i42 := $load.i8($M.21, $p41);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2427, 28} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i8.i32($i42);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2427, 52} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/ntdrivers/diskperf_false.i.cil.c:2427:52: warning: over-approximating bitwise operation or; */
  $i44 := $or.i32($i43, 128);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2427, 28} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i32.i8($i44);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2427, 18} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($add.ref($p33, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2427, 26} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.i8($M.21, $p46, $i45);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2428, 44} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p33, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2428, 44} true;
  assume {:verifier.code 0} true;
  $i48 := $load.i8($M.21, $p47);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2428, 28} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i8.i32($i48);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2428, 52} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/ntdrivers/diskperf_false.i.cil.c:2428:52: warning: over-approximating bitwise operation or; */
  $i50 := $or.i32($i49, 32);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2428, 28} true;
  assume {:verifier.code 0} true;
  $i51 := $trunc.i32.i8($i50);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2428, 18} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref($p33, $mul.ref($sub.ref(0, 1), 68)), $mul.ref(3, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2428, 26} true;
  assume {:verifier.code 0} true;
  $M.21 := $store.i8($M.21, $p52, $i51);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2429, 47} true;
  assume {:verifier.code 0} true;
  $p53 := $add.ref($add.ref($p5, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2429, 47} true;
  assume {:verifier.code 0} true;
  $p54 := $load.ref($M.18, $p53);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2429, 16} true;
  assume {:verifier.code 0} true;
  call $i55 := IofCallDriver($p54, $p1);
  call {:cexpr "status"} boogie_si_record_i64($i55);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2431, 16} true;
  assume {:verifier.code 0} true;
  $i56 := $eq.i64($i55, 259);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2431, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i56} true;
  goto $bb7, $bb8;
$bb4:
  assume ($i27 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2411, 11} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2413, 7} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume !(($i27 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2414, 24} true;
  assume {:verifier.code 0} true;
  $M.11 := 1;
  call {:cexpr "compRegistered"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2415, 18} true;
  assume {:verifier.code 0} true;
  $M.10 := DiskPerfIrpCompletion;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2416, 17} true;
  assume {:verifier.code 0} true;
  $M.49 := 0;
...
$bb7:
  assume ($i56 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2433, 31} true;
  assume {:verifier.code 0} true;
  $p57 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2433, 9} true;
  assume {:verifier.code 0} true;
  call $i58 := KeWaitForSingleObject($p57, 0, 0, 0, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2434, 18} true;
  assume {:verifier.code 0} true;
  $i59 := $M.20;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2434, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $sext.i32.i64($i59);
  call {:cexpr "status"} boogie_si_record_i64($i60);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2436, 5} true;
  assume {:verifier.code 0} true;
  $i61 := $i60;
  goto $bb9;
$bb8:
...
$bb9:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2438, 5} true;
  assume {:verifier.code 0} true;
  $r := $i61;
  $exn := false;
  return;
...
axiom (IofCompleteRequest == $sub.ref(0, 57799));
procedure {:inline 1} IofCompleteRequest($p0: ref, $i1: i8)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3910, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "IofCompleteRequest:arg:PriorityBoost"} boogie_si_record_i8($i1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3910, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3910, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3910, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i2, $i3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3910, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3911, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $M.2;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3911, 9} true;
  assume {:verifier.code 0} true;
  $M.8 := $i5;
  call {:cexpr "s"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3912, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3913, 9} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3915, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const IofCallDriver: ref;
axiom (IofCallDriver == $sub.ref(0, 58831));
  ...
  returns ($r: i64)
{
  ...
  var $i35: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3830, 28} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3830, 28} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  call {:cexpr "__BLAST_NONDET___0"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3833, 20} true;
  assume {:verifier.code 1} true;
  call $p3 := __VERIFIER_nondet_pointer();
  call {:cexpr "smack:ext:__VERIFIER_nondet_pointer"} boogie_si_record_ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3838, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.11;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3838, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3839, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $M.49;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3839, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3839, 11} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i7 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3841, 17} true;
  assume {:verifier.code 0} true;
  call $i8 := DiskPerfIrpCompletion($p0, $p1, $p3);
  call {:cexpr "tmp"} boogie_si_record_i64($i8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3842, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i64.i32($i8);
  call {:cexpr "compRetStatus"} boogie_si_record_i32($i9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3844, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $i9;
  goto $bb5;
$bb4:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3846, 21} true;
  assume {:verifier.code 0} true;
  call $i11 := DiskPerfIoCompletion($p0, $p1, $p3);
  call {:cexpr "tmp___0"} boogie_si_record_i64($i11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3847, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i64.i32($i11);
  call {:cexpr "compRetStatus"} boogie_si_record_i32($i12);
  assume {:verifier.code 0} true;
  $i10 := $i12;
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3850, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.i32.i64($i10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3850, 31} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i64($i13, $sub.i64(0, 1073741802));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3850, 11} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i14 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3852, 11} true;
  assume {:verifier.code 0} true;
  call stubMoreProcessingRequired();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3854, 7} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !(($i14 == 1));
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3856, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3858, 28} true;
  assume {:verifier.code 0} true;
  $i15 := $eq.i32($i2, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3858, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i15 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3859, 7} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !(($i15 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3861, 30} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i32($i2, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3861, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb13, $bb14;
$bb12:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3869, 13} true;
  assume {:verifier.code 0} true;
  $i17 := 0;
  goto $bb20;
$bb13:
  assume ($i16 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3862, 9} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume !(($i16 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3865, 11} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb15:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3872, 13} true;
  assume {:verifier.code 0} true;
  $i17 := $sub.i64(0, 1073741823);
  goto $bb20;
$bb16:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3875, 13} true;
  assume {:verifier.code 0} true;
  $i17 := 259;
  goto $bb20;
$bb17:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3866, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 0} true;
  goto $bb18, $bb19;
$bb18:
  assume (0 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3866, 18} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb19:
  assume !((0 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3876, 18} true;
  assume {:verifier.code 0} true;
  $i17 := $u0;
  goto $bb20;
$bb20:
...
$bb22:
  ...
  goto $bb23;
$bb23:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3882, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3882, 14} true;
  assume {:verifier.code 0} true;
  $i19 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3882, 11} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i18, $i19);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3882, 9} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i20 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3883, 11} true;
  assume {:verifier.code 0} true;
  $i21 := $M.7;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3883, 9} true;
  assume {:verifier.code 0} true;
  $M.8 := $i21;
  call {:cexpr "s"} boogie_si_record_i32($i21);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3884, 27} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i64.i32($i17);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3884, 25} true;
  assume {:verifier.code 0} true;
  $M.12 := $i22;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i22);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3885, 5} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb25:
  assume !(($i20 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3886, 11} true;
  assume {:verifier.code 0} true;
  $i23 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3886, 16} true;
  assume {:verifier.code 0} true;
  $i24 := $M.5;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3886, 13} true;
  assume {:verifier.code 0} true;
  $i25 := $eq.i32($i23, $i24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3886, 11} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb27, $bb28;
$bb26:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3903, 5} true;
  assume {:verifier.code 0} true;
  $r := $i17;
  $exn := false;
  return;
$bb27:
  assume ($i25 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3887, 24} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.i64($i17, 259);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3887, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb29, $bb30;
$bb28:
  assume !(($i25 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3895, 13} true;
  assume {:verifier.code 0} true;
  $i31 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3895, 18} true;
  assume {:verifier.code 0} true;
  $i32 := $M.3;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3895, 15} true;
  assume {:verifier.code 0} true;
  $i33 := $eq.i32($i31, $i32);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3895, 13} true;
  assume {:verifier.code 0} true;
...
$bb29:
  assume ($i26 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3888, 15} true;
  assume {:verifier.code 0} true;
  $i27 := $M.6;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3888, 13} true;
  assume {:verifier.code 0} true;
  $M.8 := $i27;
  call {:cexpr "s"} boogie_si_record_i32($i27);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3889, 31} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i64.i32($i17);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3889, 29} true;
  assume {:verifier.code 0} true;
  $M.12 := $i28;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i28);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3890, 9} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb30:
  assume !(($i26 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3891, 15} true;
  assume {:verifier.code 0} true;
  $i29 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3891, 13} true;
  assume {:verifier.code 0} true;
  $M.8 := $i29;
  call {:cexpr "s"} boogie_si_record_i32($i29);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3892, 31} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i64.i32($i17);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3892, 29} true;
  assume {:verifier.code 0} true;
  $M.12 := $i30;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i30);
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3894, 7} true;
  assume {:verifier.code 0} true;
  goto $bb32;
$bb32:
  assume {:verifier.code 0} true;
...
$bb33:
  assume ($i33 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3896, 15} true;
  assume {:verifier.code 0} true;
  $i34 := $M.4;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3896, 13} true;
  assume {:verifier.code 0} true;
  $M.8 := $i34;
  call {:cexpr "s"} boogie_si_record_i32($i34);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3897, 31} true;
  assume {:verifier.code 0} true;
  $i35 := $trunc.i64.i32($i17);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3897, 29} true;
  assume {:verifier.code 0} true;
  $M.12 := $i35;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i35);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3898, 9} true;
  assume {:verifier.code 0} true;
  goto $bb35;
$bb34:
  assume !(($i33 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3899, 13} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:verifier.code 0} true;
  goto $bb35;
...
axiom (KeWaitForSingleObject == $sub.ref(0, 59863));
  ...
  returns ($r: i64)
{
  ...
  var $i19: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3990, 28} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "__BLAST_NONDET___0"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3993, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3993, 14} true;
  assume {:verifier.code 0} true;
  $i7 := $M.6;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3993, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i32($i6, $i7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3993, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i8 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3994, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $M.13;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3994, 26} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3994, 11} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i8 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4000, 12} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb3:
  assume ($i10 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3995, 13} true;
  assume {:verifier.code 0} true;
  $i11 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3995, 11} true;
  assume {:verifier.code 0} true;
  $M.8 := $i11;
  call {:cexpr "s"} boogie_si_record_i32($i11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3996, 24} true;
  assume {:verifier.code 0} true;
  $M.13 := 0;
  call {:cexpr "setEventCalled"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3997, 7} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume !(($i10 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3998, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4000, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4002, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $M.14;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4002, 21} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4002, 11} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb8, $bb9;
$bb7:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4014, 28} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i32($i5, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4014, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  goto $bb14, $bb15;
$bb8:
  assume ($i13 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4003, 13} true;
  assume {:verifier.code 0} true;
  $i14 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4003, 11} true;
  assume {:verifier.code 0} true;
  $M.8 := $i14;
  call {:cexpr "s"} boogie_si_record_i32($i14);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4004, 19} true;
  assume {:verifier.code 0} true;
  $M.14 := 0;
  call {:cexpr "customIrp"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4005, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i13 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4006, 13} true;
  assume {:verifier.code 0} true;
  $i15 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4006, 18} true;
  assume {:verifier.code 0} true;
  $i16 := $M.6;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4006, 15} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i15, $i16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4006, 13} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i17 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4008, 13} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4010, 9} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !(($i17 == 1));
...
$bb14:
  assume ($i18 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4015, 7} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb15:
  assume !(($i18 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4018, 9} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4021, 11} true;
  assume {:verifier.code 0} true;
  $i19 := 0;
  goto $bb21;
$bb17:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4023, 11} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i64(0, 1073741823);
  goto $bb21;
$bb18:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4019, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 0} true;
  goto $bb19, $bb20;
$bb19:
  assume (0 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4019, 16} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb20:
  assume !((0 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4024, 16} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb21:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 4030, 1} true;
  assume {:verifier.code 0} true;
  $r := $i19;
  $exn := false;
  return;
...
const DiskPerfSyncFilterWithTarget: ref;
axiom (DiskPerfSyncFilterWithTarget == $sub.ref(0, 60895));
procedure {:inline 1} DiskPerfSyncFilterWithTarget($p0: ref, $p1: ref)
{
  var $p2: ref;
  var $i3: i64;
  var $i4: i64;
  ...
  var $i10: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2165, 19} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2165, 19} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 368)), $mul.ref(56, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2165, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i64($M.58, $p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2165, 25} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/ntdrivers/diskperf_false.i.cil.c:2165:25: warning: over-approximating bitwise operation or; */
  $i4 := $or.i64($i3, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2165, 25} true;
  assume {:verifier.code 0} true;
  $M.58 := $store.i64($M.58, $p2, $i4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2166, 31} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1, $mul.ref(0, 368)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2166, 31} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i64($M.59, $p5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2166, 47} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/ntdrivers/diskperf_false.i.cil.c:2166:47: warning: over-approximating bitwise operation and; */
  $i7 := $and.i64($i6, 7);
  call {:cexpr "propFlags"} boogie_si_record_i64($i7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2167, 19} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 368)), $mul.ref(64, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2167, 35} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.60, $p8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2167, 35} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/ntdrivers/diskperf_false.i.cil.c:2167:35: warning: over-approximating bitwise operation or; */
  $i10 := $or.i64($i9, $i7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2167, 35} true;
  assume {:verifier.code 0} true;
  $M.60 := $store.i64($M.60, $p8, $i10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2168, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const DiskPerfRegisterDevice: ref;
axiom (DiskPerfRegisterDevice == $sub.ref(0, 61927));
procedure {:inline 1} DiskPerfRegisterDevice($p0: ref)
  returns ($r: i64)
{
  var $p1: ref;
  var $p2: ref;
  ...
  var $i13: i64;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2809, 39} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.17, $p5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2809, 25} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2812, 54} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2812, 54} true;
  assume {:verifier.code 0} true;
  $p9 := $load.ref($M.18, $p8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2813, 25} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2811, 13} true;
  assume {:verifier.code 0} true;
  call $p11 := IoBuildDeviceIoControlRequest(2953344, $p9, $0.ref, 0, $p10, 24, 0, $p2, $p1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2815, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.ref($p11, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2815, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
...
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2817, 9} true;
  assume {:verifier.code 0} true;
  call DiskPerfLogError($p0, 256, 0, $sub.i64(0, 1073479678));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2819, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i64(0, 1073741670);
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2993, 1} true;
  assume {:verifier.code 0} true;
  $r := $i13;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2822, 47} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2822, 47} true;
  assume {:verifier.code 0} true;
  $p15 := $load.ref($M.18, $p14);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2822, 16} true;
  assume {:verifier.code 0} true;
  call $i16 := IofCallDriver($p15, $p11);
  call {:cexpr "status"} boogie_si_record_i64($i16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2823, 16} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i64($i16, 259);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2823, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i17 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2825, 31} true;
  assume {:verifier.code 0} true;
  $p18 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2825, 9} true;
  assume {:verifier.code 0} true;
  call $i19 := KeWaitForSingleObject($p18, 0, 0, 0, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2826, 27} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2826, 45} true;
  assume {:verifier.code 0} true;
  $p21 := $bitcast.ref.ref($p20);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2826, 45} true;
  assume {:verifier.code 0} true;
  $i22 := $load.i64($M.61, $p21);
  call {:cexpr "status"} boogie_si_record_i64($i22);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2828, 5} true;
  assume {:verifier.code 0} true;
  $i23 := $i22;
  goto $bb7;
$bb6:
...
$bb7:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2830, 16} true;
  assume {:verifier.code 0} true;
  $i24 := $sge.i64($i23, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2830, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i24 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2832, 46} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p3, $mul.ref(0, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2832, 46} true;
  assume {:verifier.code 0} true;
  $i26 := $load.i64($M.62, $p25);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2832, 26} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(24, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2832, 37} true;
  assume {:verifier.code 0} true;
  $M.36 := $store.i64($M.36, $p27, $i26);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2833, 35} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(152, 1));
  $p29 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(152, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2838, 25} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p3, $mul.ref(0, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2838, 25} true;
  assume {:verifier.code 0} true;
  $i31 := $load.i64($M.62, $p30);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2838, 46} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p3, $mul.ref(0, 24)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2838, 46} true;
  assume {:verifier.code 0} true;
  $i33 := $load.i64($M.63, $p32);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2833, 9} true;
  assume {:verifier.code 0} true;
  call $i34 := swprintf.ref.ref.i64.i64($p29, .str, $i31, $i33);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2841, 34} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(32, 1));
  $p36 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(32, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2841, 16} true;
  assume {:verifier.code 0} true;
  $p37 := $bitcast.ref.ref($p36);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2841, 9} true;
  assume {:verifier.code 0} true;
  call $p38 := memcpy($p37, .str.1, 16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2844, 5} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i24 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2847, 15} true;
  assume {:verifier.code 0} true;
  call $p39 := ExAllocatePoolWithTag(1, 4, 1718767684);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2848, 18} true;
  assume {:verifier.code 0} true;
  $p40 := $bitcast.ref.ref($p39);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2850, 12} true;
  assume {:verifier.code 0} true;
  $i41 := $ne.ref($p40, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2850, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i41} true;
  goto $bb11, $bb12;
$bb10:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2984, 59} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/ntdrivers/diskperf_false.i.cil.c:2984:59: warning: over-approximating bitwise operation or; */
  $i159 := $or.i64(1, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2984, 16} true;
  assume {:verifier.code 0} true;
  call $i160 := IoWMIRegistrationControl($p0, $i159);
  call {:cexpr "status"} boogie_si_record_i64($i160);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2985, 18} true;
  assume {:verifier.code 0} true;
  $i161 := $sge.i64($i160, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2985, 9} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i41 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2852, 11} true;
  assume {:verifier.code 0} true;
  call DiskPerfLogError($p0, 257, 0, $sub.i64(0, 1073479678));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2854, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i64(0, 1073741670);
  goto $bb3;
$bb13:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2861, 30} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2861, 30} true;
  assume {:verifier.code 0} true;
  $p43 := $load.ref($M.18, $p42);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2861, 64} true;
  assume {:verifier.code 0} true;
  $p44 := $bitcast.ref.ref($p40);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2859, 15} true;
  assume {:verifier.code 0} true;
  call $p45 := IoBuildDeviceIoControlRequest(5046280, $p43, $0.ref, 0, $p44, 4, 0, $p2, $p1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2864, 12} true;
  assume {:verifier.code 0} true;
  $i46 := $ne.ref($p45, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2864, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i46} true;
  goto $bb14, $bb15;
$bb14:
...
$bb15:
  assume !(($i46 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2867, 11} true;
  assume {:verifier.code 0} true;
  call DiskPerfLogError($p0, 258, 0, $sub.i64(0, 1073479678));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2869, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i64(0, 1073741670);
  goto $bb3;
$bb16:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2872, 49} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2872, 49} true;
  assume {:verifier.code 0} true;
  $p48 := $load.ref($M.18, $p47);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2872, 18} true;
  assume {:verifier.code 0} true;
  call $i49 := IofCallDriver($p48, $p45);
  call {:cexpr "status"} boogie_si_record_i64($i49);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2873, 18} true;
  assume {:verifier.code 0} true;
  $i50 := $eq.i64($i49, 259);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2873, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i50} true;
  goto $bb17, $bb18;
$bb17:
  assume ($i50 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2875, 33} true;
  assume {:verifier.code 0} true;
  $p51 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2875, 11} true;
  assume {:verifier.code 0} true;
  call $i52 := KeWaitForSingleObject($p51, 0, 0, 0, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2876, 29} true;
  assume {:verifier.code 0} true;
  $p53 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2876, 47} true;
  assume {:verifier.code 0} true;
  $p54 := $bitcast.ref.ref($p53);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2876, 47} true;
  assume {:verifier.code 0} true;
  $i55 := $load.i64($M.61, $p54);
  call {:cexpr "status"} boogie_si_record_i64($i55);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2878, 7} true;
  assume {:verifier.code 0} true;
  $i56 := $i55;
  goto $bb19;
$bb18:
...
$bb19:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2880, 18} true;
  assume {:verifier.code 0} true;
  $i57 := $eq.i64($i56, $sub.i64(0, 2147483643));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2880, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i57} true;
  goto $bb20, $bb21;
$bb20:
  assume ($i57 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2882, 70} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($add.ref($p40, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2882, 70} true;
  assume {:verifier.code 0} true;
  $i59 := $load.i16($M.64, $p58);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2882, 48} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i16.i32($i59);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2882, 48} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i32.i64($i60);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2882, 46} true;
  assume {:verifier.code 0} true;
  $i62 := $add.i64(4, $i61);
  call {:cexpr "outputSize"} boogie_si_record_i64($i62);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2884, 21} true;
  assume {:verifier.code 0} true;
  call $p63 := ExAllocatePoolWithTag(1, $i62, 1718767684);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2885, 20} true;
  assume {:verifier.code 0} true;
  $p64 := $bitcast.ref.ref($p63);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2887, 14} true;
  assume {:verifier.code 0} true;
  $i65 := $ne.ref($p64, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2887, 13} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume !(($i65 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2889, 13} true;
  assume {:verifier.code 0} true;
  call DiskPerfLogError($p0, 258, 0, $sub.i64(0, 1073479678));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2891, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i64(0, 1073741670);
  goto $bb3;
$bb24:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2898, 32} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2898, 32} true;
  assume {:verifier.code 0} true;
  $p67 := $load.ref($M.18, $p66);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2898, 66} true;
  assume {:verifier.code 0} true;
  $p68 := $bitcast.ref.ref($p64);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2896, 17} true;
  assume {:verifier.code 0} true;
  call $p69 := IoBuildDeviceIoControlRequest(5046280, $p67, $0.ref, 0, $p68, $i62, 0, $p2, $p1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2901, 14} true;
  assume {:verifier.code 0} true;
  $i70 := $ne.ref($p69, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2901, 13} true;
  assume {:verifier.code 0} true;
...
$bb26:
  assume !(($i70 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2904, 13} true;
  assume {:verifier.code 0} true;
  call DiskPerfLogError($p0, 259, 0, $sub.i64(0, 1073479678));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2906, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i64(0, 1073741670);
  goto $bb3;
$bb27:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2909, 51} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2909, 51} true;
  assume {:verifier.code 0} true;
  $p72 := $load.ref($M.18, $p71);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2909, 20} true;
  assume {:verifier.code 0} true;
  call $i73 := IofCallDriver($p72, $p69);
  call {:cexpr "status"} boogie_si_record_i64($i73);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2910, 20} true;
  assume {:verifier.code 0} true;
  $i74 := $eq.i64($i73, 259);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2910, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i74} true;
  goto $bb28, $bb29;
$bb28:
  assume ($i74 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2912, 35} true;
  assume {:verifier.code 0} true;
  $p75 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2912, 13} true;
  assume {:verifier.code 0} true;
  call $i76 := KeWaitForSingleObject($p75, 0, 0, 0, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2913, 31} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2913, 49} true;
  assume {:verifier.code 0} true;
  $p78 := $bitcast.ref.ref($p77);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2913, 49} true;
  assume {:verifier.code 0} true;
  $i79 := $load.i64($M.61, $p78);
  call {:cexpr "status"} boogie_si_record_i64($i79);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2915, 9} true;
  assume {:verifier.code 0} true;
  $i80 := $i79;
  goto $bb30;
$bb29:
...
$bb30:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2917, 7} true;
  assume {:verifier.code 0} true;
  $i81, $p82 := $i80, $p63;
  goto $bb31;
$bb31:
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2919, 20} true;
  assume {:verifier.code 0} true;
  $i83 := $sge.i64($i81, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2919, 11} true;
  assume {:verifier.code 0} true;
...
$bb33:
  assume !(($i83 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2922, 11} true;
  assume {:verifier.code 0} true;
  call DiskPerfLogError($p0, 260, 0, $sub.i64(0, 1073479677));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2924, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $i81;
  goto $bb3;
$bb34:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2928, 26} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(24, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2928, 37} true;
  assume {:verifier.code 0} true;
  $M.36 := $store.i64($M.36, $p84, $sub.i64(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2929, 62} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($add.ref($p82, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2929, 62} true;
  assume {:verifier.code 0} true;
  $i86 := $load.i16($M.64, $p85);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2929, 26} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1));
  $p88 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2929, 52} true;
  assume {:verifier.code 0} true;
  $M.65 := $store.i16($M.65, $p88, $i86);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2931, 35} true;
  assume {:verifier.code 0} true;
  $p89 := $add.ref($add.ref($p82, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2931, 35} true;
  assume {:verifier.code 0} true;
  $i90 := $load.i16($M.64, $p89);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2931, 13} true;
  assume {:verifier.code 0} true;
  $i91 := $zext.i16.i32($i90);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2931, 13} true;
  assume {:verifier.code 0} true;
  $i92 := $zext.i32.i64($i91);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2931, 46} true;
  assume {:verifier.code 0} true;
  $i93 := $add.i64($i92, 2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2931, 13} true;
  assume {:verifier.code 0} true;
  $i94 := $trunc.i64.i16($i93);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2930, 26} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1));
  $p96 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1)), $mul.ref(2, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2930, 59} true;
  assume {:verifier.code 0} true;
  $M.66 := $store.i16($M.66, $p96, $i94);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2932, 33} true;
  assume {:verifier.code 0} true;
  $p97 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1));
  $p98 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2932, 52} true;
  assume {:verifier.code 0} true;
  $p99 := $load.ref($M.67, $p98);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2932, 16} true;
  assume {:verifier.code 0} true;
  $p100 := $bitcast.ref.ref($p99);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2932, 68} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($add.ref($p82, $mul.ref(0, 4)), $mul.ref(2, 1));
  $p102 := $add.ref($add.ref($add.ref($p82, $mul.ref(0, 4)), $mul.ref(2, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2932, 60} true;
  assume {:verifier.code 0} true;
  $p103 := $bitcast.ref.ref($p102);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2933, 24} true;
  assume {:verifier.code 0} true;
  $p104 := $add.ref($add.ref($p82, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2933, 24} true;
  assume {:verifier.code 0} true;
  $i105 := $load.i16($M.64, $p104);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2933, 16} true;
  assume {:verifier.code 0} true;
  $i106 := $zext.i16.i32($i105);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2932, 9} true;
  assume {:verifier.code 0} true;
  call $p107 := memcpy($p100, $p103, $i106);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2934, 28} true;
  assume {:verifier.code 0} true;
  $p108 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1));
  $p109 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2934, 47} true;
  assume {:verifier.code 0} true;
  $p110 := $load.ref($M.67, $p109);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2935, 42} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1));
  $p112 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(136, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2935, 61} true;
  assume {:verifier.code 0} true;
  $i113 := $load.i16($M.65, $p112);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2935, 11} true;
  assume {:verifier.code 0} true;
  $i114 := $zext.i16.i32($i113);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2935, 11} true;
  assume {:verifier.code 0} true;
  $i115 := $zext.i32.i64($i114);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2935, 68} true;
  assume {:verifier.code 0} true;
  $i116 := $udiv.i64($i115, 2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2934, 54} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($p110, $mul.ref($i116, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2936, 30} true;
  assume {:verifier.code 0} true;
  $M.68 := $store.i16($M.68, $p117, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2939, 16} true;
  assume {:verifier.code 0} true;
  $p118 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2939, 9} true;
  assume {:verifier.code 0} true;
  call $p119 := memset($p118, 0, 24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2943, 30} true;
  assume {:verifier.code 0} true;
  $p120 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2943, 30} true;
  assume {:verifier.code 0} true;
  $p121 := $load.ref($M.18, $p120);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2943, 64} true;
  assume {:verifier.code 0} true;
  $p122 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2941, 15} true;
  assume {:verifier.code 0} true;
  call $p123 := IoBuildDeviceIoControlRequest(5636124, $p121, $0.ref, 0, $p122, 24, 0, $p2, $p1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2946, 12} true;
  assume {:verifier.code 0} true;
  $i124 := $ne.ref($p123, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2946, 11} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i124 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2948, 11} true;
  assume {:verifier.code 0} true;
  call DiskPerfLogError($p0, 265, 0, $sub.i64(0, 1073479678));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2950, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i64(0, 1073741670);
  goto $bb3;
$bb37:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2953, 49} true;
  assume {:verifier.code 0} true;
  $p125 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2953, 49} true;
  assume {:verifier.code 0} true;
  $p126 := $load.ref($M.18, $p125);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2953, 18} true;
  assume {:verifier.code 0} true;
  call $i127 := IofCallDriver($p126, $p123);
  call {:cexpr "status"} boogie_si_record_i64($i127);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2954, 18} true;
  assume {:verifier.code 0} true;
  $i128 := $eq.i64($i127, 259);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2954, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i128} true;
  goto $bb38, $bb39;
$bb38:
  assume ($i128 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2956, 33} true;
  assume {:verifier.code 0} true;
  $p129 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2956, 11} true;
  assume {:verifier.code 0} true;
  call $i130 := KeWaitForSingleObject($p129, 0, 0, 0, $0.ref);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2957, 29} true;
  assume {:verifier.code 0} true;
  $p131 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2957, 47} true;
  assume {:verifier.code 0} true;
  $p132 := $bitcast.ref.ref($p131);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2957, 47} true;
  assume {:verifier.code 0} true;
  $i133 := $load.i64($M.61, $p132);
  call {:cexpr "status"} boogie_si_record_i64($i133);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2959, 7} true;
  assume {:verifier.code 0} true;
  $i134 := $i133;
  goto $bb40;
$bb39:
...
$bb40:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2961, 20} true;
  assume {:verifier.code 0} true;
  $i135 := $sge.i64($i134, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2961, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i135} true;
  goto $bb41, $bb42;
$bb41:
  assume ($i135 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2964, 31} true;
  assume {:verifier.code 0} true;
  $p136 := $add.ref($add.ref($p4, $mul.ref(0, 24)), $mul.ref(8, 1));
  $p137 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 24)), $mul.ref(8, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2964, 18} true;
  assume {:verifier.code 0} true;
  $i138 := $load.i16($M.62, $p137);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2964, 13} true;
  assume {:verifier.code 0} true;
  $i139 := $zext.i16.i32($i138);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2964, 52} true;
  assume {:verifier.code 0} true;
  $i140 := $eq.i32($i139, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2964, 13} true;
  assume {:verifier.code 0} true;
...
$bb42:
  assume !(($i135 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2962, 9} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb43:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2967, 36} true;
  assume {:verifier.code 0} true;
  $p141 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(32, 1));
  $p142 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(32, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2967, 18} true;
  assume {:verifier.code 0} true;
  $p143 := $bitcast.ref.ref($p142);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2967, 11} true;
  assume {:verifier.code 0} true;
  call $p144 := memcpy($p143, .str.2, 16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2971, 22} true;
  assume {:verifier.code 0} true;
  $i145 := $sge.i64($i134, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2971, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i145} true;
  goto $bb46, $bb47;
$bb44:
  assume ($i140 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2964, 58} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb45:
  assume !(($i140 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2977, 38} true;
  assume {:verifier.code 0} true;
  $p149 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(32, 1));
  $p150 := $add.ref($add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(32, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2977, 20} true;
  assume {:verifier.code 0} true;
  $p151 := $bitcast.ref.ref($p150);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2978, 34} true;
  assume {:verifier.code 0} true;
  $p152 := $add.ref($add.ref($p4, $mul.ref(0, 24)), $mul.ref(8, 1));
  $p153 := $add.ref($add.ref($add.ref($p4, $mul.ref(0, 24)), $mul.ref(8, 1)), $mul.ref(0, 2));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2978, 20} true;
  assume {:verifier.code 0} true;
  $p154 := $bitcast.ref.ref($p153);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2977, 13} true;
  assume {:verifier.code 0} true;
  call $p155 := memcpy($p151, $p154, 16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2979, 56} true;
  assume {:verifier.code 0} true;
  $p156 := $add.ref($add.ref($p4, $mul.ref(0, 24)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2979, 56} true;
  assume {:verifier.code 0} true;
  $i157 := $load.i64($M.64, $p156);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2979, 30} true;
  assume {:verifier.code 0} true;
  $p158 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(24, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2979, 41} true;
  assume {:verifier.code 0} true;
  $M.36 := $store.i64($M.36, $p158, $i157);
  assume {:verifier.code 0} true;
  goto $bb49;
$bb46:
  assume ($i145 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2972, 56} true;
  assume {:verifier.code 0} true;
  $p146 := $add.ref($add.ref($p4, $mul.ref(0, 24)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2972, 56} true;
  assume {:verifier.code 0} true;
  $i147 := $load.i64($M.64, $p146);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2972, 30} true;
  assume {:verifier.code 0} true;
  $p148 := $add.ref($add.ref($p7, $mul.ref(0, 344)), $mul.ref(24, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2972, 41} true;
  assume {:verifier.code 0} true;
  $M.36 := $store.i64($M.36, $p148, $i147);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2973, 11} true;
  assume {:verifier.code 0} true;
  goto $bb48;
$bb47:
  assume !(($i145 == 1));
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2975, 9} true;
  assume {:verifier.code 0} true;
  goto $bb49;
$bb49:
  assume {:verifier.code 0} true;
...
$bb52:
  assume !(($i161 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2987, 9} true;
  assume {:verifier.code 0} true;
  call DiskPerfLogError($p0, 261, 0, $sub.i64(0, 1073479668));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2989, 5} true;
  assume {:verifier.code 0} true;
  goto $bb53;
$bb53:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 2991, 5} true;
  assume {:verifier.code 0} true;
  $i13 := $i160;
  goto $bb3;
}
const IoBuildDeviceIoControlRequest: ref;
axiom (IoBuildDeviceIoControlRequest == $sub.ref(0, 62959));
procedure {:inline 1} IoBuildDeviceIoControlRequest($i0: i64, $p1: ref, $p2: ref, $i3: i64, $p4: ref, $i5: i64, $i6: i8, $p7: ref, $p8: ref)
  returns ($r: ref)
{
  var $i9: i32;
  var $i10: i1;
  ...
  var $p13: ref;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3578, 28} true;
  assume {:verifier.code 1} true;
  call {:cexpr "IoBuildDeviceIoControlRequest:arg:IoControlCode"} boogie_si_record_i64($i0);
  call {:cexpr "IoBuildDeviceIoControlRequest:arg:InputBufferLength"} boogie_si_record_i64($i3);
  call {:cexpr "IoBuildDeviceIoControlRequest:arg:OutputBufferLength"} boogie_si_record_i64($i5);
  call {:cexpr "IoBuildDeviceIoControlRequest:arg:InternalDeviceIoControl"} boogie_si_record_i8($i6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3578, 28} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i9);
  call {:cexpr "__BLAST_NONDET___0"} boogie_si_record_i32($i9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3582, 15} true;
  assume {:verifier.code 0} true;
  $M.14 := 1;
  call {:cexpr "customIrp"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3583, 28} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3583, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3584, 7} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i10 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3587, 9} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3591, 17} true;
  assume {:verifier.code 0} true;
  call $p11 := malloc(216);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3593, 18} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3593, 11} true;
  assume {:verifier.code 0} true;
  $p13 := $p11;
  goto $bb8;
$bb4:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3595, 11} true;
  assume {:verifier.code 0} true;
  $p13 := $0.ref;
  goto $bb8;
$bb5:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3588, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 0} true;
  goto $bb6, $bb7;
$bb6:
  assume (0 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3588, 16} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume !((0 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3596, 16} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3602, 1} true;
  assume {:verifier.code 0} true;
  $r := $p13;
  $exn := false;
  return;
...
const swprintf: ref;
axiom (swprintf == $sub.ref(0, 63991));
procedure {:inline 1} swprintf.ref.ref.i64.i64($p0: ref, $p1: ref, p.2: i64, p.3: i64)
  returns ($r: i32);
const stub_driver_init: ref;
axiom (stub_driver_init == $sub.ref(0, 65023));
procedure {:inline 1} stub_driver_init()
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3253, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3253, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3253, 7} true;
  assume {:verifier.code 0} true;
  $M.8 := $i0;
  call {:cexpr "s"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3254, 15} true;
  assume {:verifier.code 0} true;
  $M.14 := 0;
  call {:cexpr "customIrp"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3255, 22} true;
  assume {:verifier.code 0} true;
  $i1 := $M.14;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3255, 20} true;
  assume {:verifier.code 0} true;
  $M.13 := $i1;
  call {:cexpr "setEventCalled"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3256, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $M.13;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3256, 23} true;
  assume {:verifier.code 0} true;
  $M.12 := $i2;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3257, 22} true;
  assume {:verifier.code 0} true;
  $i3 := $M.12;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3257, 20} true;
  assume {:verifier.code 0} true;
  $M.11 := $i3;
  call {:cexpr "compRegistered"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3258, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $M.11;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3258, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p6 := $i2p.i64.ref($i5);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3258, 14} true;
  assume {:verifier.code 0} true;
  $M.10 := $p6;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3259, 14} true;
  assume {:verifier.code 0} true;
  $p7 := $M.10;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3259, 14} true;
  assume {:verifier.code 0} true;
  $i8 := $p2i.ref.i32($p7);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3259, 12} true;
  assume {:verifier.code 0} true;
  $M.9 := $i8;
  call {:cexpr "pended"} boogie_si_record_i32($i8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3260, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 66055));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3265, 21} true;
  assume {:verifier.code 1} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(216, $zext.i32.i64(1)));
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(368, $zext.i32.i64(1)));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3265, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3266, 26} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i3);
  call {:cexpr "we_should_unload"} boogie_si_record_i32($i3);
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3268, 28} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i4);
  call {:cexpr "__BLAST_NONDET___0"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3269, 20} true;
  assume {:verifier.code 1} true;
  call $i5 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i5);
  call {:cexpr "irp_choice"} boogie_si_record_i32($i5);
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3271, 24} true;
  assume {:verifier.code 1} true;
  call $p6 := __VERIFIER_nondet_pointer();
  call {:cexpr "smack:ext:__VERIFIER_nondet_pointer"} boogie_si_record_ref($p6);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3271, 22} true;
  assume {:verifier.code 0} true;
  $M.69 := $p6;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3275, 12} true;
  assume {:verifier.code 0} true;
  $M.70 := $p0;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3276, 7} true;
  assume {:verifier.code 0} true;
  call _BLAST_init();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3278, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $sge.i64($i2, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3278, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3279, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3279, 9} true;
  assume {:verifier.code 0} true;
  $M.8 := $i8;
  call {:cexpr "s"} boogie_si_record_i32($i8);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3280, 17} true;
  assume {:verifier.code 0} true;
  $M.14 := 0;
  call {:cexpr "customIrp"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3281, 24} true;
  assume {:verifier.code 0} true;
  $i9 := $M.14;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3281, 22} true;
  assume {:verifier.code 0} true;
  $M.13 := $i9;
  call {:cexpr "setEventCalled"} boogie_si_record_i32($i9);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3282, 27} true;
  assume {:verifier.code 0} true;
  $i10 := $M.13;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3282, 25} true;
  assume {:verifier.code 0} true;
  $M.12 := $i10;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32($i10);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3283, 24} true;
  assume {:verifier.code 0} true;
  $i11 := $M.12;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3283, 22} true;
  assume {:verifier.code 0} true;
  $M.11 := $i11;
  call {:cexpr "compRegistered"} boogie_si_record_i32($i11);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3284, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $M.11;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3284, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p14 := $i2p.i64.ref($i13);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3284, 16} true;
  assume {:verifier.code 0} true;
  $M.10 := $p14;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3285, 16} true;
  assume {:verifier.code 0} true;
  $p15 := $M.10;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3285, 16} true;
  assume {:verifier.code 0} true;
  $i16 := $p2i.ref.i32($p15);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3285, 14} true;
  assume {:verifier.code 0} true;
  $M.9 := $i16;
  call {:cexpr "pended"} boogie_si_record_i32($i16);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3286, 7} true;
  assume {:verifier.code 0} true;
  $p17 := $M.70;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3286, 13} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p17, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p19 := $add.ref($add.ref($add.ref($p17, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3286, 40} true;
  assume {:verifier.code 0} true;
  $p20 := $bitcast.ref.ref($p19);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3286, 47} true;
  assume {:verifier.code 0} true;
  $M.19 := $store.i64($M.19, $p20, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3287, 16} true;
  assume {:verifier.code 0} true;
  $M.20 := 0;
  call {:cexpr "myStatus"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3288, 22} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.i32($i5, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3288, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb3, $bb4;
$bb2:
...
$bb3:
  assume ($i21 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3289, 9} true;
  assume {:verifier.code 0} true;
  $p22 := $M.70;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3289, 15} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($add.ref($p22, $mul.ref(0, 216)), $mul.ref(48, 1));
  $p24 := $add.ref($add.ref($add.ref($p22, $mul.ref(0, 216)), $mul.ref(48, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3289, 42} true;
  assume {:verifier.code 0} true;
  $p25 := $bitcast.ref.ref($p24);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3289, 49} true;
  assume {:verifier.code 0} true;
  $M.19 := $store.i64($M.19, $p25, $sub.i64(0, 1073741637));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3290, 18} true;
  assume {:verifier.code 0} true;
  $M.20 := $sub.i32(0, 1073741637);
  call {:cexpr "myStatus"} boogie_si_record_i32($sub.i32(0, 1073741637));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3291, 7} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume !(($i21 == 1));
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3293, 9} true;
  assume {:verifier.code 0} true;
  call stub_driver_init();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3294, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $sge.i64($i2, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3294, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  goto $bb6, $bb7;
$bb6:
...
$bb7:
  assume !(($i26 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3295, 9} true;
  assume {:verifier.code 0} true;
  $i27 := $sub.i32(0, 1);
  goto $bb8;
$bb8:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3423, 1} true;
  assume {:verifier.code 0} true;
  $r := $i27;
  $exn := false;
  return;
$bb9:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3298, 30} true;
  assume {:verifier.code 0} true;
  $i28 := $eq.i32($i4, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3298, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i28 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3299, 9} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !(($i28 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3301, 32} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.i32($i4, 2);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3301, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  goto $bb13, $bb14;
$bb12:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3318, 54} true;
  assume {:verifier.code 0} true;
  $p33 := $M.70;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3318, 30} true;
  assume {:verifier.code 0} true;
  call $i34 := DiskPerfCreate($p1, $p33);
  call {:cexpr "status"} boogie_si_record_i64($i34);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3320, 21} true;
  assume {:verifier.code 0} true;
  $i35 := $i34;
  goto $bb29;
$bb13:
  assume ($i29 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3302, 11} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume !(($i29 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3304, 34} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.i32($i4, 3);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3304, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i30} true;
  goto $bb16, $bb17;
$bb15:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3323, 61} true;
  assume {:verifier.code 0} true;
  $p36 := $M.70;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3323, 30} true;
  assume {:verifier.code 0} true;
  call $i37 := DiskPerfDeviceControl($p1, $p36);
  call {:cexpr "status"} boogie_si_record_i64($i37);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3325, 21} true;
  assume {:verifier.code 0} true;
  $i35 := $i37;
  goto $bb29;
$bb16:
  assume ($i30 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3305, 13} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb17:
  assume !(($i30 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3307, 36} true;
  assume {:verifier.code 0} true;
  $i31 := $eq.i32($i4, 4);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3307, 17} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb19, $bb20;
$bb18:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3328, 59} true;
  assume {:verifier.code 0} true;
  $p38 := $M.70;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3328, 30} true;
  assume {:verifier.code 0} true;
  call $i39 := DiskPerfDispatchPnp($p1, $p38);
  call {:cexpr "status"} boogie_si_record_i64($i39);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3330, 21} true;
  assume {:verifier.code 0} true;
  $i35 := $i39;
  goto $bb29;
$bb19:
  assume ($i31 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3308, 15} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb20:
  assume !(($i31 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3310, 38} true;
  assume {:verifier.code 0} true;
  $i32 := $eq.i32($i4, 12);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3310, 19} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i32} true;
  goto $bb22, $bb23;
$bb21:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3333, 61} true;
  assume {:verifier.code 0} true;
  $p40 := $M.70;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3333, 30} true;
  assume {:verifier.code 0} true;
  call $i41 := DiskPerfDispatchPower($p1, $p40);
  call {:cexpr "status"} boogie_si_record_i64($i41);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3335, 21} true;
  assume {:verifier.code 0} true;
  $i35 := $i41;
  goto $bb29;
$bb22:
  assume ($i32 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3311, 17} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb23:
  assume !(($i32 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3314, 19} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb24:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3338, 61} true;
  assume {:verifier.code 0} true;
  $p42 := $M.70;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3338, 30} true;
  assume {:verifier.code 0} true;
  call $i43 := DiskPerfShutdownFlush($p1, $p42);
  call {:cexpr "status"} boogie_si_record_i64($i43);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3340, 21} true;
  assume {:verifier.code 0} true;
  $i35 := $i43;
  goto $bb29;
$bb25:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3342, 21} true;
  assume {:verifier.code 0} true;
  $i27 := $sub.i32(0, 1);
  goto $bb8;
$bb26:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3315, 23} true;
  assume {:verifier.code 0} true;
  assume {:branchcond 0} true;
  goto $bb27, $bb28;
$bb27:
  assume (0 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3315, 26} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb28:
  assume !((0 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3343, 26} true;
  assume {:verifier.code 0} true;
  $i35 := $u0;
  goto $bb29;
$bb29:
...
$bb34:
  ...
  goto $bb35;
$bb35:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3352, 11} true;
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3352, 11} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume ($i44 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3355, 7} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb37:
  assume !(($i44 == 1));
  ...
  goto $bb38;
$bb38:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3357, 5} true;
  assume {:verifier.code 0} true;
  $i45 := $i35;
  goto $bb39;
$bb39:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3359, 9} true;
  assume {:verifier.code 0} true;
  $i46 := $M.9;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3359, 16} true;
  assume {:verifier.code 0} true;
  $i47 := $eq.i32($i46, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3359, 9} true;
  assume {:verifier.code 0} true;
...
$bb40:
  assume ($i47 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3360, 11} true;
  assume {:verifier.code 0} true;
  $i48 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3360, 16} true;
  assume {:verifier.code 0} true;
  $i49 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3360, 13} true;
  assume {:verifier.code 0} true;
  $i50 := $eq.i32($i48, $i49);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3360, 11} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume !(($i47 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3365, 12} true;
  assume {:verifier.code 0} true;
  goto $bb45;
$bb42:
  assume ($i50 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3361, 13} true;
  assume {:verifier.code 0} true;
  $i51 := $M.1;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3361, 11} true;
  assume {:verifier.code 0} true;
  $M.8 := $i51;
  call {:cexpr "s"} boogie_si_record_i32($i51);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3362, 7} true;
  assume {:verifier.code 0} true;
  goto $bb44;
$bb43:
  assume !(($i50 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3363, 9} true;
  assume {:verifier.code 0} true;
  goto $bb45;
$bb44:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3365, 5} true;
  assume {:verifier.code 0} true;
  goto $bb46;
$bb45:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3367, 11} true;
  assume {:verifier.code 0} true;
  $i52 := $M.9;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3367, 18} true;
  assume {:verifier.code 0} true;
  $i53 := $eq.i32($i52, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3367, 11} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb47, $bb48;
$bb46:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3421, 12} true;
  assume {:verifier.code 0} true;
  $i80 := $trunc.i64.i32($i45);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3421, 5} true;
  assume {:verifier.code 0} true;
  $i27 := $i80;
  goto $bb8;
$bb47:
  assume ($i53 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3368, 13} true;
  assume {:verifier.code 0} true;
  $i54 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3368, 18} true;
  assume {:verifier.code 0} true;
  $i55 := $M.6;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3368, 15} true;
  assume {:verifier.code 0} true;
  $i56 := $eq.i32($i54, $i55);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3368, 13} true;
  assume {:verifier.code 0} true;
...
$bb48:
  assume !(($i53 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3373, 14} true;
  assume {:verifier.code 0} true;
  goto $bb52;
$bb49:
  assume ($i56 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3369, 15} true;
  assume {:verifier.code 0} true;
  $i57 := $M.6;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3369, 13} true;
  assume {:verifier.code 0} true;
  $M.8 := $i57;
  call {:cexpr "s"} boogie_si_record_i32($i57);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3370, 9} true;
  assume {:verifier.code 0} true;
  goto $bb51;
$bb50:
  assume !(($i56 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3371, 11} true;
  assume {:verifier.code 0} true;
  goto $bb52;
$bb51:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3373, 7} true;
  assume {:verifier.code 0} true;
  goto $bb53;
$bb52:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3375, 13} true;
  assume {:verifier.code 0} true;
  $i58 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3375, 18} true;
  assume {:verifier.code 0} true;
  $i59 := $M.0;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3375, 15} true;
  assume {:verifier.code 0} true;
  $i60 := $eq.i32($i58, $i59);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3375, 13} true;
  assume {:verifier.code 0} true;
...
$bb54:
  assume ($i60 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3377, 9} true;
  assume {:verifier.code 0} true;
  goto $bb56;
$bb55:
  assume !(($i60 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3378, 22} true;
  assume {:verifier.code 0} true;
  $i61 := $eq.i64($i45, $sub.i64(0, 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3378, 15} true;
  assume {:verifier.code 0} true;
...
$bb57:
  assume ($i61 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3380, 11} true;
  assume {:verifier.code 0} true;
  goto $bb59;
$bb58:
  assume !(($i61 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3381, 17} true;
  assume {:verifier.code 0} true;
  $i62 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3381, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $M.4;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3381, 19} true;
  assume {:verifier.code 0} true;
  $i64 := $ne.i32($i62, $i63);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3381, 17} true;
  assume {:verifier.code 0} true;
...
$bb60:
  assume ($i64 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3382, 19} true;
  assume {:verifier.code 0} true;
  $i65 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3382, 24} true;
  assume {:verifier.code 0} true;
  $i66 := $M.7;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3382, 21} true;
  assume {:verifier.code 0} true;
  $i67 := $ne.i32($i65, $i66);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3382, 19} true;
  assume {:verifier.code 0} true;
...
$bb61:
  assume !(($i64 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3393, 20} true;
  assume {:verifier.code 0} true;
  goto $bb67;
$bb62:
  assume ($i67 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3383, 21} true;
  assume {:verifier.code 0} true;
  $i68 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3383, 26} true;
  assume {:verifier.code 0} true;
  $i69 := $M.2;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3383, 23} true;
  assume {:verifier.code 0} true;
  $i70 := $ne.i32($i68, $i69);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3383, 21} true;
  assume {:verifier.code 0} true;
...
$bb63:
  assume !(($i67 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3391, 17} true;
  assume {:verifier.code 0} true;
  goto $bb67;
$bb64:
  assume ($i70 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3385, 21} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3387, 17} true;
  assume {:verifier.code 0} true;
  goto $bb66;
$bb65:
  assume !(($i70 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3388, 19} true;
  assume {:verifier.code 0} true;
  goto $bb67;
$bb66:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3390, 15} true;
  assume {:verifier.code 0} true;
  goto $bb68;
$bb67:
  assume true;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3395, 19} true;
  assume {:verifier.code 0} true;
  $i71 := $M.9;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3395, 26} true;
  assume {:verifier.code 0} true;
  $i72 := $eq.i32($i71, 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3395, 19} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb70, $bb71;
$bb68:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3393, 13} true;
  assume {:verifier.code 0} true;
  goto $bb69;
$bb69:
  assume {:verifier.code 0} true;
...
$bb70:
  assume ($i72 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3396, 28} true;
  assume {:verifier.code 0} true;
  $i73 := $ne.i64($i45, 259);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3396, 21} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  goto $bb72, $bb73;
$bb71:
  assume !(($i72 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3403, 21} true;
  assume {:verifier.code 0} true;
  $i74 := $M.8;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3403, 26} true;
  assume {:verifier.code 0} true;
  $i75 := $M.2;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3403, 23} true;
  assume {:verifier.code 0} true;
  $i76 := $eq.i32($i74, $i75);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3403, 21} true;
  assume {:verifier.code 0} true;
...
$bb72:
  assume ($i73 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3398, 21} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3400, 17} true;
  assume {:verifier.code 0} true;
  goto $bb74;
$bb73:
  assume !(($i73 == 1));
  ...
  goto $bb74;
$bb74:
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3402, 15} true;
  assume {:verifier.code 0} true;
  goto $bb75;
$bb75:
  assume {:verifier.code 0} true;
...
$bb76:
  assume ($i76 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3405, 21} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3407, 17} true;
  assume {:verifier.code 0} true;
  goto $bb78;
$bb77:
  assume !(($i76 == 1));
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3408, 43} true;
  assume {:verifier.code 0} true;
  $i77 := $M.12;
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3408, 33} true;
  assume {:verifier.code 0} true;
  $i78 := $sext.i32.i64($i77);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3408, 30} true;
  assume {:verifier.code 0} true;
  $i79 := $ne.i64($i45, $i78);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3408, 23} true;
  assume {:verifier.code 0} true;
...
$bb79:
  assume ($i79 == 1);
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3410, 23} true;
  assume {:verifier.code 0} true;
  call errorFn();
  assume {:sourceloc "test/c/ntdrivers/diskperf_false.i.cil.c", 3412, 19} true;
  assume {:verifier.code 0} true;
  goto $bb81;
$bb80:
  assume !(($i79 == 1));
...
axiom (__SMACK_dummy == $sub.ref(0, 69151));
...
axiom (__VERIFIER_assert == $sub.ref(0, 70183));
...
axiom (__SMACK_and32 == $sub.ref(0, 71215));
...
axiom (__SMACK_and64 == $sub.ref(0, 72247));
...
axiom (__SMACK_and16 == $sub.ref(0, 73279));
...
axiom (__SMACK_and8 == $sub.ref(0, 74311));
...
axiom (__SMACK_or32 == $sub.ref(0, 75343));
...
axiom (__SMACK_or64 == $sub.ref(0, 76375));
...
axiom (__SMACK_or16 == $sub.ref(0, 77407));
...
axiom (__SMACK_or8 == $sub.ref(0, 78439));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 79471));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 80503));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 81535));
procedure {:inline 1} __SMACK_nondet_int()
  returns ($r: i32);
const __VERIFIER_nondet_long: ref;
axiom (__VERIFIER_nondet_long == $sub.ref(0, 82567));
...
axiom (__SMACK_nondet_long == $sub.ref(0, 83599));
procedure {:inline 1} __SMACK_nondet_long()
  returns ($r: i64);
const __VERIFIER_nondet_pointer: ref;
axiom (__VERIFIER_nondet_pointer == $sub.ref(0, 84631));
...
axiom (__VERIFIER_nondet == $sub.ref(0, 85663));
procedure {:inline 1} __VERIFIER_nondet()
  returns ($r: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 86695));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 87727));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 88759));
...
axiom (llvm.dbg.value == $sub.ref(0, 89791));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 90823));
