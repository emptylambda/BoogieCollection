...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/floor_fail.c -bpl ./floor_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 26832));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/floor_fail.c", 8, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/float/floor_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/floor_fail.c:8:3: warning: over-approximating call to llvm.floor.f64; */
  call $f0 := llvm.floor.f64($fp(2, 700000, 0));
  assume {:sourceloc "test/c/float/floor_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/floor_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/float/floor_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/floor_fail.c:9:3: warning: over-approximating call to llvm.floor.f64; */
  call $f2 := llvm.floor.f64($fp(-2, 700000, 0));
  assume {:sourceloc "test/c/float/floor_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i3 := (if $foeq.float.bool($f2, $fp(-3, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/floor_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/float/floor_fail.c", 10, 14} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/floor_fail.c:10:14: warning: over-approximating call to llvm.floor.f64; */
  call $f4 := llvm.floor.f64($fp(0, 0, 0));
  call {:cexpr "c"} boogie_si_record_float($f4);
  assume {:sourceloc "test/c/float/floor_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/float/floor_fail.c", 11, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
...
$bb17:
  ...
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $f6 := $fptrunc.float.float($f4);
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := __signbitf($f6);
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, 0);
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
...
$bb24:
  ...
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $f11 := $fpext.float.float($f4);
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := __signbitl($f11);
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/float/floor_fail.c", 12, 3} true;
...
$bb28:
  ...
  goto $bb22;
$bb29:
  assume {:sourceloc "test/c/float/floor_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/floor_fail.c:15:7: warning: over-approximating call to llvm.floor.f64; */
  call $f14 := llvm.floor.f64($fp(0, 7, 0));
  call {:cexpr "c"} boogie_si_record_float($f14);
  assume {:sourceloc "test/c/float/floor_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb30;
$bb30:
  assume {:sourceloc "test/c/float/floor_fail.c", 16, 3} true;
...
$bb42:
  ...
  goto $bb36;
$bb43:
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb44;
$bb44:
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
...
$bb45:
  ...
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $f21 := $fptrunc.float.float($f14);
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call $i22 := __signbitf($f21);
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i22, 0);
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
...
$bb52:
  ...
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $f26 := $fpext.float.float($f14);
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call $i27 := __signbitl($f26);
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i28 := $ne.i32($i27, 0);
  assume {:sourceloc "test/c/float/floor_fail.c", 21, 3} true;
...
$bb56:
  ...
  goto $bb50;
$bb57:
  assume {:sourceloc "test/c/float/floor_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__signbitf == $sub.ref(0, 3096));
...
axiom (__signbitl == $sub.ref(0, 5160));
procedure {:inline 1} __signbitl($f0: float)
  returns ($r: i32);
const __isinff: ref;
axiom (__isinff == $sub.ref(0, 6192));
procedure {:inline 1} __isinff($f0: float)
  returns ($r: i32);
const __isinf: ref;
axiom (__isinf == $sub.ref(0, 7224));
procedure {:inline 1} __isinf($f0: float)
  returns ($r: i32);
const __isinfl: ref;
axiom (__isinfl == $sub.ref(0, 8256));
...
axiom (__VERIFIER_assert == $sub.ref(0, 12384));
...
axiom (__SMACK_and32 == $sub.ref(0, 13416));
...
axiom (__SMACK_and64 == $sub.ref(0, 14448));
...
axiom (__SMACK_and16 == $sub.ref(0, 15480));
...
axiom (__SMACK_and8 == $sub.ref(0, 16512));
...
axiom (__SMACK_or32 == $sub.ref(0, 17544));
...
axiom (__SMACK_or64 == $sub.ref(0, 18576));
...
axiom (__SMACK_or16 == $sub.ref(0, 19608));
...
axiom (__SMACK_or8 == $sub.ref(0, 20640));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 21672));
...
axiom (llvm.dbg.value == $sub.ref(0, 25800));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 26832));
