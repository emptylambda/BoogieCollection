...
axiom (forall a#14#0#0: int :: 
  { #Datatypes.TheType.TheType_builder(a#14#0#0) } 
  DatatypeCtorId(#Datatypes.TheType.TheType_builder(a#14#0#0))
...
axiom (forall d: DatatypeType :: 
  { Datatypes.TheType.TheType__builder_q(d) } 
  Datatypes.TheType.TheType__builder_q(d)
     ==> (exists a#15#0#0: int :: d == #Datatypes.TheType.TheType_builder(a#15#0#0)));
...
axiom (forall a#16#0#0: int :: 
  { $Is(#Datatypes.TheType.TheType_builder(a#16#0#0), Tclass.Datatypes.TheType()) } 
  $Is(#Datatypes.TheType.TheType_builder(a#16#0#0), Tclass.Datatypes.TheType())
     <==> $Is(a#16#0#0, TInt));

// Constructor $IsAlloc
axiom (forall a#17#0#0: int, $h: Heap :: 
  { $IsAlloc(#Datatypes.TheType.TheType_builder(a#17#0#0), Tclass.Datatypes.TheType(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#Datatypes.TheType.TheType_builder(a#17#0#0), Tclass.Datatypes.TheType(), $h)
...
axiom (forall a#18#0#0: int :: 
  { #Datatypes.TheType.TheType_builder(LitInt(a#18#0#0)) } 
  #Datatypes.TheType.TheType_builder(LitInt(a#18#0#0))
     == Lit(#Datatypes.TheType.TheType_builder(a#18#0#0)));

function Datatypes.TheType.x(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#19#0#0: int :: 
  { #Datatypes.TheType.TheType_builder(a#19#0#0) } 
  Datatypes.TheType.x(#Datatypes.TheType.TheType_builder(a#19#0#0)) == a#19#0#0);
...
axiom (forall a#20#0#0: DatatypeType :: 
  { #Datatypes.TheType.TheType_copier(a#20#0#0) } 
  DatatypeCtorId(#Datatypes.TheType.TheType_copier(a#20#0#0))
...
axiom (forall d: DatatypeType :: 
  ...
  Datatypes.TheType.TheType__copier_q(d)
     ==> (exists a#21#0#0: DatatypeType :: 
      d == #Datatypes.TheType.TheType_copier(a#21#0#0)));

// Constructor $Is
axiom (forall a#22#0#0: DatatypeType :: 
  { $Is(#Datatypes.TheType.TheType_copier(a#22#0#0), Tclass.Datatypes.TheType()) } 
  $Is(#Datatypes.TheType.TheType_copier(a#22#0#0), Tclass.Datatypes.TheType())
     <==> $Is(a#22#0#0, Tclass.Datatypes.TheType()));

// Constructor $IsAlloc
axiom (forall a#23#0#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#Datatypes.TheType.TheType_copier(a#23#0#0), Tclass.Datatypes.TheType(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#Datatypes.TheType.TheType_copier(a#23#0#0), Tclass.Datatypes.TheType(), $h)
       <==> $IsAlloc(a#23#0#0, Tclass.Datatypes.TheType(), $h)));
...
axiom (forall a#24#0#0: DatatypeType :: 
  { #Datatypes.TheType.TheType_copier(Lit(a#24#0#0)) } 
  #Datatypes.TheType.TheType_copier(Lit(a#24#0#0))
     == Lit(#Datatypes.TheType.TheType_copier(a#24#0#0)));

function Datatypes.TheType.t(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#25#0#0: DatatypeType :: 
  { #Datatypes.TheType.TheType_copier(a#25#0#0) } 
  Datatypes.TheType.t(#Datatypes.TheType.TheType_copier(a#25#0#0)) == a#25#0#0);

// Inductive rank
axiom (forall a#26#0#0: DatatypeType :: 
  { #Datatypes.TheType.TheType_copier(a#26#0#0) } 
  DtRank(a#26#0#0) < DtRank(#Datatypes.TheType.TheType_copier(a#26#0#0)));
...
procedure CheckWellformed$$Datatypes.__default.f1(t#0: DatatypeType where $Is(t#0, Tclass.Datatypes.TheType()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$Datatypes.__default.f1(t#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for function f1
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(230,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume Datatypes.TheType.TheType__builder_q(t#0);
    assert Datatypes.TheType.TheType__builder_q(t#0);
    assume Datatypes.TheType.x(t#0) > 3;
    if (*)
    {
        assume false;
    }
...
procedure {:autoReq} CheckWellformed$$Datatypes.__default.test(t#0: DatatypeType where $Is(t#0, Tclass.Datatypes.TheType()));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$Datatypes.__default.test(t#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(233,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume Datatypes.TheType.TheType__builder_q(t#0);
    assert Datatypes.TheType.TheType__builder_q(t#0);
    ...
    else
    {
        ...
        assume $IsAlloc(##t#0, Tclass.Datatypes.TheType(), $Heap);
        assert {:subsumption 0} Datatypes.TheType.TheType__builder_q(##t#0);
        assert {:subsumption 0} Datatypes.TheType.x(##t#0) > 3;
        assume Datatypes.TheType.TheType__builder_q(##t#0) && Datatypes.TheType.x(##t#0) > 3;
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume Datatypes.__default.f1#canCall(t#0);
        assume Datatypes.__default.test(t#0) == Datatypes.__default.f1(t#0);
        assume Datatypes.__default.f1#canCall(t#0);
        // CheckWellformedWithResult: any expression
        assume $Is(Datatypes.__default.test(t#0), TBool);
        assert b$reqreads#0;
    }
}
   ...
   ==> (forall x#0: int :: 
    ...
    Datatypes.__default.f2#canCall(x#0)
         || (3 != $FunctionContextHeight
           && (forall t#0: DatatypeType :: 
            { Datatypes.TheType.x(t#0) } { Datatypes.TheType.TheType__builder_q(t#0) } 
            $Is(t#0, Tclass.Datatypes.TheType())
               ==> Datatypes.TheType.TheType__builder_q(t#0) && Datatypes.TheType.x(t#0) > x#0))
       ==> true);
...
axiom (forall x#0: int :: 
  ...
  Datatypes.__default.f2#requires(x#0)
     == (forall t#1: DatatypeType :: 
      { Datatypes.TheType.x(t#1) } { Datatypes.TheType.TheType__builder_q(t#1) } 
      $Is(t#1, Tclass.Datatypes.TheType())
         ==> Datatypes.TheType.TheType__builder_q(t#1) && Datatypes.TheType.x(t#1) > x#0));
    ...
    Datatypes.__default.f2#canCall(LitInt(x#0))
         || (3 != $FunctionContextHeight
           && (forall t#2: DatatypeType :: 
            { Datatypes.TheType.x(t#2) } { Datatypes.TheType.TheType__builder_q(t#2) } 
            $Is(t#2, Tclass.Datatypes.TheType())
               ==> Datatypes.TheType.TheType__builder_q(t#2) && Datatypes.TheType.x(t#2) > x#0))
       ==> Datatypes.__default.f2(LitInt(x#0)) == Lit(true));

procedure CheckWellformed$$Datatypes.__default.f2(x#0: int);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$Datatypes.__default.f2(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var t#3: DatatypeType;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(238,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc t#3;
    assume $Is(t#3, Tclass.Datatypes.TheType());
    assume Datatypes.TheType.TheType__builder_q(t#3);
    assert Datatypes.TheType.TheType__builder_q(t#3);
    assume Datatypes.TheType.x(t#3) > x#0;
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        assume Datatypes.__default.f2(x#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(Datatypes.__default.f2(x#0), TBool);
    }
}
...
axiom 4 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    Datatypes.__default.f3#canCall(y#0) || 4 != $FunctionContextHeight ==> true);
...
axiom 4 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    { Datatypes.__default.f3(y#0) } 
    Datatypes.__default.f3#canCall(y#0) || 4 != $FunctionContextHeight
...
axiom 4 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    Datatypes.__default.f3#canCall(LitInt(y#0)) || 4 != $FunctionContextHeight
       ==> Datatypes.__default.f2#canCall(LitInt(y#0))
         && Datatypes.__default.f3(LitInt(y#0)) == Lit(Datatypes.__default.f2(LitInt(y#0))));

procedure CheckWellformed$$Datatypes.__default.f3(y#0: int);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$Datatypes.__default.f3(y#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(245,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        assert {:subsumption 0} (forall t#0: DatatypeType :: 
          { Datatypes.TheType.x(t#0) } { Datatypes.TheType.TheType__builder_q(t#0) } 
          $Is(t#0, Tclass.Datatypes.TheType())
             ==> Datatypes.TheType.TheType__builder_q(t#0) && Datatypes.TheType.x(t#0) > ##x#0);
        assume (forall t#0: DatatypeType :: 
          { Datatypes.TheType.x(t#0) } { Datatypes.TheType.TheType__builder_q(t#0) } 
          $Is(t#0, Tclass.Datatypes.TheType())
             ==> Datatypes.TheType.TheType__builder_q(t#0) && Datatypes.TheType.x(t#0) > ##x#0);
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume Datatypes.__default.f2#canCall(y#0);
        assume Datatypes.__default.f3(y#0) == Datatypes.__default.f2(y#0);
        assume Datatypes.__default.f2#canCall(y#0);
        // CheckWellformedWithResult: any expression
        assume $Is(Datatypes.__default.f3(y#0), TBool);
        assert b$reqreads#0;
    }
}
    ...
    Datatypes.__default.test2#canCall(z#0)
         || (5 != $FunctionContextHeight
           && (forall t#0: DatatypeType :: 
            { Datatypes.TheType.x(t#0) } { Datatypes.TheType.TheType__builder_q(t#0) } 
            $Is(t#0, Tclass.Datatypes.TheType())
               ==> Datatypes.TheType.TheType__builder_q(t#0) && Datatypes.TheType.x(t#0) > z#0))
       ==> true);
...
axiom (forall z#0: int :: 
  ...
  Datatypes.__default.test2#requires(z#0)
     == (forall t#1: DatatypeType :: 
      { Datatypes.TheType.x(t#1) } { Datatypes.TheType.TheType__builder_q(t#1) } 
      $Is(t#1, Tclass.Datatypes.TheType())
         ==> Datatypes.TheType.TheType__builder_q(t#1) && Datatypes.TheType.x(t#1) > z#0));
    ...
    Datatypes.__default.test2#canCall(LitInt(z#0))
         || (5 != $FunctionContextHeight
           && (forall t#2: DatatypeType :: 
            { Datatypes.TheType.x(t#2) } { Datatypes.TheType.TheType__builder_q(t#2) } 
            $Is(t#2, Tclass.Datatypes.TheType())
               ==> Datatypes.TheType.TheType__builder_q(t#2) && Datatypes.TheType.x(t#2) > z#0))
       ==> Datatypes.__default.f2#canCall(LitInt(z#0))
         && Datatypes.__default.test2(LitInt(z#0))
           == Lit(Datatypes.__default.f2(LitInt(z#0))));

procedure {:autoReq} CheckWellformed$$Datatypes.__default.test2(z#0: int);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$Datatypes.__default.test2(z#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var t#3: DatatypeType;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(250,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc t#3;
    assume $Is(t#3, Tclass.Datatypes.TheType());
    assume Datatypes.TheType.TheType__builder_q(t#3);
    assert Datatypes.TheType.TheType__builder_q(t#3);
    assume Datatypes.TheType.x(t#3) > z#0;
    assume (forall t#4: DatatypeType :: 
      { Datatypes.TheType.x(t#4) } { Datatypes.TheType.TheType__builder_q(t#4) } 
      $Is(t#4, Tclass.Datatypes.TheType())
         ==> Datatypes.TheType.TheType__builder_q(t#4) && Datatypes.TheType.x(t#4) > z#0);
    if (*)
    {
        assume false;
    }
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assert {:subsumption 0} (forall t#5: DatatypeType :: 
        ...
        assume (forall t#5: DatatypeType :: 
          { Datatypes.TheType.x(t#5) } { Datatypes.TheType.TheType__builder_q(t#5) } 
          $Is(t#5, Tclass.Datatypes.TheType())
             ==> Datatypes.TheType.TheType__builder_q(t#5) && Datatypes.TheType.x(t#5) > ##x#0);
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume Datatypes.__default.f2#canCall(z#0);
        assume Datatypes.__default.test2(z#0) == Datatypes.__default.f2(z#0);
        assume Datatypes.__default.f2#canCall(z#0);
        // CheckWellformedWithResult: any expression
        assume $Is(Datatypes.__default.test2(z#0), TBool);
        assert b$reqreads#0;
    }
}
