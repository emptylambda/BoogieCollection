...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/simple_pre4_fail.c -bpl ./simple_pre4_fail.bpl
...
procedure {:inline 1} incr($i0: i16)
  returns ($r: i16)
{
  var $i1: i16;
$bb0:
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 7, 30} true;
  assume {:verifier.code 0} true;
  call {:cexpr "incr:arg:x"} boogie_si_record_i16($i0);
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 7, 30} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i16($i0, 1);
  call {:cexpr "x"} boogie_si_record_i16($i1);
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 7, 23} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  call $i0 := incr($sub.i16(0, 2));
  call {:cexpr "a"} boogie_si_record_i16($i0);
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 14, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i16.i32($i0);
  assume {:sourceloc "test/c/basic/simple_pre4_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
