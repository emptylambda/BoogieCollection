...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c -bpl ./kbfiltr_simpl2_true.cil.bpl
...
procedure {:inline 1} stub_driver_init()
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 52, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 52, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 52, 7} true;
  assume {:verifier.code 0} true;
  $M.1 := $i0;
  call {:cexpr "s"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 53, 12} true;
  assume {:verifier.code 0} true;
  $M.2 := 0;
  call {:cexpr "pended"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 54, 14} true;
  assume {:verifier.code 0} true;
  $M.3 := 0;
  call {:cexpr "compFptr"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 55, 20} true;
  assume {:verifier.code 0} true;
  $M.4 := 0;
  call {:cexpr "compRegistered"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 56, 23} true;
  assume {:verifier.code 0} true;
  $M.5 := 0;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 57, 20} true;
  assume {:verifier.code 0} true;
  $M.6 := 0;
  call {:cexpr "setEventCalled"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 58, 15} true;
  assume {:verifier.code 0} true;
  $M.7 := 0;
  call {:cexpr "customIrp"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/kbfiltr_simpl2_true.cil.c", 59, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb54:
  ...
  goto $bb55;
$bb55:
  assume {:sourceloc "kbfiltr_simpl2.cil.c", 474, 9} true;
  assume {:verifier.code 0} true;
  goto $bb52;
$bb56:
  assume ($i47 == 1);
...
$bb63:
  ...
  goto $bb64;
$bb64:
  assume {:sourceloc "kbfiltr_simpl2.cil.c", 473, 11} true;
  assume {:verifier.code 0} true;
  goto $bb55;
$bb65:
  assume ($i55 == 1);
...
$bb77:
  assume ($i62 == 1);
  assume {:sourceloc "kbfiltr_simpl2.cil.c", 469, 19} true;
  assume {:verifier.code 0} true;
  goto $bb79;
$bb78:
  assume {:sourceloc "kbfiltr_simpl2.cil.c", 468, 23} true;
