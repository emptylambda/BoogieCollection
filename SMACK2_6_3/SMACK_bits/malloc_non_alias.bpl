...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/malloc_non_alias.c -bpl ./malloc_non_alias.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 8, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 9, 19} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(4);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 9, 12} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call $p4 := malloc(4);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 10, 12} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.ref($p1, $p3);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 11, 7} true;
  assume {:verifier.code 0} true;
  $p7 := $p2;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 12, 5} true;
  assume {:verifier.code 0} true;
  $p7 := $p4;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 13, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p7, 1);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 14, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, 2);
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 15, 3} true;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/bits/malloc_non_alias.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
