...
procedure CheckWellformed$$Module0.__default.M(x#0: int) returns (n#0: int where Lit(true));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$Module0.__default.M(x#0: int) returns (n#0: int where Lit(true));
  modifies $Heap, $Tick;
...
procedure Impl$$Module0.__default.M(x#0: int) returns (n#0: int where Lit(true), $_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
