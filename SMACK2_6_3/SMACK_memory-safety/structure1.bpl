...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/structure1.c -bpl ./structure1.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/structure1.c", 13, 14} true;
  ...
  assume {:sourceloc "test/c/memory-safety/structure1.c", 14, 13} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/structure1.c", 14, 22} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2, $mul.ref(11, 4));
  assume {:sourceloc "test/c/memory-safety/structure1.c", 14, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p3);
  call {:cexpr "x"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/memory-safety/structure1.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/structure1.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call free_($p5);
  assume {:sourceloc "test/c/memory-safety/structure1.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
