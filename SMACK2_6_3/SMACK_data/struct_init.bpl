...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_init.c -bpl ./struct_init.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_init.c", 11, 12} true;
  ...
  assume {:sourceloc "test/c/data/struct_init.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_init.c", 12, 3} true;
...
$bb7:
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "test/c/data/struct_init.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
