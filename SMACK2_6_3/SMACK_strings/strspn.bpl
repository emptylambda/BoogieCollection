...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strspn.c -bpl ./strspn.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24754));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strspn.c", 8, 22} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strspn.c", 8, 22} true;
  assume {:verifier.code 0} true;
  call $i0 := strspn(.str, .str.1);
  call {:cexpr "firstNonB"} boogie_si_record_i64($i0);
  assume {:sourceloc "test/c/strings/strspn.c", 9, 16} true;
  assume {:verifier.code 0} true;
  call $i1 := strspn(.str, .str.2);
  call {:cexpr "end"} boogie_si_record_i64($i1);
  assume {:sourceloc "test/c/strings/strspn.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strspn.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strspn.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/strings/strspn.c", 12, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/strings/strspn.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strspn: ref;
axiom (strspn == $sub.ref(0, 5146));
procedure {:inline 1} strspn($p0: ref, $p1: ref)
  returns ($r: i64);
const strlen: ref;
axiom (strlen == $sub.ref(0, 6178));
procedure {:inline 1} strlen($p0: ref)
  returns ($r: i64);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 7210));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 8242));
...
axiom (__SMACK_dummy == $sub.ref(0, 9274));
...
axiom (__VERIFIER_assert == $sub.ref(0, 10306));
...
axiom (__SMACK_and32 == $sub.ref(0, 11338));
...
axiom (__SMACK_and64 == $sub.ref(0, 12370));
...
axiom (__SMACK_and16 == $sub.ref(0, 13402));
...
axiom (__SMACK_and8 == $sub.ref(0, 14434));
...
axiom (__SMACK_or32 == $sub.ref(0, 15466));
...
axiom (__SMACK_or64 == $sub.ref(0, 16498));
...
axiom (__SMACK_or16 == $sub.ref(0, 17530));
...
axiom (__SMACK_or8 == $sub.ref(0, 18562));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19594));
...
axiom (__SMACK_decls == $sub.ref(0, 20626));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 21658));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 22690));
...
axiom (llvm.dbg.value == $sub.ref(0, 23722));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 24754));
