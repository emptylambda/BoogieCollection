...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/func_ptr_array_fail.c -bpl ./func_ptr_array_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 26836));
...
const {:count 2} fptrs: ref;
axiom (fptrs == $sub.ref(0, 2068));
const func2: ref;
axiom (func2 == $sub.ref(0, 3100));
procedure {:inline 1} func2()
{
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 8, 18} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 8, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "g"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 8, 23} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const add_func: ref;
axiom (add_func == $sub.ref(0, 4132));
procedure {:inline 1} add_func($p0: ref)
{
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 10, 39} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 10, 39} true;
  assume {:verifier.code 0} true;
  $M.1 := $p0;
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 10, 44} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const func1: ref;
axiom (func1 == $sub.ref(0, 5164));
procedure {:inline 1} func1()
{
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 12, 16} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 12, 16} true;
  assume {:verifier.code 0} true;
  call add_func(func2);
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 12, 33} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 6196));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 15, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 15, 12} true;
  assume {:verifier.code 0} true;
  $M.2 := func1;
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $p0 := $M.2;
  call devirtbounce($p0);
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $M.1;
  call devirtbounce.1($p1);
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 18, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/func_ptr_array_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 9292));
...
axiom (__VERIFIER_assert == $sub.ref(0, 10324));
...
axiom (__SMACK_and32 == $sub.ref(0, 11356));
...
axiom (__SMACK_and64 == $sub.ref(0, 12388));
...
axiom (__SMACK_and16 == $sub.ref(0, 13420));
...
axiom (__SMACK_and8 == $sub.ref(0, 14452));
...
axiom (__SMACK_or32 == $sub.ref(0, 15484));
...
axiom (__SMACK_or64 == $sub.ref(0, 16516));
...
axiom (__SMACK_or16 == $sub.ref(0, 17548));
...
axiom (__SMACK_or8 == $sub.ref(0, 18580));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19612));
...
axiom (__SMACK_decls == $sub.ref(0, 20644));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 21676));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 22708));
...
axiom (llvm.dbg.value == $sub.ref(0, 23740));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 24772));
...
axiom (devirtbounce == $sub.ref(0, 25804));
procedure {:inline 1} devirtbounce(funcPtr: ref)
{
  var $p0: ref;
  var $i1: i1;
$bb0:
...
axiom (devirtbounce.1 == $sub.ref(0, 26836));
procedure {:inline 1} devirtbounce.1(funcPtr: ref)
{
  var $p0: ref;
  var $i1: i1;
$bb0:
