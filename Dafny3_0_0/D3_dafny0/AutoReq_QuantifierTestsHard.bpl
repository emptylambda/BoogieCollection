...
procedure CheckWellformed$$QuantifierTestsHard.__default.byte(x#0: int);
...
procedure CheckWellformed$$QuantifierTestsHard.__default.f__forall(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsHard.__default.f__forall(s#0: Seq Box)
{
  ...
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function f_forall
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(108,11): initial state"} true;
    ...
    else
    {
        ...
        assume QuantifierTestsHard.__default.f__forall(s#0)
           == (forall i#3: int :: 
...
procedure CheckWellformed$$QuantifierTestsHard.__default.f__exists(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsHard.__default.f__exists(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#2: int;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function f_exists
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(113,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        // End Comprehension WF check
        assume QuantifierTestsHard.__default.f__exists(s#0)
           == (exists i#3: int :: 
            { $Unbox(Seq#Index(s#0, i#3)): int } 
            (LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
                 ==> LitInt(0) <= $Unbox(Seq#Index(s#0, i#3)): int
...
procedure CheckWellformed$$QuantifierTestsHard.__default.g__forall(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsHard.__default.g__forall(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var j#3: int;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function g_forall
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(118,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc j#3;
    assume true;
    ...
    {
        assume LitInt(0) <= j#3;
        assume j#3 < Seq#Length(s#0);
        assert 0 <= j#3 && j#3 < Seq#Length(s#0);
        assume LitInt(0) <= $Unbox(Seq#Index(s#0, j#3)): int;
        assert 0 <= j#3 && j#3 < Seq#Length(s#0);
        assume $Unbox(Seq#Index(s#0, j#3)): int < 256;
    }
    else
    {
        assume LitInt(0) <= j#3 && j#3 < Seq#Length(s#0)
    ...
    if (*)
    {
        ...
        assume QuantifierTestsHard.__default.byte($Unbox(Seq#Index(s#0, j#3)): int);
    }
    else
    {
        assume LitInt(0) <= j#3 && j#3 < Seq#Length(s#0)
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        assume QuantifierTestsHard.__default.g__forall(s#0) == (Seq#Length(s#0) > 2);
        assume true;
        // CheckWellformedWithResult: any expression
...
procedure CheckWellformed$$QuantifierTestsHard.__default.h__forall(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsHard.__default.h__forall(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##s#0: Seq Box;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function h_forall
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(124,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume QuantifierTestsHard.__default.f__forall#canCall(s#0);
        assume QuantifierTestsHard.__default.h__forall(s#0)
           == QuantifierTestsHard.__default.f__forall(s#0);
        assume QuantifierTestsHard.__default.f__forall#canCall(s#0);
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsHard.__default.h__forall(s#0), TBool);
        assert b$reqreads#0;
    }
}
...
procedure CheckWellformed$$QuantifierTestsHard.__default.h(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsHard.__default.h(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var j#3: int;
  var ##x#0: int;
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(129,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc j#3;
    assume true;
    ...
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##s#0, TSeq(TInt), $Heap);
        assert {:subsumption 0} (forall j#5: int :: 
        ...
        assume QuantifierTestsHard.__default.h(s#0)
           == QuantifierTestsHard.__default.g__forall(s#0);
        assume QuantifierTestsHard.__default.g__forall#canCall(s#0);
        // CheckWellformedWithResult: any expression
...
procedure CheckWellformed$$QuantifierTestsHard.__default.i(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 6 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsHard.__default.i(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var k#3: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(134,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc k#3;
    assume true;
    ...
    {
        assume LitInt(0) <= k#3;
        assume k#3 < Seq#Length(s#0);
        assert 0 <= k#3 && k#3 < Seq#Length(s#0);
        assume LitInt(0) <= $Unbox(Seq#Index(s#0, k#3)): int;
        assert 0 <= k#3 && k#3 < Seq#Length(s#0);
        assume $Unbox(Seq#Index(s#0, k#3)): int < 5;
    }
    else
    {
        assume LitInt(0) <= k#3 && k#3 < Seq#Length(s#0)
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        assume QuantifierTestsHard.__default.i(s#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
...
procedure CheckWellformed$$QuantifierTestsHard.__default.j(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 7 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsHard.__default.j(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var k#3: int;
  var ##s#0: Seq Box;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(140,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc k#3;
    assume true;
    ...
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##s#0, TSeq(TInt), $Heap);
        assert {:subsumption 0} (forall k#5: int :: 
        ...
        assume QuantifierTestsHard.__default.j(s#0) == QuantifierTestsHard.__default.i(s#0);
        assume QuantifierTestsHard.__default.i#canCall(s#0);
        // CheckWellformedWithResult: any expression
...
axiom 8 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    { QuantifierTestsHard.__default.m(x#0) } 
    QuantifierTestsHard.__default.m#canCall(x#0) || 8 != $FunctionContextHeight
       ==> true);
...
procedure CheckWellformed$$QuantifierTestsHard.__default.m(x#0: int);
...
axiom 11 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    { QuantifierTestsHard.__default.n(x#0) } 
    QuantifierTestsHard.__default.n#canCall(x#0) || 11 != $FunctionContextHeight
       ==> true);
...
procedure CheckWellformed$$QuantifierTestsHard.__default.n(x#0: int);
...
axiom 9 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QuantifierTestsHard.__default.f1#canCall(x#0)
         || (9 != $FunctionContextHeight && x#0 > 3 && x#0 < 16)
       ==> true);
...
procedure CheckWellformed$$QuantifierTestsHard.__default.f1(x#0: int);
    ...
    QuantifierTestsHard.__default.variable__uniqueness__test#canCall(x#0)
         || (10 != $FunctionContextHeight
          ...
          ((forall y#0: int :: 
              ...
              true ==> QuantifierTestsHard.__default.m(y#0))
             ==> x#0 > 3)
           && ((forall y#1: int :: 
              { QuantifierTestsHard.__default.m(y#1) } 
              true ==> QuantifierTestsHard.__default.m(y#1))
             ==> x#0 < 16))
       ==> true);
...
axiom (forall x#0: int :: 
  ...
  QuantifierTestsHard.__default.variable__uniqueness__test#requires(x#0)
     == (((forall y#2: int :: 
          ...
          true ==> QuantifierTestsHard.__default.m(y#2))
         ==> x#0 > 3)
       && ((forall y#3: int :: 
          { QuantifierTestsHard.__default.m(y#3) } 
          true ==> QuantifierTestsHard.__default.m(y#3))
         ==> x#0 < 16)));
   ...
   ==> (forall x#0: int :: 
    ...
    QuantifierTestsHard.__default.variable__uniqueness__test#canCall(x#0)
       ...
       ==> (forall y#4: int :: 
         ...
         && ((forall y#4: int :: 
            { QuantifierTestsHard.__default.m(y#4) } 
            true ==> QuantifierTestsHard.__default.m(y#4))
           ==> QuantifierTestsHard.__default.f1#canCall(x#0))
         && QuantifierTestsHard.__default.variable__uniqueness__test(x#0)
           == ((forall y#4: int :: 
              { QuantifierTestsHard.__default.m(y#4) } 
    ...
    QuantifierTestsHard.__default.variable__uniqueness__test#canCall(LitInt(x#0))
         || (10 != $FunctionContextHeight
          ...
          ((forall y#5: int :: 
              ...
              true ==> QuantifierTestsHard.__default.m(y#5))
             ==> x#0 > 3)
           && ((forall y#6: int :: 
              { QuantifierTestsHard.__default.m(y#6) } 
              true ==> QuantifierTestsHard.__default.m(y#6))
             ==> x#0 < 16))
       ==> (forall y#7: int :: 
         ...
         && ((forall y#7: int :: 
            { QuantifierTestsHard.__default.m(y#7) } 
            true ==> QuantifierTestsHard.__default.m(y#7))
...
procedure CheckWellformed$$QuantifierTestsHard.__default.variable__uniqueness__test(x#0: int);
  free requires 10 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsHard.__default.variable__uniqueness__test(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var y#8: int;
  var ##x#0: int;
  ...
  var b$reqreads#3: bool;
    ...
    // AddWellformednessCheck for function variable_uniqueness_test
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(152,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        ...
        // End Comprehension WF check
        assume (forall y#9: int :: 
          { QuantifierTestsHard.__default.m(y#9) } 
          true ==> QuantifierTestsHard.__default.m(y#9));
        assume x#0 > 3;
    }
    else
    {
    ...
    else
    {
        ...
        if (true)
        {
            ...
            assume QuantifierTestsHard.__default.m#canCall(y#11);
        }
          ...
          true ==> QuantifierTestsHard.__default.m(y#9)))
        {
            ...
            assert {:subsumption 0} ##x#3 > 3;
            assume ##x#3 > 3;
            assert {:subsumption 0} ##x#3 < 16;
            assume ##x#3 < 16;
            b$reqreads#3 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assume QuantifierTestsHard.__default.f1#canCall(x#0);
        }

        assume QuantifierTestsHard.__default.variable__uniqueness__test(x#0)
           == ((forall y#9: int :: 
              { QuantifierTestsHard.__default.m(y#9) } 
              true ==> QuantifierTestsHard.__default.m(y#9))
             && QuantifierTestsHard.__default.f1(x#0));
        assume (forall y#9: int :: 
            { QuantifierTestsHard.__default.m(y#9) } 
            QuantifierTestsHard.__default.m#canCall(y#9))
           && ((forall y#9: int :: 
              { QuantifierTestsHard.__default.m(y#9) } 
              true ==> QuantifierTestsHard.__default.m(y#9))
             ==> QuantifierTestsHard.__default.f1#canCall(x#0));
