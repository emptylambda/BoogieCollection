...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/left_shift_overflow.c -bpl ./left_shift_overflow.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/left_shift_overflow.c", 7, 11} true;
  ...
  assume {:sourceloc "test/c/bits/left_shift_overflow.c", 8, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/left_shift_overflow.c", 9, 3} true;
...
$bb7:
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "test/c/bits/left_shift_overflow.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/bits/left_shift_overflow.c", 10, 3} true;
...
$bb15:
  ...
  goto $bb12;
$bb16:
  assume {:sourceloc "test/c/bits/left_shift_overflow.c", 11, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/left_shift_overflow.c:11:12: warning: over-approximating bitwise operation shl; */
  $i6 := $shl.i32($i0, $i1);
  assume {:sourceloc "test/c/bits/left_shift_overflow.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
