...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/unsigned_max.c -bpl ./unsigned_max.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/unsigned_max.c", 8, 16} true;
  ...
  assume {:sourceloc "test/c/basic/unsigned_max.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/unsigned_max.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/basic/unsigned_max.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $ugt.i32($i0, 4294967293);
  assume {:sourceloc "test/c/basic/unsigned_max.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/basic/unsigned_max.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
