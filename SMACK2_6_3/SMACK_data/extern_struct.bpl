...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/extern_struct.c -bpl ./extern_struct.bpl
...
const procinit: ref;
axiom (procinit == $add.ref($GLOBALS_BOTTOM, $sub.ref(0, 32776)));
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/extern_struct.c", 8, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/extern_struct.c", 8, 15} true;
  assume {:verifier.code 0} true;
  $M.0 := $0.ref;
  assume {:sourceloc "test/c/data/extern_struct.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/extern_struct.c", 9, 3} true;
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/data/extern_struct.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
