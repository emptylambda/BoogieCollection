...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_alias.c -bpl ./struct_alias.bpl
...
const f: ref;
axiom (f == $sub.ref(0, 1032));
procedure {:inline 1} f($p0: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "test/c/data/struct_alias.c", 15, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/struct_alias.c", 15, 34} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_alias.c", 15, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "test/c/data/struct_alias.c", 15, 41} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
const g: ref;
axiom (g == $sub.ref(0, 3096));
procedure {:inline 1} g($p0: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "test/c/data/struct_alias.c", 17, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/struct_alias.c", 17, 34} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_alias.c", 17, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "test/c/data/struct_alias.c", 17, 41} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_alias.c", 22, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/struct_alias.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/struct_alias.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call f($p1);
  assume {:sourceloc "test/c/data/struct_alias.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_alias.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call f($p2);
  assume {:sourceloc "test/c/data/struct_alias.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_alias.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call g($p3);
  assume {:sourceloc "test/c/data/struct_alias.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_alias.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(4, 1));
  $p5 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(4, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_alias.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p5);
  assume {:sourceloc "test/c/data/struct_alias.c", 26, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/struct_alias.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/data/struct_alias.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(8, 1));
  $p9 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(8, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_alias.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.0, $p9);
  assume {:sourceloc "test/c/data/struct_alias.c", 27, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/data/struct_alias.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
