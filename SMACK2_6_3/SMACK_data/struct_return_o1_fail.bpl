...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_return_o1_fail.c -bpl ./struct_return_o1_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $p10: ref;
$bb0:
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 14, 9} true;
  ...
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $p2 := $M.0;
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.ref($M.1, $p1, $p2);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i64($M.2, $p3, 2);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 15, 3} true;
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p6 := $load.ref($M.1, $p5);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 16, 3} true;
  assume ($extractvalue.i64($p7, 1) == $extractvalue.i64($u0, 1));
  assume ($extractvalue.ref($p7, 0) == $p6);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 16, 3} true;
  $p8 := $add.ref($add.ref($p4, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 16, 3} true;
  $i9 := $load.i64($M.2, $p8);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 16, 3} true;
  assume ($extractvalue.ref($p10, 0) == $extractvalue.ref($p7, 0));
  assume ($extractvalue.i64($p10, 1) == $i9);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := $p10;
  $exn := false;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i32($M.3, $p0, 1);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $p0;
  assume true;
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 22, 9} true;
  assume {:verifier.code 0} true;
  call $p2 := foo();
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 22, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $extractvalue.ref($p2, 0);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.ref($M.4, $p4, $p5);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $extractvalue.i64($p2, 1);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 22, 9} true;
  assume {:verifier.code 0} true;
  $M.5 := $store.i64($M.5, $p6, $i7);
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 23, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/struct_return_o1_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
