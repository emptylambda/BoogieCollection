...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/bitcast.c -bpl ./bitcast.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/bitcast.c", 7, 7} true;
  ...
  assume true;
  assume {:sourceloc "test/c/float/bitcast.c", 8, 13} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/float/bitcast.c", 8, 13} true;
  assume {:verifier.code 0} true;
  $f3 := $load.unsafe.float($M.0, $p2);
  assume {:sourceloc "test/c/float/bitcast.c", 8, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.unsafe.float($M.1, $p1, $f3);
  assume {:sourceloc "test/c/float/bitcast.c", 9, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/float/bitcast.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/bitcast.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/bitcast.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
