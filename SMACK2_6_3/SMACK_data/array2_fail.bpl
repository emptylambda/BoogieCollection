...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/array2_fail.c -bpl ./array2_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/array2_fail.c", 14, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/array2_fail.c", 14, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(40);
  assume {:sourceloc "test/c/data/array2_fail.c", 14, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/array2_fail.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array2_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array2_fail.c", 16, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, 9);
  assume {:sourceloc "test/c/data/array2_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/array2_fail.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i2);
  assume {:sourceloc "test/c/data/array2_fail.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p1, $mul.ref($i4, 4));
  assume {:sourceloc "test/c/data/array2_fail.c", 17, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, 0);
  assume {:sourceloc "test/c/data/array2_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/array2_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/data/array2_fail.c", 16, 33} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i2, 1);
...
$bb10:
  ...
  goto $bb7;
$bb11:
  assume {:sourceloc "test/c/data/array2_fail.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/array2_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call free_($p13);
  assume {:sourceloc "test/c/data/array2_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
