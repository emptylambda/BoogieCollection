...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/extern_func_ptr_fail.c -bpl ./extern_func_ptr_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/extern_func_ptr_fail.c", 8, 12} true;
  ...
  assume {:sourceloc "test/c/data/extern_func_ptr_fail.c", 9, 12} true;
  assume {:verifier.code 0} true;
  call $p1 := foo();
  assume $isExternal($p1);
  assume {:sourceloc "test/c/data/extern_func_ptr_fail.c", 11, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, 1);
  assume {:sourceloc "test/c/data/extern_func_ptr_fail.c", 12, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 2);
  assume {:sourceloc "test/c/data/extern_func_ptr_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/extern_func_ptr_fail.c", 14, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/extern_func_ptr_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
