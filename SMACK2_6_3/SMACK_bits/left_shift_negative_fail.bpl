...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/left_shift_negative_fail.c -bpl ./left_shift_negative_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/left_shift_negative_fail.c", 7, 11} true;
  ...
  assume {:sourceloc "test/c/bits/left_shift_negative_fail.c", 9, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/left_shift_negative_fail.c", 10, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/left_shift_negative_fail.c:10:12: warning: over-approximating bitwise operation shl; */
  $i2 := $shl.i32($i0, 0);
  assume {:sourceloc "test/c/bits/left_shift_negative_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
