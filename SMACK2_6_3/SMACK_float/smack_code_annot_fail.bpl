...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/smack_code_annot_fail.c -bpl ./smack_code_annot_fail.bpl
...
const f32_to_f64: ref;
axiom (f32_to_f64 == $sub.ref(0, 1032));
procedure {:inline 1} f32_to_f64($f0: float)
  returns ($r: float)
{
  var $f1: float;
  var $f2: float;
$bb0:
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 6, 16} true;
  assume {:verifier.code 1} true;
  call {:cexpr "f32_to_f64:arg:x"} boogie_si_record_float($f0);
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 6, 16} true;
  assume {:verifier.code 1} true;
  call $f1 := __VERIFIER_nondet_double();
  call {:cexpr "smack:ext:__VERIFIER_nondet_double"} boogie_si_record_float($f1);
  call {:cexpr "ret"} boogie_si_record_float($f1);
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 7, 63} true;
  assume {:verifier.code 1} true;
  $f2 := $fpext.float.float($f0);
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 7, 3} true;
  assume {:verifier.code 1} true;
  $f1 := $fpext.bvfloat.bvdouble(RNE, $f0);
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 8, 3} true;
...
procedure {:inline 1} __SMACK_code.ref.float.float($p0: ref, p.1: float, p.2: float);
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $f0 := f32_to_f64($fp(2, 0, 0));
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i1 := (if $fune.float.bool($f0, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/smack_code_annot_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
