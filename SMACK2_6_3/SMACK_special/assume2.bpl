...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/special/assume2.c -bpl ./assume2.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/special/assume2.c", 7, 20} true;
  ...
  assume {:sourceloc "test/c/special/assume2.c", 10, 23} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume2.c:10:23: warning: over-approximating bitwise operation xor; */
  $i1 := $xor.i32($i0, $i0);
  assume {:sourceloc "test/c/special/assume2.c", 10, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "test/c/special/assume2.c", 10, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/special/assume2.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/special/assume2.c", 11, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume2.c:11:3: warning: over-approximating bitwise operation xor; */
  $i3 := $xor.i32($i0, $i0);
  assume {:sourceloc "test/c/special/assume2.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 1);
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/special/assume2.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
