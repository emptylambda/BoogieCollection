...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/remainderf_fail.c -bpl ./remainderf_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 11, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $f0 := remainderf($fp(2, 0, 0), $fp(4, 0, 0));
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $f2 := remainderf($fp(2, 0, 0), $fp(4, 0, 0));
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i3 := (if $foeq.float.bool($f2, $fp(-2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $f4 := remainderf($fp(2, 0, 0), $fp(4, 0, 0));
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i5 := (if $foeq.float.bool($f4, $fp(-2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 15, 13} true;
  assume {:verifier.code 1} true;
  call $f6 := __VERIFIER_nondet_float();
  call {:cexpr "smack:ext:__VERIFIER_nondet_float"} boogie_si_record_float($f6);
  call {:cexpr "x"} boogie_si_record_float($f6);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 16, 13} true;
  assume {:verifier.code 1} true;
  call $f7 := __VERIFIER_nondet_float();
  call {:cexpr "smack:ext:__VERIFIER_nondet_float"} boogie_si_record_float($f7);
  call {:cexpr "y"} boogie_si_record_float($f7);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 18, 8} true;
  assume {:verifier.code 0} true;
  call $i8 := __isnanf($f7);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 18, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 23, 8} true;
  assume {:verifier.code 0} true;
  call $i16 := __isnanf($f6);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $ne.i32($i16, 0);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 23, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb29, $bb31;
$bb18:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 19, 5} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb19:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 19, 5} true;
  assume {:verifier.code 0} true;
  call $f10 := remainderf($fp(0, 7, 0), $f7);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 19, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := __isnanf($f10);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 19, 5} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.i32($i11, 0);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 19, 5} true;
...
$bb22:
  ...
  goto $bb21;
$bb23:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 20, 5} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb24:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 20, 5} true;
  assume {:verifier.code 0} true;
  call $f13 := remainderf($fp(0, 0, 0), $f7);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 20, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := __isnanf($f13);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 20, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $ne.i32($i14, 0);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 20, 5} true;
...
$bb27:
  ...
  goto $bb26;
$bb28:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb29:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 23, 7} true;
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb42;
$bb31:
  assume !(($i17 == 1));
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 24, 5} true;
  assume {:verifier.code 0} true;
  goto $bb32;
$bb32:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $f18 := remainderf($f6, $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call $i19 := __isnanf($f18);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 24, 5} true;
  assume {:verifier.code 0} true;
  $i20 := $ne.i32($i19, 0);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 24, 5} true;
...
$bb35:
  ...
  goto $bb34;
$bb36:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 25, 5} true;
  assume {:verifier.code 0} true;
  goto $bb37;
$bb37:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $f21 := remainderf($f6, $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 25, 5} true;
  assume {:verifier.code 0} true;
  call $i22 := __isnanf($f21);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i22, 0);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 25, 5} true;
...
$bb40:
  ...
  goto $bb39;
$bb41:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb30;
$bb42:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $f24 := remainderf($fp(0, 7, 8000000000000), $f7);
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
...
$bb45:
  ...
  goto $bb44;
$bb46:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  goto $bb47;
$bb47:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call $f27 := remainderf($f6, $fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
...
$bb50:
  ...
  goto $bb49;
$bb51:
  assume {:sourceloc "test/c/mathc/remainderf_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const remainderf: ref;
axiom (remainderf == $sub.ref(0, 2064));
procedure {:inline 1} remainderf($f0: float, $f1: float)
  returns ($r: float);
