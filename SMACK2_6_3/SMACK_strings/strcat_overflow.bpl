...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strcat_overflow.c -bpl ./strcat_overflow.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 26819));
...
const {:count 3} __const.main.notLong: ref;
axiom (__const.main.notLong == $sub.ref(0, 1027));
const .str: ref;
axiom (.str == $sub.ref(0, 2054));
const {:count 5} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 3083));
const main: ref;
axiom (main == $sub.ref(0, 4115));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(3, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 8, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const.main.notLong, 3, false);
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 10, 29} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 3)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 10, 22} true;
  assume {:verifier.code 0} true;
  call $p3 := strcat($p2, .str);
  assume $isExternal($p3);
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := strcmp($p3, .str.1);
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strcat_overflow.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 5147));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.memcpy.p0i8.p0i8.i64: ref;
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0, 6179));
procedure {:inline 1} llvm.memcpy.p0i8.p0i8.i64($p0: ref, $p1: ref, $i2: i64, $i3: i1);
const strcat: ref;
axiom (strcat == $sub.ref(0, 7211));
procedure {:inline 1} strcat($p0: ref, $p1: ref)
  returns ($r: ref);
const strcmp: ref;
axiom (strcmp == $sub.ref(0, 8243));
procedure {:inline 1} strcmp($p0: ref, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 9275));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 10307));
...
axiom (__SMACK_dummy == $sub.ref(0, 11339));
...
axiom (__VERIFIER_assert == $sub.ref(0, 12371));
...
axiom (__SMACK_and32 == $sub.ref(0, 13403));
...
axiom (__SMACK_and64 == $sub.ref(0, 14435));
...
axiom (__SMACK_and16 == $sub.ref(0, 15467));
...
axiom (__SMACK_and8 == $sub.ref(0, 16499));
...
axiom (__SMACK_or32 == $sub.ref(0, 17531));
...
axiom (__SMACK_or64 == $sub.ref(0, 18563));
...
axiom (__SMACK_or16 == $sub.ref(0, 19595));
...
axiom (__SMACK_or8 == $sub.ref(0, 20627));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 21659));
...
axiom (__SMACK_decls == $sub.ref(0, 22691));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 23723));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 24755));
...
axiom (llvm.dbg.value == $sub.ref(0, 25787));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 26819));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i8($M.0, __const.main.notLong, 83);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.notLong, $mul.ref(0, 3)), $mul.ref(1, 1)), 111);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.notLong, $mul.ref(0, 3)), $mul.ref(2, 1)), 0);
  $exn := false;
  return;
}
