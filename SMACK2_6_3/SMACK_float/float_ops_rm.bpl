...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/float_ops_rm.c -bpl ./float_ops_rm.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/float_ops_rm.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/float/float_ops_rm.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call $i0 := fesetround(2048);
  assume {:sourceloc "test/c/float/float_ops_rm.c", 9, 13} true;
  assume {:verifier.code 0} true;
  $f1 := $fptrunc.float.float($fp(0, 3, 0));
  call {:cexpr "f"} boogie_si_record_float($f1);
  assume {:sourceloc "test/c/float/float_ops_rm.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/float_ops_rm.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/float_ops_rm.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
