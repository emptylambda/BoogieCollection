...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/pointers7_fail.c -bpl ./pointers7_fail.bpl
...
const __const.main.x: ref;
axiom (__const.main.x == $sub.ref(0, 1032));
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 15, 12} true;
  ...
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 15, 12} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const.main.x, 8, false);
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 16, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, 2);
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p3, $mul.ref(1, 1));
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p5, 20);
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 19, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/pointers7_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
{
$bb0:
  $M.0 := $store.i32($M.0, __const.main.x, 10);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(__const.main.x, $mul.ref(0, 8)), $mul.ref(4, 1)), 20);
  $exn := false;
  return;
}
