...
procedure CheckWellformed$$ITER__E.RecursiveIterator.__ctor(this: ref
       where this != null
         && 
...
implementation CheckWellformed$$ITER__E.RecursiveIterator.__ctor(this: ref, cell#0: ref, n#0: int, r#0: ref, good#0: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;

    // AddMethodImpl: _ctor, CheckWellformed$$ITER__E.RecursiveIterator.__ctor
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(334,11): initial state"} true;
    assume cell#0 != null;
    assume r#0 != null;
    havoc $Heap;
    assume (forall $o: ref :: 
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(334,29): post-state"} true;
    assume ITER__E.RecursiveIterator.cell(this) == cell#0;
    assume ITER__E.RecursiveIterator.n(this) == n#0;
    assume ITER__E.RecursiveIterator.r(this) == r#0;
    assume ITER__E.RecursiveIterator.good(this) == good#0;
    assume ITER__E.RecursiveIterator.Valid#canCall($Heap, this);
    assume ITER__E.RecursiveIterator.Valid($Heap, this);
    assume Set#Equal(ITER__E.RecursiveIterator.__reads(this), Set#Empty(): Set Box);
    assume Set#Equal(ITER__E.RecursiveIterator.__modifies(this), 
      Set#UnionOne(Set#Empty(): Set Box, $Box(cell#0)));
    assume Set#Equal(read($Heap, this, ITER__E.RecursiveIterator.__new), Set#Empty(): Set Box);
    assert cell#0 != null;
    assert $IsAlloc(cell#0, Tclass.ITER__E.Cell?(), old($Heap));
    if (read(old($Heap), cell#0, ITER__E.Cell.data) < 2)
    {
    }
    else
    {
    ...
    assume ITER__E.RecursiveIterator.__decreases0(this)
       == (if read(old($Heap), cell#0, ITER__E.Cell.data) < 2
         then n#0
         else n#0 + n#0 - n#0);
}
...
procedure Call$$ITER__E.RecursiveIterator.__ctor(cell#0: ref
       where $Is(cell#0, Tclass.ITER__E.Cell?())
         && $IsAlloc(cell#0, Tclass.ITER__E.Cell?(), $Heap), 
    n#0: int where LitInt(0) <= n#0, 
    r#0: ref
  ...
  free ensures true;
  ensures ITER__E.RecursiveIterator.cell(this) == cell#0;
  free ensures true;
  ensures ITER__E.RecursiveIterator.n(this) == n#0;
  free ensures true;
  ensures ITER__E.RecursiveIterator.r(this) == r#0;
  free ensures true;
  ensures ITER__E.RecursiveIterator.good(this) == good#0;
  free ensures ITER__E.RecursiveIterator.Valid#canCall($Heap, this);
  ensures ITER__E.RecursiveIterator.Valid($Heap, this);
  free ensures true;
  ensures Set#Equal(ITER__E.RecursiveIterator.__reads(this), Set#Empty(): Set Box);
  free ensures true;
  ensures Set#Equal(ITER__E.RecursiveIterator.__modifies(this), 
    Set#UnionOne(Set#Empty(): Set Box, $Box(cell#0)));
  free ensures true;
  ensures Set#Equal(read($Heap, this, ITER__E.RecursiveIterator.__new), Set#Empty(): Set Box);
  free ensures true;
  ensures ITER__E.RecursiveIterator.__decreases0(this)
     == (if read(old($Heap), cell#0, ITER__E.Cell.data) < 2
       then n#0
       else n#0 + n#0 - n#0);
...
procedure CheckWellformed$$ITER__E.RecursiveIterator.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__E.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__E.RecursiveIterator(), $Heap));
...
implementation CheckWellformed$$ITER__E.RecursiveIterator.Valid(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b$reqreads#0: bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> $o == this
           || ITER__E.RecursiveIterator.__reads(this)[$Box($o)]
           || read($Heap, this, ITER__E.RecursiveIterator.__new)[$Box($o)]);
    b$reqreads#0 := $_Frame[this, ITER__E.RecursiveIterator.__new];
    assert b$reqreads#0;
    if (*)
    {
        assume false;
...
procedure Call$$ITER__E.RecursiveIterator.MoveNext(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__E.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__E.RecursiveIterator(), $Heap))
   returns (more#0: bool);
  // user-defined preconditions
  requires ITER__E.RecursiveIterator.Valid($Heap, this);
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
  ensures (forall $o: ref :: 
    ...
    read($Heap, this, ITER__E.RecursiveIterator.__new)[$Box($o)]
         && !read(old($Heap), this, ITER__E.RecursiveIterator.__new)[$Box($o)]
       ==> $o != null && !read(old($Heap), $o, alloc));
  free ensures true;
  ensures !read($Heap, this, ITER__E.RecursiveIterator.__new)[$Box(null)];
  free ensures more#0 ==> ITER__E.RecursiveIterator.Valid#canCall($Heap, this);
  ensures more#0 ==> ITER__E.RecursiveIterator.Valid($Heap, this);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && read(old($Heap), $o, alloc)
       ==> $Heap[$o] == old($Heap)[$o]
         || 
        $o == this
         || ITER__E.RecursiveIterator.__modifies(this)[$Box($o)]
         || read(old($Heap), this, ITER__E.RecursiveIterator.__new)[$Box($o)]);
  // boilerplate
  free ensures $HeapSucc(old($Heap), $Heap);
...
implementation CheckWellformed$$ITER__E.RecursiveIterator(this: ref, cell#0: ref, n#0: int, r#0: ref, good#0: bool)
{
  var $_OldIterHeap: Heap;
    ...
    assume r#0 != null;
    assert cell#0 != null;
    if (read($Heap, cell#0, ITER__E.Cell.data) < 2)
    {
    }
    else
    {
    ...
    call $IterHavoc0(this, ITER__E.RecursiveIterator.__reads(this), ITER__E.RecursiveIterator.__modifies(this));
    assume ITER__E.RecursiveIterator.Valid($Heap, this);
    $_OldIterHeap := $Heap;
    call $IterHavoc1(this, ITER__E.RecursiveIterator.__modifies(this), read($Heap, this, ITER__E.RecursiveIterator.__new));
    assume (forall $o: ref :: 
      { read($_OldIterHeap, $o, alloc) } 
      read($Heap, this, ITER__E.RecursiveIterator.__new)[$Box($o)]
           && !read($_OldIterHeap, this, ITER__E.RecursiveIterator.__new)[$Box($o)]
...
procedure Impl$$ITER__E.RecursiveIterator(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__E.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__E.RecursiveIterator(), $Heap), 
...
implementation Impl$$ITER__E.RecursiveIterator(this: ref, cell#0: ref, n#0: int, r#0: ref, good#0: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var _yieldCount#0: int where true;
  var $_OldIterHeap: Heap
     where $IsGoodHeap($_OldIterHeap) && $HeapSucc($_OldIterHeap, $Heap);
  var $initHeapCallStmt#1_0: Heap;
  var n##0: int;
  var $iter_newUpdate1_0: Set Box;
  var $initHeapCallStmt#0: Heap;
  var n##1: int;
  var $iter_newUpdate0: Set Box;

    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> $o == this || $o == cell#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(334,11): initial state"} true;
    assume cell#0 != null && r#0 != null;
    assume ITER__E.RecursiveIterator.cell(this) == cell#0;
    assume ITER__E.RecursiveIterator.n(this) == n#0;
    assume ITER__E.RecursiveIterator.r(this) == r#0;
    assume ITER__E.RecursiveIterator.good(this) == good#0;
    ...
    call $YieldHavoc(this, ITER__E.RecursiveIterator.__reads(this), read($Heap, this, ITER__E.RecursiveIterator.__new));
    $_OldIterHeap := $Heap;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(339,5)
    assume true;
    if (ITER__E.RecursiveIterator.n(this) == LitInt(0))
    {
    }
    else
    {
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(340,12)
        assume true;
        if (ITER__E.RecursiveIterator.good(this))
        {
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(341,10)
            $initHeapCallStmt#1_0 := $Heap;
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert ITER__E.RecursiveIterator.r(this) != null;
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert $Is(ITER__E.RecursiveIterator.n(this) - 1, Tclass._System.nat());
            n##0 := ITER__E.RecursiveIterator.n(this) - 1;
            ...
            call Call$$ITER__E.RecIterCaller.M(ITER__E.RecursiveIterator.r(this), n##0);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate1_0 := $IterCollectNewObjects($initHeapCallStmt#1_0, $Heap, this, ITER__E.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__E.RecursiveIterator.__new, $iter_newUpdate1_0);
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(341,16)"} true;
        }
        else
        {
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(343,10)
            ...
            // ProcessCallStmt: CheckSubrange
            assert $Is(ITER__E.RecursiveIterator.n(this) + 1, Tclass._System.nat());
            n##1 := ITER__E.RecursiveIterator.n(this) + 1;
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assert 0
                 <= (if read(old($Heap), cell#0, ITER__E.Cell.data) < 2
                   then n#0
            ...
            // ProcessCallStmt: Make the call
            call Call$$ITER__E.RecIterCaller.M(ITER__E.RecursiveIterator.r(this), n##1);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate0 := $IterCollectNewObjects($initHeapCallStmt#0, $Heap, this, ITER__E.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__E.RecursiveIterator.__new, $iter_newUpdate0);
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(343,16)"} true;
        }
    }
}
...
procedure CheckWellformed$$ITER__E.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__E.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__E.RecIterCaller(), $Heap), 
    n#0: int where LitInt(0) <= n#0);
...
procedure Call$$ITER__E.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__E.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__E.RecIterCaller(), $Heap), 
...
procedure Impl$$ITER__E.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__E.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__E.RecIterCaller(), $Heap), 
...
implementation Impl$$ITER__E.RecIterCaller.M(this: ref, n#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var good#0: bool;
  var cell#0: ref
  ...
  var $nw: ref;
  var iter#0: ref
     where $Is(iter#0, Tclass.ITER__E.RecursiveIterator())
       && $IsAlloc(iter#0, Tclass.ITER__E.RecursiveIterator(), $Heap);
  var cell##0: ref;
  var n##0: int;
  var r##0: ref;
  var good##0: bool;
  ...
  var $rhs##0: bool;
    ...
    // AddMethodImpl: M, Impl$$ITER__E.RecIterCaller.M
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(349,4): initial state"} true;
    $_reverifyPost := false;
    havoc good#0;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(351,16)
    assume true;
    havoc $nw;
    assume $nw != null && dtype($nw) == Tclass.ITER__E.Cell?();
    assume !read($Heap, $nw, alloc);
    $Heap := update($Heap, $nw, alloc, true);
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    cell#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(351,26)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(352,16)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(352,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    cell##0 := cell#0;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$ITER__E.RecursiveIterator.__ctor(cell##0, n##0, r##0, good##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(352,60)"} true;
    iter#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(352,60)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(353,32)
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
           ...
           && (
            $o == iter#0
             || ITER__E.RecursiveIterator.__modifies(iter#0)[$Box($o)]
             || read($Heap, iter#0, ITER__E.RecursiveIterator.__new)[$Box($o)])
         ==> $_Frame[$o, $f]);
    assert 0 <= n#0 || ITER__E.RecursiveIterator.__decreases0(iter#0) == n#0;
    assert ITER__E.RecursiveIterator.__decreases0(iter#0) < n#0;
    // ProcessCallStmt: Make the call
    call $rhs##0 := Call$$ITER__E.RecursiveIterator.MoveNext(iter#0);
    // TrCallStmt: After ProcessCallStmt
    more#0 := $rhs##0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(353,33)"} true;
}
