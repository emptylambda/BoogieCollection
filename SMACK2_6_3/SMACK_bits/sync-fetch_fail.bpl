...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/sync-fetch_fail.c -bpl ./sync-fetch_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 6, 7} true;
  ...
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, $p0);
  $M.0 := $store.i32($M.0, $p0, $add.i32($load.i32($M.0, $p0), 1));
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p0);
  $M.0 := $store.i32($M.0, $p0, $sub.i32($load.i32($M.0, $p0), 1));
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, $p0);
  $M.0 := $store.i32($M.0, $p0, $or.i32($load.i32($M.0, $p0), 1));
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p0);
  $M.0 := $store.i32($M.0, $p0, $and.i32($load.i32($M.0, $p0), 2));
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p0);
  $M.0 := $store.i32($M.0, $p0, $xor.i32($load.i32($M.0, $p0), 999));
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p0);
  $M.0 := $store.i32($M.0, $p0, $nand.i32($load.i32($M.0, $p0), 2));
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 13, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.0, $p0);
  assume {:sourceloc "test/c/bits/sync-fetch_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $exn := false;
  return;
