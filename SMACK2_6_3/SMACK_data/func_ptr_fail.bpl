...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/func_ptr_fail.c -bpl ./func_ptr_fail.bpl
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 5, 26} true;
  ...
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 5, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 7, 26} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 7, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 13, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 13, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $sgt.i32(1, 0);
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i0} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i0 == 1);
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $p1 := incr;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  call $i2 := devirtbounce($p1, 1);
  call {:cexpr "x"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 20, 3} true;
...
$bb9:
  ...
  goto $bb6;
$bb10:
  assume {:sourceloc "test/c/data/func_ptr_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
