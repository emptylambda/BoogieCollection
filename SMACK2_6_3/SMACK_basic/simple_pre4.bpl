...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/simple_pre4.c -bpl ./simple_pre4.bpl
  ...
  returns ($r: i16)
{
  var $i1: i16;
$bb0:
  assume {:sourceloc "test/c/basic/simple_pre4.c", 7, 30} true;
  ...
  assume {:sourceloc "test/c/basic/simple_pre4.c", 7, 23} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/simple_pre4.c", 13, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/simple_pre4.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/simple_pre4.c", 14, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/simple_pre4.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i16.i32($i0);
  assume {:sourceloc "test/c/basic/simple_pre4.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
