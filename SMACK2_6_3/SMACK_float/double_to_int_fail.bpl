...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/double_to_int_fail.c -bpl ./double_to_int_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/double_to_int_fail.c", 8, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/float/double_to_int_fail.c", 8, 11} true;
  assume {:verifier.code 0} true;
  $i0 := $fp2si.float.i32($fp(1, 500000, 0));
  call {:cexpr "y"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/float/double_to_int_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/double_to_int_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/double_to_int_fail.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
