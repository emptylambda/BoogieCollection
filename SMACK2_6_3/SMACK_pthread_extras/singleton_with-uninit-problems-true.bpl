...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/singleton_with-uninit-problems-true.c -bpl ./singleton_with-uninit-problems-true.bpl
...
const thread1: ref;
axiom (thread1 == $sub.ref(0, 2064));
procedure {:inline 1} thread1($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 11, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 11, 7} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(1);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 11, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := $p1;
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $p2: ref;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 16, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $M.0;
  ...
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p2, 88);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const thread3: ref;
axiom (thread3 == $sub.ref(0, 6192));
procedure {:inline 1} thread3($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 21, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $M.0;
  ...
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p2, 89);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
const thread0: ref;
axiom (thread0 == $sub.ref(0, 7224));
procedure {:inline 1} thread0($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
  ...
  var $i20: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 28, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 29, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.2, $p1);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p2, $0.ref, thread2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 31, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_create($p3, $0.ref, thread3, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 32, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p4, $0.ref, thread2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 33, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_create($p5, $0.ref, thread2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 34, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i32($M.3, $p2);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_join($i13, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 35, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.4, $p3);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $i16 := pthread_join($i15, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 36, 16} true;
  assume {:verifier.code 0} true;
  $i17 := $load.i32($M.5, $p4);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i18 := pthread_join($i17, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 37, 16} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.6, $p5);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 37, 3} true;
  assume {:verifier.code 0} true;
  call $i20 := pthread_join($i19, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 45, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 46, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.7, $p0);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 46, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 48, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 48, 3} true;
...
$bb6:
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "test/c/pthread_extras/singleton_with-uninit-problems-true.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 13416));
...
axiom (__VERIFIER_assert == $sub.ref(0, 14448));
...
axiom (__SMACK_decls == $sub.ref(0, 24768));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 25800));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 26832));
...
axiom (llvm.dbg.value == $sub.ref(0, 27864));
