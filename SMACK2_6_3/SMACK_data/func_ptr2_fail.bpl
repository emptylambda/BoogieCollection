...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/func_ptr2_fail.c -bpl ./func_ptr2_fail.bpl
...
const dll_create_generic: ref;
axiom (dll_create_generic == $sub.ref(0, 1032));
procedure {:inline 1} dll_create_generic($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 7, 8} true;
  ...
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p0);
  call devirtbounce($p2, $p1);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 9, 10} true;
  assume {:verifier.code 0} true;
  $p3 := $load.ref($M.0, $p1);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $r := $p3;
  $exn := false;
  return;
...
const dll_insert_master: ref;
axiom (dll_insert_master == $sub.ref(0, 3096));
procedure {:inline 1} dll_insert_master($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 13, 17} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 13, 17} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(4);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p0, $p1);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 14, 4} true;
  assume {:verifier.code 0} true;
  $p3 := $load.ref($M.0, $p0);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p3, 10);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
const dll_create_master: ref;
axiom (dll_create_master == $sub.ref(0, 5160));
procedure {:inline 1} dll_create_master()
  returns ($r: ref)
{
  var $p0: ref;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 17, 39} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 17, 39} true;
  assume {:verifier.code 0} true;
  call $p0 := dll_create_generic(dll_insert_master);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 17, 32} true;
  assume {:verifier.code 0} true;
  $r := $p0;
  $exn := false;
  return;
}
const inspect_base: ref;
axiom (inspect_base == $sub.ref(0, 6192));
procedure {:inline 1} inspect_base($p0: ref)
{
  var $i1: i32;
  var $i2: i1;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 19, 31} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 19, 31} true;
  assume {:verifier.code 0} true;
  goto $bb1;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 19, 51} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const inspect_init: ref;
axiom (inspect_init == $sub.ref(0, 7224));
procedure {:inline 1} inspect_init($p0: ref)
{
$bb0:
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 21, 31} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 21, 31} true;
  assume {:verifier.code 0} true;
  call inspect_base($p0);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 21, 50} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 8256));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 24, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 24, 14} true;
  assume {:verifier.code 0} true;
  call $p0 := dll_create_master();
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call inspect_init($p0);
  assume {:sourceloc "test/c/data/func_ptr2_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (devirtbounce == $sub.ref(0, 27864));
procedure {:inline 1} devirtbounce(funcPtr: ref, arg: ref)
{
  var $p0: ref;
  var $i1: i1;
$bb0:
  ...
  goto $bb1;
$bb1:
  $i1 := $eq.ref(dll_insert_master, $p0);
  assume {:branchcond $i1} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i1 == 1);
  call dll_insert_master(arg);
  $exn := false;
  return;
$bb3:
  assume !(($i1 == 1));
