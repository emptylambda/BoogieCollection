// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Matrix-OOB.dfy -print:./Matrix-OOB.bpl
...
procedure CheckWellformed$$_module.__default.M(m#0: ref
...
implementation CheckWellformed$$_module.__default.M(m#0: ref)
{
  ...
  var j#0: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Matrix-OOB.dfy(10,7): initial state"} true;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && read(old($Heap), $o, alloc) ==> $Heap[$o] == old($Heap)[$o]);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Matrix-OOB.dfy(11,10): post-state"} true;
    havoc i#0;
    havoc j#0;
    assume true;
    assert m#0 != null;
...
procedure Call$$_module.__default.M(m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap));
  modifies $Heap, $Tick;
...
procedure Impl$$_module.__default.M(m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap))
...
implementation Impl$$_module.__default.M(m#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Matrix-OOB.dfy(12,0): initial state"} true;
    $_reverifyPost := false;
}
