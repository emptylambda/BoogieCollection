...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/func_ptr1_fail.c -bpl ./func_ptr1_fail.bpl
...
procedure {:inline 1} incr($p0: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 6, 25} true;
  ...
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 6, 29} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const decr: ref;
axiom (decr == $sub.ref(0, 2064));
procedure {:inline 1} decr($p0: ref)
{
  var $i1: i32;
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 8, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 8, 25} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, $p0);
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, $i2);
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 8, 29} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 12, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 12, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 15, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32(1, 0);
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 16, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $p3 := incr;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  call devirtbounce($p3, $p1);
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 23, 3} true;
...
$bb9:
  ...
  goto $bb6;
$bb10:
  assume {:sourceloc "test/c/data/func_ptr1_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (devirtbounce == $sub.ref(0, 23736));
