...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/while3.c -bpl ./while3.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/while3.c", 5, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/reach/while3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/while3.c", 5, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 1);
  assume {:sourceloc "test/c/reach/while3.c", 5, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/reach/while3.c", 6, 6} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/reach/while3.c", 7, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i0, 1);
  assume {:sourceloc "test/c/reach/while3.c", 7, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/reach/while3.c", 8, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, 1);
  goto $bb6;
$bb5:
...
$bb6:
  assume {:sourceloc "test/c/reach/while3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/while3.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
