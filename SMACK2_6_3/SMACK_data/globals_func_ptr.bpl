...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/globals_func_ptr.c -bpl ./globals_func_ptr.bpl
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 19, 26} true;
  ...
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 19, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 21, 26} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 21, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 32, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 32, 15} true;
  assume {:verifier.code 0} true;
  $p0 := $M.0;
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 32, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 35, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/globals_func_ptr.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
