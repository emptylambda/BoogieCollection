...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock2_fail.c -bpl ./lock2_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 27876));
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 14, 4} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 14, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, t1, $0.ref);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 25, 4} true;
  assume {:verifier.code 0} true;
  $i5 := $M.0;
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 25, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 27, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 28, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.2, $p1);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 29, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lock2_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 12396));
...
axiom (__VERIFIER_assert == $sub.ref(0, 13428));
...
axiom (__SMACK_and32 == $sub.ref(0, 14460));
...
axiom (__SMACK_and64 == $sub.ref(0, 15492));
...
axiom (__SMACK_and16 == $sub.ref(0, 16524));
...
axiom (__SMACK_and8 == $sub.ref(0, 17556));
...
axiom (__SMACK_or32 == $sub.ref(0, 18588));
...
axiom (__SMACK_or64 == $sub.ref(0, 19620));
...
axiom (__SMACK_or16 == $sub.ref(0, 20652));
...
axiom (__SMACK_or8 == $sub.ref(0, 21684));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 22716));
...
axiom (__SMACK_decls == $sub.ref(0, 23748));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 24780));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 25812));
...
axiom (llvm.dbg.value == $sub.ref(0, 26844));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 27876));
