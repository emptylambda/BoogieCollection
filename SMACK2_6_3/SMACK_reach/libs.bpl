...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/libs.c -bpl ./libs.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 20642));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/libs.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/reach/libs.c", 4, 14} true;
  assume {:verifier.code 0} true;
  call $i0 := printf.ref(.str);
  assume {:sourceloc "test/c/reach/libs.c", 4, 36} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 6194));
...
axiom (__SMACK_and32 == $sub.ref(0, 7226));
...
axiom (__SMACK_and64 == $sub.ref(0, 8258));
...
axiom (__SMACK_and16 == $sub.ref(0, 9290));
...
axiom (__SMACK_and8 == $sub.ref(0, 10322));
...
axiom (__SMACK_or32 == $sub.ref(0, 11354));
...
axiom (__SMACK_or64 == $sub.ref(0, 12386));
...
axiom (__SMACK_or16 == $sub.ref(0, 13418));
...
axiom (__SMACK_or8 == $sub.ref(0, 14450));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 15482));
...
axiom (__SMACK_decls == $sub.ref(0, 16514));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 17546));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 18578));
...
axiom (llvm.dbg.value == $sub.ref(0, 19610));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 20642));
