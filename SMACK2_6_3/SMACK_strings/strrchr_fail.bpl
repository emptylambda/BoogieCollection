...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strrchr_fail.c -bpl ./strrchr_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 23729));
...
axiom (.str.1 == $sub.ref(0, 2057));
const main: ref;
axiom (main == $sub.ref(0, 3089));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strrchr_fail.c", 8, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strrchr_fail.c", 8, 17} true;
  assume {:verifier.code 0} true;
  call $p0 := strrchr(.str, 46);
  assume $isExternal($p0);
  assume {:sourceloc "test/c/strings/strrchr_fail.c", 8, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $p2i.ref.i8($p0);
  call {:cexpr "dotCom"} boogie_si_record_i8($i1);
  assume {:sourceloc "test/c/strings/strrchr_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strrchr_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strrchr_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strrchr: ref;
axiom (strrchr == $sub.ref(0, 4121));
procedure {:inline 1} strrchr($p0: ref, $i1: i32)
  returns ($r: ref);
const strcmp: ref;
axiom (strcmp == $sub.ref(0, 5153));
procedure {:inline 1} strcmp($p0: ref, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 6185));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 7217));
...
axiom (__SMACK_dummy == $sub.ref(0, 8249));
...
axiom (__VERIFIER_assert == $sub.ref(0, 9281));
...
axiom (__SMACK_and32 == $sub.ref(0, 10313));
...
axiom (__SMACK_and64 == $sub.ref(0, 11345));
...
axiom (__SMACK_and16 == $sub.ref(0, 12377));
...
axiom (__SMACK_and8 == $sub.ref(0, 13409));
...
axiom (__SMACK_or32 == $sub.ref(0, 14441));
...
axiom (__SMACK_or64 == $sub.ref(0, 15473));
...
axiom (__SMACK_or16 == $sub.ref(0, 16505));
...
axiom (__SMACK_or8 == $sub.ref(0, 17537));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18569));
...
axiom (__SMACK_decls == $sub.ref(0, 19601));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 20633));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21665));
...
axiom (llvm.dbg.value == $sub.ref(0, 22697));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 23729));
