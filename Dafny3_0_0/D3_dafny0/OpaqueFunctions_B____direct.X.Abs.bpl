...
procedure CheckWellformed$$B____direct.X.Abs.C.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.B____direct.X.Abs.C())
         && $IsAlloc(this, Tclass.B____direct.X.Abs.C(), $Heap));
  ...
  ensures B____direct.X.Abs.C.Valid($Heap, this)
     ==> LitInt(0) <= read($Heap, this, B____direct.X.Abs.C.x);
  ensures read($Heap, this, B____direct.X.Abs.C.x) == LitInt(8)
     ==> B____direct.X.Abs.C.Valid($Heap, this);



implementation CheckWellformed$$B____direct.X.Abs.C.Valid(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    if (*)
    {
        if (*)
        {
            assert this == this
               || (Set#Subset(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), 
                 ...
                 && !Set#Subset(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), 
                  Set#UnionOne(Set#Empty(): Set Box, $Box(this))));
            assume this == this || B____direct.X.Abs.C.Valid#canCall($Heap, this);
            assume B____direct.X.Abs.C.Valid($Heap, this);
            assume LitInt(0) <= read($Heap, this, B____direct.X.Abs.C.x);
        }
        else
        {
            assume B____direct.X.Abs.C.Valid($Heap, this)
        ...
        if (*)
        {
            assume read($Heap, this, B____direct.X.Abs.C.x) == LitInt(8);
            assert this == this
               || (Set#Subset(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), 
                  Set#UnionOne(Set#Empty(): Set Box, $Box(this)))
                 && !Set#Subset(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), 
...
procedure CheckWellformed$$B____direct.X.Abs.C.RevealedValid(this: ref
       where this != null
         && 
        $Is(this, Tclass.B____direct.X.Abs.C())
         && $IsAlloc(this, Tclass.B____direct.X.Abs.C(), $Heap));
...
implementation CheckWellformed$$B____direct.X.Abs.C.RevealedValid(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var b$reqreads#0: bool;
    ...
    if (*)
    {
        if (*)
        {
            assume B____direct.X.Abs.C.Valid#canCall($Heap, this);
            assume B____direct.X.Abs.C.Valid($Heap, this);
            assume LitInt(0) <= read($Heap, this, B____direct.X.Abs.C.x);
        }
        else
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> $o == this);
        b$reqreads#0 := $_Frame[this, B____direct.X.Abs.C.x];
        assume B____direct.X.Abs.C.RevealedValid($Heap, this)
           == 
          (read($Heap, this, B____direct.X.Abs.C.x)
           == LitInt(8));
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(B____direct.X.Abs.C.RevealedValid($Heap, this), TBool);
        assert b$reqreads#0;
    }
}
...
procedure CheckWellformed$$B____direct.X.Abs.C.N(this: ref
       where this != null
         && 
        $Is(this, Tclass.B____direct.X.Abs.C())
         && $IsAlloc(this, Tclass.B____direct.X.Abs.C(), $Heap));
...
procedure Call$$B____direct.X.Abs.C.N(this: ref
       where this != null
         && 
        $Is(this, Tclass.B____direct.X.Abs.C())
         && $IsAlloc(this, Tclass.B____direct.X.Abs.C(), $Heap));
...
procedure CheckWellformed$$B____direct.X.Abs.C.Get(this: ref
       where this != null
         && 
        $Is(this, Tclass.B____direct.X.Abs.C())
         && $IsAlloc(this, Tclass.B____direct.X.Abs.C(), $Heap));
