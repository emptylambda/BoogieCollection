...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/nested_struct1_fail.c -bpl ./nested_struct1_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 24, 8} true;
  ...
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 1);
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 2);
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1));
  $p5 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 26, 17} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p5, 100);
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 27, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 27, 13} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i16($M.2, $p6, 5);
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 28, 8} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1));
  $p8 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 28, 17} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i32($M.3, $p8, 200);
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 29, 5} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 29, 7} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.i32($M.4, $p9, 1000);
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 30, 7} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.i32($M.4, $p10, 2000);
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 31, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 31, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 31, 17} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.4, $p12, $p13, 8, false);
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1));
  $p22 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1));
  $p32 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb3;
$bb17:
  assume {:sourceloc "test/c/data/nested_struct1_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
