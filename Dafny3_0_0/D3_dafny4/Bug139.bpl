// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug139.dfy -print:./Bug139.bpl
...
procedure CheckWellformed$$_module.__default.R(xs#0: DatatypeType
...
procedure Call$$_module.__default.R(xs#0: DatatypeType
       where $Is(xs#0, Tclass._module.List())
         && $IsAlloc(xs#0, Tclass._module.List(), $Heap)
         && $IsA#_module.List(xs#0));
  modifies $Heap, $Tick;
...
procedure Impl$$_module.__default.R(xs#0: DatatypeType
       where $Is(xs#0, Tclass._module.List())
         && $IsAlloc(xs#0, Tclass._module.List(), $Heap)
         && $IsA#_module.List(xs#0))
          ...
          (var b#0 := LitInt(7); 
            (if _module.List.Nil_q(xs#0)
               then 0
                 ...
                 then (var a#1 := _module.List._h0(xs#0); LitInt(1))
                 else (var tail#0 := _module.List._h1(_module.List._h1(xs#0)); 
                  (var b#1 := _module.List._h0(_module.List._h1(xs#0)); 
                    (var x#0 := _module.List._h0(xs#0); LitInt(2)))))))));
          ...
          (var b#3 := LitInt(7); 
            (if _module.List.Nil_q(Lit(xs#0))
               then 0
                 ...
                 then (var a#4 := LitInt(_module.List._h0(Lit(xs#0))); LitInt(1))
                 else (var tail#2 := Lit(_module.List._h1(Lit(_module.List._h1(Lit(xs#0))))); 
                  (var b#4 := LitInt(_module.List._h0(Lit(_module.List._h1(Lit(xs#0))))); 
                    (var x#2 := LitInt(_module.List._h0(Lit(xs#0))); LitInt(2)))))))));

procedure CheckWellformed$$_module.__default.F(xs#0: DatatypeType where $Is(xs#0, Tclass._module.List()));
