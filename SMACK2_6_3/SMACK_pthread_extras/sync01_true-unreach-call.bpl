...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/sync01_true-unreach-call.c -bpl ./sync01_true-unreach-call.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 35100));
...
const num: ref;
axiom (num == $sub.ref(0, 2076));
const empty: ref;
axiom (empty == $sub.ref(0, 3108));
const full: ref;
axiom (full == $sub.ref(0, 4140));
const thread1: ref;
axiom (thread1 == $sub.ref(0, 5172));
procedure {:inline 1} thread1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i32;
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 14, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(m);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 16, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sgt.i32($i2, 0);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 16, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 17, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_cond_wait(empty, m);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 19, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 19, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_unlock(m);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_cond_signal(full);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 23, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 6204));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const pthread_mutex_lock: ref;
axiom (pthread_mutex_lock == $sub.ref(0, 7236));
procedure {:inline 1} pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_cond_wait: ref;
axiom (pthread_cond_wait == $sub.ref(0, 8268));
procedure {:inline 1} pthread_cond_wait($p0: ref, $p1: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 9300));
procedure {:inline 1} pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const pthread_cond_signal: ref;
axiom (pthread_cond_signal == $sub.ref(0, 10332));
procedure {:inline 1} pthread_cond_signal($p0: ref)
  returns ($r: i32);
const thread2: ref;
axiom (thread2 == $sub.ref(0, 11364));
procedure {:inline 1} thread2($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i32;
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 26, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(m);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 28, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 28, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 28, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 29, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_cond_wait(full, m);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 31, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 31, 6} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $i6;
  call {:cexpr "num"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 33, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_unlock(m);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_cond_signal(empty);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 41, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "num"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_init(m, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 44, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_cond_init(empty, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 45, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_cond_init(full, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 47, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p0, $0.ref, thread1, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 48, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p1, $0.ref, thread2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 50, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 51, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.2, $p1);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 51, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_join($i9, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 53, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 53, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread_extras/sync01_true-unreach-call.c", 55, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 19620));
...
axiom (__VERIFIER_assert == $sub.ref(0, 20652));
...
axiom (__SMACK_and32 == $sub.ref(0, 21684));
...
axiom (__SMACK_and64 == $sub.ref(0, 22716));
...
axiom (__SMACK_and16 == $sub.ref(0, 23748));
...
axiom (__SMACK_and8 == $sub.ref(0, 24780));
...
axiom (__SMACK_or32 == $sub.ref(0, 25812));
...
axiom (__SMACK_or64 == $sub.ref(0, 26844));
...
axiom (__SMACK_or16 == $sub.ref(0, 27876));
...
axiom (__SMACK_or8 == $sub.ref(0, 28908));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 29940));
...
axiom (__SMACK_decls == $sub.ref(0, 30972));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 32004));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 33036));
...
axiom (llvm.dbg.value == $sub.ref(0, 34068));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 35100));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := 0;
  call {:cexpr "num"} boogie_si_record_i32(0);
  $exn := false;
  return;
}
const $u0: ref;
