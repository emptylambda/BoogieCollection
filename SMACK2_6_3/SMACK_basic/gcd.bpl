...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/gcd.c -bpl ./gcd.bpl
  ...
  returns ($r: i32)
{
  ...
  var $i11: i32;
$bb0:
  assume {:sourceloc "test/c/basic/gcd.c", 9, 9} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i0, 0);
  assume {:sourceloc "test/c/basic/gcd.c", 9, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/basic/gcd.c", 10, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, $i0);
  call {:cexpr "a"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/basic/gcd.c", 10, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/gcd.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i1, 0);
  assume {:sourceloc "test/c/basic/gcd.c", 11, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $i1;
...
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/basic/gcd.c", 12, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32(0, $i1);
  call {:cexpr "b"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/basic/gcd.c", 12, 5} true;
  assume {:verifier.code 0} true;
  $i6 := $i7;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/gcd.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i8, $i9 := $i6, $i3;
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/basic/gcd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/gcd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/gcd.c", 14, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i8, 0);
  assume {:sourceloc "test/c/basic/gcd.c", 14, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i10 == 1);
  assume {:sourceloc "test/c/basic/gcd.c", 16, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $srem.i32($i9, $i8);
...
$bb9:
  assume !(($i10 == 1));
  assume {:sourceloc "test/c/basic/gcd.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/gcd.c", 23, 11} true;
  ...
  assume {:sourceloc "test/c/basic/gcd.c", 24, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/basic/gcd.c", 27, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i1, 0);
  assume {:sourceloc "test/c/basic/gcd.c", 27, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/basic/gcd.c", 27, 18} true;
  assume {:verifier.code 0} true;
  $i3 := $sgt.i32($i0, 0);
  assume {:sourceloc "test/c/basic/gcd.c", 27, 22} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/basic/gcd.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/basic/gcd.c", 27, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $srem.i32($i0, $i1);
  assume {:sourceloc "test/c/basic/gcd.c", 27, 31} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "test/c/basic/gcd.c", 27, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb6, $bb7;
$bb5:
...
$bb6:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/basic/gcd.c", 28, 9} true;
  assume {:verifier.code 0} true;
  call $i6 := gcd_test($i0, $i1);
  call {:cexpr "g"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/basic/gcd.c", 29, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume {:sourceloc "test/c/basic/gcd.c", 27, 7} true;
...
$bb11:
  ...
  goto $bb10;
$bb12:
  assume {:sourceloc "test/c/basic/gcd.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
