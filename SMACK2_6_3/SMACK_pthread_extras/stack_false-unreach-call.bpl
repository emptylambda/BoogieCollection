...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/stack_false-unreach-call.c -bpl ./stack_false-unreach-call.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 43378));
...
const m: ref;
axiom (m == $sub.ref(0, 2073));
const top: ref;
axiom (top == $sub.ref(0, 3101));
const .str: ref;
axiom (.str == $sub.ref(0, 4141));
const {:count 17} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 5182));
const {:count 5} arr: ref;
axiom (arr == $sub.ref(0, 6226));
const inc_top: ref;
axiom (inc_top == $sub.ref(0, 7258));
procedure {:inline 1} inc_top()
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 19, 25} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 19, 29} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const dec_top: ref;
axiom (dec_top == $sub.ref(0, 8290));
procedure {:inline 1} dec_top()
{
  var $i0: i32;
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 21, 25} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 21, 25} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  ...
  $M.0 := $i1;
  call {:cexpr "top"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 21, 29} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const get_top: ref;
axiom (get_top == $sub.ref(0, 9322));
procedure {:inline 1} get_top()
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 23, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 23, 28} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 23, 21} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 28, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "push:arg:x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 28, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 28, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 5);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 28, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 29, 5} true;
  assume {:verifier.code 0} true;
  call $i4 := printf.ref(.str);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(0, 1);
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 32, 11} true;
  assume {:verifier.code 0} true;
  call $i6 := get_top();
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0, $mul.ref($i7, 4));
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 32, 22} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p8, $i1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 33, 5} true;
  assume {:verifier.code 0} true;
  call inc_top();
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 11386));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const printf: ref;
axiom (printf == $sub.ref(0, 12418));
procedure {:inline 1} printf.ref($p0: ref)
  returns ($r: i32);
const pop: ref;
axiom (pop == $sub.ref(0, 13450));
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 39, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 39, 7} true;
  assume {:verifier.code 0} true;
  call $i1 := get_top();
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 39, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 39, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 40, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := printf.ref(.str.1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 41, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, 2);
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 43, 5} true;
  assume {:verifier.code 0} true;
  call dec_top();
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 44, 18} true;
  assume {:verifier.code 0} true;
  call $i5 := get_top();
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 44, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 44, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.1, $p7);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 44, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i8;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 47, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 53, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 53, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 53, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 53, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 54, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 55, 11} true;
  assume {:verifier.code 1} true;
  call $i4 := __VERIFIER_nondet_uint();
  call {:cexpr "smack:ext:__VERIFIER_nondet_uint"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 55, 36} true;
  assume {:verifier.code 0} true;
  $i5 := $urem.i32($i4, 5);
  call {:cexpr "tmp"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 56, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 60, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 57, 10} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "flag"} boogie_si_record_i8(1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 58, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(m);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 59, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 53, 26} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i1, 1);
  ...
  returns ($r: ref)
{
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 65, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 65, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 65, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 65, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 66, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 67, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.2;
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 67, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 72, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 68, 7} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb5:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 67, 9} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 70, 5} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(m);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 71, 3} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb7:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 68, 7} true;
...
$bb10:
  ...
  goto $bb9;
$bb11:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 69, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb12:
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 65, 26} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i9);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 65, 3} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 77, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 79, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 80, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p1, $0.ref, t2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 82, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.3, $p0);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 82, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_join($i5, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 83, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.4, $p1);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 83, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stack_false-unreach-call.c", 85, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assert == $sub.ref(0, 25834));
...
axiom (__SMACK_and32 == $sub.ref(0, 26866));
...
axiom (__SMACK_and64 == $sub.ref(0, 27898));
...
axiom (__SMACK_and16 == $sub.ref(0, 28930));
...
axiom (__SMACK_and8 == $sub.ref(0, 29962));
...
axiom (__SMACK_or32 == $sub.ref(0, 30994));
...
axiom (__SMACK_or64 == $sub.ref(0, 32026));
...
axiom (__SMACK_or16 == $sub.ref(0, 33058));
...
axiom (__SMACK_or8 == $sub.ref(0, 34090));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 35122));
...
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 36154));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 37186));
procedure {:inline 1} __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 38218));
...
axiom (__SMACK_decls == $sub.ref(0, 39250));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 40282));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 41314));
...
axiom (llvm.dbg.value == $sub.ref(0, 42346));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 43378));
