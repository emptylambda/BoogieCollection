...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/set_rm_invalid_fail.c -bpl ./set_rm_invalid_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/set_rm_invalid_fail.c", 7, 12} true;
  ...
  call {:cexpr "rm"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/float/set_rm_invalid_fail.c", 8, 3} true;
...
$bb9:
  ...
  goto $bb4;
$bb10:
  assume {:sourceloc "test/c/float/set_rm_invalid_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/float/set_rm_invalid_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := fesetround($i0);
  assume {:sourceloc "test/c/float/set_rm_invalid_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/float/set_rm_invalid_fail.c", 10, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/float/set_rm_invalid_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
