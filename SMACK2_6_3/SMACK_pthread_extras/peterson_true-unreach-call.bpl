...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/peterson_true-unreach-call.c -bpl ./peterson_true-unreach-call.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i7: i1;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 16, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "flag1"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 17, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "turn"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 18, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $M.2;
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 18, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 18, 21} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 18, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 18, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 1);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $M.3 := 0;
  call {:cexpr "x"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 22, 3} true;
...
$bb10:
  ...
  goto $bb9;
$bb11:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 24, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := 0;
  call {:cexpr "flag1"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i7: i1;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 28, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 28, 9} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "flag2"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := 0;
  call {:cexpr "turn"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 30, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 30, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 30, 21} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 30, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 30, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:verifier.code 0} true;
  $i3 := $i5;
...
$bb6:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $M.3 := 1;
  call {:cexpr "x"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 34, 3} true;
...
$bb10:
  ...
  goto $bb9;
$bb11:
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $M.2 := 0;
  call {:cexpr "flag2"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 37, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 42, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, thr2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 44, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.4, $p0);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 44, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 45, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.5, $p1);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 45, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/peterson_true-unreach-call.c", 46, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
