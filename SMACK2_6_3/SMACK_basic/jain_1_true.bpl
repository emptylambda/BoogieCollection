...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/jain_1_true.c -bpl ./jain_1_true.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/jain_1_true.c", 8, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/jain_1_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/jain_1_true.c", 9, 17} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/basic/jain_1_true.c", 9, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.i32(2, $i1);
  assume {:sourceloc "test/c/basic/jain_1_true.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, $i2);
  call {:cexpr "y"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/basic/jain_1_true.c", 10, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/basic/jain_1_true.c", 10, 5} true;
