...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/init_funcs_global_fail.c -bpl ./init_funcs_global_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 22700));
...
const __SMACK_init_func_g1: ref;
axiom (__SMACK_init_func_g1 == $sub.ref(0, 2060));
procedure {:inline 1} __SMACK_init_func_g1()
{
$bb0:
  assume {:sourceloc "test/c/basic/init_funcs_global_fail.c", 7, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/init_funcs_global_fail.c", 7, 22} true;
  assume {:verifier.code 0} true;
  $M.0 := 11;
  call {:cexpr "g"} boogie_si_record_i32(11);
  assume {:sourceloc "test/c/basic/init_funcs_global_fail.c", 7, 28} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __SMACK_init_func_g2: ref;
axiom (__SMACK_init_func_g2 == $sub.ref(0, 3092));
procedure {:inline 1} __SMACK_init_func_g2()
{
$bb0:
  assume {:sourceloc "test/c/basic/init_funcs_global_fail.c", 9, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/init_funcs_global_fail.c", 9, 22} true;
  assume {:verifier.code 0} true;
  $M.0 := 12;
  call {:cexpr "g"} boogie_si_record_i32(12);
  assume {:sourceloc "test/c/basic/init_funcs_global_fail.c", 9, 28} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/init_funcs_global_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb3;
$bb9:
  assume {:sourceloc "test/c/basic/init_funcs_global_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 7220));
...
axiom (__VERIFIER_assert == $sub.ref(0, 8252));
...
axiom (__SMACK_and32 == $sub.ref(0, 9284));
...
axiom (__SMACK_and64 == $sub.ref(0, 10316));
...
axiom (__SMACK_and16 == $sub.ref(0, 11348));
...
axiom (__SMACK_and8 == $sub.ref(0, 12380));
...
axiom (__SMACK_or32 == $sub.ref(0, 13412));
...
axiom (__SMACK_or64 == $sub.ref(0, 14444));
...
axiom (__SMACK_or16 == $sub.ref(0, 15476));
...
axiom (__SMACK_or8 == $sub.ref(0, 16508));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17540));
...
axiom (__SMACK_decls == $sub.ref(0, 18572));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 19604));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 20636));
...
axiom (llvm.dbg.value == $sub.ref(0, 21668));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 22700));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := 10;
  call {:cexpr "g"} boogie_si_record_i32(10);
  $exn := false;
  return;
}
...
procedure {:inline 1} $initialize()
{
  ...
  call __SMACK_init_func_g1();
  call __SMACK_init_func_g2();
