...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/pointers_fail.c -bpl ./pointers_fail.bpl
...
procedure {:inline 1} incr($p0: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/data/pointers_fail.c", 7, 25} true;
  ...
  assume {:sourceloc "test/c/data/pointers_fail.c", 7, 29} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/pointers_fail.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/pointers_fail.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/data/pointers_fail.c", 10, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/pointers_fail.c", 11, 19} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(4);
  assume {:sourceloc "test/c/data/pointers_fail.c", 11, 12} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/data/pointers_fail.c", 13, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 0);
  assume {:sourceloc "test/c/data/pointers_fail.c", 13, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "test/c/data/pointers_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call incr($p1);
  assume {:sourceloc "test/c/data/pointers_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call incr($p3);
  assume {:sourceloc "test/c/data/pointers_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call incr($p1);
  assume {:sourceloc "test/c/data/pointers_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/pointers_fail.c", 19, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/pointers_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/data/pointers_fail.c", 20, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/data/pointers_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
