// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ForbidNondeterminism.dfy -print:./ForbidNondeterminism.bpl
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       ...
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, _module.CK.x), TInt, $h));

axiom FDim(_module.CK.y) == 0
   && FieldOfDecl(class._module.CK?, field$y) == _module.CK.y
   && !$IsGhostField(_module.CK.y);

const _module.CK.y: Field int;

// CK.y: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, _module.CK.y) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass._module.CK?()
     ==> $Is(read($h, $o, _module.CK.y), TInt));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass._module.CK?()
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, _module.CK.y), TInt, $h));
...
procedure CheckWellformed$$_module.CK.Init(this: ref
       where this != null
         && 
...
procedure Call$$_module.CK.Init()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass._module.CK())
...
procedure Impl$$_module.CK.Init()
   returns (this: ref where this != null && $Is(this, Tclass._module.CK()), 
    $_reverifyPost: bool);
  free requires 6 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
...
// _module.CK: subset type $Is
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass._module.CK()) } 
  $Is(c#0, Tclass._module.CK()) <==> $Is(c#0, Tclass._module.CK?()) && c#0 != null);

// _module.CK: subset type $IsAlloc
axiom (forall c#0: ref, $h: Heap :: 
...
axiom 7 <= $FunctionContextHeight
   ==> (forall z#0: int :: 
    ...
    _module.__default.P#canCall(z#0) || 7 != $FunctionContextHeight ==> true);
...
axiom 7 <= $FunctionContextHeight
   ==> (forall z#0: int :: 
    { _module.__default.P(z#0) } 
    _module.__default.P#canCall(z#0) || 7 != $FunctionContextHeight
...
axiom 7 <= $FunctionContextHeight
   ==> (forall z#0: int :: 
    ...
    _module.__default.P#canCall(LitInt(z#0)) || 7 != $FunctionContextHeight
...
procedure CheckWellformed$$_module.__default.OutputParameters1(x#0: int) returns (s#0: int, t#0: int);
  free requires 9 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.OutputParameters1(x#0: int) returns (s#0: int, t#0: int);
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure Impl$$_module.__default.OutputParameters1(x#0: int) returns (s#0: int, t#0: int, $_reverifyPost: bool);
  free requires 9 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure CheckWellformed$$_module.__default.ArrayAllocation(n#0: int where LitInt(0) <= n#0, 
...
procedure Call$$_module.__default.ArrayAllocation(n#0: int where LitInt(0) <= n#0, 
    p#0: int where LitInt(0) <= p#0, 
    q#0: int where LitInt(0) <= q#0);
  modifies $Heap, $Tick;
  // frame condition: object granularity
...
procedure Impl$$_module.__default.ArrayAllocation(n#0: int where LitInt(0) <= n#0, 
    p#0: int where LitInt(0) <= p#0, 
    q#0: int where LitInt(0) <= q#0)
...
implementation Impl$$_module.__default.ArrayAllocation(n#0: int, p#0: int, q#0: int) returns ($_reverifyPost: bool)
{
  ...
  var m#0: ref
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ForbidNondeterminism.dfy(59,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ForbidNondeterminism.dfy(60,9)
    assume true;
    assert 0 <= n#0;
    havoc $nw;
    ...
    a#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ForbidNondeterminism.dfy(60,21)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ForbidNondeterminism.dfy(61,9)
    assume true;
    assert 0 <= p#0;
    assert 0 <= q#0;
    havoc $nw;
    ...
    assume $IsHeapAnchor($Heap);
    m#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ForbidNondeterminism.dfy(61,24)"} true;
}
