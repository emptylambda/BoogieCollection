...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/malloc_collapsing.c -bpl ./malloc_collapsing.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 8, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 9, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 2);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 10, 22} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 10, 14} true;
  assume {:verifier.code 0} true;
  call $p3 := realloc($p2, 4);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 10, 7} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 11, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, 1);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.1, $p4);
  assume {:sourceloc "test/c/basic/malloc_collapsing.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 19608));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 20640));
...
const realloc: ref;
axiom (realloc == $sub.ref(0, 21672));
procedure {:inline 1} realloc($p0: ref, $i1: i64)
  returns ($r: ref)
{
  var $p2: ref;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "realloc:arg:size"} boogie_si_record_i64($i1);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call free_($p0);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 43, 9} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc($i1);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 44, 3} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_end();
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 45, 3} true;
  assume {:verifier.code 0} true;
  $r := $p2;
  $exn := false;
  return;
