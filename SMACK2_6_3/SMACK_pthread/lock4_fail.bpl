...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock4_fail.c -bpl ./lock4_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 13, 4} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 13, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_destroy(lock);
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 24, 4} true;
  assume {:verifier.code 0} true;
  $i4 := $M.0;
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 24, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 27, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lock4_fail.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_mutex_destroy == $sub.ref(0, 9300));
