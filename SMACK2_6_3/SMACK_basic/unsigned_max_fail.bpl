...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/unsigned_max_fail.c -bpl ./unsigned_max_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 8, 16} true;
  assume {:verifier.code 1} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 8, 16} true;
  assume {:verifier.code 1} true;
  call $i0 := __VERIFIER_nondet_unsigned();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned"} boogie_si_record_i32($i0);
  call {:cexpr "x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $sub.i32(4294967295, 1);
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i0, $i1);
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $uge.i32($i0, 4294967294);
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/basic/unsigned_max_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_unsigned == $sub.ref(0, 15480));
...
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 16512));
