...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/globals_func_ptr_fail.c -bpl ./globals_func_ptr_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24792));
...
const my_int_ops: ref;
axiom (my_int_ops == $sub.ref(0, 1048));
const my_ops: ref;
axiom (my_ops == $sub.ref(0, 2088));
const incr: ref;
axiom (incr == $sub.ref(0, 3120));
procedure {:inline 1} incr($i0: i32)
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 19, 26} true;
  assume {:verifier.code 0} true;
  call {:cexpr "incr:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 19, 26} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  call {:cexpr "x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 19, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
const decr: ref;
axiom (decr == $sub.ref(0, 4152));
procedure {:inline 1} decr($i0: i32)
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 21, 26} true;
  assume {:verifier.code 0} true;
  call {:cexpr "decr:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 21, 26} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, $sub.i32(0, 1));
  call {:cexpr "x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 21, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 32, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 32, 15} true;
  assume {:verifier.code 0} true;
  $p0 := $M.0;
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 32, 21} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 32, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $M.1;
  call $i3 := devirtbounce($p2, 0);
  call {:cexpr "x"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 35, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/globals_func_ptr_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 8280));
...
axiom (__VERIFIER_assert == $sub.ref(0, 9312));
...
axiom (__SMACK_and32 == $sub.ref(0, 10344));
...
axiom (__SMACK_and64 == $sub.ref(0, 11376));
...
axiom (__SMACK_and16 == $sub.ref(0, 12408));
...
axiom (__SMACK_and8 == $sub.ref(0, 13440));
...
axiom (__SMACK_or32 == $sub.ref(0, 14472));
...
axiom (__SMACK_or64 == $sub.ref(0, 15504));
...
axiom (__SMACK_or16 == $sub.ref(0, 16536));
...
axiom (__SMACK_or8 == $sub.ref(0, 17568));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18600));
...
axiom (__SMACK_decls == $sub.ref(0, 19632));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 20664));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21696));
...
axiom (llvm.dbg.value == $sub.ref(0, 22728));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 23760));
...
axiom (devirtbounce == $sub.ref(0, 24792));
procedure {:inline 1} devirtbounce(funcPtr: ref, arg: i32)
  returns ($r: i32)
{
  var $p0: ref;
  var $i1: i32;
