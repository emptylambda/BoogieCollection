// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue57.dfy -print:./git-issue57.bpl
...
procedure CheckWellformed$$_module.__default.lemma__RotateRightAdds(x#0: bv32);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.lemma__RotateRightAdds(x#0: bv32)
{
  var $_Frame: <beta>[ref,Field beta]bool;

    // AddMethodImpl: lemma_RotateRightAdds, CheckWellformed$$_module.__default.lemma__RotateRightAdds
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue57.dfy(4,6): initial state"} true;
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue57.dfy(5,46): post-state"} true;
    assert 0 <= LitInt(2);
    assert LitInt(2) <= 32;
    assert 0 <= LitInt(3);
    assert LitInt(3) <= 32;
    assert 0 <= LitInt(5);
    assert LitInt(5) <= 32;
    assume RightRotate_bv32(RightRotate_bv32(x#0, 2bv32), 3bv32)
       == RightRotate_bv32(x#0, 5bv32);
}



procedure Call$$_module.__default.lemma__RotateRightAdds(x#0: bv32);
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
  ensures RightRotate_bv32(RightRotate_bv32(x#0, 2bv32), 3bv32)
     == RightRotate_bv32(x#0, 5bv32);
  // frame condition
...
procedure Impl$$_module.__default.lemma__RotateRightAdds(x#0: bv32) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
...
implementation Impl$$_module.__default.lemma__RotateRightAdds(x#0: bv32) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;

    // AddMethodImpl: lemma_RotateRightAdds, Impl$$_module.__default.lemma__RotateRightAdds
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue57.dfy(6,0): initial state"} true;
    $_reverifyPost := false;
}
