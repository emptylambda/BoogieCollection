...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock2.c -bpl ./lock2.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock2.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock2.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock2.c", 13, 4} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread/lock2.c", 13, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock2.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock2.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock2.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lock2.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/lock2.c", 21, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/pthread/lock2.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "test/c/pthread/lock2.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, t1, $0.ref);
  assume {:sourceloc "test/c/pthread/lock2.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock2.c", 26, 4} true;
  assume {:verifier.code 0} true;
  $i9 := $M.0;
  assume {:sourceloc "test/c/pthread/lock2.c", 26, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock2.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock2.c", 28, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.3, $p0);
  assume {:sourceloc "test/c/pthread/lock2.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "test/c/pthread/lock2.c", 29, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.4, $p1);
  assume {:sourceloc "test/c/pthread/lock2.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "test/c/pthread/lock2.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/pthread/lock2.c", 30, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/pthread/lock2.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
