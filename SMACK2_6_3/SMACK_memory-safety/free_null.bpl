...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/free_null.c -bpl ./free_null.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/free_null.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/memory-safety/free_null.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $p0 := $bitcast.ref.ref($0.ref);
  assume {:sourceloc "test/c/memory-safety/free_null.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call free_($p0);
  assume {:sourceloc "test/c/memory-safety/free_null.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
