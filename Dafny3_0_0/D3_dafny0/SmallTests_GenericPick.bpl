...
function $let#0_x(GenericPick._default.SetPick0$U: Ty, s: Set Box) : Box;

function $let#0$canCall(GenericPick._default.SetPick0$U: Ty, s: Set Box) : bool;
...
axiom (forall GenericPick._default.SetPick0$U: Ty, s: Set Box :: 
  ...
  $let#0$canCall(GenericPick._default.SetPick0$U, s)
     ==> s[$let#0_x(GenericPick._default.SetPick0$U, s)]);
...
procedure CheckWellformed$$GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U: Ty, 
    s#0: Set Box where $Is(s#0, TSet(GenericPick._default.SetPick0$U)));
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U: Ty, s#0: Set Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#2: Box;


    // AddWellformednessCheck for function SetPick0
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(766,11): initial state"} true;
    ...
    else
    {
        ...
        assert (exists x#3: Box :: $IsBox(x#3, GenericPick._default.SetPick0$U) && s#0[x#3]);
        assume $IsBox(x#2, GenericPick._default.SetPick0$U);
        assume s#0[x#2];
        assume $let#0$canCall(GenericPick._default.SetPick0$U, s#0);
        assume GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U, s#0) == x#2;
        assume true;
...
function $let#3_x(GenericPick._default.SetPick1$U: Ty, s: Set Box) : Box;

function $let#3$canCall(GenericPick._default.SetPick1$U: Ty, s: Set Box) : bool;
...
axiom (forall GenericPick._default.SetPick1$U: Ty, s: Set Box :: 
  ...
  $let#3$canCall(GenericPick._default.SetPick1$U, s)
     ==> s[$let#3_x(GenericPick._default.SetPick1$U, s)]);
...
procedure CheckWellformed$$GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U: Ty, 
    s#0: Set Box where $Is(s#0, TSet(GenericPick._default.SetPick1$U)));
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U: Ty, s#0: Set Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#2: Box;


    // AddWellformednessCheck for function SetPick1
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(771,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ...
    else
    {
        ...
        assert (exists x#3: Box :: $IsBox(x#3, GenericPick._default.SetPick1$U) && s#0[x#3]);
        assume $IsBox(x#2, GenericPick._default.SetPick1$U);
        assume s#0[x#2];
        assume $let#3$canCall(GenericPick._default.SetPick1$U, s#0);
        assume GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U, s#0) == x#2;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U, s#0), 
          GenericPick._default.SetPick1$U);
    ...
    GenericPick.__default.SetPick2#canCall(GenericPick._default.SetPick2$U, s#0)
         || (6 != $FunctionContextHeight
          ...
          $Is(s#0, TSet(GenericPick._default.SetPick2$U))
           && (exists x#0: Box :: 
            { s#0[x#0] } 
            $IsBox(x#0, GenericPick._default.SetPick2$U) && s#0[x#0]))
...
axiom (forall GenericPick._default.SetPick2$U: Ty, $Heap: Heap, s#0: Set Box :: 
  ...
  $IsGoodHeap($Heap) && $Is(s#0, TSet(GenericPick._default.SetPick2$U))
     ==> GenericPick.__default.SetPick2#requires(GenericPick._default.SetPick2$U, s#0)
       == (exists x#1: Box :: 
        { s#0[x#1] } 
        $IsBox(x#1, GenericPick._default.SetPick2$U) && s#0[x#1]));

function $let#6_x(GenericPick._default.SetPick2$U: Ty, s: Set Box) : Box;

function $let#6$canCall(GenericPick._default.SetPick2$U: Ty, s: Set Box) : bool;
...
axiom (forall GenericPick._default.SetPick2$U: Ty, s: Set Box :: 
  ...
  $let#6$canCall(GenericPick._default.SetPick2$U, s)
     ==> s[$let#6_x(GenericPick._default.SetPick2$U, s)]);
    ...
    GenericPick.__default.SetPick2#canCall(GenericPick._default.SetPick2$U, Lit(s#0))
         || (6 != $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#3: Box :: 
            { s#0[x#3] } 
            $IsBox(x#3, GenericPick._default.SetPick2$U) && Lit(s#0)[x#3]))
...
procedure CheckWellformed$$GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U: Ty, 
    s#0: Set Box where $Is(s#0, TSet(GenericPick._default.SetPick2$U)));
  free requires 6 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U: Ty, s#0: Set Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#5: Box;
  var x#6: Box;
    ...
    // AddWellformednessCheck for function SetPick2
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(776,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc x#5;
    ...
    else
    {
        ...
        assert (exists x#7: Box :: $IsBox(x#7, GenericPick._default.SetPick2$U) && s#0[x#7]);
        assume $IsBox(x#6, GenericPick._default.SetPick2$U);
        assume s#0[x#6];
        assume $let#6$canCall(GenericPick._default.SetPick2$U, s#0);
        assume GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U, s#0) == x#6;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U, s#0), 
          GenericPick._default.SetPick2$U);
...
function $let#9_x(GenericPick._default.MultisetPick0$U: Ty, s: MultiSet Box) : Box;

function $let#9$canCall(GenericPick._default.MultisetPick0$U: Ty, s: MultiSet Box) : bool;
...
axiom (forall GenericPick._default.MultisetPick0$U: Ty, s: MultiSet Box :: 
  ...
  $let#9$canCall(GenericPick._default.MultisetPick0$U, s)
     ==> s[$let#9_x(GenericPick._default.MultisetPick0$U, s)] > 0);
...
procedure CheckWellformed$$GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U: Ty, 
    s#0: MultiSet Box
       where $Is(s#0, TMultiSet(GenericPick._default.MultisetPick0$U)));
  free requires 7 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U: Ty, s#0: MultiSet Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#2: Box;


    // AddWellformednessCheck for function MultisetPick0
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(782,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume !MultiSet#Equal(s#0, MultiSet#Empty(): MultiSet Box);
    if (*)
    {
    ...
    else
    {
        ...
        assert (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.MultisetPick0$U) && s#0[x#3] > 0);
        assume $IsBox(x#2, GenericPick._default.MultisetPick0$U);
        assume s#0[x#2] > 0;
        assume $let#9$canCall(GenericPick._default.MultisetPick0$U, s#0);
        assume GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U, s#0)
           == x#2;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U, s#0), 
...
function $let#12_x(GenericPick._default.MultisetPick1$U: Ty, s: MultiSet Box) : Box;

function $let#12$canCall(GenericPick._default.MultisetPick1$U: Ty, s: MultiSet Box) : bool;
...
axiom (forall GenericPick._default.MultisetPick1$U: Ty, s: MultiSet Box :: 
  ...
  $let#12$canCall(GenericPick._default.MultisetPick1$U, s)
     ==> s[$let#12_x(GenericPick._default.MultisetPick1$U, s)] > 0);
...
procedure CheckWellformed$$GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U: Ty, 
    s#0: MultiSet Box
       where $Is(s#0, TMultiSet(GenericPick._default.MultisetPick1$U)));
  free requires 8 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U: Ty, s#0: MultiSet Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#2: Box;


    // AddWellformednessCheck for function MultisetPick1
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(787,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ...
    else
    {
        ...
        assert (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.MultisetPick1$U) && s#0[x#3] > 0);
        assume $IsBox(x#2, GenericPick._default.MultisetPick1$U);
        assume s#0[x#2] > 0;
        assume $let#12$canCall(GenericPick._default.MultisetPick1$U, s#0);
        assume GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U, s#0)
           == x#2;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U, s#0), 
    ...
    GenericPick.__default.MultisetPick2#canCall(GenericPick._default.MultisetPick2$U, s#0)
         || (9 != $FunctionContextHeight
          ...
          $Is(s#0, TMultiSet(GenericPick._default.MultisetPick2$U))
           && (exists x#0: Box :: 
            { s#0[x#0] } 
            $IsBox(x#0, GenericPick._default.MultisetPick2$U) && s#0[x#0] > 0))
...
axiom (forall GenericPick._default.MultisetPick2$U: Ty, $Heap: Heap, s#0: MultiSet Box :: 
  ...
  $IsGoodHeap($Heap) && $Is(s#0, TMultiSet(GenericPick._default.MultisetPick2$U))
     ==> GenericPick.__default.MultisetPick2#requires(GenericPick._default.MultisetPick2$U, s#0)
       == (exists x#1: Box :: 
        { s#0[x#1] } 
        $IsBox(x#1, GenericPick._default.MultisetPick2$U) && s#0[x#1] > 0));

function $let#15_x(GenericPick._default.MultisetPick2$U: Ty, s: MultiSet Box) : Box;

function $let#15$canCall(GenericPick._default.MultisetPick2$U: Ty, s: MultiSet Box) : bool;
...
axiom (forall GenericPick._default.MultisetPick2$U: Ty, s: MultiSet Box :: 
  ...
  $let#15$canCall(GenericPick._default.MultisetPick2$U, s)
     ==> s[$let#15_x(GenericPick._default.MultisetPick2$U, s)] > 0);
    ...
    GenericPick.__default.MultisetPick2#canCall(GenericPick._default.MultisetPick2$U, Lit(s#0))
         || (9 != $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#3: Box :: 
            { s#0[x#3] } 
            $IsBox(x#3, GenericPick._default.MultisetPick2$U) && Lit(s#0)[x#3] > 0))
...
procedure CheckWellformed$$GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U: Ty, 
    s#0: MultiSet Box
       where $Is(s#0, TMultiSet(GenericPick._default.MultisetPick2$U)));
  free requires 9 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U: Ty, s#0: MultiSet Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#5: Box;
  var x#6: Box;
    ...
    // AddWellformednessCheck for function MultisetPick2
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(792,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc x#5;
    ...
    else
    {
        ...
        assert (exists x#7: Box :: 
          $IsBox(x#7, GenericPick._default.MultisetPick2$U) && s#0[x#7] > 0);
        assume $IsBox(x#6, GenericPick._default.MultisetPick2$U);
        assume s#0[x#6] > 0;
        assume $let#15$canCall(GenericPick._default.MultisetPick2$U, s#0);
        assume GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U, s#0)
           == x#6;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U, s#0), 
...
function $let#18_x(GenericPick._default.MultisetPick3$U: Ty, s: MultiSet Box) : Box;

function $let#18$canCall(GenericPick._default.MultisetPick3$U: Ty, s: MultiSet Box) : bool;
...
axiom (forall GenericPick._default.MultisetPick3$U: Ty, s: MultiSet Box :: 
  ...
  $let#18$canCall(GenericPick._default.MultisetPick3$U, s)
     ==> s[$let#18_x(GenericPick._default.MultisetPick3$U, s)] > 0);
...
procedure CheckWellformed$$GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U: Ty, 
    s#0: MultiSet Box
       where $Is(s#0, TMultiSet(GenericPick._default.MultisetPick3$U)));
  free requires 10 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U: Ty, s#0: MultiSet Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#5: Box;
  var x#6: Box;
    ...
    // AddWellformednessCheck for function MultisetPick3
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(797,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc x#5;
    ...
    else
    {
        ...
        assert (exists x#7: Box :: 
          $IsBox(x#7, GenericPick._default.MultisetPick3$U) && s#0[x#7] > 0);
        assume $IsBox(x#6, GenericPick._default.MultisetPick3$U);
        assume s#0[x#6] > 0;
        assume $let#18$canCall(GenericPick._default.MultisetPick3$U, s#0);
        assume GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U, s#0)
           == x#6;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U, s#0), 
...
function $let#21_x(GenericPick._default.SeqPick0$U: Ty, s: Seq Box) : Box;

function $let#21$canCall(GenericPick._default.SeqPick0$U: Ty, s: Seq Box) : bool;
...
procedure CheckWellformed$$GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U: Ty, 
    s#0: Seq Box where $Is(s#0, TSeq(GenericPick._default.SeqPick0$U)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U: Ty, s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var s##0: Seq Box;
  var x#2: Box;
    ...
    // AddWellformednessCheck for function SeqPick0
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(803,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(806,45)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        s##0 := s#0;
        // ProcessCallStmt: Make the call
        call Call$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.SeqPick0$U, s##0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(806,47)"} true;
        havoc x#2;
        ...
        assume GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U, s#0) == x#2;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U, s#0), 
          GenericPick._default.SeqPick0$U);
...
function $let#24_x(GenericPick._default.SeqPick1$U: Ty, s: Seq Box) : Box;

function $let#24$canCall(GenericPick._default.SeqPick1$U: Ty, s: Seq Box) : bool;
...
procedure CheckWellformed$$GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U: Ty, 
    s#0: Seq Box where $Is(s#0, TSeq(GenericPick._default.SeqPick1$U)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U: Ty, s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var s##0: Seq Box;
  var x#2: Box;
    ...
    // AddWellformednessCheck for function SeqPick1
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(809,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(812,45)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        s##0 := s#0;
        // ProcessCallStmt: Make the call
        call Call$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.SeqPick1$U, s##0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(812,47)"} true;
        havoc x#2;
        ...
        assume GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U, s#0) == x#2;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U, s#0), 
          GenericPick._default.SeqPick1$U);
...
function $let#27_x(GenericPick._default.SeqPick2$U: Ty, s: Seq Box) : Box;

function $let#27$canCall(GenericPick._default.SeqPick2$U: Ty, s: Seq Box) : bool;
...
procedure CheckWellformed$$GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U: Ty, 
    s#0: Seq Box where $Is(s#0, TSeq(GenericPick._default.SeqPick2$U)));
  free requires 11 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U: Ty, s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#5: Box;
  var x#6: Box;
    ...
    // AddWellformednessCheck for function SeqPick2
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(815,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc x#5;
    assume $IsBox(x#5, GenericPick._default.SeqPick2$U);
    assume Seq#Contains(s#0, x#5);
    if (*)
    {
    ...
    else
    {
        ...
        assume GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U, s#0) == x#6;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U, s#0), 
          GenericPick._default.SeqPick2$U);
    ...
    GenericPick.__default.SeqPick3#canCall(GenericPick._default.SeqPick3$U, s#0)
         || (3 != $FunctionContextHeight
          ...
          $Is(s#0, TSeq(GenericPick._default.SeqPick3$U))
           && (exists i#0: int :: {:nowarn} LitInt(0) <= i#0 && i#0 < Seq#Length(s#0)))
...
axiom (forall GenericPick._default.SeqPick3$U: Ty, $Heap: Heap, s#0: Seq Box :: 
  ...
  $IsGoodHeap($Heap) && $Is(s#0, TSeq(GenericPick._default.SeqPick3$U))
     ==> GenericPick.__default.SeqPick3#requires(GenericPick._default.SeqPick3$U, s#0)
       == (exists i#1: int :: {:nowarn} LitInt(0) <= i#1 && i#1 < Seq#Length(s#0)));

function $let#30_x(GenericPick._default.SeqPick3$U: Ty, s: Seq Box) : Box;

function $let#30$canCall(GenericPick._default.SeqPick3$U: Ty, s: Seq Box) : bool;
   ...
   ==> (forall GenericPick._default.SeqPick3$U: Ty, $Heap: Heap, s#0: Seq Box :: 
    ...
    GenericPick.__default.SeqPick3#canCall(GenericPick._default.SeqPick3$U, Lit(s#0))
         || (3 != $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick3$U))
           && (exists i#2: int :: {:nowarn} LitInt(0) <= i#2 && i#2 < Seq#Length(Lit(s#0))))
...
procedure CheckWellformed$$GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U: Ty, 
    s#0: Seq Box where $Is(s#0, TSeq(GenericPick._default.SeqPick3$U)));
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U: Ty, s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#3: int;
  var s##0: Seq Box;
  var x#2: Box;
    ...
    // AddWellformednessCheck for function SeqPick3
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(820,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc i#3;
    assume true;
    assume LitInt(0) <= i#3;
    assume i#3 < Seq#Length(s#0);
    if (*)
    {
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(823,45)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        s##0 := s#0;
        // ProcessCallStmt: Make the call
        call Call$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.SeqPick3$U, s##0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(823,47)"} true;
        havoc x#2;
        ...
        assume GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U, s#0) == x#2;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U, s#0), 
          GenericPick._default.SeqPick3$U);
...
function $let#33_i(GenericPick._default.SeqPick4$U: Ty, s: Seq Box) : int;

function $let#33$canCall(GenericPick._default.SeqPick4$U: Ty, s: Seq Box) : bool;
   ...
   ==> (forall GenericPick._default.SeqPick4$U: Ty, $Heap: Heap, s#0: Seq Box :: 
    ...
    GenericPick.__default.SeqPick4#canCall(GenericPick._default.SeqPick4$U, Lit(s#0))
         || (12 != $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick4$U))
           && (exists i#3: int :: {:nowarn} LitInt(0) <= i#3 && i#3 < Seq#Length(Lit(s#0))))
...
procedure CheckWellformed$$GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U: Ty, 
    s#0: Seq Box where $Is(s#0, TSeq(GenericPick._default.SeqPick4$U)));
  free requires 12 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U: Ty, s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#5: int;
  var i#6: int;
    ...
    // AddWellformednessCheck for function SeqPick4
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(826,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc i#5;
    assume true;
    assume LitInt(0) <= i#5;
    assume i#5 < Seq#Length(s#0);
    if (*)
    {
    ...
    else
    {
        ...
        assert ($Is(Seq#Length(s#0) - 1, TInt)
             && 
        ...
        assume GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U, s#0)
           == Seq#Index(s#0, i#6);
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U, s#0), 
...
procedure CheckWellformed$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U: Ty, 
    s#0: Seq Box
...
procedure Call$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U: Ty, 
    s#0: Seq Box
       where $Is(s#0, TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U))
         && $IsAlloc(s#0, 
          TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U), 
...
procedure Impl$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U: Ty, 
    s#0: Seq Box
       where $Is(s#0, TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U))
         && $IsAlloc(s#0, 
          TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U), 
...
implementation Impl$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U: Ty, 
    s#0: Seq Box)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(836,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(837,5)
    assert {:subsumption 0} 0 <= LitInt(0) && LitInt(0) < Seq#Length(s#0);
    assume true;
    assert Seq#Contains(s#0, Seq#Index(s#0, LitInt(0)));
}
...
function $let#36_x(GenericPick._default.MapPick0$U: Ty, 
    GenericPick._default.MapPick0$V: Ty, 
    m: Map Box Box)
   : Box;

function $let#36$canCall(GenericPick._default.MapPick0$U: Ty, 
    GenericPick._default.MapPick0$V: Ty, 
    m: Map Box Box)
   : bool;
...
axiom (forall GenericPick._default.MapPick0$U: Ty, 
  ...
  $let#36$canCall(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m)
     ==> Map#Domain(m)[$let#36_x(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m)]);
...
procedure CheckWellformed$$GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U: Ty, 
    GenericPick._default.MapPick0$V: Ty, 
    m#0: Map Box Box
...
implementation CheckWellformed$$GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U: Ty, 
    GenericPick._default.MapPick0$V: Ty, 
    m#0: Map Box Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#2: Box;
    ...
    // AddWellformednessCheck for function MapPick0
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(840,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume !Map#Equal(m#0, Map#Empty(): Map Box Box);
    if (*)
    {
    ...
    else
    {
        ...
        assert (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.MapPick0$U) && Map#Domain(m#0)[x#3]);
        assume $IsBox(x#2, GenericPick._default.MapPick0$U);
        assume Map#Domain(m#0)[x#2];
        assume $let#36$canCall(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0);
        assume GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0)
           == x#2;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0), 
...
function $let#39_x(GenericPick._default.MapPick1$U: Ty, 
    GenericPick._default.MapPick1$V: Ty, 
    m: Map Box Box)
   : Box;

function $let#39$canCall(GenericPick._default.MapPick1$U: Ty, 
    GenericPick._default.MapPick1$V: Ty, 
    m: Map Box Box)
   : bool;
...
axiom (forall GenericPick._default.MapPick1$U: Ty, 
  ...
  $let#39$canCall(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m)
     ==> Map#Domain(m)[$let#39_x(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m)]);
...
procedure CheckWellformed$$GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U: Ty, 
    GenericPick._default.MapPick1$V: Ty, 
    m#0: Map Box Box
...
implementation CheckWellformed$$GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U: Ty, 
    GenericPick._default.MapPick1$V: Ty, 
    m#0: Map Box Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#2: Box;
    ...
    // AddWellformednessCheck for function MapPick1
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(845,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume Map#Card(m#0) != 0;
    if (*)
    {
    ...
    else
    {
        ...
        assert (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.MapPick1$U) && Map#Domain(m#0)[x#3]);
        ...
        assume GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0)
           == x#2;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0), 
    ...
    GenericPick.__default.MapPick2#canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0)
         || (15 != $FunctionContextHeight
          ...
          $Is(m#0, TMap(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V))
           && (exists x#0: Box :: 
            { Map#Domain(m#0)[x#0] } 
            $IsBox(x#0, GenericPick._default.MapPick2$U) && Map#Domain(m#0)[x#0]))
...
axiom (forall GenericPick._default.MapPick2$U: Ty, 
  ...
  $IsGoodHeap($Heap)
     ...
     ==> GenericPick.__default.MapPick2#requires(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0)
       == (exists x#1: Box :: 
        { Map#Domain(m#0)[x#1] } 
        $IsBox(x#1, GenericPick._default.MapPick2$U) && Map#Domain(m#0)[x#1]));

function $let#42_x(GenericPick._default.MapPick2$U: Ty, 
    GenericPick._default.MapPick2$V: Ty, 
    m: Map Box Box)
   : Box;

function $let#42$canCall(GenericPick._default.MapPick2$U: Ty, 
    GenericPick._default.MapPick2$V: Ty, 
    m: Map Box Box)
   : bool;
...
axiom (forall GenericPick._default.MapPick2$U: Ty, 
  ...
  $let#42$canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m)
     ==> Map#Domain(m)[$let#42_x(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m)]);
    ...
    GenericPick.__default.MapPick2#canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, Lit(m#0))
         || (15 != $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#3: Box :: 
            { Map#Domain(m#0)[x#3] } 
            $IsBox(x#3, GenericPick._default.MapPick2$U) && Map#Domain(m#0)[x#3]))
...
procedure CheckWellformed$$GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U: Ty, 
    GenericPick._default.MapPick2$V: Ty, 
    m#0: Map Box Box
...
implementation CheckWellformed$$GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U: Ty, 
    GenericPick._default.MapPick2$V: Ty, 
    m#0: Map Box Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var x#6: Box;
    ...
    // AddWellformednessCheck for function MapPick2
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(850,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc x#5;
    assume $IsBox(x#5, GenericPick._default.MapPick2$U);
    assume Map#Domain(m#0)[x#5];
    if (*)
    {
    ...
    else
    {
        ...
        assert (exists x#7: Box :: 
          $IsBox(x#7, GenericPick._default.MapPick2$U) && Map#Domain(m#0)[x#7]);
        assume $IsBox(x#6, GenericPick._default.MapPick2$U);
        assume Map#Domain(m#0)[x#6];
        assume $let#42$canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0);
        assume GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0)
           == x#6;
        assume true;
        // CheckWellformedWithResult: Let expression
        assume $IsBox(GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0), 
