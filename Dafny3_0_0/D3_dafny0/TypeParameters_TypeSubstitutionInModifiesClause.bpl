...
procedure CheckWellformed$$TypeSubstitutionInModifiesClause.C.__ctor(TypeSubstitutionInModifiesClause.C$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, 
...
procedure Call$$TypeSubstitutionInModifiesClause.C.__ctor(TypeSubstitutionInModifiesClause.C$T: Ty)
   returns (this: ref
       where this != null
         && 
        $Is(this, 
  ...
  ensures (forall $o: ref :: 
    { TypeSubstitutionInModifiesClause.C.Repr(TypeSubstitutionInModifiesClause.C$T, this)[$Box($o)] } 
    TypeSubstitutionInModifiesClause.C.Repr(TypeSubstitutionInModifiesClause.C$T, this)[$Box($o)]
       ==> $o != null && !read(old($Heap), $o, alloc));
...
procedure CheckWellformed$$TypeSubstitutionInModifiesClause.C.Update(TypeSubstitutionInModifiesClause.C$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, 
...
procedure Call$$TypeSubstitutionInModifiesClause.C.Update(TypeSubstitutionInModifiesClause.C$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, 
...
procedure CheckWellformed$$TypeSubstitutionInModifiesClause.__default.Client();
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$TypeSubstitutionInModifiesClause.__default.Client();
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure Impl$$TypeSubstitutionInModifiesClause.__default.Client() returns ($_reverifyPost: bool);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$TypeSubstitutionInModifiesClause.__default.Client() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var c#0: ref
     where $Is(c#0, Tclass.TypeSubstitutionInModifiesClause.C(TInt))
  ...
  var $nw: ref;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(397,18): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(398,11)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(398,14)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$TypeSubstitutionInModifiesClause.C.__ctor(TInt);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(398,25)"} true;
    c#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(398,25)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(400,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
           && read($Heap, $o, alloc)
           && TypeSubstitutionInModifiesClause.C.Repr(TInt, c#0)[$Box($o)]
         ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$TypeSubstitutionInModifiesClause.C.Update(TInt, c#0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(400,14)"} true;
}
