...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/bit_fields_fail.c -bpl ./bit_fields_fail.bpl
...
const __const.main.dt: ref;
axiom (__const.main.dt == $sub.ref(0, 1032));
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 12, 8} true;
  ...
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 12, 8} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const.main.dt, 8, false);
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 13, 3} true;
  ...
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bit_fields_fail.c:13:3: warning: over-approximating bitwise operation and; */
  $i4 := $and.i16($i3, 31);
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i16.i32($i4);
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 14, 3} true;
  ...
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bit_fields_fail.c:14:3: warning: over-approximating bitwise operation lshr; */
  $i9 := $lshr.i16($i8, 5);
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/bit_fields_fail.c:14:3: warning: over-approximating bitwise operation and; */
  $i10 := $and.i16($i9, 15);
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 15, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/bits/bit_fields_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
{
$bb0:
  $M.0 := $store.i8($M.0, __const.main.dt, 127);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.dt, $mul.ref(0, 8)), $mul.ref(1, 1)), 1);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(__const.main.dt, $mul.ref(0, 8)), $mul.ref(4, 1)), 2014);
  $exn := false;
  return;
}
