...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock3.c -bpl ./lock3.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 28908));
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock3.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock3.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock3.c", 13, 4} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread/lock3.c", 13, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock3.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock3.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock3.c", 19, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock3.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock3.c", 20, 4} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread/lock3.c", 20, 4} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $i3;
  call {:cexpr "x"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/pthread/lock3.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock3.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock3.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lock3.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/lock3.c", 28, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/pthread/lock3.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "test/c/pthread/lock3.c", 31, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, t2, $0.ref);
  assume {:sourceloc "test/c/pthread/lock3.c", 32, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock3.c", 33, 4} true;
  assume {:verifier.code 0} true;
  $i9 := $M.0;
  assume {:sourceloc "test/c/pthread/lock3.c", 33, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock3.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock3.c", 35, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.3, $p0);
  assume {:sourceloc "test/c/pthread/lock3.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "test/c/pthread/lock3.c", 36, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.4, $p1);
  assume {:sourceloc "test/c/pthread/lock3.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "test/c/pthread/lock3.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/pthread/lock3.c", 37, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/pthread/lock3.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 13428));
...
axiom (__VERIFIER_assert == $sub.ref(0, 14460));
...
axiom (__SMACK_and32 == $sub.ref(0, 15492));
...
axiom (__SMACK_and64 == $sub.ref(0, 16524));
...
axiom (__SMACK_and16 == $sub.ref(0, 17556));
...
axiom (__SMACK_and8 == $sub.ref(0, 18588));
...
axiom (__SMACK_or32 == $sub.ref(0, 19620));
...
axiom (__SMACK_or64 == $sub.ref(0, 20652));
...
axiom (__SMACK_or16 == $sub.ref(0, 21684));
...
axiom (__SMACK_or8 == $sub.ref(0, 22716));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 23748));
...
axiom (__SMACK_decls == $sub.ref(0, 24780));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 25812));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 26844));
...
axiom (llvm.dbg.value == $sub.ref(0, 27876));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 28908));
