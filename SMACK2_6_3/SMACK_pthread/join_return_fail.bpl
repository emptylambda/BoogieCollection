...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/join_return_fail.c -bpl ./join_return_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $p10: ref;
$bb0:
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 19, 4} true;
  ...
  assume true;
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 20, 26} true;
  assume {:verifier.code 0} true;
  call $p4 := malloc(8);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 20, 18} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.ref($M.1, $p1, $p4);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.1, $p1);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p6, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 21, 13} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p7, 2);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $p8 := $load.ref($M.1, $p1);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p8, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 22, 13} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i32($M.3, $p9, 4);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 23, 16} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($p10);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (pthread_exit == $sub.ref(0, 5156));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 32, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.4, $p0);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 32, 19} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i3, $p4);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 33, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 34, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 35, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $p16 := $load.ref($M.5, $p1);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $p17 := $bitcast.ref.ref($p16);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call free_($p17);
  assume {:sourceloc "test/c/pthread/join_return_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 12380));
...
axiom (__VERIFIER_assert == $sub.ref(0, 13412));
