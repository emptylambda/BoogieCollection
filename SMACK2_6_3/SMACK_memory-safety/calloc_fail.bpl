...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/calloc_fail.c -bpl ./calloc_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 7, 21} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 7, 21} true;
  assume {:verifier.code 0} true;
  call $p0 := calloc(5, 4);
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 7, 14} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 8, 13} true;
  ...
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.ref($p1, $0.ref);
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 9, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 10, 5} true;
  assume {:verifier.code 0} true;
  $i4 := 1;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 14, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call free_($p9);
  assume {:sourceloc "test/c/memory-safety/calloc_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb3;
}
const free_: ref;
axiom (free_ == $sub.ref(0, 2064));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 21672));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 22704));
