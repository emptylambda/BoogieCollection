...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/array4.c -bpl ./array4.bpl
...
procedure {:inline 1} initializeArray($p0: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/data/array4.c", 21, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array4.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array4.c", 21, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "test/c/data/array4.c", 21, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/array4.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/array4.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0, $mul.ref($i3, 12));
  assume {:sourceloc "test/c/data/array4.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref($i3, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/array4.c", 22, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p5, 0);
  assume {:sourceloc "test/c/data/array4.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/array4.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/array4.c", 21, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/array4.c", 28, 25} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/array4.c", 28, 25} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(120);
  assume {:sourceloc "test/c/data/array4.c", 28, 17} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/array4.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call initializeArray($p1);
  assume {:sourceloc "test/c/data/array4.c", 32, 8} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array4.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array4.c", 32, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, 10);
  assume {:sourceloc "test/c/data/array4.c", 32, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/array4.c", 33, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/array4.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/array4.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call free_($p11);
  assume {:sourceloc "test/c/data/array4.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/data/array4.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/data/array4.c", 32, 29} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i2, 1);
