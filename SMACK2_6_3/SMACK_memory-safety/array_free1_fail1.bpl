...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/array_free1_fail1.c -bpl ./array_free1_fail1.bpl
...
procedure {:inline 1} free_array()
{
  ...
  var $i31: i32;
$bb0:
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 20, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 20, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 21, 21} true;
  assume {:verifier.code 0} true;
  call $p3 := malloc(4);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i5, 16));
  $p7 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i5, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 21, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p7, $p3);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i8, 16));
  $p10 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i8, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $p11 := $load.ref($M.0, $p10);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 22, 15} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p11, 1);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $i12 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i12, 16));
  $p14 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i12, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 23, 12} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p14, 2);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 20, 29} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i1, 1);
...
$bb5:
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 26, 17} true;
  assume {:verifier.code 0} true;
  $i17 := $slt.i32($i16, 4);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 26, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i17 == 1);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 27, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $sext.i32.i64($i16);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 27, 9} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i18, 16));
  $p20 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i18, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 27, 14} true;
  assume {:verifier.code 0} true;
  $p21 := $load.ref($M.0, $p20);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 27, 16} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i17 == 1));
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb8:
  assume ($i22 == 1);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $i23 := $sext.i32.i64($i16);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i23, 16));
  $p25 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i23, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 28, 17} true;
  assume {:verifier.code 0} true;
  $p26 := $load.ref($M.0, $p25);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $p27 := $bitcast.ref.ref($p26);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 28, 7} true;
  assume {:verifier.code 0} true;
  call free_($p27);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 29, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $sext.i32.i64($i16);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 29, 7} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i28, 16));
  $p30 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 80)), $mul.ref($i28, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 29, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p30, $0.ref);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 27, 9} true;
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 26, 33} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i32($i16, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call free_array();
  assume {:sourceloc "test/c/memory-safety/array_free1_fail1.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
