...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/simple_pre1_fail.c -bpl ./simple_pre1_fail.bpl
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/basic/simple_pre1_fail.c", 7, 26} true;
  ...
  assume {:sourceloc "test/c/basic/simple_pre1_fail.c", 7, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/simple_pre1_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/simple_pre1_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  call $i0 := incr($sub.i32(0, 1));
  call {:cexpr "a"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/simple_pre1_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/simple_pre1_fail.c", 14, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/simple_pre1_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
