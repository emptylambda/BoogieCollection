...
procedure CheckWellformed$$CanCallRegressionTests.C.Id(this: ref
       where this != null
         && 
        $Is(this, Tclass.CanCallRegressionTests.C())
         && $IsAlloc(this, Tclass.CanCallRegressionTests.C(), $Heap), 
    c#0: ref where $Is(c#0, Tclass.CanCallRegressionTests.C()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure CheckWellformed$$CanCallRegressionTests.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.CanCallRegressionTests.C())
         && $IsAlloc(this, Tclass.CanCallRegressionTests.C(), $Heap));
...
procedure Call$$CanCallRegressionTests.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.CanCallRegressionTests.C())
         && $IsAlloc(this, Tclass.CanCallRegressionTests.C(), $Heap));
...
procedure Impl$$CanCallRegressionTests.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.CanCallRegressionTests.C())
         && $IsAlloc(this, Tclass.CanCallRegressionTests.C(), $Heap))
...
function $let#0_c(this: ref) : ref;

function $let#0$canCall(this: ref) : bool;

axiom (forall this: ref :: 
  { $let#0_c(this) } 
  $let#0$canCall(this)
     ==> $Is($let#0_c(this), Tclass.CanCallRegressionTests.C()) && $let#0_c(this) == this);

function $let#1_c(this: ref) : ref;

function $let#1$canCall(this: ref) : bool;

axiom (forall this: ref :: 
  { $let#1_c(this) } 
  $let#1$canCall(this)
     ==> $Is($let#1_c(this), Tclass.CanCallRegressionTests.C()) && $let#1_c(this) == this);

implementation Impl$$CanCallRegressionTests.C.M(this: ref) returns ($_reverifyPost: bool)
{
  ...
  var c#2: ref;
    ...
    // AddMethodImpl: M, Impl$$CanCallRegressionTests.C.M
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(365,4): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(366,7)
    ##c#0 := this;
    // assume allocatedness for argument to function
    assume $IsAlloc(##c#0, Tclass.CanCallRegressionTests.C(), $Heap);
    assume CanCallRegressionTests.C.Id#canCall(this, this);
    assume CanCallRegressionTests.C.Id#canCall(this, this);
    assert CanCallRegressionTests.C.Id(this, this) == this;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(367,13)
    assume true;
    ##c#1 := this;
    // assume allocatedness for argument to function
    assume $IsAlloc(##c#1, Tclass.CanCallRegressionTests.C(), $Heap);
    assume CanCallRegressionTests.C.Id#canCall(this, this);
    assert CanCallRegressionTests.C.Id(this, this) != null;
    assume CanCallRegressionTests.C.Id#canCall(this, this);
    e#0 := read($Heap, CanCallRegressionTests.C.Id(this, this), CanCallRegressionTests.C.x);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(367,25)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(368,7)
    havoc c#0;
    if ($Is(c#0, Tclass.CanCallRegressionTests.C()))
    {
    }

    assert ($Is(this, Tclass.CanCallRegressionTests.C()) && this == this)
       || 
      ($Is(null, Tclass.CanCallRegressionTests.C()) && null == this)
       || (exists c#1: ref :: $Is(c#1, Tclass.CanCallRegressionTests.C()) && c#1 == this);
    assume $Is(c#0, Tclass.CanCallRegressionTests.C());
    assume c#0 == this;
    assume $let#0$canCall(this);
    assume $let#0$canCall(this);
    assert (var c#1 := $let#0_c(this); c#1) == this;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(369,13)
    assume true;
    havoc c#2;
    if ($Is(c#2, Tclass.CanCallRegressionTests.C()))
    {
    }
    ...
    assert ($Is(this, Tclass.CanCallRegressionTests.C()) && this == this)
       || 
      ($Is(null, Tclass.CanCallRegressionTests.C()) && null == this)
       || (exists c#3: ref :: $Is(c#3, Tclass.CanCallRegressionTests.C()) && c#3 == this);
    assume $Is(c#2, Tclass.CanCallRegressionTests.C());
    assume c#2 == this;
    assume $let#1$canCall(this);
    assert (var c#3 := $let#1_c(this); c#3) != null;
    assume $let#1$canCall(this);
    d#0 := read($Heap, (var c#3 := $let#1_c(this); c#3), CanCallRegressionTests.C.x);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(369,43)"} true;
}
