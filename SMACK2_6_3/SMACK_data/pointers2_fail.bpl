...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/pointers2_fail.c -bpl ./pointers2_fail.bpl
...
procedure {:inline 1} incr($p0: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/data/pointers2_fail.c", 15, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/pointers2_fail.c", 15, 6} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/pointers2_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/pointers2_fail.c", 16, 6} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/pointers2_fail.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.1, $p4);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 16, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/pointers2_fail.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure {:inline 1} decr($p0: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/data/pointers2_fail.c", 20, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/pointers2_fail.c", 20, 6} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/pointers2_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, $i3);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 21, 6} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/pointers2_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.1, $p4);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, $i6);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 22, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/pointers2_fail.c", 25, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 25, 13} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $add.ref($add.ref(p, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 25, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, p, 0);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call incr(p);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call decr(p);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call decr(p);
  assume {:sourceloc "test/c/data/pointers2_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/pointers2_fail.c", 31, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/pointers2_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/data/pointers2_fail.c", 32, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/data/pointers2_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
