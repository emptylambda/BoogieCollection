...
procedure CheckWellformed$$B.__default.P(x#0: int, y#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$B.__default.P(x#0: int, y#0: int);
  modifies $Heap, $Tick;
...
procedure Impl$$B.__default.P(x#0: int, y#0: int) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
