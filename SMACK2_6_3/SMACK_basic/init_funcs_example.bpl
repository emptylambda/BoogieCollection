...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/init_funcs_example.c -bpl ./init_funcs_example.bpl
...
{
$bb0:
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 17, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 17, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 18, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 19, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 20, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 21, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 22, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 23, 1} true;
...
{
$bb0:
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 29, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 29, 3} true;
  assume {:verifier.code 1} true;
  assume (forall x:ref :: $processStatus[x] == $process_uninitialized);
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 34, 15} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 35, 3} true;
  assume {:verifier.code 1} true;
  assert($processStatus[$p0] == $process_uninitialized);
  assume {:sourceloc "test/c/basic/init_funcs_example.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
