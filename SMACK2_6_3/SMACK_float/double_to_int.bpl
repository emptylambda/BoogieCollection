...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/double_to_int.c -bpl ./double_to_int.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/double_to_int.c", 8, 11} true;
  ...
  assume {:sourceloc "test/c/float/double_to_int.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/double_to_int.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/double_to_int.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
