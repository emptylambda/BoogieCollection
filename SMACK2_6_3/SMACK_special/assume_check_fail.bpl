...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/special/assume_check_fail.c -bpl ./assume_check_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/special/assume_check_fail.c", 8, 20} true;
  ...
  assume {:sourceloc "test/c/special/assume_check_fail.c", 9, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/special/assume_check_fail.c", 13, 23} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check_fail.c:13:23: warning: over-approximating bitwise operation xor; */
  $i2 := $xor.i32($i0, $i1);
  assume {:sourceloc "test/c/special/assume_check_fail.c", 13, 34} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check_fail.c:13:34: warning: over-approximating bitwise operation xor; */
  $i3 := $xor.i32($i1, $i0);
  assume {:sourceloc "test/c/special/assume_check_fail.c", 13, 28} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i2, $i3);
  assume {:sourceloc "test/c/special/assume_check_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/special/assume_check_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/special/assume_check_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check_fail.c:14:3: warning: over-approximating bitwise operation xor; */
  $i5 := $xor.i32($i0, $i1);
  assume {:sourceloc "test/c/special/assume_check_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check_fail.c:14:3: warning: over-approximating bitwise operation xor; */
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/special/assume_check_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const llvm.assume: ref;
axiom (llvm.assume == $sub.ref(0, 2064));
procedure {:inline 1} llvm.assume($i0: i1);
...
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 16512));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 17544));
