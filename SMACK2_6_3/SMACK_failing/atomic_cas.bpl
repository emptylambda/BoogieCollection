...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/failing/atomic_cas.c -bpl ./atomic_cas.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/failing/atomic_cas.c", 9, 8} true;
  ...
  assume true;
  assume {:sourceloc "test/c/failing/atomic_cas.c", 10, 7} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, 0);
  assume true;
  assume {:sourceloc "test/c/failing/atomic_cas.c", 11, 12} true;
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.0, $p0);
  assume {:sourceloc "test/c/failing/atomic_cas.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p2, $p4);
  assume {:sourceloc "test/c/failing/atomic_cas.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/failing/atomic_cas.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i12 == 1));
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/failing/atomic_cas.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
