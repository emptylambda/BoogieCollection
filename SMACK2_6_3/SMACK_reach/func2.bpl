...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/func2.c -bpl ./func2.bpl
...
const func: ref;
axiom (func == $sub.ref(0, 1032));
procedure {:inline 1} func()
  returns ($r: i32)
{
$bb0:
  assume {:sourceloc "test/c/reach/func2.c", 3, 14} true;
...
const func2: ref;
axiom (func2 == $sub.ref(0, 2064));
procedure {:inline 1} func2()
  returns ($r: i32)
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "test/c/reach/func2.c", 5, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/func2.c", 5, 22} true;
  assume {:verifier.code 0} true;
  call $i0 := func();
  assume {:sourceloc "test/c/reach/func2.c", 5, 15} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/func2.c", 9, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/reach/func2.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
