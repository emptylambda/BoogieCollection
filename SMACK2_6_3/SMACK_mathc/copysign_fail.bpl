...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/copysign_fail.c -bpl ./copysign_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 12, 14} true;
  ...
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 13, 14} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  call $i2 := __isnan($f0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 19} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 28, 8} true;
  assume {:verifier.code 0} true;
  call $i21 := __isnan($f1);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 28, 8} true;
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i21, 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 28, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i22} true;
  goto $bb28, $bb30;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 23} true;
  assume {:verifier.code 0} true;
  call $i4 := __isinf($f0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 34} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 38} true;
  assume {:verifier.code 0} true;
  call $i6 := __iszero($f0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 10} true;
  assume {:verifier.code 0} true;
  call $i8 := __isnan($f1);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 21} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb10:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 25} true;
  assume {:verifier.code 0} true;
  call $i10 := __isinf($f1);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 25} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 36} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i11 == 1));
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 40} true;
  assume {:verifier.code 0} true;
  call $i12 := __iszero($f1);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 40} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 16, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i13 == 1));
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 17, 20} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/copysign_fail.c:17:20: warning: over-approximating unmodeled operation llvm.copysign.f64; */
  call $f14 := llvm.copysign.f64($f0, $f1);
  call {:cexpr "val"} boogie_si_record_float($f14);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 18, 11} true;
  assume {:verifier.code 0} true;
  call $i15 := __signbit($f0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 18, 26} true;
  assume {:verifier.code 0} true;
  call $i16 := __signbit($f1);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 18, 24} true;
  assume {:verifier.code 0} true;
  $i17 := $sub.i32($i15, $i16);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 18, 24} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i18 == 1);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 19, 9} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i18 == 1));
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb17:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 19, 9} true;
  assume {:verifier.code 0} true;
  $i19 := (if $foeq.float.bool($f14, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 19, 9} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb19;
$bb21:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 23, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb23:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i20 := (if $foeq.float.bool($f14, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb30:
  assume !(($i22 == 1));
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 29, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/copysign_fail.c:29:18: warning: over-approximating unmodeled operation llvm.copysign.f64; */
  call $f23 := llvm.copysign.f64($fp(0, 7, 8000000000000), $f1);
  call {:cexpr "val"} boogie_si_record_float($f23);
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 30, 5} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/copysign_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb29;
}
...
procedure {:inline 1} __iszero($f0: float)
  returns ($r: i32);
const llvm.copysign.f64: ref;
axiom (llvm.copysign.f64 == $sub.ref(0, 6192));
procedure {:inline 1} llvm.copysign.f64($f0: float, $f1: float)
  returns ($r: float);
const __signbit: ref;
