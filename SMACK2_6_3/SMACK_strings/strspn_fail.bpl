...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strspn_fail.c -bpl ./strspn_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 23728));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strspn_fail.c", 8, 16} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strspn_fail.c", 8, 16} true;
  assume {:verifier.code 0} true;
  call $i0 := strspn(.str, .str.1);
  call {:cexpr "end"} boogie_si_record_i64($i0);
  assume {:sourceloc "test/c/strings/strspn_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strspn_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strspn_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 8248));
...
axiom (__VERIFIER_assert == $sub.ref(0, 9280));
...
axiom (__SMACK_and32 == $sub.ref(0, 10312));
...
axiom (__SMACK_and64 == $sub.ref(0, 11344));
...
axiom (__SMACK_and16 == $sub.ref(0, 12376));
...
axiom (__SMACK_and8 == $sub.ref(0, 13408));
...
axiom (__SMACK_or32 == $sub.ref(0, 14440));
...
axiom (__SMACK_or64 == $sub.ref(0, 15472));
...
axiom (__SMACK_or16 == $sub.ref(0, 16504));
...
axiom (__SMACK_or8 == $sub.ref(0, 17536));
...
axiom (__SMACK_decls == $sub.ref(0, 19600));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 20632));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21664));
...
axiom (llvm.dbg.value == $sub.ref(0, 22696));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 23728));
