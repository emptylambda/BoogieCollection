...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/global_alloc_fail_free.c -bpl ./global_alloc_fail_free.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/global_alloc_fail_free.c", 10, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/memory-safety/global_alloc_fail_free.c", 10, 11} true;
  assume {:verifier.code 0} true;
  $p0 := $add.ref(x, $mul.ref(0, 4));
  assume {:sourceloc "test/c/memory-safety/global_alloc_fail_free.c", 10, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/memory-safety/global_alloc_fail_free.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref(x);
  assume {:sourceloc "test/c/memory-safety/global_alloc_fail_free.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call free_($p2);
  assume {:sourceloc "test/c/memory-safety/global_alloc_fail_free.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 6188));
