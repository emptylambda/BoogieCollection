...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strcmp_fail.c -bpl ./strcmp_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 22698));
...
axiom (.str.1 == $sub.ref(0, 2058));
const main: ref;
axiom (main == $sub.ref(0, 3090));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strcmp_fail.c", 9, 20} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strcmp_fail.c", 9, 20} true;
  assume {:verifier.code 0} true;
  call $i0 := strcmp(.str, .str.1);
  call {:cexpr "comparison"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/strings/strcmp_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strcmp_fail.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strcmp_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 7218));
...
axiom (__VERIFIER_assert == $sub.ref(0, 8250));
...
axiom (__SMACK_and32 == $sub.ref(0, 9282));
...
axiom (__SMACK_and64 == $sub.ref(0, 10314));
...
axiom (__SMACK_and16 == $sub.ref(0, 11346));
...
axiom (__SMACK_and8 == $sub.ref(0, 12378));
...
axiom (__SMACK_or32 == $sub.ref(0, 13410));
...
axiom (__SMACK_or64 == $sub.ref(0, 14442));
...
axiom (__SMACK_or16 == $sub.ref(0, 15474));
...
axiom (__SMACK_or8 == $sub.ref(0, 16506));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17538));
...
axiom (__SMACK_decls == $sub.ref(0, 18570));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 19602));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 20634));
...
axiom (llvm.dbg.value == $sub.ref(0, 21666));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 22698));
