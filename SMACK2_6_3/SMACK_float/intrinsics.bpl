...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/intrinsics.c -bpl ./intrinsics.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/intrinsics.c", 6, 13} true;
  ...
  assume {:sourceloc "test/c/float/intrinsics.c", 7, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/intrinsics.c", 8, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/float/intrinsics.c", 8, 3} true;
  ...
  assume {:sourceloc "test/c/float/intrinsics.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/intrinsics.c:8:3: warning: over-approximating call to llvm.fabs.f64; */
  call $f3 := llvm.fabs.f64($f2);
  assume {:sourceloc "test/c/float/intrinsics.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/intrinsics.c:8:3: warning: over-approximating floating-point arithmetic fneg; */
  $f4 := $fneg.float($f0);
  assume {:sourceloc "test/c/float/intrinsics.c", 8, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/float/intrinsics.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i6 := (if $foeq.float.bool($f3, $f5) then 1 else 0);
  assume {:sourceloc "test/c/float/intrinsics.c", 8, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/float/intrinsics.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
