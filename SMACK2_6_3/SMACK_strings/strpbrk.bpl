...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strpbrk.c -bpl ./strpbrk.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24756));
...
axiom (.str.1 == $sub.ref(0, 2056));
const {:count 4} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 3084));
const main: ref;
axiom (main == $sub.ref(0, 4116));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strpbrk.c", 8, 25} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strpbrk.c", 8, 25} true;
  assume {:verifier.code 0} true;
  call $p0 := strpbrk(.str, .str.1);
  assume $isExternal($p0);
  assume {:sourceloc "test/c/strings/strpbrk.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strpbrk.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := strcmp($p0, .str.2);
  assume {:sourceloc "test/c/strings/strpbrk.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "test/c/strings/strpbrk.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strpbrk.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strpbrk: ref;
axiom (strpbrk == $sub.ref(0, 5148));
procedure {:inline 1} strpbrk($p0: ref, $p1: ref)
  returns ($r: ref);
const strcmp: ref;
axiom (strcmp == $sub.ref(0, 6180));
procedure {:inline 1} strcmp($p0: ref, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 7212));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 8244));
...
axiom (__SMACK_dummy == $sub.ref(0, 9276));
...
axiom (__VERIFIER_assert == $sub.ref(0, 10308));
...
axiom (__SMACK_and32 == $sub.ref(0, 11340));
...
axiom (__SMACK_and64 == $sub.ref(0, 12372));
...
axiom (__SMACK_and16 == $sub.ref(0, 13404));
...
axiom (__SMACK_and8 == $sub.ref(0, 14436));
...
axiom (__SMACK_or32 == $sub.ref(0, 15468));
...
axiom (__SMACK_or64 == $sub.ref(0, 16500));
...
axiom (__SMACK_or16 == $sub.ref(0, 17532));
...
axiom (__SMACK_or8 == $sub.ref(0, 18564));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19596));
...
axiom (__SMACK_decls == $sub.ref(0, 20628));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 21660));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 22692));
...
axiom (llvm.dbg.value == $sub.ref(0, 23724));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 24756));
