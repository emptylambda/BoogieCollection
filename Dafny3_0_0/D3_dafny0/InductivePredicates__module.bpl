// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy -print:./InductivePredicates.bpl
...
axiom (forall a#14#0#0: int :: 
  { #_module.natinf.N(a#14#0#0) } 
  DatatypeCtorId(#_module.natinf.N(a#14#0#0)) == ##_module.natinf.N);
...
axiom (forall d: DatatypeType :: 
  { _module.natinf.N_q(d) } 
  _module.natinf.N_q(d)
     ==> (exists a#15#0#0: int :: d == #_module.natinf.N(a#15#0#0)));
...
axiom (forall a#16#0#0: int :: 
  { $Is(#_module.natinf.N(a#16#0#0), Tclass._module.natinf()) } 
  $Is(#_module.natinf.N(a#16#0#0), Tclass._module.natinf())
     <==> $Is(a#16#0#0, Tclass._System.nat()));

// Constructor $IsAlloc
axiom (forall a#17#0#0: int, $h: Heap :: 
  { $IsAlloc(#_module.natinf.N(a#17#0#0), Tclass._module.natinf(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.natinf.N(a#17#0#0), Tclass._module.natinf(), $h)
...
axiom (forall a#18#0#0: int :: 
  { #_module.natinf.N(LitInt(a#18#0#0)) } 
  #_module.natinf.N(LitInt(a#18#0#0)) == Lit(#_module.natinf.N(a#18#0#0)));

function _module.natinf.n(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#19#0#0: int :: 
  { #_module.natinf.N(a#19#0#0) } 
  _module.natinf.n(#_module.natinf.N(a#19#0#0)) == a#19#0#0);
...
// Constructor $IsAlloc
axiom (forall $h: Heap :: 
  { $IsAlloc(#_module.natinf.Inf(), Tclass._module.natinf(), $h) } 
  $IsGoodHeap($h) ==> $IsAlloc(#_module.natinf.Inf(), Tclass._module.natinf(), $h));
...
procedure CheckWellformed$$_module.__default.Even(x#0: DatatypeType where $Is(x#0, Tclass._module.natinf()));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.Even(x#0: DatatypeType)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(6,16): initial state"} true;
    ...
    else
    {
        ...
        if (!(_module.natinf.N_q(x#0) && _module.natinf.n(x#0) == LitInt(0)))
        {
            ...
            {
                assert _module.natinf.N_q(x#0);
                assert $Is(_module.natinf.n(x#0) - 2, Tclass._System.nat());
        ...
        assume _module.__default.Even($LS($LZ), x#0)
           == ((_module.natinf.N_q(x#0) && _module.natinf.n(x#0) == LitInt(0))
             || (
              _module.natinf.N_q(x#0)
               && LitInt(2) <= _module.natinf.n(x#0)
...
axiom 3 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: DatatypeType :: 
    ...
    _module.__default.Even_h#canCall(_k#0, x#0)
         || (3 != $FunctionContextHeight && $Is(x#0, Tclass._module.natinf()))
       ==> true);
...
procedure {:_induction x#0} CheckWellformed$$_module.__default.M(x#0: DatatypeType
...
implementation {:_induction x#0} CheckWellformed$$_module.__default.M(x#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(12,6): initial state"} true;
    ##x#0 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, Tclass._module.natinf(), $Heap);
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(14,15): post-state"} true;
    assume _module.natinf.N_q(x#0);
    assert _module.natinf.N_q(x#0);
    assert LitInt(2) != 0;
    assume Mod(_module.natinf.n(x#0), LitInt(2)) == LitInt(0);
}



procedure {:_induction x#0} Call$$_module.__default.M(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
  // user-defined preconditions
  requires _module.__default.Even#canCall(x#0)
  ...
  free ensures true;
  ensures _module.natinf.N_q(x#0);
  ensures Mod(_module.natinf.n(x#0), LitInt(2)) == LitInt(0);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:_induction x#0} Impl$$_module.__default.M(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0))
  ...
  free requires 13 == $FunctionContextHeight;
  // user-defined preconditions
  free requires _module.__default.Even#canCall(x#0)
     && 
    _module.__default.Even($LS($LZ), x#0)
     && ((_module.natinf.N_q(x#0) && _module.natinf.n(x#0) == LitInt(0))
       || (
...
implementation {:_induction x#0} Impl$$_module.__default.M(x#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var x##0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(15,0): initial state"} true;
    ...
    $_reverifyPost := false;
    // ----- assign-such-that statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(16,18)
    havoc k#1;
    if (true)
    {
        ##_k#0 := k#1;
    ...
    assert (exists $as#k0#0: Box :: _module.__default.Even_h($LS($LZ), $as#k0#0, x#0));
    havoc k#0;
    assume _module.__default.Even_h($LS($LZ), k#0, x#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(16,31)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(17,5)
    ...
    call Call$$_module.__default.M_k(k##0, x##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(17,10)"} true;
}



procedure {:induction false} CheckWellformed$$_module.__default.M_k(k#0: Box, 
    x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
...
implementation {:induction false} CheckWellformed$$_module.__default.M_k(k#0: Box, x#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##_k#0: Box;
  var ##x#0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(21,25): initial state"} true;
    ##_k#0 := k#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##_k#0, TORDINAL, $Heap);
    ##x#0 := x#0;
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(23,15): post-state"} true;
    assume _module.natinf.N_q(x#0);
    assert _module.natinf.N_q(x#0);
    assert LitInt(2) != 0;
    assume Mod(_module.natinf.n(x#0), LitInt(2)) == LitInt(0);
...
procedure {:induction false} Call$$_module.__default.M_k(k#0: Box, 
    x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
  // user-defined preconditions
  requires _module.__default.Even_h#canCall(k#0, x#0)
...
procedure {:induction false} Impl$$_module.__default.M_k(k#0: Box, 
    x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0))
  ...
  free requires 12 == $FunctionContextHeight;
  // user-defined preconditions
  free requires _module.__default.Even_h#canCall(k#0, x#0)
     && 
    _module.__default.Even_h($LS($LZ), k#0, x#0)
     && 
    (0 < ORD#Offset(k#0)
...
implementation {:induction false} Impl$$_module.__default.M_k(k#0: Box, x#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##_k#0_0_0: Box;
  ...
  var x##0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(24,0): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(25,3)
    assume true;
    if (ORD#IsSucc(k#0))
    {
        // ----- alternative statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(26,5)
        if (*)
        {
            if (_module.natinf.N_q(x#0))
            {
        ...
        else if (*)
        {
            ...
            assume _module.natinf.N_q(x#0)
               ...
               && _module.__default.Even_h($LS($LZ), 
                ORD#Minus(k#0, ORD#FromNat(1)), 
                #_module.natinf.N(_module.natinf.n(x#0) - 2));
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(30,11)
            // TrCallStmt: Before ProcessCallStmt
            assert ORD#IsNat(Lit(ORD#FromNat(1)));
            assert ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(k#0);
            assume true;
            ...
            x##0_0_0 := #_module.natinf.N(_module.natinf.n(x#0) - 2);
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assert ORD#Less(k##0_0_0, k#0) || (k##0_0_0 == k#0 && DtRank(x##0_0_0) < DtRank(x#0));
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.M_k(k##0_0_0, x##0_0_0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(30,27)"} true;
        }
        else
        {
            assume true;
    ...
    {
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(33,5)
        assume true;
        assert ORD#IsLimit(k#0);
        // ----- assign-such-that statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(34,12)
        havoc k'#1;
        if (true)
        {
            if (ORD#Less(k'#1, k#0))
            ...
            assume ORD#Less(k'#1, k#0) ==> _module.__default.Even_h#canCall(k'#1, x#0);
        }

        assert (exists $as#k'0#0: Box :: 
          ORD#Less($as#k'0#0, k#0) && _module.__default.Even_h($LS($LZ), $as#k'0#0, x#0));
        havoc k'#0;
        assume ORD#Less(k'#0, k#0) && _module.__default.Even_h($LS($LZ), k'#0, x#0);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(34,36)"} true;
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(35,7)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        k##0 := k'#0;
        ...
        x##0 := x#0;
        assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assert ORD#Less(k##0, k#0) || (k##0 == k#0 && DtRank(x##0) < DtRank(x#0));
        // ProcessCallStmt: Make the call
        call Call$$_module.__default.M_k(k##0, x##0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(35,13)"} true;
    }
}



procedure {:_induction k#0, x#0} CheckWellformed$$_module.__default.M_k__auto(k#0: Box, 
    x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
...
implementation {:_induction k#0, x#0} CheckWellformed$$_module.__default.M_k__auto(k#0: Box, x#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##_k#0: Box;
  var ##x#0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(39,6): initial state"} true;
    ##_k#0 := k#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##_k#0, TORDINAL, $Heap);
    ##x#0 := x#0;
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(41,15): post-state"} true;
    assume _module.natinf.N_q(x#0);
    assert _module.natinf.N_q(x#0);
    assert LitInt(2) != 0;
    assume Mod(_module.natinf.n(x#0), LitInt(2)) == LitInt(0);
...
procedure {:_induction k#0, x#0} Call$$_module.__default.M_k__auto(k#0: Box, 
    x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
...
procedure {:_induction k#0, x#0} Impl$$_module.__default.M_k__auto(k#0: Box, 
    x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0))
...
implementation {:_induction k#0, x#0} Impl$$_module.__default.M_k__auto(k#0: Box, x#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(42,0): initial state"} true;
    assume $IsA#_module.natinf(x#0);
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
...
procedure {:induction false} CheckWellformed$$_module.__default.IL(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
...
implementation {:induction false} CheckWellformed$$_module.__default.IL(x#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(46,31): initial state"} true;
    ##x#0 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, Tclass._module.natinf(), $Heap);
    assume _module.__default.Even#canCall(x#0);
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(48,15): post-state"} true;
    assume _module.natinf.N_q(x#0);
    assert _module.natinf.N_q(x#0);
    assert LitInt(2) != 0;
    assume Mod(_module.natinf.n(x#0), LitInt(2)) == LitInt(0);
...
procedure {:induction false} Call$$_module.__default.IL(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
  // user-defined preconditions
...
procedure {:induction false} CoCall$$_module.__default.IL_h(_k#0: Box, 
    x#1: DatatypeType
       where $Is(x#1, Tclass._module.natinf())
         && $IsAlloc(x#1, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#1));
  // user-defined preconditions
  requires _module.__default.Even_h#canCall(_k#0, x#1)
  ...
  // user-defined postconditions
  free ensures true;
  ensures _module.natinf.N_q(x#1);
  ensures Mod(_module.natinf.n(x#1), LitInt(2)) == LitInt(0);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:induction false} Impl$$_module.__default.IL_h(_k#0: Box, 
    x#1: DatatypeType
       where $Is(x#1, Tclass._module.natinf())
         && $IsAlloc(x#1, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#1))
  ...
  // user-defined preconditions
  free requires _module.__default.Even_h#canCall(_k#0, x#1)
     && 
    _module.__default.Even_h($LS($LZ), _k#0, x#1)
     && 
    (0 < ORD#Offset(_k#0)
...
implementation {:induction false} Impl$$_module.__default.IL_h(_k#0: Box, x#1: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##_k#0: Box;
  var ##x#1: DatatypeType;
  ...
  var $initHeapForallStmt#0: Heap;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(46,31): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(49,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- alternative statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(50,3)
        if (*)
        {
            if (_module.natinf.N_q(x#1))
            {
                assert _module.natinf.N_q(x#1);
            }

            assume true;
            assume _module.natinf.N_q(x#1) && _module.natinf.n(x#1) == LitInt(0);
        }
        else if (*)
        {
            if (_module.natinf.N_q(x#1))
            ...
            if (_module.natinf.N_q(x#1) && LitInt(2) <= _module.natinf.n(x#1))
            {
                ...
                assert _module.natinf.N_q(x#1);
                assert $Is(_module.natinf.n(x#1) - 2, Tclass._System.nat());
            ...
            assume _module.natinf.N_q(x#1)
               ...
               && _module.__default.Even_h($LS($LZ), 
                ORD#Minus(_k#0, ORD#FromNat(1)), 
                #_module.natinf.N(_module.natinf.n(x#1) - 2));
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(54,9)
            // TrCallStmt: Before ProcessCallStmt
            assert ORD#IsNat(Lit(ORD#FromNat(1)));
            assert ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
            assume true;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call CoCall$$_module.__default.IL_h(_k##0, x##0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(54,20)"} true;
        }
        else
        {
            assume true;
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(46,32)
        $initHeapForallStmt#0 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#0 == $Heap;
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(46,31)"} true;
    }
}



procedure {:induction false} CheckWellformed$$_module.__default.IL__EvenBetter(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
...
implementation {:induction false} CheckWellformed$$_module.__default.IL__EvenBetter(x#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(58,31): initial state"} true;
    ##x#0 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, Tclass._module.natinf(), $Heap);
    assume _module.__default.Even#canCall(x#0);
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(60,15): post-state"} true;
    assume _module.natinf.N_q(x#0);
    assert _module.natinf.N_q(x#0);
    assert LitInt(2) != 0;
    assume Mod(_module.natinf.n(x#0), LitInt(2)) == LitInt(0);
...
procedure {:induction false} Call$$_module.__default.IL__EvenBetter(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
  // user-defined preconditions
...
procedure {:induction false} CoCall$$_module.__default.IL__EvenBetter_h(_k#0: Box, 
    x#1: DatatypeType
       where $Is(x#1, Tclass._module.natinf())
         && $IsAlloc(x#1, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#1));
...
procedure {:induction false} Impl$$_module.__default.IL__EvenBetter_h(_k#0: Box, 
    x#1: DatatypeType
       where $Is(x#1, Tclass._module.natinf())
         && $IsAlloc(x#1, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#1))
...
implementation {:induction false} Impl$$_module.__default.IL__EvenBetter_h(_k#0: Box, x#1: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##_k#0: Box;
  var ##x#1: DatatypeType;
  ...
  var $initHeapForallStmt#0: Heap;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(58,31): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(61,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- alternative statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(62,3)
        if (*)
        {
            if (_module.natinf.N_q(x#1))
            {
        ...
        else if (*)
        {
            ...
            assume _module.natinf.N_q(x#1)
               ...
               && _module.__default.Even_h($LS($LZ), 
                ORD#Minus(_k#0, ORD#FromNat(1)), 
                #_module.natinf.N(_module.natinf.n(x#1) - 2));
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(66,20)
            // TrCallStmt: Before ProcessCallStmt
            assert ORD#IsNat(Lit(ORD#FromNat(1)));
            assert ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
            assume true;
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call CoCall$$_module.__default.IL__EvenBetter_h(_k##0, x##0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(66,31)"} true;
        }
        else
        {
            assume true;
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(58,32)
        $initHeapForallStmt#0 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#0 == $Heap;
        assume (forall _k'#2: Box, x#2: DatatypeType :: 
          $Is(x#2, Tclass._module.natinf())
              ...
              ORD#Less(_k'#2, _k#0)
               && _module.__default.Even_h($LS($LZ), _k'#2, x#2)
             ==> _module.natinf.N_q(x#2) && Mod(_module.natinf.n(x#2), LitInt(2)) == LitInt(0));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(58,31)"} true;
    }
}



procedure CheckWellformed$$_module.__default.IL__Best(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
...
implementation CheckWellformed$$_module.__default.IL__Best(x#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(70,12): initial state"} true;
    ##x#0 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, Tclass._module.natinf(), $Heap);
    assume _module.__default.Even#canCall(x#0);
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(72,15): post-state"} true;
    assume _module.natinf.N_q(x#0);
    assert _module.natinf.N_q(x#0);
    assert LitInt(2) != 0;
    assume Mod(_module.natinf.n(x#0), LitInt(2)) == LitInt(0);
...
procedure Call$$_module.__default.IL__Best(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
  // user-defined preconditions
...
procedure {:_induction _k#0, x#1} CoCall$$_module.__default.IL__Best_h(_k#0: Box, 
    x#1: DatatypeType
       where $Is(x#1, Tclass._module.natinf())
         && $IsAlloc(x#1, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#1));
...
procedure {:_induction _k#0, x#1} Impl$$_module.__default.IL__Best_h(_k#0: Box, 
    x#1: DatatypeType
       where $Is(x#1, Tclass._module.natinf())
         && $IsAlloc(x#1, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#1))
...
implementation {:_induction _k#0, x#1} Impl$$_module.__default.IL__Best_h(_k#0: Box, x#1: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  var $initHeapForallStmt#1: Heap;
    ...
    assume (forall $ih#_k0#0: Box, $ih#x0#0: DatatypeType :: 
      $Is($ih#x0#0, Tclass._module.natinf())
         ...
         ==> _module.natinf.N_q($ih#x0#0)
           && Mod(_module.natinf.n($ih#x0#0), LitInt(2)) == LitInt(0));
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(73,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
    }
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(70,13)
        ...
        assume (forall _k'#2: Box, x#2: DatatypeType :: 
          $Is(x#2, Tclass._module.natinf())
              ...
              ORD#Less(_k'#2, _k#0)
               && _module.__default.Even_h($LS($LZ), _k'#2, x#2)
             ==> _module.natinf.N_q(x#2) && Mod(_module.natinf.n(x#2), LitInt(2)) == LitInt(0));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(70,12)"} true;
    }
}



procedure CheckWellformed$$_module.__default.IL__Bad(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
...
implementation CheckWellformed$$_module.__default.IL__Bad(x#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(76,12): initial state"} true;
    ##x#0 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, Tclass._module.natinf(), $Heap);
    assume _module.__default.Even#canCall(x#0);
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(78,15): post-state"} true;
    assume _module.natinf.N_q(x#0);
    assert _module.natinf.N_q(x#0);
    assert LitInt(2) != 0;
    assume Mod(_module.natinf.n(x#0), LitInt(2)) == LitInt(0);
...
procedure Call$$_module.__default.IL__Bad(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0));
  // user-defined preconditions
...
procedure {:_induction _k#0, x#1} CoCall$$_module.__default.IL__Bad_h(_k#0: Box, 
    x#1: DatatypeType
       where $Is(x#1, Tclass._module.natinf())
         && $IsAlloc(x#1, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#1));
...
procedure {:_induction _k#0, x#1} Impl$$_module.__default.IL__Bad_h(_k#0: Box, 
    x#1: DatatypeType
       where $Is(x#1, Tclass._module.natinf())
         && $IsAlloc(x#1, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#1))
...
implementation {:_induction _k#0, x#1} Impl$$_module.__default.IL__Bad_h(_k#0: Box, x#1: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  var $initHeapForallStmt#1: Heap;
    ...
    assume (forall $ih#_k0#0: Box, $ih#x0#0: DatatypeType :: 
      $Is($ih#x0#0, Tclass._module.natinf())
         ...
         ==> _module.natinf.N_q($ih#x0#0)
           && Mod(_module.natinf.n($ih#x0#0), LitInt(2)) == LitInt(0));
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(79,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(80,3)
        assume true;
        assert false;
    }
    else
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(76,13)
        $initHeapForallStmt#1 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#1 == $Heap;
        assume (forall _k'#2: Box, x#2: DatatypeType :: 
          $Is(x#2, Tclass._module.natinf())
              ...
              ORD#Less(_k'#2, _k#0)
               && _module.__default.Even_h($LS($LZ), _k'#2, x#2)
             ==> _module.natinf.N_q(x#2) && Mod(_module.natinf.n(x#2), LitInt(2)) == LitInt(0));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(76,12)"} true;
    }
}



procedure CheckWellformed$$_module.__default.InfNotEven();
  free requires 16 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.InfNotEven();
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures _module.__default.Even#canCall(Lit(#_module.natinf.Inf()));
  ensures !Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.Inf())));
  // frame condition
  free ensures old($Heap) == $Heap;



procedure Impl$$_module.__default.InfNotEven() returns ($_reverifyPost: bool);
  free requires 16 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures _module.__default.Even#canCall(Lit(#_module.natinf.Inf()));
...
implementation Impl$$_module.__default.InfNotEven() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(85,0): initial state"} true;
    $_reverifyPost := false;
}
...
implementation Impl$$_module.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var ##x#2: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(89,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(90,3)
    ...
    assume _module.__default.Even#canCall(Lit(#_module.natinf.N(LitInt(1))));
    assert {:subsumption 0} !Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(1)))));
    assume !Lit(_module.__default.Even($LS($LZ), Lit(#_module.natinf.N(LitInt(1)))));
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(91,3)
    ...
    assume _module.__default.Even#canCall(Lit(#_module.natinf.N(LitInt(5))));
    assert {:subsumption 0} !Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(5)))));
    assume !Lit(_module.__default.Even($LS($LZ), Lit(#_module.natinf.N(LitInt(5)))));
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(92,3)
    ...
    assume _module.__default.Even#canCall(Lit(#_module.natinf.N(LitInt(17))));
    assert {:subsumption 0} !Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(17)))));
    assume !Lit(_module.__default.Even($LS($LZ), Lit(#_module.natinf.N(LitInt(17)))));
}



procedure CheckWellformed$$_module.__default.SeventeenIsNotEven();
  free requires 18 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$_module.__default.SeventeenIsNotEven()
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(95,6): initial state"} true;
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(96,10): post-state"} true;
    assert $Is(LitInt(17), Tclass._System.nat());
...
procedure Call$$_module.__default.SeventeenIsNotEven();
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures _module.__default.Even#canCall(Lit(#_module.natinf.N(LitInt(17))));
  ensures !Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(17)))));
  // frame condition
  free ensures old($Heap) == $Heap;



procedure Impl$$_module.__default.SeventeenIsNotEven() returns ($_reverifyPost: bool);
  free requires 18 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures _module.__default.Even#canCall(Lit(#_module.natinf.N(LitInt(17))));
...
implementation Impl$$_module.__default.SeventeenIsNotEven() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#1: DatatypeType;
  var ##x#2: DatatypeType;
  ...
  var ##x#17: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(97,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(98,3)
    assert $Is(LitInt(17), Tclass._System.nat());
    ##x#1 := Lit(#_module.natinf.N(LitInt(17)));
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#1, Tclass._module.natinf(), $Heap);
    assume _module.__default.Even#canCall(Lit(#_module.natinf.N(LitInt(17))));
    assert $Is(LitInt(15), Tclass._System.nat());
       ...
       == Lit(_module.__default.Even($LS($LZ), Lit(#_module.natinf.N(LitInt(15))))))
    {
        ...
        assume _module.__default.Even#canCall(Lit(#_module.natinf.N(LitInt(15))));
        assert $Is(LitInt(13), Tclass._System.nat());
    ...
    assert {:subsumption 0} Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(15)))))
       == Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(13)))));
    assert {:subsumption 0} Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(13)))))
       == Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(11)))));
    assert {:subsumption 0} Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(11)))))
       == Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(9)))));
    assert {:subsumption 0} Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(9)))))
       == Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(7)))));
    assert {:subsumption 0} Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(7)))))
    ...
    assert {:subsumption 0} Lit(_module.__default.Even($LS($LS($LZ)), Lit(#_module.natinf.N(LitInt(3)))))
...
procedure CheckWellformed$$_module.__default.OneMore(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0))
...
procedure Call$$_module.__default.OneMore(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0))
   returns (y#0: DatatypeType
...
procedure Impl$$_module.__default.OneMore(x#0: DatatypeType
       where $Is(x#0, Tclass._module.natinf())
         && $IsAlloc(x#0, Tclass._module.natinf(), $Heap)
         && $IsA#_module.natinf(x#0))
   returns (y#0: DatatypeType
  ...
  // user-defined postconditions
  free ensures _module.__default.Even#canCall(y#0);
  ensures _module.__default.Even#canCall(y#0)
     ==> _module.__default.Even($LS($LZ), y#0)
       || 
      (_module.natinf.N_q(y#0) && _module.natinf.n(y#0) == LitInt(0))
       || (
...
implementation Impl$$_module.__default.OneMore(x#0: DatatypeType) returns (y#0: DatatypeType, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(113,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(114,5)
    assume true;
    assert _module.natinf.N_q(x#0);
    assert $Is(_module.natinf.n(x#0) + 2, Tclass._System.nat());
    assume true;
    y#0 := #_module.natinf.N(_module.natinf.n(x#0) + 2);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(114,17)"} true;
}
...
axiom (forall a#3#0#0: int, $h: Heap :: 
  { $IsAlloc(#Alt.natinf.N(a#3#0#0), Tclass.Alt.natinf(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#Alt.natinf.N(a#3#0#0), Tclass.Alt.natinf(), $h)
...
axiom (forall a#4#0#0: int :: 
  { #Alt.natinf.N(LitInt(a#4#0#0)) } 
  #Alt.natinf.N(LitInt(a#4#0#0)) == Lit(#Alt.natinf.N(a#4#0#0)));

function Alt.natinf.n(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#5#0#0: int :: 
  { #Alt.natinf.N(a#5#0#0) } 
  Alt.natinf.n(#Alt.natinf.N(a#5#0#0)) == a#5#0#0);
...
// Constructor $IsAlloc
axiom (forall $h: Heap :: 
  { $IsAlloc(#Alt.natinf.Inf(), Tclass.Alt.natinf(), $h) } 
  $IsGoodHeap($h) ==> $IsAlloc(#Alt.natinf.Inf(), Tclass.Alt.natinf(), $h));
...
axiom (forall a: DatatypeType, b: DatatypeType :: 
  ...
  Alt.natinf.Inf_q(a) && Alt.natinf.Inf_q(b)
     ==> (Alt.natinf#Equal(a, b) <==> true));
...
function Tclass.Alt.__default() : Ty;

const unique Tagclass.Alt.__default: TyTag;

// Tclass.Alt.__default Tag
axiom Tag(Tclass.Alt.__default()) == Tagclass.Alt.__default
   && TagFamily(Tclass.Alt.__default()) == tytagFamily$_default;

// Box/unbox axiom for Tclass.Alt.__default
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.Alt.__default()) } 
  $IsBox(bx, Tclass.Alt.__default())
     ==> $Box($Unbox(bx): ref) == bx && $Is($Unbox(bx): ref, Tclass.Alt.__default()));

// _default: Class $Is
axiom (forall $o: ref :: 
  { $Is($o, Tclass.Alt.__default()) } 
  $Is($o, Tclass.Alt.__default())
     <==> $o == null || dtype($o) == Tclass.Alt.__default());

// _default: Class $IsAlloc
axiom (forall $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass.Alt.__default(), $h) } 
  $IsAlloc($o, Tclass.Alt.__default(), $h) <==> $o == null || read($h, $o, alloc));
...
// consequence axiom for Alt.__default.Even
axiom true
   ==> (forall $ly: LayerType, x#0: DatatypeType :: 
    { Alt.__default.Even($ly, x#0) } 
    Alt.__default.Even#canCall(x#0) || $Is(x#0, Tclass.Alt.natinf()) ==> true);
...
// consequence axiom for Alt.__default.Even_h
axiom true
   ==> (forall $ly: LayerType, _k#0: Box, x#0: DatatypeType :: 
    { Alt.__default.Even_h($ly, _k#0, x#0) } 
...
function Tclass.TargetedMonotonicity.__default() : Ty;

const unique Tagclass.TargetedMonotonicity.__default: TyTag;

// Tclass.TargetedMonotonicity.__default Tag
axiom Tag(Tclass.TargetedMonotonicity.__default())
     == Tagclass.TargetedMonotonicity.__default
   && TagFamily(Tclass.TargetedMonotonicity.__default()) == tytagFamily$_default;

// Box/unbox axiom for Tclass.TargetedMonotonicity.__default
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.TargetedMonotonicity.__default()) } 
  $IsBox(bx, Tclass.TargetedMonotonicity.__default())
     ==> $Box($Unbox(bx): ref) == bx
       && $Is($Unbox(bx): ref, Tclass.TargetedMonotonicity.__default()));

// _default: Class $Is
axiom (forall $o: ref :: 
  { $Is($o, Tclass.TargetedMonotonicity.__default()) } 
  $Is($o, Tclass.TargetedMonotonicity.__default())
     <==> $o == null || dtype($o) == Tclass.TargetedMonotonicity.__default());

// _default: Class $IsAlloc
axiom (forall $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass.TargetedMonotonicity.__default(), $h) } 
  $IsAlloc($o, Tclass.TargetedMonotonicity.__default(), $h)
     <==> $o == null || read($h, $o, alloc));
...
// consequence axiom for TargetedMonotonicity.__default.Next
axiom true
   ==> (forall x#0: int :: { TargetedMonotonicity.__default.Next(x#0) } true ==> true);
...
// consequence axiom for TargetedMonotonicity.__default.P
axiom true
   ==> (forall $ly: LayerType, x#0: int, y#0: int, z#0: int :: 
    { TargetedMonotonicity.__default.P($ly, x#0, y#0, z#0) } 
    true ==> true);
...
// 3rd prefix predicate axiom
axiom true
   ==> (forall $ly: LayerType, x#0: int, y#0: int, z#0: int, _k#0: Box :: 
...
// targeted prefix predicate monotonicity axiom
axiom true
   ==> (forall $ly: LayerType, x#0: int, y#0: int, z#0: int, _k#0: Box, _m: Box, _limit: Box :: 
...
// consequence axiom for TargetedMonotonicity.__default.P_h
axiom true
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int, y#0: int, z#0: int :: 
    { TargetedMonotonicity.__default.P_h($ly, _k#0, x#0, y#0, z#0) } 
    true ==> true);
...
function Tclass.SomeCoolDisjunctionTests.__default() : Ty;

const unique Tagclass.SomeCoolDisjunctionTests.__default: TyTag;

// Tclass.SomeCoolDisjunctionTests.__default Tag
axiom Tag(Tclass.SomeCoolDisjunctionTests.__default())
     == Tagclass.SomeCoolDisjunctionTests.__default
   && TagFamily(Tclass.SomeCoolDisjunctionTests.__default()) == tytagFamily$_default;

// Box/unbox axiom for Tclass.SomeCoolDisjunctionTests.__default
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.SomeCoolDisjunctionTests.__default()) } 
  $IsBox(bx, Tclass.SomeCoolDisjunctionTests.__default())
     ==> $Box($Unbox(bx): ref) == bx
       && $Is($Unbox(bx): ref, Tclass.SomeCoolDisjunctionTests.__default()));

// _default: Class $Is
axiom (forall $o: ref :: 
  { $Is($o, Tclass.SomeCoolDisjunctionTests.__default()) } 
  $Is($o, Tclass.SomeCoolDisjunctionTests.__default())
     <==> $o == null || dtype($o) == Tclass.SomeCoolDisjunctionTests.__default());

// _default: Class $IsAlloc
axiom (forall $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass.SomeCoolDisjunctionTests.__default(), $h) } 
  $IsAlloc($o, Tclass.SomeCoolDisjunctionTests.__default(), $h)
     <==> $o == null || read($h, $o, alloc));
...
// consequence axiom for SomeCoolDisjunctionTests.__default.P
axiom true
...
// consequence axiom for SomeCoolDisjunctionTests.__default.P_h
axiom true
...
// consequence axiom for SomeCoolDisjunctionTests.__default.Q
axiom true
   ==> (forall $ly: LayerType, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Q($ly, x#0) } 
    true ==> true);
...
// consequence axiom for SomeCoolDisjunctionTests.__default.Q_h
axiom true
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Q_h($ly, _k#0, x#0) } 
    true ==> true);
...
// consequence axiom for SomeCoolDisjunctionTests.__default.Pn
axiom true
   ==> (forall $ly: LayerType, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Pn($ly, x#0) } 
    true ==> true);
...
// 3rd prefix predicate axiom
axiom true
   ==> (forall $ly: LayerType, x#0: int, _k#0: int :: 
...
// consequence axiom for SomeCoolDisjunctionTests.__default.Pn_h
axiom true
   ==> (forall $ly: LayerType, _k#0: int, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Pn_h($ly, _k#0, x#0) } 
...
// consequence axiom for SomeCoolDisjunctionTests.__default.Qn
axiom true
   ==> (forall $ly: LayerType, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Qn($ly, x#0) } 
    true ==> true);
...
// consequence axiom for SomeCoolDisjunctionTests.__default.Qn_h
axiom true
   ==> (forall $ly: LayerType, _k#0: int, x#0: int :: 
    { SomeCoolDisjunctionTests.__default.Qn_h($ly, _k#0, x#0) } 
