// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy -print:./SchorrWaite.bpl
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass._module.Node?()
     ==> $Is(read($h, $o, _module.Node.childrenVisited), TInt));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass._module.Node?()
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, _module.Node.childrenVisited), TInt, $h));
...
axiom (forall a#19#0#0: DatatypeType, a#19#1#0: ref :: 
  { #_module.Path.Extend(a#19#0#0, a#19#1#0) } 
  DatatypeCtorId(#_module.Path.Extend(a#19#0#0, a#19#1#0))
     == ##_module.Path.Extend);
...
axiom (forall d: DatatypeType :: 
  { _module.Path.Extend_q(d) } 
  _module.Path.Extend_q(d)
     ==> (exists a#20#0#0: DatatypeType, a#20#1#0: ref :: 
      d == #_module.Path.Extend(a#20#0#0, a#20#1#0)));

// Constructor $Is
axiom (forall a#21#0#0: DatatypeType, a#21#1#0: ref :: 
  { $Is(#_module.Path.Extend(a#21#0#0, a#21#1#0), Tclass._module.Path()) } 
  $Is(#_module.Path.Extend(a#21#0#0, a#21#1#0), Tclass._module.Path())
     <==> $Is(a#21#0#0, Tclass._module.Path()) && $Is(a#21#1#0, Tclass._module.Node()));

// Constructor $IsAlloc
axiom (forall a#22#0#0: DatatypeType, a#22#1#0: ref, $h: Heap :: 
  { $IsAlloc(#_module.Path.Extend(a#22#0#0, a#22#1#0), Tclass._module.Path(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Path.Extend(a#22#0#0, a#22#1#0), Tclass._module.Path(), $h)
       <==> $IsAlloc(a#22#0#0, Tclass._module.Path(), $h)
         && $IsAlloc(a#22#1#0, Tclass._module.Node(), $h)));
...
// Constructor literal
axiom (forall a#23#0#0: DatatypeType, a#23#1#0: ref :: 
  { #_module.Path.Extend(Lit(a#23#0#0), Lit(a#23#1#0)) } 
  #_module.Path.Extend(Lit(a#23#0#0), Lit(a#23#1#0))
     == Lit(#_module.Path.Extend(a#23#0#0, a#23#1#0)));

function _module.Path._h0(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#24#0#0: DatatypeType, a#24#1#0: ref :: 
  { #_module.Path.Extend(a#24#0#0, a#24#1#0) } 
  _module.Path._h0(#_module.Path.Extend(a#24#0#0, a#24#1#0)) == a#24#0#0);

// Inductive rank
axiom (forall a#25#0#0: DatatypeType, a#25#1#0: ref :: 
  { #_module.Path.Extend(a#25#0#0, a#25#1#0) } 
  DtRank(a#25#0#0) < DtRank(#_module.Path.Extend(a#25#0#0, a#25#1#0)));

function _module.Path._h1(DatatypeType) : ref;

// Constructor injectivity
axiom (forall a#26#0#0: DatatypeType, a#26#1#0: ref :: 
  { #_module.Path.Extend(a#26#0#0, a#26#1#0) } 
  _module.Path._h1(#_module.Path.Extend(a#26#0#0, a#26#1#0)) == a#26#1#0);
...
procedure CheckWellformed$$_module.Main.RecursiveMark(this: ref
       where this != null
         && 
...
implementation CheckWellformed$$_module.Main.RecursiveMark(this: ref, root#0: ref, S#0: Set Box)
{
  ...
  var n#6: ref;
    ...
    // AddMethodImpl: RecursiveMark, CheckWellformed$$_module.Main.RecursiveMark
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(20,9): initial state"} true;
    ...
    havoc n#2;
    assume $Is(n#2, Tclass._module.Node());
    if (*)
    {
        assume S#0[$Box(n#2)];
        assert n#2 != null;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(27,17): post-state"} true;
    assert root#0 != null;
    assume read($Heap, root#0, _module.Node.marked);
    havoc n#4;
    assume $Is(n#4, Tclass._module.Node());
    if (*)
    {
        assume S#0[$Box(n#4)];
        assert n#4 != null;
         ...
         ==> (forall ch#5: ref :: 
          ...
          $Is(ch#5, Tclass._module.Node?())
            ...
            Seq#Contains(read($Heap, n#5, _module.Node.children), $Box(ch#5))
             ...
             ==> read($Heap, ch#5, _module.Node.marked)));
    havoc n#6;
    assume $Is(n#6, Tclass._module.Node());
    if (*)
    {
        assume S#0[$Box(n#6)];
        assert n#6 != null;
...
procedure Call$$_module.Main.RecursiveMark(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
procedure Impl$$_module.Main.RecursiveMark(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
implementation Impl$$_module.Main.RecursiveMark(this: ref, root#0: ref, S#0: Set Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var root##0: ref;
  var S##0: Set Box;
  var stackNodes##0: Set Box;
    ...
    // AddMethodImpl: RecursiveMark, Impl$$_module.Main.RecursiveMark
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(34,2): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(35,24)
    ...
    call Call$$_module.Main.RecursiveMarkWorker(this, root##0, S##0, stackNodes##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(35,36)"} true;
}



procedure CheckWellformed$$_module.Main.RecursiveMarkWorker(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
implementation CheckWellformed$$_module.Main.RecursiveMarkWorker(this: ref, root#0: ref, S#0: Set Box, stackNodes#0: Set Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var n#0: ref;
  var ch#0: ref;
  ...
  var n#10: ref;
    ...
    // AddMethodImpl: RecursiveMarkWorker, CheckWellformed$$_module.Main.RecursiveMarkWorker
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(38,9): initial state"} true;
    assume S#0[$Box(root#0)];
    havoc n#0;
    assume $Is(n#0, Tclass._module.Node());
    if (*)
    ...
    assume (forall $o: ref :: 
      ...
      $o != null && read(old($Heap), $o, alloc)
         ==> $Heap[$o] == old($Heap)[$o] || S#0[$Box($o)]);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(47,17): post-state"} true;
    assert root#0 != null;
    assume read($Heap, root#0, _module.Node.marked);
    havoc n#6;
    assume $Is(n#6, Tclass._module.Node());
           ...
           || (forall ch#8: ref :: 
            ...
            $Is(ch#8, Tclass._module.Node?())
              ...
              Seq#Contains(read($Heap, n#7, _module.Node.children), $Box(ch#8))
               ...
               ==> read($Heap, ch#8, _module.Node.marked)));
    havoc n#8;
    assume $Is(n#8, Tclass._module.Node());
    if (*)
    {
        assume S#0[$Box(n#8)];
        assert n#8 != null;
    ...
    assume (forall n#9: ref :: 
      ...
      $Is(n#9, Tclass._module.Node())
        ...
        S#0[$Box(n#9)] && read(old($Heap), n#9, _module.Node.marked)
         ==> read($Heap, n#9, _module.Node.marked));
    havoc n#10;
    assume $Is(n#10, Tclass._module.Node());
    if (*)
    {
        assume S#0[$Box(n#10)];
        assert n#10 != null;
...
procedure Call$$_module.Main.RecursiveMarkWorker(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
procedure Impl$$_module.Main.RecursiveMarkWorker(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
implementation Impl$$_module.Main.RecursiveMarkWorker(this: ref, root#0: ref, S#0: Set Box, stackNodes#0: Set Box)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $rhs#0_0: bool;
  ...
  var stackNodes##0_0_0_0: Set Box;
    ...
    // AddMethodImpl: RecursiveMarkWorker, Impl$$_module.Main.RecursiveMarkWorker
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(57,2): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(58,5)
    assert root#0 != null;
    assume true;
    if (!read($Heap, root#0, _module.Node.marked))
    {
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(59,19)
        assert root#0 != null;
        assume true;
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(59,25)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(60,13)
        assume true;
        assume true;
        i#0_0 := LitInt(0);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(60,16)"} true;
        // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(61,7)
        ...
        while (true)
          ...
          free invariant Seq#Length(read($Heap, root#0, _module.Node.children)) - i#0_0
             ...
             && (Seq#Length(read($Heap, root#0, _module.Node.children)) - i#0_0
               ...
               ==> true);
        {
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(61,6): after some loop iterations"} true;
            if (!$w$loop#0_0)
            {
            ...
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(74,15)
            assume true;
            assert root#0 != null;
            ...
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(74,33)"} true;
            // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(75,9)
            assume true;
            if (c#0_0_0 != null)
            {
                // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(76,30)
                // TrCallStmt: Before ProcessCallStmt
                assume true;
                assume true;
                // ProcessCallStmt: CheckSubrange
                ...
                // ProcessCallStmt: Make the call
                call Call$$_module.Main.RecursiveMarkWorker(this, root##0_0_0_0, S##0_0_0_0, stackNodes##0_0_0_0);
                // TrCallStmt: After ProcessCallStmt
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(76,56)"} true;
            }
            else
            {
            }

            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(78,11)
            assume true;
            assume true;
            i#0_0 := i#0_0 + 1;
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(78,18)"} true;
            // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(61,7)
...
procedure CheckWellformed$$_module.Main.IterativeMark(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
implementation CheckWellformed$$_module.Main.IterativeMark(this: ref, root#0: ref, S#0: Set Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var n#0: ref;
  var ch#0: ref;
  ...
  var n#6: ref;
    ...
    // AddMethodImpl: IterativeMark, CheckWellformed$$_module.Main.IterativeMark
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(85,9): initial state"} true;
    assume S#0[$Box(root#0)];
    havoc n#0;
    assume $Is(n#0, Tclass._module.Node());
    if (*)
    ...
    assume (forall $o: ref :: 
      ...
      $o != null && read(old($Heap), $o, alloc)
         ==> $Heap[$o] == old($Heap)[$o] || S#0[$Box($o)]);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(92,17): post-state"} true;
    assert root#0 != null;
    assume read($Heap, root#0, _module.Node.marked);
    havoc n#4;
    assume $Is(n#4, Tclass._module.Node());
...
procedure Call$$_module.Main.IterativeMark(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
procedure Impl$$_module.Main.IterativeMark(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
implementation Impl$$_module.Main.IterativeMark(this: ref, root#0: ref, S#0: Set Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var t#0: ref
  ...
  var $rhs#0_0: bool;
    ...
    // AddMethodImpl: IterativeMark, Impl$$_module.Main.IterativeMark
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(99,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(100,11)
    assume true;
    assume true;
    t#0 := root#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(100,17)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(101,14)
    assert t#0 != null;
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(101,20)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(102,31)
    assume true;
    assume true;
    stackNodes#0 := Lit(Seq#Empty(): Seq Box);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(102,35)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(103,29)
    assume true;
    assume true;
    unmarkedNodes#0 := Set#Difference(S#0, Set#UnionOne(Set#Empty(): Set Box, $Box(t#0)));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(103,38)"} true;
    // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(104,5)
    // Assume Fuel Constant
             ...
             && (Seq#Rank(stackNodes#0) == Seq#Rank($decr_init$loop#01)
               ==> Seq#Length(read($Heap, t#0, _module.Node.children))
                 ...
                 && (Seq#Length(read($Heap, t#0, _module.Node.children))
                   ...
                   ==> true)));
    {
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(104,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            assert {:subsumption 0} root#0 != null;
            if (read($Heap, root#0, _module.Node.marked))
            ...
            // Begin Comprehension WF check
            havoc n#10;
            if ($Is(n#10, Tclass._module.Node()))
            {
            ...
            // Begin Comprehension WF check
            havoc n#12;
            if ($Is(n#12, Tclass._module.Node()))
            {
            ...
            // Begin Comprehension WF check
            havoc n#14;
            if ($Is(n#14, Tclass._module.Node()))
            {
                if (S#0[$Box(n#14)])
                {
            ...
            // Begin Comprehension WF check
            havoc n#16;
            if ($Is(n#16, Tclass._module.Node()))
            {
                if (S#0[$Box(n#16)])
                {
                }
            ...
            // Begin Comprehension WF check
            havoc n#18;
            if ($Is(n#18, Tclass._module.Node()))
            {
                if (S#0[$Box(n#18)])
                {
            ...
            // Begin Comprehension WF check
            havoc n#20;
            if ($Is(n#20, Tclass._module.Node()))
            {
                if (S#0[$Box(n#20)])
                {
        ...
        $decr$loop#02 := Seq#Length(read($Heap, t#0, _module.Node.children))
           - read($Heap, t#0, _module.Node.childrenVisited);
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(129,7)
        assert t#0 != null;
        assert t#0 != null;
        assume true;
        if (read($Heap, t#0, _module.Node.childrenVisited)
           == Seq#Length(read($Heap, t#0, _module.Node.children)))
        {
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(131,27)
            assert t#0 != null;
            assume true;
            ...
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(131,30)"} true;
            // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(132,9)
            assume true;
            if (Seq#Length(stackNodes#0) == LitInt(0))
            {
                // ----- return statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(133,11)
                return;
            }
            else
            {
            ...
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(135,11)
            assume true;
            assert 0 <= Seq#Length(stackNodes#0) - 1
               && Seq#Length(stackNodes#0) - 1 < Seq#Length(stackNodes#0);
            assume true;
            t#0 := $Unbox(Seq#Index(stackNodes#0, Seq#Length(stackNodes#0) - 1)): ref;
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(135,41)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(136,20)
            assume true;
            assert 0 <= Seq#Length(stackNodes#0) - 1
               && Seq#Length(stackNodes#0) - 1 <= Seq#Length(stackNodes#0);
            assume true;
            stackNodes#0 := Seq#Take(stackNodes#0, Seq#Length(stackNodes#0) - 1);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(136,52)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(137,27)
            assert t#0 != null;
            assume true;
            assert $_Frame[t#0, _module.Node.childrenVisited];
            assert t#0 != null;
            ...
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(137,50)"} true;
        }
        else
        {
            // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(138,14)
            assert t#0 != null;
            assert t#0 != null;
            ...
            if ($Unbox(Seq#Index(read($Heap, t#0, _module.Node.children), 
               ...
               || read($Heap, 
                ...
                _module.Node.marked))
            {
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(140,27)
                assert t#0 != null;
                assume true;
                assert $_Frame[t#0, _module.Node.childrenVisited];
                assert t#0 != null;
                assume true;
                $rhs#0_1_0 := read($Heap, t#0, _module.Node.childrenVisited) + 1;
                $Heap := update($Heap, t#0, _module.Node.childrenVisited, $rhs#0_1_0);
                assume $IsGoodHeap($Heap);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(140,50)"} true;
            }
            else
            {
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(143,20)
                assume true;
                assume true;
                ...
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(143,38)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(144,11)
                assume true;
                assert t#0 != null;
                assert t#0 != null;
                assert 0 <= read($Heap, t#0, _module.Node.childrenVisited)
                ...
                t#0 := $Unbox(Seq#Index(read($Heap, t#0, _module.Node.children), 
                    read($Heap, t#0, _module.Node.childrenVisited))): ref;
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(144,42)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(145,18)
                assert t#0 != null;
                assume true;
                assert $_Frame[t#0, _module.Node.marked];
                assume true;
                $rhs#0_0 := Lit(true);
                $Heap := update($Heap, t#0, _module.Node.marked, $rhs#0_0);
                assume $IsGoodHeap($Heap);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(145,24)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(146,23)
                assume true;
                assume true;
                unmarkedNodes#0 := Set#Difference(unmarkedNodes#0, Set#UnionOne(Set#Empty(): Set Box, $Box(t#0)));
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(146,44)"} true;
            }
        }

        // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(104,5)
...
// function declaration for _module.Main.Reachable
function _module.Main.Reachable($heap: Heap, this: ref, from#0: ref, to#0: ref, S#0: Set Box) : bool;

function _module.Main.Reachable#canCall($heap: Heap, this: ref, from#0: ref, to#0: ref, S#0: Set Box) : bool;

// frame axiom for _module.Main.Reachable
axiom (forall $h0: Heap, $h1: Heap, this: ref, from#0: ref, to#0: ref, S#0: Set Box :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), _module.Main.Reachable($h1, this, from#0, to#0, S#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && 
      this != null
       && $Is(this, Tclass._module.Main())
       && (_module.Main.Reachable#canCall($h0, this, from#0, to#0, S#0)
         || (
          $Is(from#0, Tclass._module.Node())
           && $Is(to#0, Tclass._module.Node())
    ...
    (forall<alpha> $o: ref, $f: Field alpha :: 
     ...
     ==> _module.Main.Reachable($h0, this, from#0, to#0, S#0)
       == _module.Main.Reachable($h1, this, from#0, to#0, S#0));

// consequence axiom for _module.Main.Reachable
axiom 6 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, this: ref, from#0: ref, to#0: ref, S#0: Set Box :: 
    { _module.Main.Reachable($Heap, this, from#0, to#0, S#0) } 
    _module.Main.Reachable#canCall($Heap, this, from#0, to#0, S#0)
...
function _module.Main.Reachable#requires(Heap, ref, ref, ref, Set Box) : bool;

// #requires axiom for _module.Main.Reachable
axiom (forall $Heap: Heap, this: ref, from#0: ref, to#0: ref, S#0: Set Box :: 
  { _module.Main.Reachable#requires($Heap, this, from#0, to#0, S#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap)
       && 
      this != null
       && 
      $Is(this, Tclass._module.Main())
       ...
       && $Is(to#0, Tclass._module.Node())
       && $Is(S#0, TSet(Tclass._module.Node()))
     ==> _module.Main.Reachable#requires($Heap, this, from#0, to#0, S#0) == true);

// definition axiom for _module.Main.Reachable (revealed)
axiom 6 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, this: ref, from#0: ref, to#0: ref, S#0: Set Box :: 
    { _module.Main.Reachable($Heap, this, from#0, to#0, S#0), $IsGoodHeap($Heap) } 
    _module.Main.Reachable#canCall($Heap, this, from#0, to#0, S#0)
         || (6 != $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
       ...
       ==> (forall via#0: DatatypeType :: 
          { _module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, via#0, to#0, S#0) } 
          $Is(via#0, Tclass._module.Path())
             ==> _module.Main.ReachableVia#canCall($Heap, this, from#0, via#0, to#0, S#0))
         && _module.Main.Reachable($Heap, this, from#0, to#0, S#0)
...
procedure CheckWellformed$$_module.Main.Reachable(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
    from#0: ref where $Is(from#0, Tclass._module.Node()), 
    to#0: ref where $Is(to#0, Tclass._module.Node()), 
...
implementation CheckWellformed$$_module.Main.Reachable(this: ref, from#0: ref, to#0: ref, S#0: Set Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var via#1: DatatypeType;
  var ##from#0: ref;
  var ##via#0: DatatypeType;
  var ##to#0: ref;
  var ##S#0: Set Box;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(153,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    if (*)
    {
    ...
    else
    {
        ...
        if ($Is(via#1, Tclass._module.Path()))
        {
            ...
            assume $IsAlloc(##from#0, Tclass._module.Node(), $Heap);
            ##via#0 := via#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##via#0, Tclass._module.Path(), $Heap);
            ##to#0 := to#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##to#0, Tclass._module.Node(), $Heap);
            ##S#0 := S#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##S#0, TSet(Tclass._module.Node()), $Heap);
            b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: 
              $o != null && read($Heap, $o, alloc) && ##S#0[$Box($o)] ==> $_Frame[$o, $f]);
            assume _module.Main.ReachableVia#canCall($Heap, this, from#0, via#1, to#0, S#0);
        }

        // End Comprehension WF check
        assume _module.Main.Reachable($Heap, this, from#0, to#0, S#0)
           == (exists via#2: DatatypeType :: 
            { _module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, via#2, to#0, S#0) } 
            $Is(via#2, Tclass._module.Path())
               && _module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, via#2, to#0, S#0));
        assume (forall via#2: DatatypeType :: 
          { _module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, via#2, to#0, S#0) } 
          $Is(via#2, Tclass._module.Path())
             ==> _module.Main.ReachableVia#canCall($Heap, this, from#0, via#2, to#0, S#0));
        // CheckWellformedWithResult: any expression
        assume $Is(_module.Main.Reachable($Heap, this, from#0, to#0, S#0), TBool);
        assert b$reqreads#0;
    }
}
...
// function declaration for _module.Main.ReachableVia
function _module.Main.ReachableVia($ly: LayerType, 
    $heap: Heap, 
    this: ref, 
    from#0: ref, 
    via#0: DatatypeType, 
...
function _module.Main.ReachableVia#canCall($heap: Heap, 
    this: ref, 
    from#0: ref, 
    via#0: DatatypeType, 
    to#0: ref, 
...
axiom (forall $ly: LayerType, 
    ...
    to#0: ref, 
    S#0: Set Box :: 
  { _module.Main.ReachableVia($LS($ly), $Heap, this, from#0, via#0, to#0, S#0) } 
  _module.Main.ReachableVia($LS($ly), $Heap, this, from#0, via#0, to#0, S#0)
     == _module.Main.ReachableVia($ly, $Heap, this, from#0, via#0, to#0, S#0));
...
axiom (forall $ly: LayerType, 
    ...
    to#0: ref, 
    S#0: Set Box :: 
  { _module.Main.ReachableVia(AsFuelBottom($ly), $Heap, this, from#0, via#0, to#0, S#0) } 
  _module.Main.ReachableVia($ly, $Heap, this, from#0, via#0, to#0, S#0)
     == _module.Main.ReachableVia($LZ, $Heap, this, from#0, via#0, to#0, S#0));

// frame axiom for _module.Main.ReachableVia
axiom (forall $ly: LayerType, 
    $h0: Heap, 
    $h1: Heap, 
    this: ref, 
    ...
    to#0: ref, 
    S#0: Set Box :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), _module.Main.ReachableVia($ly, $h1, this, from#0, via#0, to#0, S#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && 
      this != null
       && $Is(this, Tclass._module.Main())
       && (_module.Main.ReachableVia#canCall($h0, this, from#0, via#0, to#0, S#0)
         || (
          $Is(from#0, Tclass._module.Node())
           && $Is(via#0, Tclass._module.Path())
           && $Is(to#0, Tclass._module.Node())
    ...
    (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null && S#0[$Box($o)] ==> read($h0, $o, $f) == read($h1, $o, $f))
     ==> _module.Main.ReachableVia($ly, $h0, this, from#0, via#0, to#0, S#0)
       == _module.Main.ReachableVia($ly, $h1, this, from#0, via#0, to#0, S#0));

// consequence axiom for _module.Main.ReachableVia
...
function _module.Main.ReachableVia#requires(LayerType, Heap, ref, ref, DatatypeType, ref, Set Box) : bool;

// #requires axiom for _module.Main.ReachableVia
axiom (forall $ly: LayerType, 
    $Heap: Heap, 
    this: ref, 
    from#0: ref, 
    ...
    to#0: ref, 
    S#0: Set Box :: 
  { _module.Main.ReachableVia#requires($ly, $Heap, this, from#0, via#0, to#0, S#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap)
       && 
      this != null
       && 
      $Is(this, Tclass._module.Main())
       ...
       && $Is(to#0, Tclass._module.Node())
       && $Is(S#0, TSet(Tclass._module.Node()))
     ==> _module.Main.ReachableVia#requires($ly, $Heap, this, from#0, via#0, to#0, S#0)
       == true);

// definition axiom for _module.Main.ReachableVia (revealed)
axiom 5 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, 
      $Heap: Heap, 
      this: ref, 
      ...
      to#0: ref, 
      S#0: Set Box :: 
    { _module.Main.ReachableVia($LS($ly), $Heap, this, from#0, via#0, to#0, S#0), $IsGoodHeap($Heap) } 
    _module.Main.ReachableVia#canCall($Heap, this, from#0, via#0, to#0, S#0)
         || (5 != $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
          ...
          $Is(this, Tclass._module.Main())
           ...
           && $Is(to#0, Tclass._module.Node())
           && $Is(S#0, TSet(Tclass._module.Node())))
       ==> (!_module.Path.Empty_q(via#0)
           ==> (var n#1 := _module.Path._h1(via#0); 
            (var prefix#1 := _module.Path._h0(via#0); 
              S#0[$Box(n#1)]
                 ==> 
                Seq#Contains(read($Heap, n#1, _module.Node.children), $Box(to#0))
                 ==> _module.Main.ReachableVia#canCall($Heap, this, from#0, prefix#1, n#1, S#0))))
         && _module.Main.ReachableVia($LS($ly), $Heap, this, from#0, via#0, to#0, S#0)
           == (if _module.Path.Empty_q(via#0)
             then from#0 == to#0
             else (var n#0 := _module.Path._h1(via#0); 
              (var prefix#0 := _module.Path._h0(via#0); 
                S#0[$Box(n#0)]
                   && Seq#Contains(read($Heap, n#0, _module.Node.children), $Box(to#0))
                   && _module.Main.ReachableVia($ly, $Heap, this, from#0, prefix#0, n#0, S#0)))));

procedure CheckWellformed$$_module.Main.ReachableVia(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
    from#0: ref where $Is(from#0, Tclass._module.Node()), 
    via#0: DatatypeType where $Is(via#0, Tclass._module.Path()), 
    to#0: ref where $Is(to#0, Tclass._module.Node()), 
    S#0: Set Box where $Is(S#0, TSet(Tclass._module.Node())));
...
implementation CheckWellformed$$_module.Main.ReachableVia(this: ref, from#0: ref, via#0: DatatypeType, to#0: ref, S#0: Set Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(159,12): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    if (*)
    {
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
        if (via#0 == #_module.Path.Empty())
        {
            assume _module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, via#0, to#0, S#0)
               == 
              (from#0
               == to#0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, via#0, to#0, S#0), 
              TBool);
        }
        else if (via#0 == #_module.Path.Extend(_mcc#0#0, _mcc#1#0))
        {
            ...
            if (S#0[$Box(n#Z#0)]
               && Seq#Contains(read($Heap, n#Z#0, _module.Node.children), $Box(to#0)))
            {
                ##from#0 := from#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##from#0, Tclass._module.Node(), $Heap);
                ...
                // assume allocatedness for argument to function
                assume $IsAlloc(##via#0, Tclass._module.Path(), $Heap);
                assert $Is(n#Z#0, Tclass._module.Node());
                ##to#0 := n#Z#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##to#0, Tclass._module.Node(), $Heap);
                ##S#0 := S#0;
                ...
                b$reqreads#1 := (forall<alpha> $o: ref, $f: Field alpha :: 
                  $o != null && read($Heap, $o, alloc) && ##S#0[$Box($o)] ==> $_Frame[$o, $f]);
                assert DtRank(##via#0) < DtRank(via#0);
                assume _module.Main.ReachableVia#canCall($Heap, this, from#0, prefix#Z#0, n#Z#0, S#0);
            }
            ...
            assume _module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, via#0, to#0, S#0)
               == (
                S#0[$Box(n#Z#0)]
                 && Seq#Contains(read($Heap, n#Z#0, _module.Node.children), $Box(to#0))
                 && _module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, prefix#Z#0, n#Z#0, S#0));
            assume S#0[$Box(n#Z#0)]
               ==> 
              Seq#Contains(read($Heap, n#Z#0, _module.Node.children), $Box(to#0))
               ==> _module.Main.ReachableVia#canCall($Heap, this, from#0, prefix#Z#0, n#Z#0, S#0);
            // CheckWellformedWithResult: any expression
            assume $Is(_module.Main.ReachableVia($LS($LZ), $Heap, this, from#0, via#0, to#0, S#0), 
              TBool);
        }
...
procedure CheckWellformed$$_module.Main.SchorrWaite(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
implementation CheckWellformed$$_module.Main.SchorrWaite(this: ref, root#0: ref, S#0: Set Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var n#0: ref;
  var ch#0: ref;
  ...
  var n#8: ref;
    ...
    // AddMethodImpl: SchorrWaite, CheckWellformed$$_module.Main.SchorrWaite
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(168,9): initial state"} true;
    assume S#0[$Box(root#0)];
    havoc n#0;
    assume $Is(n#0, Tclass._module.Node());
    if (*)
    ...
    assume (forall $o: ref :: 
      ...
      $o != null && read(old($Heap), $o, alloc)
         ==> $Heap[$o] == old($Heap)[$o] || S#0[$Box($o)]);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(177,17): post-state"} true;
    assert root#0 != null;
    assume read($Heap, root#0, _module.Node.marked);
    havoc n#4;
    assume $Is(n#4, Tclass._module.Node());
    ...
    if (*)
    {
        ...
        ##to#0 := n#6;
        ##S#0 := S#0;
        assert $IsAlloc(this, Tclass._module.Main(), old($Heap));
        assert $IsAlloc(root#0, Tclass._module.Node(), old($Heap));
        assert $IsAlloc(n#6, Tclass._module.Node(), old($Heap));
        assert $IsAlloc(S#0, TSet(Tclass._module.Node()), old($Heap));
        assume _module.Main.Reachable#canCall(old($Heap), this, root#0, n#6, S#0);
        assume _module.Main.Reachable(old($Heap), this, root#0, n#6, S#0);
    }
    else
    {
        assume S#0[$Box(n#6)] && read($Heap, n#6, _module.Node.marked)
           ==> _module.Main.Reachable(old($Heap), this, root#0, n#6, S#0);
    }
    ...
    assume (forall n#7: ref :: 
      ...
      $Is(n#7, Tclass._module.Node())
         ==> 
        S#0[$Box(n#7)] && read($Heap, n#7, _module.Node.marked)
         ==> _module.Main.Reachable(old($Heap), this, root#0, n#7, S#0));
    havoc n#8;
    assume $Is(n#8, Tclass._module.Node());
    if (*)
    {
...
procedure Call$$_module.Main.SchorrWaite(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
  ...
  free ensures (forall n#7: ref :: 
    $Is(n#7, Tclass._module.Node())
      ...
      S#0[$Box(n#7)]
       ==> 
      read($Heap, n#7, _module.Node.marked)
       ==> _module.Main.Reachable#canCall(old($Heap), this, root#0, n#7, S#0));
  ensures (forall n#7: ref :: 
    {:autotriggers false} 
    $Is(n#7, Tclass._module.Node())
       ==> 
...
procedure Impl$$_module.Main.SchorrWaite(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.Main())
         && $IsAlloc(this, Tclass._module.Main(), $Heap), 
...
implementation Impl$$_module.Main.SchorrWaite(this: ref, root#0: ref, S#0: Set Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var t#0: ref
     where $Is(t#0, Tclass._module.Node()) && $IsAlloc(t#0, Tclass._module.Node(), $Heap);
  ...
  var $rhs#0: bool;
  var $rhs#1: DatatypeType where $Is($rhs#1, Tclass._module.Path());
  var stackNodes#0: Seq Box
     where $Is(stackNodes#0, TSeq(Tclass._module.Node()))
       && $IsAlloc(stackNodes#0, TSeq(Tclass._module.Node()), $Heap);
  var unmarkedNodes#0: Set Box
  ...
  var $rhs#0_0_1: Seq Box where $Is($rhs#0_0_1, TSeq(Tclass._module.Node?()));
  var $rhs#0_0_2: int;
  var $rhs#0_1_0: int;
  var newT#0_0: ref
     where $Is(newT#0_0, Tclass._module.Node?())
       && $IsAlloc(newT#0_0, Tclass._module.Node?(), $Heap);
  var $rhs#0_0: Seq Box where $Is($rhs#0_0, TSeq(Tclass._module.Node?()));
  var $rhs#0_1: bool;
  var $rhs#0_2: DatatypeType where $Is($rhs#0_2, Tclass._module.Path());

    // AddMethodImpl: SchorrWaite, Impl$$_module.Main.SchorrWaite
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> S#0[$Box($o)]);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(186,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(187,11)
    assume true;
    assume true;
    t#0 := root#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(187,17)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(188,18)
    assume true;
    assume true;
    p#0 := null;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(188,24)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(189,20)
    assume true;
    assume true;
    path#0 := Lit(#_module.Path.Empty());
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(189,32)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(190,14)
    assert t#0 != null;
    assume true;
    assert $_Frame[t#0, _module.Node.marked];
    assume true;
    ...
    $Heap := update($Heap, t#0, _module.Node.marked, $rhs#0);
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(190,20)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(191,20)
    assert t#0 != null;
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(191,26)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(192,37)
    assume true;
    assume true;
    stackNodes#0 := Lit(Seq#Empty(): Seq Box);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(192,41)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(193,29)
    assume true;
    assume true;
    unmarkedNodes#0 := Set#Difference(S#0, Set#UnionOne(Set#Empty(): Set Box, $Box(t#0)));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(193,38)"} true;
    // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(194,5)
    // Assume Fuel Constant
    $PreLoopHeap$loop#0 := $Heap;
    $decr_init$loop#00 := unmarkedNodes#0;
    $decr_init$loop#01 := stackNodes#0;
    ...
    while (true)
      ...
      invariant $w$loop#0 ==> !Seq#Contains(stackNodes#0, $Box(t#0));
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0 ==> (Seq#Length(stackNodes#0) == LitInt(0) <==> p#0 == null);
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0
         ==> 
        0 < Seq#Length(stackNodes#0)
         ==> p#0 == $Unbox(Seq#Index(stackNodes#0, Seq#Length(stackNodes#0) - 1)): ref;
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0
         ==> (forall i#1: int, j#1: int :: 
          { $Unbox(Seq#Index(stackNodes#0, j#1)): ref, $Unbox(Seq#Index(stackNodes#0, i#1)): ref } 
      ...
      invariant $w$loop#0
         ==> (forall n#11: ref :: 
          { S#0[$Box(n#11)] } { Seq#Contains(stackNodes#0, $Box(n#11)) } 
          $Is(n#11, Tclass._module.Node())
             ==> 
            Seq#Contains(stackNodes#0, $Box(n#11))
             ==> S#0[$Box(n#11)]);
      ...
      invariant $w$loop#0
         ==> (forall n#13: ref :: 
          { read($Heap, n#13, _module.Node.marked) } 
            { Seq#Contains(stackNodes#0, $Box(n#13)) } 
          $Is(n#13, Tclass._module.Node())
             ==> 
            Seq#Contains(stackNodes#0, $Box(n#13)) || n#13 == t#0
             ==> read($Heap, n#13, _module.Node.marked));
      invariant $w$loop#0
         ==> (forall n#13: ref :: 
          { read($Heap, n#13, _module.Node.childrenVisited) } 
          ...
          $Is(n#13, Tclass._module.Node())
             ==> 
            Seq#Contains(stackNodes#0, $Box(n#13)) || n#13 == t#0
             ==> LitInt(0) <= read($Heap, n#13, _module.Node.childrenVisited));
      invariant $w$loop#0
         ==> (forall n#13: ref :: 
          { read($Heap, n#13, _module.Node.children) } 
            { read($Heap, n#13, _module.Node.childrenVisited) } 
          ...
          $Is(n#13, Tclass._module.Node())
             ==> (Seq#Contains(stackNodes#0, $Box(n#13)) || n#13 == t#0
               ...
               && (Seq#Contains(stackNodes#0, $Box(n#13)) || n#13 == t#0
                 ==> (forall j#3: int :: 
                  { $Unbox(Seq#Index(read($Heap, n#13, _module.Node.children), j#3)): ref } 
                  true
                     ==> 
                    LitInt(0) <= j#3 && j#3 < read($Heap, n#13, _module.Node.childrenVisited)
                     ==> $Unbox(Seq#Index(read($Heap, n#13, _module.Node.children), j#3)): ref == null
                       || read($Heap, 
                        $Unbox(Seq#Index(read($Heap, n#13, _module.Node.children), j#3)): ref, 
                        _module.Node.marked))));
      free invariant $w$loop#0 ==> true;
      ...
      invariant $w$loop#0
         ==> (forall n#17: ref :: 
          ...
          $Is(n#17, Tclass._module.Node())
             ==> 
            S#0[$Box(n#17)]
               && read($Heap, n#17, _module.Node.marked)
               && !Seq#Contains(stackNodes#0, $Box(n#17))
               && n#17 != t#0
             ==> (forall ch#7: ref :: 
              { read($Heap, ch#7, _module.Node.marked) } 
                { Seq#Contains(read($Heap, n#17, _module.Node.children), $Box(ch#7)) } 
              $Is(ch#7, Tclass._module.Node?())
                 ==> 
                Seq#Contains(read($Heap, n#17, _module.Node.children), $Box(ch#7))
                   && ch#7 != null
      ...
      invariant $w$loop#0
         ==> (forall n#19: ref :: 
          { read(old($Heap), n#19, _module.Node.childrenVisited) } 
            { read($Heap, n#19, _module.Node.childrenVisited) } 
            { Seq#Contains(stackNodes#0, $Box(n#19)) } 
            { S#0[$Box(n#19)] } 
          $Is(n#19, Tclass._module.Node())
             ==> 
            S#0[$Box(n#19)] && !Seq#Contains(stackNodes#0, $Box(n#19)) && n#19 != t#0
             ==> read($Heap, n#19, _module.Node.childrenVisited)
               == read(old($Heap), n#19, _module.Node.childrenVisited));
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0
         ==> (forall n#21: ref :: 
          { read(old($Heap), n#21, _module.Node.children) } 
          ...
          $Is(n#21, Tclass._module.Node())
            ...
            S#0[$Box(n#21)]
             ==> Seq#Contains(stackNodes#0, $Box(n#21))
               || Seq#Equal(read($Heap, n#21, _module.Node.children), 
                read(old($Heap), n#21, _module.Node.children)));
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0
         ==> (forall n#23: ref :: 
          { read($Heap, n#23, _module.Node.childrenVisited) } 
            { read(old($Heap), n#23, _module.Node.children) } 
            { read($Heap, n#23, _module.Node.children) } 
            { Seq#Contains(stackNodes#0, $Box(n#23)) } 
          $Is(n#23, Tclass._module.Node())
             ==> (Seq#Contains(stackNodes#0, $Box(n#23))
                 ==> Seq#Length(read($Heap, n#23, _module.Node.children))
                   == Seq#Length(read(old($Heap), n#23, _module.Node.children)))
               && (Seq#Contains(stackNodes#0, $Box(n#23))
                 ==> (forall j#5: int :: 
                  { $Unbox(Seq#Index(read(old($Heap), n#23, _module.Node.children), j#5)): ref } 
                    { $Unbox(Seq#Index(read($Heap, n#23, _module.Node.children), j#5)): ref } 
                  true
                     ==> 
                    LitInt(0) <= j#5 && j#5 < Seq#Length(read($Heap, n#23, _module.Node.children))
                     ==> j#5 == read($Heap, n#23, _module.Node.childrenVisited)
                       || $Unbox(Seq#Index(read($Heap, n#23, _module.Node.children), j#5)): ref
                         == $Unbox(Seq#Index(read(old($Heap), n#23, _module.Node.children), j#5)): ref)));
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0 ==> $IsAlloc(path#0, Tclass._module.Path(), old($Heap));
      free invariant $w$loop#0
         ==> _module.Main.ReachableVia#canCall(old($Heap), this, root#0, path#0, t#0, S#0);
      invariant $w$loop#0
         ==> _module.Main.ReachableVia($LS($LS($LZ)), old($Heap), this, root#0, path#0, t#0, S#0);
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0
         ==> (forall n#25: ref :: 
      ...
      free invariant $w$loop#0
         ==> (forall n#27: ref :: 
          { _module.Main.ReachableVia($LS($LZ), 
              old($Heap), 
              this, 
              root#0, 
              read(old($Heap), n#27, _module.Node.pathFromRoot), 
              n#27, 
              S#0) } 
            { read($Heap, n#27, _module.Node.pathFromRoot) } 
          ...
          $Is(n#27, Tclass._module.Node())
            ...
            S#0[$Box(n#27)]
             ==> 
            read($Heap, n#27, _module.Node.marked)
             ==> (var pth#1 := read($Heap, n#27, _module.Node.pathFromRoot); 
              _module.Main.ReachableVia#canCall(old($Heap), this, root#0, pth#1, n#27, S#0)));
      invariant $w$loop#0
         ==> (forall n#27: ref :: 
          { _module.Main.ReachableVia($LS($LZ), 
              old($Heap), 
          ...
          $Is(n#27, Tclass._module.Node())
            ...
            S#0[$Box(n#27)] && read($Heap, n#27, _module.Node.marked)
             ==> (var pth#1 := read($Heap, n#27, _module.Node.pathFromRoot); 
              _module.Main.ReachableVia($LS($LZ), old($Heap), this, root#0, pth#1, n#27, S#0)));
      free invariant $w$loop#0
         ==> (forall n#29: ref :: 
          { _module.Main.Reachable(old($Heap), this, root#0, n#29, S#0) } 
          ...
          $Is(n#29, Tclass._module.Node())
            ...
            S#0[$Box(n#29)]
             ==> 
            read($Heap, n#29, _module.Node.marked)
             ==> _module.Main.Reachable#canCall(old($Heap), this, root#0, n#29, S#0));
      invariant $w$loop#0
         ==> (forall n#29: ref :: 
          { _module.Main.Reachable(old($Heap), this, root#0, n#29, S#0) } 
            { read($Heap, n#29, _module.Node.marked) } 
      ...
      invariant $w$loop#0
         ==> (forall k#1: int, _t#0#0: int :: 
          { $Unbox(Seq#Index(stackNodes#0, _t#0#0)): ref, $Unbox(Seq#Index(stackNodes#0, k#1)): ref } 
          _t#0#0 == k#1 - 1
             ==> 
      ...
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0
         ==> (forall k#3: int, _t#0#1: int :: 
          { $Unbox(Seq#Index(stackNodes#0, _t#0#1)): ref, read(old($Heap), $Unbox(Seq#Index(stackNodes#0, k#3)): ref, _module.Node.children) } 
            { $Unbox(Seq#Index(stackNodes#0, _t#0#1)): ref, $Unbox(Seq#Index(stackNodes#0, k#3)): ref } 
          _t#0#1 == k#3 + 1
             ==> 
            LitInt(0) <= k#3 && _t#0#1 < Seq#Length(stackNodes#0)
             ==> $Unbox(Seq#Index(read(old($Heap), $Unbox(Seq#Index(stackNodes#0, k#3)): ref, _module.Node.children), 
               ...
               == $Unbox(Seq#Index(stackNodes#0, _t#0#1)): ref);
      free invariant $w$loop#0 ==> true;
      invariant $w$loop#0
         ==> 
        0 < Seq#Length(stackNodes#0)
      ...
      invariant $w$loop#0
         ==> (forall n#31: ref :: 
          { unmarkedNodes#0[$Box(n#31)] } 
            { read($Heap, n#31, _module.Node.marked) } 
            { S#0[$Box(n#31)] } 
          $Is(n#31, Tclass._module.Node())
             ==> 
            S#0[$Box(n#31)] && !read($Heap, n#31, _module.Node.marked)
             ==> unmarkedNodes#0[$Box(n#31)]);
      free invariant (forall $o: ref :: 
        { $Heap[$o] } 
        $o != null && read(old($Heap), $o, alloc)
             ...
             && (Seq#Rank(stackNodes#0) == Seq#Rank($decr_init$loop#01)
               ==> Seq#Length(read($Heap, t#0, _module.Node.children))
                 ...
                 && (Seq#Length(read($Heap, t#0, _module.Node.children))
                   ...
                   ==> true)));
    {
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(194,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            assert {:subsumption 0} root#0 != null;
            if (read($Heap, root#0, _module.Node.marked))
            ...
            assume read($Heap, root#0, _module.Node.marked)
               ...
               && !Seq#Contains(stackNodes#0, $Box(t#0));
            assume true;
            assume Seq#Length(stackNodes#0) == LitInt(0) <==> p#0 == null;
            if (0 < Seq#Length(stackNodes#0))
            {
                assert {:subsumption 0} 0 <= Seq#Length(stackNodes#0) - 1
                   && Seq#Length(stackNodes#0) - 1 < Seq#Length(stackNodes#0);
            ...
            if ($Is(n#12, Tclass._module.Node()))
            {
                ...
                if (Seq#Contains(stackNodes#0, $Box(n#12)) || n#12 == t#0)
                {
                    assert {:subsumption 0} n#12 != null;
                    if (read($Heap, n#12, _module.Node.marked))
                    {
                        assert {:subsumption 0} n#12 != null;
                        if (LitInt(0) <= read($Heap, n#12, _module.Node.childrenVisited))
                        {
                            assert {:subsumption 0} n#12 != null;
                            assert {:subsumption 0} n#12 != null;
                        }
                    ...
                    if (read($Heap, n#12, _module.Node.marked)
                       && 
                      LitInt(0) <= read($Heap, n#12, _module.Node.childrenVisited)
                       && read($Heap, n#12, _module.Node.childrenVisited)
                         <= Seq#Length(read($Heap, n#12, _module.Node.children)))
                    {
                        // Begin Comprehension WF check
                        havoc j#2;
                        if (true)
                        {
                            ...
                            if (LitInt(0) <= j#2 && j#2 < read($Heap, n#12, _module.Node.childrenVisited))
                            {
                                assert {:subsumption 0} n#12 != null;
                                assert {:subsumption 0} 0 <= j#2 && j#2 < Seq#Length(read($Heap, n#12, _module.Node.children));
                                if ($Unbox(Seq#Index(read($Heap, n#12, _module.Node.children), j#2)): ref != null)
                                {
                                    assert {:subsumption 0} n#12 != null;
                                    assert {:subsumption 0} 0 <= j#2 && j#2 < Seq#Length(read($Heap, n#12, _module.Node.children));
                                    assert {:subsumption 0} $Unbox(Seq#Index(read($Heap, n#12, _module.Node.children), j#2)): ref != null;
                                }
                            }
                        }
            ...
            if ($Is(n#16, Tclass._module.Node()))
            {
                ...
                if (S#0[$Box(n#16)] && read($Heap, n#16, _module.Node.marked))
                {
                }

                if (S#0[$Box(n#16)]
                   && read($Heap, n#16, _module.Node.marked)
                   && !Seq#Contains(stackNodes#0, $Box(n#16)))
                {
                }
                   ...
                   && n#16 != t#0)
                {
                    ...
                    {
                        assert {:subsumption 0} n#16 != null;
                        if (Seq#Contains(read($Heap, n#16, _module.Node.children), $Box(ch#6)))
                        {
                        }
            ...
            if ($Is(n#18, Tclass._module.Node()))
            {
                ...
                if (S#0[$Box(n#18)] && !Seq#Contains(stackNodes#0, $Box(n#18)))
                {
                }

                if (S#0[$Box(n#18)] && !Seq#Contains(stackNodes#0, $Box(n#18)) && n#18 != t#0)
                {
                    assert {:subsumption 0} n#18 != null;
                    assert {:subsumption 0} n#18 != null;
                    assert $IsAlloc(n#18, Tclass._module.Node(), old($Heap));
            ...
            if ($Is(n#20, Tclass._module.Node()))
            {
                if (S#0[$Box(n#20)])
                {
                    if (!Seq#Contains(stackNodes#0, $Box(n#20)))
                    {
                        assert {:subsumption 0} n#20 != null;
                        assert {:subsumption 0} n#20 != null;
                        assert $IsAlloc(n#20, Tclass._module.Node(), old($Heap));
                    }
                }
            }
            ...
            // Begin Comprehension WF check
            havoc n#22;
            if ($Is(n#22, Tclass._module.Node()))
            {
                if (Seq#Contains(stackNodes#0, $Box(n#22)))
                {
                    assert {:subsumption 0} n#22 != null;
                    assert {:subsumption 0} n#22 != null;
                    assert $IsAlloc(n#22, Tclass._module.Node(), old($Heap));
                    if (Seq#Length(read($Heap, n#22, _module.Node.children))
                       == Seq#Length(read(old($Heap), n#22, _module.Node.children)))
                    {
                        // Begin Comprehension WF check
                        havoc j#4;
                        if (true)
                        {
                            ...
                            if (LitInt(0) <= j#4 && j#4 < Seq#Length(read($Heap, n#22, _module.Node.children)))
                            {
                                assert {:subsumption 0} n#22 != null;
                                if (j#4 != read($Heap, n#22, _module.Node.childrenVisited))
                                {
                                    assert {:subsumption 0} n#22 != null;
                                    assert {:subsumption 0} 0 <= j#4 && j#4 < Seq#Length(read($Heap, n#22, _module.Node.children));
                                    assert {:subsumption 0} n#22 != null;
                                    assert $IsAlloc(n#22, Tclass._module.Node(), old($Heap));
                                    assert {:subsumption 0} 0 <= j#4 && j#4 < Seq#Length(read(old($Heap), n#22, _module.Node.children));
                                }
                            }
                        }
            ...
            assert $IsAlloc(S#0, TSet(Tclass._module.Node()), old($Heap));
            assume _module.Main.ReachableVia#canCall(old($Heap), this, root#0, path#0, t#0, S#0);
            assume _module.Main.ReachableVia#canCall(old($Heap), this, root#0, path#0, t#0, S#0);
            assume _module.Main.ReachableVia($LS($LZ), old($Heap), this, root#0, path#0, t#0, S#0);
            // Begin Comprehension WF check
            havoc n#24;
            if ($Is(n#24, Tclass._module.Node()))
            {
                if (S#0[$Box(n#24)])
                {
            ...
            // Begin Comprehension WF check
            havoc n#26;
            if ($Is(n#26, Tclass._module.Node()))
            {
                if (S#0[$Box(n#26)])
                {
                ...
                {
                    havoc pth#Z#1;
                    assume $Is(pth#Z#1, Tclass._module.Path());
                    assert {:subsumption 0} n#26 != null;
                    assume let#1#0#0 == read($Heap, n#26, _module.Node.pathFromRoot);
                    assume true;
                    // CheckWellformedWithResult: any expression
                    assume $Is(let#1#0#0, Tclass._module.Path());
                    assume pth#Z#1 == let#1#0#0;
                    ##from#2 := root#0;
                    ##via#1 := pth#Z#1;
                    ##to#2 := n#26;
                    ##S#2 := S#0;
                    assert $IsAlloc(this, Tclass._module.Main(), old($Heap));
                    assert $IsAlloc(root#0, Tclass._module.Node(), old($Heap));
                    assert $IsAlloc(pth#Z#1, Tclass._module.Path(), old($Heap));
                    assert $IsAlloc(n#26, Tclass._module.Node(), old($Heap));
                    assert $IsAlloc(S#0, TSet(Tclass._module.Node()), old($Heap));
                    assume _module.Main.ReachableVia#canCall(old($Heap), this, root#0, pth#Z#1, n#26, S#0);
                }
            }
            ...
            // Begin Comprehension WF check
            havoc n#28;
            if ($Is(n#28, Tclass._module.Node()))
            {
                if (S#0[$Box(n#28)])
                {
                ...
                if (S#0[$Box(n#28)] && read($Heap, n#28, _module.Node.marked))
                {
                    ...
                    assert $IsAlloc(this, Tclass._module.Main(), old($Heap));
                    assert $IsAlloc(root#0, Tclass._module.Node(), old($Heap));
                    assert $IsAlloc(n#28, Tclass._module.Node(), old($Heap));
                    assert $IsAlloc(S#0, TSet(Tclass._module.Node()), old($Heap));
                    assume _module.Main.Reachable#canCall(old($Heap), this, root#0, n#28, S#0);
                }
            }
            ...
            if (true)
            {
                ...
                if (LitInt(0) <= k#2 && k#2 + 1 < Seq#Length(stackNodes#0))
                {
            ...
            // End Comprehension WF check
            assume true;
            assume (forall k#3: int, _t#0#1: int :: 
              { $Unbox(Seq#Index(stackNodes#0, _t#0#1)): ref, read(old($Heap), $Unbox(Seq#Index(stackNodes#0, k#3)): ref, _module.Node.children) } 
                { $Unbox(Seq#Index(stackNodes#0, _t#0#1)): ref, $Unbox(Seq#Index(stackNodes#0, k#3)): ref } 
              _t#0#1 == k#3 + 1
                 ==> 
            ...
            // Begin Comprehension WF check
            havoc n#30;
            if ($Is(n#30, Tclass._module.Node()))
            {
                if (S#0[$Box(n#30)])
                {
                    assert {:subsumption 0} n#30 != null;
                }

                if (S#0[$Box(n#30)] && !read($Heap, n#30, _module.Node.marked))
                {
                }
            }
        ...
        $decr$loop#02 := Seq#Length(read($Heap, t#0, _module.Node.children))
           - read($Heap, t#0, _module.Node.childrenVisited);
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(235,7)
        assert t#0 != null;
        assert t#0 != null;
        assume true;
        if (read($Heap, t#0, _module.Node.childrenVisited)
           == Seq#Length(read($Heap, t#0, _module.Node.children)))
        {
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(237,27)
            assert t#0 != null;
            assume true;
            assert $_Frame[t#0, _module.Node.childrenVisited];
            assume true;
            ...
            $Heap := update($Heap, t#0, _module.Node.childrenVisited, $rhs#0_0_0);
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(237,30)"} true;
            // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(238,9)
            assume true;
            if (p#0 == null)
            {
                // ----- return statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(239,11)
                return;
            }
            else
            {
            ...
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(241,18)
            assume true;
            assert p#0 != null;
            assert p#0 != null;
            ...
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(241,49)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(242,20)
            assert p#0 != null;
            assume true;
            ...
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(242,56)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(243,11)
            assume true;
            assume true;
            assert $Is(p#0, Tclass._module.Node());
            t#0 := p#0;
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(243,14)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(244,11)
            assume true;
            assume true;
            p#0 := oldP#0_0_0;
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(244,17)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(245,20)
            assume true;
            assert 0 <= Seq#Length(stackNodes#0) - 1
               && Seq#Length(stackNodes#0) - 1 <= Seq#Length(stackNodes#0);
            assume true;
            stackNodes#0 := Seq#Take(stackNodes#0, Seq#Length(stackNodes#0) - 1);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(245,52)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(246,27)
            assert t#0 != null;
            assume true;
            assert $_Frame[t#0, _module.Node.childrenVisited];
            assert t#0 != null;
            ...
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(246,50)"} true;
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(247,14)
            assume true;
            assert t#0 != null;
            assume true;
            path#0 := read($Heap, t#0, _module.Node.pathFromRoot);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(247,30)"} true;
        }
        else
        {
            // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(249,14)
            assert t#0 != null;
            assert t#0 != null;
            assert 0 <= read($Heap, t#0, _module.Node.childrenVisited)
               && read($Heap, t#0, _module.Node.childrenVisited)
            ...
            if ($Unbox(Seq#Index(read($Heap, t#0, _module.Node.children), 
               ...
               || read($Heap, 
                ...
                _module.Node.marked))
            {
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(251,27)
                assert t#0 != null;
                assume true;
                assert $_Frame[t#0, _module.Node.childrenVisited];
                assert t#0 != null;
                ...
                $Heap := update($Heap, t#0, _module.Node.childrenVisited, $rhs#0_1_0);
                assume $IsGoodHeap($Heap);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(251,50)"} true;
            }
            else
            {
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(256,18)
                assume true;
                assert t#0 != null;
                assert t#0 != null;
                assert 0 <= read($Heap, t#0, _module.Node.childrenVisited)
                   && read($Heap, t#0, _module.Node.childrenVisited)
                     < Seq#Length(read($Heap, t#0, _module.Node.children));
                assume true;
                newT#0_0 := $Unbox(Seq#Index(read($Heap, t#0, _module.Node.children), 
                    read($Heap, t#0, _module.Node.childrenVisited))): ref;
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(256,49)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(257,20)
                assert t#0 != null;
                assume true;
                ...
                assert 0 <= read($Heap, t#0, _module.Node.childrenVisited)
                   && read($Heap, t#0, _module.Node.childrenVisited)
                     < Seq#Length(read($Heap, t#0, _module.Node.children));
                assume true;
                $rhs#0_0 := Seq#Update(read($Heap, t#0, _module.Node.children), 
                  read($Heap, t#0, _module.Node.childrenVisited), 
                  $Box(p#0));
                $Heap := update($Heap, t#0, _module.Node.children, $rhs#0_0);
                assume $IsGoodHeap($Heap);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(257,56)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(258,11)
                assume true;
                assume true;
                p#0 := t#0;
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(258,14)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(259,20)
                assume true;
                assume true;
                stackNodes#0 := Seq#Append(stackNodes#0, Seq#Build(Seq#Empty(): Seq Box, $Box(t#0)));
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(259,38)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(260,14)
                assume true;
                assume true;
                path#0 := #_module.Path.Extend(path#0, t#0);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(260,36)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(261,11)
                assume true;
                assume true;
                assert $Is(newT#0_0, Tclass._module.Node());
                t#0 := newT#0_0;
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(261,17)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(262,18)
                assert t#0 != null;
                assume true;
                assert $_Frame[t#0, _module.Node.marked];
                assume true;
                $rhs#0_1 := Lit(true);
                $Heap := update($Heap, t#0, _module.Node.marked, $rhs#0_1);
                assume $IsGoodHeap($Heap);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(262,24)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(263,24)
                assert t#0 != null;
                assume true;
                assert $_Frame[t#0, _module.Node.pathFromRoot];
                assume true;
                $rhs#0_2 := path#0;
                $Heap := update($Heap, t#0, _module.Node.pathFromRoot, $rhs#0_2);
                assume $IsGoodHeap($Heap);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(263,30)"} true;
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(264,23)
                assume true;
                assume true;
                unmarkedNodes#0 := Set#Difference(unmarkedNodes#0, Set#UnionOne(Set#Empty(): Set Box, $Box(t#0)));
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(264,44)"} true;
            }
        }

        // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny1/SchorrWaite.dfy(194,5)
        assert 0 <= $decr$loop#02
           || (Set#Subset(unmarkedNodes#0, $decr$loop#00)
             && !Set#Subset($decr$loop#00, unmarkedNodes#0))
           || Seq#Rank(stackNodes#0) < Seq#Rank($decr$loop#01)
