...
axiom (forall a#14#0#0: int, a#14#1#0: int :: 
  { #GhostLetExpr.Dt.MyRecord(a#14#0#0, a#14#1#0) } 
  DatatypeCtorId(#GhostLetExpr.Dt.MyRecord(a#14#0#0, a#14#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  GhostLetExpr.Dt.MyRecord_q(d)
     ==> (exists a#15#0#0: int, a#15#1#0: int :: 
      d == #GhostLetExpr.Dt.MyRecord(a#15#0#0, a#15#1#0)));
...
axiom (forall a#16#0#0: int, a#16#1#0: int :: 
  { $Is(#GhostLetExpr.Dt.MyRecord(a#16#0#0, a#16#1#0), Tclass.GhostLetExpr.Dt()) } 
  $Is(#GhostLetExpr.Dt.MyRecord(a#16#0#0, a#16#1#0), Tclass.GhostLetExpr.Dt())
     <==> $Is(a#16#0#0, TInt) && $Is(a#16#1#0, TInt));

// Constructor $IsAlloc
axiom (forall a#17#0#0: int, a#17#1#0: int, $h: Heap :: 
  { $IsAlloc(#GhostLetExpr.Dt.MyRecord(a#17#0#0, a#17#1#0), Tclass.GhostLetExpr.Dt(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#GhostLetExpr.Dt.MyRecord(a#17#0#0, a#17#1#0), Tclass.GhostLetExpr.Dt(), $h)
...
axiom (forall a#18#0#0: int, a#18#1#0: int :: 
  { #GhostLetExpr.Dt.MyRecord(LitInt(a#18#0#0), LitInt(a#18#1#0)) } 
  #GhostLetExpr.Dt.MyRecord(LitInt(a#18#0#0), LitInt(a#18#1#0))
     == Lit(#GhostLetExpr.Dt.MyRecord(a#18#0#0, a#18#1#0)));

function GhostLetExpr.Dt.a(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#19#0#0: int, a#19#1#0: int :: 
  { #GhostLetExpr.Dt.MyRecord(a#19#0#0, a#19#1#0) } 
  GhostLetExpr.Dt.a(#GhostLetExpr.Dt.MyRecord(a#19#0#0, a#19#1#0)) == a#19#0#0);

function GhostLetExpr.Dt.b(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#20#0#0: int, a#20#1#0: int :: 
  { #GhostLetExpr.Dt.MyRecord(a#20#0#0, a#20#1#0) } 
  GhostLetExpr.Dt.b(#GhostLetExpr.Dt.MyRecord(a#20#0#0, a#20#1#0)) == a#20#1#0);
...
procedure CheckWellformed$$GhostLetExpr.__default.M();
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$GhostLetExpr.__default.M();
  modifies $Heap, $Tick;
...
procedure Impl$$GhostLetExpr.__default.M() returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$GhostLetExpr.__default.M() returns ($_reverifyPost: bool)
{
  ...
  var let#1#0#0: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(214,13): initial state"} true;
    $_reverifyPost := false;
    havoc y#0;
    havoc x#0;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(217,11)
    assume true;
    ##x#0 := x#0;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(217,20)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(218,17)
    assume true;
    havoc ta#Z#0;
    assume true;
    assume GhostLetExpr.__default.F#canCall();
    assume let#0#0#0 == LitInt(GhostLetExpr.__default.F());
    assume GhostLetExpr.__default.F#canCall();
    // CheckWellformedWithResult: any expression
    assume $Is(let#0#0#0, TInt);
    assume ta#Z#0 == let#0#0#0;
    assume GhostLetExpr.__default.F#canCall();
    h#0 := (var ta#0 := LitInt(GhostLetExpr.__default.F()); LitInt(5));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(218,35)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(219,11)
    assume true;
    havoc tb#Z#0;
    assume true;
    assume GhostLetExpr.__default.F#canCall();
    assume let#1#0#0 == LitInt(GhostLetExpr.__default.F());
    assume GhostLetExpr.__default.F#canCall();
    // CheckWellformedWithResult: any expression
    assume $Is(let#1#0#0, TInt);
    assume tb#Z#0 == let#1#0#0;
    assume GhostLetExpr.__default.F#canCall();
    j#0 := (var tb#0 := LitInt(GhostLetExpr.__default.F()); LitInt(5));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(219,35)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(220,5)
    assume true;
    assert h#0 == j#0;
}
...
axiom 1 <= $FunctionContextHeight
   ==> 
  GhostLetExpr.__default.F#canCall() || 1 != $FunctionContextHeight
   ==> true;
...
procedure CheckWellformed$$GhostLetExpr.__default.F();
...
axiom 3 <= $FunctionContextHeight
   ==> (forall x#0: int, y#0: int :: 
    ...
    GhostLetExpr.__default.G#canCall(x#0, y#0) || 3 != $FunctionContextHeight
       ==> true);
...
procedure CheckWellformed$$GhostLetExpr.__default.G(x#0: int, y#0: int);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GhostLetExpr.__default.G(x#0: int, y#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for function G
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(226,18): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(227,5)
        assume true;
        assert y#0 == y#0;
        assume GhostLetExpr.__default.G(x#0, y#0) == x#0;
        assume true;
        // CheckWellformedWithResult: any expression
...
procedure CheckWellformed$$GhostLetExpr.__default.P(dt#0: DatatypeType
...
procedure Call$$GhostLetExpr.__default.P(dt#0: DatatypeType
       where $Is(dt#0, Tclass.GhostLetExpr.Dt())
         && $IsAlloc(dt#0, Tclass.GhostLetExpr.Dt(), $Heap)
         && $IsA#GhostLetExpr.Dt(dt#0));
  modifies $Heap, $Tick;
...
procedure Impl$$GhostLetExpr.__default.P(dt#0: DatatypeType
       where $Is(dt#0, Tclass.GhostLetExpr.Dt())
         && $IsAlloc(dt#0, Tclass.GhostLetExpr.Dt(), $Heap)
         && $IsA#GhostLetExpr.Dt(dt#0))
...
axiom 5 <= $FunctionContextHeight
   ==> 
  GhostLetExpr.__default.FM#canCall() || 5 != $FunctionContextHeight
   ==> true;
...
procedure CheckWellformed$$GhostLetExpr.__default.FM();
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$GhostLetExpr.__default.FM()
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var xyz#Z#0: int;
  var let#0#0#0: int;
  ...
  var b$reqreads#1: bool;
    ...
    // AddWellformednessCheck for function FM
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(241,18): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        assume GhostLetExpr.__default.G#canCall(LitInt(5), xyz#Z#0);
        assume GhostLetExpr.__default.FM() == GhostLetExpr.__default.G(LitInt(5), xyz#Z#0);
        assume GhostLetExpr.__default.G#canCall(LitInt(5), xyz#Z#0);
        // CheckWellformedWithResult: any expression
        assume $Is(GhostLetExpr.__default.FM(), TInt);
        assert b$reqreads#0;
        assert b$reqreads#1;
    }
}
