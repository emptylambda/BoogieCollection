...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lockattr.c -bpl ./lockattr.bpl
...
const x: ref;
axiom (x == $sub.ref(0, 2076));
const lockattr: ref;
axiom (lockattr == $sub.ref(0, 3116));
const t1: ref;
axiom (t1 == $sub.ref(0, 4148));
  ...
  returns ($r: ref)
{
  ...
  var $i9: i1;
$bb0:
  assume {:sourceloc "test/c/pthread/lockattr.c", 14, 13} true;
  ...
  assume {:sourceloc "test/c/pthread/lockattr.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lockattr.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(lock);
  call {:cexpr "err"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/pthread/lockattr.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/lockattr.c", 18, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lockattr.c", 19, 4} true;
  assume {:verifier.code 0} true;
  $i5 := $M.0;
  assume {:sourceloc "test/c/pthread/lockattr.c", 19, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lockattr.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lockattr.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(lock);
  call {:cexpr "err"} boogie_si_record_i32($i8);
  assume {:sourceloc "test/c/pthread/lockattr.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/lockattr.c", 23, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/pthread/lockattr.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lockattr.c", 28, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lockattr.c", 29, 18} true;
  assume {:verifier.code 0} true;
  $M.1 := 2;
  assume {:sourceloc "test/c/pthread/lockattr.c", 30, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  call {:cexpr "err"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/pthread/lockattr.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/lockattr.c", 32, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lockattr.c", 33, 9} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_unlock(lock);
  call {:cexpr "err"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/pthread/lockattr.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/lockattr.c", 35, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/pthread/lockattr.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutexattr_init(lockattr);
  assume {:sourceloc "test/c/pthread/lockattr.c", 37, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutexattr_settype(lockattr, 2);
  assume {:sourceloc "test/c/pthread/lockattr.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_init(lock, lockattr);
  assume true;
  assume {:sourceloc "test/c/pthread/lockattr.c", 40, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_create($p0, $0.ref, t1, $0.ref);
  assume {:sourceloc "test/c/pthread/lockattr.c", 41, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.2, $p0);
  assume {:sourceloc "test/c/pthread/lockattr.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_join($i9, $0.ref);
  assume {:sourceloc "test/c/pthread/lockattr.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/pthread/lockattr.c", 42, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/pthread/lockattr.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (pthread_mutexattr_init == $sub.ref(0, 9308));
procedure {:inline 1} pthread_mutexattr_init($p0: ref)
  returns ($r: i32);
const pthread_mutexattr_settype: ref;
axiom (pthread_mutexattr_settype == $sub.ref(0, 10340));
procedure {:inline 1} pthread_mutexattr_settype($p0: ref, $i1: i32)
  returns ($r: i32);
const pthread_mutex_init: ref;
axiom (pthread_mutex_init == $sub.ref(0, 11372));
procedure {:inline 1} pthread_mutex_init($p0: ref, $p1: ref)
  returns ($r: i32);
const pthread_create: ref;
axiom (pthread_create == $sub.ref(0, 12404));
procedure {:inline 1} pthread_create($p0: ref, $p1: ref, $p2: ref, $p3: ref)
  returns ($r: i32);
const pthread_join: ref;
axiom (pthread_join == $sub.ref(0, 13436));
procedure {:inline 1} pthread_join($i0: i32, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 14468));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 15500));
...
axiom (__SMACK_dummy == $sub.ref(0, 16532));
...
axiom (__VERIFIER_assert == $sub.ref(0, 17564));
...
axiom (__SMACK_and32 == $sub.ref(0, 18596));
...
axiom (__SMACK_and64 == $sub.ref(0, 19628));
...
axiom (__SMACK_and16 == $sub.ref(0, 20660));
...
axiom (__SMACK_and8 == $sub.ref(0, 21692));
...
axiom (__SMACK_or32 == $sub.ref(0, 22724));
...
axiom (__SMACK_or64 == $sub.ref(0, 23756));
...
axiom (__SMACK_or16 == $sub.ref(0, 24788));
...
axiom (__SMACK_or8 == $sub.ref(0, 25820));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 26852));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 27884));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 28916));
