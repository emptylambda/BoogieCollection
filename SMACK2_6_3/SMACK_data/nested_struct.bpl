...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/nested_struct.c -bpl ./nested_struct.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/nested_struct.c", 24, 8} true;
  ...
  assume {:sourceloc "test/c/data/nested_struct.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "test/c/data/nested_struct.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/nested_struct.c", 25, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/nested_struct.c", 27, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 27, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p5, 2);
  assume {:sourceloc "test/c/data/nested_struct.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/data/nested_struct.c", 28, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/data/nested_struct.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1));
  $p10 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 30, 17} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p10, 100);
  assume {:sourceloc "test/c/data/nested_struct.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/data/nested_struct.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 31, 3} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/data/nested_struct.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/data/nested_struct.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1));
  $p15 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 32, 3} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/data/nested_struct.c", 34, 8} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 34, 13} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i16($M.2, $p18, 5);
  assume {:sourceloc "test/c/data/nested_struct.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/data/nested_struct.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 35, 3} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/data/nested_struct.c", 36, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/data/nested_struct.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1));
  $p23 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 36, 3} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb28;
$bb30:
  assume {:sourceloc "test/c/data/nested_struct.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/data/nested_struct.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 37, 3} true;
  assume {:verifier.code 0} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/data/nested_struct.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1));
  $p31 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 39, 17} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i32($M.3, $p31, 200);
  assume {:sourceloc "test/c/data/nested_struct.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/data/nested_struct.c", 40, 3} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(12, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 40, 3} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/data/nested_struct.c", 41, 3} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/data/nested_struct.c", 41, 3} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1));
  $p36 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(4, 1)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 41, 3} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/data/nested_struct.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb46;
$bb46:
  assume {:sourceloc "test/c/data/nested_struct.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 42, 3} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb48;
$bb50:
  assume {:sourceloc "test/c/data/nested_struct.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb51;
$bb51:
  assume {:sourceloc "test/c/data/nested_struct.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1));
  $p44 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 28)), $mul.ref(16, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct.c", 43, 3} true;
  assume {:verifier.code 0} true;
...
$bb54:
  ...
  goto $bb53;
$bb55:
  assume {:sourceloc "test/c/data/nested_struct.c", 45, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
