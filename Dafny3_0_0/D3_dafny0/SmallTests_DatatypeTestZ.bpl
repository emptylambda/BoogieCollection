...
procedure CheckWellformed$$DatatypeTestZ.__default.Test();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$DatatypeTestZ.__default.Test();
  modifies $Heap, $Tick;
...
procedure Impl$$DatatypeTestZ.__default.Test() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$DatatypeTestZ.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var bb#0: DatatypeType
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(871,16): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(872,12)
    assume true;
    assume true;
    aa#0 := Lit(#ListLibrary.List.Nil());
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(872,35)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(873,12)
    assume true;
    assume true;
    bb#0 := Lit(#ListLibrary.List.Nil());
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(873,24)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/SmallTests.dfy(874,5)
    assume $IsA#ListLibrary.List(aa#0) && $IsA#ListLibrary.List(bb#0);
    assert ListLibrary.List#Equal(aa#0, bb#0);
}
