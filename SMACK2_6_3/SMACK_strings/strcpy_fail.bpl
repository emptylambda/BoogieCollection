...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strcpy_fail.c -bpl ./strcpy_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strcpy_fail.c", 10, 10} true;
  ...
  assume {:sourceloc "test/c/strings/strcpy_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := strcpy($p1, .str);
  assume $isExternal($p2);
  assume {:sourceloc "test/c/strings/strcpy_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strcpy_fail.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strcpy_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
