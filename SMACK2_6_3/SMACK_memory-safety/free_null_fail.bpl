...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/free_null_fail.c -bpl ./free_null_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/free_null_fail.c", 7, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/memory-safety/free_null_fail.c", 7, 10} true;
  assume {:verifier.code 0} true;
  $p0 := $add.ref($0.ref, $mul.ref(1, 4));
  assume {:sourceloc "test/c/memory-safety/free_null_fail.c", 7, 8} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/memory-safety/free_null_fail.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call free_($p1);
  assume {:sourceloc "test/c/memory-safety/free_null_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
