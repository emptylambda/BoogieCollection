...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/round_fail.c -bpl ./round_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/round_fail.c", 12, 16} true;
  ...
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __isnan($f0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 21} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/round_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 25} true;
  assume {:verifier.code 0} true;
  call $i3 := __isinf($f0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 38} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 42} true;
  assume {:verifier.code 0} true;
  call $i5 := __iszero($f0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 42} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/round_fail.c", 15, 19} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:15:19: warning: over-approximating call to llvm.round.f64; */
  call $f7 := llvm.round.f64($f0);
  call {:cexpr "rval"} boogie_si_record_float($f7);
  assume {:sourceloc "test/c/mathc/round_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "test/c/mathc/round_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:16:5: warning: over-approximating call to llvm.floor.f64; */
  call $f8 := llvm.floor.f64($f0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  assume {:sourceloc "test/c/mathc/round_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:16:5: warning: over-approximating call to llvm.ceil.f64; */
  call $f10 := llvm.ceil.f64($f0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb10;
$bb14:
  assume {:sourceloc "test/c/mathc/round_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb15:
  assume {:sourceloc "test/c/mathc/round_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:19:3: warning: over-approximating call to llvm.round.f64; */
  call $f12 := llvm.round.f64($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/round_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i13 := (if $folt.float.bool($f12, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb17;
$bb19:
  assume {:sourceloc "test/c/mathc/round_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/mathc/round_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:20:3: warning: over-approximating call to llvm.round.f64; */
  call $f14 := llvm.round.f64($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/round_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i15 := (if $foeq.float.bool($f14, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb22;
$bb24:
  assume {:sourceloc "test/c/mathc/round_fail.c", 21, 25} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:21:25: warning: over-approximating call to llvm.round.f64; */
  call $f16 := llvm.round.f64($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/round_fail.c", 21, 15} true;
  assume {:verifier.code 0} true;
  call $i17 := __signbit($f16);
  call {:cexpr "isNeg"} boogie_si_record_i32($i17);
  assume {:sourceloc "test/c/mathc/round_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb25:
  assume {:sourceloc "test/c/mathc/round_fail.c", 22, 3} true;
...
$bb28:
  ...
  goto $bb27;
$bb29:
  assume {:sourceloc "test/c/mathc/round_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb30;
$bb30:
  assume {:sourceloc "test/c/mathc/round_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:24:3: warning: over-approximating call to llvm.round.f64; */
  call $f19 := llvm.round.f64($fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/round_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  goto $bb32;
$bb34:
  assume {:sourceloc "test/c/mathc/round_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb35;
$bb35:
  assume {:sourceloc "test/c/mathc/round_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:25:3: warning: over-approximating call to llvm.round.f64; */
  call $f21 := llvm.round.f64($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/round_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(0, 0, 32157568)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb37;
$bb39:
  assume {:sourceloc "test/c/mathc/round_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb40;
$bb40:
  assume {:sourceloc "test/c/mathc/round_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/round_fail.c:27:3: warning: over-approximating call to llvm.round.f64; */
  call $f23 := llvm.round.f64($fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/round_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i24 := __isnan($f23);
  assume {:sourceloc "test/c/mathc/round_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.i32($i24, 0);
  assume {:sourceloc "test/c/mathc/round_fail.c", 27, 3} true;
...
$bb43:
  ...
  goto $bb42;
$bb44:
  assume {:sourceloc "test/c/mathc/round_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure {:inline 1} __iszero($f0: float)
  returns ($r: i32);
const llvm.round.f64: ref;
axiom (llvm.round.f64 == $sub.ref(0, 6192));
procedure {:inline 1} llvm.round.f64($f0: float)
  returns ($r: float);
const llvm.floor.f64: ref;
axiom (llvm.floor.f64 == $sub.ref(0, 7224));
procedure {:inline 1} llvm.floor.f64($f0: float)
  returns ($r: float);
const llvm.ceil.f64: ref;
axiom (llvm.ceil.f64 == $sub.ref(0, 8256));
procedure {:inline 1} llvm.ceil.f64($f0: float)
  returns ($r: float);
const __signbit: ref;
axiom (__signbit == $sub.ref(0, 9288));
