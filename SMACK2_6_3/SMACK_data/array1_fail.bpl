...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/array1_fail.c -bpl ./array1_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/array1_fail.c", 11, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/array1_fail.c", 11, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(40);
  assume {:sourceloc "test/c/data/array1_fail.c", 11, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/array1_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(5, 4));
  assume {:sourceloc "test/c/data/array1_fail.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 10);
  assume {:sourceloc "test/c/data/array1_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array1_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p1, $mul.ref(4, 4));
  assume {:sourceloc "test/c/data/array1_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.1, $p3);
  assume {:sourceloc "test/c/data/array1_fail.c", 15, 3} true;
...
$bb6:
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "test/c/data/array1_fail.c", 17, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/array1_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call free_($p9);
  assume {:sourceloc "test/c/data/array1_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
