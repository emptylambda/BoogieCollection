...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/while.c -bpl ./while.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/while.c", 5, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/reach/while.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/while.c", 5, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 1);
  assume {:sourceloc "test/c/reach/while.c", 5, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/reach/while.c", 6, 6} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/reach/while.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
