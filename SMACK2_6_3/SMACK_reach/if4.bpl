...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/if4.c -bpl ./if4.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/if4.c", 6, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/reach/if4.c", 6, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $eq.i32(3, 4);
  assume {:sourceloc "test/c/reach/if4.c", 6, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i0} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i0 == 1);
  assume {:sourceloc "test/c/reach/if4.c", 7, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "test/c/reach/if4.c", 6, 7} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/reach/if4.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 4;
  $exn := false;
  return;
