...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/floorf.c -bpl ./floorf.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/floorf.c", 12, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/mathc/floorf.c", 12, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:12:3: warning: over-approximating call to llvm.floor.f32; */
  call $f0 := llvm.floor.f32($fp(0, 4007333340000000, 140265994694644));
  assume {:sourceloc "test/c/mathc/floorf.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i1 := (if $foeq.float.bool($f0, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/floorf.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/floorf.c", 14, 15} true;
  assume {:verifier.code 1} true;
  call $f2 := __VERIFIER_nondet_float();
  call {:cexpr "smack:ext:__VERIFIER_nondet_float"} boogie_si_record_float($f2);
  call {:cexpr "val"} boogie_si_record_float($f2);
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 8} true;
  assume {:verifier.code 0} true;
  call $i3 := __isnanf($f2);
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 22} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/mathc/floorf.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb8:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 26} true;
  assume {:verifier.code 0} true;
  call $i5 := __isinff($f2);
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 40} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 44} true;
  assume {:verifier.code 0} true;
  call $i7 := __iszerof($f2);
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 44} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, 0);
  assume {:sourceloc "test/c/mathc/floorf.c", 16, 7} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i8 == 1));
  assume {:sourceloc "test/c/mathc/floorf.c", 17, 5} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "test/c/mathc/floorf.c", 17, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:17:5: warning: over-approximating call to llvm.floor.f32; */
  call $f9 := llvm.floor.f32($f2);
  assume {:sourceloc "test/c/mathc/floorf.c", 17, 5} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb15;
$bb17:
  assume {:sourceloc "test/c/mathc/floorf.c", 18, 5} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb18:
  assume {:sourceloc "test/c/mathc/floorf.c", 18, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:18:5: warning: over-approximating call to llvm.floor.f32; */
  call $f11 := llvm.floor.f32($f2);
  assume {:sourceloc "test/c/mathc/floorf.c", 18, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:18:5: warning: over-approximating floating-point arithmetic fsub; */
  $f12 := $fsub.float($f2, $fp(1, 0, 0));
  assume {:sourceloc "test/c/mathc/floorf.c", 18, 5} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  goto $bb20;
$bb22:
  assume {:sourceloc "test/c/mathc/floorf.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb23:
  assume {:sourceloc "test/c/mathc/floorf.c", 21, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:21:3: warning: over-approximating call to llvm.floor.f32; */
  call $f14 := llvm.floor.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/floorf.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb25;
$bb27:
  assume {:sourceloc "test/c/mathc/floorf.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb28:
  assume {:sourceloc "test/c/mathc/floorf.c", 22, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:22:3: warning: over-approximating call to llvm.floor.f32; */
  call $f16 := llvm.floor.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/floorf.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb31:
  ...
  goto $bb30;
$bb32:
  assume {:sourceloc "test/c/mathc/floorf.c", 23, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:23:26: warning: over-approximating call to llvm.floor.f32; */
  call $f18 := llvm.floor.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/floorf.c", 23, 15} true;
  assume {:verifier.code 0} true;
  call $i19 := __signbitf($f18);
  call {:cexpr "isNeg"} boogie_si_record_i32($i19);
  assume {:sourceloc "test/c/mathc/floorf.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/mathc/floorf.c", 24, 3} true;
...
$bb36:
  ...
  goto $bb35;
$bb37:
  assume {:sourceloc "test/c/mathc/floorf.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb38:
  assume {:sourceloc "test/c/mathc/floorf.c", 26, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:26:3: warning: over-approximating call to llvm.floor.f32; */
  call $f21 := llvm.floor.f32($fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/floorf.c", 26, 3} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb40;
$bb42:
  assume {:sourceloc "test/c/mathc/floorf.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb43:
  assume {:sourceloc "test/c/mathc/floorf.c", 27, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:27:3: warning: over-approximating call to llvm.floor.f32; */
  call $f23 := llvm.floor.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/floorf.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i24 := (if $foeq.float.bool($f23, $fp(0, 0, 28831536)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/floorf.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb46:
  ...
  goto $bb45;
$bb47:
  assume {:sourceloc "test/c/mathc/floorf.c", 29, 3} true;
  assume {:verifier.code 0} true;
  goto $bb48;
$bb48:
  assume {:sourceloc "test/c/mathc/floorf.c", 29, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floorf.c:29:3: warning: over-approximating call to llvm.floor.f32; */
  call $f25 := llvm.floor.f32($fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/floorf.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call $i26 := __isnanf($f25);
  assume {:sourceloc "test/c/mathc/floorf.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $ne.i32($i26, 0);
  assume {:sourceloc "test/c/mathc/floorf.c", 29, 3} true;
...
$bb51:
  ...
  goto $bb50;
$bb52:
  assume {:sourceloc "test/c/mathc/floorf.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.floor.f32 == $sub.ref(0, 2064));
