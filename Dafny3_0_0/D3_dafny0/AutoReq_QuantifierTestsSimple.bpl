...
procedure CheckWellformed$$QuantifierTestsSimple.__default.byte(x#0: int);
...
procedure CheckWellformed$$QuantifierTestsSimple.__default.f__forall(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsSimple.__default.f__forall(s#0: Seq Box)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(75,11): initial state"} true;
    ...
    else
    {
        ...
        assume QuantifierTestsSimple.__default.f__forall(s#0)
           == (forall i#3: int :: 
...
procedure CheckWellformed$$QuantifierTestsSimple.__default.f__exists(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsSimple.__default.f__exists(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#2: int;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(80,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        // End Comprehension WF check
        assume QuantifierTestsSimple.__default.f__exists(s#0)
           == (exists i#3: int :: 
            { $Unbox(Seq#Index(s#0, i#3)): int } 
            LitInt(0) <= i#3
               && i#3 < Seq#Length(s#0)
...
procedure CheckWellformed$$QuantifierTestsSimple.__default.g__forall(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsSimple.__default.g__forall(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##s#0: Seq Box;
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(85,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##s#0 := s#0;
    // assume allocatedness for argument to function
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        assume QuantifierTestsSimple.__default.g__forall(s#0) == (Seq#Length(s#0) > 2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsSimple.__default.g__forall(s#0), TBool);
    }
}
...
procedure CheckWellformed$$QuantifierTestsSimple.__default.g__exists(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsSimple.__default.g__exists(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##s#0: Seq Box;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function g_exists
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(91,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##s#0 := s#0;
    // assume allocatedness for argument to function
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        assume QuantifierTestsSimple.__default.g__exists(s#0) == (Seq#Length(s#0) > 2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsSimple.__default.g__exists(s#0), TBool);
    }
}
...
procedure CheckWellformed$$QuantifierTestsSimple.__default.h(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$QuantifierTestsSimple.__default.h(s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##s#0: Seq Box;
  var ##s#1: Seq Box;
  ...
  var b$reqreads#4: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(97,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##s#0 := s#0;
    // assume allocatedness for argument to function
    ...
    if (*)
    {
        ...
        assert {:subsumption 0} QuantifierTestsSimple.__default.f__forall#canCall(##s#1)
        ...
        assume QuantifierTestsSimple.__default.g__forall(s#0);
        ##s#2 := s#0;
        // assume allocatedness for argument to function
    ...
    else
    {
        ...
        assert {:subsumption 0} QuantifierTestsSimple.__default.f__forall#canCall(##s#3)
        ...
        if (QuantifierTestsSimple.__default.g__forall(s#0))
        {
            ...
            assert {:subsumption 0} QuantifierTestsSimple.__default.f__exists#canCall(##s#4)
        ...
        assume QuantifierTestsSimple.__default.h(s#0)
           == (QuantifierTestsSimple.__default.g__forall(s#0)
             && QuantifierTestsSimple.__default.g__exists(s#0));
        assume QuantifierTestsSimple.__default.g__forall#canCall(s#0)
           && (QuantifierTestsSimple.__default.g__forall(s#0)
