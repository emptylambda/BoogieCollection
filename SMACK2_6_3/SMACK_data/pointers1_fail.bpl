...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/pointers1_fail.c -bpl ./pointers1_fail.bpl
...
procedure {:inline 1} incr($p0: ref)
{
  ...
  var $i9: i32;
$bb0:
  assume {:sourceloc "test/c/data/pointers1_fail.c", 13, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/pointers1_fail.c", 13, 6} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/pointers1_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/pointers1_fail.c", 14, 6} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/pointers1_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.1, $p4);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/pointers1_fail.c", 15, 6} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/pointers1_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/pointers1_fail.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/pointers1_fail.c", 19, 23} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 19, 23} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 19, 14} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 21, 13} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/pointers1_fail.c", 21, 15} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p2, 0);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 21, 6} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/pointers1_fail.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 0);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call incr($p1);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/pointers1_fail.c", 25, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/pointers1_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/data/pointers1_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/pointers1_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.1, $p7);
  assume {:sourceloc "test/c/data/pointers1_fail.c", 26, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/data/pointers1_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
