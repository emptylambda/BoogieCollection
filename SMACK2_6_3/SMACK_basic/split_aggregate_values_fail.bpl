...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/split_aggregate_values_fail.c -bpl ./split_aggregate_values_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $p12: ref;
$bb0:
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 13, 5} true;
  ...
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 1);
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 2);
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 3);
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p5, $p6, 12, false);
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 16, 3} true;
  $p7 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 16, 3} true;
  $i8 := $load.i64($M.1, $p7);
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 16, 3} true;
  assume ($extractvalue.i32($p9, 1) == $extractvalue.i32($u0, 1));
  ...
  assume ($extractvalue.i32($p12, 1) == $i11);
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := $p12;
  $exn := false;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  call $M.3 := $memcpy.i8($M.3, $M.2, $p8, $p7, 12, false);
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 21, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/split_aggregate_values_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
