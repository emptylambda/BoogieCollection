...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/simple_float.c -bpl ./simple_float.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/simple_float.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/simple_float.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
