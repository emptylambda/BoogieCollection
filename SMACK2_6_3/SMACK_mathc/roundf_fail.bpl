...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/roundf_fail.c -bpl ./roundf_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 12, 15} true;
  ...
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __isnanf($f0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 22} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 26} true;
  assume {:verifier.code 0} true;
  call $i3 := __isinff($f0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 26} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 40} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 44} true;
  assume {:verifier.code 0} true;
  call $i5 := __iszerof($f0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 44} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 15, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:15:18: warning: over-approximating call to llvm.round.f32; */
  call $f7 := llvm.round.f32($f0);
  call {:cexpr "rval"} boogie_si_record_float($f7);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:16:5: warning: over-approximating call to llvm.floor.f32; */
  call $f8 := llvm.floor.f32($f0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:16:5: warning: over-approximating call to llvm.ceil.f32; */
  call $f10 := llvm.ceil.f32($f0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb10;
$bb14:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb15:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:19:3: warning: over-approximating call to llvm.round.f32; */
  call $f12 := llvm.round.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i13 := (if $foeq.float.bool($f12, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb17;
$bb19:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:20:3: warning: over-approximating call to llvm.round.f32; */
  call $f14 := llvm.round.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i15 := (if $fogt.float.bool($f14, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb22;
$bb24:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 21, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:21:26: warning: over-approximating call to llvm.round.f32; */
  call $f16 := llvm.round.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 21, 15} true;
  assume {:verifier.code 0} true;
  call $i17 := __signbitf($f16);
  call {:cexpr "isNeg"} boogie_si_record_i32($i17);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb25:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 22, 3} true;
...
$bb28:
  ...
  goto $bb27;
$bb29:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb30;
$bb30:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:24:3: warning: over-approximating call to llvm.round.f32; */
  call $f19 := llvm.round.f32($fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i20 := (if $foeq.float.bool($f19, $fp(0, 7, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  goto $bb32;
$bb34:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb35;
$bb35:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:25:3: warning: over-approximating call to llvm.round.f32; */
  call $f21 := llvm.round.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(0, 0, 34812592)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb37;
$bb39:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb40;
$bb40:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundf_fail.c:27:3: warning: over-approximating call to llvm.round.f32; */
  call $f23 := llvm.round.f32($fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i24 := __isnanf($f23);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.i32($i24, 0);
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 27, 3} true;
...
$bb43:
  ...
  goto $bb42;
$bb44:
  assume {:sourceloc "test/c/mathc/roundf_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure {:inline 1} __iszerof($f0: float)
  returns ($r: i32);
const llvm.round.f32: ref;
axiom (llvm.round.f32 == $sub.ref(0, 6192));
procedure {:inline 1} llvm.round.f32($f0: float)
  returns ($r: float);
const llvm.floor.f32: ref;
axiom (llvm.floor.f32 == $sub.ref(0, 7224));
procedure {:inline 1} llvm.floor.f32($f0: float)
  returns ($r: float);
const llvm.ceil.f32: ref;
axiom (llvm.ceil.f32 == $sub.ref(0, 8256));
procedure {:inline 1} llvm.ceil.f32($f0: float)
  returns ($r: float);
const __signbitf: ref;
axiom (__signbitf == $sub.ref(0, 9288));
