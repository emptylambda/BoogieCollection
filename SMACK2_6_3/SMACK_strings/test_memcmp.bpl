...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/test_memcmp.c -bpl ./test_memcmp.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 25812));
...
const {:count 12} __const.main.word1: ref;
axiom (__const.main.word1 == $sub.ref(0, 1036));
const {:count 12} __const.main.word2: ref;
axiom (__const.main.word2 == $sub.ref(0, 2072));
const {:count 12} __const.main.word3: ref;
axiom (__const.main.word3 == $sub.ref(0, 3108));
const main: ref;
axiom (main == $sub.ref(0, 4140));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/test_memcmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(12, $zext.i32.i64(1)));
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/strings/test_memcmp.c", 7, 8} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p3, __const.main.word1, 12, false);
  assume true;
  assume {:sourceloc "test/c/strings/test_memcmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/strings/test_memcmp.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call $M.3 := $memcpy.i8($M.3, $M.2, $p4, __const.main.word2, 12, false);
  assume true;
  assume {:sourceloc "test/c/strings/test_memcmp.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/strings/test_memcmp.c", 9, 8} true;
  assume {:verifier.code 0} true;
  call $M.5 := $memcpy.i8($M.5, $M.4, $p5, __const.main.word3, 12, false);
  assume {:sourceloc "test/c/strings/test_memcmp.c", 12, 19} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp.c", 12, 26} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p1, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp.c", 12, 12} true;
  assume {:verifier.code 0} true;
  call $i8 := memcmp($p6, $p7, 11);
  call {:cexpr "result"} boogie_si_record_i32($i8);
  assume {:sourceloc "test/c/strings/test_memcmp.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/test_memcmp.c", 13, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/test_memcmp.c", 14, 19} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp.c", 14, 26} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p2, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp.c", 14, 12} true;
  assume {:verifier.code 0} true;
  call $i12 := memcmp($p10, $p11, 11);
  call {:cexpr "result"} boogie_si_record_i32($i12);
  assume {:sourceloc "test/c/strings/test_memcmp.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/strings/test_memcmp.c", 15, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/strings/test_memcmp.c", 16, 19} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p2, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp.c", 16, 12} true;
  assume {:verifier.code 0} true;
  call $i16 := memcmp($p14, $p15, 8);
  call {:cexpr "result"} boogie_si_record_i32($i16);
  assume {:sourceloc "test/c/strings/test_memcmp.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/strings/test_memcmp.c", 17, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/strings/test_memcmp.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 10332));
...
axiom (__VERIFIER_assert == $sub.ref(0, 11364));
...
axiom (__SMACK_and32 == $sub.ref(0, 12396));
...
axiom (__SMACK_and64 == $sub.ref(0, 13428));
...
axiom (__SMACK_and16 == $sub.ref(0, 14460));
...
axiom (__SMACK_and8 == $sub.ref(0, 15492));
...
axiom (__SMACK_or32 == $sub.ref(0, 16524));
...
axiom (__SMACK_or64 == $sub.ref(0, 17556));
...
axiom (__SMACK_or16 == $sub.ref(0, 18588));
...
axiom (__SMACK_or8 == $sub.ref(0, 19620));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 20652));
...
axiom (__SMACK_decls == $sub.ref(0, 21684));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 22716));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 23748));
...
axiom (llvm.dbg.value == $sub.ref(0, 24780));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 25812));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i8($M.0, __const.main.word1, 84);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(1, 1)), 101);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(2, 1)), 115);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(3, 1)), 116);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(4, 1)), 32);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(5, 1)), 109);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(6, 1)), 101);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(7, 1)), 109);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(8, 1)), 99);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(9, 1)), 109);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(10, 1)), 112);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word1, $mul.ref(0, 12)), $mul.ref(11, 1)), 0);
  $M.2 := $store.i8($M.2, __const.main.word2, 84);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(1, 1)), 101);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(2, 1)), 115);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(3, 1)), 116);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(4, 1)), 32);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(5, 1)), 109);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(6, 1)), 101);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(7, 1)), 109);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(8, 1)), 99);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(9, 1)), 109);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(10, 1)), 112);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(11, 1)), 0);
  $M.4 := $store.i8($M.4, __const.main.word3, 84);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(1, 1)), 101);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(2, 1)), 115);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(3, 1)), 116);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(4, 1)), 32);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(5, 1)), 109);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(6, 1)), 101);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(7, 1)), 109);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(8, 1)), 99);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(9, 1)), 112);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(10, 1)), 121);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(11, 1)), 0);
  $exn := false;
  return;
}
