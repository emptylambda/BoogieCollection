...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strncmp_fail.c -bpl ./strncmp_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strncmp_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strncmp_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
