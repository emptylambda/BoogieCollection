...
procedure CheckWellformed$$ITER__A.RecursiveIterator.__ctor(this: ref
       where this != null
         && 
...
procedure Call$$ITER__A.RecursiveIterator.__ctor(n#0: int where LitInt(0) <= n#0, 
    r#0: ref
       where $Is(r#0, Tclass.ITER__A.RecIterCaller?())
         && $IsAlloc(r#0, Tclass.ITER__A.RecIterCaller?(), $Heap), 
    good#0: bool)
  ...
  free ensures true;
  ensures ITER__A.RecursiveIterator.n(this) == n#0;
  free ensures true;
  ensures ITER__A.RecursiveIterator.r(this) == r#0;
  free ensures true;
  ensures ITER__A.RecursiveIterator.good(this) == good#0;
  free ensures ITER__A.RecursiveIterator.Valid#canCall($Heap, this);
  ensures ITER__A.RecursiveIterator.Valid($Heap, this);
  free ensures true;
  ensures Set#Equal(ITER__A.RecursiveIterator.__reads(this), Set#Empty(): Set Box);
  free ensures true;
  ensures Set#Equal(ITER__A.RecursiveIterator.__modifies(this), Set#Empty(): Set Box);
  free ensures true;
  ensures Set#Equal(read($Heap, this, ITER__A.RecursiveIterator.__new), Set#Empty(): Set Box);
  free ensures true;
  ensures ITER__A.RecursiveIterator.__decreases0(this) == n#0 + 2;
  free ensures true;
  ensures ITER__A.RecursiveIterator.__decreases1(this) == LitInt(0);
...
procedure CheckWellformed$$ITER__A.RecursiveIterator.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__A.RecursiveIterator(), $Heap));
...
implementation CheckWellformed$$ITER__A.RecursiveIterator.Valid(this: ref)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(243,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> $o == this
           || ITER__A.RecursiveIterator.__reads(this)[$Box($o)]
           || read($Heap, this, ITER__A.RecursiveIterator.__new)[$Box($o)]);
    b$reqreads#0 := $_Frame[this, ITER__A.RecursiveIterator.__new];
    assert b$reqreads#0;
    if (*)
    {
        assume false;
...
procedure Call$$ITER__A.RecursiveIterator.MoveNext(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__A.RecursiveIterator(), $Heap))
   returns (more#0: bool);
  // user-defined preconditions
  requires ITER__A.RecursiveIterator.Valid($Heap, this);
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
  ensures (forall $o: ref :: 
    ...
    read($Heap, this, ITER__A.RecursiveIterator.__new)[$Box($o)]
         && !read(old($Heap), this, ITER__A.RecursiveIterator.__new)[$Box($o)]
       ==> $o != null && !read(old($Heap), $o, alloc));
  free ensures true;
  ensures !read($Heap, this, ITER__A.RecursiveIterator.__new)[$Box(null)];
  free ensures more#0 ==> ITER__A.RecursiveIterator.Valid#canCall($Heap, this);
  ensures more#0 ==> ITER__A.RecursiveIterator.Valid($Heap, this);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && read(old($Heap), $o, alloc)
       ==> $Heap[$o] == old($Heap)[$o]
         || 
        $o == this
         || ITER__A.RecursiveIterator.__modifies(this)[$Box($o)]
         || read(old($Heap), this, ITER__A.RecursiveIterator.__new)[$Box($o)]);
  // boilerplate
  free ensures $HeapSucc(old($Heap), $Heap);
...
procedure Impl$$ITER__A.RecursiveIterator(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__A.RecursiveIterator(), $Heap), 
...
implementation Impl$$ITER__A.RecursiveIterator(this: ref, n#0: int, r#0: ref, good#0: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var $iter_newUpdate0: Set Box;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(243,11): initial state"} true;
    assume r#0 != null;
    assume ITER__A.RecursiveIterator.n(this) == n#0;
    assume ITER__A.RecursiveIterator.r(this) == r#0;
    assume ITER__A.RecursiveIterator.good(this) == good#0;
    assume ITER__A.RecursiveIterator.Valid($Heap, this);
    assume Set#Equal(ITER__A.RecursiveIterator.__reads(this), Set#Empty(): Set Box);
    assume Set#Equal(ITER__A.RecursiveIterator.__modifies(this), Set#Empty(): Set Box);
    assume Set#Equal(read($Heap, this, ITER__A.RecursiveIterator.__new), Set#Empty(): Set Box);
    assume ITER__A.RecursiveIterator.__decreases0(this) == n#0 + 2;
    assume ITER__A.RecursiveIterator.__decreases1(this) == LitInt(0);
    assume _yieldCount#0 == 0;
    call $YieldHavoc(this, ITER__A.RecursiveIterator.__reads(this), read($Heap, this, ITER__A.RecursiveIterator.__new));
    $_OldIterHeap := $Heap;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(247,5)
    assume true;
    if (ITER__A.RecursiveIterator.n(this) == LitInt(0))
    {
    }
    else
    {
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(248,12)
        assume true;
        if (ITER__A.RecursiveIterator.good(this))
        {
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(249,10)
            $initHeapCallStmt#1_0 := $Heap;
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert ITER__A.RecursiveIterator.r(this) != null;
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert $Is(ITER__A.RecursiveIterator.n(this) - 1, Tclass._System.nat());
            n##0 := ITER__A.RecursiveIterator.n(this) - 1;
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assert 0 <= n#0 + 2 || n##0 + 2 == n#0 + 2;
            assert n##0 + 2 < n#0 + 2;
            // ProcessCallStmt: Make the call
            call Call$$ITER__A.RecIterCaller.M(ITER__A.RecursiveIterator.r(this), n##0);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate1_0 := $IterCollectNewObjects($initHeapCallStmt#1_0, $Heap, this, ITER__A.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__A.RecursiveIterator.__new, $iter_newUpdate1_0);
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(249,16)"} true;
        }
        else
        {
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(251,10)
            ...
            // ProcessCallStmt: CheckSubrange
            assert $Is(ITER__A.RecursiveIterator.n(this) + 1, Tclass._System.nat());
            n##1 := ITER__A.RecursiveIterator.n(this) + 1;
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assert 0 <= n#0 + 2 || n##1 + 2 == n#0 + 2;
            assert n##1 + 2 < n#0 + 2;
            // ProcessCallStmt: Make the call
            call Call$$ITER__A.RecIterCaller.M(ITER__A.RecursiveIterator.r(this), n##1);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate0 := $IterCollectNewObjects($initHeapCallStmt#0, $Heap, this, ITER__A.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__A.RecursiveIterator.__new, $iter_newUpdate0);
            assume $IsGoodHeap($Heap);
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(251,16)"} true;
        }
    }
}
...
procedure CheckWellformed$$ITER__A.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__A.RecIterCaller(), $Heap), 
    n#0: int where LitInt(0) <= n#0);
...
procedure Call$$ITER__A.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__A.RecIterCaller(), $Heap), 
...
procedure Impl$$ITER__A.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__A.RecIterCaller(), $Heap), 
...
implementation Impl$$ITER__A.RecIterCaller.M(this: ref, n#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var good#0: bool;
  var iter#0: ref
     where $Is(iter#0, Tclass.ITER__A.RecursiveIterator())
       && $IsAlloc(iter#0, Tclass.ITER__A.RecursiveIterator(), $Heap);
  var $nw: ref;
  var n##0: int;
  var r##0: ref;
  var good##0: bool;
  ...
  var $rhs##0: bool;
    ...
    // AddMethodImpl: M, Impl$$ITER__A.RecIterCaller.M
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(258,4): initial state"} true;
    $_reverifyPost := false;
    havoc good#0;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(260,16)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(260,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    n##0 := n#0;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$ITER__A.RecursiveIterator.__ctor(n##0, r##0, good##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(260,54)"} true;
    iter#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(260,54)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(261,32)
    assume true;
    ...
    assert (forall<alpha> $o: ref, $f: Field alpha :: 
      $o != null
           ...
           && (
            $o == iter#0
             || ITER__A.RecursiveIterator.__modifies(iter#0)[$Box($o)]
             || read($Heap, iter#0, ITER__A.RecursiveIterator.__new)[$Box($o)])
         ==> $_Frame[$o, $f]);
    assert 0 <= n#0 + 2 || ITER__A.RecursiveIterator.__decreases0(iter#0) == n#0 + 2;
    assert ITER__A.RecursiveIterator.__decreases0(iter#0) <= n#0 + 2
       && (ITER__A.RecursiveIterator.__decreases0(iter#0) == n#0 + 2 ==> true);
    // ProcessCallStmt: Make the call
    call $rhs##0 := Call$$ITER__A.RecursiveIterator.MoveNext(iter#0);
    // TrCallStmt: After ProcessCallStmt
    more#0 := $rhs##0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Iterators.dfy(261,33)"} true;
}
