...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/vararg_fail.c -bpl ./vararg_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 26839));
...
const .str: ref;
axiom (.str == $sub.ref(0, 1034));
const {:count 13} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 2071));
const main: ref;
axiom (main == $sub.ref(0, 3103));
procedure {:entrypoint} main()
  returns ($r: i32)
{
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/vararg_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call panic.i32(1);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call panic.i32.i32(2, 2);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const panic: ref;
axiom (panic == $sub.ref(0, 4135));
procedure {:inline 1} panic.i32.i32($i0: i32, p.1: i32)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
  ...
  var $i23: i1;
$bb0:
  assume {:sourceloc "test/c/basic/vararg_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(24, $zext.i32.i64(1)));
  call {:cexpr "panic:arg:x"} boogie_si_record_i32($i0);
  assume true;
  assume {:sourceloc "test/c/basic/vararg_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1, $mul.ref(0, 24)), $mul.ref(0, 24));
  assume {:sourceloc "test/c/basic/vararg_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/basic/vararg_fail.c:9:3: warning: unsoundly ignoring unmodeled operation llvm.va_start; */
  call llvm.va_start($p3);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := printf.ref.i32(.str, $i0);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1, $mul.ref(0, 24)), $mul.ref(0, 24));
  $p6 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 24)), $mul.ref(0, 24)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
...
$bb1:
  assume ($i8 == 1);
  $p9 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 24)), $mul.ref(0, 24)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $p10 := $load.ref($M.1, $p9);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p10, $mul.ref($zext.i32.i64($i7), 1));
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !(($i8 == 1));
  $p15 := $add.ref($add.ref($add.ref($p1, $mul.ref(0, 24)), $mul.ref(0, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p16, $mul.ref(8, 1));
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p15, $p18);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $p14 := $p16;
  goto $bb3;
$bb3:
  ...
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 30} true;
  assume {:verifier.code 0} true;
  $i19 := $load.i32($M.3, $p14);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i20 := printf.ref.i32.i32(.str.1, $i0, $i19);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p1, $mul.ref(0, 24)), $mul.ref(0, 24));
  assume {:sourceloc "test/c/basic/vararg_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $p22 := $bitcast.ref.ref($p21);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/basic/vararg_fail.c:12:3: warning: unsoundly ignoring unmodeled operation llvm.va_end; */
  call llvm.va_end($p22);
  assume {:sourceloc "test/c/basic/vararg_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/basic/vararg_fail.c", 13, 3} true;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/basic/vararg_fail.c", 14, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
procedure {:inline 1} panic.i32($i0: i32)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
...
axiom (llvm.dbg.declare == $sub.ref(0, 5167));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.va_start: ref;
axiom (llvm.va_start == $sub.ref(0, 6199));
procedure {:inline 1} llvm.va_start($p0: ref);
const printf: ref;
axiom (printf == $sub.ref(0, 7231));
procedure {:inline 1} printf.ref.i32.i32($p0: ref, p.1: i32, p.2: i32)
  returns ($r: i32);
procedure {:inline 1} printf.ref.i32($p0: ref, p.1: i32)
  returns ($r: i32);
const llvm.va_end: ref;
axiom (llvm.va_end == $sub.ref(0, 8263));
procedure {:inline 1} llvm.va_end($p0: ref);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 9295));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 10327));
...
axiom (__SMACK_dummy == $sub.ref(0, 11359));
...
axiom (__VERIFIER_assert == $sub.ref(0, 12391));
...
axiom (__SMACK_decls == $sub.ref(0, 22711));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 23743));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 24775));
...
axiom (llvm.dbg.value == $sub.ref(0, 25807));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 26839));
