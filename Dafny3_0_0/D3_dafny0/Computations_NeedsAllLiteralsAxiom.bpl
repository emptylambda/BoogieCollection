...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int, m#0: int :: 
    ...
    NeedsAllLiteralsAxiom.__default.trick#canCall(n#0, m#0)
         || (1 != $FunctionContextHeight && LitInt(0) <= n#0 && LitInt(0) <= m#0)
...
procedure CheckWellformed$$NeedsAllLiteralsAxiom.__default.trick(n#0: int where LitInt(0) <= n#0, m#0: int where LitInt(0) <= m#0);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$NeedsAllLiteralsAxiom.__default.trick(n#0: int, m#0: int)
{
  ...
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function trick
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Computations.dfy(194,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        assume LitInt(0) <= NeedsAllLiteralsAxiom.__default.trick($LS($LZ), n#0, m#0);
        assume false;
    }
    else
    {
        ...
        if (n#0 < m#0 || m#0 == LitInt(0))
        {
            assume NeedsAllLiteralsAxiom.__default.trick($LS($LZ), n#0, m#0) == n#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(NeedsAllLiteralsAxiom.__default.trick($LS($LZ), n#0, m#0), Tclass._System.nat());
        }
        else
        {
            assert $Is(n#0 - m#0, Tclass._System.nat());
            ##n#0 := n#0 - m#0;
            ...
            assert ##n#0 < n#0;
            assume NeedsAllLiteralsAxiom.__default.trick#canCall(n#0 - m#0, m#0);
            assert $Is(NeedsAllLiteralsAxiom.__default.trick($LS($LZ), n#0 - m#0, m#0) + m#0, 
              Tclass._System.nat());
            assume NeedsAllLiteralsAxiom.__default.trick($LS($LZ), n#0, m#0)
               == NeedsAllLiteralsAxiom.__default.trick($LS($LZ), n#0 - m#0, m#0) + m#0;
            assume NeedsAllLiteralsAxiom.__default.trick#canCall(n#0 - m#0, m#0);
            // CheckWellformedWithResult: any expression
            assume $Is(NeedsAllLiteralsAxiom.__default.trick($LS($LZ), n#0, m#0), Tclass._System.nat());
        }
...
procedure {:_induction n#0, m#0} CheckWellformed$$NeedsAllLiteralsAxiom.__default.lemma__trick(n#0: int where LitInt(0) <= n#0, m#0: int where LitInt(0) <= m#0);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure {:_induction n#0, m#0} Call$$NeedsAllLiteralsAxiom.__default.lemma__trick(n#0: int where LitInt(0) <= n#0, m#0: int where LitInt(0) <= m#0);
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures NeedsAllLiteralsAxiom.__default.trick#canCall(n#0, m#0);
  ensures NeedsAllLiteralsAxiom.__default.trick($LS($LS($LZ)), n#0, m#0) == n#0;
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:_induction n#0, m#0} Impl$$NeedsAllLiteralsAxiom.__default.lemma__trick(n#0: int where LitInt(0) <= n#0, m#0: int where LitInt(0) <= m#0)
...
implementation {:_induction n#0, m#0} Impl$$NeedsAllLiteralsAxiom.__default.lemma__trick(n#0: int, m#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;

    // AddMethodImpl: lemma_trick, Impl$$NeedsAllLiteralsAxiom.__default.lemma__trick
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Computations.dfy(202,2): initial state"} true;
    ...
    assume (forall $ih#n0#0: int, $ih#m0#0: int :: 
      LitInt(0) <= $ih#n0#0
         ...
         ==> NeedsAllLiteralsAxiom.__default.trick($LS($LZ), $ih#n0#0, $ih#m0#0) == $ih#n0#0);
    $_reverifyPost := false;
}



procedure CheckWellformed$$NeedsAllLiteralsAxiom.__default.calc__trick(n#0: int where LitInt(0) <= n#0, m#0: int where LitInt(0) <= m#0);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$NeedsAllLiteralsAxiom.__default.calc__trick(n#0: int, m#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##n#0: int;
  var ##m#0: int;

    // AddMethodImpl: calc_trick, CheckWellformed$$NeedsAllLiteralsAxiom.__default.calc__trick
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Computations.dfy(205,8): initial state"} true;
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Computations.dfy(206,27): post-state"} true;
    ...
    // assume allocatedness for argument to function
    assume $IsAlloc(##m#0, Tclass._System.nat(), $Heap);
    assume NeedsAllLiteralsAxiom.__default.trick#canCall(LitInt(100), LitInt(10));
    assume LitInt(NeedsAllLiteralsAxiom.__default.trick($LS($LZ), LitInt(100), LitInt(10)))
       == LitInt(100);
}



procedure Call$$NeedsAllLiteralsAxiom.__default.calc__trick(n#0: int where LitInt(0) <= n#0, m#0: int where LitInt(0) <= m#0);
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures NeedsAllLiteralsAxiom.__default.trick#canCall(LitInt(100), LitInt(10));
  ensures LitInt(NeedsAllLiteralsAxiom.__default.trick($LS($LS($LZ)), LitInt(100), LitInt(10)))
     == LitInt(100);
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure Impl$$NeedsAllLiteralsAxiom.__default.calc__trick(n#0: int where LitInt(0) <= n#0, m#0: int where LitInt(0) <= m#0)
   returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // user-defined postconditions
...
implementation Impl$$NeedsAllLiteralsAxiom.__default.calc__trick(n#0: int, m#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;

    // AddMethodImpl: calc_trick, Impl$$NeedsAllLiteralsAxiom.__default.calc__trick
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Computations.dfy(207,2): initial state"} true;
    $_reverifyPost := false;
}
