...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_cast_fail.c -bpl ./struct_cast_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_cast_fail.c", 18, 12} true;
  ...
  assume {:sourceloc "test/c/data/struct_cast_fail.c", 20, 6} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_cast_fail.c", 20, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 3);
  assume {:sourceloc "test/c/data/struct_cast_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p1, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_cast_fail.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 4);
  assume {:sourceloc "test/c/data/struct_cast_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_cast_fail.c", 23, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/struct_cast_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
