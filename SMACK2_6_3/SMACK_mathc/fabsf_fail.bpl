...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/fabsf_fail.c -bpl ./fabsf_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 12, 15} true;
  ...
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __isnanf($f0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 22} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 26} true;
  assume {:verifier.code 0} true;
  call $i3 := __isinff($f0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 26} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 40} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 44} true;
  assume {:verifier.code 0} true;
  call $i5 := __iszerof($f0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 44} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i7 := (if $fogt.float.bool($f0, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 15, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i7 == 1);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 16, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb10:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 16, 7} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fabsf_fail.c:16:7: warning: over-approximating call to llvm.fabs.f32; */
  call $f8 := llvm.fabs.f32($f0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 16, 7} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb12;
$bb14:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 17, 5} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb16:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fabsf_fail.c:18:7: warning: over-approximating call to llvm.fabs.f32; */
  call $f10 := llvm.fabs.f32($f0);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fabsf_fail.c:22:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f12 := llvm.fabs.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fabsf_fail.c:23:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f14 := llvm.fabs.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb28;
$bb30:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 24, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fabsf_fail.c:24:26: warning: over-approximating call to llvm.fabs.f32; */
  call $f16 := llvm.fabs.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 24, 15} true;
  assume {:verifier.code 0} true;
  call $i17 := __signbitf($f16);
  call {:cexpr "isNeg"} boogie_si_record_i32($i17);
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 25, 3} true;
...
$bb34:
  ...
  goto $bb35;
$bb35:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fabsf_fail.c:27:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f19 := llvm.fabs.f32($fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fabsf_fail.c:28:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f21 := llvm.fabs.f32($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb46;
$bb46:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fabsf_fail.c:30:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f23 := llvm.fabs.f32($fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb48;
$bb50:
  assume {:sourceloc "test/c/mathc/fabsf_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.fabs.f32 == $sub.ref(0, 6192));
