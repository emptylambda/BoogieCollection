...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/pointers4_fail.c -bpl ./pointers4_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 8, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 10, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 256);
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 11, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 11, 15} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2, $mul.ref(1, 1));
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 11, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p3, 1);
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call free_($p6);
  assume {:sourceloc "test/c/bits/pointers4_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
