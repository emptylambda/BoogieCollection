...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/modf_fail.c -bpl ./modf_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/modf_fail.c", 13, 14} true;
  ...
  assume true;
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 8} true;
  assume {:verifier.code 0} true;
  call $i2 := __isnan($f1);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 19} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 27, 11} true;
  assume {:verifier.code 0} true;
  call $f16 := modf($fp(0, 0, 0), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f16);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 23} true;
  assume {:verifier.code 0} true;
  call $i4 := __isinf($f1);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 34} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 38} true;
  assume {:verifier.code 0} true;
  call $i6 := __iszero($f1);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 16, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/modf_fail.c", 17, 13} true;
  assume {:verifier.code 0} true;
  call $f8 := modf($f1, $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f8);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 18, 11} true;
  assume {:verifier.code 0} true;
  $i9 := (if $folt.float.bool($f1, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i9 == 1);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/modf_fail.c", 22, 7} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb10:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 19, 7} true;
  ...
  assume {:sourceloc "test/c/mathc/modf_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
  $i11 := (if $folt.float.bool($f1, $f10) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb12;
$bb14:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  $i12 := (if $folt.float.bool($f1, $f8) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb17;
$bb19:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb21:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 22, 7} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 23, 7} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 23, 7} true;
...
$bb37:
  ...
  goto $bb34;
$bb38:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 30, 11} true;
  assume {:verifier.code 0} true;
  call $f20 := modf($fp(0, 0, 0), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f20);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb39;
$bb39:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 31, 3} true;
...
$bb45:
  ...
  goto $bb42;
$bb46:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 33, 11} true;
  assume {:verifier.code 0} true;
  call $f24 := modf($fp(0, 7, 0), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f24);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb47;
$bb47:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 34, 3} true;
...
$bb53:
  ...
  goto $bb50;
$bb54:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 36, 11} true;
  assume {:verifier.code 0} true;
  call $f28 := modf($fp(0, 0, 48), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f28);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb55;
$bb55:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 37, 3} true;
...
$bb61:
  ...
  goto $bb58;
$bb62:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 39, 11} true;
  assume {:verifier.code 0} true;
  call $f32 := modf($fp(0, 7, 8000000000000), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f32);
  assume {:sourceloc "test/c/mathc/modf_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb63;
$bb63:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 40, 3} true;
...
$bb69:
  ...
  goto $bb66;
$bb70:
  assume {:sourceloc "test/c/mathc/modf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_double == $sub.ref(0, 3096));
...
procedure {:inline 1} __iszero($f0: float)
  returns ($r: i32);
const modf: ref;
axiom (modf == $sub.ref(0, 7224));
procedure {:inline 1} modf($f0: float, $p1: ref)
  returns ($r: float);
