...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/unaligned_struct_fail.c -bpl ./unaligned_struct_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 12, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 12, 15} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(8);
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 13, 13} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 14, 6} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 10);
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 15, 6} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 20);
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 16, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p2, 0);
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 17, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/unaligned_struct_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
