...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/strings_fail.c -bpl ./strings_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/strings_fail.c", 9, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/strings_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
