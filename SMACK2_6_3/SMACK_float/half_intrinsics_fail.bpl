...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/half_intrinsics_fail.c -bpl ./half_intrinsics_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 12, 6} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(2, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 12, 6} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i16($M.0, $p1, 1);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
...
$bb2:
  ...
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $f3 := $load.unsafe.float($M.0, $p2);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $f4 := $fpext.float.float($f3);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $f5 := $fpext.float.float($f4);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := __isnormall($f5);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
...
$bb8:
  ...
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $f9 := $load.unsafe.float($M.0, $p8);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $f10 := $fpext.float.float($f9);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $f11 := $fpext.float.float($f10);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := __isnormal($f11);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
...
$bb9:
  ...
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $f15 := $load.unsafe.float($M.0, $p14);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $f16 := $fpext.float.float($f15);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i17 := __isnormalf($f16);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $ne.i32($i17, 0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 13, 3} true;
...
$bb13:
  ...
  goto $bb7;
$bb14:
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
...
$bb16:
  ...
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $f20 := $load.unsafe.float($M.0, $p19);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $f21 := $fpext.float.float($f20);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $f22 := $fpext.float.float($f21);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i23 := __isnormall($f22);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i23, 0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
...
$bb22:
  ...
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $f26 := $load.unsafe.float($M.0, $p25);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $f27 := $fpext.float.float($f26);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i28 := __isnormal($f27);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i29 := $ne.i32($i28, 0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
...
$bb23:
  ...
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $f31 := $load.unsafe.float($M.0, $p30);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $f32 := $fpext.float.float($f31);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $f33 := $fptrunc.float.float($f32);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i34 := __isnormalf($f33);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i34, 0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 14, 3} true;
...
$bb27:
  ...
  goto $bb21;
$bb28:
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 15, 6} true;
  assume {:verifier.code 0} true;
  $p36 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.unsafe.float($M.0, $p36, $fp(0, 0, 140531350174682));
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb29:
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 16, 3} true;
...
$bb32:
  ...
  goto $bb31;
$bb33:
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $p41 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 17, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.unsafe.float($M.0, $p41, $fp(0, 0, 140531350174682));
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb34;
$bb34:
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 18, 3} true;
...
$bb37:
  ...
  goto $bb36;
$bb38:
  assume {:sourceloc "test/c/float/half_intrinsics_fail.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const __isnormall: ref;
axiom (__isnormall == $sub.ref(0, 3096));
procedure {:inline 1} __isnormall($f0: float)
  returns ($r: i32);
const __isnormal: ref;
axiom (__isnormal == $sub.ref(0, 4128));
procedure {:inline 1} __isnormal($f0: float)
  returns ($r: i32);
const __isnormalf: ref;
axiom (__isnormalf == $sub.ref(0, 5160));
procedure {:inline 1} __isnormalf($f0: float)
  returns ($r: i32);
