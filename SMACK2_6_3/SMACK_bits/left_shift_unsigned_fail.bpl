...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/left_shift_unsigned_fail.c -bpl ./left_shift_unsigned_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/left_shift_unsigned_fail.c", 7, 20} true;
  ...
  assume {:sourceloc "test/c/bits/left_shift_unsigned_fail.c", 8, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/left_shift_unsigned_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/left_shift_unsigned_fail.c", 11, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/left_shift_unsigned_fail.c:11:12: warning: over-approximating bitwise operation shl; */
  $i4 := $shl.i32($i0, $i1);
  assume {:sourceloc "test/c/bits/left_shift_unsigned_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 14448));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 15480));
