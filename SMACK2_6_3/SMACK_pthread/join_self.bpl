...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/join_self.c -bpl ./join_self.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i7: i1;
$bb0:
  assume {:sourceloc "test/c/pthread/join_self.c", 10, 24} true;
  ...
  assume {:sourceloc "test/c/pthread/join_self.c", 11, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, $p2);
  call {:cexpr "self"} boogie_si_record_i32($i3);
  assume true;
  assume {:sourceloc "test/c/pthread/join_self.c", 13, 32} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/join_self.c", 13, 32} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/pthread/join_self.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_join($i3, $p5);
  call {:cexpr "err"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/pthread/join_self.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/join_self.c", 15, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/join_self.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($i2p.i64.ref(1));
  assume {:sourceloc "test/c/pthread/join_self.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/join_self.c", 21, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/pthread/join_self.c", 21, 13} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p0, $i1);
  assume {:sourceloc "test/c/pthread/join_self.c", 23, 32} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/join_self.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p0, $0.ref, t1, $p2);
  assume {:sourceloc "test/c/pthread/join_self.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
