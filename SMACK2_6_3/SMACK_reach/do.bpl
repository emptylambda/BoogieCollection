...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/do.c -bpl ./do.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/do.c", 5, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/reach/do.c", 6, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/reach/do.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $i0 := $eq.i32(2, 1);
  assume {:sourceloc "test/c/reach/do.c", 6, 5} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume !(($i0 == 1));
  assume {:sourceloc "test/c/reach/do.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $r := 2;
  $exn := false;
  return;
