...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/intrinsics_fail.c -bpl ./intrinsics_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 6, 13} true;
  ...
  call {:cexpr "a"} boogie_si_record_float($f0);
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 7, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $i1 := (if $foeq.float.bool($f0, $fp(-1, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 7, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 8, 3} true;
  ...
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/intrinsics_fail.c:8:3: warning: over-approximating call to llvm.fabs.f64; */
  call $f3 := llvm.fabs.f64($f2);
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/intrinsics_fail.c:8:3: warning: over-approximating floating-point arithmetic fneg; */
  $f4 := $fneg.float($f0);
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i6 := (if $folt.float.bool($f3, $f5) then 1 else 0);
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/float/intrinsics_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
