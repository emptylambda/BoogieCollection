...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/llvm_intrinsic.c -bpl ./llvm_intrinsic.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 7, 14} true;
  ...
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 8, 3} true;
...
$bb2:
  ...
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/llvm_intrinsic.c:8:3: warning: over-approximating call to llvm.fabs.f80; */
  call $f2 := llvm.fabs.f80($f1);
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i3 := (if $fone.float.bool($f2, $fp(0, 0, 140735056292816)) then 1 else 0);
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 8, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/llvm_intrinsic.c:8:3: warning: over-approximating call to llvm.fabs.f64; */
...
$bb9:
  ...
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 8, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/llvm_intrinsic.c:8:3: warning: over-approximating call to llvm.fabs.f32; */
...
$bb13:
  ...
  goto $bb7;
$bb14:
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 9, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/llvm_intrinsic.c:9:3: warning: over-approximating floating-point arithmetic fadd; */
  $f9 := $fadd.float($f0, $fp(0, 0, 0));
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i10 := (if $foeq.float.bool($f9, $f0) then 1 else 0);
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 9, 3} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb17;
$bb19:
  assume {:sourceloc "test/c/float/llvm_intrinsic.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
