...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/loop1_fail.c -bpl ./loop1_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/loop1_fail.c", 16, 5} true;
  ...
  assume {:sourceloc "test/c/basic/loop1_fail.c", 18, 8} true;
  assume {:verifier.code 0} true;
  $i0 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/loop1_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/loop1_fail.c", 18, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 10);
  assume {:sourceloc "test/c/basic/loop1_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/basic/loop1_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/basic/loop1_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/basic/loop1_fail.c", 18, 29} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, 1);
...
$bb8:
  ...
  goto $bb7;
$bb9:
  assume {:sourceloc "test/c/basic/loop1_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
