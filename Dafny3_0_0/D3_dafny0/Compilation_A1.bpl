...
procedure CheckWellformed$$A1.__default.run();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$A1.__default.run();
  modifies $Heap, $Tick;
...
procedure Impl$$A1.__default.run() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$A1.__default.run() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var x#0: ref
     where $Is(x#0, Tclass.A1.X.B.Abs.C()) && $IsAlloc(x#0, Tclass.A1.X.B.Abs.C(), $Heap);
  var $nw: ref;

    // AddMethodImpl: run, Impl$$A1.__default.run
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(143,16): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(144,10)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$A1.X.Abs.__default.do();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(144,11)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(145,12)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(145,15)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$A1.X.B.Abs.C.__ctor();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(145,25)"} true;
    x#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(145,25)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(146,9)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert x#0 != null;
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$A1.X.B.Abs.C.m(x#0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Compilation.dfy(146,10)"} true;
}
...
procedure CheckWellformed$$A1.X.B.Abs.C.__ctor(this: ref
       where this != null
         && 
        $Is(this, Tclass.A1.X.B.Abs.C())
         && $IsAlloc(this, Tclass.A1.X.B.Abs.C(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$A1.X.B.Abs.C.__ctor()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass.A1.X.B.Abs.C())
...
procedure CheckWellformed$$A1.X.B.Abs.C.m(this: ref
       where this != null
         && 
        $Is(this, Tclass.A1.X.B.Abs.C())
         && $IsAlloc(this, Tclass.A1.X.B.Abs.C(), $Heap));
...
procedure Call$$A1.X.B.Abs.C.m(this: ref
       where this != null
         && 
        $Is(this, Tclass.A1.X.B.Abs.C())
         && $IsAlloc(this, Tclass.A1.X.B.Abs.C(), $Heap));
...
procedure CheckWellformed$$A1.X.Abs.__default.do();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$A1.X.Abs.__default.do();
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
