// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue28.dfy -print:./git-issue28.bpl
...
implementation Impl$$_module.__default.mylemma() returns ($_reverifyPost: bool)
{
  ...
  var newtype$check#1: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue28.dfy(5,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue28.dfy(6,19)
    assume true;
    assume true;
    shift#0 := LitInt(1);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue28.dfy(6,22)"} true;
    // ----- assume statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue28.dfy(7,5)
    newtype$check#0 := LitInt(1);
    assert 0 <= newtype$check#0 && newtype$check#0 < 4294967296;
    assert {:subsumption 0} 0 <= shift#0;
    assert {:subsumption 0} shift#0 <= 32;
    assume true;
    assume nat_from_bv32(LeftShift_bv32(1bv32, nat_to_bv32(shift#0))) == LitInt(2);
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue28.dfy(8,5)
    newtype$check#1 := LitInt(1);
    assert 0 <= newtype$check#1 && newtype$check#1 < 4294967296;
    assert {:subsumption 0} 0 <= LitInt(1);
    assert {:subsumption 0} LitInt(1) <= 32;
    assume true;
    assert nat_from_bv32(LeftShift_bv32(1bv32, 1bv32)) == LitInt(2);
}
