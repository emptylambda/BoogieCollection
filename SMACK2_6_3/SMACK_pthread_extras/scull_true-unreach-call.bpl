...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/scull_true-unreach-call.c -bpl ./scull_true-unreach-call.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 34068));
...
axiom (llvm.dbg.declare == $sub.ref(0, 3108));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const loader: ref;
axiom (loader == $sub.ref(0, 4140));
procedure {:inline 1} loader($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 420, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 420, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := scull_init_module();
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 421, 3} true;
  assume {:verifier.code 0} true;
  call scull_cleanup_module();
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 422, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (scull_init_module == $sub.ref(0, 5172));
procedure {:inline 1} scull_init_module()
  returns ($r: i32);
const scull_cleanup_module: ref;
axiom (scull_cleanup_module == $sub.ref(0, 6204));
procedure {:inline 1} scull_cleanup_module();
const thread1: ref;
axiom (thread1 == $sub.ref(0, 7236));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 429, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 429, 20} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 429, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := scull_open(1, $i1, $u1);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 430, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := scull_read(1, $u1, $u1, 10, 0);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 432, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (scull_open == $sub.ref(0, 8268));
procedure {:inline 1} scull_open($i0: i32, $i1: i32, $i2: i32)
  returns ($r: i32);
const scull_read: ref;
axiom (scull_read == $sub.ref(0, 9300));
procedure {:inline 1} scull_read($i0: i32, $i1: i32, $i2: i32, $i3: i32, $i4: i32)
  returns ($r: i32);
const thread2: ref;
axiom (thread2 == $sub.ref(0, 10332));
  ...
  returns ($r: ref)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 439, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 439, 20} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 439, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := scull_open(2, $i1, $u1);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 440, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := scull_write(2, $u1, $u1, 10, 0);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 442, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (scull_write == $sub.ref(0, 11364));
procedure {:inline 1} scull_write($i0: i32, $i1: i32, $i2: i32, $i3: i32, $i4: i32)
  returns ($r: i32);
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 446, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 447, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, loader, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 448, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread1, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 449, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p2, $0.ref, thread2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 450, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 450, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_join($i7, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 451, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.2, $p1);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 451, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_join($i9, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 452, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.3, $p2);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 452, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := pthread_join($i11, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 453, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_mutex_destroy(lock);
  assume {:sourceloc "test/c/pthread_extras/scull_true-unreach-call.c", 454, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_and32 == $sub.ref(0, 20652));
...
axiom (__SMACK_and64 == $sub.ref(0, 21684));
...
axiom (__SMACK_and16 == $sub.ref(0, 22716));
...
axiom (__SMACK_and8 == $sub.ref(0, 23748));
...
axiom (__SMACK_or32 == $sub.ref(0, 24780));
...
axiom (__SMACK_or64 == $sub.ref(0, 25812));
...
axiom (__SMACK_or16 == $sub.ref(0, 26844));
...
axiom (__SMACK_or8 == $sub.ref(0, 27876));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 28908));
...
axiom (__SMACK_decls == $sub.ref(0, 29940));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 30972));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 32004));
...
axiom (llvm.dbg.value == $sub.ref(0, 33036));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 34068));
