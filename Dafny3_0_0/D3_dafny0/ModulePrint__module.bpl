// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy -print:./ModulePrint.bpl
...
implementation Impl$$_module.__default._default_Main() returns ($_reverifyPost: bool)
{
  ...
  var c#0: ref where $Is(c#0, Tclass.T.C()) && $IsAlloc(c#0, Tclass.T.C(), $Heap);
  var $nw: ref;

    // AddMethodImpl: Main, Impl$$_module.__default._default_Main
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(32,14): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(33,9)
    assume true;
    // ----- init call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(33,12)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $nw := Call$$T.C.__ctor();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(33,20)"} true;
    c#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(33,20)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(34,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert c#0 != null;
    ...
    call Call$$T.C.m(c#0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/ModulePrint.dfy(34,7)"} true;
}
...
const S.C.g: Field int;

// C.g: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, S.C.g) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.S.C?()
     ==> $Is(read($h, $o, S.C.g), TInt));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass.S.C?()
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, S.C.g), TInt, $h));

axiom FDim(S.C.h) == 0
   && FieldOfDecl(class.S.C?, field$h) == S.C.h
   && !$IsGhostField(S.C.h);

const S.C.h: Field int;

// C.h: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, S.C.h) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.S.C?()
     ==> $Is(read($h, $o, S.C.h), TInt));
...
const T.C.h: Field int;

// C.h: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, T.C.h) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.T.C?()
     ==> $Is(read($h, $o, T.C.h), TInt));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass.T.C?()
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, T.C.h), TInt, $h));

axiom FDim(T.C.j) == 0
   && FieldOfDecl(class.T.C?, field$j) == T.C.j
   && $IsGhostField(T.C.j);

const T.C.j: Field int;

// C.j: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, T.C.j) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.T.C?()
     ==> $Is(read($h, $o, T.C.j), TInt));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass.T.C?()
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, T.C.j), TInt, $h));

axiom FDim(T.C.k) == 0
   && FieldOfDecl(class.T.C?, field$k) == T.C.k
   && !$IsGhostField(T.C.k);

const T.C.k: Field int;

// C.k: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, T.C.k) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.T.C?()
     ==> $Is(read($h, $o, T.C.k), TInt));
...
procedure Call$$T.C.m(this: ref
  ...
  free ensures true;
  ensures read($Heap, this, T.C.h) == read($Heap, this, T.C.h);
  free ensures true;
  ensures read($Heap, this, T.C.j) == read($Heap, this, T.C.j);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && read(old($Heap), $o, alloc)
...
const T.C.g: Field int;

// C.g: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, T.C.g) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.T.C?()
     ==> $Is(read($h, $o, T.C.g), TInt));
