...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c -bpl ./floppy_simpl4_true.cil.bpl
...
procedure {:inline 1} _BLAST_init()
{
  var $i0: i32;
$bb0:
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 75, 14} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 75, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := 0;
  call {:cexpr "UNLOADED"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 76, 8} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "NP"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 77, 8} true;
  assume {:verifier.code 0} true;
  $M.2 := 2;
  call {:cexpr "DC"} boogie_si_record_i32(2);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 78, 11} true;
  assume {:verifier.code 0} true;
  $M.3 := 3;
  call {:cexpr "SKIP1"} boogie_si_record_i32(3);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 79, 11} true;
  assume {:verifier.code 0} true;
  $M.4 := 4;
  call {:cexpr "SKIP2"} boogie_si_record_i32(4);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 80, 10} true;
  assume {:verifier.code 0} true;
  $M.5 := 5;
  call {:cexpr "MPR1"} boogie_si_record_i32(5);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 81, 10} true;
  assume {:verifier.code 0} true;
  $M.6 := 6;
  call {:cexpr "MPR3"} boogie_si_record_i32(6);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 82, 9} true;
  assume {:verifier.code 0} true;
  $M.7 := 7;
  call {:cexpr "IPC"} boogie_si_record_i32(7);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 83, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $M.0;
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 83, 7} true;
  assume {:verifier.code 0} true;
  $M.8 := $i0;
  call {:cexpr "s"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 84, 12} true;
  assume {:verifier.code 0} true;
  $M.9 := 0;
  call {:cexpr "pended"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 85, 20} true;
  assume {:verifier.code 0} true;
  $M.10 := 0;
  call {:cexpr "compRegistered"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 86, 23} true;
  assume {:verifier.code 0} true;
  $M.11 := 0;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 87, 20} true;
  assume {:verifier.code 0} true;
  $M.12 := 0;
  call {:cexpr "setEventCalled"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 88, 15} true;
  assume {:verifier.code 0} true;
  $M.13 := 0;
  call {:cexpr "customIrp"} boogie_si_record_i32(0);
  assume {:sourceloc "test/c/ntdrivers-simplified/floppy_simpl4_true.cil.c", 89, 5} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
