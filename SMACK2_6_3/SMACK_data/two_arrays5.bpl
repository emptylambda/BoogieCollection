...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/two_arrays5.c -bpl ./two_arrays5.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 26828));
...
procedure {:inline 1} resetArray($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays5.c", 21, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/two_arrays5.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays5.c", 21, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays5.c", 21, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i1, $i2);
  assume {:sourceloc "test/c/data/two_arrays5.c", 21, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/two_arrays5.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays5.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0, $mul.ref($i4, 12));
  assume {:sourceloc "test/c/data/two_arrays5.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref($i4, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays5.c", 22, 21} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p6, 0);
  assume {:sourceloc "test/c/data/two_arrays5.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/two_arrays5.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays5.c", 21, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
...
procedure {:inline 1} setArray($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays5.c", 29, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays5.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/data/two_arrays5.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays5.c", 29, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays5.c", 29, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i1, $i2);
  assume {:sourceloc "test/c/data/two_arrays5.c", 29, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/two_arrays5.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays5.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0, $mul.ref($i4, 12));
  assume {:sourceloc "test/c/data/two_arrays5.c", 30, 14} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref($i4, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays5.c", 30, 21} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p6, 1);
  assume {:sourceloc "test/c/data/two_arrays5.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/two_arrays5.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays5.c", 29, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/data/two_arrays5.c", 29, 3} true;
...
procedure {:inline 1} initializeCount($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays5.c", 37, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays5.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/data/two_arrays5.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays5.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays5.c", 37, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i1, $i2);
  assume {:sourceloc "test/c/data/two_arrays5.c", 37, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/two_arrays5.c", 38, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays5.c", 38, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0, $mul.ref($i4, 12));
  assume {:sourceloc "test/c/data/two_arrays5.c", 38, 14} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref($i4, 12)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/two_arrays5.c", 38, 20} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p6, 0);
  assume {:sourceloc "test/c/data/two_arrays5.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/two_arrays5.c", 40, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays5.c", 37, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/data/two_arrays5.c", 37, 3} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/two_arrays5.c", 43, 15} true;
  ...
  assume {:sourceloc "test/c/data/two_arrays5.c", 43, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $i0;
  call {:cexpr "arraySize"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/data/two_arrays5.c", 44, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/two_arrays5.c", 44, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/two_arrays5.c", 46, 35} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays5.c", 46, 35} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "test/c/data/two_arrays5.c", 46, 45} true;
  assume {:verifier.code 0} true;
  $i5 := $mul.i64($i4, 12);
  assume {:sourceloc "test/c/data/two_arrays5.c", 46, 28} true;
  assume {:verifier.code 0} true;
  call $p6 := malloc($i5);
  assume {:sourceloc "test/c/data/two_arrays5.c", 46, 20} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p6);
  assume {:sourceloc "test/c/data/two_arrays5.c", 47, 35} true;
  assume {:verifier.code 0} true;
  $i8 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays5.c", 47, 35} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i8);
  assume {:sourceloc "test/c/data/two_arrays5.c", 47, 45} true;
  assume {:verifier.code 0} true;
  $i10 := $mul.i64($i9, 12);
  assume {:sourceloc "test/c/data/two_arrays5.c", 47, 28} true;
  assume {:verifier.code 0} true;
  call $p11 := malloc($i10);
  assume {:sourceloc "test/c/data/two_arrays5.c", 47, 20} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p11);
  assume {:sourceloc "test/c/data/two_arrays5.c", 49, 3} true;
  assume {:verifier.code 0} true;
  call resetArray($p7);
  assume {:sourceloc "test/c/data/two_arrays5.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call setArray($p12);
  assume {:sourceloc "test/c/data/two_arrays5.c", 51, 3} true;
  assume {:verifier.code 0} true;
  call initializeCount($p12);
  assume {:sourceloc "test/c/data/two_arrays5.c", 53, 3} true;
  assume {:verifier.code 0} true;
  call initializeCount($p7);
  assume {:sourceloc "test/c/data/two_arrays5.c", 54, 3} true;
  assume {:verifier.code 0} true;
  call setArray($p7);
  assume {:sourceloc "test/c/data/two_arrays5.c", 55, 3} true;
  assume {:verifier.code 0} true;
  call resetArray($p12);
  assume {:sourceloc "test/c/data/two_arrays5.c", 57, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p7);
  assume {:sourceloc "test/c/data/two_arrays5.c", 57, 3} true;
  assume {:verifier.code 0} true;
  call free_($p13);
  assume {:sourceloc "test/c/data/two_arrays5.c", 58, 8} true;
  assume {:verifier.code 0} true;
  $p14 := $bitcast.ref.ref($p12);
  assume {:sourceloc "test/c/data/two_arrays5.c", 58, 3} true;
  assume {:verifier.code 0} true;
  call free_($p14);
  assume {:sourceloc "test/c/data/two_arrays5.c", 59, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_and32 == $sub.ref(0, 11348));
...
axiom (__SMACK_and64 == $sub.ref(0, 12380));
...
axiom (__SMACK_and16 == $sub.ref(0, 13412));
...
axiom (__SMACK_and8 == $sub.ref(0, 14444));
...
axiom (__SMACK_or32 == $sub.ref(0, 15476));
...
axiom (__SMACK_or64 == $sub.ref(0, 16508));
...
axiom (__SMACK_or16 == $sub.ref(0, 17540));
...
axiom (__SMACK_or8 == $sub.ref(0, 18572));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19604));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 20636));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 21668));
procedure {:inline 1} __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 22700));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 23732));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 24764));
...
axiom (llvm.dbg.value == $sub.ref(0, 25796));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 26828));
