...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/stateful01_false-unreach-call.c -bpl ./stateful01_false-unreach-call.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 32016));
...
const ma: ref;
axiom (ma == $sub.ref(0, 1048));
const data1: ref;
axiom (data1 == $sub.ref(0, 2076));
const data2: ref;
axiom (data2 == $sub.ref(0, 3104));
const mb: ref;
axiom (mb == $sub.ref(0, 4152));
const thread1: ref;
axiom (thread1 == $sub.ref(0, 5184));
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 10, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 11, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_lock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 15, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 21, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 21, 9} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $i3;
  call {:cexpr "data1"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_lock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 25, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $M.1;
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 25, 9} true;
  assume {:verifier.code 0} true;
  ...
  $M.1 := $i7;
  call {:cexpr "data2"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i8 := pthread_mutex_unlock(ma);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 27, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 32, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 33, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_init(mb, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := 10;
  call {:cexpr "data1"} boogie_si_record_i32(10);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := 10;
  call {:cexpr "data2"} boogie_si_record_i32(10);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_create($p0, $0.ref, thread1, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 39, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_create($p1, $0.ref, thread2, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 41, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.2, $p0);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_join($i6, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 42, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.3, $p1);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 44, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 44, 3} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "test/c/pthread_extras/stateful01_false-unreach-call.c", 45, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 16536));
...
axiom (__VERIFIER_assert == $sub.ref(0, 17568));
...
axiom (__SMACK_and32 == $sub.ref(0, 18600));
...
axiom (__SMACK_and64 == $sub.ref(0, 19632));
...
axiom (__SMACK_and16 == $sub.ref(0, 20664));
...
axiom (__SMACK_and8 == $sub.ref(0, 21696));
...
axiom (__SMACK_or32 == $sub.ref(0, 22728));
...
axiom (__SMACK_or64 == $sub.ref(0, 23760));
...
axiom (__SMACK_or16 == $sub.ref(0, 24792));
...
axiom (__SMACK_or8 == $sub.ref(0, 25824));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 26856));
...
axiom (__SMACK_decls == $sub.ref(0, 27888));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 28920));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 29952));
...
axiom (llvm.dbg.value == $sub.ref(0, 30984));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 32016));
