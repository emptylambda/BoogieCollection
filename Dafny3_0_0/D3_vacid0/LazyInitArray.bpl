// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy -print:./LazyInitArray.bpl
...
implementation CheckWellformed$$_module.LazyInitArray.Valid(_module.LazyInitArray$T: Ty, this: ref)
{
  ...
  var b$reqreads#63: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(13,12): initial state"} true;
    ...
    else
    {
        ...
        b$reqreads#4 := $_Frame[this, _module.LazyInitArray.Contents];
        if (_System.array.Length(read($Heap, this, _module.LazyInitArray.a))
           == Seq#Length(read($Heap, this, _module.LazyInitArray.Contents)))
        {
            b$reqreads#5 := $_Frame[this, _module.LazyInitArray.b];
            assert read($Heap, this, _module.LazyInitArray.b) != null;
            b$reqreads#6 := $_Frame[this, _module.LazyInitArray.Contents];
        }
        ...
        if (_System.array.Length(read($Heap, this, _module.LazyInitArray.a))
           ...
           && _System.array.Length(read($Heap, this, _module.LazyInitArray.b))
             == Seq#Length(read($Heap, this, _module.LazyInitArray.Contents)))
        {
            b$reqreads#7 := $_Frame[this, _module.LazyInitArray.c];
            assert read($Heap, this, _module.LazyInitArray.c) != null;
            b$reqreads#8 := $_Frame[this, _module.LazyInitArray.Contents];
        }
        ...
        if (_System.array.Length(read($Heap, this, _module.LazyInitArray.a))
           ...
           && _System.array.Length(read($Heap, this, _module.LazyInitArray.c))
             == Seq#Length(read($Heap, this, _module.LazyInitArray.Contents)))
        {
            b$reqreads#9 := $_Frame[this, _module.LazyInitArray.b];
        ...
        if (_System.array.Length(read($Heap, this, _module.LazyInitArray.a))
           ...
           && read($Heap, this, _module.LazyInitArray.b)
             != read($Heap, this, _module.LazyInitArray.c))
        {
            b$reqreads#11 := $_Frame[this, _module.LazyInitArray.a];
        ...
        if (_System.array.Length(read($Heap, this, _module.LazyInitArray.a))
           ...
           && read($Heap, this, _module.LazyInitArray.a)
             != read($Heap, this, _module.LazyInitArray.b))
        {
            b$reqreads#13 := $_Frame[this, _module.LazyInitArray.a];
            b$reqreads#14 := $_Frame[this, _module.LazyInitArray.c];
        }
        ...
        if (_System.array.Length(read($Heap, this, _module.LazyInitArray.a))
           ...
           && read($Heap, this, _module.LazyInitArray.a)
             != read($Heap, this, _module.LazyInitArray.c))
        {
            b$reqreads#15 := $_Frame[this, _module.LazyInitArray.n];
        }
        ...
        if (_System.array.Length(read($Heap, this, _module.LazyInitArray.a))
           ...
           && LitInt(0) <= read($Heap, this, _module.LazyInitArray.n))
        {
            b$reqreads#16 := $_Frame[this, _module.LazyInitArray.n];
             ...
             <= _System.array.Length(read($Heap, this, _module.LazyInitArray.c)))
        {
            ...
            if (true)
            {
                if (LitInt(0) <= i#6)
                {
                    b$reqreads#18 := $_Frame[this, _module.LazyInitArray.Contents];
                }

                if (LitInt(0) <= i#6
                   && i#6 < Seq#Length(read($Heap, this, _module.LazyInitArray.Contents)))
                {
                    b$reqreads#19 := $_Frame[this, _module.LazyInitArray.Contents];
                    assert 0 <= i#6 && i#6 < Seq#Length(read($Heap, this, _module.LazyInitArray.Contents));
                    b$reqreads#20 := $_Frame[this, _module.LazyInitArray.b];
                    assert read($Heap, this, _module.LazyInitArray.b) != null;
                    assert 0 <= i#6
                       && i#6 < _System.array.Length(read($Heap, this, _module.LazyInitArray.b));
                    b$reqreads#21 := $_Frame[read($Heap, this, _module.LazyInitArray.b), IndexField(i#6)];
                    if (LitInt(0)
                       <= $Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#6))): int)
                    {
                        b$reqreads#22 := $_Frame[this, _module.LazyInitArray.b];
                        assert read($Heap, this, _module.LazyInitArray.b) != null;
                        assert 0 <= i#6
                           && i#6 < _System.array.Length(read($Heap, this, _module.LazyInitArray.b));
                        b$reqreads#23 := $_Frame[read($Heap, this, _module.LazyInitArray.b), IndexField(i#6)];
                        b$reqreads#24 := $_Frame[this, _module.LazyInitArray.n];
                    }
                    ...
                    if (LitInt(0)
                       ...
                       && $Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#6))): int
                         < read($Heap, this, _module.LazyInitArray.n))
                    {
                        b$reqreads#25 := $_Frame[this, _module.LazyInitArray.c];
                        assert read($Heap, this, _module.LazyInitArray.c) != null;
                        b$reqreads#26 := $_Frame[this, _module.LazyInitArray.b];
                        assert read($Heap, this, _module.LazyInitArray.b) != null;
                        assert 0 <= i#6
                           && i#6 < _System.array.Length(read($Heap, this, _module.LazyInitArray.b));
                        b$reqreads#27 := $_Frame[read($Heap, this, _module.LazyInitArray.b), IndexField(i#6)];
                        assert 0
                             <= $Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#6))): int
                           && $Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#6))): int
                             < _System.array.Length(read($Heap, this, _module.LazyInitArray.c));
                        b$reqreads#28 := $_Frame[read($Heap, this, _module.LazyInitArray.c), IndexField($Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#6))): int)];
                    }
                    ...
                    if (LitInt(0)
                       ...
                       && $Unbox(read($Heap, 
                         ...
                         == i#6)
                    {
                        b$reqreads#29 := $_Frame[this, _module.LazyInitArray.a];
                        assert read($Heap, this, _module.LazyInitArray.a) != null;
                        assert 0 <= i#6
                           && i#6 < _System.array.Length(read($Heap, this, _module.LazyInitArray.a));
                        b$reqreads#30 := $_Frame[read($Heap, this, _module.LazyInitArray.a), IndexField(i#6)];
                    }
                    else
                    {
                        b$reqreads#31 := $_Frame[this, _module.LazyInitArray.Zero];
                    }
                }
            }
                   ...
                   else read($Heap, this, _module.LazyInitArray.Zero))))
        {
            ...
            if (true)
            {
                if (LitInt(0) <= i#7)
                {
                    b$reqreads#32 := $_Frame[this, _module.LazyInitArray.Contents];
                }
                   ...
                   && i#7 < Seq#Length(read($Heap, this, _module.LazyInitArray.Contents)))
                {
                    ...
                    if (true)
                    {
                        if (LitInt(0) <= j#1)
                        {
                            b$reqreads#33 := $_Frame[this, _module.LazyInitArray.n];
                        }

                        if (LitInt(0) <= j#1 && j#1 < read($Heap, this, _module.LazyInitArray.n))
                        {
                            b$reqreads#34 := $_Frame[this, _module.LazyInitArray.c];
                            assert read($Heap, this, _module.LazyInitArray.c) != null;
                            assert 0 <= j#1
                               && j#1 < _System.array.Length(read($Heap, this, _module.LazyInitArray.c));
                            b$reqreads#35 := $_Frame[read($Heap, this, _module.LazyInitArray.c), IndexField(j#1)];
                        }
                    }

                    // End Comprehension WF check
                    b$reqreads#36 := $_Frame[this, _module.LazyInitArray.b];
                    assert read($Heap, this, _module.LazyInitArray.b) != null;
                    assert 0 <= i#7
                       && i#7 < _System.array.Length(read($Heap, this, _module.LazyInitArray.b));
                    b$reqreads#37 := $_Frame[read($Heap, this, _module.LazyInitArray.b), IndexField(i#7)];
                    if (LitInt(0)
                       <= $Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#7))): int)
                    {
                        b$reqreads#38 := $_Frame[this, _module.LazyInitArray.b];
                        assert read($Heap, this, _module.LazyInitArray.b) != null;
                        assert 0 <= i#7
                           && i#7 < _System.array.Length(read($Heap, this, _module.LazyInitArray.b));
                        b$reqreads#39 := $_Frame[read($Heap, this, _module.LazyInitArray.b), IndexField(i#7)];
                        b$reqreads#40 := $_Frame[this, _module.LazyInitArray.n];
                    }
                    ...
                    if (LitInt(0)
                       ...
                       && $Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#7))): int
                         < read($Heap, this, _module.LazyInitArray.n))
                    {
                        b$reqreads#41 := $_Frame[this, _module.LazyInitArray.c];
                        assert read($Heap, this, _module.LazyInitArray.c) != null;
                        b$reqreads#42 := $_Frame[this, _module.LazyInitArray.b];
                        assert read($Heap, this, _module.LazyInitArray.b) != null;
                        assert 0 <= i#7
                           && i#7 < _System.array.Length(read($Heap, this, _module.LazyInitArray.b));
                        b$reqreads#43 := $_Frame[read($Heap, this, _module.LazyInitArray.b), IndexField(i#7)];
                        assert 0
                             <= $Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#7))): int
                           && $Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#7))): int
                             < _System.array.Length(read($Heap, this, _module.LazyInitArray.c));
                        b$reqreads#44 := $_Frame[read($Heap, this, _module.LazyInitArray.c), IndexField($Unbox(read($Heap, read($Heap, this, _module.LazyInitArray.b), IndexField(i#7))): int)];
                    }
                }
            }
               ...
               ==> ((exists j#2: int :: 
                 ...
                 <==> LitInt(0)
                   ...
                   && $Unbox(read($Heap, 
                     ...
                     == i#9)))
        {
            b$reqreads#45 := $_Frame[this, _module.LazyInitArray.d];
            b$reqreads#46 := $_Frame[this, _module.LazyInitArray.Contents];
        }
        ...
        if (_System.array.Length(read($Heap, this, _module.LazyInitArray.a))
           ...
           && Seq#Length(read($Heap, this, _module.LazyInitArray.d))
             == Seq#Length(read($Heap, this, _module.LazyInitArray.Contents)))
        {
            b$reqreads#47 := $_Frame[this, _module.LazyInitArray.e];
            b$reqreads#48 := $_Frame[this, _module.LazyInitArray.Contents];
        }
             ...
             == Seq#Length(read($Heap, this, _module.LazyInitArray.Contents)))
        {
            ...
            if (true)
            {
                if (LitInt(0) <= i#10)
                {
                    b$reqreads#49 := $_Frame[this, _module.LazyInitArray.n];
                }

                if (LitInt(0) <= i#10 && i#10 < read($Heap, this, _module.LazyInitArray.n))
                {
                    b$reqreads#50 := $_Frame[this, _module.LazyInitArray.c];
                    assert read($Heap, this, _module.LazyInitArray.c) != null;
                    assert 0 <= i#10
                       && i#10 < _System.array.Length(read($Heap, this, _module.LazyInitArray.c));
                    b$reqreads#51 := $_Frame[read($Heap, this, _module.LazyInitArray.c), IndexField(i#10)];
                    b$reqreads#52 := $_Frame[this, _module.LazyInitArray.d];
                 ...
                 == $Unbox(Seq#Index(read($Heap, this, _module.LazyInitArray.d), i#12)): int))
        {
            ...
            if (true)
            {
                if (LitInt(0) <= i#11)
                {
                    b$reqreads#53 := $_Frame[this, _module.LazyInitArray.d];
                }

                if (LitInt(0) <= i#11
                   && i#11 < Seq#Length(read($Heap, this, _module.LazyInitArray.d)))
                {
                    b$reqreads#54 := $_Frame[this, _module.LazyInitArray.d];
                     ...
                     < Seq#Length(read($Heap, this, _module.LazyInitArray.d)))))
        {
            ...
            if (true)
            {
                if (LitInt(0) <= i#13)
                {
                    b$reqreads#57 := $_Frame[this, _module.LazyInitArray.e];
                }

                if (LitInt(0) <= i#13
                   && i#13 < Seq#Length(read($Heap, this, _module.LazyInitArray.e)))
                {
                    b$reqreads#58 := $_Frame[this, _module.LazyInitArray.e];
                    ...
                    {
                        b$reqreads#59 := $_Frame[this, _module.LazyInitArray.e];
                        assert 0 <= i#13 && i#13 < Seq#Length(read($Heap, this, _module.LazyInitArray.e));
                     ...
                     < Seq#Length(read($Heap, this, _module.LazyInitArray.e)))))
        {
            ...
            if (true)
            {
                ...
                {
                    b$reqreads#62 := $_Frame[this, _module.LazyInitArray.d];
   ...
   returns ($_reverifyPost: bool)
{
  ...
  var $rhs#7: Seq Box where $Is($rhs#7, TSeq(_module.LazyInitArray$T));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> $o == this
           ...
           || $o == read($Heap, this, _module.LazyInitArray.b)
           || $o == read($Heap, this, _module.LazyInitArray.c));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(45,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(46,7)
    assume true;
    assert $_Frame[this, _module.LazyInitArray.a];
    assert 0 <= N#0;
    havoc $nw;
    assume $nw != null && dtype($nw) == Tclass._System.array?(_module.LazyInitArray$T);
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(46,17)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(47,7)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(47,19)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(48,7)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(48,19)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(49,7)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(49,10)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(53,17)
    assume true;
    assume true;
    s#0 := Lit(Seq#Empty(): Seq Box);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(53,21)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(54,18)
    assume true;
    assume true;
    id#0 := Lit(Seq#Empty(): Seq Box);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(54,22)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(55,17)
    assume true;
    assume true;
    k#0 := LitInt(0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(55,20)"} true;
    // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(56,5)
    ...
    {
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(56,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            assume true;
            assume k#0 <= N#0;
        ...
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(61,9)
        assume true;
        assume true;
        s#0 := Seq#Append(s#0, Seq#Build(Seq#Empty(): Seq Box, zero#0));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(61,21)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(62,10)
        assume true;
        assume true;
        id#0 := Seq#Append(id#0, Seq#Build(Seq#Empty(): Seq Box, $Box(k#0)));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(62,20)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(63,9)
        assume true;
        assume true;
        k#0 := k#0 + 1;
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(63,16)"} true;
        // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(56,5)
    ...
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(66,7)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(66,11)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(67,7)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(67,11)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(68,10)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(68,16)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(69,14)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(69,17)"} true;
}
...
implementation CheckWellformed$$_module.LazyInitArray.Get(_module.LazyInitArray$T: Ty, this: ref, i#0: int) returns (x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(72,9): initial state"} true;
    ...
    havoc x#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(75,14): post-state"} true;
   ...
   returns (x#0: Box, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(76,2): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(77,5)
    assert read($Heap, this, _module.LazyInitArray.b) != null;
    assert 0 <= i#0
    ...
    if (LitInt(0)
       ...
       && $Unbox(read($Heap, 
         ...
         == i#0)
    {
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(78,9)
        assume true;
        assert read($Heap, this, _module.LazyInitArray.a) != null;
        assert 0 <= i#0
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(78,15)"} true;
    }
    else
    {
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(80,9)
        assume true;
        assume true;
        x#0 := read($Heap, this, _module.LazyInitArray.Zero);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(80,15)"} true;
    }
}
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> $o == this
           ...
           || $o == read($Heap, this, _module.LazyInitArray.b)
           || $o == read($Heap, this, _module.LazyInitArray.c));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(84,9): initial state"} true;
    assume _module.LazyInitArray.Valid#canCall(_module.LazyInitArray$T, $Heap, this);
    assume _module.LazyInitArray.Valid(_module.LazyInitArray$T, $Heap, this);
    assume LitInt(0) <= i#0;
    assume i#0 < Seq#Length(read($Heap, this, _module.LazyInitArray.Contents));
      ...
      $o != null && read(old($Heap), $o, alloc)
         ==> $Heap[$o] == old($Heap)[$o]
          ...
          $o == this
           ...
           || $o == read(old($Heap), this, _module.LazyInitArray.c));
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(88,17): post-state"} true;
    assume _module.LazyInitArray.Valid#canCall(_module.LazyInitArray$T, $Heap, this);
    assume _module.LazyInitArray.Valid(_module.LazyInitArray$T, $Heap, this);
   ...
   returns ($_reverifyPost: bool)
{
  ...
  var $rhs#6: Seq Box where $Is($rhs#6, TSeq(_module.LazyInitArray$T));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc)
         ==> $o == this
           ...
           || $o == read($Heap, this, _module.LazyInitArray.b)
           || $o == read($Heap, this, _module.LazyInitArray.c));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(91,2): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(92,5)
    assert read($Heap, this, _module.LazyInitArray.b) != null;
    assert 0 <= i#0
       && i#0 < _System.array.Length(read($Heap, this, _module.LazyInitArray.b));
    if (LitInt(0)
    ...
    {
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(94,7)
        ...
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(95,12)
        assert read($Heap, this, _module.LazyInitArray.b) != null;
        assert 0 <= i#0
           && i#0 < _System.array.Length(read($Heap, this, _module.LazyInitArray.b));
        assume true;
        ...
        assume $IsGoodHeap($Heap);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(95,15)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(96,12)
        assert read($Heap, this, _module.LazyInitArray.c) != null;
        ...
        $Heap := update($Heap, 
          ...
          $Box($rhs#1));
        assume $IsGoodHeap($Heap);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(96,15)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(97,19)
        assume true;
        assert 0 <= read($Heap, this, _module.LazyInitArray.n)
           && read($Heap, this, _module.LazyInitArray.n)
             < Seq#Length(read($Heap, this, _module.LazyInitArray.d));
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(97,25)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(98,19)
        assume true;
        ...
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(98,25)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(99,9)
        assume true;
        assert $_Frame[this, _module.LazyInitArray.d];
        assert 0 <= read($Heap, this, _module.LazyInitArray.n)
           && read($Heap, this, _module.LazyInitArray.n)
        ...
        assume $IsGoodHeap($Heap);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(99,28)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(100,9)
        assume true;
        assert $_Frame[this, _module.LazyInitArray.e];
        assert 0 <= i#0 && i#0 < Seq#Length(read($Heap, this, _module.LazyInitArray.e));
        assert 0 <= t#0
        ...
        assume $IsGoodHeap($Heap);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(100,28)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(101,9)
        assume true;
        assert $_Frame[this, _module.LazyInitArray.n];
        assume true;
        ...
        assume $IsGoodHeap($Heap);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(101,16)"} true;
    }

    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(104,10)
    assert read($Heap, this, _module.LazyInitArray.a) != null;
    assert 0 <= i#0
       && i#0 < _System.array.Length(read($Heap, this, _module.LazyInitArray.a));
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(104,13)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(105,14)
    assume true;
    assert $_Frame[this, _module.LazyInitArray.Contents];
    assert 0 <= i#0 && i#0 < Seq#Length(read($Heap, this, _module.LazyInitArray.Contents));
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vacid0/LazyInitArray.dfy(105,32)"} true;
}



// _module.LazyInitArray: subset type $Is
...
// _module.LazyInitArray: subset type $IsAlloc
