...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/nested_struct2_fail.c -bpl ./nested_struct2_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 24, 8} true;
  ...
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 24, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 1);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 2);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 26, 15} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.ref($M.1, $p4, $p1);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 27, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 27, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $load.ref($M.1, $p5);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 27, 16} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p6, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 27, 18} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p7, 100);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 28, 8} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 28, 13} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i16($M.3, $p8, 5);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(20, 1));
  $p10 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(20, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 29, 17} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.i32($M.4, $p10, 200);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 30, 7} true;
  assume {:verifier.code 0} true;
  $M.5 := $store.i32($M.5, $p11, 1000);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 31, 7} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p12, 2000);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
...
$bb6:
  ...
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(20, 1));
  $p21 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(20, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p1, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p31 := $load.ref($M.1, $p30);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p31, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p36 := $load.ref($M.1, $p35);
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p36, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb3;
$bb17:
  assume {:sourceloc "test/c/data/nested_struct2_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
