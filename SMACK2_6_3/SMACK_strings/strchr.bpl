...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strchr.c -bpl ./strchr.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strchr.c", 8, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strchr.c", 8, 28} true;
  assume {:verifier.code 0} true;
  call $p0 := strchr(.str, 46);
  assume $isExternal($p0);
  assume {:sourceloc "test/c/strings/strchr.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strchr.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strchr.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
