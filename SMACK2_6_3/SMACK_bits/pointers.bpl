...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/pointers.c -bpl ./pointers.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/pointers.c", 7, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/bits/pointers.c", 7, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/bits/pointers.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/bits/pointers.c", 8, 21} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(8);
  assume {:sourceloc "test/c/bits/pointers.c", 8, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/bits/pointers.c", 9, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 256);
  assume {:sourceloc "test/c/bits/pointers.c", 10, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.ref($M.1, $p3, $p0);
  assume {:sourceloc "test/c/bits/pointers.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/pointers.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/pointers.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/bits/pointers.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call free_($p8);
  assume {:sourceloc "test/c/bits/pointers.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
