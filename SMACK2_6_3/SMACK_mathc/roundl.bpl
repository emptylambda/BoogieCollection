...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/roundl.c -bpl ./roundl.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/roundl.c", 11, 21} true;
  ...
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __isnanl($f0);
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 22} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/roundl.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 26} true;
  assume {:verifier.code 0} true;
  call $i3 := __isinfl($f0);
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 26} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 40} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 44} true;
  assume {:verifier.code 0} true;
  call $i5 := __iszerol($f0);
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 44} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/roundl.c", 13, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/roundl.c", 14, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:14:24: warning: over-approximating call to llvm.round.f80; */
  call $f7 := llvm.round.f80($f0);
  call {:cexpr "rval"} boogie_si_record_float($f7);
  assume {:sourceloc "test/c/mathc/roundl.c", 15, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "test/c/mathc/roundl.c", 15, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:15:5: warning: over-approximating call to llvm.floor.f80; */
...
$bb11:
  ...
  assume {:sourceloc "test/c/mathc/roundl.c", 15, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:15:5: warning: over-approximating call to llvm.ceil.f80; */
...
$bb13:
  ...
  goto $bb10;
$bb14:
  assume {:sourceloc "test/c/mathc/roundl.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb15:
  assume {:sourceloc "test/c/mathc/roundl.c", 18, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:18:3: warning: over-approximating call to llvm.round.f80; */
  call $f12 := llvm.round.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundl.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i13 := (if $foeq.float.bool($f12, $fp(0, 0, 10204720)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/roundl.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb17;
$bb19:
  assume {:sourceloc "test/c/mathc/roundl.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/mathc/roundl.c", 19, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:19:3: warning: over-approximating call to llvm.round.f80; */
  call $f14 := llvm.round.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundl.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i15 := (if $foeq.float.bool($f14, $fp(0, 0, 9446416)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/roundl.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  goto $bb22;
$bb24:
  assume {:sourceloc "test/c/mathc/roundl.c", 20, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:20:26: warning: over-approximating call to llvm.round.f80; */
  call $f16 := llvm.round.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundl.c", 20, 15} true;
  assume {:verifier.code 0} true;
  call $i17 := __signbitl($f16);
  call {:cexpr "isNeg"} boogie_si_record_i32($i17);
  assume {:sourceloc "test/c/mathc/roundl.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb25:
  assume {:sourceloc "test/c/mathc/roundl.c", 21, 3} true;
...
$bb28:
  ...
  goto $bb27;
$bb29:
  assume {:sourceloc "test/c/mathc/roundl.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb30;
$bb30:
  assume {:sourceloc "test/c/mathc/roundl.c", 23, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:23:3: warning: over-approximating call to llvm.round.f80; */
  call $f19 := llvm.round.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundl.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $i20 := (if $foeq.float.bool($f19, $fp(0, 0, 9700224)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/roundl.c", 23, 3} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  goto $bb32;
$bb34:
  assume {:sourceloc "test/c/mathc/roundl.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb35;
$bb35:
  assume {:sourceloc "test/c/mathc/roundl.c", 24, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:24:3: warning: over-approximating call to llvm.round.f80; */
  call $f21 := llvm.round.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/roundl.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(0, 0, 10350480)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/roundl.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb38:
  ...
  goto $bb37;
$bb39:
  assume {:sourceloc "test/c/mathc/roundl.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb40;
$bb40:
  assume {:sourceloc "test/c/mathc/roundl.c", 26, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/roundl.c:26:3: warning: over-approximating call to llvm.round.f80; */
...
$bb43:
  ...
  goto $bb42;
$bb44:
  assume {:sourceloc "test/c/mathc/roundl.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
