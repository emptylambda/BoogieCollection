...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread_extras/queue_false-unreach-call.c -bpl ./queue_false-unreach-call.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 42398));
...
const m: ref;
axiom (m == $sub.ref(0, 1048));
const queue: ref;
axiom (queue == $sub.ref(0, 2124));
const {:count 10} stored_elements: ref;
axiom (stored_elements == $sub.ref(0, 3188));
const enqueue_flag: ref;
axiom (enqueue_flag == $sub.ref(0, 4213));
const dequeue_flag: ref;
axiom (dequeue_flag == $sub.ref(0, 5238));
const .str: ref;
axiom (.str == $sub.ref(0, 6278));
const init: ref;
axiom (init == $sub.ref(0, 7310));
procedure {:inline 1} init($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 28, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 28, 6} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(40, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 28, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 29, 6} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(44, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 29, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 0);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 30, 6} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 30, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, 0);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $exn := false;
  return;
...
axiom (llvm.dbg.declare == $sub.ref(0, 8342));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const empty: ref;
axiom (empty == $sub.ref(0, 9374));
procedure {:inline 1} empty($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $i2: i32;
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 34, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 34, 10} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(40, 1));
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 34, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(44, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 34, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p3);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 34, 15} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i2, $i4);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 34, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 35, 5} true;
  assume {:verifier.code 0} true;
  call $i6 := printf.ref(.str);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32(0, 1);
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 38, 5} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 39, 1} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
...
const printf: ref;
axiom (printf == $sub.ref(0, 10406));
procedure {:inline 1} printf.ref($p0: ref)
  returns ($r: i32);
const enqueue: ref;
axiom (enqueue == $sub.ref(0, 11438));
procedure {:inline 1} enqueue($p0: ref, $i1: i32)
  returns ($r: i32)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $i16: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 50, 6} true;
  assume {:verifier.code 0} true;
  call {:cexpr "enqueue:arg:x"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 50, 6} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 50, 17} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(44, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 50, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.0, $p3);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i4);
  $p6 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref($i5, 4));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 50, 23} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p6, $i1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 51, 6} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 51, 12} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 51, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 52, 10} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(44, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 52, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, $p10);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 52, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $eq.i32($i11, 10);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 52, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 53, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(44, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 53, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p13, 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 54, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 55, 8} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(44, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 55, 12} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 58, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const dequeue: ref;
axiom (dequeue == $sub.ref(0, 12470));
procedure {:inline 1} dequeue($p0: ref)
  returns ($r: i32)
{
  var $p1: ref;
  var $p2: ref;
  ...
  var $i16: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 64, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 64, 10} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 64, 21} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(40, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 64, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, $p2);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 64, 7} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  $p5 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref($i4, 4));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 64, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p5);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 65, 6} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(48, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 65, 12} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 65, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p7, $i9);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 66, 10} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(40, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 66, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.0, $p10);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 66, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $eq.i32($i11, 10);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 66, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i12 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 67, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(40, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 67, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p13, 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 68, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i12 == 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 69, 8} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 52)), $mul.ref(40, 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 69, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, $p14);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 69, 12} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 71, 3} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
...
const t1: ref;
axiom (t1 == $sub.ref(0, 13502));
procedure {:inline 1} t1($p0: ref)
  returns ($r: ref)
{
  var $i1: i32;
  var $i2: i32;
  ...
  var $i19: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 77, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 77, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(m);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 78, 11} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  call {:cexpr "value"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 79, 7} true;
  assume {:verifier.code 0} true;
  call $i3 := enqueue(queue, $i2);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 79, 7} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 79, 7} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 80, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 83, 22} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, stored_elements, $i2);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 84, 7} true;
  assume {:verifier.code 0} true;
  call $i5 := empty(queue);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 84, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 105, 3} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 85, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 88, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_unlock(m);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 90, 8} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 90, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.i32($i8, 9);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 90, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb7, $bb8;
$bb7:
  assume ($i9 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 91, 5} true;
  assume {:verifier.code 0} true;
  call $i10 := pthread_mutex_lock(m);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 92, 9} true;
  assume {:verifier.code 0} true;
  $i11 := $M.2;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 92, 9} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 102, 3} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb9:
  assume ($i12 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 93, 15} true;
  assume {:verifier.code 1} true;
  call $i13 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i13);
  call {:cexpr "value"} boogie_si_record_i32($i13);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 94, 7} true;
  assume {:verifier.code 0} true;
  call $i14 := enqueue(queue, $i13);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 95, 25} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i8, 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 95, 7} true;
  assume {:verifier.code 0} true;
  $i16 := $sext.i32.i64($i15);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 95, 7} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref($i16, 4));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 95, 30} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p17, $i13);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 96, 20} true;
  assume {:verifier.code 0} true;
  $M.2 := 0;
  call {:cexpr "enqueue_flag"} boogie_si_record_i8(0);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 97, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := 1;
  call {:cexpr "dequeue_flag"} boogie_si_record_i8(1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 98, 5} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 92, 9} true;
  ...
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 99, 5} true;
  assume {:verifier.code 0} true;
  call $i18 := pthread_mutex_unlock(m);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 100, 3} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb12:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 90, 32} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i8, 1);
  ...
  goto $bb6;
$bb13:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 106, 1} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i12: i32;
$bb0:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 111, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 111, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 111, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 111, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 112, 5} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_lock(m);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 113, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $M.3;
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 113, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 121, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 114, 7} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb5:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 113, 9} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 118, 5} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_mutex_unlock(m);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 119, 3} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb7:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 114, 7} true;
  assume {:verifier.code 0} true;
  call $i6 := dequeue(queue);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 114, 7} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 114, 7} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref($i7, 4));
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 114, 7} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.1, $p8);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 114, 7} true;
...
$bb10:
  ...
  goto $bb9;
$bb11:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 115, 20} true;
  assume {:verifier.code 0} true;
  $M.3 := 0;
  call {:cexpr "dequeue_flag"} boogie_si_record_i8(0);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 116, 20} true;
  assume {:verifier.code 0} true;
  $M.2 := 1;
  call {:cexpr "enqueue_flag"} boogie_si_record_i8(1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 117, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb12:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 111, 26} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i1, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 127, 16} true;
  assume {:verifier.code 0} true;
  ...
  $M.2 := 1;
  call {:cexpr "enqueue_flag"} boogie_si_record_i8(1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 128, 16} true;
  assume {:verifier.code 0} true;
  $M.3 := 0;
  call {:cexpr "dequeue_flag"} boogie_si_record_i8(0);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 130, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := init(queue);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 132, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 132, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 134, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_init(m, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 136, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, t1, queue);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 137, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, t2, queue);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 139, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.4, $p0);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 139, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 140, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.5, $p1);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 140, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "test/c/pthread_extras/queue_false-unreach-call.c", 142, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 24854));
...
axiom (__VERIFIER_assert == $sub.ref(0, 25886));
...
axiom (__SMACK_and32 == $sub.ref(0, 26918));
...
axiom (__SMACK_and64 == $sub.ref(0, 27950));
...
axiom (__SMACK_and16 == $sub.ref(0, 28982));
...
axiom (__SMACK_and8 == $sub.ref(0, 30014));
...
axiom (__SMACK_or32 == $sub.ref(0, 31046));
...
axiom (__SMACK_or64 == $sub.ref(0, 32078));
...
axiom (__SMACK_or16 == $sub.ref(0, 33110));
...
axiom (__SMACK_or8 == $sub.ref(0, 34142));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 35174));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 36206));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 37238));
procedure {:inline 1} __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 38270));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 39302));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 40334));
...
axiom (llvm.dbg.value == $sub.ref(0, 41366));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 42398));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, queue, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(1, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(2, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(3, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(4, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(5, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(6, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(7, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(8, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(0, 1)), $mul.ref(9, 4)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(40, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(44, 1)), 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(queue, $mul.ref(0, 52)), $mul.ref(48, 1)), 0);
  $M.1 := $store.i32($M.1, stored_elements, 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(1, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(2, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(3, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(4, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(5, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(6, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(7, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(8, 4)), 0);
  $M.1 := $store.i32($M.1, $add.ref($add.ref(stored_elements, $mul.ref(0, 40)), $mul.ref(9, 4)), 0);
  $M.2 := 0;
  call {:cexpr "enqueue_flag"} boogie_si_record_i8(0);
  $M.3 := 0;
  call {:cexpr "dequeue_flag"} boogie_si_record_i8(0);
