...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strlen.c -bpl ./strlen.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 23733));
...
const {:count 5} __const.main.word: ref;
axiom (__const.main.word == $sub.ref(0, 1029));
const main: ref;
axiom (main == $sub.ref(0, 2061));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strlen.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(5, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "test/c/strings/strlen.c", 8, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/strings/strlen.c", 8, 8} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const.main.word, 5, false);
  assume {:sourceloc "test/c/strings/strlen.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strlen.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strlen.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assert == $sub.ref(0, 9285));
...
axiom (__SMACK_decls == $sub.ref(0, 19605));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 20637));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21669));
...
axiom (llvm.dbg.value == $sub.ref(0, 22701));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 23733));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i8($M.0, __const.main.word, 72);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word, $mul.ref(0, 5)), $mul.ref(1, 1)), 105);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word, $mul.ref(0, 5)), $mul.ref(2, 1)), 33);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word, $mul.ref(0, 5)), $mul.ref(3, 1)), 33);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(__const.main.word, $mul.ref(0, 5)), $mul.ref(4, 1)), 0);
  $exn := false;
  return;
}
