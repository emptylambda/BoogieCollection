...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/func_ptr_vararg.c -bpl ./func_ptr_vararg.bpl
...
{
$bb0:
  assume {:sourceloc "test/c/data/func_ptr_vararg.c", 8, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/func_ptr_vararg.c", 8, 5} true;
  assume {:verifier.code 0} true;
  $M.0 := 1;
  call {:cexpr "g"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/data/func_ptr_vararg.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/func_ptr_vararg.c", 15, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/func_ptr_vararg.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/func_ptr_vararg.c", 16, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/func_ptr_vararg.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
