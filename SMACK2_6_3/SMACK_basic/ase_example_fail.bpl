...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/ase_example_fail.c -bpl ./ase_example_fail.bpl
...
const alloc: ref;
axiom (alloc == $sub.ref(0, 1032));
procedure {:inline 1} alloc($i0: i32)
  returns ($r: ref)
{
  var $i1: i64;
  var $i2: i64;
  ...
  var $p4: ref;
$bb0:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 13, 47} true;
  assume {:verifier.code 0} true;
  call {:cexpr "alloc:arg:size"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 13, 47} true;
  assume {:verifier.code 0} true;
  $i1 := $sext.i32.i64($i0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 13, 52} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.i64($i1, 8);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 13, 40} true;
  assume {:verifier.code 0} true;
  call $p3 := malloc($i2);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 13, 32} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 13, 25} true;
  assume {:verifier.code 0} true;
  $r := $p4;
  $exn := false;
  return;
...
procedure {:inline 1} init($i0: i32)
{
  var $p1: ref;
  var $i2: i32;
  var $i3: i1;
  ...
  var $i24: i32;
$bb0:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 17, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "init:arg:size"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 17, 14} true;
  assume {:verifier.code 0} true;
  call $p1 := alloc($i0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 20, 8} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 20, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, $i0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i2);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p1, $mul.ref($i4, 8));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p1, $mul.ref($i4, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 21, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p6, 1);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 20, 26} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i2, 1);
...
$bb5:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 24, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $slt.i32($i8, $i0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i9 == 1);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i8);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p1, $mul.ref($i10, 8));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 25, 11} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p1, $mul.ref($i10, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 25, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p12, 0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.i32.i64($i8);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p1, $mul.ref($i13, 8));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 26, 11} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p1, $mul.ref($i13, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 26, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p15, 0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $i17 := 0;
  goto $bb9;
$bb8:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 24, 26} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i8, 1);
...
$bb9:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 29, 17} true;
  assume {:verifier.code 0} true;
  $i18 := $slt.i32($i17, $i0);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  goto $bb10, $bb11;
$bb10:
  assume ($i18 == 1);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !(($i18 == 1));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb12:
  ...
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p1, $mul.ref($i19, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  goto $bb14;
$bb16:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb17:
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 29, 26} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i17, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 34, 18} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 34, 18} true;
  assume {:verifier.code 0} true;
  call init(10);
  assume {:sourceloc "test/c/basic/ase_example_fail.c", 34, 28} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
