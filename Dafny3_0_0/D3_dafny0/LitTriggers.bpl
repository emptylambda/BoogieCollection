// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy -print:./LitTriggers.bpl
...
axiom (forall a#24#0#0: DatatypeType, a#24#1#0: DatatypeType :: 
  ...
  _module.Tree.left(#_module.Tree.Node(a#24#0#0, a#24#1#0)) == a#24#0#0);
...
axiom (forall a#26#0#0: DatatypeType, a#26#1#0: DatatypeType :: 
  ...
  _module.Tree.right(#_module.Tree.Node(a#26#0#0, a#26#1#0)) == a#26#1#0);
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, this: DatatypeType :: 
    ...
    _module.Tree.Elements#canCall(this)
         || (2 != $FunctionContextHeight && $Is(this, Tclass._module.Tree()))
...
implementation CheckWellformed$$_module.Tree.Elements(this: DatatypeType)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(41,11): initial state"} true;
...
axiom 5 <= $FunctionContextHeight
   ==> (forall x#0: int, y#0: int :: 
    { _module.__default.P(x#0, y#0) } 
    _module.__default.P#canCall(x#0, y#0) || 5 != $FunctionContextHeight ==> true);
...
procedure CheckWellformed$$_module.__default.P(x#0: int, y#0: int);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure CheckWellformed$$_module.__default.L1(x#0: int, y#0: int);
  free requires 6 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.L1(x#0: int, y#0: int);
  // user-defined preconditions
  requires y#0 == LitInt(2);
  requires (forall i#1: int :: 
    { _module.__default.P(i#1, 3) } 
    true ==> _module.__default.P(i#1, LitInt(3)));
  modifies $Heap, $Tick;
  // frame condition
...
procedure Impl$$_module.__default.L1(x#0: int, y#0: int) returns ($_reverifyPost: bool);
  free requires 6 == $FunctionContextHeight;
  // user-defined preconditions
  requires y#0 == LitInt(2);
  requires (forall i#1: int :: 
...
implementation Impl$$_module.__default.L1(x#0: int, y#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#1: int;
  var ##y#1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(11,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(12,5)
    ##x#1 := x#0;
    ...
    assume _module.__default.P#canCall(x#0, y#0 + 1);
    assert _module.__default.P(x#0, y#0 + 1);
}



procedure CheckWellformed$$_module.__default.L2(x#0: int, y#0: int);
  free requires 7 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.L2(x#0: int, y#0: int);
  // user-defined preconditions
  requires y#0 == LitInt(2);
  requires (forall i#1: int :: 
    { _module.__default.P(i#1, 3) } 
...
procedure Impl$$_module.__default.L2(x#0: int, y#0: int) returns ($_reverifyPost: bool);
  free requires 7 == $FunctionContextHeight;
  // user-defined preconditions
  requires y#0 == LitInt(2);
  requires (forall i#1: int :: 
...
implementation Impl$$_module.__default.L2(x#0: int, y#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#1: int;
  var ##y#1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(18,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(19,5)
    ##x#1 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#1, TInt, $Heap);
    ##y#1 := y#0 + 1;
...
procedure CheckWellformed$$_module.__default.L3(x#0: int, y#0: int);
  free requires 8 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.L3(x#0: int, y#0: int);
  // user-defined preconditions
  requires y#0 == LitInt(2);
  requires (forall i#1: int :: 
    { _module.__default.P(i#1, 3) } 
...
procedure Impl$$_module.__default.L3(x#0: int, y#0: int) returns ($_reverifyPost: bool);
  free requires 8 == $FunctionContextHeight;
  // user-defined preconditions
  requires y#0 == LitInt(2);
  requires (forall i#1: int :: 
...
implementation Impl$$_module.__default.L3(x#0: int, y#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var dummy#0: int;
  var ##x#1: int;
  var ##y#1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(25,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(26,15)
    assume true;
    assume true;
    dummy#0 := LitInt(3);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(26,18)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(27,5)
    ##x#1 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#1, TInt, $Heap);
    ##y#1 := y#0 + 1;
...
procedure CheckWellformed$$_module.__default.L4(x#0: int, y#0: int);
  free requires 9 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.L4(x#0: int, y#0: int);
  // user-defined preconditions
  requires y#0 == LitInt(2);
  requires (forall i#1: int, j#1: int :: 
    { _module.__default.P(i#1, j#1) } 
    true ==> j#1 == LitInt(3) ==> _module.__default.P(i#1, j#1));
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure Impl$$_module.__default.L4(x#0: int, y#0: int) returns ($_reverifyPost: bool);
  free requires 9 == $FunctionContextHeight;
  // user-defined preconditions
  requires y#0 == LitInt(2);
  requires (forall i#1: int, j#1: int :: 
...
implementation Impl$$_module.__default.L4(x#0: int, y#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#1: int;
  var ##y#1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(33,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(34,5)
    ##x#1 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#1, TInt, $Heap);
    ##y#1 := y#0 + 1;
...
procedure CheckWellformed$$_module.__default.Sum(t#0: DatatypeType where $Is(t#0, Tclass._module.Tree()));
...
axiom 3 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    _module.__default.IsEven#canCall(x#0) || 3 != $FunctionContextHeight ==> true);
...
procedure {:_induction t#0} CheckWellformed$$_module.__default.TimesOut(t#0: DatatypeType
...
procedure {:_induction t#0} Call$$_module.__default.TimesOut(t#0: DatatypeType
       where $Is(t#0, Tclass._module.Tree())
         && $IsAlloc(t#0, Tclass._module.Tree(), $Heap)
         && $IsA#_module.Tree(t#0));
  // user-defined preconditions
...
procedure {:_induction t#0} Impl$$_module.__default.TimesOut(t#0: DatatypeType
       where $Is(t#0, Tclass._module.Tree())
         && $IsAlloc(t#0, Tclass._module.Tree(), $Heap)
         && $IsA#_module.Tree(t#0))
...
implementation {:_induction t#0} Impl$$_module.__default.TimesOut(t#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var ##x#1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(55,0): initial state"} true;
    ...
    assume (forall $ih#t0#0: DatatypeType :: 
      $Is($ih#t0#0, Tclass._module.Tree())
         ...
         ==> true);
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LitTriggers.dfy(56,3)
    ...
    assert {:subsumption 0} _module.Tree.Node_q(t#0)
