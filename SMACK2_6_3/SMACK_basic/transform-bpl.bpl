...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/transform-bpl.c -bpl ./transform-bpl.bpl
...
{
$bb0:
  assume {:sourceloc "test/c/basic/transform-bpl.c", 8, 17} true;
...
const bar: ref;
axiom (bar == $sub.ref(0, 2064));
procedure {:inline 1} bar()
  returns ($r: i32)
{
$bb0:
  assume {:sourceloc "test/c/basic/transform-bpl.c", 10, 17} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/transform-bpl.c", 10, 17} true;
  assume {:verifier.code 0} true;
  $r := 1;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/transform-bpl.c", 13, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/transform-bpl.c", 14, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := bar();
  call {:cexpr "y"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/basic/transform-bpl.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/transform-bpl.c", 15, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/transform-bpl.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
