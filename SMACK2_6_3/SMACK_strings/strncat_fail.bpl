...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strncat_fail.c -bpl ./strncat_fail.bpl
...
axiom (.str.1 == $sub.ref(0, 2054));
const {:count 5} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 3083));
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strncat_fail.c", 8, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(30, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "test/c/strings/strncat_fail.c", 8, 10} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 30)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strncat_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := strcpy($p1, .str);
  assume $isExternal($p2);
  assume {:sourceloc "test/c/strings/strncat_fail.c", 11, 11} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 30)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strncat_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $p4 := strncat($p3, .str.1, 2);
  assume $isExternal($p4);
  assume {:sourceloc "test/c/strings/strncat_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strncat_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref(0, 30)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strncat_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := strcmp($p5, .str.2);
  assume {:sourceloc "test/c/strings/strncat_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "test/c/strings/strncat_fail.c", 13, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strncat_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strcpy: ref;
axiom (strcpy == $sub.ref(0, 6179));
procedure {:inline 1} strcpy($p0: ref, $p1: ref)
  returns ($r: ref);
const strncat: ref;
axiom (strncat == $sub.ref(0, 7211));
procedure {:inline 1} strncat($p0: ref, $p1: ref, $i2: i64)
  returns ($r: ref);
const strcmp: ref;
