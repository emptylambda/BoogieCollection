...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_alias_fail.c -bpl ./struct_alias_fail.bpl
...
procedure {:inline 1} f($p0: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 15, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 15, 34} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 15, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 0);
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 15, 41} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
procedure {:inline 1} g($p0: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 17, 34} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 17, 34} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 17, 36} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 17, 41} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 22, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call f($p1);
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call f($p2);
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 24, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call g($p3);
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 26, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/struct_alias_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
