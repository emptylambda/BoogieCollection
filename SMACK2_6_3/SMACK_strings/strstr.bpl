...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strstr.c -bpl ./strstr.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strstr.c", 9, 31} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strstr.c", 9, 31} true;
  assume {:verifier.code 0} true;
  call $p0 := strstr(.str, .str.1);
  assume $isExternal($p0);
  assume {:sourceloc "test/c/strings/strstr.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strstr.c", 11, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strstr.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strstr: ref;
axiom (strstr == $sub.ref(0, 5148));
procedure {:inline 1} strstr($p0: ref, $p1: ref)
  returns ($r: ref);
const strcmp: ref;
