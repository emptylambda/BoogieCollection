...
procedure CheckWellformed$$B.X.Abs.C.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.B.X.Abs.C())
         && $IsAlloc(this, Tclass.B.X.Abs.C(), $Heap));
  ...
  modifies $Heap, $Tick;
  ensures B.X.Abs.C.Valid($Heap, this) ==> LitInt(0) <= read($Heap, this, B.X.Abs.C.x);
  ensures read($Heap, this, B.X.Abs.C.x) == LitInt(8) ==> B.X.Abs.C.Valid($Heap, this);



implementation CheckWellformed$$B.X.Abs.C.Valid(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    if (*)
    {
        if (*)
        {
            assert this == this
               || (Set#Subset(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), 
                 ...
                 && !Set#Subset(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), 
                  Set#UnionOne(Set#Empty(): Set Box, $Box(this))));
            assume this == this || B.X.Abs.C.Valid#canCall($Heap, this);
            assume B.X.Abs.C.Valid($Heap, this);
            assume LitInt(0) <= read($Heap, this, B.X.Abs.C.x);
        }
        else
        {
            assume B.X.Abs.C.Valid($Heap, this) ==> LitInt(0) <= read($Heap, this, B.X.Abs.C.x);
        }

        if (*)
        {
            assume read($Heap, this, B.X.Abs.C.x) == LitInt(8);
            assert this == this
               || (Set#Subset(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), 
                  Set#UnionOne(Set#Empty(): Set Box, $Box(this)))
                 && !Set#Subset(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), 
        ...
        {
            assume read($Heap, this, B.X.Abs.C.x) == LitInt(8) ==> B.X.Abs.C.Valid($Heap, this);
        }
...
procedure CheckWellformed$$B.X.Abs.C.RevealedValid(this: ref
       where this != null
         && 
        $Is(this, Tclass.B.X.Abs.C())
         && $IsAlloc(this, Tclass.B.X.Abs.C(), $Heap));
...
implementation CheckWellformed$$B.X.Abs.C.RevealedValid(this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    if (*)
    {
        if (*)
        {
            assume B.X.Abs.C.Valid#canCall($Heap, this);
            assume B.X.Abs.C.Valid($Heap, this);
            assume LitInt(0) <= read($Heap, this, B.X.Abs.C.x);
        }
        else
...
procedure CheckWellformed$$B.X.Abs.C.Get(this: ref
       where this != null
         && 
        $Is(this, Tclass.B.X.Abs.C())
         && $IsAlloc(this, Tclass.B.X.Abs.C(), $Heap));
