...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/simd/constant_fail.c -bpl ./constant_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/simd/constant_fail.c", 8, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/simd/constant_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i0 := $extractelement.vec.2xi64.i32(mk.vec.2xi64(255, 255), 0);
  assume {:sourceloc "test/c/simd/constant_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i64($i0, 254);
  assume {:sourceloc "test/c/simd/constant_fail.c", 8, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/simd/constant_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
