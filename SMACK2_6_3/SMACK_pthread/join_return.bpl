...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/join_return.c -bpl ./join_return.bpl
  ...
  returns ($r: ref)
{
  ...
  var $p7: ref;
$bb0:
  assume {:sourceloc "test/c/pthread/join_return.c", 19, 4} true;
  ...
  assume {:sourceloc "test/c/pthread/join_return.c", 20, 26} true;
  assume {:verifier.code 0} true;
  call $p3 := malloc(8);
  assume {:sourceloc "test/c/pthread/join_return.c", 20, 18} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/pthread/join_return.c", 21, 11} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p4, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/join_return.c", 21, 13} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p5, 3);
  assume {:sourceloc "test/c/pthread/join_return.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p4, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/join_return.c", 22, 13} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p6, 4);
  assume {:sourceloc "test/c/pthread/join_return.c", 23, 16} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/pthread/join_return.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($p7);
  assume {:sourceloc "test/c/pthread/join_return.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/join_return.c", 31, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join_return.c", 32, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.3, $p0);
  assume {:sourceloc "test/c/pthread/join_return.c", 32, 19} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/join_return.c", 32, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i3, $p4);
  assume {:sourceloc "test/c/pthread/join_return.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/join_return.c", 33, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/join_return.c", 34, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/pthread/join_return.c", 34, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/pthread/join_return.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/pthread/join_return.c", 35, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/pthread/join_return.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $p16 := $load.ref($M.4, $p1);
  assume {:sourceloc "test/c/pthread/join_return.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $p17 := $bitcast.ref.ref($p16);
  assume {:sourceloc "test/c/pthread/join_return.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call free_($p17);
  assume {:sourceloc "test/c/pthread/join_return.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
