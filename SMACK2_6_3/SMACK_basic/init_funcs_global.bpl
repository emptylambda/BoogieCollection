...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/init_funcs_global.c -bpl ./init_funcs_global.bpl
...
{
$bb0:
  assume {:sourceloc "test/c/basic/init_funcs_global.c", 7, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/init_funcs_global.c", 7, 22} true;
  assume {:verifier.code 0} true;
  $M.0 := 11;
  call {:cexpr "g"} boogie_si_record_i32(11);
  assume {:sourceloc "test/c/basic/init_funcs_global.c", 7, 28} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
{
$bb0:
  assume {:sourceloc "test/c/basic/init_funcs_global.c", 9, 22} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/init_funcs_global.c", 9, 22} true;
  assume {:verifier.code 0} true;
  $M.0 := 12;
  call {:cexpr "g"} boogie_si_record_i32(12);
  assume {:sourceloc "test/c/basic/init_funcs_global.c", 9, 28} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/init_funcs_global.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/init_funcs_global.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
