...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/extern_func.c -bpl ./extern_func.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/extern_func.c", 9, 7} true;
  ...
  assume {:sourceloc "test/c/basic/extern_func.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
