...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/global_and_heap_alloc_fail_free.c -bpl ./global_and_heap_alloc_fail_free.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 21668));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_free.c", 10, 12} true;
  ...
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_free.c", 11, 11} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref(x, $mul.ref(0, 4));
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_free.c", 11, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  call {:cexpr "c"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_free.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_free.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call free_($p4);
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_free.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref(x);
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_free.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call free_($p5);
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_free.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (__SMACK_and32 == $sub.ref(0, 8252));
...
axiom (__SMACK_and64 == $sub.ref(0, 9284));
...
axiom (__SMACK_and16 == $sub.ref(0, 10316));
...
axiom (__SMACK_and8 == $sub.ref(0, 11348));
...
axiom (__SMACK_or32 == $sub.ref(0, 12380));
...
axiom (__SMACK_or64 == $sub.ref(0, 13412));
...
axiom (__SMACK_or16 == $sub.ref(0, 14444));
...
axiom (__SMACK_or8 == $sub.ref(0, 15476));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 16508));
...
axiom (__SMACK_decls == $sub.ref(0, 17540));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 18572));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 19604));
...
axiom (llvm.dbg.value == $sub.ref(0, 20636));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 21668));
