...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/vararg.c -bpl ./vararg.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/vararg.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/vararg.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call panic.i32(1);
  assume {:sourceloc "test/c/basic/vararg.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call panic.i32.i32(1, 2);
  assume {:sourceloc "test/c/basic/vararg.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure {:inline 1} panic.i32.i32($i0: i32, p.1: i32)
{
  ...
  var $i23: i1;
$bb0:
  assume {:sourceloc "test/c/basic/vararg.c", 9, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/vararg.c", 9, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/basic/vararg.c:9:3: warning: unsoundly ignoring unmodeled operation llvm.va_start; */
  call llvm.va_start($p3);
  assume {:sourceloc "test/c/basic/vararg.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := printf.ref.i32(.str, $i0);
  assume {:sourceloc "test/c/basic/vararg.c", 11, 30} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:sourceloc "test/c/basic/vararg.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i20 := printf.ref.i32.i32(.str.1, $i0, $i19);
  assume {:sourceloc "test/c/basic/vararg.c", 12, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/vararg.c", 12, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/basic/vararg.c:12:3: warning: unsoundly ignoring unmodeled operation llvm.va_end; */
  call llvm.va_end($p22);
  assume {:sourceloc "test/c/basic/vararg.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/basic/vararg.c", 13, 3} true;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/basic/vararg.c", 14, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
