...
axiom (forall a#14#0#0: ref :: 
  { #ArrayTypeMagic.ArrayCubeTree.Leaf(a#14#0#0) } 
  DatatypeCtorId(#ArrayTypeMagic.ArrayCubeTree.Leaf(a#14#0#0))
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.ArrayCubeTree.Leaf_q(d) } 
  ArrayTypeMagic.ArrayCubeTree.Leaf_q(d)
     ==> (exists a#15#0#0: ref :: d == #ArrayTypeMagic.ArrayCubeTree.Leaf(a#15#0#0)));
...
// Constructor $Is
axiom (forall ArrayTypeMagic.ArrayCubeTree$T: Ty, a#16#0#0: ref :: 
  { $Is(#ArrayTypeMagic.ArrayCubeTree.Leaf(a#16#0#0), 
      Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T)) } 
  $Is(#ArrayTypeMagic.ArrayCubeTree.Leaf(a#16#0#0), 
      Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T))
     <==> $Is(a#16#0#0, Tclass._System.array3(ArrayTypeMagic.ArrayCubeTree$T)));

// Constructor $IsAlloc
axiom (forall ArrayTypeMagic.ArrayCubeTree$T: Ty, a#17#0#0: ref, $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.ArrayCubeTree.Leaf(a#17#0#0), 
      Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.ArrayCubeTree.Leaf(a#17#0#0), 
        Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T), 
        $h)
       <==> $IsAlloc(a#17#0#0, Tclass._System.array3(ArrayTypeMagic.ArrayCubeTree$T), $h)));
...
// Constructor literal
axiom (forall a#18#0#0: ref :: 
  { #ArrayTypeMagic.ArrayCubeTree.Leaf(Lit(a#18#0#0)) } 
  #ArrayTypeMagic.ArrayCubeTree.Leaf(Lit(a#18#0#0))
     == Lit(#ArrayTypeMagic.ArrayCubeTree.Leaf(a#18#0#0)));

function ArrayTypeMagic.ArrayCubeTree._h4(DatatypeType) : ref;

// Constructor injectivity
axiom (forall a#19#0#0: ref :: 
  { #ArrayTypeMagic.ArrayCubeTree.Leaf(a#19#0#0) } 
  ArrayTypeMagic.ArrayCubeTree._h4(#ArrayTypeMagic.ArrayCubeTree.Leaf(a#19#0#0))
     == a#19#0#0);
...
axiom (forall a#20#0#0: DatatypeType, a#20#1#0: DatatypeType :: 
  { #ArrayTypeMagic.ArrayCubeTree.Node(a#20#0#0, a#20#1#0) } 
  DatatypeCtorId(#ArrayTypeMagic.ArrayCubeTree.Node(a#20#0#0, a#20#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  ArrayTypeMagic.ArrayCubeTree.Node_q(d)
     ==> (exists a#21#0#0: DatatypeType, a#21#1#0: DatatypeType :: 
      d == #ArrayTypeMagic.ArrayCubeTree.Node(a#21#0#0, a#21#1#0)));

// Constructor $Is
axiom (forall ArrayTypeMagic.ArrayCubeTree$T: Ty, 
    a#22#0#0: DatatypeType, 
    a#22#1#0: DatatypeType :: 
  { $Is(#ArrayTypeMagic.ArrayCubeTree.Node(a#22#0#0, a#22#1#0), 
      Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T)) } 
  $Is(#ArrayTypeMagic.ArrayCubeTree.Node(a#22#0#0, a#22#1#0), 
      Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T))
     <==> $Is(a#22#0#0, Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T))
       && $Is(a#22#1#0, Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T)));

// Constructor $IsAlloc
axiom (forall ArrayTypeMagic.ArrayCubeTree$T: Ty, 
    a#23#0#0: DatatypeType, 
    a#23#1#0: DatatypeType, 
    $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.ArrayCubeTree.Node(a#23#0#0, a#23#1#0), 
      Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic.ArrayCubeTree$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.ArrayCubeTree.Node(a#23#0#0, a#23#1#0), 
...
axiom (forall a#24#0#0: DatatypeType, a#24#1#0: DatatypeType :: 
  { #ArrayTypeMagic.ArrayCubeTree.Node(Lit(a#24#0#0), Lit(a#24#1#0)) } 
  #ArrayTypeMagic.ArrayCubeTree.Node(Lit(a#24#0#0), Lit(a#24#1#0))
     == Lit(#ArrayTypeMagic.ArrayCubeTree.Node(a#24#0#0, a#24#1#0)));
...
axiom (forall a#25#0#0: DatatypeType, a#25#1#0: DatatypeType :: 
  { #ArrayTypeMagic.ArrayCubeTree.Node(a#25#0#0, a#25#1#0) } 
  ArrayTypeMagic.ArrayCubeTree._h5(#ArrayTypeMagic.ArrayCubeTree.Node(a#25#0#0, a#25#1#0))
     == a#25#0#0);

// Inductive rank
axiom (forall a#26#0#0: DatatypeType, a#26#1#0: DatatypeType :: 
  { #ArrayTypeMagic.ArrayCubeTree.Node(a#26#0#0, a#26#1#0) } 
  DtRank(a#26#0#0)
     < DtRank(#ArrayTypeMagic.ArrayCubeTree.Node(a#26#0#0, a#26#1#0)));
...
axiom (forall a#27#0#0: DatatypeType, a#27#1#0: DatatypeType :: 
  { #ArrayTypeMagic.ArrayCubeTree.Node(a#27#0#0, a#27#1#0) } 
  ArrayTypeMagic.ArrayCubeTree._h6(#ArrayTypeMagic.ArrayCubeTree.Node(a#27#0#0, a#27#1#0))
     == a#27#1#0);

// Inductive rank
axiom (forall a#28#0#0: DatatypeType, a#28#1#0: DatatypeType :: 
  { #ArrayTypeMagic.ArrayCubeTree.Node(a#28#0#0, a#28#1#0) } 
  DtRank(a#28#1#0)
     < DtRank(#ArrayTypeMagic.ArrayCubeTree.Node(a#28#0#0, a#28#1#0)));
...
axiom (forall a#29#0#0: ref :: 
  { #ArrayTypeMagic.AnotherACT.Leaf(a#29#0#0) } 
  DatatypeCtorId(#ArrayTypeMagic.AnotherACT.Leaf(a#29#0#0))
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.AnotherACT.Leaf_q(d) } 
  ArrayTypeMagic.AnotherACT.Leaf_q(d)
     ==> (exists a#30#0#0: ref :: d == #ArrayTypeMagic.AnotherACT.Leaf(a#30#0#0)));
...
// Constructor $Is
axiom (forall ArrayTypeMagic.AnotherACT$T: Ty, a#31#0#0: ref :: 
  { $Is(#ArrayTypeMagic.AnotherACT.Leaf(a#31#0#0), 
      Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T)) } 
  $Is(#ArrayTypeMagic.AnotherACT.Leaf(a#31#0#0), 
      Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T))
     <==> $Is(a#31#0#0, Tclass._System.array3(ArrayTypeMagic.AnotherACT$T)));

// Constructor $IsAlloc
axiom (forall ArrayTypeMagic.AnotherACT$T: Ty, a#32#0#0: ref, $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.AnotherACT.Leaf(a#32#0#0), 
      Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.AnotherACT.Leaf(a#32#0#0), 
        Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T), 
        $h)
       <==> $IsAlloc(a#32#0#0, Tclass._System.array3(ArrayTypeMagic.AnotherACT$T), $h)));
...
axiom (forall a#33#0#0: ref :: 
  { #ArrayTypeMagic.AnotherACT.Leaf(Lit(a#33#0#0)) } 
  #ArrayTypeMagic.AnotherACT.Leaf(Lit(a#33#0#0))
     == Lit(#ArrayTypeMagic.AnotherACT.Leaf(a#33#0#0)));

function ArrayTypeMagic.AnotherACT._h7(DatatypeType) : ref;

// Constructor injectivity
axiom (forall a#34#0#0: ref :: 
  { #ArrayTypeMagic.AnotherACT.Leaf(a#34#0#0) } 
  ArrayTypeMagic.AnotherACT._h7(#ArrayTypeMagic.AnotherACT.Leaf(a#34#0#0))
     == a#34#0#0);
...
axiom (forall a#35#0#0: DatatypeType, a#35#1#0: DatatypeType :: 
  { #ArrayTypeMagic.AnotherACT.Node(a#35#0#0, a#35#1#0) } 
  DatatypeCtorId(#ArrayTypeMagic.AnotherACT.Node(a#35#0#0, a#35#1#0))
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.AnotherACT.Node_q(d) } 
  ArrayTypeMagic.AnotherACT.Node_q(d)
     ==> (exists a#36#0#0: DatatypeType, a#36#1#0: DatatypeType :: 
      d == #ArrayTypeMagic.AnotherACT.Node(a#36#0#0, a#36#1#0)));

// Constructor $Is
axiom (forall ArrayTypeMagic.AnotherACT$T: Ty, a#37#0#0: DatatypeType, a#37#1#0: DatatypeType :: 
  { $Is(#ArrayTypeMagic.AnotherACT.Node(a#37#0#0, a#37#1#0), 
      Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T)) } 
  $Is(#ArrayTypeMagic.AnotherACT.Node(a#37#0#0, a#37#1#0), 
      Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T))
     <==> $Is(a#37#0#0, Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T))
       && $Is(a#37#1#0, Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T)));
...
axiom (forall ArrayTypeMagic.AnotherACT$T: Ty, 
    ...
    $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.AnotherACT.Node(a#38#0#0, a#38#1#0), 
      Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.AnotherACT.Node(a#38#0#0, a#38#1#0), 
        Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T), 
        $h)
       <==> $IsAlloc(a#38#0#0, Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T), $h)
         && $IsAlloc(a#38#1#0, Tclass.ArrayTypeMagic.AnotherACT(ArrayTypeMagic.AnotherACT$T), $h)));
...
axiom (forall a#39#0#0: DatatypeType, a#39#1#0: DatatypeType :: 
  { #ArrayTypeMagic.AnotherACT.Node(Lit(a#39#0#0), Lit(a#39#1#0)) } 
  #ArrayTypeMagic.AnotherACT.Node(Lit(a#39#0#0), Lit(a#39#1#0))
     == Lit(#ArrayTypeMagic.AnotherACT.Node(a#39#0#0, a#39#1#0)));

function ArrayTypeMagic.AnotherACT._h8(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#40#0#0: DatatypeType, a#40#1#0: DatatypeType :: 
  { #ArrayTypeMagic.AnotherACT.Node(a#40#0#0, a#40#1#0) } 
  ArrayTypeMagic.AnotherACT._h8(#ArrayTypeMagic.AnotherACT.Node(a#40#0#0, a#40#1#0))
     == a#40#0#0);

// Inductive rank
axiom (forall a#41#0#0: DatatypeType, a#41#1#0: DatatypeType :: 
  { #ArrayTypeMagic.AnotherACT.Node(a#41#0#0, a#41#1#0) } 
  DtRank(a#41#0#0) < DtRank(#ArrayTypeMagic.AnotherACT.Node(a#41#0#0, a#41#1#0)));

function ArrayTypeMagic.AnotherACT._h9(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#42#0#0: DatatypeType, a#42#1#0: DatatypeType :: 
  { #ArrayTypeMagic.AnotherACT.Node(a#42#0#0, a#42#1#0) } 
  ArrayTypeMagic.AnotherACT._h9(#ArrayTypeMagic.AnotherACT.Node(a#42#0#0, a#42#1#0))
     == a#42#1#0);

// Inductive rank
axiom (forall a#43#0#0: DatatypeType, a#43#1#0: DatatypeType :: 
  { #ArrayTypeMagic.AnotherACT.Node(a#43#0#0, a#43#1#0) } 
  DtRank(a#43#1#0) < DtRank(#ArrayTypeMagic.AnotherACT.Node(a#43#0#0, a#43#1#0)));
...
// Constructor identifier
axiom (forall a#44#0#0: ref :: 
  { #ArrayTypeMagic.OneMoreACT.Leaf(a#44#0#0) } 
  DatatypeCtorId(#ArrayTypeMagic.OneMoreACT.Leaf(a#44#0#0))
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.OneMoreACT.Leaf_q(d) } 
  ArrayTypeMagic.OneMoreACT.Leaf_q(d)
     ==> (exists a#45#0#0: ref :: d == #ArrayTypeMagic.OneMoreACT.Leaf(a#45#0#0)));
...
// Constructor $Is
axiom (forall ArrayTypeMagic.OneMoreACT$T: Ty, ArrayTypeMagic.OneMoreACT$U: Ty, a#46#0#0: ref :: 
  { $Is(#ArrayTypeMagic.OneMoreACT.Leaf(a#46#0#0), 
      Tclass.ArrayTypeMagic.OneMoreACT(ArrayTypeMagic.OneMoreACT$T, ArrayTypeMagic.OneMoreACT$U)) } 
  $Is(#ArrayTypeMagic.OneMoreACT.Leaf(a#46#0#0), 
      Tclass.ArrayTypeMagic.OneMoreACT(ArrayTypeMagic.OneMoreACT$T, ArrayTypeMagic.OneMoreACT$U))
     <==> $Is(a#46#0#0, Tclass._System.array3(ArrayTypeMagic.OneMoreACT$T)));
...
axiom (forall ArrayTypeMagic.OneMoreACT$T: Ty, 
    ...
    a#47#0#0: ref, 
    $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.OneMoreACT.Leaf(a#47#0#0), 
      Tclass.ArrayTypeMagic.OneMoreACT(ArrayTypeMagic.OneMoreACT$T, ArrayTypeMagic.OneMoreACT$U), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.OneMoreACT.Leaf(a#47#0#0), 
        Tclass.ArrayTypeMagic.OneMoreACT(ArrayTypeMagic.OneMoreACT$T, ArrayTypeMagic.OneMoreACT$U), 
        $h)
       <==> $IsAlloc(a#47#0#0, Tclass._System.array3(ArrayTypeMagic.OneMoreACT$T), $h)));
...
// Constructor literal
axiom (forall a#48#0#0: ref :: 
  { #ArrayTypeMagic.OneMoreACT.Leaf(Lit(a#48#0#0)) } 
  #ArrayTypeMagic.OneMoreACT.Leaf(Lit(a#48#0#0))
     == Lit(#ArrayTypeMagic.OneMoreACT.Leaf(a#48#0#0)));

function ArrayTypeMagic.OneMoreACT._h10(DatatypeType) : ref;

// Constructor injectivity
axiom (forall a#49#0#0: ref :: 
  { #ArrayTypeMagic.OneMoreACT.Leaf(a#49#0#0) } 
  ArrayTypeMagic.OneMoreACT._h10(#ArrayTypeMagic.OneMoreACT.Leaf(a#49#0#0))
     == a#49#0#0);
...
axiom (forall a#50#0#0: DatatypeType, a#50#1#0: DatatypeType :: 
  { #ArrayTypeMagic.OneMoreACT.Node(a#50#0#0, a#50#1#0) } 
  DatatypeCtorId(#ArrayTypeMagic.OneMoreACT.Node(a#50#0#0, a#50#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  ArrayTypeMagic.OneMoreACT.Node_q(d)
     ==> (exists a#51#0#0: DatatypeType, a#51#1#0: DatatypeType :: 
      d == #ArrayTypeMagic.OneMoreACT.Node(a#51#0#0, a#51#1#0)));

// Constructor $Is
axiom (forall ArrayTypeMagic.OneMoreACT$T: Ty, 
    ArrayTypeMagic.OneMoreACT$U: Ty, 
    a#52#0#0: DatatypeType, 
    a#52#1#0: DatatypeType :: 
  { $Is(#ArrayTypeMagic.OneMoreACT.Node(a#52#0#0, a#52#1#0), 
      Tclass.ArrayTypeMagic.OneMoreACT(ArrayTypeMagic.OneMoreACT$T, ArrayTypeMagic.OneMoreACT$U)) } 
  $Is(#ArrayTypeMagic.OneMoreACT.Node(a#52#0#0, a#52#1#0), 
      Tclass.ArrayTypeMagic.OneMoreACT(ArrayTypeMagic.OneMoreACT$T, ArrayTypeMagic.OneMoreACT$U))
     <==> $Is(a#52#0#0, 
...
axiom (forall ArrayTypeMagic.OneMoreACT$T: Ty, 
    ...
    a#53#1#0: DatatypeType, 
    $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.OneMoreACT.Node(a#53#0#0, a#53#1#0), 
      Tclass.ArrayTypeMagic.OneMoreACT(ArrayTypeMagic.OneMoreACT$T, ArrayTypeMagic.OneMoreACT$U), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.OneMoreACT.Node(a#53#0#0, a#53#1#0), 
...
axiom (forall a#54#0#0: DatatypeType, a#54#1#0: DatatypeType :: 
  { #ArrayTypeMagic.OneMoreACT.Node(Lit(a#54#0#0), Lit(a#54#1#0)) } 
  #ArrayTypeMagic.OneMoreACT.Node(Lit(a#54#0#0), Lit(a#54#1#0))
     == Lit(#ArrayTypeMagic.OneMoreACT.Node(a#54#0#0, a#54#1#0)));
...
axiom (forall a#55#0#0: DatatypeType, a#55#1#0: DatatypeType :: 
  { #ArrayTypeMagic.OneMoreACT.Node(a#55#0#0, a#55#1#0) } 
  ArrayTypeMagic.OneMoreACT._h11(#ArrayTypeMagic.OneMoreACT.Node(a#55#0#0, a#55#1#0))
     == a#55#0#0);

// Inductive rank
axiom (forall a#56#0#0: DatatypeType, a#56#1#0: DatatypeType :: 
  { #ArrayTypeMagic.OneMoreACT.Node(a#56#0#0, a#56#1#0) } 
  DtRank(a#56#0#0) < DtRank(#ArrayTypeMagic.OneMoreACT.Node(a#56#0#0, a#56#1#0)));
...
axiom (forall a#57#0#0: DatatypeType, a#57#1#0: DatatypeType :: 
  { #ArrayTypeMagic.OneMoreACT.Node(a#57#0#0, a#57#1#0) } 
  ArrayTypeMagic.OneMoreACT._h12(#ArrayTypeMagic.OneMoreACT.Node(a#57#0#0, a#57#1#0))
     == a#57#1#0);

// Inductive rank
axiom (forall a#58#0#0: DatatypeType, a#58#1#0: DatatypeType :: 
  { #ArrayTypeMagic.OneMoreACT.Node(a#58#0#0, a#58#1#0) } 
  DtRank(a#58#1#0) < DtRank(#ArrayTypeMagic.OneMoreACT.Node(a#58#0#0, a#58#1#0)));
...
axiom (forall a#64#0#0: DatatypeType :: 
  { #ArrayTypeMagic.Nat.Succ(a#64#0#0) } 
  DatatypeCtorId(#ArrayTypeMagic.Nat.Succ(a#64#0#0)) == ##ArrayTypeMagic.Nat.Succ);
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.Nat.Succ_q(d) } 
  ArrayTypeMagic.Nat.Succ_q(d)
     ==> (exists a#65#0#0: DatatypeType :: d == #ArrayTypeMagic.Nat.Succ(a#65#0#0)));

// Constructor $Is
axiom (forall a#66#0#0: DatatypeType :: 
  { $Is(#ArrayTypeMagic.Nat.Succ(a#66#0#0), Tclass.ArrayTypeMagic.Nat()) } 
  $Is(#ArrayTypeMagic.Nat.Succ(a#66#0#0), Tclass.ArrayTypeMagic.Nat())
     <==> $Is(a#66#0#0, Tclass.ArrayTypeMagic.Nat()));

// Constructor $IsAlloc
axiom (forall a#67#0#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.Nat.Succ(a#67#0#0), Tclass.ArrayTypeMagic.Nat(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.Nat.Succ(a#67#0#0), Tclass.ArrayTypeMagic.Nat(), $h)
       <==> $IsAlloc(a#67#0#0, Tclass.ArrayTypeMagic.Nat(), $h)));
...
axiom (forall a#68#0#0: DatatypeType :: 
  { #ArrayTypeMagic.Nat.Succ(Lit(a#68#0#0)) } 
  #ArrayTypeMagic.Nat.Succ(Lit(a#68#0#0))
     == Lit(#ArrayTypeMagic.Nat.Succ(a#68#0#0)));

function ArrayTypeMagic.Nat._h14(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#69#0#0: DatatypeType :: 
  { #ArrayTypeMagic.Nat.Succ(a#69#0#0) } 
  ArrayTypeMagic.Nat._h14(#ArrayTypeMagic.Nat.Succ(a#69#0#0)) == a#69#0#0);

// Inductive rank
axiom (forall a#70#0#0: DatatypeType :: 
  { #ArrayTypeMagic.Nat.Succ(a#70#0#0) } 
  DtRank(a#70#0#0) < DtRank(#ArrayTypeMagic.Nat.Succ(a#70#0#0)));
...
// Constructor identifier
axiom (forall a#76#0#0: Box, a#76#1#0: DatatypeType :: 
  { #ArrayTypeMagic.List.Cons(a#76#0#0, a#76#1#0) } 
  DatatypeCtorId(#ArrayTypeMagic.List.Cons(a#76#0#0, a#76#1#0))
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.List.Cons_q(d) } 
  ArrayTypeMagic.List.Cons_q(d)
     ==> (exists a#77#0#0: Box, a#77#1#0: DatatypeType :: 
      d == #ArrayTypeMagic.List.Cons(a#77#0#0, a#77#1#0)));

// Constructor $Is
axiom (forall ArrayTypeMagic.List$T: Ty, a#78#0#0: Box, a#78#1#0: DatatypeType :: 
  { $Is(#ArrayTypeMagic.List.Cons(a#78#0#0, a#78#1#0), 
      Tclass.ArrayTypeMagic.List(ArrayTypeMagic.List$T)) } 
  $Is(#ArrayTypeMagic.List.Cons(a#78#0#0, a#78#1#0), 
      Tclass.ArrayTypeMagic.List(ArrayTypeMagic.List$T))
     <==> $IsBox(a#78#0#0, ArrayTypeMagic.List$T)
       && $Is(a#78#1#0, Tclass.ArrayTypeMagic.List(ArrayTypeMagic.List$T)));

// Constructor $IsAlloc
axiom (forall ArrayTypeMagic.List$T: Ty, a#79#0#0: Box, a#79#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.List.Cons(a#79#0#0, a#79#1#0), 
      Tclass.ArrayTypeMagic.List(ArrayTypeMagic.List$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.List.Cons(a#79#0#0, a#79#1#0), 
        Tclass.ArrayTypeMagic.List(ArrayTypeMagic.List$T), 
        $h)
       <==> $IsAllocBox(a#79#0#0, ArrayTypeMagic.List$T, $h)
         && $IsAlloc(a#79#1#0, Tclass.ArrayTypeMagic.List(ArrayTypeMagic.List$T), $h)));
...
// Constructor literal
axiom (forall a#80#0#0: Box, a#80#1#0: DatatypeType :: 
  { #ArrayTypeMagic.List.Cons(Lit(a#80#0#0), Lit(a#80#1#0)) } 
  #ArrayTypeMagic.List.Cons(Lit(a#80#0#0), Lit(a#80#1#0))
     == Lit(#ArrayTypeMagic.List.Cons(a#80#0#0, a#80#1#0)));

function ArrayTypeMagic.List._h15(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#81#0#0: Box, a#81#1#0: DatatypeType :: 
  { #ArrayTypeMagic.List.Cons(a#81#0#0, a#81#1#0) } 
  ArrayTypeMagic.List._h15(#ArrayTypeMagic.List.Cons(a#81#0#0, a#81#1#0))
     == a#81#0#0);

// Inductive rank
axiom (forall a#82#0#0: Box, a#82#1#0: DatatypeType :: 
  { #ArrayTypeMagic.List.Cons(a#82#0#0, a#82#1#0) } 
  BoxRank(a#82#0#0) < DtRank(#ArrayTypeMagic.List.Cons(a#82#0#0, a#82#1#0)));

function ArrayTypeMagic.List._h16(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#83#0#0: Box, a#83#1#0: DatatypeType :: 
  { #ArrayTypeMagic.List.Cons(a#83#0#0, a#83#1#0) } 
  ArrayTypeMagic.List._h16(#ArrayTypeMagic.List.Cons(a#83#0#0, a#83#1#0))
     == a#83#1#0);

// Inductive rank
axiom (forall a#84#0#0: Box, a#84#1#0: DatatypeType :: 
  { #ArrayTypeMagic.List.Cons(a#84#0#0, a#84#1#0) } 
  DtRank(a#84#1#0) < DtRank(#ArrayTypeMagic.List.Cons(a#84#0#0, a#84#1#0)));
...
axiom (forall a#85#0#0: Box :: 
  { #ArrayTypeMagic.Cell.Mk(a#85#0#0) } 
  DatatypeCtorId(#ArrayTypeMagic.Cell.Mk(a#85#0#0)) == ##ArrayTypeMagic.Cell.Mk);
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.Cell.Mk_q(d) } 
  ArrayTypeMagic.Cell.Mk_q(d)
     ==> (exists a#86#0#0: Box :: d == #ArrayTypeMagic.Cell.Mk(a#86#0#0)));
...
// Constructor $Is
axiom (forall ArrayTypeMagic.Cell$T: Ty, a#87#0#0: Box :: 
  { $Is(#ArrayTypeMagic.Cell.Mk(a#87#0#0), 
      Tclass.ArrayTypeMagic.Cell(ArrayTypeMagic.Cell$T)) } 
  $Is(#ArrayTypeMagic.Cell.Mk(a#87#0#0), 
      Tclass.ArrayTypeMagic.Cell(ArrayTypeMagic.Cell$T))
     <==> $IsBox(a#87#0#0, ArrayTypeMagic.Cell$T));

// Constructor $IsAlloc
axiom (forall ArrayTypeMagic.Cell$T: Ty, a#88#0#0: Box, $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.Cell.Mk(a#88#0#0), 
      Tclass.ArrayTypeMagic.Cell(ArrayTypeMagic.Cell$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.Cell.Mk(a#88#0#0), 
        Tclass.ArrayTypeMagic.Cell(ArrayTypeMagic.Cell$T), 
        $h)
       <==> $IsAllocBox(a#88#0#0, ArrayTypeMagic.Cell$T, $h)));
...
axiom (forall a#89#0#0: Box :: 
  { #ArrayTypeMagic.Cell.Mk(Lit(a#89#0#0)) } 
  #ArrayTypeMagic.Cell.Mk(Lit(a#89#0#0)) == Lit(#ArrayTypeMagic.Cell.Mk(a#89#0#0)));

function ArrayTypeMagic.Cell._h17(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#90#0#0: Box :: 
  { #ArrayTypeMagic.Cell.Mk(a#90#0#0) } 
  ArrayTypeMagic.Cell._h17(#ArrayTypeMagic.Cell.Mk(a#90#0#0)) == a#90#0#0);

// Inductive rank
axiom (forall a#91#0#0: Box :: 
  { #ArrayTypeMagic.Cell.Mk(a#91#0#0) } 
  BoxRank(a#91#0#0) < DtRank(#ArrayTypeMagic.Cell.Mk(a#91#0#0)));
...
// Constructor identifier
axiom (forall a#92#0#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Nil(a#92#0#0) } 
  DatatypeCtorId(#ArrayTypeMagic.DList.Nil(a#92#0#0))
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.DList.Nil_q(d) } 
  ArrayTypeMagic.DList.Nil_q(d)
     ==> (exists a#93#0#0: DatatypeType :: d == #ArrayTypeMagic.DList.Nil(a#93#0#0)));
...
// Constructor $Is
axiom (forall ArrayTypeMagic.DList$T: Ty, ArrayTypeMagic.DList$U: Ty, a#94#0#0: DatatypeType :: 
  { $Is(#ArrayTypeMagic.DList.Nil(a#94#0#0), 
      Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U)) } 
  $Is(#ArrayTypeMagic.DList.Nil(a#94#0#0), 
      Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U))
     <==> $Is(a#94#0#0, Tclass.ArrayTypeMagic.Cell(ArrayTypeMagic.DList$T)));

// Constructor $IsAlloc
axiom (forall ArrayTypeMagic.DList$T: Ty, 
    ArrayTypeMagic.DList$U: Ty, 
    a#95#0#0: DatatypeType, 
    $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.DList.Nil(a#95#0#0), 
      Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.DList.Nil(a#95#0#0), 
        Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U), 
        $h)
       <==> $IsAlloc(a#95#0#0, Tclass.ArrayTypeMagic.Cell(ArrayTypeMagic.DList$T), $h)));
...
// Constructor literal
axiom (forall a#96#0#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Nil(Lit(a#96#0#0)) } 
  #ArrayTypeMagic.DList.Nil(Lit(a#96#0#0))
     == Lit(#ArrayTypeMagic.DList.Nil(a#96#0#0)));

function ArrayTypeMagic.DList._h18(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#97#0#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Nil(a#97#0#0) } 
  ArrayTypeMagic.DList._h18(#ArrayTypeMagic.DList.Nil(a#97#0#0)) == a#97#0#0);

// Inductive rank
axiom (forall a#98#0#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Nil(a#98#0#0) } 
  DtRank(a#98#0#0) < DtRank(#ArrayTypeMagic.DList.Nil(a#98#0#0)));
...
// Constructor identifier
axiom (forall a#99#0#0: Box, a#99#1#0: Box, a#99#2#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Cons(a#99#0#0, a#99#1#0, a#99#2#0) } 
  DatatypeCtorId(#ArrayTypeMagic.DList.Cons(a#99#0#0, a#99#1#0, a#99#2#0))
...
axiom (forall d: DatatypeType :: 
  { ArrayTypeMagic.DList.Cons_q(d) } 
  ArrayTypeMagic.DList.Cons_q(d)
     ==> (exists a#100#0#0: Box, a#100#1#0: Box, a#100#2#0: DatatypeType :: 
      d == #ArrayTypeMagic.DList.Cons(a#100#0#0, a#100#1#0, a#100#2#0)));
...
axiom (forall ArrayTypeMagic.DList$T: Ty, 
    ...
    a#101#0#0: Box, 
    a#101#1#0: Box, 
    a#101#2#0: DatatypeType :: 
  { $Is(#ArrayTypeMagic.DList.Cons(a#101#0#0, a#101#1#0, a#101#2#0), 
      Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U)) } 
  $Is(#ArrayTypeMagic.DList.Cons(a#101#0#0, a#101#1#0, a#101#2#0), 
      Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U))
     <==> $IsBox(a#101#0#0, ArrayTypeMagic.DList$T)
       && $IsBox(a#101#1#0, ArrayTypeMagic.DList$U)
       && $Is(a#101#2#0, 
        Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U)));
...
axiom (forall ArrayTypeMagic.DList$T: Ty, 
    ...
    a#102#0#0: Box, 
    a#102#1#0: Box, 
    a#102#2#0: DatatypeType, 
    $h: Heap :: 
  { $IsAlloc(#ArrayTypeMagic.DList.Cons(a#102#0#0, a#102#1#0, a#102#2#0), 
      Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ArrayTypeMagic.DList.Cons(a#102#0#0, a#102#1#0, a#102#2#0), 
        Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U), 
        $h)
       <==> $IsAllocBox(a#102#0#0, ArrayTypeMagic.DList$T, $h)
         && $IsAllocBox(a#102#1#0, ArrayTypeMagic.DList$U, $h)
         && $IsAlloc(a#102#2#0, 
          Tclass.ArrayTypeMagic.DList(ArrayTypeMagic.DList$T, ArrayTypeMagic.DList$U), 
          $h)));
...
// Constructor literal
axiom (forall a#103#0#0: Box, a#103#1#0: Box, a#103#2#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Cons(Lit(a#103#0#0), Lit(a#103#1#0), Lit(a#103#2#0)) } 
  #ArrayTypeMagic.DList.Cons(Lit(a#103#0#0), Lit(a#103#1#0), Lit(a#103#2#0))
     == Lit(#ArrayTypeMagic.DList.Cons(a#103#0#0, a#103#1#0, a#103#2#0)));

function ArrayTypeMagic.DList._h19(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#104#0#0: Box, a#104#1#0: Box, a#104#2#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Cons(a#104#0#0, a#104#1#0, a#104#2#0) } 
  ArrayTypeMagic.DList._h19(#ArrayTypeMagic.DList.Cons(a#104#0#0, a#104#1#0, a#104#2#0))
     == a#104#0#0);

// Inductive rank
axiom (forall a#105#0#0: Box, a#105#1#0: Box, a#105#2#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Cons(a#105#0#0, a#105#1#0, a#105#2#0) } 
  BoxRank(a#105#0#0)
     < DtRank(#ArrayTypeMagic.DList.Cons(a#105#0#0, a#105#1#0, a#105#2#0)));

function ArrayTypeMagic.DList._h20(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#106#0#0: Box, a#106#1#0: Box, a#106#2#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Cons(a#106#0#0, a#106#1#0, a#106#2#0) } 
  ArrayTypeMagic.DList._h20(#ArrayTypeMagic.DList.Cons(a#106#0#0, a#106#1#0, a#106#2#0))
     == a#106#1#0);

// Inductive rank
axiom (forall a#107#0#0: Box, a#107#1#0: Box, a#107#2#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Cons(a#107#0#0, a#107#1#0, a#107#2#0) } 
  BoxRank(a#107#1#0)
     < DtRank(#ArrayTypeMagic.DList.Cons(a#107#0#0, a#107#1#0, a#107#2#0)));

function ArrayTypeMagic.DList._h21(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#108#0#0: Box, a#108#1#0: Box, a#108#2#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Cons(a#108#0#0, a#108#1#0, a#108#2#0) } 
  ArrayTypeMagic.DList._h21(#ArrayTypeMagic.DList.Cons(a#108#0#0, a#108#1#0, a#108#2#0))
     == a#108#2#0);

// Inductive rank
axiom (forall a#109#0#0: Box, a#109#1#0: Box, a#109#2#0: DatatypeType :: 
  { #ArrayTypeMagic.DList.Cons(a#109#0#0, a#109#1#0, a#109#2#0) } 
  DtRank(a#109#2#0)
     < DtRank(#ArrayTypeMagic.DList.Cons(a#109#0#0, a#109#1#0, a#109#2#0)));
...
procedure CheckWellformed$$ArrayTypeMagic.__default.M(ArrayTypeMagic._default.M$_T0: Ty, 
    a#0: ref
...
procedure Call$$ArrayTypeMagic.__default.M(ArrayTypeMagic._default.M$_T0: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array2(ArrayTypeMagic._default.M$_T0))
         && $IsAlloc(a#0, Tclass._System.array2(ArrayTypeMagic._default.M$_T0), $Heap));
  modifies $Heap, $Tick;
...
procedure Impl$$ArrayTypeMagic.__default.M(ArrayTypeMagic._default.M$_T0: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array2(ArrayTypeMagic._default.M$_T0))
         && $IsAlloc(a#0, Tclass._System.array2(ArrayTypeMagic._default.M$_T0), $Heap))
...
procedure CheckWellformed$$ArrayTypeMagic.__default.F(ArrayTypeMagic._default.F$_T0: Ty, 
    b#0: ref
...
procedure Call$$ArrayTypeMagic.__default.F(ArrayTypeMagic._default.F$_T0: Ty, 
    b#0: ref
       where $Is(b#0, Tclass._System.array(ArrayTypeMagic._default.F$_T0))
         && $IsAlloc(b#0, Tclass._System.array(ArrayTypeMagic._default.F$_T0), $Heap))
   returns (s#0: Seq Box
...
procedure Impl$$ArrayTypeMagic.__default.F(ArrayTypeMagic._default.F$_T0: Ty, 
    b#0: ref
       where $Is(b#0, Tclass._System.array(ArrayTypeMagic._default.F$_T0))
         && $IsAlloc(b#0, Tclass._System.array(ArrayTypeMagic._default.F$_T0), $Heap))
   returns (s#0: Seq Box
...
implementation Impl$$ArrayTypeMagic.__default.F(ArrayTypeMagic._default.F$_T0: Ty, b#0: ref)
   returns (s#0: Seq Box, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(330,2): initial state"} true;
    $_reverifyPost := false;
    // ----- return statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(331,5)
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(331,5)
    assume true;
    assert b#0 != null;
    assume true;
    s#0 := Seq#FromArray($Heap, b#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(331,16)"} true;
    return;
}
...
procedure CheckWellformed$$ArrayTypeMagic.__default.G(ArrayTypeMagic._default.G$_T0: Ty, 
    t#0: DatatypeType
...
implementation CheckWellformed$$ArrayTypeMagic.__default.G(ArrayTypeMagic._default.G$_T0: Ty, t#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeParameters.dfy(338,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        ...
        if (t#0 == #ArrayTypeMagic.ArrayCubeTree.Leaf(_mcc#0#0))
        {
            ...
            havoc d#Z#0;
            assume $Is(d#Z#0, Tclass._System.array3?(ArrayTypeMagic._default.G$_T0));
            ...
            assert $Is(d#Z#0, Tclass._System.array3(ArrayTypeMagic._default.G$_T0));
            assume ArrayTypeMagic.__default.G(ArrayTypeMagic._default.G$_T0, $LS($LZ), t#0)
               == d#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(ArrayTypeMagic.__default.G(ArrayTypeMagic._default.G$_T0, $LS($LZ), t#0), 
        ...
        else if (t#0 == #ArrayTypeMagic.ArrayCubeTree.Node(_mcc#1#0, _mcc#2#0))
        {
            ...
            havoc l#Z#0;
            assume $Is(l#Z#0, Tclass.ArrayTypeMagic.ArrayCubeTree(ArrayTypeMagic._default.G$_T0));
