// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy -print:./TypeAntecedents.bpl
...
axiom (forall a#14#0#0: Box :: 
  { #_module.Wrapper.Wrap(a#14#0#0) } 
  DatatypeCtorId(#_module.Wrapper.Wrap(a#14#0#0)) == ##_module.Wrapper.Wrap);
...
axiom (forall d: DatatypeType :: 
  { _module.Wrapper.Wrap_q(d) } 
  _module.Wrapper.Wrap_q(d)
     ==> (exists a#15#0#0: Box :: d == #_module.Wrapper.Wrap(a#15#0#0)));
...
// Constructor $Is
axiom (forall _module.Wrapper$T: Ty, a#16#0#0: Box :: 
  { $Is(#_module.Wrapper.Wrap(a#16#0#0), Tclass._module.Wrapper(_module.Wrapper$T)) } 
  $Is(#_module.Wrapper.Wrap(a#16#0#0), Tclass._module.Wrapper(_module.Wrapper$T))
     <==> $IsBox(a#16#0#0, _module.Wrapper$T));

// Constructor $IsAlloc
axiom (forall _module.Wrapper$T: Ty, a#17#0#0: Box, $h: Heap :: 
  { $IsAlloc(#_module.Wrapper.Wrap(a#17#0#0), Tclass._module.Wrapper(_module.Wrapper$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Wrapper.Wrap(a#17#0#0), Tclass._module.Wrapper(_module.Wrapper$T), $h)
       <==> $IsAllocBox(a#17#0#0, _module.Wrapper$T, $h)));
...
axiom (forall a#18#0#0: Box :: 
  { #_module.Wrapper.Wrap(Lit(a#18#0#0)) } 
  #_module.Wrapper.Wrap(Lit(a#18#0#0)) == Lit(#_module.Wrapper.Wrap(a#18#0#0)));

function _module.Wrapper._h0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#19#0#0: Box :: 
  { #_module.Wrapper.Wrap(a#19#0#0) } 
  _module.Wrapper._h0(#_module.Wrapper.Wrap(a#19#0#0)) == a#19#0#0);

// Inductive rank
axiom (forall a#20#0#0: Box :: 
  { #_module.Wrapper.Wrap(a#20#0#0) } 
  BoxRank(a#20#0#0) < DtRank(#_module.Wrapper.Wrap(a#20#0#0)));
...
// Constructor $IsAlloc
axiom (forall $h: Heap :: 
  { $IsAlloc(#_module.Unit.It(), Tclass._module.Unit(), $h) } 
  $IsGoodHeap($h) ==> $IsAlloc(#_module.Unit.It(), Tclass._module.Unit(), $h));
...
axiom (forall a: DatatypeType, b: DatatypeType :: 
  ...
  true ==> (_module.Unit#Equal(a, b) <==> true));
...
// Constructor $IsAlloc
axiom (forall $h: Heap :: 
  { $IsAlloc(#_module.Color.Yellow(), Tclass._module.Color(), $h) } 
  $IsGoodHeap($h)
     ==> $IsAlloc(#_module.Color.Yellow(), Tclass._module.Color(), $h));
...
// consequence axiom for _module.MyClass.H
...
procedure CheckWellformed$$_module.MyClass.H(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.MyClass())
...
// Constructor identifier
axiom (forall a#5#0#0: ref, a#5#1#0: DatatypeType :: 
...
axiom (forall d: DatatypeType :: 
  { _module.List.Cons_q(d) } 
  _module.List.Cons_q(d)
     ==> (exists a#6#0#0: ref, a#6#1#0: DatatypeType :: 
      d == #_module.List.Cons(a#6#0#0, a#6#1#0)));

// Constructor $Is
axiom (forall a#7#0#0: ref, a#7#1#0: DatatypeType :: 
  { $Is(#_module.List.Cons(a#7#0#0, a#7#1#0), Tclass._module.List()) } 
  $Is(#_module.List.Cons(a#7#0#0, a#7#1#0), Tclass._module.List())
     <==> $Is(a#7#0#0, Tclass._module.MyClass?()) && $Is(a#7#1#0, Tclass._module.List()));

// Constructor $IsAlloc
axiom (forall a#8#0#0: ref, a#8#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.List.Cons(a#8#0#0, a#8#1#0), Tclass._module.List(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.List.Cons(a#8#0#0, a#8#1#0), Tclass._module.List(), $h)
       <==> $IsAlloc(a#8#0#0, Tclass._module.MyClass?(), $h)
         && $IsAlloc(a#8#1#0, Tclass._module.List(), $h)));
...
// Constructor injectivity
axiom (forall a#11#0#0: ref, a#11#1#0: DatatypeType :: 
  { #_module.List.Cons(a#11#0#0, a#11#1#0) } 
  _module.List._h2(#_module.List.Cons(a#11#0#0, a#11#1#0)) == a#11#1#0);

// Inductive rank
axiom (forall a#12#0#0: ref, a#12#1#0: DatatypeType :: 
  { #_module.List.Cons(a#12#0#0, a#12#1#0) } 
  DtRank(a#12#1#0) < DtRank(#_module.List.Cons(a#12#0#0, a#12#1#0)));
...
axiom (forall $o: ref, $h: Heap :: 
  ...
  $IsAlloc($o, Tclass._module.State?(), $h) <==> $o == null || read($h, $o, alloc));

axiom FDim(_module.State.a) == 0
   && FieldOfDecl(class._module.State?, field$a) == _module.State.a
   && !$IsGhostField(_module.State.a);

const _module.State.a: Field ref;

// State.a: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { read($h, $o, _module.State.a) } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass._module.State?()
     ==> $Is(read($h, $o, _module.State.a), Tclass._module.MyClass?()));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       ...
       && read($h, $o, alloc)
     ==> $IsAlloc(read($h, $o, _module.State.a), Tclass._module.MyClass?(), $h));
   ...
   ==> (forall $Heap: Heap, this: ref :: 
    ...
    _module.State.NF#canCall($Heap, this)
         || (11 != $FunctionContextHeight
          ...
          $Is(this, Tclass._module.State())
           && $IsAlloc(this, Tclass._module.State(), $Heap))
       ==> _module.State.NF($Heap, this) == read($Heap, this, _module.State.a));

procedure CheckWellformed$$_module.State.NF(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.State())
         && $IsAlloc(this, Tclass._module.State(), $Heap));
...
implementation CheckWellformed$$_module.State.NF(this: ref)
{
  ...
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function NF
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(96,11): initial state"} true;
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> $o == this);
        b$reqreads#0 := $_Frame[this, _module.State.a];
        assume _module.State.NF($Heap, this) == read($Heap, this, _module.State.a);
        assume true;
...
// Constructor $IsAlloc
axiom (forall _module.GenData$T: Ty, a#3#0#0: Box, a#3#1#0: Box, $h: Heap :: 
  { $IsAlloc(#_module.GenData.Pair(a#3#0#0, a#3#1#0), 
      Tclass._module.GenData(_module.GenData$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.GenData.Pair(a#3#0#0, a#3#1#0), 
        Tclass._module.GenData(_module.GenData$T), 
        $h)
       <==> $IsAllocBox(a#3#0#0, _module.GenData$T, $h)
         && $IsAllocBox(a#3#1#0, _module.GenData$T, $h)));
...
// Constructor literal
axiom (forall a#4#0#0: Box, a#4#1#0: Box :: 
  { #_module.GenData.Pair(Lit(a#4#0#0), Lit(a#4#1#0)) } 
  #_module.GenData.Pair(Lit(a#4#0#0), Lit(a#4#1#0))
     == Lit(#_module.GenData.Pair(a#4#0#0, a#4#1#0)));
...
axiom (forall a#5#0#0: Box, a#5#1#0: Box :: 
  ...
  _module.GenData._h3(#_module.GenData.Pair(a#5#0#0, a#5#1#0)) == a#5#0#0);

// Inductive rank
axiom (forall a#6#0#0: Box, a#6#1#0: Box :: 
  { #_module.GenData.Pair(a#6#0#0, a#6#1#0) } 
  BoxRank(a#6#0#0) < DtRank(#_module.GenData.Pair(a#6#0#0, a#6#1#0)));
...
axiom (forall a#7#0#0: Box, a#7#1#0: Box :: 
  ...
  _module.GenData._h4(#_module.GenData.Pair(a#7#0#0, a#7#1#0)) == a#7#1#0);

// Inductive rank
axiom (forall a#8#0#0: Box, a#8#1#0: Box :: 
  { #_module.GenData.Pair(a#8#0#0, a#8#1#0) } 
  BoxRank(a#8#1#0) < DtRank(#_module.GenData.Pair(a#8#0#0, a#8#1#0)));
...
procedure CheckWellformed$$_module.__default.F(a#0: DatatypeType where $Is(a#0, Tclass._module.Wrapper(Tclass._module.Unit())));
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures _module.Wrapper#Equal(a#0, #_module.Wrapper.Wrap($Box(Lit(#_module.Unit.It()))));



implementation CheckWellformed$$_module.__default.F(a#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(10,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        assume _module.Wrapper#Equal(a#0, #_module.Wrapper.Wrap($Box(Lit(#_module.Unit.It()))));
        assume false;
    }
    else
    {
        ...
        if (a#0 == #_module.Wrapper.Wrap($Box(_mcc#0#0)))
        {
            ...
            havoc u#Z#0;
            assume $Is(u#Z#0, Tclass._module.Unit());
            ...
            assume _module.__default.F(a#0) == _module.__default.G(u#Z#0);
            assume _module.__default.G#canCall(u#Z#0);
            // CheckWellformedWithResult: any expression
...
axiom 3 <= $FunctionContextHeight
   ==> (forall u#0: DatatypeType :: 
    ...
    _module.__default.G#canCall(u#0)
         || (3 != $FunctionContextHeight && $Is(u#0, Tclass._module.Unit()))
...
procedure CheckWellformed$$_module.__default.G(u#0: DatatypeType where $Is(u#0, Tclass._module.Unit()));
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures _module.Unit#Equal(u#0, #_module.Unit.It());



implementation CheckWellformed$$_module.__default.G(u#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for function G
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(17,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        assume _module.Unit#Equal(u#0, #_module.Unit.It());
        assume false;
    }
    else
    {
        ...
        {
            assume _module.__default.G(u#0) == Lit(true);
            assume true;
            // CheckWellformedWithResult: any expression
...
procedure CheckWellformed$$_module.__default.BadLemma(c0#0: DatatypeType
...
procedure Call$$_module.__default.BadLemma(c0#0: DatatypeType
       where $Is(c0#0, Tclass._module.Color())
         && $IsAlloc(c0#0, Tclass._module.Color(), $Heap)
         && $IsA#_module.Color(c0#0), 
    c1#0: DatatypeType
  ...
  ensures _module.Color#Equal(c0#0, c1#0);
...
procedure Impl$$_module.__default.BadLemma(c0#0: DatatypeType
       where $Is(c0#0, Tclass._module.Color())
         && $IsAlloc(c0#0, Tclass._module.Color(), $Heap)
         && $IsA#_module.Color(c0#0), 
    c1#0: DatatypeType
...
implementation Impl$$_module.__default.BadLemma(c0#0: DatatypeType, c1#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var w1#0: DatatypeType
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(26,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(27,10)
    assume true;
    assume true;
    w0#0 := #_module.Wrapper.Wrap($Box(c0#0));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(27,28)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(28,10)
    assume true;
    assume true;
    w1#0 := #_module.Wrapper.Wrap($Box(c1#0));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(28,28)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(35,3)
    assume $IsA#_module.Wrapper(w0#0) && $IsA#_module.Wrapper(w1#0);
    assert _module.Wrapper#Equal(w0#0, w1#0);
}
...
implementation Impl$$_module.__default._default_Main() returns ($_reverifyPost: bool)
{
  ...
  var c1##0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(38,14): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(39,11)
    ...
    call Call$$_module.__default.BadLemma(c0##0, c1##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(39,36)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(40,3)
    assume true;
    assert false;
}
...
procedure CheckWellformed$$_module.__default.M(list#0: DatatypeType
...
procedure Call$$_module.__default.M(list#0: DatatypeType
       where $Is(list#0, Tclass._module.List())
         && $IsAlloc(list#0, Tclass._module.List(), $Heap)
         && $IsA#_module.List(list#0), 
    S#0: Set Box
...
procedure Impl$$_module.__default.M(list#0: DatatypeType
       where $Is(list#0, Tclass._module.List())
         && $IsAlloc(list#0, Tclass._module.List(), $Heap)
         && $IsA#_module.List(list#0), 
    S#0: Set Box
...
implementation Impl$$_module.__default.M(list#0: DatatypeType, S#0: Set Box) returns (ret#0: int, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var _mcc#0#0_0: ref;
  ...
  var $rhs##0: ref
     where $Is($rhs##0, Tclass._module.MyClass())
       && $IsAlloc($rhs##0, Tclass._module.MyClass(), $Heap);
  var st#0: ref
     where $Is(st#0, Tclass._module.State())
  ...
  var ##p#0: DatatypeType;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(58,0): initial state"} true;
    $_reverifyPost := false;
    assume true;
    ...
    else if (list#0 == #_module.List.Cons(_mcc#0#0_0, _mcc#1#0_0))
    {
        assume $Is(_mcc#0#0_0, Tclass._module.MyClass?())
           && $IsAlloc(_mcc#0#0_0, Tclass._module.MyClass?(), $Heap);
        ...
        assume r#0_0 == let#0_1#0#0;
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(62,7)
        assume true;
        if (r#0_0 != null)
        {
            // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(63,21)
            assume true;
            assert r#0_0 != null;
            assume _module.MyClass.H#canCall(r#0_0);
            assume _module.MyClass.H#canCall(r#0_0);
            h#0_0_0 := LitInt(_module.MyClass.H(r#0_0));
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(63,28)"} true;
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(64,9)
            assume true;
            assert h#0_0_0 == LitInt(5);
        }
        else
        {
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(66,9)
            assume true;
            assert false;
        }
    }
    ...
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(69,13)
    assume true;
    // TrCallStmt: Adding lhs with type MyClass
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call $rhs##0 := Call$$_module.__default.N();
    // TrCallStmt: After ProcessCallStmt
    k#0 := $rhs##0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(69,14)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(70,3)
    assert {:subsumption 0} k#0 != null;
    assume _module.MyClass.H#canCall(k#0);
    assume _module.MyClass.H#canCall(k#0);
    assert LitInt(_module.MyClass.H(k#0)) == LitInt(5);
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(71,10)
    assume true;
    havoc $nw;
    assume $nw != null && dtype($nw) == Tclass._module.State?();
    assume !read($Heap, $nw, alloc);
    $Heap := update($Heap, $nw, alloc, true);
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    st#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(71,21)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(72,15)
    assume true;
    assert st#0 != null;
    assume _module.State.NF#canCall($Heap, st#0);
    assume _module.State.NF#canCall($Heap, st#0);
    l#0 := _module.State.NF($Heap, st#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(72,24)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(73,3)
    if (l#0 != null)
    {
    ...
    assert {:subsumption 0} l#0 != null ==> LitInt(_module.MyClass.H(l#0)) == LitInt(5);
    assume l#0 != null ==> LitInt(_module.MyClass.H(l#0)) == LitInt(5);
    // ----- forall statement (proof) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(75,3)
    if (*)
    {
        // Assume Fuel Constant
        havoc s#0;
        assume $Is(s#0, Tclass._module.MyClass());
        assume true;
        assume S#0[$Box(s#0)];
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(75,37)
        assert {:subsumption 0} s#0 != null;
        assume _module.MyClass.H#canCall(s#0);
        assume _module.MyClass.H#canCall(s#0);
        assert LitInt(_module.MyClass.H(s#0)) == LitInt(5);
        assert true;
        assume false;
    }
    else
    {
        assume (forall s#1: ref :: 
          { S#0[$Box(s#1)] } 
          $Is(s#1, Tclass._module.MyClass()) && S#0[$Box(s#1)] ==> Lit(true));
    }

    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(75,55)"} true;
    // ----- forall statement (assign) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(76,3)
    if (*)
    {
        // Assume Fuel Constant
        havoc s#2;
        assume $Is(s#2, Tclass._module.MyClass());
        assume true;
        assume S#0[$Box(s#2)];
        assert {:subsumption 0} s#2 != null;
        assume true;
        assert $_Frame[s#2, _module.MyClass.x];
        assume true;
        havoc s#3;
        assume $Is(s#3, Tclass._module.MyClass());
        assume S#0[$Box(s#3)];
        assume s#2 != s#3;
        assert s#2 != s#3 || _module.MyClass.x != _module.MyClass.x || LitInt(0) == LitInt(0);
        assume false;
    }
    else
    {
        ...
        assume (forall<alpha> $o: ref, $f: Field alpha :: 
          ...
          read($Heap, $o, $f) == read($prevHeap, $o, $f)
             || (exists s#4: ref :: 
              $Is(s#4, Tclass._module.MyClass())
                 && S#0[$Box(s#4)]
                 && $o == s#4
                 && $f == _module.MyClass.x));
        assume (forall s#inv#0: ref :: 
          { read($Heap, s#inv#0, _module.MyClass.x) } 
          $Is(s#inv#0, Tclass._module.MyClass()) && s#inv#0 != null && S#0[$Box(s#inv#0)]
             ==> read($Heap, s#inv#0, _module.MyClass.x) == LitInt(0));
    }

    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(78,2)"} true;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(80,3)
    ...
    assert (forall t#1: ref :: 
      { _module.MyClass.H(t#1) } 
      $Is(t#1, Tclass._module.MyClass?())
         ==> t#1 == null || LitInt(_module.MyClass.H(t#1)) == LitInt(5));
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(82,3)
    // Begin Comprehension WF check
    havoc t#2;
    if ($Is(t#2, Tclass._module.MyClass?()))
    {
        if (t#2 != null)
        {
            assert {:subsumption 0} t#2 != null;
            assume _module.MyClass.H#canCall(t#2);
            if (LitInt(_module.MyClass.H(t#2)) == LitInt(5))
            {
            }
            else
            {
                assert {:subsumption 0} LitInt(0) != 0;
            }
        }
    }
    ...
    assert (forall t#3: ref :: 
      { _module.MyClass.H(t#3) } 
      $Is(t#3, Tclass._module.MyClass?())
         ==> 
        t#3 != null
         ==> (if LitInt(_module.MyClass.H(t#3)) == LitInt(5)
           then true
           else LitInt(Div(10, LitInt(0))) == LitInt(3)));
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(84,3)
    ...
    assume _module.__default.TakesADatatype#canCall(Lit(#_module.List.Nil()));
    assert LitInt(_module.__default.TakesADatatype(Lit(#_module.List.Nil()))) == LitInt(12);
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(85,3)
    ...
    assume _module.__default.TakesADatatype#canCall(#_module.List.Cons(null, Lit(#_module.List.Nil())));
    assert _module.__default.TakesADatatype(#_module.List.Cons(null, Lit(#_module.List.Nil())))
       == LitInt(12);
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(86,3)
    ...
    assume _module.__default.AlsoTakesADatatype#canCall(TBool, Lit(#_module.GenData.Pair($Box(Lit(false)), $Box(Lit(true)))));
    assert LitInt(_module.__default.AlsoTakesADatatype(TBool, Lit(#_module.GenData.Pair($Box(Lit(false)), $Box(Lit(true))))))
       == LitInt(17);
}
...
procedure Impl$$_module.__default.N()
...
implementation Impl$$_module.__default.N() returns (defass#k#0: bool, k#0: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $nw: ref;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(90,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(91,5)
    assume true;
    havoc $nw;
    ...
    k#0 := $nw;
    defass#k#0 := true;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/TypeAntecedents.dfy(91,18)"} true;
    assert defass#k#0;
}
...
procedure CheckWellformed$$_module.__default.TakesADatatype(a#0: DatatypeType where $Is(a#0, Tclass._module.List()));
...
// consequence axiom for _module.__default.AlsoTakesADatatype
...
procedure CheckWellformed$$_module.__default.AlsoTakesADatatype(_module._default.AlsoTakesADatatype$U: Ty, 
    p#0: DatatypeType
