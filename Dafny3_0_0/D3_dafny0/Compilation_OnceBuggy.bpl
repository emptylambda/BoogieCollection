...
axiom (forall a#19#0#0: Box, a#19#1#0: DatatypeType :: 
  { #OnceBuggy.MyDt.Cons(a#19#0#0, a#19#1#0) } 
  DatatypeCtorId(#OnceBuggy.MyDt.Cons(a#19#0#0, a#19#1#0))
     == ##OnceBuggy.MyDt.Cons);
...
axiom (forall d: DatatypeType :: 
  ...
  OnceBuggy.MyDt.Cons_q(d)
     ==> (exists a#20#0#0: Box, a#20#1#0: DatatypeType :: 
      d == #OnceBuggy.MyDt.Cons(a#20#0#0, a#20#1#0)));

// Constructor $Is
axiom (forall OnceBuggy.MyDt$T: Ty, a#21#0#0: Box, a#21#1#0: DatatypeType :: 
  { $Is(#OnceBuggy.MyDt.Cons(a#21#0#0, a#21#1#0), 
      Tclass.OnceBuggy.MyDt(OnceBuggy.MyDt$T)) } 
  $Is(#OnceBuggy.MyDt.Cons(a#21#0#0, a#21#1#0), 
      Tclass.OnceBuggy.MyDt(OnceBuggy.MyDt$T))
     <==> $IsBox(a#21#0#0, OnceBuggy.MyDt$T)
       && $Is(a#21#1#0, Tclass.OnceBuggy.MyDt(OnceBuggy.MyDt$T)));

// Constructor $IsAlloc
axiom (forall OnceBuggy.MyDt$T: Ty, a#22#0#0: Box, a#22#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#OnceBuggy.MyDt.Cons(a#22#0#0, a#22#1#0), 
      Tclass.OnceBuggy.MyDt(OnceBuggy.MyDt$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#OnceBuggy.MyDt.Cons(a#22#0#0, a#22#1#0), 
        Tclass.OnceBuggy.MyDt(OnceBuggy.MyDt$T), 
        $h)
       <==> $IsAllocBox(a#22#0#0, OnceBuggy.MyDt$T, $h)
         && $IsAlloc(a#22#1#0, Tclass.OnceBuggy.MyDt(OnceBuggy.MyDt$T), $h)));
...
axiom (forall a#23#0#0: Box, a#23#1#0: DatatypeType :: 
  { #OnceBuggy.MyDt.Cons(Lit(a#23#0#0), Lit(a#23#1#0)) } 
  #OnceBuggy.MyDt.Cons(Lit(a#23#0#0), Lit(a#23#1#0))
     == Lit(#OnceBuggy.MyDt.Cons(a#23#0#0, a#23#1#0)));

function OnceBuggy.MyDt._h0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#24#0#0: Box, a#24#1#0: DatatypeType :: 
  { #OnceBuggy.MyDt.Cons(a#24#0#0, a#24#1#0) } 
  OnceBuggy.MyDt._h0(#OnceBuggy.MyDt.Cons(a#24#0#0, a#24#1#0)) == a#24#0#0);

// Inductive rank
axiom (forall a#25#0#0: Box, a#25#1#0: DatatypeType :: 
  { #OnceBuggy.MyDt.Cons(a#25#0#0, a#25#1#0) } 
  BoxRank(a#25#0#0) < DtRank(#OnceBuggy.MyDt.Cons(a#25#0#0, a#25#1#0)));

function OnceBuggy.MyDt._h1(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#26#0#0: Box, a#26#1#0: DatatypeType :: 
  { #OnceBuggy.MyDt.Cons(a#26#0#0, a#26#1#0) } 
  OnceBuggy.MyDt._h1(#OnceBuggy.MyDt.Cons(a#26#0#0, a#26#1#0)) == a#26#1#0);

// Inductive rank
axiom (forall a#27#0#0: Box, a#27#1#0: DatatypeType :: 
  { #OnceBuggy.MyDt.Cons(a#27#0#0, a#27#1#0) } 
  DtRank(a#27#1#0) < DtRank(#OnceBuggy.MyDt.Cons(a#27#0#0, a#27#1#0)));
...
procedure CheckWellformed$$OnceBuggy.__default.M(OnceBuggy._default.M$U: Ty, 
    x#0: DatatypeType
       where $Is(x#0, Tclass.OnceBuggy.MyDt(TInt))
         && $IsAlloc(x#0, Tclass.OnceBuggy.MyDt(TInt), $Heap)
         && $IsA#OnceBuggy.MyDt(x#0));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$OnceBuggy.__default.M(OnceBuggy._default.M$U: Ty, 
    x#0: DatatypeType
       where $Is(x#0, Tclass.OnceBuggy.MyDt(TInt))
         && $IsAlloc(x#0, Tclass.OnceBuggy.MyDt(TInt), $Heap)
         && $IsA#OnceBuggy.MyDt(x#0));
...
procedure Impl$$OnceBuggy.__default.M(OnceBuggy._default.M$U: Ty, 
    x#0: DatatypeType
       where $Is(x#0, Tclass.OnceBuggy.MyDt(TInt))
         && $IsAlloc(x#0, Tclass.OnceBuggy.MyDt(TInt), $Heap)
         && $IsA#OnceBuggy.MyDt(x#0))
