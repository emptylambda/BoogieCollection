...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/floats_in_memory_fail.c -bpl ./floats_in_memory_fail.bpl
...
const ff2: ref;
axiom (ff2 == $sub.ref(0, 1032));
procedure {:inline 1} ff2($p0: ref, $p1: ref)
{
  var $f2: float;
  var $f3: float;
$bb0:
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 6, 40} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 6, 40} true;
  assume {:verifier.code 0} true;
  $f2 := $load.float($M.0, $p1);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 6, 44} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/floats_in_memory_fail.c:6:44: warning: over-approximating floating-point arithmetic fadd; */
  $f3 := $fadd.float($f2, $fp(2, 0, 0));
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 6, 38} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.float($M.1, $p0, $f3);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 6, 52} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 10, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 10, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.float($M.1, $p0, $fp(0, 0, 0));
  assume true;
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.float($M.0, $p1, $fp(1, 0, 0));
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call ff1($u0);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
  $f2 := $load.float($M.1, $p0);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call ff1($f2);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call ff2($p0, $p1);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $f3 := $load.float($M.1, $p0);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $f4 := $load.float($M.0, $p1);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i5 := (if $foeq.float.bool($f3, $f4) then 1 else 0);
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/floats_in_memory_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const ff1: ref;
axiom (ff1 == $sub.ref(0, 4128));
procedure {:inline 1} ff1($f0: float);
