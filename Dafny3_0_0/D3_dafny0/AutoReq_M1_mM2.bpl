...
axiom 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    M1_mM2.__default.f#canCall(x#0) || (0 != $FunctionContextHeight && x#0 > 3)
       ==> true);
...
axiom 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    M1_mM2.__default.f#canCall(LitInt(x#0))
         || (0 != $FunctionContextHeight && Lit(x#0 > 3))
       ==> M1_mM2.__default.f(LitInt(x#0)) == Lit(x#0 > 7));

procedure CheckWellformed$$M1_mM2.__default.f(x#0: int);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    M1_mM2.__default.h#canCall(y#0) || (1 != $FunctionContextHeight && y#0 > 3)
       ==> true);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    M1_mM2.__default.h#canCall(LitInt(y#0))
...
procedure {:autoReq} CheckWellformed$$M1_mM2.__default.h(y#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$M1_mM2.__default.h(y#0: int)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(220,24): initial state"} true;
    ...
    else
    {
        ...
        assume M1_mM2.__default.f#canCall(y#0);
        assume M1_mM2.__default.h(y#0) == M1_mM2.__default.f(y#0);
        assume M1_mM2.__default.f#canCall(y#0);
        // CheckWellformedWithResult: any expression
        assume $Is(M1_mM2.__default.h(y#0), TBool);
        assert b$reqreads#0;
    }
}
