...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/fmodf_fail.c -bpl ./fmodf_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 17, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 17, 13} true;
  assume {:verifier.code 0} true;
  call $f0 := fmodf($fp(0, 4014666660000000, 140735768232336), $fp(-3, 0, 0));
  call {:cexpr "c"} boogie_si_record_float($f0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $f1 := $fpext.float.float($f0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmodf_fail.c:18:3: warning: over-approximating floating-point arithmetic fsub; */
  $f2 := $fsub.float($f1, $fp(2, 100000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $f3 := $fptrunc.float.float($f2);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmodf_fail.c:18:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f4 := llvm.fabs.f32($f3);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i5 := (if $foeq.float.bool($f4, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 20, 8} true;
  assume {:verifier.code 0} true;
  call $i6 := __isnanf($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 20, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  call $i14 := __isnanf($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $i15 := $ne.i32($i14, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb19, $bb21;
$bb8:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call $f8 := fmodf($fp(0, 7, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call $i9 := __isnanf($f8);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 21, 5} true;
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call $f11 := fmodf($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call $i12 := __isnanf($f11);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 22, 5} true;
...
$bb17:
  ...
  goto $bb16;
$bb18:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb19:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 25, 7} true;
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 30, 8} true;
  assume {:verifier.code 0} true;
  call $i22 := __isnanf($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i23 := $ne.i32($i22, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 30, 20} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i23} true;
  goto $bb32, $bb34;
$bb21:
  assume !(($i15 == 1));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $f16 := fmodf($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $i17 := __isnanf($f16);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $i18 := $ne.i32($i17, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 26, 5} true;
...
$bb25:
  ...
  goto $bb24;
$bb26:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb27:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $f19 := fmodf($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $i20 := __isnanf($f19);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $i21 := $ne.i32($i20, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 27, 5} true;
...
$bb30:
  ...
  goto $bb29;
$bb31:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb32:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 30, 20} true;
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 35, 8} true;
  assume {:verifier.code 0} true;
  call $i30 := __isnanf($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 35, 8} true;
  assume {:verifier.code 0} true;
  $i31 := $ne.i32($i30, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 35, 20} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  goto $bb47, $bb49;
$bb34:
  assume !(($i23 == 1));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 30, 24} true;
  assume {:verifier.code 0} true;
  call $i24 := __isinff($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 30, 24} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.i32($i24, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 30, 7} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i25 == 1));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  goto $bb37;
$bb37:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  call $f26 := fmodf($fp(2, 0, 0), $fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i27 := (if $foeq.float.bool($f26, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
...
$bb40:
  ...
  goto $bb39;
$bb41:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  goto $bb42;
$bb42:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  call $f28 := fmodf($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $i29 := (if $foeq.float.bool($f28, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
...
$bb45:
  ...
  goto $bb44;
$bb46:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb47:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 35, 20} true;
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb67;
$bb49:
  assume !(($i31 == 1));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 35, 24} true;
  assume {:verifier.code 0} true;
  call $i32 := __iszerof($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 35, 24} true;
  assume {:verifier.code 0} true;
  $i33 := $ne.i32($i32, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 35, 7} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume !(($i33 == 1));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
  goto $bb52;
$bb52:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
  call $f34 := fmodf($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i35 := (if $foeq.float.bool($f34, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb54;
$bb56:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 37, 5} true;
  assume {:verifier.code 0} true;
  goto $bb57;
$bb57:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call $f36 := fmodf($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 37, 5} true;
  assume {:verifier.code 0} true;
...
$bb60:
  ...
  goto $bb59;
$bb61:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 38, 28} true;
  assume {:verifier.code 0} true;
  call $f38 := fmodf($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 38, 17} true;
  assume {:verifier.code 0} true;
  call $i39 := __signbitf($f38);
  call {:cexpr "isNeg"} boogie_si_record_i32($i39);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 39, 5} true;
  assume {:verifier.code 0} true;
  goto $bb62;
$bb62:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 39, 5} true;
...
$bb65:
  ...
  goto $bb64;
$bb66:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb48;
$bb67:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $f41 := fmodf($fp(0, 7, 8000000000000), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $i42 := __isnanf($f41);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $i43 := $ne.i32($i42, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 42, 3} true;
...
$bb70:
  ...
  goto $bb69;
$bb71:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb72;
$bb72:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $f44 := fmodf($fp(2, 0, 0), $fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $i45 := __isnanf($f44);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $i46 := $ne.i32($i45, 0);
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 43, 3} true;
...
$bb75:
  ...
  goto $bb74;
$bb76:
  assume {:sourceloc "test/c/mathc/fmodf_fail.c", 45, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const fmodf: ref;
axiom (fmodf == $sub.ref(0, 2064));
procedure {:inline 1} fmodf($f0: float, $f1: float)
  returns ($r: float);
const llvm.fabs.f32: ref;
axiom (llvm.fabs.f32 == $sub.ref(0, 3096));
procedure {:inline 1} llvm.fabs.f32($f0: float)
  returns ($r: float);
const __isnanf: ref;
axiom (__isnanf == $sub.ref(0, 4128));
procedure {:inline 1} __isnanf($f0: float)
  returns ($r: i32);
const __isinff: ref;
axiom (__isinff == $sub.ref(0, 5160));
procedure {:inline 1} __isinff($f0: float)
  returns ($r: i32);
const __iszerof: ref;
axiom (__iszerof == $sub.ref(0, 6192));
procedure {:inline 1} __iszerof($f0: float)
  returns ($r: i32);
const __signbitf: ref;
axiom (__signbitf == $sub.ref(0, 7224));
