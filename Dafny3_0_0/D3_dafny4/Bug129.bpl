// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug129.dfy -print:./Bug129.bpl
...
axiom (forall a#14#0#0: Box :: 
  { #_module.Maybe.Some(a#14#0#0) } 
  DatatypeCtorId(#_module.Maybe.Some(a#14#0#0)) == ##_module.Maybe.Some);
...
axiom (forall d: DatatypeType :: 
  { _module.Maybe.Some_q(d) } 
  _module.Maybe.Some_q(d)
     ==> (exists a#15#0#0: Box :: d == #_module.Maybe.Some(a#15#0#0)));
...
// Constructor $Is
axiom (forall _module.Maybe$T: Ty, a#16#0#0: Box :: 
  { $Is(#_module.Maybe.Some(a#16#0#0), Tclass._module.Maybe(_module.Maybe$T)) } 
  $Is(#_module.Maybe.Some(a#16#0#0), Tclass._module.Maybe(_module.Maybe$T))
     <==> $IsBox(a#16#0#0, _module.Maybe$T));

// Constructor $IsAlloc
axiom (forall _module.Maybe$T: Ty, a#17#0#0: Box, $h: Heap :: 
  { $IsAlloc(#_module.Maybe.Some(a#17#0#0), Tclass._module.Maybe(_module.Maybe$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Maybe.Some(a#17#0#0), Tclass._module.Maybe(_module.Maybe$T), $h)
       <==> $IsAllocBox(a#17#0#0, _module.Maybe$T, $h)));
...
axiom (forall a#18#0#0: Box :: 
  { #_module.Maybe.Some(Lit(a#18#0#0)) } 
  #_module.Maybe.Some(Lit(a#18#0#0)) == Lit(#_module.Maybe.Some(a#18#0#0)));
...
axiom (forall a#19#0#0: Box :: 
  ...
  _module.Maybe.v(#_module.Maybe.Some(a#19#0#0)) == a#19#0#0);

// Inductive rank
axiom (forall a#20#0#0: Box :: 
  { #_module.Maybe.Some(a#20#0#0) } 
  BoxRank(a#20#0#0) < DtRank(#_module.Maybe.Some(a#20#0#0)));
...
axiom (forall d: DatatypeType :: 
  { $IsA#_module.Maybe(d) } 
  $IsA#_module.Maybe(d) ==> _module.Maybe.Some_q(d) || _module.Maybe.None_q(d));
...
axiom (forall _module.Maybe$T: Ty, d: DatatypeType :: 
  ...
  $Is(d, Tclass._module.Maybe(_module.Maybe$T))
     ==> _module.Maybe.Some_q(d) || _module.Maybe.None_q(d));
...
// Constructor function declaration
function #_module.B.B(DatatypeType) : DatatypeType;
...
axiom (forall a#26#0#0: DatatypeType :: 
  ...
  DatatypeCtorId(#_module.B.B(a#26#0#0)) == ##_module.B.B);
...
axiom (forall d: DatatypeType :: 
  { _module.B.B_q(d) } 
  _module.B.B_q(d)
     ==> (exists a#27#0#0: DatatypeType :: d == #_module.B.B(a#27#0#0)));
...
axiom (forall a#28#0#0: DatatypeType :: 
  { $Is(#_module.B.B(a#28#0#0), Tclass._module.B()) } 
  $Is(#_module.B.B(a#28#0#0), Tclass._module.B())
     <==> $Is(a#28#0#0, Tclass._module.Maybe(Tclass._module.B())));

// Constructor $IsAlloc
axiom (forall a#29#0#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.B.B(a#29#0#0), Tclass._module.B(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.B.B(a#29#0#0), Tclass._module.B(), $h)
       <==> $IsAlloc(a#29#0#0, Tclass._module.Maybe(Tclass._module.B()), $h)));

// Destructor $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(_module.B.b(d), Tclass._module.Maybe(Tclass._module.B()), $h) } 
  $IsGoodHeap($h) && _module.B.B_q(d) && $IsAlloc(d, Tclass._module.B(), $h)
     ==> $IsAlloc(_module.B.b(d), Tclass._module.Maybe(Tclass._module.B()), $h));

// Constructor literal
axiom (forall a#30#0#0: DatatypeType :: 
  { #_module.B.B(Lit(a#30#0#0)) } 
  #_module.B.B(Lit(a#30#0#0)) == Lit(#_module.B.B(a#30#0#0)));

function _module.B.b(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#31#0#0: DatatypeType :: 
  { #_module.B.B(a#31#0#0) } 
  _module.B.b(#_module.B.B(a#31#0#0)) == a#31#0#0);

// Inductive rank
axiom (forall a#32#0#0: DatatypeType :: 
  { #_module.B.B(a#32#0#0) } 
  DtRank(a#32#0#0) < DtRank(#_module.B.B(a#32#0#0)));
...
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { _module.B#Equal(a, b) } 
  true
     ==> (_module.B#Equal(a, b) <==> _module.Maybe#Equal(_module.B.b(a), _module.B.b(b))));
...
axiom (forall a#38#0#0: Box, a#38#1#0: DatatypeType :: 
  ...
  DatatypeCtorId(#_module.List.Cons(a#38#0#0, a#38#1#0)) == ##_module.List.Cons);
...
axiom (forall d: DatatypeType :: 
  { _module.List.Cons_q(d) } 
  _module.List.Cons_q(d)
     ==> (exists a#39#0#0: Box, a#39#1#0: DatatypeType :: 
      d == #_module.List.Cons(a#39#0#0, a#39#1#0)));

// Constructor $Is
axiom (forall _module.List$T: Ty, a#40#0#0: Box, a#40#1#0: DatatypeType :: 
  { $Is(#_module.List.Cons(a#40#0#0, a#40#1#0), Tclass._module.List(_module.List$T)) } 
  $Is(#_module.List.Cons(a#40#0#0, a#40#1#0), Tclass._module.List(_module.List$T))
     <==> $IsBox(a#40#0#0, _module.List$T)
       && $Is(a#40#1#0, Tclass._module.List(_module.List$T)));

// Constructor $IsAlloc
axiom (forall _module.List$T: Ty, a#41#0#0: Box, a#41#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.List.Cons(a#41#0#0, a#41#1#0), Tclass._module.List(_module.List$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.List.Cons(a#41#0#0, a#41#1#0), Tclass._module.List(_module.List$T), $h)
       <==> $IsAllocBox(a#41#0#0, _module.List$T, $h)
         && $IsAlloc(a#41#1#0, Tclass._module.List(_module.List$T), $h)));
...
axiom (forall a#42#0#0: Box, a#42#1#0: DatatypeType :: 
  { #_module.List.Cons(Lit(a#42#0#0), Lit(a#42#1#0)) } 
  #_module.List.Cons(Lit(a#42#0#0), Lit(a#42#1#0))
     == Lit(#_module.List.Cons(a#42#0#0, a#42#1#0)));

function _module.List._h0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#43#0#0: Box, a#43#1#0: DatatypeType :: 
  { #_module.List.Cons(a#43#0#0, a#43#1#0) } 
  _module.List._h0(#_module.List.Cons(a#43#0#0, a#43#1#0)) == a#43#0#0);

// Inductive rank
axiom (forall a#44#0#0: Box, a#44#1#0: DatatypeType :: 
  { #_module.List.Cons(a#44#0#0, a#44#1#0) } 
  BoxRank(a#44#0#0) < DtRank(#_module.List.Cons(a#44#0#0, a#44#1#0)));

function _module.List._h1(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#45#0#0: Box, a#45#1#0: DatatypeType :: 
  { #_module.List.Cons(a#45#0#0, a#45#1#0) } 
  _module.List._h1(#_module.List.Cons(a#45#0#0, a#45#1#0)) == a#45#1#0);

// Inductive rank
axiom (forall a#46#0#0: Box, a#46#1#0: DatatypeType :: 
  { #_module.List.Cons(a#46#0#0, a#46#1#0) } 
  DtRank(a#46#1#0) < DtRank(#_module.List.Cons(a#46#0#0, a#46#1#0)));
...
// Constructor function declaration
function #_module.Tree.Nodes(DatatypeType) : DatatypeType;

const unique ##_module.Tree.Nodes: DtCtorId;

// Constructor identifier
axiom (forall a#47#0#0: DatatypeType :: 
  { #_module.Tree.Nodes(a#47#0#0) } 
  DatatypeCtorId(#_module.Tree.Nodes(a#47#0#0)) == ##_module.Tree.Nodes);

function _module.Tree.Nodes_q(DatatypeType) : bool;

// Questionmark and identifier
axiom (forall d: DatatypeType :: 
  { _module.Tree.Nodes_q(d) } 
  _module.Tree.Nodes_q(d) <==> DatatypeCtorId(d) == ##_module.Tree.Nodes);

// Constructor questionmark has arguments
axiom (forall d: DatatypeType :: 
  { _module.Tree.Nodes_q(d) } 
  _module.Tree.Nodes_q(d)
     ==> (exists a#48#0#0: DatatypeType :: d == #_module.Tree.Nodes(a#48#0#0)));
...
// Constructor $Is
axiom (forall _module.Tree$T: Ty, a#49#0#0: DatatypeType :: 
  { $Is(#_module.Tree.Nodes(a#49#0#0), Tclass._module.Tree(_module.Tree$T)) } 
  $Is(#_module.Tree.Nodes(a#49#0#0), Tclass._module.Tree(_module.Tree$T))
     <==> $Is(a#49#0#0, Tclass._module.List(Tclass._module.Tree(_module.Tree$T))));

// Constructor $IsAlloc
axiom (forall _module.Tree$T: Ty, a#50#0#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.Tree.Nodes(a#50#0#0), Tclass._module.Tree(_module.Tree$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Tree.Nodes(a#50#0#0), Tclass._module.Tree(_module.Tree$T), $h)
       <==> $IsAlloc(a#50#0#0, Tclass._module.List(Tclass._module.Tree(_module.Tree$T)), $h)));

// Destructor $IsAlloc
axiom (forall d: DatatypeType, _module.Tree$T: Ty, $h: Heap :: 
  { $IsAlloc(_module.Tree.children(d), 
      Tclass._module.List(Tclass._module.Tree(_module.Tree$T)), 
      $h) } 
  $IsGoodHeap($h)
       && 
      _module.Tree.Nodes_q(d)
...
axiom (forall a#51#0#0: DatatypeType :: 
  { #_module.Tree.Nodes(Lit(a#51#0#0)) } 
  #_module.Tree.Nodes(Lit(a#51#0#0)) == Lit(#_module.Tree.Nodes(a#51#0#0)));

function _module.Tree.children(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#52#0#0: DatatypeType :: 
  { #_module.Tree.Nodes(a#52#0#0) } 
  _module.Tree.children(#_module.Tree.Nodes(a#52#0#0)) == a#52#0#0);

// Inductive rank
axiom (forall a#53#0#0: DatatypeType :: 
  { #_module.Tree.Nodes(a#53#0#0) } 
  DtRank(a#53#0#0) < DtRank(#_module.Tree.Nodes(a#53#0#0)));
...
axiom (forall d: DatatypeType :: 
  { $IsA#_module.Tree(d) } 
  $IsA#_module.Tree(d) ==> _module.Tree.Nodes_q(d));

// Questionmark data type disjunctivity
axiom (forall _module.Tree$T: Ty, d: DatatypeType :: 
  { _module.Tree.Nodes_q(d), $Is(d, Tclass._module.Tree(_module.Tree$T)) } 
  $Is(d, Tclass._module.Tree(_module.Tree$T)) ==> _module.Tree.Nodes_q(d));

// Datatype extensional equality declaration
function _module.Tree#Equal(DatatypeType, DatatypeType) : bool;

// Datatype extensional equality definition: #_module.Tree.Nodes
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { _module.Tree#Equal(a, b) } 
  true
     ==> (_module.Tree#Equal(a, b)
       <==> _module.List#Equal(_module.Tree.children(a), _module.Tree.children(b))));
