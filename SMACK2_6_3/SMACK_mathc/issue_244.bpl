...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/issue_244.c -bpl ./issue_244.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/issue_244.c", 7, 18} true;
...
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/mathc/issue_244.c", 7, 59} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
