...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/bitcast_fail.c -bpl ./bitcast_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/bitcast_fail.c", 7, 7} true;
  ...
  assume {:sourceloc "test/c/float/bitcast_fail.c", 7, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, 2);
  assume true;
  assume {:sourceloc "test/c/float/bitcast_fail.c", 8, 13} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/float/bitcast_fail.c", 8, 13} true;
  assume {:verifier.code 0} true;
  $f3 := $load.unsafe.float($M.0, $p2);
  assume {:sourceloc "test/c/float/bitcast_fail.c", 8, 9} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.unsafe.float($M.1, $p1, $f3);
  assume {:sourceloc "test/c/float/bitcast_fail.c", 9, 12} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/float/bitcast_fail.c", 9, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.1, $p4);
  call {:cexpr "i1"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/float/bitcast_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/bitcast_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/bitcast_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
