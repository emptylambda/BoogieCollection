...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/join_null_retval.c -bpl ./join_null_retval.bpl
...
{
$bb0:
  assume {:sourceloc "test/c/pthread/join_null_retval.c", 8, 23} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/join_null_retval.c", 12, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join_null_retval.c", 13, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p0);
  assume {:sourceloc "test/c/pthread/join_null_retval.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $0.ref);
  assume {:sourceloc "test/c/pthread/join_null_retval.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
