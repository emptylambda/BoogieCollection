...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/array2_free_fail.c -bpl ./array2_free_fail.bpl
...
axiom (freeMemory == $sub.ref(0, 1032));
procedure {:inline 1} freeMemory($p0: ref)
{
  var $p1: ref;
$bb0:
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 6, 38} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 6, 38} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 6, 33} true;
  assume {:verifier.code 0} true;
  call free_($p1);
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 6, 48} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 9, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call freeMemory($p1);
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 12, 7} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(9, 4));
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 12, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, $p2);
  call {:cexpr "b"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/memory-safety/array2_free_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
