...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/modfl_fail.c -bpl ./modfl_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 12, 19} true;
  assume {:verifier.code 1} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(10, $zext.i32.i64(1)));
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 12, 19} true;
  assume {:verifier.code 1} true;
  call $f1 := __VERIFIER_nondet_long_double();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long_double"} boogie_si_record_float($f1);
  call {:cexpr "x"} boogie_si_record_float($f1);
  assume true;
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  call $i2 := __isnanl($f1);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 20} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 26, 11} true;
  assume {:verifier.code 0} true;
  call $f16 := modfl($fp(0, 0, 139798533235056), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f16);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 24} true;
  assume {:verifier.code 0} true;
  call $i4 := __isinfl($f1);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 24} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 36} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 40} true;
  assume {:verifier.code 0} true;
  call $i6 := __iszerol($f1);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 40} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 16, 13} true;
  assume {:verifier.code 0} true;
  call $f8 := modfl($f1, $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f8);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 17, 11} true;
  assume {:verifier.code 0} true;
  $i9 := (if $folt.float.bool($f1, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 17, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i9} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i9 == 1);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb10:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
  $f10 := $load.float($M.0, $p0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
  $i11 := (if $fole.float.bool($f1, $f10) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 18, 7} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb12;
$bb14:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
  $i12 := (if $fole.float.bool($f1, $f8) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb17;
$bb19:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 20, 5} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb21:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $f13 := $load.float($M.0, $p0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i14 := (if $fogt.float.bool($f1, $f13) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 21, 7} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 22, 7} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i15 := (if $fogt.float.bool($f1, $f8) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 22, 7} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $f17 := $load.float($M.0, $p0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i18 := (if $foeq.float.bool($f17, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb32:
  ...
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i19 := (if $foeq.float.bool($f16, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb37:
  ...
  goto $bb34;
$bb38:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 29, 11} true;
  assume {:verifier.code 0} true;
  call $f20 := modfl($fp(0, 0, 48), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f20);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb39;
$bb39:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $f21 := $load.float($M.0, $p0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
...
$bb40:
  ...
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $i23 := (if $foeq.float.bool($f20, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
...
$bb45:
  ...
  goto $bb42;
$bb46:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 32, 11} true;
  assume {:verifier.code 0} true;
  call $f24 := modfl($fp(0, 0, 48), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f24);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb47;
$bb47:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $f25 := $load.float($M.0, $p0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $i26 := (if $foeq.float.bool($f25, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb48:
  ...
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $i27 := (if $foeq.float.bool($f24, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
...
$bb53:
  ...
  goto $bb50;
$bb54:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 35, 11} true;
  assume {:verifier.code 0} true;
  call $f28 := modfl($fp(0, 0, 48), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f28);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  goto $bb55;
$bb55:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $f29 := $load.float($M.0, $p0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $i30 := (if $foeq.float.bool($f29, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
...
$bb56:
  ...
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $i31 := (if $foeq.float.bool($f28, $fp(0, 0, 4413253)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
...
$bb61:
  ...
  goto $bb58;
$bb62:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 38, 11} true;
  assume {:verifier.code 0} true;
  call $f32 := modfl($fp(0, 0, 48), $p0);
  call {:cexpr "fPart"} boogie_si_record_float($f32);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb63;
$bb63:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $f33 := $load.float($M.0, $p0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  call $i34 := __isnanl($f33);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $i35 := $ne.i32($i34, 0);
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 39, 3} true;
...
$bb69:
  ...
  goto $bb66;
$bb70:
  assume {:sourceloc "test/c/mathc/modfl_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure {:inline 1} __iszerol($f0: float)
  returns ($r: i32);
const modfl: ref;
axiom (modfl == $sub.ref(0, 7224));
procedure {:inline 1} modfl($f0: float, $p1: ref)
  returns ($r: float);
