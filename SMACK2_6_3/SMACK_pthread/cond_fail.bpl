...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/cond_fail.c -bpl ./cond_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/cond_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/cond_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread/cond_fail.c", 16, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/cond_fail.c", 17, 15} true;
  assume {:verifier.code 0} true;
  $M.1 := 1;
  call {:cexpr "thread1Done"} boogie_si_record_i32(1);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_cond_signal(cond);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/cond_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/cond_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_cond_wait(cond, lock);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/cond_fail.c", 27, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/cond_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/cond_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/cond_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_init(lock, $0.ref);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/cond_fail.c", 37, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/cond_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_create($p0, $0.ref, j1, $0.ref);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_create($p1, $0.ref, j2, $0.ref);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 40, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.3, $p0);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 41, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.4, $p1);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "test/c/pthread/cond_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
