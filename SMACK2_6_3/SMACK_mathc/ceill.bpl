...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/ceill.c -bpl ./ceill.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/ceill.c", 11, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/mathc/ceill.c", 11, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:11:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f0 := llvm.ceil.f80($fp(0, 0, 139729350533108));
  assume {:sourceloc "test/c/mathc/ceill.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i1 := (if $foeq.float.bool($f0, $fp(0, 0, 140731537321040)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 11, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/ceill.c", 13, 21} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 8} true;
  assume {:verifier.code 0} true;
  call $i3 := __isnanl($f2);
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 22} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/mathc/ceill.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb8:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 26} true;
  assume {:verifier.code 0} true;
  call $i5 := __isinfl($f2);
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 26} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 40} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 44} true;
  assume {:verifier.code 0} true;
  call $i7 := __iszerol($f2);
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 44} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 15, 7} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i8 == 1));
  assume {:sourceloc "test/c/mathc/ceill.c", 16, 5} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "test/c/mathc/ceill.c", 16, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:16:5: warning: over-approximating call to llvm.ceil.f80; */
  call $f9 := llvm.ceil.f80($f2);
  assume {:sourceloc "test/c/mathc/ceill.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $i10 := (if $foge.float.bool($f9, $f2) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 16, 5} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb15;
$bb17:
  assume {:sourceloc "test/c/mathc/ceill.c", 17, 5} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb18:
  assume {:sourceloc "test/c/mathc/ceill.c", 17, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:17:5: warning: over-approximating call to llvm.ceil.f80; */
  call $f11 := llvm.ceil.f80($f2);
  assume {:sourceloc "test/c/mathc/ceill.c", 17, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:17:5: warning: over-approximating floating-point arithmetic fadd; */
  $f12 := $fadd.float($f2, $fp(0, 0, 5193739));
  assume {:sourceloc "test/c/mathc/ceill.c", 17, 5} true;
  assume {:verifier.code 0} true;
  $i13 := (if $fole.float.bool($f11, $f12) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 17, 5} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  goto $bb20;
$bb22:
  assume {:sourceloc "test/c/mathc/ceill.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb23:
  assume {:sourceloc "test/c/mathc/ceill.c", 20, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:20:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f14 := llvm.ceil.f80($fp(0, 0, 139729357839236));
  assume {:sourceloc "test/c/mathc/ceill.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i15 := (if $foeq.float.bool($f14, $fp(0, 0, 14893552)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb25;
$bb27:
  assume {:sourceloc "test/c/mathc/ceill.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb28:
  assume {:sourceloc "test/c/mathc/ceill.c", 21, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:21:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f16 := llvm.ceil.f80($fp(0, 0, 139729357839236));
  assume {:sourceloc "test/c/mathc/ceill.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i17 := (if $foeq.float.bool($f16, $fp(0, 0, 15282176)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb31:
  ...
  goto $bb30;
$bb32:
  assume {:sourceloc "test/c/mathc/ceill.c", 22, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:22:26: warning: over-approximating call to llvm.ceil.f80; */
  call $f18 := llvm.ceil.f80($fp(0, 0, 139729357839236));
  assume {:sourceloc "test/c/mathc/ceill.c", 22, 15} true;
  assume {:verifier.code 0} true;
  call $i19 := __signbitl($f18);
  call {:cexpr "isNeg"} boogie_si_record_i32($i19);
  assume {:sourceloc "test/c/mathc/ceill.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/mathc/ceill.c", 23, 3} true;
...
$bb36:
  ...
  goto $bb35;
$bb37:
  assume {:sourceloc "test/c/mathc/ceill.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb38:
  assume {:sourceloc "test/c/mathc/ceill.c", 25, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:25:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f21 := llvm.ceil.f80($fp(0, 0, 139729357839236));
  assume {:sourceloc "test/c/mathc/ceill.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(0, 0, 14784656)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 25, 3} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb40;
$bb42:
  assume {:sourceloc "test/c/mathc/ceill.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb43:
  assume {:sourceloc "test/c/mathc/ceill.c", 26, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:26:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f23 := llvm.ceil.f80($fp(0, 0, 139729357839236));
  assume {:sourceloc "test/c/mathc/ceill.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $i24 := (if $foeq.float.bool($f23, $fp(0, 0, 15106400)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/ceill.c", 26, 3} true;
  assume {:verifier.code 0} true;
...
$bb46:
  ...
  goto $bb45;
$bb47:
  assume {:sourceloc "test/c/mathc/ceill.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb48;
$bb48:
  assume {:sourceloc "test/c/mathc/ceill.c", 28, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/ceill.c:28:3: warning: over-approximating call to llvm.ceil.f80; */
  call $f25 := llvm.ceil.f80($fp(0, 0, 139729357839236));
  assume {:sourceloc "test/c/mathc/ceill.c", 28, 3} true;
  assume {:verifier.code 0} true;
...
$bb51:
  ...
  goto $bb50;
$bb52:
  assume {:sourceloc "test/c/mathc/ceill.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.ceil.f80 == $sub.ref(0, 2064));
