...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/smack_code_annot_fail.c -bpl ./smack_code_annot_fail.bpl
...
const u16_to_u32: ref;
axiom (u16_to_u32 == $sub.ref(0, 1032));
procedure {:inline 1} u16_to_u32($i0: i16)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 10, 13} true;
  assume {:verifier.code 1} true;
  call {:cexpr "u16_to_u32:arg:x"} boogie_si_record_i16($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 10, 13} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 11, 51} true;
  assume {:verifier.code 1} true;
  $i2 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 11, 3} true;
  assume {:verifier.code 1} true;
  $i1 := $zext.bv16.bv32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 12, 3} true;
...
procedure {:inline 1} __SMACK_code.ref.i32.i32($p0: ref, p.1: i32, p.2: i32);
const u8_to_u32: ref;
axiom (u8_to_u32 == $sub.ref(0, 3096));
procedure {:inline 1} u8_to_u32($i0: i8)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 16, 13} true;
  assume {:verifier.code 1} true;
  call {:cexpr "u8_to_u32:arg:x"} boogie_si_record_i8($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 16, 13} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_unsigned_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_int"} boogie_si_record_i32($i1);
  call {:cexpr "ret"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 17, 50} true;
  assume {:verifier.code 1} true;
  $i2 := $zext.i8.i32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 17, 3} true;
  assume {:verifier.code 1} true;
  $i1 := $zext.bv8.bv32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
const u16_id: ref;
axiom (u16_id == $sub.ref(0, 4128));
procedure {:inline 1} u16_id($i0: i16)
  returns ($r: i16)
{
  var $i1: i16;
  var $i2: i32;
  var $i3: i32;
$bb0:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 22, 13} true;
  assume {:verifier.code 1} true;
  call {:cexpr "u16_id:arg:x"} boogie_si_record_i16($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 22, 13} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_unsigned_short();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_short"} boogie_si_record_i16($i1);
  call {:cexpr "ret"} boogie_si_record_i16($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 23, 29} true;
  assume {:verifier.code 1} true;
  $i2 := $zext.i16.i32($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 23, 34} true;
  assume {:verifier.code 1} true;
  $i3 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 23, 3} true;
  assume {:verifier.code 1} true;
  $i1 := $i0;
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
const u8_id: ref;
axiom (u8_id == $sub.ref(0, 5160));
procedure {:inline 1} u8_id($i0: i8)
  returns ($r: i8)
{
  var $i1: i8;
  var $i2: i32;
  var $i3: i32;
$bb0:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 28, 12} true;
  assume {:verifier.code 1} true;
  call {:cexpr "u8_id:arg:x"} boogie_si_record_i8($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 28, 12} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_unsigned_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_char"} boogie_si_record_i8($i1);
  call {:cexpr "ret"} boogie_si_record_i8($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 29, 29} true;
  assume {:verifier.code 1} true;
  $i2 := $zext.i8.i32($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 29, 34} true;
  assume {:verifier.code 1} true;
  $i3 := $zext.i8.i32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 29, 3} true;
  assume {:verifier.code 1} true;
  $i1 := $i0;
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 34, 11} true;
  assume {:verifier.code 1} true;
  ...
  call {:cexpr "x8"} boogie_si_record_i8($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 35, 11} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_unsigned_char();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_char"} boogie_si_record_i8($i1);
  call {:cexpr "y8"} boogie_si_record_i8($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 36, 13} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_unsigned_short();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_short"} boogie_si_record_i16($i2);
  call {:cexpr "x16"} boogie_si_record_i16($i2);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 37, 13} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_unsigned_short();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_short"} boogie_si_record_i16($i3);
  call {:cexpr "y16"} boogie_si_record_i16($i3);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 38, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 39, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := u8_to_u32($i0);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := u8_to_u32($i1);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  $i16 := $ult.i32($i14, $i15);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 40, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call $i17 := u16_to_u32($i2);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call $i18 := u16_to_u32($i3);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  $i19 := $ugt.i32($i17, $i18);
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 41, 3} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/bits/smack_code_annot_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.dbg.value == $sub.ref(0, 28896));
