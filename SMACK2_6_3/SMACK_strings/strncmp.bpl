...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strncmp.c -bpl ./strncmp.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strncmp.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strncmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/strings/strncmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := strncmp(.str, .str.1, 3);
  assume {:sourceloc "test/c/strings/strncmp.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, 0);
  assume {:sourceloc "test/c/strings/strncmp.c", 11, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/strings/strncmp.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
