...
axiom (forall a#14#0#0: int :: 
  { #LetPatterns.MyDt.AAA(a#14#0#0) } 
  DatatypeCtorId(#LetPatterns.MyDt.AAA(a#14#0#0)) == ##LetPatterns.MyDt.AAA);
...
axiom (forall d: DatatypeType :: 
  { LetPatterns.MyDt.AAA_q(d) } 
  LetPatterns.MyDt.AAA_q(d)
     ==> (exists a#15#0#0: int :: d == #LetPatterns.MyDt.AAA(a#15#0#0)));
...
axiom (forall a#16#0#0: int :: 
  { $Is(#LetPatterns.MyDt.AAA(a#16#0#0), Tclass.LetPatterns.MyDt()) } 
  $Is(#LetPatterns.MyDt.AAA(a#16#0#0), Tclass.LetPatterns.MyDt())
     <==> $Is(a#16#0#0, TInt));

// Constructor $IsAlloc
axiom (forall a#17#0#0: int, $h: Heap :: 
  { $IsAlloc(#LetPatterns.MyDt.AAA(a#17#0#0), Tclass.LetPatterns.MyDt(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#LetPatterns.MyDt.AAA(a#17#0#0), Tclass.LetPatterns.MyDt(), $h)
...
axiom (forall a#18#0#0: int :: 
  { #LetPatterns.MyDt.AAA(LitInt(a#18#0#0)) } 
  #LetPatterns.MyDt.AAA(LitInt(a#18#0#0)) == Lit(#LetPatterns.MyDt.AAA(a#18#0#0)));

function LetPatterns.MyDt.x(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#19#0#0: int :: 
  { #LetPatterns.MyDt.AAA(a#19#0#0) } 
  LetPatterns.MyDt.x(#LetPatterns.MyDt.AAA(a#19#0#0)) == a#19#0#0);
...
axiom (forall a#20#0#0: int :: 
  { #LetPatterns.MyDt.BBB(a#20#0#0) } 
  DatatypeCtorId(#LetPatterns.MyDt.BBB(a#20#0#0)) == ##LetPatterns.MyDt.BBB);
...
axiom (forall d: DatatypeType :: 
  { LetPatterns.MyDt.BBB_q(d) } 
  LetPatterns.MyDt.BBB_q(d)
     ==> (exists a#21#0#0: int :: d == #LetPatterns.MyDt.BBB(a#21#0#0)));

// Constructor $Is
axiom (forall a#22#0#0: int :: 
  { $Is(#LetPatterns.MyDt.BBB(a#22#0#0), Tclass.LetPatterns.MyDt()) } 
  $Is(#LetPatterns.MyDt.BBB(a#22#0#0), Tclass.LetPatterns.MyDt())
     <==> $Is(a#22#0#0, TInt));

// Constructor $IsAlloc
axiom (forall a#23#0#0: int, $h: Heap :: 
  { $IsAlloc(#LetPatterns.MyDt.BBB(a#23#0#0), Tclass.LetPatterns.MyDt(), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#LetPatterns.MyDt.BBB(a#23#0#0), Tclass.LetPatterns.MyDt(), $h)
...
axiom (forall a#24#0#0: int :: 
  { #LetPatterns.MyDt.BBB(LitInt(a#24#0#0)) } 
  #LetPatterns.MyDt.BBB(LitInt(a#24#0#0)) == Lit(#LetPatterns.MyDt.BBB(a#24#0#0)));

function LetPatterns.MyDt.y(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#25#0#0: int :: 
  { #LetPatterns.MyDt.BBB(a#25#0#0) } 
  LetPatterns.MyDt.y(#LetPatterns.MyDt.BBB(a#25#0#0)) == a#25#0#0);
   ...
   ==> (forall m#0: DatatypeType :: 
    ...
    LetPatterns.__default.M#canCall(m#0)
         || (1 != $FunctionContextHeight
          ...
          $Is(m#0, Tclass.LetPatterns.MyDt())
           && LetPatterns.MyDt.AAA_q(m#0))
       ==> LetPatterns.__default.M(m#0) == (var u#0 := LetPatterns.MyDt.x(m#0); u#0));
   ...
   ==> (forall m#0: DatatypeType :: 
    ...
    LetPatterns.__default.M#canCall(Lit(m#0))
         || (1 != $FunctionContextHeight
           && 
          $Is(m#0, Tclass.LetPatterns.MyDt())
           && Lit(LetPatterns.MyDt.AAA_q(Lit(m#0))))
       ==> LetPatterns.__default.M(Lit(m#0))
         == (var u#1 := LetPatterns.MyDt.x(Lit(m#0)); u#1));

procedure CheckWellformed$$LetPatterns.__default.M(m#0: DatatypeType where $Is(m#0, Tclass.LetPatterns.MyDt()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$LetPatterns.__default.M(m#0: DatatypeType)
{
  ...
  var let#0#0#0: DatatypeType;
    ...
    // AddWellformednessCheck for function M
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(366,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume LetPatterns.MyDt.AAA_q(m#0);
    if (*)
    {
        assume false;
    }
    else
    {
        ...
        havoc u#Z#0;
        assume true;
        assume let#0#0#0 == m#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, Tclass.LetPatterns.MyDt());
        assert LetPatterns.MyDt.AAA_q(let#0#0#0);
        assume #LetPatterns.MyDt.AAA(u#Z#0) == let#0#0#0;
        assume LetPatterns.__default.M(m#0) == u#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(LetPatterns.__default.M(m#0), TInt);
    }
}



procedure CheckWellformed$$LetPatterns.__default.P();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$LetPatterns.__default.P();
  modifies $Heap, $Tick;
...
procedure Impl$$LetPatterns.__default.P() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$LetPatterns.__default.P() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var v#0: int;
  var m#0: DatatypeType
     where $Is(m#0, Tclass.LetPatterns.MyDt())
       && $IsAlloc(m#0, Tclass.LetPatterns.MyDt(), $Heap);
  var w#0: int;
  var u#Z#0: int;
  var let#0#0#0: DatatypeType;

    // AddMethodImpl: P, Impl$$LetPatterns.__default.P
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(374,2): initial state"} true;
    $_reverifyPost := false;
    havoc v#0;
    havoc m#0 /* where $Is(m#0, Tclass.LetPatterns.MyDt())
       && $IsAlloc(m#0, Tclass.LetPatterns.MyDt(), $Heap) */;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(377,11)
    assume true;
    havoc u#Z#0;
    assume true;
    assume let#0#0#0 == m#0;
    ...
    assume #LetPatterns.MyDt.AAA(u#Z#0) == let#0#0#0;
    assume true;
    w#0 := v#0 + (var u#0 := LetPatterns.MyDt.x(m#0); u#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(377,35)"} true;
}
