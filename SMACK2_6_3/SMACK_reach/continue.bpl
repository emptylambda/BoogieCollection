...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/continue.c -bpl ./continue.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/continue.c", 5, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/reach/continue.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/continue.c", 5, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $ne.i32($i0, 5);
  assume {:sourceloc "test/c/reach/continue.c", 5, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/reach/continue.c", 6, 6} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, 1);
  call {:cexpr "a"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/reach/continue.c", 7, 5} true;
  assume {:verifier.code 0} true;
  $i0 := $i2;
  goto $bb1;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/reach/continue.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
