...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/test_sourceloc_fail.c -bpl ./test_sourceloc_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 11, 7} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 12, 16} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(4);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 12, 9} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 12, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $p2;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p4);
  call {:cexpr "ret"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 17, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call free_($p6);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
