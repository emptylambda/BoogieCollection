...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strcpy_overflow.c -bpl ./strcpy_overflow.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 21669));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strcpy_overflow.c", 10, 10} true;
  ...
  assume {:sourceloc "test/c/strings/strcpy_overflow.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 2)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/strcpy_overflow.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $p2 := strcpy($p1, .str);
  assume $isExternal($p2);
  assume {:sourceloc "test/c/strings/strcpy_overflow.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strcpy: ref;
axiom (strcpy == $sub.ref(0, 4125));
procedure {:inline 1} strcpy($p0: ref, $p1: ref)
  returns ($r: ref);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 5157));
...
axiom (__SMACK_dummy == $sub.ref(0, 7221));
...
axiom (__SMACK_and32 == $sub.ref(0, 8253));
...
axiom (__SMACK_and64 == $sub.ref(0, 9285));
...
axiom (__SMACK_and16 == $sub.ref(0, 10317));
...
axiom (__SMACK_and8 == $sub.ref(0, 11349));
...
axiom (__SMACK_or32 == $sub.ref(0, 12381));
...
axiom (__SMACK_or64 == $sub.ref(0, 13413));
...
axiom (__SMACK_or16 == $sub.ref(0, 14445));
...
axiom (__SMACK_or8 == $sub.ref(0, 15477));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 16509));
...
axiom (__SMACK_decls == $sub.ref(0, 17541));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 18573));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 19605));
...
axiom (llvm.dbg.value == $sub.ref(0, 20637));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 21669));
