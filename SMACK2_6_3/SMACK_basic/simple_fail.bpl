...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/simple_fail.c -bpl ./simple_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/simple_fail.c", 12, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/basic/simple_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i0 := $ne.i32($sub.i32(0, 1), $sub.i32(0, 1));
  assume {:sourceloc "test/c/basic/simple_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/simple_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := $sub.i32(0, 1);
  $exn := false;
  return;
