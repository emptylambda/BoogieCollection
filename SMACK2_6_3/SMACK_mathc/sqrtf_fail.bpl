...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/sqrtf_fail.c -bpl ./sqrtf_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 15, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call $f0 := sqrtf($fp(4, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrtf_fail.c:15:3: warning: over-approximating floating-point arithmetic fsub; */
  $f1 := $fsub.float($fp(2, 0, 0), $f0);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrtf_fail.c:15:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f2 := llvm.fabs.f32($f1);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $f3 := $fpext.float.float($f2);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i4 := (if $folt.float.bool($f3, $fp(1, 0, 8)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $f5 := sqrtf($fp(0, 3, 0));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrtf_fail.c:16:3: warning: over-approximating floating-point arithmetic fsub; */
  $f6 := $fsub.float($fp(0, 3, 5555560000000), $f5);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrtf_fail.c:16:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f7 := llvm.fabs.f32($f6);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $f8 := $fpext.float.float($f7);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i9 := (if $folt.float.bool($f8, $fp(1, 0, 8)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call $f10 := sqrtf($fp(-1, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call $f13 := sqrtf($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call $f15 := sqrtf($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 21, 26} true;
  assume {:verifier.code 0} true;
  call $f17 := sqrtf($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 21, 15} true;
  assume {:verifier.code 0} true;
  call $i18 := __signbitf($f17);
  call {:cexpr "isNeg"} boogie_si_record_i32($i18);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 22, 3} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $f20 := sqrtf($fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $f22 := sqrtf($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $i23 := __isnanf($f22);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i23, 0);
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 25, 3} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $f25 := sqrtf($fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/sqrtf_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const sqrtf: ref;
axiom (sqrtf == $sub.ref(0, 2064));
procedure {:inline 1} sqrtf($f0: float)
  returns ($r: float);
...
axiom (__signbitf == $sub.ref(0, 5160));
