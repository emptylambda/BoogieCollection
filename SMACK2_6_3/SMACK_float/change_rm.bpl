...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/change_rm.c -bpl ./change_rm.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/change_rm.c", 7, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/change_rm.c", 9, 12} true;
  assume {:verifier.code 1} true;
  call $i2 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i2);
  call {:cexpr "rm"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/float/change_rm.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/float/change_rm.c", 10, 3} true;
...
$bb15:
  ...
  goto $bb8;
$bb16:
  assume {:sourceloc "test/c/float/change_rm.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb17:
  assume {:sourceloc "test/c/float/change_rm.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := fesetround($i2);
  assume {:sourceloc "test/c/float/change_rm.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, 0);
  assume {:sourceloc "test/c/float/change_rm.c", 13, 3} true;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/float/change_rm.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/float/change_rm.c", 15, 3} true;
...
$bb25:
  ...
  goto $bb24;
$bb26:
  assume {:sourceloc "test/c/float/change_rm.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const fegetround: ref;
axiom (fegetround == $sub.ref(0, 2064));
procedure {:inline 1} fegetround()
  returns ($r: i32);
const fesetround: ref;
axiom (fesetround == $sub.ref(0, 3096));
