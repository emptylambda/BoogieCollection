...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/two_arrays1_fail.c -bpl ./two_arrays1_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 24768));
...
axiom (resetArray == $sub.ref(0, 1032));
procedure {:inline 1} resetArray($p0: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 22, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 22, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0, $mul.ref($i3, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref($i3, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 23, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p5, 0);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 22, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
...
procedure {:inline 1} setArray($p0: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 30, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 30, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 9);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0, $mul.ref($i3, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 31, 14} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref($i3, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 31, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p5, 1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 33, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 30, 33} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 30, 3} true;
...
axiom (initializeCount == $sub.ref(0, 3096));
procedure {:inline 1} initializeCount($p0: ref)
{
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 38, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 38, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 38, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 39, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 39, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0, $mul.ref($i3, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 39, 14} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0, $mul.ref($i3, 12)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 39, 20} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p5, 0);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 41, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 38, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 38, 3} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 45, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 45, 28} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(120);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 45, 20} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 46, 28} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(120);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 46, 20} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 48, 3} true;
  assume {:verifier.code 0} true;
  call resetArray($p1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 49, 3} true;
  assume {:verifier.code 0} true;
  call setArray($p3);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call initializeCount($p3);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 52, 8} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 52, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, 10);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 52, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 53, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 58, 3} true;
  assume {:verifier.code 0} true;
  call initializeCount($p1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 59, 3} true;
  assume {:verifier.code 0} true;
  call setArray($p1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 60, 3} true;
  assume {:verifier.code 0} true;
  call resetArray($p3);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 62, 8} true;
  assume {:verifier.code 0} true;
  $i24 := 0;
  goto $bb20;
$bb4:
  ...
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 53, 5} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p1, $mul.ref($i6, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 53, 5} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p1, $mul.ref($i6, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 53, 5} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, $p8);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 53, 5} true;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 54, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 54, 5} true;
  ...
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 54, 5} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p3, $mul.ref($i12, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 54, 5} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p3, $mul.ref($i12, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 54, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, $p14);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 54, 5} true;
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 55, 5} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 55, 5} true;
  ...
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 55, 5} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p3, $mul.ref($i18, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 55, 5} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p3, $mul.ref($i18, 12)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 55, 5} true;
  assume {:verifier.code 0} true;
...
$bb17:
  ...
  goto $bb16;
$bb18:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 56, 3} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb19:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 52, 29} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i4, 1);
...
$bb20:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 62, 17} true;
  assume {:verifier.code 0} true;
  $i25 := $slt.i32($i24, 10);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 62, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  goto $bb21, $bb22;
$bb21:
  assume ($i25 == 1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 63, 5} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb22:
  assume !(($i25 == 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 68, 8} true;
  assume {:verifier.code 0} true;
  $p44 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 68, 3} true;
  assume {:verifier.code 0} true;
  call free_($p44);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 69, 8} true;
  assume {:verifier.code 0} true;
  $p45 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 69, 3} true;
  assume {:verifier.code 0} true;
  call free_($p45);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 70, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb23:
  ...
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 63, 5} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p1, $mul.ref($i26, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 63, 5} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p1, $mul.ref($i26, 12)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 63, 5} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  goto $bb25;
$bb27:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 64, 5} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb28:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 64, 5} true;
  ...
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p1, $mul.ref($i31, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p1, $mul.ref($i31, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $i34 := $load.i8($M.0, $p33);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 64, 5} true;
...
$bb31:
  ...
  goto $bb30;
$bb32:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 65, 5} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 65, 5} true;
  ...
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 65, 5} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p3, $mul.ref($i37, 12));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 65, 5} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($add.ref($p3, $mul.ref($i37, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 65, 5} true;
  assume {:verifier.code 0} true;
  $i40 := $load.i8($M.0, $p39);
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 65, 5} true;
...
$bb36:
  ...
  goto $bb35;
$bb37:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 66, 3} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb38:
  assume {:sourceloc "test/c/data/two_arrays1_fail.c", 62, 29} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i32($i24, 1);
...
axiom (__VERIFIER_assert == $sub.ref(0, 10320));
...
axiom (__SMACK_and32 == $sub.ref(0, 11352));
...
axiom (__SMACK_and64 == $sub.ref(0, 12384));
...
axiom (__SMACK_and16 == $sub.ref(0, 13416));
...
axiom (__SMACK_and8 == $sub.ref(0, 14448));
...
axiom (__SMACK_or32 == $sub.ref(0, 15480));
...
axiom (__SMACK_or64 == $sub.ref(0, 16512));
...
axiom (__SMACK_or16 == $sub.ref(0, 17544));
...
axiom (__SMACK_or8 == $sub.ref(0, 18576));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19608));
...
axiom (llvm.dbg.value == $sub.ref(0, 23736));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 24768));
