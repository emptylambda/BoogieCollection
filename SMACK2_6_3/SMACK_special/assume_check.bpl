...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/special/assume_check.c -bpl ./assume_check.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/special/assume_check.c", 8, 20} true;
  ...
  assume {:sourceloc "test/c/special/assume_check.c", 9, 20} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/special/assume_check.c", 12, 23} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check.c:12:23: warning: over-approximating bitwise operation xor; */
  $i2 := $xor.i32($i0, $i1);
  assume {:sourceloc "test/c/special/assume_check.c", 12, 34} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check.c:12:34: warning: over-approximating bitwise operation xor; */
  $i3 := $xor.i32($i1, $i0);
  assume {:sourceloc "test/c/special/assume_check.c", 12, 28} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i2, $i3);
  assume {:sourceloc "test/c/special/assume_check.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/special/assume_check.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/special/assume_check.c", 13, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check.c:13:3: warning: over-approximating bitwise operation xor; */
  $i5 := $xor.i32($i0, $i1);
  assume {:sourceloc "test/c/special/assume_check.c", 13, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/assume_check.c:13:3: warning: over-approximating bitwise operation xor; */
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/special/assume_check.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
