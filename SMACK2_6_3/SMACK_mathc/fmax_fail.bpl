...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/fmax_fail.c -bpl ./fmax_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 11, 14} true;
  ...
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 12, 14} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call $i2 := __isnan($f0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 19} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  call $i18 := __isnan($f1);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.i32($i18, 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb28, $bb30;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 23} true;
  assume {:verifier.code 0} true;
  call $i4 := __isinf($f0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 34} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 38} true;
  assume {:verifier.code 0} true;
  call $i6 := __iszero($f0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 38} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call $i8 := __isnan($f1);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 21} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb10:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 25} true;
  assume {:verifier.code 0} true;
  call $i10 := __isinf($f1);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 25} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 36} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i11 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 40} true;
  assume {:verifier.code 0} true;
  call $i12 := __iszero($f1);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 40} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i13 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 16, 23} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmax_fail.c:16:23: warning: over-approximating call to llvm.maxnum.f64; */
  call $f14 := llvm.maxnum.f64($f0, $f1);
  call {:cexpr "maxVal"} boogie_si_record_float($f14);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 17, 13} true;
  assume {:verifier.code 0} true;
  $i15 := (if $fogt.float.bool($f0, $f1) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 17, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i15 == 1);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i15 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb17:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 18, 9} true;
...
$bb20:
  ...
  goto $bb19;
$bb21:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb23:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 20, 9} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 31, 8} true;
  assume {:verifier.code 0} true;
  call $i26 := __isnan($f0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 31, 8} true;
  assume {:verifier.code 0} true;
  $i27 := $ne.i32($i26, 0);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 31, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb46, $bb48;
$bb30:
  assume !(($i19 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmax_fail.c:26:5: warning: over-approximating call to llvm.maxnum.f64; */
  call $f20 := llvm.maxnum.f64($fp(0, 7, 0), $f1);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmax_fail.c:27:5: warning: over-approximating call to llvm.maxnum.f64; */
  call $f22 := llvm.maxnum.f64($fp(0, 0, 0), $f1);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 28, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmax_fail.c:28:5: warning: over-approximating call to llvm.maxnum.f64; */
  call $f24 := llvm.maxnum.f64($fp(0, 7, 8000000000000), $f1);
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 28, 5} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb46:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 31, 7} true;
  ...
  goto $bb47;
$bb47:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb64;
$bb48:
  assume !(($i27 == 1));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  goto $bb49;
$bb49:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmax_fail.c:32:5: warning: over-approximating call to llvm.maxnum.f64; */
  call $f28 := llvm.maxnum.f64($f0, $fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
...
$bb52:
  ...
  goto $bb51;
$bb53:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 33, 5} true;
  assume {:verifier.code 0} true;
  goto $bb54;
$bb54:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 33, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmax_fail.c:33:5: warning: over-approximating call to llvm.maxnum.f64; */
  call $f30 := llvm.maxnum.f64($f0, $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 33, 5} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb56;
$bb58:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 34, 5} true;
  assume {:verifier.code 0} true;
  goto $bb59;
$bb59:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 34, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmax_fail.c:34:5: warning: over-approximating call to llvm.maxnum.f64; */
  call $f32 := llvm.maxnum.f64($f0, $fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 34, 5} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb61;
$bb63:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb47;
$bb64:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmax_fail.c:37:3: warning: over-approximating call to llvm.maxnum.f64; */
  call $f34 := llvm.maxnum.f64($fp(0, 7, 8000000000000), $fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
...
$bb67:
  ...
  goto $bb66;
$bb68:
  assume {:sourceloc "test/c/mathc/fmax_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure {:inline 1} __iszero($f0: float)
  returns ($r: i32);
const llvm.maxnum.f64: ref;
axiom (llvm.maxnum.f64 == $sub.ref(0, 6192));
procedure {:inline 1} llvm.maxnum.f64($f0: float, $f1: float)
  returns ($r: float);
