...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/free_as_func_ptr.c -bpl ./free_as_func_ptr.bpl
...
const free_me: ref;
axiom (free_me == $sub.ref(0, 1032));
procedure {:inline 1} free_me($p0: ref)
{
  var $p1: ref;
  var $p2: ref;
  var $p3: ref;
$bb0:
  assume {:sourceloc "test/c/data/free_as_func_ptr.c", 7, 19} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/free_as_func_ptr.c", 7, 19} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(4);
  assume {:sourceloc "test/c/data/free_as_func_ptr.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/free_as_func_ptr.c", 8, 11} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  call devirtbounce($p0, $p3);
  assume {:sourceloc "test/c/data/free_as_func_ptr.c", 9, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/free_as_func_ptr.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/free_as_func_ptr.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call free_me(free_);
  assume {:sourceloc "test/c/data/free_as_func_ptr.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
