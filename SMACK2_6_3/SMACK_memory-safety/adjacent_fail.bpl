...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/adjacent_fail.c -bpl ./adjacent_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 7, 12} true;
  ...
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 8, 12} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(40);
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 8, 12} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p1, $mul.ref(10, 4));
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p4);
  call {:cexpr "c"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 10, 8} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call free_($p6);
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call free_($p7);
  assume {:sourceloc "test/c/memory-safety/adjacent_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
