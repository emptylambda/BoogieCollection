...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/pack_struct_fail.c -bpl ./pack_struct_fail.bpl
  ...
  returns ($r: i1)
{
  ...
  var $i10: i1;
$bb0:
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 14, 47} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 14, 55} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p3, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 14, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.1, $p8);
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 14, 49} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i7, $i9);
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 14, 37} true;
  assume {:verifier.code 0} true;
  $r := $i10;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 20, 7} true;
  assume {:verifier.code 0} true;
  call $M.3 := $memcpy.i8($M.3, $M.2, $p2, $p3, 8, false);
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 21, 3} true;
...
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/bits/pack_struct_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
