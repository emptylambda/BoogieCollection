// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy -print:./Problem1.bpl
...
procedure CheckWellformed$$_module.__default.IsRelaxedPrefix(_module._default.IsRelaxedPrefix$T: Ty, 
...
implementation CheckWellformed$$_module.__default.IsRelaxedPrefix(_module._default.IsRelaxedPrefix$T: Ty, pat#0: Seq Box, a#0: Seq Box)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(12,10): initial state"} true;
...
procedure CheckWellformed$$_module.__default.IsRelaxedPrefixAux(_module._default.IsRelaxedPrefixAux$T: Ty, 
...
implementation CheckWellformed$$_module.__default.IsRelaxedPrefixAux(_module._default.IsRelaxedPrefixAux$T: Ty, 
    pat#0: Seq Box, 
    a#0: Seq Box, 
    slack#0: int)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(19,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
...
procedure CheckWellformed$$_module.__default.ComputeIsRelaxedPrefix(_module._default.ComputeIsRelaxedPrefix$T: Ty, 
    pat#0: Seq Box
...
procedure Call$$_module.__default.ComputeIsRelaxedPrefix(_module._default.ComputeIsRelaxedPrefix$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.ComputeIsRelaxedPrefix$T))
         && $IsAlloc(pat#0, TSeq(_module._default.ComputeIsRelaxedPrefix$T), $Heap), 
    a#0: Seq Box
...
procedure Impl$$_module.__default.ComputeIsRelaxedPrefix(_module._default.ComputeIsRelaxedPrefix$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.ComputeIsRelaxedPrefix$T))
         && $IsAlloc(pat#0, TSeq(_module._default.ComputeIsRelaxedPrefix$T), $Heap), 
    a#0: Seq Box
...
implementation Impl$$_module.__default.ComputeIsRelaxedPrefix(_module._default.ComputeIsRelaxedPrefix$T: Ty, pat#0: Seq Box, a#0: Seq Box)
   returns (b#0: bool, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var B#0: bool;
  ...
  var $decr$loop#00: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(36,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(43,15)
    assume true;
    ##pat#1 := pat#0;
    // assume allocatedness for argument to function
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(43,46)"} true;
    // ----- update statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(44,16)
    assume true;
    assume true;
    assume true;
    $rhs#0 := LitInt(0);
    ...
    shift#0 := $rhs#0;
    i#0 := $rhs#1;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(44,22)"} true;
    // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(45,3)
    ...
    while (true)
      ...
      free invariant Seq#Length(pat#0) - i#0 <= $decr_init$loop#00
         && (Seq#Length(pat#0) - i#0 == $decr_init$loop#00 ==> true);
    {
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(45,2): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            if (LitInt(0) <= i#0)
            {
        ...
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(51,5)
        ...
        {
            // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(52,7)
            assume true;
            if (shift#0 == LitInt(0))
            {
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(53,15)
                assume true;
                assume true;
                shift#0 := LitInt(1);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(53,18)"} true;
            }
            else
            {
                // ----- return statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(55,9)
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(55,9)
                assume true;
                assume true;
                b#0 := Lit(false);
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(55,20)"} true;
                return;
            }
        }
        else
        ...
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(58,7)
        assume true;
        assume true;
        i#0 := i#0 + 1;
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(58,14)"} true;
        // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(45,3)
    ...
    // ----- return statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(60,3)
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(60,3)
    assume true;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(60,44)"} true;
    return;
}
...
implementation Impl$$_module.__default._default_Main() returns ($_reverifyPost: bool)
{
  ...
  var a##2: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(64,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(65,9)
    assume true;
    assume true;
    a#0 := Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
          $Box(LitInt(2))), 
        $Box(LitInt(3))));
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(65,20)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(66,34)
    assume true;
    ...
    b#0 := $rhs##0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(66,43)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(67,3)
    assume true;
    assume true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(68,30)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##1;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(68,41)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(69,3)
    assume true;
    assume true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(70,30)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##2;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(70,41)"} true;
    // ----- print statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(71,3)
    assume true;
    assume true;
}
...
procedure CheckWellformed$$_module.__default.IRP__Alt(_module._default.IRP_Alt$T: Ty, 
...
implementation CheckWellformed$$_module.__default.IRP__Alt(_module._default.IRP_Alt$T: Ty, pat#0: Seq Box, a#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var k#2: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(76,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
...
procedure CheckWellformed$$_module.__default.AreTheSame__Theorem(_module._default.AreTheSame_Theorem$T: Ty, 
    pat#0: Seq Box
...
procedure Call$$_module.__default.AreTheSame__Theorem(_module._default.AreTheSame_Theorem$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.AreTheSame_Theorem$T))
         && $IsAlloc(pat#0, TSeq(_module._default.AreTheSame_Theorem$T), $Heap), 
    a#0: Seq Box
...
procedure Impl$$_module.__default.AreTheSame__Theorem(_module._default.AreTheSame_Theorem$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.AreTheSame_Theorem$T))
         && $IsAlloc(pat#0, TSeq(_module._default.AreTheSame_Theorem$T), $Heap), 
    a#0: Seq Box
...
implementation Impl$$_module.__default.AreTheSame__Theorem(_module._default.AreTheSame_Theorem$T: Ty, pat#0: Seq Box, a#0: Seq Box)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##pat#2: Seq Box;
  ...
  var ##a#1_0: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(89,0): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(91,3)
    ##pat#2 := pat#0;
    // assume allocatedness for argument to function
    ...
    {
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(92,5)
        assume true;
        if (Seq#Length(pat#0) <= Seq#Length(a#0)
           && Seq#SameUntil(pat#0, a#0, Seq#Length(pat#0)))
        {
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(93,12)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            pat##0_0_0 := pat#0;
            ...
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(93,19)"} true;
        }
        else
        {
            // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(94,12)
            // Begin Comprehension WF check
            havoc k#0_0;
            if (true)
            {
                ...
                if (LitInt(0) <= k#0_0 && k#0_0 < Seq#Length(pat#0))
                {
                    assert 0 <= k#0_0 && k#0_0 <= Seq#Length(pat#0);
                    assert 0 <= k#0_0 + 1 && k#0_0 + 1 <= Seq#Length(pat#0);
                }
            }
            ...
            assume true;
            if ((exists k#0_1: int :: 
              { Seq#Take(pat#0, k#0_1) } 
              LitInt(0) <= k#0_1
                 && k#0_1 < Seq#Length(pat#0)
                 && 
                Seq#Length(Seq#Append(Seq#Take(pat#0, k#0_1), Seq#Drop(pat#0, k#0_1 + 1)))
                   <= Seq#Length(a#0)
                 && Seq#SameUntil(Seq#Append(Seq#Take(pat#0, k#0_1), Seq#Drop(pat#0, k#0_1 + 1)), 
                  a#0, 
                  Seq#Length(Seq#Append(Seq#Take(pat#0, k#0_1), Seq#Drop(pat#0, k#0_1 + 1))))))
            {
                // ----- assign-such-that statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(95,13)
                havoc k#0_1_1;
                if (true)
                {
                    if (LitInt(0) <= k#0_1_1)
                    ...
                    if (LitInt(0) <= k#0_1_1 && k#0_1_1 < Seq#Length(pat#0))
                    {
                        assert {:subsumption 0} 0 <= k#0_1_1 && k#0_1_1 <= Seq#Length(pat#0);
                        assert {:subsumption 0} 0 <= k#0_1_1 + 1 && k#0_1_1 + 1 <= Seq#Length(pat#0);
                    }
                  ...
                  ($Is(LitInt(0), TInt)
                   ...
                   || (exists $as#k0_1_0#0_1_0: int :: 
                    LitInt(0) <= $as#k0_1_0#0_1_0
                       && $as#k0_1_0#0_1_0 < Seq#Length(pat#0)
                       && 
                      Seq#Length(Seq#Append(Seq#Take(pat#0, $as#k0_1_0#0_1_0), Seq#Drop(pat#0, $as#k0_1_0#0_1_0 + 1)))
                         <= Seq#Length(a#0)
                       && Seq#SameUntil(Seq#Append(Seq#Take(pat#0, $as#k0_1_0#0_1_0), Seq#Drop(pat#0, $as#k0_1_0#0_1_0 + 1)), 
                        a#0, 
                        Seq#Length(Seq#Append(Seq#Take(pat#0, $as#k0_1_0#0_1_0), Seq#Drop(pat#0, $as#k0_1_0#0_1_0 + 1)))));
                havoc k#0_1_0;
                assume LitInt(0) <= k#0_1_0
                   && k#0_1_0 < Seq#Length(pat#0)
                   && 
                  Seq#Length(Seq#Append(Seq#Take(pat#0, k#0_1_0), Seq#Drop(pat#0, k#0_1_0 + 1)))
                     <= Seq#Length(a#0)
                   && Seq#SameUntil(Seq#Append(Seq#Take(pat#0, k#0_1_0), Seq#Drop(pat#0, k#0_1_0 + 1)), 
                    a#0, 
                    Seq#Length(Seq#Append(Seq#Take(pat#0, k#0_1_0), Seq#Drop(pat#0, k#0_1_0 + 1))));
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(95,59)"} true;
                // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(96,12)
                // TrCallStmt: Before ProcessCallStmt
                assume true;
                // ProcessCallStmt: CheckSubrange
                pat##0_1_0 := pat#0;
                ...
                assume true;
                // ProcessCallStmt: CheckSubrange
                assert $Is(k#0_1_0, Tclass._System.nat());
                k##0_1_0 := k#0_1_0;
                assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
                // ProcessCallStmt: Make the call
                call Call$$_module.__default.Same1(_module._default.AreTheSame_Theorem$T, pat##0_1_0, a##0_1_0, k##0_1_0);
                // TrCallStmt: After ProcessCallStmt
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(96,22)"} true;
            }
            else
            {
            }
        ...
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(98,5)
        ##pat#0_0 := pat#0;
        // assume allocatedness for argument to function
    ...
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(101,3)
    ##pat#3 := pat#0;
    // assume allocatedness for argument to function
    ...
    {
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(102,10)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        pat##1_0 := pat#0;
        ...
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(102,17)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(103,5)
        ##pat#1_0 := pat#0;
        // assume allocatedness for argument to function
...
procedure {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same0(_module._default.Same0$T: Ty, 
    pat#0: Seq Box
...
implementation {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same0(_module._default.Same0$T: Ty, pat#0: Seq Box, a#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##pat#0: Seq Box;
  var ##a#0: Seq Box;
  var ##slack#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(106,6): initial state"} true;
    assume Seq#Length(pat#0) <= Seq#Length(a#0)
       && Seq#SameUntil(pat#0, a#0, Seq#Length(pat#0));
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(108,28): post-state"} true;
    ##pat#0 := pat#0;
    // assume allocatedness for argument to function
...
procedure {:_induction pat#0, a#0} Call$$_module.__default.Same0(_module._default.Same0$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same0$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same0$T), $Heap), 
    a#0: Seq Box
...
procedure {:_induction pat#0, a#0} Impl$$_module.__default.Same0(_module._default.Same0$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same0$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same0$T), $Heap), 
    a#0: Seq Box
...
implementation {:_induction pat#0, a#0} Impl$$_module.__default.Same0(_module._default.Same0$T: Ty, pat#0: Seq Box, a#0: Seq Box)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(109,0): initial state"} true;
...
procedure {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same1(_module._default.Same1$T: Ty, 
    pat#0: Seq Box
...
implementation {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same1(_module._default.Same1$T: Ty, pat#0: Seq Box, a#0: Seq Box, k#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##pat#0: Seq Box;
  var ##a#0: Seq Box;
  var ##slack#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(111,6): initial state"} true;
    if (LitInt(0) <= k#0)
    {
    }
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(113,28): post-state"} true;
    ##pat#0 := pat#0;
    // assume allocatedness for argument to function
...
procedure {:_induction pat#0, a#0} Call$$_module.__default.Same1(_module._default.Same1$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same1$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same1$T), $Heap), 
    a#0: Seq Box
...
procedure {:_induction pat#0, a#0} Impl$$_module.__default.Same1(_module._default.Same1$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same1$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same1$T), $Heap), 
    a#0: Seq Box
...
implementation {:_induction pat#0, a#0} Impl$$_module.__default.Same1(_module._default.Same1$T: Ty, pat#0: Seq Box, a#0: Seq Box, k#0: int)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  ...
  var k##0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(114,0): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#pat0#0: Seq Box, $ih#a0#0: Seq Box :: 
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(116,9)
    assume true;
    assume true;
    d#0 := k#0;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(116,12)"} true;
    // ----- while statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(117,3)
    // Assume Fuel Constant
    $PreLoopHeap$loop#0 := $Heap;
    ...
    {
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(117,2): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            if (LitInt(0) <= d#0)
            {
        ...
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(120,7)
        assume true;
        assume true;
        d#0 := d#0 + 1;
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(120,14)"} true;
        // ----- loop termination check ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(117,3)
        assert 0 <= $decr$loop#00 || Seq#Length(pat#0) - (d#0 + 1) == $decr$loop#00;
        assert Seq#Length(pat#0) - (d#0 + 1) < $decr$loop#00;
        assume true;
    }

    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(122,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    pat##0 := pat#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(122,22)"} true;
}



procedure {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same1__Aux(_module._default.Same1_Aux$T: Ty, 
    pat#0: Seq Box
...
implementation {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same1__Aux(_module._default.Same1_Aux$T: Ty, pat#0: Seq Box, a#0: Seq Box, k#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##pat#0: Seq Box;
  var ##a#0: Seq Box;
  var ##slack#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(124,6): initial state"} true;
    if (LitInt(0) <= k#0)
    {
    }
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(126,28): post-state"} true;
    ##pat#0 := pat#0;
    // assume allocatedness for argument to function
...
procedure {:_induction pat#0, a#0} Call$$_module.__default.Same1__Aux(_module._default.Same1_Aux$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same1_Aux$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same1_Aux$T), $Heap), 
    a#0: Seq Box
...
procedure {:_induction pat#0, a#0} Impl$$_module.__default.Same1__Aux(_module._default.Same1_Aux$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same1_Aux$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same1_Aux$T), $Heap), 
    a#0: Seq Box
...
implementation {:_induction pat#0, a#0} Impl$$_module.__default.Same1__Aux(_module._default.Same1_Aux$T: Ty, pat#0: Seq Box, a#0: Seq Box, k#0: int)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  ...
  var k##0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(127,0): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#pat0#0: Seq Box, $ih#a0#0: Seq Box :: 
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(128,3)
    assume true;
    if (k#0 + 1 == Seq#Length(pat#0))
    {
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(129,5)
        ...
        assume Seq#Equal(Seq#Append(Seq#Take(pat#0, k#0), Seq#Drop(pat#0, k#0 + 1)), Seq#Take(pat#0, k#0))
          ...
          Seq#Length(Seq#Take(pat#0, k#0)) <= Seq#Length(a#0)
           && Seq#SameUntil(Seq#Take(pat#0, k#0), a#0, Seq#Length(Seq#Take(pat#0, k#0)));
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(130,5)
        assume true;
        if (k#0 == LitInt(0))
        {
        }
        ...
        {
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(132,7)
            ##pat#0_0 := pat#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##pat#0_0, TSeq(_module._default.Same1_Aux$T), $Heap);
            ##a#0_0 := a#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##a#0_0, TSeq(_module._default.Same1_Aux$T), $Heap);
            assert $Is(LitInt(1), Tclass._System.nat());
            ##slack#0_0 := LitInt(1);
            // assume allocatedness for argument to function
            assume $IsAlloc(##slack#0_0, Tclass._System.nat(), $Heap);
            assume _module.__default.IsRelaxedPrefixAux#canCall(_module._default.Same1_Aux$T, pat#0, a#0, LitInt(1));
            assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
            assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
            ##pat#0_1 := Seq#Drop(pat#0, LitInt(1));
            // assume allocatedness for argument to function
            assume $IsAlloc(##pat#0_1, TSeq(_module._default.Same1_Aux$T), $Heap);
            ##a#0_1 := Seq#Drop(a#0, LitInt(1));
            // assume allocatedness for argument to function
            assume $IsAlloc(##a#0_1, TSeq(_module._default.Same1_Aux$T), $Heap);
            assert $Is(LitInt(1), Tclass._System.nat());
            ##slack#0_1 := LitInt(1);
            // assume allocatedness for argument to function
            assume $IsAlloc(##slack#0_1, Tclass._System.nat(), $Heap);
            ...
            assume _module.__default.IsRelaxedPrefixAux(_module._default.Same1_Aux$T, $LS($LZ), pat#0, a#0, LitInt(1))
               == _module.__default.IsRelaxedPrefixAux(_module._default.Same1_Aux$T, 
                ...
                Seq#Drop(a#0, LitInt(1)), 
                LitInt(1));
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(133,16)
            // TrCallStmt: Before ProcessCallStmt
            assert 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
            assume true;
            // ProcessCallStmt: CheckSubrange
            pat##0_0 := Seq#Drop(pat#0, LitInt(1));
            assert 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
            assume true;
            // ProcessCallStmt: CheckSubrange
            a##0_0 := Seq#Drop(a#0, LitInt(1));
            assume true;
            // ProcessCallStmt: CheckSubrange
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            assert 0 <= k#0
               || Seq#Rank(pat##0_0) < Seq#Rank(pat#0)
               || Seq#Rank(a##0_0) < Seq#Rank(a#0)
               || k##0_0 == k#0;
            assert Seq#Rank(pat##0_0) < Seq#Rank(pat#0)
               || (Seq#Rank(pat##0_0) == Seq#Rank(pat#0)
                 && (Seq#Rank(a##0_0) < Seq#Rank(a#0)
                   || (Seq#Rank(a##0_0) == Seq#Rank(a#0) && k##0_0 < k#0)));
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Same1__Aux(_module._default.Same1_Aux$T, pat##0_0, a##0_0, k##0_0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(133,38)"} true;
        }
    }
    else
    {
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(135,10)
        assume true;
        if (k#0 == LitInt(0))
        {
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(136,5)
            ...
            assert Seq#Equal(Seq#Append(Seq#Take(pat#0, LitInt(0)), Seq#Drop(pat#0, LitInt(1))), 
              Seq#Drop(pat#0, LitInt(1)));
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(137,5)
            assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) < Seq#Length(pat#0);
            assert {:subsumption 0} 0 <= LitInt(0) && LitInt(0) < Seq#Length(a#0);
            assume true;
            assert Seq#Index(pat#0, LitInt(1)) == Seq#Index(a#0, LitInt(0));
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(138,5)
            assert {:subsumption 0} 0 <= LitInt(0) && LitInt(0) < Seq#Length(pat#0);
            assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) < Seq#Length(pat#0);
            assume true;
            assert Seq#Index(pat#0, LitInt(0)) != Seq#Index(pat#0, LitInt(1));
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(139,5)
            ##pat#1_0 := pat#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##pat#1_0, TSeq(_module._default.Same1_Aux$T), $Heap);
            ##a#1_0 := a#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##a#1_0, TSeq(_module._default.Same1_Aux$T), $Heap);
            assert $Is(LitInt(1), Tclass._System.nat());
            ##slack#1_0 := LitInt(1);
            // assume allocatedness for argument to function
            assume $IsAlloc(##slack#1_0, Tclass._System.nat(), $Heap);
            assume _module.__default.IsRelaxedPrefixAux#canCall(_module._default.Same1_Aux$T, pat#0, a#0, LitInt(1));
            assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
            ##pat#1_1 := Seq#Drop(pat#0, LitInt(1));
            // assume allocatedness for argument to function
            assume $IsAlloc(##pat#1_1, TSeq(_module._default.Same1_Aux$T), $Heap);
            ##a#1_1 := a#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##a#1_1, TSeq(_module._default.Same1_Aux$T), $Heap);
            assert $Is(LitInt(0), Tclass._System.nat());
            ##slack#1_1 := LitInt(0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##slack#1_1, Tclass._System.nat(), $Heap);
            ...
            assume _module.__default.IsRelaxedPrefixAux(_module._default.Same1_Aux$T, $LS($LZ), pat#0, a#0, LitInt(1))
               == _module.__default.IsRelaxedPrefixAux(_module._default.Same1_Aux$T, 
                ...
                a#0, 
                LitInt(0));
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(140,11)
            // TrCallStmt: Before ProcessCallStmt
            assert 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
            assume true;
            // ProcessCallStmt: CheckSubrange
            pat##1_0 := Seq#Drop(pat#0, LitInt(1));
            assume true;
            // ProcessCallStmt: CheckSubrange
            a##1_0 := a#0;
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Prefix(_module._default.Same1_Aux$T, pat##1_0, a##1_0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(140,23)"} true;
        }
        else
        {
            // ----- calc statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
            // Assume Fuel Constant
            if (*)
            {
                // ----- assert wf[initial] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                assume true;
                assume false;
            }
            else if (*)
            {
                // ----- assume wf[lhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                assume true;
                // ----- assume lhs ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                assume true;
                // ----- Hint0 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                assert {:subsumption 0} 0 <= k#0 && k#0 <= Seq#Length(pat#0);
                assert {:subsumption 0} 0 <= k#0 + 1 && k#0 + 1 <= Seq#Length(pat#0);
                assume true;
                // ----- assert line0 ==> line1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
            ...
            else if (*)
            {
                ...
                assume Seq#Length(Seq#Append(Seq#Take(pat#0, k#0), Seq#Drop(pat#0, k#0 + 1)))
                   ...
                   && Seq#SameUntil(Seq#Append(Seq#Take(pat#0, k#0), Seq#Drop(pat#0, k#0 + 1)), 
                    a#0, 
                    Seq#Length(Seq#Append(Seq#Take(pat#0, k#0), Seq#Drop(pat#0, k#0 + 1))));
                // ----- Hint1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                assert {:subsumption 0} 0 <= k#0 && k#0 <= Seq#Length(pat#0);
                assert {:subsumption 0} 0 <= k#0 + 1 && k#0 + 1 <= Seq#Length(pat#0);
                ...
                assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                assume true;
                // ----- assert line1 ==> line2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
            ...
            else if (*)
            {
                ...
                assume Seq#Length(Seq#Drop(Seq#Append(Seq#Take(pat#0, k#0), Seq#Drop(pat#0, k#0 + 1)), LitInt(1)))
                   ...
                   && Seq#SameUntil(Seq#Drop(Seq#Append(Seq#Take(pat#0, k#0), Seq#Drop(pat#0, k#0 + 1)), LitInt(1)), 
                    Seq#Drop(a#0, LitInt(1)), 
                    Seq#Length(Seq#Drop(Seq#Append(Seq#Take(pat#0, k#0), Seq#Drop(pat#0, k#0 + 1)), LitInt(1))));
                // ----- Hint2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                assert {:subsumption 0} 0 <= k#0 && k#0 <= Seq#Length(pat#0);
                ...
                assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                assume true;
                // ----- assert line2 ==> line3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
            ...
            else if (*)
            {
                ...
                assume Seq#Length(Seq#Append(Seq#Drop(Seq#Take(pat#0, k#0), LitInt(1)), Seq#Drop(pat#0, k#0 + 1)))
                   ...
                   && Seq#SameUntil(Seq#Append(Seq#Drop(Seq#Take(pat#0, k#0), LitInt(1)), Seq#Drop(pat#0, k#0 + 1)), 
                    Seq#Drop(a#0, LitInt(1)), 
                    Seq#Length(Seq#Append(Seq#Drop(Seq#Take(pat#0, k#0), LitInt(1)), Seq#Drop(pat#0, k#0 + 1))));
                // ----- Hint3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(147,9)
                assert {:subsumption 0} 0 <= k#0 && k#0 <= Seq#Length(pat#0);
                assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(Seq#Take(pat#0, k#0));
                assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                ...
                assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                assume true;
                // ----- assert line3 ==> line4 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
            ...
            else if (*)
            {
                ...
                assume Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#0 - 1), Seq#Drop(pat#0, k#0 + 1)))
                   ...
                   && Seq#SameUntil(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#0 - 1), Seq#Drop(pat#0, k#0 + 1)), 
                    Seq#Drop(a#0, LitInt(1)), 
                    Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#0 - 1), Seq#Drop(pat#0, k#0 + 1))));
                // ----- Hint4 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
                // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(149,9)
                assert {:subsumption 0} 0 <= k#0 + 1 && k#0 + 1 <= Seq#Length(pat#0);
                assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                ...
                assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                assume true;
                // ----- assert line4 ==> line5 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(142,5)
            ...
            assume true
               ==> Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#0 - 1), 
                 ...
                 && Seq#SameUntil(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#0 - 1), 
                  ...
                  Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#0 - 1), 
                      Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#0))));
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(152,14)
            // TrCallStmt: Before ProcessCallStmt
            assert 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
            assume true;
            // ProcessCallStmt: CheckSubrange
            ...
            assert Seq#Rank(pat##0) < Seq#Rank(pat#0)
               || (Seq#Rank(pat##0) == Seq#Rank(pat#0)
                 && (Seq#Rank(a##0) < Seq#Rank(a#0)
                   || (Seq#Rank(a##0) == Seq#Rank(a#0) && k##0 < k#0)));
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Same1__Aux(_module._default.Same1_Aux$T, pat##0, a##0, k##0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(152,36)"} true;
        }
    }
}
...
procedure {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Prefix(_module._default.Prefix$T: Ty, 
    pat#0: Seq Box
...
implementation {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Prefix(_module._default.Prefix$T: Ty, pat#0: Seq Box, a#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##pat#0: Seq Box;
  var ##a#0: Seq Box;
  var ##slack#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(155,6): initial state"} true;
    assume Seq#Length(pat#0) <= Seq#Length(a#0)
       && Seq#SameUntil(pat#0, a#0, Seq#Length(pat#0));
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(157,28): post-state"} true;
    ##pat#0 := pat#0;
    // assume allocatedness for argument to function
...
procedure {:_induction pat#0, a#0} Call$$_module.__default.Prefix(_module._default.Prefix$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Prefix$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Prefix$T), $Heap), 
    a#0: Seq Box
...
procedure {:_induction pat#0, a#0} Impl$$_module.__default.Prefix(_module._default.Prefix$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Prefix$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Prefix$T), $Heap), 
    a#0: Seq Box
...
implementation {:_induction pat#0, a#0} Impl$$_module.__default.Prefix(_module._default.Prefix$T: Ty, pat#0: Seq Box, a#0: Seq Box)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(158,0): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#pat0#0: Seq Box, $ih#a0#0: Seq Box :: 
...
procedure {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same2(_module._default.Same2$T: Ty, 
    pat#0: Seq Box
...
implementation {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same2(_module._default.Same2$T: Ty, pat#0: Seq Box, a#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##pat#0: Seq Box;
  var ##a#0: Seq Box;
  ...
  var ##a#1: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(160,6): initial state"} true;
    ##pat#0 := pat#0;
    // assume allocatedness for argument to function
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(162,17): post-state"} true;
    ##pat#1 := pat#0;
    // assume allocatedness for argument to function
...
procedure {:_induction pat#0, a#0} Call$$_module.__default.Same2(_module._default.Same2$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same2$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same2$T), $Heap), 
    a#0: Seq Box
...
procedure {:_induction pat#0, a#0} Impl$$_module.__default.Same2(_module._default.Same2$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same2$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same2$T), $Heap), 
    a#0: Seq Box
...
implementation {:_induction pat#0, a#0} Impl$$_module.__default.Same2(_module._default.Same2$T: Ty, pat#0: Seq Box, a#0: Seq Box)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  var x#1_0: Box
     where $IsBox(x#1_0, _module._default.Same2$T)
       && $IsAllocBox(x#1_0, _module._default.Same2$T, $Heap);
  var k#1_0: int;
  var k#1_1: int;
  var pat##0: Seq Box;
  var a##0: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(163,0): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#pat0#0: Seq Box, $ih#a0#0: Seq Box :: 
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(164,3)
    assume true;
    if (Seq#Equal(pat#0, Seq#Empty(): Seq Box))
    {
    }
    ...
    {
        // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(165,10)
        if (!Seq#Equal(a#0, Seq#Empty(): Seq Box))
        {
            assert 0 <= LitInt(0) && LitInt(0) < Seq#Length(pat#0);
            assert 0 <= LitInt(0) && LitInt(0) < Seq#Length(a#0);
        ...
        if (!Seq#Equal(a#0, Seq#Empty(): Seq Box)
           && Seq#Index(pat#0, LitInt(0)) == Seq#Index(a#0, LitInt(0)))
        {
            // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(166,5)
            assert 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
            assert 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
            assume true;
            ...
            {
                // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(168,13)
                assume true;
                assert 0 <= LitInt(0) && LitInt(0) < Seq#Length(a#0);
                assume true;
                x#1_0 := Seq#Index(a#0, LitInt(0));
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(168,19)"} true;
                // ----- assign-such-that statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(169,13)
                havoc k#1_1;
                if (true)
                {
                    if (LitInt(0) <= k#1_1)
                    ...
                    if (LitInt(0) <= k#1_1 && k#1_1 < Seq#Length(Seq#Drop(pat#0, LitInt(1))))
                    {
                        assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                        assert {:subsumption 0} 0 <= k#1_1 && k#1_1 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                        assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                        assert {:subsumption 0} 0 <= k#1_1 + 1 && k#1_1 + 1 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                        assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                    }
                  ...
                  ($Is(LitInt(0), TInt)
                   ...
                   || (exists $as#k1_0#1_0: int :: 
                    LitInt(0) <= $as#k1_0#1_0
                       && $as#k1_0#1_0 < Seq#Length(Seq#Drop(pat#0, LitInt(1)))
                       && 
                      Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), $as#k1_0#1_0), 
                            Seq#Drop(Seq#Drop(pat#0, LitInt(1)), $as#k1_0#1_0 + 1)))
                         <= Seq#Length(Seq#Drop(a#0, LitInt(1)))
                       && Seq#SameUntil(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), $as#k1_0#1_0), 
                          Seq#Drop(Seq#Drop(pat#0, LitInt(1)), $as#k1_0#1_0 + 1)), 
                        Seq#Drop(a#0, LitInt(1)), 
                        Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), $as#k1_0#1_0), 
                            Seq#Drop(Seq#Drop(pat#0, LitInt(1)), $as#k1_0#1_0 + 1)))));
                ...
                assume LitInt(0) <= k#1_0
                   && k#1_0 < Seq#Length(Seq#Drop(pat#0, LitInt(1)))
                   && 
                  Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), 
                        Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1)))
                     <= Seq#Length(Seq#Drop(a#0, LitInt(1)))
                   && Seq#SameUntil(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), 
                      Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1)), 
                    Seq#Drop(a#0, LitInt(1)), 
                    Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), 
                        Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1))));
                assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(169,79)"} true;
                // ----- calc statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                // Assume Fuel Constant
                if (*)
                {
                    // ----- assert wf[initial] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 && k#1_0 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 + 1 && k#1_0 + 1 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                    assume true;
                    assume false;
                }
                ...
                {
                    // ----- assume wf[lhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assume {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assume {:subsumption 0} 0 <= k#1_0 && k#1_0 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assume {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assume {:subsumption 0} 0 <= k#1_0 + 1 && k#1_0 + 1 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assume {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                    assume true;
                    // ----- Hint0 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(172,13)
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 + 1 && k#1_0 + 1 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assert {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assume true;
                    assert Seq#Equal(Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1), Seq#Drop(pat#0, k#1_0 + 2));
                    // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 && k#1_0 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assert {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                    assume true;
                    // ----- assert line0 == line1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} (Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), 
                              Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1)))
                           <= Seq#Length(Seq#Drop(a#0, LitInt(1)))
                         && Seq#SameUntil(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), 
                            Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1)), 
                          ...
                          Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), 
                              Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1)))))
                       == (Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2)))
                           <= Seq#Length(Seq#Drop(a#0, LitInt(1)))
                         && Seq#SameUntil(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2)), 
                          Seq#Drop(a#0, LitInt(1)), 
                          Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2)))));
                    assume false;
                }
                else if (*)
                {
                    ...
                    assume {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assume {:subsumption 0} 0 <= k#1_0 && k#1_0 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assume {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assume {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                    assume true;
                    // ----- Hint1 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 && k#1_0 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assert {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                    assume true;
                    // ----- assert line1 == line2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} (Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2)))
                           <= Seq#Length(Seq#Drop(a#0, LitInt(1)))
                         && Seq#SameUntil(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2)), 
                          Seq#Drop(a#0, LitInt(1)), 
                          Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2)))))
                       == (Seq#Length(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                              Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2))))
                           <= Seq#Length(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), Seq#Drop(a#0, LitInt(1))))
                         && Seq#SameUntil(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                            Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2))), 
                          Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), Seq#Drop(a#0, LitInt(1))), 
                          Seq#Length(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                              Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2))))));
                    assume false;
                }
                else if (*)
                {
                    ...
                    assume {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                    assume true;
                    // ----- Hint2 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(176,13)
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(a#0);
                    assume true;
                    assert Seq#Equal(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), Seq#Drop(a#0, LitInt(1))), 
                      a#0);
                    // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 && k#1_0 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assert {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assume true;
                    // ----- assert line2 == line3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} (Seq#Length(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                              Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2))))
                           <= Seq#Length(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), Seq#Drop(a#0, LitInt(1))))
                         && Seq#SameUntil(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                            Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2))), 
                ...
                else if (*)
                {
                    ...
                    assume {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assume true;
                    // ----- Hint3 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(178,13)
                    assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 && k#1_0 <= Seq#Length(Seq#Drop(pat#0, LitInt(1)));
                    assert {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 + 1 && k#1_0 + 1 <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assume true;
                    assert Seq#Equal(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                        Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2))), 
                      Seq#Append(Seq#Take(pat#0, k#1_0 + 1), Seq#Drop(pat#0, k#1_0 + 2)));
                    // ----- assert wf[rhs] ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} 0 <= k#1_0 + 1 && k#1_0 + 1 <= Seq#Length(pat#0);
                    assert {:subsumption 0} 0 <= k#1_0 + 2 && k#1_0 + 2 <= Seq#Length(pat#0);
                    assume true;
                    // ----- assert line3 == line4 ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(170,7)
                    assert {:subsumption 0} (Seq#Length(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                              Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2))))
                           <= Seq#Length(a#0)
                         && Seq#SameUntil(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                          ...
                          Seq#Length(Seq#Append(Seq#Build(Seq#Empty(): Seq Box, x#1_0), 
                              Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), Seq#Drop(pat#0, k#1_0 + 2))))))
                       == (Seq#Length(Seq#Append(Seq#Take(pat#0, k#1_0 + 1), Seq#Drop(pat#0, k#1_0 + 2)))
                           <= Seq#Length(a#0)
                         && Seq#SameUntil(Seq#Append(Seq#Take(pat#0, k#1_0 + 1), Seq#Drop(pat#0, k#1_0 + 2)), 
                          a#0, 
                          Seq#Length(Seq#Append(Seq#Take(pat#0, k#1_0 + 1), Seq#Drop(pat#0, k#1_0 + 2)))));
                    assume false;
                }

                assume (Seq#Length(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), 
                          Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1)))
                       <= Seq#Length(Seq#Drop(a#0, LitInt(1)))
                     && Seq#SameUntil(Seq#Append(Seq#Take(Seq#Drop(pat#0, LitInt(1)), k#1_0), 
                        Seq#Drop(Seq#Drop(pat#0, LitInt(1)), k#1_0 + 1)), 
        ...
        {
            // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(183,17)
            // TrCallStmt: Before ProcessCallStmt
            assert 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
            assume true;
            // ProcessCallStmt: CheckSubrange
            ...
            assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
            // ProcessCallStmt: Make the call
            call Call$$_module.__default.Same2__Prefix(_module._default.Same2$T, pat##0, a##0);
            // TrCallStmt: After ProcessCallStmt
            assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(183,29)"} true;
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(184,5)
            assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(pat#0);
            assume true;
            ...
            // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(185,5)
...
procedure {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same2__Prefix(_module._default.Same2_Prefix$T: Ty, 
    pat#0: Seq Box
...
implementation {:_induction pat#0, a#0} CheckWellformed$$_module.__default.Same2__Prefix(_module._default.Same2_Prefix$T: Ty, pat#0: Seq Box, a#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##pat#0: Seq Box;
  var ##a#0: Seq Box;
  var ##slack#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(188,6): initial state"} true;
    ##pat#0 := pat#0;
    // assume allocatedness for argument to function
    ...
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(190,14): post-state"} true;
    assume Seq#Length(pat#0) <= Seq#Length(a#0)
       && Seq#SameUntil(pat#0, a#0, Seq#Length(pat#0));
}
...
procedure {:_induction pat#0, a#0} Call$$_module.__default.Same2__Prefix(_module._default.Same2_Prefix$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same2_Prefix$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same2_Prefix$T), $Heap), 
    a#0: Seq Box
...
procedure {:_induction pat#0, a#0} Impl$$_module.__default.Same2__Prefix(_module._default.Same2_Prefix$T: Ty, 
    pat#0: Seq Box
       where $Is(pat#0, TSeq(_module._default.Same2_Prefix$T))
         && $IsAlloc(pat#0, TSeq(_module._default.Same2_Prefix$T), $Heap), 
    a#0: Seq Box
...
implementation {:_induction pat#0, a#0} Impl$$_module.__default.Same2__Prefix(_module._default.Same2_Prefix$T: Ty, pat#0: Seq Box, a#0: Seq Box)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/VerifyThis2015/Problem1.dfy(191,0): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#pat0#0: Seq Box, $ih#a0#0: Seq Box :: 
