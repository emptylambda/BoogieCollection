...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock3_fail.c -bpl ./lock3_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 13, 4} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 13, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 19, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 19, 4} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  ...
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create($p1, $0.ref, t2, $0.ref);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_lock(lock);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 29, 4} true;
  assume {:verifier.code 0} true;
  $i5 := $M.0;
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 29, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_unlock(lock);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 31, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i8, $0.ref);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 32, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i32($M.2, $p1);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_join($i10, $0.ref);
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 33, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/lock3_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
