...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/special/countpop8.c -bpl ./countpop8.bpl
  ...
  returns ($r: i8)
{
  ...
  var $i3: i8;
$bb0:
  assume {:sourceloc "test/c/special/countpop8.c", 20, 36} true;
  ...
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, $p2);
  assume {:sourceloc "test/c/special/countpop8.c", 20, 29} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/special/countpop8.c", 23, 15} true;
  ...
  assume {:sourceloc "test/c/special/countpop8.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/special/countpop8.c", 24, 3} true;
...
$bb7:
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "test/c/special/countpop8.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/special/countpop8.c", 25, 3} true;
  ...
  assume {:sourceloc "test/c/special/countpop8.c", 25, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/countpop8.c:25:3: warning: over-approximating call to llvm.ctpop.i32; */
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "test/c/special/countpop8.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
