...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/simd/cast_fail.c -bpl ./cast_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/simd/cast_fail.c", 8, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/simd/cast_fail.c", 8, 13} true;
  assume {:verifier.code 0} true;
  $v0 := $bitcast.i64.vec.1xi64(42);
  call {:cexpr "b"} boogie_si_record_vec.1xi64($v0);
  assume {:sourceloc "test/c/simd/cast_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/simd/cast_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $extractelement.vec.1xi64.i32($v0, 0);
  assume {:sourceloc "test/c/simd/cast_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i64($i1, 41);
  assume {:sourceloc "test/c/simd/cast_fail.c", 9, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/simd/cast_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
function $bitcast.i64.vec.1xi64(v: i64) returns (vec.1xi64) { mk.vec.1xi64(v) }
axiom (forall v: i64 :: ($bitcast.vec.1xi64.i64($bitcast.i64.vec.1xi64(v)) == v));
function $bitcast.vec.1xi64.i64(v: vec.1xi64) returns (i64) { i0#mk.vec.1xi64(v) }
axiom (forall v: vec.1xi64 :: ($bitcast.i64.vec.1xi64($bitcast.vec.1xi64.i64(v)) == v));
function $extractelement.vec.1xi64.i32(v: vec.1xi64, i: i32) returns (i64);
axiom (forall v: vec.1xi64 :: ($extractelement.vec.1xi64.i32(v, 0) == i0#mk.vec.1xi64(v)));
...
procedure {:inline 1} boogie_si_record_vec.1xi64(x: vec.1xi64);
function {:constructor} mk.vec.1xi64(i0: i64) returns (vec.1xi64);
type {:datatype} vec.1xi64;
