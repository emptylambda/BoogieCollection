...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/jain_5_true.c -bpl ./jain_5_true.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/jain_5_true.c", 8, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/jain_5_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/jain_5_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/jain_5_true.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, $i1);
  call {:cexpr "x"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/basic/jain_5_true.c", 10, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i1, 4);
  call {:cexpr "y"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/basic/jain_5_true.c", 11, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/basic/jain_5_true.c", 11, 5} true;
