...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/select.c -bpl ./select.bpl
...
procedure {:inline 1} foo($i0: i32)
{
  var $i1: i1;
$bb0:
  assume {:sourceloc "test/c/basic/select.c", 6, 19} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/select.c", 6, 30} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/select.c", 9, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/basic/select.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/select.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/select.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i0, 2);
  assume {:sourceloc "test/c/basic/select.c", 11, 7} true;
  assume {:verifier.code 0} true;
  $i3 := (if ($i2 == 1) then 1 else 0);
  assume {:sourceloc "test/c/basic/select.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call foo($i3);
  assume {:sourceloc "test/c/basic/select.c", 12, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
