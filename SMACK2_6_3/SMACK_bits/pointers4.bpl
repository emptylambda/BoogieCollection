...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/pointers4.c -bpl ./pointers4.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/pointers4.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/bits/pointers4.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/bits/pointers4.c", 8, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/bits/pointers4.c", 10, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p1, 256);
  assume {:sourceloc "test/c/bits/pointers4.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/bits/pointers4.c", 11, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, $p2, 1);
  assume {:sourceloc "test/c/bits/pointers4.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/pointers4.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/pointers4.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/bits/pointers4.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call free_($p5);
  assume {:sourceloc "test/c/bits/pointers4.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
