...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/lock5.c -bpl ./lock5.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/lock5.c", 9, 3} true;
  ...
  assume {:sourceloc "test/c/pthread/lock5.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := pthread_mutex_init($p0, $0.ref);
  assume {:sourceloc "test/c/pthread/lock5.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := pthread_mutex_lock($p0);
  assume {:sourceloc "test/c/pthread/lock5.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_mutex_unlock($p0);
  assume {:sourceloc "test/c/pthread/lock5.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
