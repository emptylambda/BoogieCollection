...
axiom (forall a#14#0#0: Box, a#14#1#0: Box :: 
  { #PatternsWithExplicitTypes.Tuple.Pair(a#14#0#0, a#14#1#0) } 
  DatatypeCtorId(#PatternsWithExplicitTypes.Tuple.Pair(a#14#0#0, a#14#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  PatternsWithExplicitTypes.Tuple.Pair_q(d)
     ==> (exists a#15#0#0: Box, a#15#1#0: Box :: 
      d == #PatternsWithExplicitTypes.Tuple.Pair(a#15#0#0, a#15#1#0)));
...
axiom (forall PatternsWithExplicitTypes.Tuple$T: Ty, 
    ...
    a#16#0#0: Box, 
    a#16#1#0: Box :: 
  { $Is(#PatternsWithExplicitTypes.Tuple.Pair(a#16#0#0, a#16#1#0), 
      Tclass.PatternsWithExplicitTypes.Tuple(PatternsWithExplicitTypes.Tuple$T, PatternsWithExplicitTypes.Tuple$U)) } 
  $Is(#PatternsWithExplicitTypes.Tuple.Pair(a#16#0#0, a#16#1#0), 
      Tclass.PatternsWithExplicitTypes.Tuple(PatternsWithExplicitTypes.Tuple$T, PatternsWithExplicitTypes.Tuple$U))
     <==> $IsBox(a#16#0#0, PatternsWithExplicitTypes.Tuple$T)
       && $IsBox(a#16#1#0, PatternsWithExplicitTypes.Tuple$U));
...
axiom (forall PatternsWithExplicitTypes.Tuple$T: Ty, 
    ...
    a#17#1#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#PatternsWithExplicitTypes.Tuple.Pair(a#17#0#0, a#17#1#0), 
      Tclass.PatternsWithExplicitTypes.Tuple(PatternsWithExplicitTypes.Tuple$T, PatternsWithExplicitTypes.Tuple$U), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#PatternsWithExplicitTypes.Tuple.Pair(a#17#0#0, a#17#1#0), 
        Tclass.PatternsWithExplicitTypes.Tuple(PatternsWithExplicitTypes.Tuple$T, PatternsWithExplicitTypes.Tuple$U), 
        $h)
       <==> $IsAllocBox(a#17#0#0, PatternsWithExplicitTypes.Tuple$T, $h)
         && $IsAllocBox(a#17#1#0, PatternsWithExplicitTypes.Tuple$U, $h)));
...
axiom (forall a#18#0#0: Box, a#18#1#0: Box :: 
  { #PatternsWithExplicitTypes.Tuple.Pair(Lit(a#18#0#0), Lit(a#18#1#0)) } 
  #PatternsWithExplicitTypes.Tuple.Pair(Lit(a#18#0#0), Lit(a#18#1#0))
     == Lit(#PatternsWithExplicitTypes.Tuple.Pair(a#18#0#0, a#18#1#0)));

function PatternsWithExplicitTypes.Tuple._0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#19#0#0: Box, a#19#1#0: Box :: 
  { #PatternsWithExplicitTypes.Tuple.Pair(a#19#0#0, a#19#1#0) } 
  PatternsWithExplicitTypes.Tuple._0(#PatternsWithExplicitTypes.Tuple.Pair(a#19#0#0, a#19#1#0))
     == a#19#0#0);

// Inductive rank
axiom (forall a#20#0#0: Box, a#20#1#0: Box :: 
  { #PatternsWithExplicitTypes.Tuple.Pair(a#20#0#0, a#20#1#0) } 
  BoxRank(a#20#0#0)
     < DtRank(#PatternsWithExplicitTypes.Tuple.Pair(a#20#0#0, a#20#1#0)));

function PatternsWithExplicitTypes.Tuple._1(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#21#0#0: Box, a#21#1#0: Box :: 
  { #PatternsWithExplicitTypes.Tuple.Pair(a#21#0#0, a#21#1#0) } 
  PatternsWithExplicitTypes.Tuple._1(#PatternsWithExplicitTypes.Tuple.Pair(a#21#0#0, a#21#1#0))
     == a#21#1#0);

// Inductive rank
axiom (forall a#22#0#0: Box, a#22#1#0: Box :: 
  { #PatternsWithExplicitTypes.Tuple.Pair(a#22#0#0, a#22#1#0) } 
  BoxRank(a#22#1#0)
     < DtRank(#PatternsWithExplicitTypes.Tuple.Pair(a#22#0#0, a#22#1#0)));
...
procedure CheckWellformed$$PatternsWithExplicitTypes.__default.LetExpr(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
       where $Is(q#0, Tclass.PatternsWithExplicitTypes.Tuple(TInt, TBool))
         && $IsAlloc(q#0, Tclass.PatternsWithExplicitTypes.Tuple(TInt, TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(q#0))
   returns (z#0: int);
...
procedure Call$$PatternsWithExplicitTypes.__default.LetExpr(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
procedure Impl$$PatternsWithExplicitTypes.__default.LetExpr(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
implementation Impl$$PatternsWithExplicitTypes.__default.LetExpr(p#0: DatatypeType, q#0: DatatypeType) returns (z#0: int, $_reverifyPost: bool)
{
  ...
  var let#0#0#0: DatatypeType;
    ...
    // AddMethodImpl: LetExpr, Impl$$PatternsWithExplicitTypes.__default.LetExpr
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(339,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(340,7)
    assume true;
    havoc xx#Z#0;
    havoc yy#Z#0;
    assume LitInt(0) <= xx#Z#0;
    assume let#0#0#0 == q#0;
    assume true;
    // CheckWellformedWithResult: any expression
    assume $Is(let#0#0#0, Tclass.PatternsWithExplicitTypes.Tuple(TInt, TBool));
    assume PatternsWithExplicitTypes.Tuple.Pair_q(let#0#0#0);
    assert $Is($Unbox(PatternsWithExplicitTypes.Tuple._0(let#0#0#0)): int, Tclass._System.nat());
    assume #PatternsWithExplicitTypes.Tuple.Pair($Box(xx#Z#0), $Box(yy#Z#0)) == let#0#0#0;
    assume true;
    z#0 := (var xx#0, yy#0 := $Unbox(PatternsWithExplicitTypes.Tuple._0(q#0)): int, 
        $Unbox(PatternsWithExplicitTypes.Tuple._1(q#0)): bool; 
      xx#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(340,39)"} true;
}



procedure CheckWellformed$$PatternsWithExplicitTypes.__default.LetStmt(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
procedure Call$$PatternsWithExplicitTypes.__default.LetStmt(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
procedure Impl$$PatternsWithExplicitTypes.__default.LetStmt(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
implementation Impl$$PatternsWithExplicitTypes.__default.LetStmt(p#0: DatatypeType, q#0: DatatypeType) returns (z#0: int, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var xx#0: int;
  var yy#0: bool;
  var let#0#0#0: DatatypeType;
    ...
    // AddMethodImpl: LetStmt, Impl$$PatternsWithExplicitTypes.__default.LetStmt
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/LetExpr.dfy(343,2): initial state"} true;
    $_reverifyPost := false;
    havoc xx#0;
    assume LitInt(0) <= xx#0;
    havoc yy#0;
    assume let#0#0#0 == q#0;
    assume true;
    // CheckWellformedWithResult: any expression
    ...
    assume PatternsWithExplicitTypes.Tuple.Pair_q(let#0#0#0);
    assert $Is($Unbox(PatternsWithExplicitTypes.Tuple._0(let#0#0#0)): int, Tclass._System.nat());
    assume #PatternsWithExplicitTypes.Tuple.Pair($Box(xx#0), $Box(yy#0)) == let#0#0#0;
}



procedure CheckWellformed$$PatternsWithExplicitTypes.__default.LetExpr_k(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
procedure Call$$PatternsWithExplicitTypes.__default.LetExpr_k(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
procedure Impl$$PatternsWithExplicitTypes.__default.LetExpr_k(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
procedure CheckWellformed$$PatternsWithExplicitTypes.__default.LetStmt_k(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
procedure Call$$PatternsWithExplicitTypes.__default.LetStmt_k(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
...
procedure Impl$$PatternsWithExplicitTypes.__default.LetStmt_k(p#0: DatatypeType
       where $Is(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool))
         && $IsAlloc(p#0, Tclass.PatternsWithExplicitTypes.Tuple(Tclass._System.nat(), TBool), $Heap)
         && $IsA#PatternsWithExplicitTypes.Tuple(p#0), 
    q#0: DatatypeType
