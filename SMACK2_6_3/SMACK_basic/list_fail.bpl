...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/list_fail.c -bpl ./list_fail.bpl
...
axiom (search_list == $sub.ref(0, 2064));
procedure {:inline 1} search_list($p0: ref, $i1: i32)
  returns ($r: ref)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $p10: ref;
$bb0:
  assume {:sourceloc "test/c/basic/list_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "search_list:arg:k"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/basic/list_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  $p2 := $M.0;
  assume {:sourceloc "test/c/basic/list_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $p2;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/list_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/list_fail.c", 16, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.ref($p3, $0.ref);
  assume {:sourceloc "test/c/basic/list_fail.c", 16, 20} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/basic/list_fail.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/list_fail.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.1, $p6);
  assume {:sourceloc "test/c/basic/list_fail.c", 16, 30} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, $i1);
  assume {:verifier.code 0} true;
  $i5 := $i8;
...
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/basic/list_fail.c", 17, 12} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/basic/list_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := $p3;
  $exn := false;
  return;
...
axiom (insert_list == $sub.ref(0, 3096));
procedure {:inline 1} insert_list($p0: ref, $i1: i32)
{
  var $p2: ref;
  var $p3: ref;
  var $p4: ref;
  ...
  var $p10: ref;
$bb0:
  assume {:sourceloc "test/c/basic/list_fail.c", 23, 16} true;
  assume {:verifier.code 0} true;
  call {:cexpr "insert_list:arg:k"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/basic/list_fail.c", 23, 16} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(16);
  assume {:sourceloc "test/c/basic/list_fail.c", 23, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/basic/list_fail.c", 24, 6} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/list_fail.c", 24, 10} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, $i1);
  assume {:sourceloc "test/c/basic/list_fail.c", 25, 7} true;
  assume {:verifier.code 0} true;
  $p5 := $M.0;
  assume {:sourceloc "test/c/basic/list_fail.c", 25, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.ref($p5, $0.ref);
  assume {:sourceloc "test/c/basic/list_fail.c", 25, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "test/c/basic/list_fail.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/basic/list_fail.c", 26, 13} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p7, $0.ref);
  assume {:sourceloc "test/c/basic/list_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/basic/list_fail.c", 28, 8} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/basic/list_fail.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p8, $i1);
  assume {:sourceloc "test/c/basic/list_fail.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $p9 := $M.0;
  assume {:sourceloc "test/c/basic/list_fail.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p3, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/basic/list_fail.c", 29, 13} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p10, $p9);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/basic/list_fail.c", 31, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $p2;
  assume {:sourceloc "test/c/basic/list_fail.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/list_fail.c", 36, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/list_fail.c", 36, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $0.ref;
  assume {:sourceloc "test/c/basic/list_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  call insert_list($u0, 2);
  assume {:sourceloc "test/c/basic/list_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call insert_list($u0, 5);
  assume {:sourceloc "test/c/basic/list_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  call insert_list($u0, 1);
  assume {:sourceloc "test/c/basic/list_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  call insert_list($u0, 3);
  assume {:sourceloc "test/c/basic/list_fail.c", 41, 22} true;
  assume {:verifier.code 0} true;
  $p0 := $M.0;
  assume {:sourceloc "test/c/basic/list_fail.c", 41, 10} true;
  assume {:verifier.code 0} true;
  call $p1 := search_list($p0, 2);
  assume {:sourceloc "test/c/basic/list_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/list_fail.c", 42, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/list_fail.c", 43, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
