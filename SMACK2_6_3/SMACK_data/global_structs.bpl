...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/global_structs.c -bpl ./global_structs.bpl
...
procedure {:inline 1} mutex_lock($p0: ref)
{
  ...
  var $p8: ref;
$bb0:
  assume {:sourceloc "test/c/data/global_structs.c", 14, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/global_structs.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/data/global_structs.c", 15, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/data/global_structs.c", 16, 9} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/global_structs.c", 16, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p7, 1);
  assume {:sourceloc "test/c/data/global_structs.c", 17, 9} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/global_structs.c", 17, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p8, 2);
  assume {:sourceloc "test/c/data/global_structs.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/global_structs.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/global_structs.c", 21, 3} true;
  assume {:verifier.code 0} true;
  call mutex_lock(m_inode);
  assume {:sourceloc "test/c/data/global_structs.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call mutex_lock(m_busy);
  assume {:sourceloc "test/c/data/global_structs.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
