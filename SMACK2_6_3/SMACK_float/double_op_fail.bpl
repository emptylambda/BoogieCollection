...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/double_op_fail.c -bpl ./double_op_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/double_op_fail.c", 14, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/float/double_op_fail.c", 14, 10} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/double_op_fail.c:14:10: warning: over-approximating floating-point arithmetic fmul; */
  $f0 := $fmul.float($fp(1, 990000, 0), $fp(5, 0, 1));
  assume {:sourceloc "test/c/float/double_op_fail.c", 14, 15} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/float/double_op_fail.c:14:15: warning: over-approximating floating-point arithmetic fdiv; */
  $f1 := $fdiv.float($f0, $fp(5, 0, 1));
  call {:cexpr "c"} boogie_si_record_float($f1);
  assume {:sourceloc "test/c/float/double_op_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/double_op_fail.c", 15, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/double_op_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
