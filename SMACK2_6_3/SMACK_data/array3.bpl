...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/array3.c -bpl ./array3.bpl
...
procedure {:inline 1} initializeArray($p0: ref)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "test/c/data/array3.c", 15, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array3.c", 15, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 10);
  assume {:sourceloc "test/c/data/array3.c", 15, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/array3.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/array3.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0, $mul.ref($i3, 4));
  assume {:sourceloc "test/c/data/array3.c", 16, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 0);
  assume {:sourceloc "test/c/data/array3.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/array3.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/array3.c", 15, 29} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/array3.c", 22, 23} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/array3.c", 22, 23} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(40);
  assume {:sourceloc "test/c/data/array3.c", 22, 16} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/data/array3.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call initializeArray($p1);
  assume {:sourceloc "test/c/data/array3.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array3.c", 26, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, 10);
  assume {:sourceloc "test/c/data/array3.c", 26, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/array3.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/array3.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/data/array3.c", 30, 3} true;
  assume {:verifier.code 0} true;
  call free_($p9);
  assume {:sourceloc "test/c/data/array3.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/data/array3.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/data/array3.c", 26, 29} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i2, 1);
