...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strtok_fail.c -bpl ./strtok_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 25778));
...
axiom (.str.2 == $sub.ref(0, 3080));
const {:count 2} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 4106));
const main: ref;
axiom (main == $sub.ref(0, 5138));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strtok_fail.c", 9, 20} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strtok_fail.c", 9, 20} true;
  assume {:verifier.code 0} true;
  call $p0 := strtok(.str, .str.1);
  assume $isExternal($p0);
  assume {:sourceloc "test/c/strings/strtok_fail.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call $p1 := strtok($0.ref, .str.1);
  assume $isExternal($p1);
  assume {:sourceloc "test/c/strings/strtok_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strtok_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i2 := strcmp($p0, .str.2);
  assume {:sourceloc "test/c/strings/strtok_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "test/c/strings/strtok_fail.c", 12, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strtok_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/strings/strtok_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := strcmp($p1, .str.3);
  assume {:sourceloc "test/c/strings/strtok_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4, 0);
  assume {:sourceloc "test/c/strings/strtok_fail.c", 13, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/strings/strtok_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strtok: ref;
axiom (strtok == $sub.ref(0, 6170));
procedure {:inline 1} strtok($p0: ref, $p1: ref)
  returns ($r: ref);
const strcmp: ref;
axiom (strcmp == $sub.ref(0, 7202));
procedure {:inline 1} strcmp($p0: ref, $p1: ref)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 8234));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 9266));
...
axiom (__SMACK_dummy == $sub.ref(0, 10298));
...
axiom (__VERIFIER_assert == $sub.ref(0, 11330));
...
axiom (__SMACK_and32 == $sub.ref(0, 12362));
...
axiom (__SMACK_and64 == $sub.ref(0, 13394));
...
axiom (__SMACK_and16 == $sub.ref(0, 14426));
...
axiom (__SMACK_and8 == $sub.ref(0, 15458));
...
axiom (__SMACK_or32 == $sub.ref(0, 16490));
...
axiom (__SMACK_or64 == $sub.ref(0, 17522));
...
axiom (__SMACK_or16 == $sub.ref(0, 18554));
...
axiom (__SMACK_or8 == $sub.ref(0, 19586));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 20618));
...
axiom (__SMACK_decls == $sub.ref(0, 21650));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 22682));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 23714));
...
axiom (llvm.dbg.value == $sub.ref(0, 24746));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 25778));
