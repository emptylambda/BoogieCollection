...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/simple_pre2.c -bpl ./simple_pre2.bpl
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/basic/simple_pre2.c", 7, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "incr:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/simple_pre2.c", 7, 28} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  assume {:sourceloc "test/c/basic/simple_pre2.c", 7, 19} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/simple_pre2.c", 13, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/simple_pre2.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/simple_pre2.c", 14, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/simple_pre2.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
