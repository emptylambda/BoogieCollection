...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/adjacent_global.c -bpl ./adjacent_global.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/adjacent_global.c", 9, 11} true;
  ...
  assume {:sourceloc "test/c/memory-safety/adjacent_global.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
