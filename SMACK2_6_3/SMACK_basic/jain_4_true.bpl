...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/jain_4_true.c -bpl ./jain_4_true.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/jain_4_true.c", 8, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/jain_4_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/jain_4_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/jain_4_true.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/jain_4_true.c", 9, 17} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 9, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $mul.i32(4, $i3);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, $i4);
  call {:cexpr "x"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 10, 17} true;
  assume {:verifier.code 1} true;
  call $i6 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 10, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i32(4, $i6);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 10, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i0, $i7);
  call {:cexpr "y"} boogie_si_record_i32($i8);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 11, 17} true;
  assume {:verifier.code 1} true;
  call $i9 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i9);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 11, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $mul.i32(8, $i9);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 11, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i2, $i10);
  call {:cexpr "z"} boogie_si_record_i32($i11);
  assume {:sourceloc "test/c/basic/jain_4_true.c", 12, 5} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/basic/jain_4_true.c", 12, 5} true;
...
axiom (__SMACK_nondet_int == $sub.ref(0, 16512));
