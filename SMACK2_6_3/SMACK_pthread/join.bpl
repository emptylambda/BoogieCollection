...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/join.c -bpl ./join.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/join.c", 10, 4} true;
  ...
  assume {:sourceloc "test/c/pthread/join.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "test/c/pthread/join.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/join.c", 18, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join.c", 19, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread/join.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_join($i2, $0.ref);
  assume {:sourceloc "test/c/pthread/join.c", 20, 4} true;
  assume {:verifier.code 0} true;
  $i4 := $M.0;
  assume {:sourceloc "test/c/pthread/join.c", 20, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/join.c", 21, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/join.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
