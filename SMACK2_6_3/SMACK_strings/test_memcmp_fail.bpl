...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/test_memcmp_fail.c -bpl ./test_memcmp_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 7, 8} true;
  ...
  assume true;
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 8, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 9, 8} true;
  assume {:verifier.code 0} true;
  call $M.5 := $memcpy.i8($M.5, $M.4, $p5, __const.main.word3, 12, false);
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 12, 20} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 12, 27} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p1, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 12, 13} true;
  assume {:verifier.code 0} true;
  call $i8 := memcmp($p6, $p7, 11);
  call {:cexpr "result1"} boogie_si_record_i32($i8);
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 13, 20} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 13, 27} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p2, $mul.ref(0, 12)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call $i11 := memcmp($p9, $p10, 11);
  call {:cexpr "result2"} boogie_si_record_i32($i11);
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 14, 3} true;
...
$bb6:
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "test/c/strings/test_memcmp_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb0:
  ...
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(9, 1)), 112);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.word2, $mul.ref(0, 12)), $mul.ref(10, 1)), 121);
  ...
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(9, 1)), 109);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.word3, $mul.ref(0, 12)), $mul.ref(10, 1)), 112);
