...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/nondet_pointer_fail.c -bpl ./nondet_pointer_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/nondet_pointer_fail.c", 7, 7} true;
  ...
  assume {:sourceloc "test/c/data/nondet_pointer_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/nondet_pointer_fail.c", 8, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/nondet_pointer_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet == $sub.ref(0, 2064));
