...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/lock_fail.c -bpl ./lock_fail.bpl
...
const main_lock: ref;
axiom (main_lock == $sub.ref(0, 1032));
const global_lock: ref;
axiom (global_lock == $sub.ref(0, 2064));
const acquire_lock: ref;
axiom (acquire_lock == $sub.ref(0, 3096));
procedure {:inline 1} acquire_lock($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
  var $i3: i1;
  var $p4: ref;
$bb0:
  assume {:sourceloc "test/c/basic/lock_fail.c", 19, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/lock_fail.c", 20, 6} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/basic/lock_fail.c", 20, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 1);
  assume {:sourceloc "test/c/basic/lock_fail.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const release_lock: ref;
axiom (release_lock == $sub.ref(0, 4128));
procedure {:inline 1} release_lock($p0: ref)
{
  var $p1: ref;
  var $i2: i32;
  var $i3: i1;
  var $p4: ref;
$bb0:
  assume {:sourceloc "test/c/basic/lock_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/lock_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/lock_fail.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/basic/lock_fail.c", 25, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 0);
  assume {:sourceloc "test/c/basic/lock_fail.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/lock_fail.c", 29, 20} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/lock_fail.c", 29, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $add.ref($add.ref(main_lock, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  assume {:sourceloc "test/c/basic/lock_fail.c", 30, 22} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $add.ref($add.ref(global_lock, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  assume {:sourceloc "test/c/basic/lock_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  call acquire_lock(main_lock);
  assume {:sourceloc "test/c/basic/lock_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  call acquire_lock(global_lock);
  assume {:sourceloc "test/c/basic/lock_fail.c", 33, 3} true;
  assume {:verifier.code 0} true;
  call release_lock(main_lock);
  assume {:sourceloc "test/c/basic/lock_fail.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call acquire_lock(global_lock);
  assume {:sourceloc "test/c/basic/lock_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
{
$bb0:
  $M.1 := $store.i32($M.1, main_lock, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(main_lock, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  $M.1 := $store.i32($M.1, global_lock, 0);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(global_lock, $mul.ref(0, 8)), $mul.ref(4, 1)), 0);
  $exn := false;
  return;
}
