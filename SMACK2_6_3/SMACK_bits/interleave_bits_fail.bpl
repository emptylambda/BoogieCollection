...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/interleave_bits_fail.c -bpl ./interleave_bits_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 12, 22} true;
  ...
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 13, 22} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_unsigned_short();
  call {:cexpr "smack:ext:__VERIFIER_nondet_unsigned_short"} boogie_si_record_i16($i1);
  call {:cexpr "y"} boogie_si_record_i16($i1);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i3);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i64($i4, 16);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i16.i32($i0);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 20} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:23:20: warning: over-approximating bitwise operation shl; */
  $i7 := $shl.i32(1, $i3);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 14} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:23:14: warning: over-approximating bitwise operation and; */
  $i8 := $and.i32($i6, $i7);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 27} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:23:27: warning: over-approximating bitwise operation shl; */
  $i9 := $shl.i32($i8, $i3);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 37} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i16.i32($i1);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 45} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:23:45: warning: over-approximating bitwise operation shl; */
  $i11 := $shl.i32(1, $i3);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 39} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:23:39: warning: over-approximating bitwise operation and; */
  $i12 := $and.i32($i10, $i11);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 58} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i3, 1);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 52} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:23:52: warning: over-approximating bitwise operation shl; */
  $i14 := $shl.i32($i12, $i13);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 33} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:23:33: warning: over-approximating bitwise operation or; */
  $i15 := $or.i32($i9, $i14);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 23, 7} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:23:7: warning: over-approximating bitwise operation or; */
  $i16 := $or.i32($i2, $i15);
  call {:cexpr "z"} boogie_si_record_i32($i16);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32($i3, 1);
...
$bb3:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 27, 8} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i16.i32($i0);
  call {:cexpr "xx"} boogie_si_record_i32($i18);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 28, 8} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i16.i32($i1);
  call {:cexpr "yy"} boogie_si_record_i32($i19);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 30, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:30:18: warning: over-approximating bitwise operation shl; */
  $i20 := $shl.i32($i18, 8);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 30, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:30:12: warning: over-approximating bitwise operation or; */
  $i21 := $or.i32($i18, $i20);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 30, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:30:26: warning: over-approximating bitwise operation and; */
  $i22 := $and.i32($i21, 16711935);
  call {:cexpr "xx"} boogie_si_record_i32($i22);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 31, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:31:18: warning: over-approximating bitwise operation shl; */
  $i23 := $shl.i32($i22, 4);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 31, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:31:12: warning: over-approximating bitwise operation or; */
  $i24 := $or.i32($i22, $i23);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 31, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:31:26: warning: over-approximating bitwise operation and; */
  $i25 := $and.i32($i24, 252645135);
  call {:cexpr "xx"} boogie_si_record_i32($i25);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 32, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:32:18: warning: over-approximating bitwise operation shl; */
  $i26 := $shl.i32($i25, 2);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 32, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:32:12: warning: over-approximating bitwise operation or; */
  $i27 := $or.i32($i25, $i26);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 32, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:32:26: warning: over-approximating bitwise operation and; */
  $i28 := $and.i32($i27, 858993459);
  call {:cexpr "xx"} boogie_si_record_i32($i28);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 33, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:33:18: warning: over-approximating bitwise operation shl; */
  $i29 := $shl.i32($i28, 1);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 33, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:33:12: warning: over-approximating bitwise operation or; */
  $i30 := $or.i32($i28, $i29);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 33, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:33:26: warning: over-approximating bitwise operation and; */
  $i31 := $and.i32($i30, 1431655765);
  call {:cexpr "xx"} boogie_si_record_i32($i31);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 35, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:35:18: warning: over-approximating bitwise operation shl; */
  $i32 := $shl.i32($i19, 8);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 35, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:35:12: warning: over-approximating bitwise operation or; */
  $i33 := $or.i32($i19, $i32);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 35, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:35:26: warning: over-approximating bitwise operation and; */
  $i34 := $and.i32($i33, 16711935);
  call {:cexpr "yy"} boogie_si_record_i32($i34);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 36, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:36:18: warning: over-approximating bitwise operation shl; */
  $i35 := $shl.i32($i34, 4);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 36, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:36:12: warning: over-approximating bitwise operation or; */
  $i36 := $or.i32($i34, $i35);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 36, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:36:26: warning: over-approximating bitwise operation and; */
  $i37 := $and.i32($i36, 252645135);
  call {:cexpr "yy"} boogie_si_record_i32($i37);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 37, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:37:18: warning: over-approximating bitwise operation shl; */
  $i38 := $shl.i32($i37, 2);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 37, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:37:12: warning: over-approximating bitwise operation or; */
  $i39 := $or.i32($i37, $i38);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 37, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:37:26: warning: over-approximating bitwise operation and; */
  $i40 := $and.i32($i39, 858993459);
  call {:cexpr "yy"} boogie_si_record_i32($i40);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 38, 18} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:38:18: warning: over-approximating bitwise operation shl; */
  $i41 := $shl.i32($i40, 1);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 38, 12} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:38:12: warning: over-approximating bitwise operation or; */
  $i42 := $or.i32($i40, $i41);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 38, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:38:26: warning: over-approximating bitwise operation and; */
  $i43 := $and.i32($i42, 1431655765);
  call {:cexpr "yy"} boogie_si_record_i32($i43);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 40, 17} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:40:17: warning: over-approximating bitwise operation shl; */
  $i44 := $shl.i32($i43, 2);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 40, 11} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/interleave_bits_fail.c:40:11: warning: over-approximating bitwise operation or; */
  $i45 := $or.i32($i31, $i44);
  call {:cexpr "zz"} boogie_si_record_i32($i45);
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 42, 3} true;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/bits/interleave_bits_fail.c", 43, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_nondet_unsigned_short == $sub.ref(0, 15480));
...
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 16512));
