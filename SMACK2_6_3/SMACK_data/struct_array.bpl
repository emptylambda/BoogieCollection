...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_array.c -bpl ./struct_array.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_array.c", 13, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/struct_array.c", 13, 9} true;
  assume {:verifier.code 0} true;
  $i0 := $load.i16($M.0, $add.ref($add.ref(s, $mul.ref(0, 8)), $mul.ref(6, 1)));
  assume {:sourceloc "test/c/data/struct_array.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $sext.i16.i64($i0);
  $p2 := $add.ref($add.ref($add.ref(s, $mul.ref(0, 8)), $mul.ref(0, 1)), $mul.ref($i1, 2));
  assume {:sourceloc "test/c/data/struct_array.c", 13, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i16($M.0, $p2, 1);
  assume {:sourceloc "test/c/data/struct_array.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_array.c", 14, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/struct_array.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/data/struct_array.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i16($M.0, $add.ref($add.ref($add.ref(s, $mul.ref(0, 8)), $mul.ref(0, 1)), $mul.ref(1, 2)));
  assume {:sourceloc "test/c/data/struct_array.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i16.i32($i6);
  assume {:sourceloc "test/c/data/struct_array.c", 15, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/data/struct_array.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
{
$bb0:
  $M.0 := $store.i16($M.0, s, 0);
  $M.0 := $store.i16($M.0, $add.ref($add.ref($add.ref(s, $mul.ref(0, 8)), $mul.ref(0, 1)), $mul.ref(1, 2)), 0);
  $M.0 := $store.i16($M.0, $add.ref($add.ref($add.ref(s, $mul.ref(0, 8)), $mul.ref(0, 1)), $mul.ref(2, 2)), 0);
  $M.0 := $store.i16($M.0, $add.ref($add.ref(s, $mul.ref(0, 8)), $mul.ref(6, 1)), 0);
  $exn := false;
  return;
}
