...
axiom 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    TargetedMonotonicity.__default.Next#canCall(x#0) || 0 != $FunctionContextHeight
       ==> true);
...
procedure CheckWellformed$$TargetedMonotonicity.__default.Next(x#0: int);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int, y#0: int, z#0: int :: 
    { TargetedMonotonicity.__default.P($ly, x#0, y#0, z#0) } 
    TargetedMonotonicity.__default.P#canCall(x#0, y#0, z#0)
...
procedure CheckWellformed$$TargetedMonotonicity.__default.P(x#0: int, y#0: int, z#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$TargetedMonotonicity.__default.P(x#0: int, y#0: int, z#0: int)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(237,18): initial state"} true;
    ...
    else
    {
        ...
        if (!(x#0 == LitInt(0) && y#0 == z#0))
        {
            if (x#0 != 0)
            {
                ...
                assume TargetedMonotonicity.__default.Next#canCall(x#0);
                ##x#1 := TargetedMonotonicity.__default.Next(x#0);
                // assume allocatedness for argument to function
                ...
                assume TargetedMonotonicity.__default.P#canCall(TargetedMonotonicity.__default.Next(x#0), y#0, z#0);
            }
        }

        assume TargetedMonotonicity.__default.P($LS($LZ), x#0, y#0, z#0)
           == ((x#0 == LitInt(0) && y#0 == z#0)
             || (x#0 != 0
               && TargetedMonotonicity.__default.P($LS($LZ), TargetedMonotonicity.__default.Next(x#0), y#0, z#0)));
        assume !(x#0 == LitInt(0) && y#0 == z#0)
           ==> 
          x#0 != 0
           ==> TargetedMonotonicity.__default.Next#canCall(x#0)
             && TargetedMonotonicity.__default.P#canCall(TargetedMonotonicity.__default.Next(x#0), y#0, z#0);
        // CheckWellformedWithResult: any expression
        assume $Is(TargetedMonotonicity.__default.P($LS($LZ), x#0, y#0, z#0), TBool);
        assert b$reqreads#0;
        assert b$reqreads#1;
    }
}
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int, y#0: int, z#0: int :: 
    { TargetedMonotonicity.__default.P_h($ly, _k#0, x#0, y#0, z#0) } 
    TargetedMonotonicity.__default.P_h#canCall(_k#0, x#0, y#0, z#0)
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int, y#0: int, z#0: int :: 
    ...
    TargetedMonotonicity.__default.P_h#canCall(Lit(_k#0), x#0, y#0, z#0)
         || 2 != $FunctionContextHeight
       ==> (0 < ORD#Offset(_k#0)
           ==> 
          !(x#0 == LitInt(0) && y#0 == z#0)
         ...
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#1: Box :: 
            { TargetedMonotonicity.__default.P_h($LS($ly), _k'#1, x#0, y#0, z#0) } 
            ORD#LessThanLimit(_k'#1, _k#0)
               ==> TargetedMonotonicity.__default.P_h#canCall(_k'#1, x#0, y#0, z#0)))
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, x#0: int, y#0: int, z#0: int :: 
    ...
    TargetedMonotonicity.__default.P_h#canCall(Lit(_k#0), LitInt(x#0), LitInt(y#0), LitInt(z#0))
         || 2 != $FunctionContextHeight
       ==> (0 < ORD#Offset(_k#0)
           ==> 
          !(x#0 == LitInt(0) && y#0 == z#0)
         ...
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
            { TargetedMonotonicity.__default.P_h($LS($ly), _k'#2, x#0, y#0, z#0) } 
            ORD#LessThanLimit(_k'#2, _k#0)
               ==> TargetedMonotonicity.__default.P_h#canCall(_k'#2, x#0, y#0, z#0)))
...
procedure CheckWellformed$$TargetedMonotonicity.__default.Deterministic(x#0: int, y#0: int, z#0: int, z'#0: int);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$TargetedMonotonicity.__default.Deterministic(x#0: int, y#0: int, z#0: int, z'#0: int);
  // user-defined preconditions
  requires TargetedMonotonicity.__default.P#canCall(x#0, y#0, z#0)
     ==> TargetedMonotonicity.__default.P($LS($LZ), x#0, y#0, z#0)
       || 
      (x#0 == LitInt(0) && y#0 == z#0)
       || (x#0 != 0
         && TargetedMonotonicity.__default.P($LS($LS($LZ)), TargetedMonotonicity.__default.Next(x#0), y#0, z#0));
  requires TargetedMonotonicity.__default.P#canCall(x#0, y#0, z'#0)
     ==> TargetedMonotonicity.__default.P($LS($LZ), x#0, y#0, z'#0)
       || 
      (x#0 == LitInt(0) && y#0 == z'#0)
...
procedure {:_induction _k#0, x#1, y#1, z#1, z'#1} CoCall$$TargetedMonotonicity.__default.Deterministic_h(_k#0: Box, x#1: int, y#1: int, z#1: int, z'#1: int);
  // user-defined preconditions
  requires TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z#1)
     ==> TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z#1)
       || (0 < ORD#Offset(_k#0)
         ==> (x#1 == LitInt(0) && y#1 == z#1)
           || (x#1 != 0
             && TargetedMonotonicity.__default.P_h($LS($LS($LZ)), 
              ORD#Minus(_k#0, ORD#FromNat(1)), 
              TargetedMonotonicity.__default.Next(x#1), 
              y#1, 
              z#1)));
  requires TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z#1)
     ==> TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z#1)
  ...
  requires TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z'#1)
     ==> TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z'#1)
       || (LitInt(0) == ORD#Offset(_k#0)
         ==> (exists _k'#1: Box :: 
          { TargetedMonotonicity.__default.P_h($LS($LZ), _k'#1, x#1, y#1, z'#1) } 
          ORD#LessThanLimit(_k'#1, _k#0)
             && TargetedMonotonicity.__default.P_h($LS($LZ), _k'#1, x#1, y#1, z'#1)));
  modifies $Heap, $Tick;
  // user-defined postconditions
...
procedure {:_induction _k#0, x#1, y#1, z#1, z'#1} Impl$$TargetedMonotonicity.__default.Deterministic_h(_k#0: Box, x#1: int, y#1: int, z#1: int, z'#1: int)
   returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  // user-defined preconditions
  free requires TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z#1)
     && 
    TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z#1)
     && 
    (0 < ORD#Offset(_k#0)
       ==> (x#1 == LitInt(0) && y#1 == z#1)
         || (x#1 != 0
           && TargetedMonotonicity.__default.P_h($LS($LZ), 
            ORD#Minus(_k#0, ORD#FromNat(1)), 
            TargetedMonotonicity.__default.Next(x#1), 
            y#1, 
            z#1)))
     && (LitInt(0) == ORD#Offset(_k#0)
       ==> (exists _k'#2: Box :: 
        { TargetedMonotonicity.__default.P_h($LS($LZ), _k'#2, x#1, y#1, z#1) } 
        ORD#LessThanLimit(_k'#2, _k#0)
           && TargetedMonotonicity.__default.P_h($LS($LZ), _k'#2, x#1, y#1, z#1)));
  free requires TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z'#1)
     && 
    ...
    (0 < ORD#Offset(_k#0)
     ...
     && (LitInt(0) == ORD#Offset(_k#0)
       ==> (exists _k'#3: Box :: 
        { TargetedMonotonicity.__default.P_h($LS($LZ), _k'#3, x#1, y#1, z'#1) } 
...
implementation {:_induction _k#0, x#1, y#1, z#1, z'#1} Impl$$TargetedMonotonicity.__default.Deterministic_h(_k#0: Box, x#1: int, y#1: int, z#1: int, z'#1: int)
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  ...
  var $initHeapForallStmt#1: Heap;
    ...
    // AddMethodImpl: Deterministic#, Impl$$TargetedMonotonicity.__default.Deterministic_h
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(243,14): initial state"} true;
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#_k0#0: Box, $ih#x0#0: int, $ih#y0#0: int, $ih#z0#0: int, $ih#z'0#0: int :: 
      TargetedMonotonicity.__default.P_h($LS($LZ), $ih#_k0#0, $ih#x0#0, $ih#y0#0, $ih#z0#0)
           && TargetedMonotonicity.__default.P_h($LS($LZ), $ih#_k0#0, $ih#x0#0, $ih#y0#0, $ih#z'0#0)
           && (ORD#Less($ih#_k0#0, _k#0)
             || ($ih#_k0#0 == _k#0
               && ((0 <= $ih#x0#0 && $ih#x0#0 < x#1)
                 || ($ih#x0#0 == x#1
                   && ((0 <= $ih#y0#0 && $ih#y0#0 < y#1)
                     || ($ih#y0#0 == y#1
                       && ((0 <= $ih#z0#0 && $ih#z0#0 < z#1)
                         || ($ih#z0#0 == z#1 && 0 <= $ih#z'0#0 && $ih#z'0#0 < z'#1))))))))
         ==> $ih#z0#0 == $ih#z'0#0);
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(246,3)
    assume true;
    ...
    {
        // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(243,15)
        $initHeapForallStmt#1 := $Heap;
        havoc $Heap, $Tick;
        assume $initHeapForallStmt#1 == $Heap;
        assume (forall _k'#4: Box, x#2: int, y#2: int, z#2: int, z'#2: int :: 
          ORD#Less(_k'#4, _k#0)
               && 
              TargetedMonotonicity.__default.P_h($LS($LZ), _k'#4, x#2, y#2, z#2)
               && TargetedMonotonicity.__default.P_h($LS($LZ), _k'#4, x#2, y#2, z'#2)
             ==> z#2 == z'#2);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/InductivePredicates.dfy(243,14)"} true;
    }
}
