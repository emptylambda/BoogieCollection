...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/failing/atomic_cas_fail.c -bpl ./atomic_cas_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 9, 8} true;
  ...
  assume true;
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 10, 7} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, 0);
  assume true;
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 11, 12} true;
  assume {:verifier.code 0} true;
  $p4 := $load.ref($M.0, $p0);
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p2, $p4);
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p3, $p1);
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p10 := $load.i64($M.2, $p5);
  $M.2 := $store.i64($M.2, $p5, (if ($load.i64($M.2, $p5) == $i8) then $i9 else $load.i64($M.2, $p5)));
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i11 := $extractvalue.i64($p10, 0);
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i12 := $extractvalue.i1($p10, 1);
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i12 == 1));
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/failing/atomic_cas_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
