// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy -print:./git-issue88.bpl
...
implementation Impl$$_module.__default.M2() returns ($_reverifyPost: bool)
{
  ...
  var $rhs#0: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(6,12): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(7,15)
    assume true;
    assert 0 <= LitInt(9);
    assert 0 <= LitInt(9);
    havoc $nw;
    ...
    g#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(7,29)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(8,10)
    assert g#0 != null;
    assert 0 <= LitInt(0) && LitInt(0) < _System.array2.Length0(g#0);
    assert 0 <= LitInt(0) && LitInt(0) < _System.array2.Length1(g#0);
    assume true;
    assert $_Frame[g#0, MultiIndexField(IndexField(LitInt(0)), LitInt(0))];
    assume true;
    $rhs#0 := LitInt(1);
    $Heap := update($Heap, g#0, MultiIndexField(IndexField(LitInt(0)), LitInt(0)), $Box($rhs#0));
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(8,13)"} true;
}
...
implementation Impl$$_module.__default.M1() returns ($_reverifyPost: bool)
{
  ...
  var $rhs#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(13,12): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(14,15)
    assume true;
    assert 0 <= LitInt(9);
    havoc $nw;
    ...
    assume $IsHeapAnchor($Heap);
    g#0 := $nw;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(14,27)"} true;
    // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(15,8)
    assert g#0 != null;
    assert 0 <= LitInt(0) && LitInt(0) < _System.array.Length(g#0);
    assume true;
    assert $_Frame[g#0, IndexField(LitInt(0))];
    assume true;
    $rhs#0 := LitInt(1);
    $Heap := update($Heap, g#0, IndexField(LitInt(0)), $Box($rhs#0));
    assume $IsGoodHeap($Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(15,11)"} true;
}
...
implementation Impl$$_module.__default._default_Main() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(19,0): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(20,5)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.__default.M2();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(20,6)"} true;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(21,5)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$_module.__default.M1();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/git-issue88.dfy(21,6)"} true;
}
