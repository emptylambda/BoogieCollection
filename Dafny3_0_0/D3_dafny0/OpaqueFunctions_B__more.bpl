...
procedure CheckWellformed$$B__more.__default.L(c#0: ref
       where $Is(c#0, Tclass.B____more.X.Abs.C())
         && $IsAlloc(c#0, Tclass.B____more.X.Abs.C(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$B__more.__default.L(c#0: ref
       where $Is(c#0, Tclass.B____more.X.Abs.C())
         && $IsAlloc(c#0, Tclass.B____more.X.Abs.C(), $Heap));
  modifies $Heap, $Tick;
...
procedure Impl$$B__more.__default.L(c#0: ref
       where $Is(c#0, Tclass.B____more.X.Abs.C())
         && $IsAlloc(c#0, Tclass.B____more.X.Abs.C(), $Heap))
...
implementation Impl$$B__more.__default.L(c#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;

    // AddMethodImpl: L, Impl$$B__more.__default.L
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> $o == c#0);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(134,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(135,5)
    assert {:subsumption 0} c#0 != null;
    assume B____more.X.Abs.C.Get#canCall($Heap, c#0);
    assert {:subsumption 0} c#0 != null;
    assume B____more.X.Abs.C.Get#canCall($Heap, c#0);
    assert B____more.X.Abs.C.Get($Heap, c#0) == read($Heap, c#0, B____more.X.Abs.C.x);
}
