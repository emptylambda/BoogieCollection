...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/failing/extern_mem2.c -bpl ./extern_mem2.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/failing/extern_mem2.c", 10, 12} true;
  ...
  assume {:sourceloc "test/c/failing/extern_mem2.c", 11, 12} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(4);
  assume {:sourceloc "test/c/failing/extern_mem2.c", 11, 12} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/failing/extern_mem2.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call foo($p3);
  assume {:sourceloc "test/c/failing/extern_mem2.c", 15, 7} true;
  assume {:verifier.code 0} true;
  call $p4 := bar();
  assume $isExternal($p4);
  assume {:sourceloc "test/c/failing/extern_mem2.c", 16, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, 1);
  assume {:sourceloc "test/c/failing/extern_mem2.c", 17, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p4, 2);
  assume {:sourceloc "test/c/failing/extern_mem2.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/failing/extern_mem2.c", 18, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/failing/extern_mem2.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
