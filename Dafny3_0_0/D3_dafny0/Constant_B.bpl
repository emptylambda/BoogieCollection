...
procedure CheckWellformed$$B.__default.x();
...
axiom 0 < $FunctionContextHeight ==> $Is(B.__default.x(), TInt);
...
procedure CheckWellformed$$B.__default.TestRhsIsInherited();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$B.__default.TestRhsIsInherited();
  modifies $Heap, $Tick;
  // frame condition
...
procedure Impl$$B.__default.TestRhsIsInherited() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
...
implementation Impl$$B.__default.TestRhsIsInherited() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;

    // AddMethodImpl: TestRhsIsInherited, Impl$$B.__default.TestRhsIsInherited
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(229,29): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Constant.dfy(230,5)
    assume true;
