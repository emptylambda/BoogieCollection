...
axiom (forall a#19#0#0: Box, a#19#1#0: DatatypeType :: 
  { #Regression.List.Cons(a#19#0#0, a#19#1#0) } 
  DatatypeCtorId(#Regression.List.Cons(a#19#0#0, a#19#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  Regression.List.Cons_q(d)
     ==> (exists a#20#0#0: Box, a#20#1#0: DatatypeType :: 
      d == #Regression.List.Cons(a#20#0#0, a#20#1#0)));

// Constructor $Is
axiom (forall Regression.List$A: Ty, a#21#0#0: Box, a#21#1#0: DatatypeType :: 
  { $Is(#Regression.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.Regression.List(Regression.List$A)) } 
  $Is(#Regression.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.Regression.List(Regression.List$A))
     <==> $IsBox(a#21#0#0, Regression.List$A)
       && $Is(a#21#1#0, Tclass.Regression.List(Regression.List$A)));

// Constructor $IsAlloc
axiom (forall Regression.List$A: Ty, a#22#0#0: Box, a#22#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#Regression.List.Cons(a#22#0#0, a#22#1#0), 
      Tclass.Regression.List(Regression.List$A), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#Regression.List.Cons(a#22#0#0, a#22#1#0), 
        Tclass.Regression.List(Regression.List$A), 
        $h)
       <==> $IsAllocBox(a#22#0#0, Regression.List$A, $h)
         && $IsAlloc(a#22#1#0, Tclass.Regression.List(Regression.List$A), $h)));
...
axiom (forall a#23#0#0: Box, a#23#1#0: DatatypeType :: 
  { #Regression.List.Cons(Lit(a#23#0#0), Lit(a#23#1#0)) } 
  #Regression.List.Cons(Lit(a#23#0#0), Lit(a#23#1#0))
     == Lit(#Regression.List.Cons(a#23#0#0, a#23#1#0)));

function Regression.List._h1(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#24#0#0: Box, a#24#1#0: DatatypeType :: 
  { #Regression.List.Cons(a#24#0#0, a#24#1#0) } 
  Regression.List._h1(#Regression.List.Cons(a#24#0#0, a#24#1#0)) == a#24#0#0);

// Inductive rank
axiom (forall a#25#0#0: Box, a#25#1#0: DatatypeType :: 
  { #Regression.List.Cons(a#25#0#0, a#25#1#0) } 
  BoxRank(a#25#0#0) < DtRank(#Regression.List.Cons(a#25#0#0, a#25#1#0)));

function Regression.List.tl(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#26#0#0: Box, a#26#1#0: DatatypeType :: 
  { #Regression.List.Cons(a#26#0#0, a#26#1#0) } 
  Regression.List.tl(#Regression.List.Cons(a#26#0#0, a#26#1#0)) == a#26#1#0);

// Inductive rank
axiom (forall a#27#0#0: Box, a#27#1#0: DatatypeType :: 
  { #Regression.List.Cons(a#27#0#0, a#27#1#0) } 
  DtRank(a#27#1#0) < DtRank(#Regression.List.Cons(a#27#0#0, a#27#1#0)));
...
procedure CheckWellformed$$Regression.__default.Empty(Regression._default.Empty$A: Ty);
...
procedure {:opaque} CheckWellformed$$Regression.__default.Length(Regression._default.Length$A: Ty, 
    s#0: DatatypeType
       where $Is(s#0, Tclass.Regression.List(Regression._default.Length$A)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures LitInt(0)
     <= Regression.__default.Length(Regression._default.Length$A, StartFuelAssert_Regression._default.Length, s#0);



implementation {:opaque} CheckWellformed$$Regression.__default.Length(Regression._default.Length$A: Ty, s#0: DatatypeType)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(273,21): initial state"} true;
    ...
    if (*)
    {
        ...
        assert s#0 == s#0 || DtRank(##s#0) < DtRank(s#0);
        assume s#0 == s#0
           || Regression.__default.Length#canCall(Regression._default.Length$A, s#0);
        assume LitInt(0)
           <= Regression.__default.Length(Regression._default.Length$A, StartFuel_Regression._default.Length, s#0);
        assume false;
    }
    else
    {
        ...
        if (Regression.List.Cons_q(s#0))
        {
            assert Regression.List.Cons_q(s#0);
            ...
            assert DtRank(##s#1) < DtRank(s#0);
            assume Regression.__default.Length#canCall(Regression._default.Length$A, Regression.List.tl(s#0));
            assume Regression.__default.Length(Regression._default.Length$A, StartFuel_Regression._default.Length, s#0)
               == 1
            ...
            assume $Is(Regression.__default.Length(Regression._default.Length$A, StartFuel_Regression._default.Length, s#0), 
              TInt);
        }
        else
        {
...
procedure CheckWellformed$$Regression.__default.Empty__ToZero(Regression._default.Empty_ToZero$A: Ty);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$Regression.__default.Empty__ToZero(Regression._default.Empty_ToZero$A: Ty);
  modifies $Heap, $Tick;
  ...
  ensures Regression.__default.Length(Regression._default.Empty_ToZero$A, 
      StartFuelAssert_Regression._default.Length, 
      Lit(Regression.__default.Empty(Regression._default.Empty_ToZero$A)))
     == LitInt(0);
  // frame condition
...
procedure Impl$$Regression.__default.Empty__ToZero(Regression._default.Empty_ToZero$A: Ty) returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures Regression.__default.Empty#canCall(Regression._default.Empty_ToZero$A)
...
implementation Impl$$Regression.__default.Empty__ToZero(Regression._default.Empty_ToZero$A: Ty) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(281,2): initial state"} true;
    $_reverifyPost := false;
    // ----- reveal statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(282,5)
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(282,18)
    // TrCallStmt: Before ProcessCallStmt
    assert (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    // ProcessCallStmt: Make the call
    call Call$$Regression.__default.reveal__Length();
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/OpaqueFunctions.dfy(282,19)"} true;
}



procedure {:auto_generated} {:opaque_reveal} {:verify false} CheckWellformed$$Regression.__default.reveal__Length();
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



const MoreFuel_Regression._default.Length0: LayerType;

procedure {:auto_generated} {:opaque_reveal} {:verify false} Call$$Regression.__default.reveal__Length();
  modifies $Heap, $Tick;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures StartFuel_Regression._default.Length
     == $LS(MoreFuel_Regression._default.Length0);
  free ensures StartFuelAssert_Regression._default.Length
     == $LS($LS(MoreFuel_Regression._default.Length0));
  // Shortcut to LZ
  free ensures AsFuelBottom(MoreFuel_Regression._default.Length0)
     == MoreFuel_Regression._default.Length0;
