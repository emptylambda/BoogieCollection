// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy -print:./Tree.bpl
...
// Datatype extensional equality definition: #_module.Result.Fail
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { _module.Result#Equal(a, b), _module.Result.Fail_q(a) } 
    { _module.Result#Equal(a, b), _module.Result.Fail_q(b) } 
  _module.Result.Fail_q(a) && _module.Result.Fail_q(b)
     ==> (_module.Result#Equal(a, b) <==> true));

// Datatype extensional equality definition: #_module.Result.Res
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { _module.Result#Equal(a, b), _module.Result.Res_q(a) } 
    { _module.Result#Equal(a, b), _module.Result.Res_q(b) } 
  _module.Result.Res_q(a) && _module.Result.Res_q(b)
     ==> (_module.Result#Equal(a, b)
       <==> _module.Tree#Equal(_module.Result.t(a), _module.Result.t(b))
         && Seq#Equal(_module.Result.sOut(a), _module.Result.sOut(b))));
   ...
   ==> (forall $ly: LayerType, d#0: int, t#0: DatatypeType :: 
    ...
    _module.__default.toList#canCall(d#0, t#0)
       ...
       ==> (!_module.Tree.Leaf_q(t#0)
           ==> (var r#1 := _module.Tree._h1(t#0); 
            (var l#1 := _module.Tree._h0(t#0); 
              _module.__default.toList#canCall(d#0 + 1, l#1)
                 && _module.__default.toList#canCall(d#0 + 1, r#1))))
         && _module.__default.toList($LS($ly), d#0, t#0)
           == (if _module.Tree.Leaf_q(t#0)
             then Seq#Build(Seq#Empty(): Seq Box, $Box(d#0))
             else (var r#0 := _module.Tree._h1(t#0); 
              (var l#0 := _module.Tree._h0(t#0); 
                Seq#Append(_module.__default.toList($ly, d#0 + 1, l#0), 
                  _module.__default.toList($ly, d#0 + 1, r#0))))));
   ...
   ==> (forall $ly: LayerType, d#0: int, t#0: DatatypeType :: 
    ...
    _module.__default.toList#canCall(d#0, Lit(t#0))
       ...
       ==> (!Lit(_module.Tree.Leaf_q(Lit(t#0)))
           ==> (var r#3 := Lit(_module.Tree._h1(Lit(t#0))); 
            (var l#3 := Lit(_module.Tree._h0(Lit(t#0))); 
              _module.__default.toList#canCall(d#0 + 1, l#3)
                 && _module.__default.toList#canCall(d#0 + 1, r#3))))
         && _module.__default.toList($LS($ly), d#0, Lit(t#0))
           == (if _module.Tree.Leaf_q(Lit(t#0))
             then Seq#Build(Seq#Empty(): Seq Box, $Box(d#0))
             else (var r#2 := Lit(_module.Tree._h1(Lit(t#0))); 
              (var l#2 := Lit(_module.Tree._h0(Lit(t#0))); 
                Seq#Append(_module.__default.toList($LS($ly), d#0 + 1, l#2), 
                  _module.__default.toList($LS($ly), d#0 + 1, r#2))))));
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, d#0: int, t#0: DatatypeType :: 
    ...
    _module.__default.toList#canCall(LitInt(d#0), Lit(t#0))
         || (2 != $FunctionContextHeight && $Is(t#0, Tclass._module.Tree()))
       ==> (!Lit(_module.Tree.Leaf_q(Lit(t#0)))
           ==> (var r#5 := Lit(_module.Tree._h1(Lit(t#0))); 
            (var l#5 := Lit(_module.Tree._h0(Lit(t#0))); 
              _module.__default.toList#canCall(LitInt(d#0 + 1), l#5)
                 && _module.__default.toList#canCall(LitInt(d#0 + 1), r#5))))
         && _module.__default.toList($LS($ly), LitInt(d#0), Lit(t#0))
           == (if _module.Tree.Leaf_q(Lit(t#0))
             then Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(d#0)))
             else (var r#4 := Lit(_module.Tree._h1(Lit(t#0))); 
              (var l#4 := Lit(_module.Tree._h0(Lit(t#0))); 
                Seq#Append(_module.__default.toList($LS($ly), LitInt(d#0 + 1), l#4), 
                  _module.__default.toList($LS($ly), LitInt(d#0 + 1), r#4))))));
...
implementation CheckWellformed$$_module.__default.toList(d#0: int, t#0: DatatypeType)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(24,9): initial state"} true;
    ...
    else
    {
        ...
        else if (t#0 == #_module.Tree.Node(_mcc#0#0, _mcc#1#0))
        {
            ...
            assume _module.__default.toList#canCall(d#0 + 1, l#Z#0);
            ##d#4 := d#0 + 1;
            // assume allocatedness for argument to function
            ...
            assume _module.__default.toList#canCall(d#0 + 1, r#Z#0);
            assume _module.__default.toList($LS($LZ), d#0, t#0)
               == Seq#Append(_module.__default.toList($LS($LZ), d#0 + 1, l#Z#0), 
                _module.__default.toList($LS($LZ), d#0 + 1, r#Z#0));
            assume _module.__default.toList#canCall(d#0 + 1, l#Z#0)
               && _module.__default.toList#canCall(d#0 + 1, r#Z#0);
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.toList($LS($LZ), d#0, t#0), TSeq(TInt));
        }
        else
...
axiom 3 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, d#0: int, s#0: Seq Box :: 
    { _module.__default.build__rec($ly, d#0, s#0) } 
    _module.__default.build__rec#canCall(d#0, s#0)
         || (3 != $FunctionContextHeight && $Is(s#0, TSeq(TInt)))
...
axiom (forall $ly: LayerType, d#0: int, s#0: Seq Box :: 
  { _module.__default.build__rec#requires($ly, d#0, s#0) } 
  $Is(s#0, TSeq(TInt))
       ...
       ==> (!(Seq#Equal(s#0, Seq#Empty(): Seq Box)
          ...
          $Unbox(Seq#Index(s#0, LitInt(0))): int != d#0
           ==> _module.__default.build__rec#canCall(d#0 + 1, s#0)
             && (var left#0 := _module.__default.build__rec($ly, d#0 + 1, s#0); 
              !_module.Result.Fail_q(left#0)
                 ==> _module.__default.build__rec#canCall(d#0 + 1, _module.Result.sOut(left#0))))
         && _module.__default.build__rec($LS($ly), d#0, s#0)
           == (if Seq#Equal(s#0, Seq#Empty(): Seq Box)
             ...
             then #_module.Result.Fail()
               ...
               else (var left#0 := _module.__default.build__rec($ly, d#0 + 1, s#0); 
                (if _module.Result.Fail_q(left#0)
                   then #_module.Result.Fail()
                   else (var right#0 := _module.__default.build__rec($ly, d#0 + 1, _module.Result.sOut(left#0)); 
                    (if _module.Result.Fail_q(right#0)
                       then #_module.Result.Fail()
                       else #_module.Result.Res(#_module.Tree.Node(_module.Result.t(left#0), _module.Result.t(right#0)), 
                        _module.Result.sOut(right#0)))))))));

// definition axiom for _module.__default.build__rec for all literals (revealed)
axiom 3 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, d#0: int, s#0: Seq Box :: 
    {:weight 3} { _module.__default.build__rec($LS($ly), LitInt(d#0), Lit(s#0)) } 
       ...
       ==> (!(Seq#Equal(s#0, Seq#Empty(): Seq Box)
          ...
          $Unbox(Seq#Index(Lit(s#0), LitInt(0))): int != LitInt(d#0)
           ==> _module.__default.build__rec#canCall(LitInt(d#0 + 1), Lit(s#0))
             && (var left#1 := Lit(_module.__default.build__rec($LS($ly), LitInt(d#0 + 1), Lit(s#0))); 
              !_module.Result.Fail_q(left#1)
                 ==> _module.__default.build__rec#canCall(LitInt(d#0 + 1), _module.Result.sOut(left#1))))
         && _module.__default.build__rec($LS($ly), LitInt(d#0), Lit(s#0))
           == (if Seq#Equal(s#0, Seq#Empty(): Seq Box)
             ...
             then #_module.Result.Fail()
               ...
               else (var left#1 := Lit(_module.__default.build__rec($LS($ly), LitInt(d#0 + 1), Lit(s#0))); 
                (if _module.Result.Fail_q(left#1)
                   then #_module.Result.Fail()
                   else (var right#1 := Lit(_module.__default.build__rec($LS($ly), LitInt(d#0 + 1), Lit(_module.Result.sOut(left#1)))); 
                    (if _module.Result.Fail_q(right#1)
                       then #_module.Result.Fail()
                       else #_module.Result.Res(Lit(#_module.Tree.Node(Lit(_module.Result.t(left#1)), Lit(_module.Result.t(right#1)))), 
                        Lit(_module.Result.sOut(right#1))))))))));
...
implementation CheckWellformed$$_module.__default.build__rec(d#0: int, s#0: Seq Box)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(43,16): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (Seq#Equal(s#0, Seq#Empty(): Seq Box))
    {
    ...
    else
    {
        ...
        else
        {
            ...
            {
                havoc left#Z#0;
                assume $Is(left#Z#0, Tclass._module.Result());
                ##d#8 := d#0 + 1;
                // assume allocatedness for argument to function
                ...
                assume left#Z#0 == let#0#0#0;
                if (_module.Result.Fail_q(left#Z#0))
                {
                    assume _module.__default.build__rec($LS($LZ), d#0, s#0) == Lit(#_module.Result.Fail());
                    assume true;
                    // CheckWellformedWithResult: any expression
                ...
                {
                    havoc right#Z#0;
                    assume $Is(right#Z#0, Tclass._module.Result());
                    assert _module.Result.Res_q(left#Z#0);
                    ##d#9 := d#0 + 1;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##d#9, TInt, $Heap);
                    ##s#8 := _module.Result.sOut(left#Z#0);
                    // assume allocatedness for argument to function
                    ...
                    assume _module.__default.build__rec#canCall(d#0 + 1, _module.Result.sOut(left#Z#0));
                    assume let#1#0#0
                       == _module.__default.build__rec($LS($LZ), d#0 + 1, _module.Result.sOut(left#Z#0));
                    assume _module.__default.build__rec#canCall(d#0 + 1, _module.Result.sOut(left#Z#0));
                    // CheckWellformedWithResult: any expression
                    assume $Is(let#1#0#0, Tclass._module.Result());
                    assume right#Z#0 == let#1#0#0;
                    if (_module.Result.Fail_q(right#Z#0))
                    {
                        assume _module.__default.build__rec($LS($LZ), d#0, s#0) == Lit(#_module.Result.Fail());
                        assume true;
                        // CheckWellformedWithResult: any expression
                    ...
                    {
                        assert _module.Result.Res_q(left#Z#0);
                        assert _module.Result.Res_q(right#Z#0);
                        assert _module.Result.Res_q(right#Z#0);
                        assume _module.__default.build__rec($LS($LZ), d#0, s#0)
                           == #_module.Result.Res(#_module.Tree.Node(_module.Result.t(left#Z#0), _module.Result.t(right#Z#0)), 
                            _module.Result.sOut(right#Z#0));
                        assume true;
                        // CheckWellformedWithResult: any expression
                        assume $Is(_module.__default.build__rec($LS($LZ), d#0, s#0), Tclass._module.Result());
                    }
...
function _module.__default.build(s#0: Seq Box) : DatatypeType;
...
axiom 4 <= $FunctionContextHeight
   ==> (forall s#0: Seq Box :: 
    { _module.__default.build(s#0) } 
    _module.__default.build#canCall(s#0)
         || (4 != $FunctionContextHeight && $Is(s#0, TSeq(TInt)))
       ==> (_module.Result.Res_q(_module.__default.build(s#0))
           ==> Seq#Equal(_module.__default.toList($LS($LZ), LitInt(0), _module.Result.t(_module.__default.build(s#0))), 
            s#0))
         && $Is(_module.__default.build(s#0), Tclass._module.Result()));

function _module.__default.build#requires(Seq Box) : bool;

// #requires axiom for _module.__default.build
axiom (forall s#0: Seq Box :: 
  { _module.__default.build#requires(s#0) } 
  $Is(s#0, TSeq(TInt)) ==> _module.__default.build#requires(s#0) == true);
   ...
   ==> (forall s#0: Seq Box :: 
    ...
    _module.__default.build#canCall(s#0)
       ...
       ==> _module.__default.build__rec#canCall(LitInt(0), s#0)
         && _module.__default.build(s#0)
           == (var r#0 := _module.__default.build__rec($LS($LZ), LitInt(0), s#0); 
...
axiom 4 <= $FunctionContextHeight
   ==> (forall s#0: Seq Box :: 
    {:weight 3} { _module.__default.build(Lit(s#0)) } 
    _module.__default.build#canCall(Lit(s#0))
         || (4 != $FunctionContextHeight && $Is(s#0, TSeq(TInt)))
       ==> _module.__default.build__rec#canCall(LitInt(0), Lit(s#0))
         && _module.__default.build(Lit(s#0))
           == (var r#1 := Lit(_module.__default.build__rec($LS($LZ), LitInt(0), Lit(s#0))); 
            (if _module.Result.Res_q(r#1)
                 && Seq#Equal(_module.Result.sOut(r#1), Seq#Empty(): Seq Box)
               then r#1
               else #_module.Result.Fail())));
...
procedure CheckWellformed$$_module.__default.build(s#0: Seq Box where $Is(s#0, TSeq(TInt)));
  ...
  modifies $Heap, $Tick;
  ensures _module.Result.Res_q(_module.__default.build(s#0))
     ==> Seq#Equal(_module.__default.toList($LS($LS($LZ)), LitInt(0), _module.Result.t(_module.__default.build(s#0))), 
      s#0);
...
implementation CheckWellformed$$_module.__default.build(s#0: Seq Box)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(70,16): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        assume $Is(_module.__default.build(s#0), Tclass._module.Result());
        if (*)
        {
            ##s#0 := s#0;
            // assume allocatedness for argument to function
            ...
            assume _module.Result.Res_q(_module.__default.build(s#0));
            ##s#1 := s#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##s#1, TSeq(TInt), $Heap);
            assert s#0 == s#0 || Seq#Rank(##s#1) < Seq#Rank(s#0);
            assume s#0 == s#0 || _module.__default.build#canCall(s#0);
            assert _module.Result.Res_q(_module.__default.build(s#0));
            ##d#0 := LitInt(0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##d#0, TInt, $Heap);
            ##t#0 := _module.Result.t(_module.__default.build(s#0));
            // assume allocatedness for argument to function
            assume $IsAlloc(##t#0, Tclass._module.Tree(), $Heap);
            assume _module.__default.toList#canCall(LitInt(0), _module.Result.t(_module.__default.build(s#0)));
            assume Seq#Equal(_module.__default.toList($LS($LZ), LitInt(0), _module.Result.t(_module.__default.build(s#0))), 
              s#0);
        }
        else
        {
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        havoc r#Z#0;
        assume $Is(r#Z#0, Tclass._module.Result());
        ##d#1 := LitInt(0);
        // assume allocatedness for argument to function
        assume $IsAlloc(##d#1, TInt, $Heap);
        ##s#2 := s#0;
        ...
        assume $Is(let#0#0#0, Tclass._module.Result());
        assume r#Z#0 == let#0#0#0;
        if (_module.Result.Res_q(r#Z#0))
        {
            assert _module.Result.Res_q(r#Z#0);
        }

        if (_module.Result.Res_q(r#Z#0)
           && Seq#Equal(_module.Result.sOut(r#Z#0), Seq#Empty(): Seq Box))
        {
            assume _module.__default.build(s#0) == r#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.build(s#0), Tclass._module.Result());
        }
        ...
        {
            assume _module.__default.build(s#0) == Lit(#_module.Result.Fail());
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.build(s#0), Tclass._module.Result());
        }
...
implementation {:_induction t#0, d#0, s#0} CheckWellformed$$_module.__default.lemma0(t#0: DatatypeType, d#0: int, s#0: Seq Box)
{
  ...
  var ##s#1: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(87,6): initial state"} true;
    havoc $Heap;
    assume old($Heap) == $Heap;
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(88,46): post-state"} true;
    ##d#0 := d#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##d#0, TInt, $Heap);
    ##t#0 := t#0;
...
implementation {:_induction t#0, d#0, s#0} Impl$$_module.__default.lemma0(t#0: DatatypeType, d#0: int, s#0: Seq Box) returns ($_reverifyPost: bool)
{
  ...
  var ##t#1_0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(90,0): initial state"} true;
    ...
    if (t#0 == #_module.Tree.Leaf())
    {
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(93,5)
        ##d#1_0 := d#0;
        // assume allocatedness for argument to function
    ...
    else if (t#0 == #_module.Tree.Node(_mcc#0#0_0, _mcc#1#0_0))
    {
        ...
        assume $Is(l#0_0, Tclass._module.Tree())
           && $IsAlloc(l#0_0, Tclass._module.Tree(), $Heap);
        assume let#0_1#0#0 == _mcc#0#0_0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0_1#0#0, Tclass._module.Tree());
        assume l#0_0 == let#0_1#0#0;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(95,5)
        ##d#0_0 := d#0;
        // assume allocatedness for argument to function
...
procedure {:_induction t#0} CheckWellformed$$_module.__default.lemma1(t#0: DatatypeType
       where $Is(t#0, Tclass._module.Tree())
         && $IsAlloc(t#0, Tclass._module.Tree(), $Heap)
         && $IsA#_module.Tree(t#0), 
    s#0: Seq Box where $Is(s#0, TSeq(TInt)) && $IsAlloc(s#0, TSeq(TInt), $Heap));
...
procedure {:_induction t#0} Call$$_module.__default.lemma1(t#0: DatatypeType
       where $Is(t#0, Tclass._module.Tree())
         && $IsAlloc(t#0, Tclass._module.Tree(), $Heap)
         && $IsA#_module.Tree(t#0), 
    s#0: Seq Box where $Is(s#0, TSeq(TInt)) && $IsAlloc(s#0, TSeq(TInt), $Heap));
...
procedure {:_induction t#0} Impl$$_module.__default.lemma1(t#0: DatatypeType
       where $Is(t#0, Tclass._module.Tree())
         && $IsAlloc(t#0, Tclass._module.Tree(), $Heap)
         && $IsA#_module.Tree(t#0), 
    s#0: Seq Box where $Is(s#0, TSeq(TInt)) && $IsAlloc(s#0, TSeq(TInt), $Heap))
...
implementation {:_induction t#0} Impl$$_module.__default.lemma1(t#0: DatatypeType, s#0: Seq Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $initHeapForallStmt#0: Heap;
  var t##0: DatatypeType;
  ...
  var s##0: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(110,0): initial state"} true;
    assume $IsA#_module.Tree(t#0);
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap, $Tick;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#t0#0: DatatypeType :: 
      $Is($ih#t0#0, Tclass._module.Tree())
           ...
           && (DtRank($ih#t0#0) < DtRank(t#0)
             || (DtRank($ih#t0#0) == DtRank(t#0) && Seq#Rank(s#0) < Seq#Rank(s#0)))
         ==> _module.Result.Res_q(_module.__default.build(s#0)));
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(111,9)
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(111,18)"} true;
}



procedure CheckWellformed$$_module.__default.lemma2(s#0: Seq Box where $Is(s#0, TSeq(TInt)) && $IsAlloc(s#0, TSeq(TInt), $Heap));
  free requires 7 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.lemma2(s#0: Seq Box where $Is(s#0, TSeq(TInt)) && $IsAlloc(s#0, TSeq(TInt), $Heap));
  modifies $Heap, $Tick;
  // user-defined postconditions
...
procedure Impl$$_module.__default.lemma2(s#0: Seq Box where $Is(s#0, TSeq(TInt)) && $IsAlloc(s#0, TSeq(TInt), $Heap))
   returns ($_reverifyPost: bool);
  free requires 7 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // user-defined postconditions
...
implementation Impl$$_module.__default.lemma2(s#0: Seq Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var t#2: DatatypeType;
  var ##d#1: int;
  ...
  var $initHeapForallStmt#0: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(119,0): initial state"} true;
    $_reverifyPost := false;
    // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(120,3)
    if (*)
    {
        // Assume Fuel Constant
        havoc t#2;
        assume $Is(t#2, Tclass._module.Tree());
        ##d#1 := LitInt(0);
        // assume allocatedness for argument to function
        assume $IsAlloc(##d#1, TInt, $Heap);
        ##t#1 := t#2;
        // assume allocatedness for argument to function
        assume $IsAlloc(##t#1, Tclass._module.Tree(), $Heap);
        assume _module.__default.toList#canCall(LitInt(0), t#2);
        assume _module.__default.toList#canCall(LitInt(0), t#2);
        assume Seq#Equal(_module.__default.toList($LS($LZ), LitInt(0), t#2), s#0);
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(121,11)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        t##0 := t#2;
        ...
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(121,16)"} true;
        assume false;
    }
    else
    {
        ...
        assume (forall t#3: DatatypeType :: 
          { _module.__default.toList($LS($LZ), 0, t#3) } 
          $Is(t#3, Tclass._module.Tree())
               && Seq#Equal(_module.__default.toList($LS($LZ), LitInt(0), t#3), s#0)
             ==> _module.Result.Res_q(_module.__default.build(s#0)));
    }

    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(122,2)"} true;
}
  ...
  free ensures (forall s#1: Seq Box :: 
    ...
    $Is(s#1, TSeq(TInt))
      ...
      (exists t#2: DatatypeType :: 
        ...
        $Is(t#2, Tclass._module.Tree())
           && Seq#Equal(_module.__default.toList($LS($LZ), LitInt(0), t#2), s#1))
       ==> _module.Result.Res_q(_module.__default.build(s#1)));
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure Impl$$_module.__default.completeness() returns ($_reverifyPost: bool);
  ...
  ensures (forall s#1: Seq Box :: 
    ...
    $Is(s#1, TSeq(TInt))
       ==> 
      (exists t#2: DatatypeType :: 
        { _module.__default.toList($LS($LS($LZ)), 0, t#2) } 
        $Is(t#2, Tclass._module.Tree())
...
implementation Impl$$_module.__default.completeness() returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#0: Heap;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(133,0): initial state"} true;
    $_reverifyPost := false;
    // ----- forall statement (call) ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(134,3)
    if (*)
    {
        // Assume Fuel Constant
        havoc s#2;
        ...
        assume true;
        assume true;
        // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(135,11)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        s##0 := s#2;
        ...
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(135,13)"} true;
        assume false;
    }
    else
    {
        ...
        assume (forall s#3: Seq Box :: 
          { _module.__default.build(s#3) } 
          $Is(s#3, TSeq(TInt)) && Lit(true)
             ==> 
            (exists _'t#0: DatatypeType :: 
              $Is(_'t#0, Tclass._module.Tree())
                 && Seq#Equal(_module.__default.toList($LS($LZ), LitInt(0), _'t#0), s#3))
             ==> _module.Result.Res_q(_module.__default.build(s#3)));
    }

    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(136,2)"} true;
}
...
implementation CheckWellformed$$_module.__default.harness0()
{
  ...
  var ##s#1: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(144,7): initial state"} true;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && read(old($Heap), $o, alloc) ==> $Heap[$o] == old($Heap)[$o]);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(145,32): post-state"} true;
    ...
    assume _module.__default.build#canCall(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
            $Box(LitInt(3))), 
          $Box(LitInt(2)))));
    assume _module.Result.Res_q(Lit(_module.__default.build(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                $Box(LitInt(3))), 
              $Box(LitInt(2)))))));
    ...
    assume _module.__default.build#canCall(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
            $Box(LitInt(3))), 
          $Box(LitInt(2)))));
    assert _module.Result.Res_q(Lit(_module.__default.build(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                $Box(LitInt(3))), 
              $Box(LitInt(2)))))));
    assume _module.Tree#Equal(_module.Result.t(Lit(_module.__default.build(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                  $Box(LitInt(3))), 
                $Box(LitInt(2))))))), 
      #_module.Tree.Node(Lit(#_module.Tree.Leaf()), 
...
procedure Call$$_module.__default.harness0();
  ...
  free ensures _module.__default.build#canCall(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
            $Box(LitInt(3))), 
          $Box(LitInt(2)))))
     && (Lit(_module.Result.Res_q(Lit(_module.__default.build(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                    $Box(LitInt(3))), 
                  $Box(LitInt(2))))))))
       ==> $IsA#_module.Tree(Lit(_module.Result.t(Lit(_module.__default.build(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                        $Box(LitInt(3))), 
                      $Box(LitInt(2)))))))))
         && _module.__default.build#canCall(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                $Box(LitInt(3))), 
              $Box(LitInt(2))))));
  ensures Lit(_module.Result.Res_q(Lit(_module.__default.build(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                $Box(LitInt(3))), 
              $Box(LitInt(2))))))));
  ensures _module.Tree#Equal(_module.Result.t(Lit(_module.__default.build(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                $Box(LitInt(3))), 
              $Box(LitInt(2))))))), 
    #_module.Tree.Node(Lit(#_module.Tree.Leaf()), 
      Lit(#_module.Tree.Node(Lit(#_module.Tree.Node(Lit(#_module.Tree.Leaf()), Lit(#_module.Tree.Leaf()))), 
...
implementation Impl$$_module.__default.harness0() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(147,0): initial state"} true;
    $_reverifyPost := false;
}
...
procedure Call$$_module.__default.harness1();
  ...
  free ensures _module.__default.build#canCall(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
          $Box(LitInt(2))), 
        $Box(LitInt(2)))));
  ensures Lit(_module.Result.Fail_q(Lit(_module.__default.build(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq Box, $Box(LitInt(1))), $Box(LitInt(3))), 
                $Box(LitInt(2))), 
              $Box(LitInt(2))))))));
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$_module.__default.harness1() returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/vstte2012/Tree.dfy(157,0): initial state"} true;
    $_reverifyPost := false;
}
