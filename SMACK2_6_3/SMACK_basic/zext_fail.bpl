...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/zext_fail.c -bpl ./zext_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/zext_fail.c", 9, 22} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/zext_fail.c", 9, 22} true;
  assume {:verifier.code 0} true;
  $i0 := $zext.i32.i64($sub.i32(0, 1));
  call {:cexpr "xl"} boogie_si_record_i64($i0);
  assume {:sourceloc "test/c/basic/zext_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/zext_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i64($i0, 4294967295);
  assume {:sourceloc "test/c/basic/zext_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/zext_fail.c", 11, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($sub.i32(0, 1));
  call {:cexpr "yl"} boogie_si_record_i64($i2);
  assume {:sourceloc "test/c/basic/zext_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/basic/zext_fail.c", 12, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/basic/zext_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
