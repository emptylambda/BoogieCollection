...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/simple_double_free.c -bpl ./simple_double_free.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/simple_double_free.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/memory-safety/simple_double_free.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(40);
  assume {:sourceloc "test/c/memory-safety/simple_double_free.c", 10, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/memory-safety/simple_double_free.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/simple_double_free.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call free_($p2);
  assume {:sourceloc "test/c/memory-safety/simple_double_free.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/simple_double_free.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call free_($p3);
  assume {:sourceloc "test/c/memory-safety/simple_double_free.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
