...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/for2.c -bpl ./for2.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/for2.c", 6, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/reach/for2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/for2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/for2.c", 6, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i0, 1);
  assume {:sourceloc "test/c/reach/for2.c", 6, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/reach/for2.c", 7, 6} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i1, 1);
  call {:cexpr "b"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/reach/for2.c", 7, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/reach/for2.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/reach/for2.c", 6, 23} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i0, 1);
