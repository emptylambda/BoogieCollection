...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/pointers4_fail.c -bpl ./pointers4_fail.bpl
...
procedure {:inline 1} foo($p0: ref)
{
  ...
  var $i3: i1;
$bb0:
  assume {:sourceloc "test/c/data/pointers4_fail.c", 5, 20} true;
...
$bb1:
  assume {:sourceloc "test/c/data/pointers4_fail.c", 5, 20} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($p0, $mul.ref($sub.ref(0, 1), 4));
  assume {:sourceloc "test/c/data/pointers4_fail.c", 5, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "test/c/data/pointers4_fail.c", 5, 20} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/pointers4_fail.c", 5, 40} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/pointers4_fail.c", 8, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/pointers4_fail.c", 8, 7} true;
  assume {:verifier.code 0} true;
  call $M.0 := $memset.i8($M.0, $p1, 0, 12, false);
  assume {:sourceloc "test/c/data/pointers4_fail.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 12)), $mul.ref(1, 4));
  assume {:sourceloc "test/c/data/pointers4_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call foo($p2);
  assume {:sourceloc "test/c/data/pointers4_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
