...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/special/countpop8_fail.c -bpl ./countpop8_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 25016));
...
const {:count 256} results: ref;
axiom (results == $sub.ref(0, 1280));
const ctpop8: ref;
axiom (ctpop8 == $sub.ref(0, 2312));
procedure {:inline 1} ctpop8($i0: i8)
  returns ($r: i8)
{
  var $i1: i64;
  var $p2: ref;
  var $i3: i8;
$bb0:
  assume {:sourceloc "test/c/special/countpop8_fail.c", 20, 36} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ctpop8:arg:x"} boogie_si_record_i8($i0);
  assume {:sourceloc "test/c/special/countpop8_fail.c", 20, 36} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i8.i64($i0);
  assume {:sourceloc "test/c/special/countpop8_fail.c", 20, 36} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref($i1, 1));
  assume {:sourceloc "test/c/special/countpop8_fail.c", 20, 36} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, $p2);
  assume {:sourceloc "test/c/special/countpop8_fail.c", 20, 29} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/special/countpop8_fail.c", 23, 15} true;
  ...
  assume {:sourceloc "test/c/special/countpop8_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/special/countpop8_fail.c", 24, 3} true;
...
$bb7:
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "test/c/special/countpop8_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/special/countpop8_fail.c", 25, 3} true;
  ...
  assume {:sourceloc "test/c/special/countpop8_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/special/countpop8_fail.c:25:3: warning: over-approximating call to llvm.ctpop.i32; */
  call $i6 := llvm.ctpop.i32($i5);
  assume {:sourceloc "test/c/special/countpop8_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := ctpop8($i0);
  assume {:sourceloc "test/c/special/countpop8_fail.c", 25, 3} true;
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "test/c/special/countpop8_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const llvm.ctpop.i32: ref;
axiom (llvm.ctpop.i32 == $sub.ref(0, 4376));
procedure {:inline 1} llvm.ctpop.i32($i0: i32)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 5408));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 6440));
...
axiom (__SMACK_dummy == $sub.ref(0, 7472));
...
axiom (__VERIFIER_assert == $sub.ref(0, 8504));
...
axiom (__SMACK_and32 == $sub.ref(0, 9536));
...
axiom (__SMACK_and64 == $sub.ref(0, 10568));
...
axiom (__SMACK_and16 == $sub.ref(0, 11600));
...
axiom (__SMACK_and8 == $sub.ref(0, 12632));
...
axiom (__SMACK_or32 == $sub.ref(0, 13664));
...
axiom (__SMACK_or64 == $sub.ref(0, 14696));
...
axiom (__SMACK_or16 == $sub.ref(0, 15728));
...
axiom (__SMACK_or8 == $sub.ref(0, 16760));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17792));
...
axiom (__VERIFIER_nondet_unsigned_char == $sub.ref(0, 18824));
...
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 19856));
procedure {:inline 1} __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 20888));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 21920));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 22952));
...
axiom (llvm.dbg.value == $sub.ref(0, 23984));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 25016));
procedure {:inline 1} __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i8($M.0, results, 0);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(1, 1)), 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(2, 1)), 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(3, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(4, 1)), 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(5, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(6, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(7, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(8, 1)), 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(9, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(10, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(11, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(12, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(13, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(14, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(15, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(16, 1)), 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(17, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(18, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(19, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(20, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(21, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(22, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(23, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(24, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(25, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(26, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(27, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(28, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(29, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(30, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(31, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(32, 1)), 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(33, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(34, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(35, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(36, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(37, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(38, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(39, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(40, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(41, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(42, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(43, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(44, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(45, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(46, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(47, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(48, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(49, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(50, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(51, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(52, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(53, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(54, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(55, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(56, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(57, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(58, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(59, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(60, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(61, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(62, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(63, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(64, 1)), 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(65, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(66, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(67, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(68, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(69, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(70, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(71, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(72, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(73, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(74, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(75, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(76, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(77, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(78, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(79, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(80, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(81, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(82, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(83, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(84, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(85, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(86, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(87, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(88, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(89, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(90, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(91, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(92, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(93, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(94, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(95, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(96, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(97, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(98, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(99, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(100, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(101, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(102, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(103, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(104, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(105, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(106, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(107, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(108, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(109, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(110, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(111, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(112, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(113, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(114, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(115, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(116, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(117, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(118, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(119, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(120, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(121, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(122, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(123, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(124, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(125, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(126, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(127, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(128, 1)), 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(129, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(130, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(131, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(132, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(133, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(134, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(135, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(136, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(137, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(138, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(139, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(140, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(141, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(142, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(143, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(144, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(145, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(146, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(147, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(148, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(149, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(150, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(151, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(152, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(153, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(154, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(155, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(156, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(157, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(158, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(159, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(160, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(161, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(162, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(163, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(164, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(165, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(166, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(167, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(168, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(169, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(170, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(171, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(172, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(173, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(174, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(175, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(176, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(177, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(178, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(179, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(180, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(181, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(182, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(183, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(184, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(185, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(186, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(187, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(188, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(189, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(190, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(191, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(192, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(193, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(194, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(195, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(196, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(197, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(198, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(199, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(200, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(201, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(202, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(203, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(204, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(205, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(206, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(207, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(208, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(209, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(210, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(211, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(212, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(213, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(214, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(215, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(216, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(217, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(218, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(219, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(220, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(221, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(222, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(223, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(224, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(225, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(226, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(227, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(228, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(229, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(230, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(231, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(232, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(233, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(234, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(235, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(236, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(237, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(238, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(239, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(240, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(241, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(242, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(243, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(244, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(245, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(246, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(247, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(248, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(249, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(250, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(251, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(252, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(253, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(254, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(results, $mul.ref(0, 256)), $mul.ref(255, 1)), 8);
  $exn := false;
  return;
}
