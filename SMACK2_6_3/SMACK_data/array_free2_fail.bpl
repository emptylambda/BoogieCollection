...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/array_free2_fail.c -bpl ./array_free2_fail.bpl
...
const free_array: ref;
axiom (free_array == $sub.ref(0, 1032));
procedure {:inline 1} free_array()
{
  var $p0: ref;
  var $i1: i32;
  var $i2: i1;
  ...
  var $i50: i32;
$bb0:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 22, 8} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p0 := $alloc($mul.ref(240, $zext.i32.i64(1)));
  assume true;
  assume {:sourceloc "test/c/data/array_free2_fail.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array_free2_fail.c", 22, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 9);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 23, 21} true;
  assume {:verifier.code 0} true;
  call $p3 := malloc(4);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 23, 14} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 23, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i5, 24));
  $p7 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i5, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 23, 12} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p7, $p3);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i8, 24));
  $p10 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i8, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 24, 12} true;
  assume {:verifier.code 0} true;
  $p11 := $load.ref($M.0, $p10);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 24, 15} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p11, 1);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $i12 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 25, 5} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i12, 24));
  $p14 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i12, 24)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 25, 12} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p14, 2);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i15, 24));
  $p17 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i15, 24)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 26, 12} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i32($M.3, $p17, 3);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $i19 := 0;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 22, 33} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i1, 1);
...
$bb5:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/array_free2_fail.c", 29, 17} true;
  assume {:verifier.code 0} true;
  $i20 := $slt.i32($i19, 10);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb6, $bb7;
$bb6:
  assume ($i20 == 1);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !(($i20 == 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb8:
  ...
  assume {:sourceloc "test/c/data/array_free2_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i21, 24));
  $p23 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i21, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 30, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb10;
$bb12:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 31, 5} true;
  ...
  assume {:sourceloc "test/c/data/array_free2_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i27, 24));
  $p29 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i27, 24)), $mul.ref(16, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 31, 5} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb15;
$bb17:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb18:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 32, 5} true;
  ...
  assume {:sourceloc "test/c/data/array_free2_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i32, 24));
  $p34 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i32, 24)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  goto $bb20;
$bb22:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $i37 := $sext.i32.i64($i19);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i37, 24));
  $p39 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i37, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 33, 14} true;
  assume {:verifier.code 0} true;
  $p40 := $load.ref($M.0, $p39);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 33, 16} true;
  assume {:verifier.code 0} true;
...
$bb23:
  assume ($i41 == 1);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 34, 12} true;
  assume {:verifier.code 0} true;
  $i42 := $sext.i32.i64($i19);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 34, 12} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i42, 24));
  $p44 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i42, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 34, 17} true;
  assume {:verifier.code 0} true;
  $p45 := $load.ref($M.0, $p44);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 34, 12} true;
  assume {:verifier.code 0} true;
  $p46 := $bitcast.ref.ref($p45);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 34, 7} true;
  assume {:verifier.code 0} true;
  call free_($p46);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $i47 := $sext.i32.i64($i19);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i47, 24));
  $p49 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 240)), $mul.ref($i47, 24)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/array_free2_fail.c", 35, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p49, $0.ref);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 36, 5} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb24:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 33, 9} true;
  ...
  goto $bb25;
$bb25:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/data/array_free2_fail.c", 29, 29} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i32($i19, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/array_free2_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/data/array_free2_fail.c", 41, 3} true;
  assume {:verifier.code 0} true;
  call free_array();
  assume {:sourceloc "test/c/data/array_free2_fail.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
