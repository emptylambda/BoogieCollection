...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/float/floats_in_memory.c -bpl ./floats_in_memory.bpl
...
procedure {:inline 1} ff2($p0: ref, $p1: ref)
{
  var $f2: float;
$bb0:
  assume {:sourceloc "test/c/float/floats_in_memory.c", 6, 40} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/float/floats_in_memory.c", 6, 40} true;
  assume {:verifier.code 0} true;
  $f2 := $load.float($M.0, $p1);
  assume {:sourceloc "test/c/float/floats_in_memory.c", 6, 38} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.float($M.1, $p0, $f2);
  assume {:sourceloc "test/c/float/floats_in_memory.c", 6, 45} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/float/floats_in_memory.c", 10, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "test/c/float/floats_in_memory.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.float($M.0, $p1, $fp(1, 0, 0));
  assume {:sourceloc "test/c/float/floats_in_memory.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call ff1($u0);
  assume {:sourceloc "test/c/float/floats_in_memory.c", 14, 7} true;
  assume {:verifier.code 0} true;
  $f2 := $load.float($M.1, $p0);
  assume {:sourceloc "test/c/float/floats_in_memory.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call ff1($f2);
  assume {:sourceloc "test/c/float/floats_in_memory.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call ff2($p0, $p1);
  assume {:sourceloc "test/c/float/floats_in_memory.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/float/floats_in_memory.c", 17, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/float/floats_in_memory.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
