...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/adjacent_global_fail.c -bpl ./adjacent_global_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 19604));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/adjacent_global_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/memory-safety/adjacent_global_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $p0 := $add.ref(x, $mul.ref(1, 4));
  assume {:sourceloc "test/c/memory-safety/adjacent_global_fail.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/memory-safety/adjacent_global_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
axiom (llvm.dbg.value == $sub.ref(0, 18572));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 19604));
