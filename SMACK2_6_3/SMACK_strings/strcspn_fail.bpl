...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strcspn_fail.c -bpl ./strcspn_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 22695));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strcspn_fail.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/strings/strcspn_fail.c", 8, 19} true;
  assume {:verifier.code 0} true;
  call $i0 := strcspn(.str, .str.1);
  call {:cexpr "firstE"} boogie_si_record_i64($i0);
  assume {:sourceloc "test/c/strings/strcspn_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strcspn_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strcspn_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strcspn: ref;
axiom (strcspn == $sub.ref(0, 4119));
procedure {:inline 1} strcspn($p0: ref, $p1: ref)
  returns ($r: i64);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 5151));
procedure {:inline 1} __SMACK_code.ref($p0: ref);
procedure {:inline 1} __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 6183));
...
axiom (__SMACK_dummy == $sub.ref(0, 7215));
...
axiom (__VERIFIER_assert == $sub.ref(0, 8247));
...
axiom (__SMACK_and32 == $sub.ref(0, 9279));
...
axiom (__SMACK_and64 == $sub.ref(0, 10311));
...
axiom (__SMACK_and16 == $sub.ref(0, 11343));
...
axiom (__SMACK_and8 == $sub.ref(0, 12375));
...
axiom (__SMACK_or32 == $sub.ref(0, 13407));
...
axiom (__SMACK_or64 == $sub.ref(0, 14439));
...
axiom (__SMACK_or16 == $sub.ref(0, 15471));
...
axiom (__SMACK_or8 == $sub.ref(0, 16503));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17535));
...
axiom (__SMACK_decls == $sub.ref(0, 18567));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 19599));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 20631));
...
axiom (llvm.dbg.value == $sub.ref(0, 21663));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 22695));
