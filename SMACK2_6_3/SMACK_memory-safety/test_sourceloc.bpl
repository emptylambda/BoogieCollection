...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/test_sourceloc.c -bpl ./test_sourceloc.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 10, 7} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 11, 16} true;
  assume {:verifier.code 0} true;
  call $p2 := malloc(4);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 11, 5} true;
  assume {:verifier.code 0} true;
  $p4 := $p2;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 15, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.ref($p4, $0.ref);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p4);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 15, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call free_($p8);
  assume {:sourceloc "test/c/memory-safety/test_sourceloc.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
