...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/contracts/array.c -bpl ./array.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/contracts/array.c", 11, 3} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/contracts/array.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
