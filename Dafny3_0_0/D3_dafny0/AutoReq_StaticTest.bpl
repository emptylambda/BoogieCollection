...
procedure CheckWellformed$$StaticTest.__default.f(x#0: int);
...
procedure {:autoReq} CheckWellformed$$StaticTest.__default.g(z#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$StaticTest.__default.g(z#0: int)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(279,22): initial state"} true;
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        assume StaticTest.__default.g(z#0) == Lit(true);
        assume true;
...
procedure {:autoReq} CheckWellformed$$StaticTest.__default.h(y#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$StaticTest.__default.h(y#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(286,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume y#0 > 3;
    ##x#0 := y#0;
    ...
    assume StaticTest.__default.f(y#0);
    assert b$reqreads#0;
    if (*)
    {
        assume false;
    ...
    else
    {
        ...
        assert {:subsumption 0} ##z#0 > 3;
        assume ##z#0 > 3;
        assert {:subsumption 0} StaticTest.__default.f#canCall(##z#0)
        ...
        assume StaticTest.__default.h(y#0) == StaticTest.__default.g(y#0);
        assume StaticTest.__default.g#canCall(y#0);
        // CheckWellformedWithResult: any expression
...
axiom 3 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    StaticTest.__default.IsEven#canCall(x#0) || 3 != $FunctionContextHeight ==> true);
...
procedure CheckWellformed$$StaticTest.__default.IsEven(x#0: int);
...
axiom 4 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    StaticTest.__default.EvenDoubler#canCall(x#0)
         || (4 != $FunctionContextHeight && StaticTest.__default.IsEven(x#0))
       ==> true);
...
procedure CheckWellformed$$StaticTest.__default.EvenDoubler(x#0: int);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation CheckWellformed$$StaticTest.__default.EvenDoubler(x#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
    ...
    // AddWellformednessCheck for function EvenDoubler
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(293,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##x#0 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
    assume StaticTest.__default.IsEven#canCall(x#0);
    assume StaticTest.__default.IsEven(x#0);
    assert b$reqreads#0;
    if (*)
    {
        assume false;
...
axiom 5 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    StaticTest.__default.test#canCall(y#0)
         || (5 != $FunctionContextHeight && StaticTest.__default.IsEven(y#0))
       ==> true);
...
axiom 5 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    StaticTest.__default.test#canCall(LitInt(y#0))
         || (5 != $FunctionContextHeight && StaticTest.__default.IsEven(LitInt(y#0)))
...
procedure {:autoReq} CheckWellformed$$StaticTest.__default.test(y#0: int);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$StaticTest.__default.test(y#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(297,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##x#0 := y#0;
    // assume allocatedness for argument to function
    ...
    assume StaticTest.__default.IsEven(y#0);
    assert b$reqreads#0;
    if (*)
    {
        assume false;
    ...
    else
    {
        ...
        assert {:subsumption 0} StaticTest.__default.IsEven(##x#1);
        assume StaticTest.__default.IsEven(##x#1);
        b$reqreads#1 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume StaticTest.__default.EvenDoubler#canCall(y#0);
        assume StaticTest.__default.test(y#0) == StaticTest.__default.EvenDoubler(y#0);
        assume StaticTest.__default.EvenDoubler#canCall(y#0);
        // CheckWellformedWithResult: any expression
