...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/test_memcpy_fail.c -bpl ./test_memcpy_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 7, 11} true;
  ...
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 7, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, $i2);
  assume true;
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 8, 11} true;
  assume {:verifier.code 1} true;
  call $i3 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 8, 7} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, $i3);
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call $M.0 := $memcpy.i8($M.0, $M.1, $p4, $p5, 4, false);
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/test_memcpy_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
