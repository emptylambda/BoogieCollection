...
procedure CheckWellformed$$intOrder.__default.Leq(a#0: int, b#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  ensures intOrder.__default.Leq(a#0, b#0) ==> a#0 <= b#0;



implementation CheckWellformed$$intOrder.__default.Leq(a#0: int, b#0: int)
{
  ...
  var ##b#0: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/GenericSort.dfy(157,19): initial state"} true;
    ...
    if (*)
    {
        if (*)
        {
            ...
            assume intOrder.__default.Leq(a#0, b#0);
            assume a#0 <= b#0;
        }
        else
        {
            assume intOrder.__default.Leq(a#0, b#0) ==> a#0 <= b#0;
        }
...
procedure CheckWellformed$$intOrder.__default.Antisymmetry(a#0: int, b#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$intOrder.__default.Antisymmetry(a#0: int, b#0: int);
  // user-defined preconditions
  requires intOrder.__default.Leq(a#0, b#0);
  requires intOrder.__default.Leq(b#0, a#0);
  modifies $Heap, $Tick;
...
procedure Impl$$intOrder.__default.Antisymmetry(a#0: int, b#0: int) returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  // user-defined preconditions
  requires intOrder.__default.Leq(a#0, b#0);
  requires intOrder.__default.Leq(b#0, a#0);
...
implementation Impl$$intOrder.__default.Antisymmetry(a#0: int, b#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/GenericSort.dfy(164,25): initial state"} true;
    $_reverifyPost := false;
}
...
procedure Impl$$intOrder.__default.Transitivity(a#0: int, b#0: int, c#0: int) returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  // user-defined preconditions
  requires intOrder.__default.Leq(a#0, b#0);
  requires intOrder.__default.Leq(b#0, c#0);
  ...
  // user-defined postconditions
  free ensures intOrder.__default.Leq#canCall(a#0, c#0);
  ensures intOrder.__default.Leq#canCall(a#0, c#0)
...
implementation Impl$$intOrder.__default.Transitivity(a#0: int, b#0: int, c#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/GenericSort.dfy(165,25): initial state"} true;
    $_reverifyPost := false;
}
...
procedure Impl$$intOrder.__default.Totality(a#0: int, b#0: int) returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures intOrder.__default.Leq#canCall(a#0, b#0)
...
implementation Impl$$intOrder.__default.Totality(a#0: int, b#0: int) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny3/GenericSort.dfy(166,21): initial state"} true;
    $_reverifyPost := false;
}
