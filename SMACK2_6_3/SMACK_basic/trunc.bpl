...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/trunc.c -bpl ./trunc.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/trunc.c", 9, 17} true;
  ...
  assume {:sourceloc "test/c/basic/trunc.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/trunc.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/trunc.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i64.i32(9223372036854775807);
  call {:cexpr "ys"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/basic/trunc.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/basic/trunc.c", 13, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/basic/trunc.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i64.i32(9223372036854775807);
  call {:cexpr "xs"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/basic/trunc.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $trunc.i64.i32($sub.i64(0, 1));
  call {:cexpr "ys"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/basic/trunc.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/basic/trunc.c", 16, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/basic/trunc.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
