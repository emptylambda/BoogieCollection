...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/account_fail.c -bpl ./account_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 34056));
...
const acc: ref;
axiom (acc == $sub.ref(0, 1032));
const create: ref;
axiom (create == $sub.ref(0, 2064));
procedure {:inline 1} create($i0: i32)
  returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
  ...
  var $i6: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/account_fail.c", 24, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "create:arg:b"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/pthread/account_fail.c", 24, 28} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(32);
  assume {:sourceloc "test/c/pthread/account_fail.c", 24, 18} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/account_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 25, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p3, $i0);
  assume {:sourceloc "test/c/pthread/account_fail.c", 26, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 26, 18} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p4, 0);
  assume {:sourceloc "test/c/pthread/account_fail.c", 27, 28} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_mutex_init($p5, $0.ref);
  assume {:sourceloc "test/c/pthread/account_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $r := $p2;
  $exn := false;
  return;
...
axiom (pthread_mutex_init == $sub.ref(0, 5160));
procedure {:inline 1} pthread_mutex_init($p0: ref, $p1: ref)
  returns ($r: i32);
const read: ref;
axiom (read == $sub.ref(0, 6192));
procedure {:inline 1} read()
  returns ($r: i32)
{
  var $p0: ref;
  var $p1: ref;
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/account_fail.c", 32, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/account_fail.c", 32, 21} true;
  assume {:verifier.code 0} true;
  $p0 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 32, 26} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 32, 26} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "test/c/pthread/account_fail.c", 32, 14} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
const deposit: ref;
axiom (deposit == $sub.ref(0, 7224));
procedure {:inline 1} deposit($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $p2: ref;
  ...
  var $i14: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/account_fail.c", 35, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/account_fail.c", 35, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/account_fail.c", 36, 23} true;
  assume {:verifier.code 0} true;
  $p2 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 36, 28} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p2, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i4 := pthread_mutex_lock($p3);
  assume {:sourceloc "test/c/pthread/account_fail.c", 37, 18} true;
  assume {:verifier.code 0} true;
  $p5 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 37, 23} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p5, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 37, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "test/c/pthread/account_fail.c", 37, 33} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.3, $p1);
  assume {:sourceloc "test/c/pthread/account_fail.c", 37, 31} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i7, $i8);
  assume {:sourceloc "test/c/pthread/account_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p10 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p10, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 37, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p11, $i9);
  assume {:sourceloc "test/c/pthread/account_fail.c", 38, 25} true;
  assume {:verifier.code 0} true;
  $p12 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 38, 30} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p12, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_mutex_unlock($p13);
  assume {:sourceloc "test/c/pthread/account_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
axiom (pthread_mutex_lock == $sub.ref(0, 8256));
procedure {:inline 1} pthread_mutex_lock($p0: ref)
  returns ($r: i32);
const pthread_mutex_unlock: ref;
axiom (pthread_mutex_unlock == $sub.ref(0, 9288));
procedure {:inline 1} pthread_mutex_unlock($p0: ref)
  returns ($r: i32);
const withdraw: ref;
axiom (withdraw == $sub.ref(0, 10320));
procedure {:inline 1} withdraw($p0: ref)
  returns ($r: ref)
{
  var $p1: ref;
  var $i2: i32;
  ...
  var $p18: ref;
$bb0:
  assume {:sourceloc "test/c/pthread/account_fail.c", 44, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/account_fail.c", 44, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/account_fail.c", 46, 7} true;
  assume {:verifier.code 0} true;
  call $i2 := read();
  call {:cexpr "r"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/pthread/account_fail.c", 47, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.4, $p1);
  assume {:sourceloc "test/c/pthread/account_fail.c", 47, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $sge.i32($i2, $i3);
  assume {:sourceloc "test/c/pthread/account_fail.c", 47, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "test/c/pthread/account_fail.c", 48, 25} true;
  assume {:verifier.code 0} true;
  $p5 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 48, 30} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p5, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 48, 5} true;
  assume {:verifier.code 0} true;
  call $i7 := pthread_mutex_lock($p6);
  assume {:sourceloc "test/c/pthread/account_fail.c", 49, 24} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.4, $p1);
  assume {:sourceloc "test/c/pthread/account_fail.c", 49, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i2, $i8);
  assume {:sourceloc "test/c/pthread/account_fail.c", 49, 5} true;
  assume {:verifier.code 0} true;
  $p10 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 49, 10} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p10, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 49, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p11, $i9);
  assume {:sourceloc "test/c/pthread/account_fail.c", 50, 27} true;
  assume {:verifier.code 0} true;
  $p12 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 50, 32} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p12, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 50, 5} true;
  assume {:verifier.code 0} true;
  call $i14 := pthread_mutex_unlock($p13);
  assume {:sourceloc "test/c/pthread/account_fail.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $p15 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 51, 10} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p15, $mul.ref(0, 32)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 51, 20} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p16, 1);
  assume {:sourceloc "test/c/pthread/account_fail.c", 52, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 54, 3} true;
  assume {:verifier.code 0} true;
  $p17 := $M.2;
  assume {:sourceloc "test/c/pthread/account_fail.c", 54, 8} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p17, $mul.ref(0, 32)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 54, 18} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p18, 0);
  assume {:sourceloc "test/c/pthread/account_fail.c", 55, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/pthread/account_fail.c", 56, 1} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/account_fail.c", 63, 7} true;
  ...
  assume {:sourceloc "test/c/pthread/account_fail.c", 64, 7} true;
  assume {:verifier.code 1} true;
  call $i5 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/pthread/account_fail.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $M.5 := $store.i32($M.5, $p2, $i5);
  assume {:sourceloc "test/c/pthread/account_fail.c", 65, 7} true;
  assume {:verifier.code 1} true;
  call $i6 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_i32($i6);
  assume {:sourceloc "test/c/pthread/account_fail.c", 65, 5} true;
  assume {:verifier.code 0} true;
  $M.6 := $store.i32($M.6, $p3, $i6);
  assume {:sourceloc "test/c/pthread/account_fail.c", 66, 9} true;
  assume {:verifier.code 0} true;
  call $p7 := create($i4);
  assume {:sourceloc "test/c/pthread/account_fail.c", 66, 7} true;
  assume {:verifier.code 0} true;
  $M.2 := $p7;
  assume {:sourceloc "test/c/pthread/account_fail.c", 69, 37} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/pthread/account_fail.c", 69, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_create($p0, $0.ref, deposit, $p8);
  assume {:sourceloc "test/c/pthread/account_fail.c", 70, 38} true;
  assume {:verifier.code 0} true;
  $p10 := $bitcast.ref.ref($p3);
  assume {:sourceloc "test/c/pthread/account_fail.c", 70, 3} true;
  assume {:verifier.code 0} true;
  call $i11 := pthread_create($p1, $0.ref, withdraw, $p10);
  assume {:sourceloc "test/c/pthread/account_fail.c", 72, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i32($M.7, $p0);
  assume {:sourceloc "test/c/pthread/account_fail.c", 72, 3} true;
  assume {:verifier.code 0} true;
  call $i13 := pthread_join($i12, $0.ref);
  assume {:sourceloc "test/c/pthread/account_fail.c", 73, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $load.i32($M.8, $p1);
  assume {:sourceloc "test/c/pthread/account_fail.c", 73, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := pthread_join($i14, $0.ref);
  assume {:sourceloc "test/c/pthread/account_fail.c", 75, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/account_fail.c", 75, 3} true;
  ...
  assume {:sourceloc "test/c/pthread/account_fail.c", 75, 3} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p16, $mul.ref(0, 32)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/pthread/account_fail.c", 75, 3} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "test/c/pthread/account_fail.c", 76, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assert == $sub.ref(0, 17544));
...
axiom (llvm.dbg.value == $sub.ref(0, 33024));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 34056));
