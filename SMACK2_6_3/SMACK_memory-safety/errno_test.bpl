...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/errno_test.c -bpl ./errno_test.bpl
...
axiom (errno_global == $sub.ref(0, 1028));
const main: ref;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/errno_test.c", 6, 21} true;
  ...
  assume {:verifier.code 0} true;
  $i1 := $M.0;
  assume {:sourceloc "test/c/memory-safety/errno_test.c", 6, 14} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
axiom (__SMACK_and32 == $sub.ref(0, 6188));
...
axiom (__SMACK_and64 == $sub.ref(0, 7220));
...
axiom (__SMACK_and16 == $sub.ref(0, 8252));
...
axiom (__SMACK_and8 == $sub.ref(0, 9284));
...
axiom (__SMACK_or32 == $sub.ref(0, 10316));
...
axiom (__SMACK_or64 == $sub.ref(0, 11348));
...
axiom (__SMACK_or16 == $sub.ref(0, 12380));
...
axiom (__SMACK_or8 == $sub.ref(0, 13412));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 14444));
...
axiom (__SMACK_decls == $sub.ref(0, 15476));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 16508));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 17540));
...
axiom (__errno_location == $sub.ref(0, 18572));
procedure {:inline 1} __errno_location()
  returns ($r: ref)
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/errno.c", 7, 31} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "/usr/local/share/smack/lib/errno.c", 7, 31} true;
  assume {:verifier.code 0} true;
  $r := errno_global;
