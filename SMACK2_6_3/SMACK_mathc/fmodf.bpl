...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/fmodf.c -bpl ./fmodf.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/fmodf.c", 17, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/mathc/fmodf.c", 17, 13} true;
  assume {:verifier.code 0} true;
  call $f0 := fmodf($fp(0, 4014666660000000, 140735749247056), $fp(-3, 0, 0));
  call {:cexpr "c"} boogie_si_record_float($f0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/mathc/fmodf.c", 18, 3} true;
  ...
  assume {:sourceloc "test/c/mathc/fmodf.c", 18, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmodf.c:18:3: warning: over-approximating floating-point arithmetic fsub; */
  ...
  assume {:sourceloc "test/c/mathc/fmodf.c", 18, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmodf.c:18:3: warning: over-approximating call to llvm.fabs.f32; */
  call $f4 := llvm.fabs.f32($f3);
  assume {:sourceloc "test/c/mathc/fmodf.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $f5 := $fpext.float.float($f4);
  assume {:sourceloc "test/c/mathc/fmodf.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i6 := (if $folt.float.bool($f5, $fp(1, 0, 8)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/fmodf.c", 20, 8} true;
  assume {:verifier.code 0} true;
  call $i7 := __isnanf($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 20, 8} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 20, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/mathc/fmodf.c", 25, 8} true;
  assume {:verifier.code 0} true;
  call $i15 := __isnanf($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $i16 := $ne.i32($i15, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  goto $bb19, $bb21;
$bb8:
  assume !(($i8 == 1));
  assume {:sourceloc "test/c/mathc/fmodf.c", 21, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/mathc/fmodf.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call $f9 := fmodf($fp(0, 7, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 21, 5} true;
  assume {:verifier.code 0} true;
  call $i10 := __isnanf($f9);
  assume {:sourceloc "test/c/mathc/fmodf.c", 21, 5} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 21, 5} true;
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "test/c/mathc/fmodf.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "test/c/mathc/fmodf.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call $f12 := fmodf($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 22, 5} true;
  assume {:verifier.code 0} true;
  call $i13 := __isnanf($f12);
  assume {:sourceloc "test/c/mathc/fmodf.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i13, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 22, 5} true;
...
$bb17:
  ...
  goto $bb16;
$bb18:
  assume {:sourceloc "test/c/mathc/fmodf.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb19:
  assume {:sourceloc "test/c/mathc/fmodf.c", 25, 7} true;
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/mathc/fmodf.c", 30, 8} true;
  assume {:verifier.code 0} true;
  call $i23 := __isnanf($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i23, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 30, 20} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb32, $bb34;
$bb21:
  assume !(($i16 == 1));
  assume {:sourceloc "test/c/mathc/fmodf.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/mathc/fmodf.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $f17 := fmodf($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 26, 5} true;
  assume {:verifier.code 0} true;
  call $i18 := __isnanf($f17);
  assume {:sourceloc "test/c/mathc/fmodf.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.i32($i18, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 26, 5} true;
...
$bb25:
  ...
  goto $bb24;
$bb26:
  assume {:sourceloc "test/c/mathc/fmodf.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb27;
$bb27:
  assume {:sourceloc "test/c/mathc/fmodf.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $f20 := fmodf($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 27, 5} true;
  assume {:verifier.code 0} true;
  call $i21 := __isnanf($f20);
  assume {:sourceloc "test/c/mathc/fmodf.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i21, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 27, 5} true;
...
$bb30:
  ...
  goto $bb29;
$bb31:
  assume {:sourceloc "test/c/mathc/fmodf.c", 28, 3} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb32:
  assume {:sourceloc "test/c/mathc/fmodf.c", 30, 20} true;
  ...
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/mathc/fmodf.c", 35, 8} true;
  assume {:verifier.code 0} true;
  call $i31 := __isnanf($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 35, 8} true;
  assume {:verifier.code 0} true;
  $i32 := $ne.i32($i31, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 35, 20} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i32} true;
  goto $bb47, $bb49;
$bb34:
  assume !(($i24 == 1));
  assume {:sourceloc "test/c/mathc/fmodf.c", 30, 24} true;
  assume {:verifier.code 0} true;
  call $i25 := __isinff($fp(2, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 30, 24} true;
  assume {:verifier.code 0} true;
  $i26 := $ne.i32($i25, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 30, 7} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume !(($i26 == 1));
  assume {:sourceloc "test/c/mathc/fmodf.c", 31, 5} true;
  assume {:verifier.code 0} true;
  goto $bb37;
$bb37:
  assume {:sourceloc "test/c/mathc/fmodf.c", 31, 5} true;
  assume {:verifier.code 0} true;
  call $f27 := fmodf($fp(2, 0, 0), $fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 31, 5} true;
  assume {:verifier.code 0} true;
  $i28 := (if $foeq.float.bool($f27, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 31, 5} true;
  assume {:verifier.code 0} true;
...
$bb40:
  ...
  goto $bb39;
$bb41:
  assume {:sourceloc "test/c/mathc/fmodf.c", 32, 5} true;
  assume {:verifier.code 0} true;
  goto $bb42;
$bb42:
  assume {:sourceloc "test/c/mathc/fmodf.c", 32, 5} true;
  assume {:verifier.code 0} true;
  call $f29 := fmodf($fp(2, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $i30 := (if $foeq.float.bool($f29, $fp(2, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 32, 5} true;
  assume {:verifier.code 0} true;
...
$bb45:
  ...
  goto $bb44;
$bb46:
  assume {:sourceloc "test/c/mathc/fmodf.c", 33, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb47:
  assume {:sourceloc "test/c/mathc/fmodf.c", 35, 20} true;
  ...
  goto $bb48;
$bb48:
  assume {:sourceloc "test/c/mathc/fmodf.c", 42, 3} true;
  assume {:verifier.code 0} true;
  goto $bb67;
$bb49:
  assume !(($i32 == 1));
  assume {:sourceloc "test/c/mathc/fmodf.c", 35, 24} true;
  assume {:verifier.code 0} true;
  call $i33 := __iszerof($fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 35, 24} true;
  assume {:verifier.code 0} true;
  $i34 := $ne.i32($i33, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 35, 7} true;
  assume {:verifier.code 0} true;
...
$bb51:
  assume !(($i34 == 1));
  assume {:sourceloc "test/c/mathc/fmodf.c", 36, 5} true;
  assume {:verifier.code 0} true;
  goto $bb52;
$bb52:
  assume {:sourceloc "test/c/mathc/fmodf.c", 36, 5} true;
  assume {:verifier.code 0} true;
  call $f35 := fmodf($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 36, 5} true;
  assume {:verifier.code 0} true;
  $i36 := (if $foeq.float.bool($f35, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 36, 5} true;
  assume {:verifier.code 0} true;
...
$bb55:
  ...
  goto $bb54;
$bb56:
  assume {:sourceloc "test/c/mathc/fmodf.c", 37, 5} true;
  assume {:verifier.code 0} true;
  goto $bb57;
$bb57:
  assume {:sourceloc "test/c/mathc/fmodf.c", 37, 5} true;
  assume {:verifier.code 0} true;
  call $f37 := fmodf($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 37, 5} true;
  assume {:verifier.code 0} true;
  $i38 := (if $foeq.float.bool($f37, $fp(0, 0, 0)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 37, 5} true;
  assume {:verifier.code 0} true;
...
$bb60:
  ...
  goto $bb59;
$bb61:
  assume {:sourceloc "test/c/mathc/fmodf.c", 38, 28} true;
  assume {:verifier.code 0} true;
  call $f39 := fmodf($fp(0, 0, 0), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 38, 17} true;
  assume {:verifier.code 0} true;
  call $i40 := __signbitf($f39);
  call {:cexpr "isNeg"} boogie_si_record_i32($i40);
  assume {:sourceloc "test/c/mathc/fmodf.c", 39, 5} true;
  assume {:verifier.code 0} true;
  goto $bb62;
$bb62:
  assume {:sourceloc "test/c/mathc/fmodf.c", 39, 5} true;
...
$bb65:
  ...
  goto $bb64;
$bb66:
  assume {:sourceloc "test/c/mathc/fmodf.c", 40, 3} true;
  assume {:verifier.code 0} true;
  goto $bb48;
$bb67:
  assume {:sourceloc "test/c/mathc/fmodf.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $f42 := fmodf($fp(0, 7, 8000000000000), $fp(-8, 500000, 0));
  assume {:sourceloc "test/c/mathc/fmodf.c", 42, 3} true;
  assume {:verifier.code 0} true;
  call $i43 := __isnanf($f42);
  assume {:sourceloc "test/c/mathc/fmodf.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $i44 := $ne.i32($i43, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 42, 3} true;
...
$bb70:
  ...
  goto $bb69;
$bb71:
  assume {:sourceloc "test/c/mathc/fmodf.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb72;
$bb72:
  assume {:sourceloc "test/c/mathc/fmodf.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $f45 := fmodf($fp(2, 0, 0), $fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/fmodf.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call $i46 := __isnanf($f45);
  assume {:sourceloc "test/c/mathc/fmodf.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $i47 := $ne.i32($i46, 0);
  assume {:sourceloc "test/c/mathc/fmodf.c", 43, 3} true;
...
$bb75:
  ...
  goto $bb74;
$bb76:
  assume {:sourceloc "test/c/mathc/fmodf.c", 45, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
