...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/globals.c -bpl ./globals.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/globals.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/globals.c", 10, 19} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(4);
  assume {:sourceloc "test/c/basic/globals.c", 10, 12} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/basic/globals.c", 12, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := 3;
  call {:cexpr "g1"} boogie_si_record_i32(3);
  assume {:sourceloc "test/c/basic/globals.c", 13, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, 4);
  assume {:sourceloc "test/c/basic/globals.c", 14, 6} true;
  assume {:verifier.code 0} true;
  $M.2 := 5;
  call {:cexpr "g2"} boogie_si_record_i32(5);
  assume {:sourceloc "test/c/basic/globals.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/globals.c", 15, 3} true;
...
$bb9:
  ...
  goto $bb4;
$bb10:
  assume {:sourceloc "test/c/basic/globals.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
