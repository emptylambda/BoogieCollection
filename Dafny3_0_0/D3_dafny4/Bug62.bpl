// Dafny 3.0.0.30204
// Command Line Options: -compile:0 -noVerify /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny4/Bug62.dfy -print:./Bug62.bpl
...
procedure CheckWellformed$$_module.C._C(this: ref
       where this != null
         && 
...
procedure CheckWellformed$$_module.C.Main(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.C())
         && $IsAlloc(this, Tclass._module.C(), $Heap));
...
procedure Call$$_module.C.Main(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.C())
         && $IsAlloc(this, Tclass._module.C(), $Heap));
...
procedure Impl$$_module.C.Main(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.C())
         && $IsAlloc(this, Tclass._module.C(), $Heap))
...
procedure CheckWellformed$$_module.D.Main(this: ref
       where this != null
         && 
...
procedure Call$$_module.D.Main(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.D())
         && $IsAlloc(this, Tclass._module.D(), $Heap));
...
procedure Impl$$_module.D.Main(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.D())
         && $IsAlloc(this, Tclass._module.D(), $Heap))
...
procedure CheckWellformed$$_module.E.E_Main();
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.E.E_Main();
...
procedure Impl$$_module.E.E_Main() returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  // user-defined preconditions
  requires Lit(true);
  modifies $Heap, $Tick;
