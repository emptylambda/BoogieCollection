...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/mm.c -bpl ./mm.bpl
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "test/c/bits/mm.c", 13, 16} true;
  ...
  assume {:sourceloc "test/c/bits/mm.c", 14, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/mm.c:14:9: warning: over-approximating bitwise operation ashr; */
  $i3 := $ashr.i32($i2, 28);
  call {:cexpr "f"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/bits/mm.c", 15, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/mm.c:15:9: warning: over-approximating bitwise operation and; */
  $i4 := $and.i32($i3, 15);
  call {:cexpr "f"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/bits/mm.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
procedure {:inline 1} set_field($p0: ref, $i1: i32)
{
  ...
  var $p8: ref;
$bb0:
  assume {:sourceloc "test/c/bits/mm.c", 20, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "set_field:arg:f"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/bits/mm.c", 20, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/mm.c:20:9: warning: over-approximating bitwise operation and; */
  $i2 := $and.i32($i1, 15);
  call {:cexpr "f"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/bits/mm.c", 21, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/mm.c:21:9: warning: over-approximating bitwise operation shl; */
  $i3 := $shl.i32($i2, 28);
  call {:cexpr "f"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/bits/mm.c", 22, 20} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/bits/mm.c", 22, 20} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p4);
  assume {:sourceloc "test/c/bits/mm.c", 22, 24} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/mm.c:22:24: warning: over-approximating bitwise operation and; */
  $i6 := $and.i32($i5, 268435455);
  assume {:sourceloc "test/c/bits/mm.c", 22, 37} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/mm.c:22:37: warning: over-approximating bitwise operation or; */
  $i7 := $or.i32($i6, $i3);
  assume {:sourceloc "test/c/bits/mm.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/bits/mm.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p8, $i7);
  assume {:sourceloc "test/c/bits/mm.c", 23, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/mm.c", 27, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/bits/mm.c", 28, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, 1);
  assume {:sourceloc "test/c/bits/mm.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call set_field($p0, $i2);
  assume {:sourceloc "test/c/bits/mm.c", 29, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := get_field($p0);
  call {:cexpr "g"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/bits/mm.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/mm.c", 30, 3} true;
  ...
  assume {:sourceloc "test/c/bits/mm.c", 30, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/mm.c:30:3: warning: over-approximating bitwise operation and; */
  $i5 := $and.i32($i4, 15);
  assume {:sourceloc "test/c/bits/mm.c", 30, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/mm.c:30:3: warning: over-approximating bitwise operation and; */
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/mm.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
