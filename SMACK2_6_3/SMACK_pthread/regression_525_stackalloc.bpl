...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/regression_525_stackalloc.c -bpl ./regression_525_stackalloc.bpl
...
procedure {:inline 1} atomic_store_ptr($p0: ref, $p1: ref)
{
  var $p2: ref;
$bb0:
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 24, 26} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 24, 26} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p0, $mul.ref(0, 8)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p2, $p1);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
  ...
  returns ($r: ref)
{
  ...
  var $p4: ref;
$bb0:
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 28, 17} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 28, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 37, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 37, 4} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 37, 29} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i64($M.3, $p5, 0);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 38, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  $p7 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 38, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.ref($M.0, $p7, $0.ref);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 40, 42} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 40, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i10 == 1);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 41, 5} true;
  assume {:verifier.code 0} true;
  $i11 := 1;
  goto $bb3;
$bb2:
  assume !(($i10 == 1));
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 43, 26} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  $p13 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 43, 28} true;
  assume {:verifier.code 0} true;
  $p14 := $load.ref($M.3, $p13);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 43, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $p2i.ref.i64($p14);
  call {:cexpr "v"} boogie_si_record_i64($i15);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 44, 23} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 44, 3} true;
  assume {:verifier.code 0} true;
  call atomic_store_ptr($p16, $0.ref);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 45, 26} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  $p18 := $add.ref($add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1)), $mul.ref(0, 1));
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 45, 28} true;
  assume {:verifier.code 0} true;
  $p19 := $load.ref($M.3, $p18);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 45, 16} true;
  assume {:verifier.code 0} true;
  $i20 := $p2i.ref.i64($p19);
  call {:cexpr "w"} boogie_si_record_i64($i20);
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 46, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 48, 1} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $exn := false;
  return;
...
$bb7:
  ...
  goto $bb6;
$bb8:
  assume {:sourceloc "test/c/pthread/regression_525_stackalloc.c", 47, 3} true;
  assume {:verifier.code 0} true;
  $i11 := 0;
  goto $bb3;
}
