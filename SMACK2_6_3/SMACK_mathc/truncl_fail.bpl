...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/truncl_fail.c -bpl ./truncl_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 11, 21} true;
  ...
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __isnanl($f0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 22} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 26} true;
  assume {:verifier.code 0} true;
  call $i3 := __isinfl($f0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 26} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 40} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 44} true;
  assume {:verifier.code 0} true;
  call $i5 := __iszerol($f0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 44} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 13, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 14, 13} true;
  assume {:verifier.code 0} true;
  $i7 := (if $fogt.float.bool($f0, $fp(0, 0, 37782864)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 14, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i7 == 1);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 17, 7} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb10:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/truncl_fail.c:15:7: warning: over-approximating call to llvm.trunc.f80; */
  call $f8 := llvm.trunc.f80($f0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
  $i9 := (if $fole.float.bool($f8, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 15, 7} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb12;
$bb14:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb16:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 17, 7} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/truncl_fail.c:17:7: warning: over-approximating call to llvm.trunc.f80; */
  call $f10 := llvm.trunc.f80($f0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 17, 7} true;
  assume {:verifier.code 0} true;
  $i11 := (if $foge.float.bool($f10, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 17, 7} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/truncl_fail.c:21:3: warning: over-approximating call to llvm.trunc.f80; */
  call $f12 := llvm.trunc.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $i13 := (if $foeq.float.bool($f12, $fp(0, 0, 37142176)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/truncl_fail.c:22:3: warning: over-approximating call to llvm.trunc.f80; */
  call $f14 := llvm.trunc.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i15 := (if $foeq.float.bool($f14, $fp(0, 0, 37547616)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  goto $bb28;
$bb30:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 23, 26} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/truncl_fail.c:23:26: warning: over-approximating call to llvm.trunc.f80; */
  call $f16 := llvm.trunc.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 23, 15} true;
  assume {:verifier.code 0} true;
  call $i17 := __signbitl($f16);
  call {:cexpr "isNeg"} boogie_si_record_i32($i17);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 24, 3} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/truncl_fail.c:26:3: warning: over-approximating call to llvm.trunc.f80; */
  call $f19 := llvm.trunc.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  $i20 := (if $foeq.float.bool($f19, $fp(0, 0, 37045488)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/truncl_fail.c:27:3: warning: over-approximating call to llvm.trunc.f80; */
  call $f21 := llvm.trunc.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(0, 0, 37217312)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  goto $bb46;
$bb46:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/truncl_fail.c:29:3: warning: over-approximating call to llvm.trunc.f80; */
  call $f23 := llvm.trunc.f80($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
...
$bb49:
  ...
  goto $bb50;
$bb50:
  assume {:sourceloc "test/c/mathc/truncl_fail.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
procedure {:inline 1} __iszerol($f0: float)
  returns ($r: i32);
const llvm.trunc.f80: ref;
axiom (llvm.trunc.f80 == $sub.ref(0, 6192));
procedure {:inline 1} llvm.trunc.f80($f0: float)
  returns ($r: float);
