...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/copysignl_fail.c -bpl ./copysignl_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 11, 19} true;
  ...
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 12, 19} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call $i2 := __isnanl($f0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 20} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 27, 8} true;
  assume {:verifier.code 0} true;
  call $i23 := __isnanl($f1);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 27, 8} true;
  assume {:verifier.code 0} true;
  $i24 := $ne.i32($i23, 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 27, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i24} true;
  goto $bb28, $bb30;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 24} true;
  assume {:verifier.code 0} true;
  call $i4 := __isinfl($f0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 24} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 36} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 40} true;
  assume {:verifier.code 0} true;
  call $i6 := __iszerol($f0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 40} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call $i8 := __isnanl($f1);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 22} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb10:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 26} true;
  assume {:verifier.code 0} true;
  call $i10 := __isinfl($f1);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 26} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 38} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i11 == 1));
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 42} true;
  assume {:verifier.code 0} true;
  call $i12 := __iszerol($f1);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 42} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i13 == 1));
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 16, 25} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/copysignl_fail.c:16:25: warning: over-approximating unmodeled operation llvm.copysign.f80; */
  call $f14 := llvm.copysign.f80($f0, $f1);
  call {:cexpr "val"} boogie_si_record_float($f14);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 17, 11} true;
  assume {:verifier.code 0} true;
  call $i15 := __signbitl($f0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 17, 27} true;
  assume {:verifier.code 0} true;
  call $i16 := __signbitl($f1);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 17, 25} true;
  assume {:verifier.code 0} true;
  $i17 := $sub.i32($i15, $i16);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 17, 25} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i18 == 1);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i18 == 1));
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb17:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/copysignl_fail.c:18:9: warning: over-approximating floating-point arithmetic fneg; */
  $f19 := $fneg.float($f0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $i20 := (if $foeq.float.bool($f14, $f19) then 1 else 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb19;
$bb21:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb23:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/copysignl_fail.c:20:9: warning: over-approximating floating-point arithmetic fneg; */
  $f21 := $fneg.float($f0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f14, $f21) then 1 else 0);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb30:
  assume !(($i24 == 1));
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 28, 23} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/copysignl_fail.c:28:23: warning: over-approximating unmodeled operation llvm.copysign.f80; */
  call $f25 := llvm.copysign.f80($fp(0, 0, 0), $f1);
  call {:cexpr "val"} boogie_si_record_float($f25);
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 29, 5} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 29, 5} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/copysignl_fail.c", 30, 3} true;
  assume {:verifier.code 0} true;
  goto $bb29;
}
...
procedure {:inline 1} __iszerol($f0: float)
  returns ($r: i32);
const llvm.copysign.f80: ref;
axiom (llvm.copysign.f80 == $sub.ref(0, 6192));
procedure {:inline 1} llvm.copysign.f80($f0: float, $f1: float)
  returns ($r: float);
