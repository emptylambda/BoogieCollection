...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/checking_invert_out.c -bpl ./checking_invert_out.bpl
...
{
$bb0:
  assume {:sourceloc "test/c/basic/checking_invert_out.c", 9, 17} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/checking_invert_out.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/basic/checking_invert_out.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call foo();
  assume {:sourceloc "test/c/basic/checking_invert_out.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/checking_invert_out.c", 13, 3} true;
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/basic/checking_invert_out.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
