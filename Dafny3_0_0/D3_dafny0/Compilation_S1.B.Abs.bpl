...
procedure CheckWellformed$$S1.B.Abs.C.__ctor(this: ref
       where this != null
         && 
        $Is(this, Tclass.S1.B.Abs.C())
         && $IsAlloc(this, Tclass.S1.B.Abs.C(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$S1.B.Abs.C.__ctor()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass.S1.B.Abs.C())
...
procedure CheckWellformed$$S1.B.Abs.C.m(this: ref
       where this != null
         && 
        $Is(this, Tclass.S1.B.Abs.C())
         && $IsAlloc(this, Tclass.S1.B.Abs.C(), $Heap));
...
procedure Call$$S1.B.Abs.C.m(this: ref
       where this != null
         && 
        $Is(this, Tclass.S1.B.Abs.C())
         && $IsAlloc(this, Tclass.S1.B.Abs.C(), $Heap));
