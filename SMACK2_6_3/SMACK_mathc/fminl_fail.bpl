...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/fminl_fail.c -bpl ./fminl_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 11, 19} true;
  assume {:verifier.code 1} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 11, 19} true;
  assume {:verifier.code 1} true;
  call $f0 := __VERIFIER_nondet_long_double();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long_double"} boogie_si_record_float($f0);
  call {:cexpr "x"} boogie_si_record_float($f0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 12, 19} true;
  assume {:verifier.code 1} true;
  call $f1 := __VERIFIER_nondet_long_double();
  call {:cexpr "smack:ext:__VERIFIER_nondet_long_double"} boogie_si_record_float($f1);
  call {:cexpr "y"} boogie_si_record_float($f1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call $i2 := __isnanl($f0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 20} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  call $i18 := __isnanl($f1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.i32($i18, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb28, $bb30;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 24} true;
  assume {:verifier.code 0} true;
  call $i4 := __isinfl($f0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 24} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 36} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 40} true;
  assume {:verifier.code 0} true;
  call $i6 := __iszerol($f0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 40} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call $i8 := __isnanl($f1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 22} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb10:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 26} true;
  assume {:verifier.code 0} true;
  call $i10 := __isinfl($f1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 26} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 38} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i11 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 42} true;
  assume {:verifier.code 0} true;
  call $i12 := __iszerol($f1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 42} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i13 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 16, 28} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fminl_fail.c:16:28: warning: over-approximating call to llvm.minnum.f80; */
  call $f14 := llvm.minnum.f80($f0, $f1);
  call {:cexpr "minVal"} boogie_si_record_float($f14);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 17, 13} true;
  assume {:verifier.code 0} true;
  $i15 := (if $folt.float.bool($f0, $f1) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 17, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i15 == 1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i15 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb17:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $i16 := (if $foeq.float.bool($f14, $f1) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
...
$bb20:
  ...
  goto $bb19;
$bb21:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb23:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
  $i17 := (if $foeq.float.bool($f14, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 20, 9} true;
  assume {:verifier.code 0} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 31, 8} true;
  assume {:verifier.code 0} true;
  call $i26 := __isnanl($f0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 31, 8} true;
  assume {:verifier.code 0} true;
  $i27 := $ne.i32($i26, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 31, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb46, $bb48;
$bb30:
  assume !(($i19 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fminl_fail.c:26:5: warning: over-approximating call to llvm.minnum.f80; */
  call $f20 := llvm.minnum.f80($fp(0, 0, 0), $f1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
  $i21 := (if $foeq.float.bool($f20, $f1) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 26, 5} true;
  assume {:verifier.code 0} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fminl_fail.c:27:5: warning: over-approximating call to llvm.minnum.f80; */
  call $f22 := llvm.minnum.f80($fp(0, 0, 0), $f1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
  $i23 := (if $foeq.float.bool($f22, $fp(0, 0, 33448688)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 27, 5} true;
  assume {:verifier.code 0} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 28, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fminl_fail.c:28:5: warning: over-approximating call to llvm.minnum.f80; */
  call $f24 := llvm.minnum.f80($fp(0, 0, 0), $f1);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 28, 5} true;
  assume {:verifier.code 0} true;
  $i25 := (if $foeq.float.bool($f24, $f1) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 28, 5} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb46:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 31, 7} true;
  ...
  goto $bb47;
$bb47:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb64;
$bb48:
  assume !(($i27 == 1));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  goto $bb49;
$bb49:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fminl_fail.c:32:5: warning: over-approximating call to llvm.minnum.f80; */
  call $f28 := llvm.minnum.f80($f0, $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
  $i29 := (if $foeq.float.bool($f28, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 32, 5} true;
  assume {:verifier.code 0} true;
...
$bb52:
  ...
  goto $bb51;
$bb53:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 33, 5} true;
  assume {:verifier.code 0} true;
  goto $bb54;
$bb54:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 33, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fminl_fail.c:33:5: warning: over-approximating call to llvm.minnum.f80; */
  call $f30 := llvm.minnum.f80($f0, $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $i31 := (if $foeq.float.bool($f30, $fp(0, 0, 33146912)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 33, 5} true;
  assume {:verifier.code 0} true;
...
$bb57:
  ...
  goto $bb56;
$bb58:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 34, 5} true;
  assume {:verifier.code 0} true;
  goto $bb59;
$bb59:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 34, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fminl_fail.c:34:5: warning: over-approximating call to llvm.minnum.f80; */
  call $f32 := llvm.minnum.f80($f0, $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 34, 5} true;
  assume {:verifier.code 0} true;
  $i33 := (if $foeq.float.bool($f32, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 34, 5} true;
  assume {:verifier.code 0} true;
...
$bb62:
  ...
  goto $bb61;
$bb63:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb47;
$bb64:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fminl_fail.c:37:3: warning: over-approximating call to llvm.minnum.f80; */
  call $f34 := llvm.minnum.f80($fp(0, 0, 0), $fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  call $i35 := __isnanl($f34);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $i36 := $ne.i32($i35, 0);
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 37, 3} true;
...
$bb67:
  ...
  goto $bb66;
$bb68:
  assume {:sourceloc "test/c/mathc/fminl_fail.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
}
const __VERIFIER_nondet_long_double: ref;
axiom (__VERIFIER_nondet_long_double == $sub.ref(0, 2064));
procedure {:inline 1} __VERIFIER_nondet_long_double()
  returns ($r: float);
const __isnanl: ref;
axiom (__isnanl == $sub.ref(0, 3096));
procedure {:inline 1} __isnanl($f0: float)
  returns ($r: i32);
const __isinfl: ref;
axiom (__isinfl == $sub.ref(0, 4128));
procedure {:inline 1} __isinfl($f0: float)
  returns ($r: i32);
const __iszerol: ref;
axiom (__iszerol == $sub.ref(0, 5160));
procedure {:inline 1} __iszerol($f0: float)
  returns ($r: i32);
const llvm.minnum.f80: ref;
axiom (llvm.minnum.f80 == $sub.ref(0, 6192));
procedure {:inline 1} llvm.minnum.f80($f0: float, $f1: float)
  returns ($r: float);
...
procedure {:inline 1} boogie_si_record_float(x: float);
