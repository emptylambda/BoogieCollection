...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/contracts/simple.c -bpl ./simple.bpl
  ...
  ensures $expr($M.0);
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "test/c/contracts/simple.c", 11, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/simple.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/contracts/simple.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/simple.c", 12, 3} true;
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/contracts/simple.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb3;
$bb3:
  assert {:loopinvariant} $expr.2($M.0);
  assume {:sourceloc "test/c/contracts/simple.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/simple.c", 13, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, 10);
  assume {:sourceloc "test/c/contracts/simple.c", 13, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/contracts/simple.c", 14, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/simple.c", 14, 5} true;
  assume {:verifier.code 1} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/contracts/simple.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb6:
  assume {:sourceloc "test/c/contracts/simple.c", 15, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $M.0;
  assume {:sourceloc "test/c/contracts/simple.c", 15, 6} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/contracts/simple.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "test/c/contracts/simple.c", 13, 28} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i2, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/contracts/simple.c", 21, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/contracts/simple.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $i0 := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "test/c/contracts/simple.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/simple.c", 22, 21} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 10);
  assume {:sourceloc "test/c/contracts/simple.c", 22, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/contracts/simple.c", 23, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/contracts/simple.c", 23, 5} true;
  assume {:verifier.code 1} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/contracts/simple.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb4:
  assume {:sourceloc "test/c/contracts/simple.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call p();
  assume {:sourceloc "test/c/contracts/simple.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "test/c/contracts/simple.c", 22, 28} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, 1);
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/contracts/simple.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
