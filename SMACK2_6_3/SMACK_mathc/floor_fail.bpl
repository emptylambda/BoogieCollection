...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/floor_fail.c -bpl ./floor_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/floor_fail.c", 12, 16} true;
  ...
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call $i1 := __isnan($f0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 21} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 25} true;
  assume {:verifier.code 0} true;
  call $i3 := __isinf($f0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i32($i3, 0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 38} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i4 == 1));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 42} true;
  assume {:verifier.code 0} true;
  call $i5 := __iszero($f0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 42} true;
  assume {:verifier.code 0} true;
  $i6 := $ne.i32($i5, 0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i6 == 1));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:15:5: warning: over-approximating call to llvm.floor.f64; */
  call $f7 := llvm.floor.f64($f0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $i8 := (if $folt.float.bool($f7, $f0) then 1 else 0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 15, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  ...
  goto $bb10;
$bb12:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:16:5: warning: over-approximating call to llvm.floor.f64; */
  call $f9 := llvm.floor.f64($f0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:16:5: warning: over-approximating floating-point arithmetic fsub; */
  $f10 := $fsub.float($f0, $fp(1, 0, 0));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $i11 := (if $foge.float.bool($f9, $f10) then 1 else 0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 16, 5} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb15;
$bb17:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb18:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:19:3: warning: over-approximating call to llvm.floor.f64; */
  call $f12 := llvm.floor.f64($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb21:
  ...
  goto $bb20;
$bb22:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb23:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:20:3: warning: over-approximating call to llvm.floor.f64; */
...
$bb26:
  ...
  goto $bb25;
$bb27:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 21, 25} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:21:25: warning: over-approximating call to llvm.floor.f64; */
  call $f16 := llvm.floor.f64($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 21, 15} true;
  assume {:verifier.code 0} true;
  call $i17 := __signbit($f16);
  call {:cexpr "isNeg"} boogie_si_record_i32($i17);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb28:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 22, 3} true;
...
$bb31:
  ...
  goto $bb30;
$bb32:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:24:3: warning: over-approximating call to llvm.floor.f64; */
  call $f19 := llvm.floor.f64($fp(0, 7, 0));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
...
$bb36:
  ...
  goto $bb35;
$bb37:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb38:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:25:3: warning: over-approximating call to llvm.floor.f64; */
  call $f21 := llvm.floor.f64($fp(0, 0, 0));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i22 := (if $foeq.float.bool($f21, $fp(0, 0, 20518368)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/floor_fail.c", 25, 3} true;
  assume {:verifier.code 0} true;
...
$bb41:
  ...
  goto $bb40;
$bb42:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb43:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/floor_fail.c:27:3: warning: over-approximating call to llvm.floor.f64; */
  call $f23 := llvm.floor.f64($fp(0, 7, 8000000000000));
  assume {:sourceloc "test/c/mathc/floor_fail.c", 27, 3} true;
  assume {:verifier.code 0} true;
...
$bb46:
  ...
  goto $bb45;
$bb47:
  assume {:sourceloc "test/c/mathc/floor_fail.c", 29, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.floor.f64 == $sub.ref(0, 6192));
