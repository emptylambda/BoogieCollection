...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/test_memset_fail.c -bpl ./test_memset_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/test_memset_fail.c", 7, 22} true;
  ...
  assume {:sourceloc "test/c/bits/test_memset_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/bits/test_memset_fail.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call $M.0 := $memset.i8($M.0, $p1, 1, 8, false);
  assume {:sourceloc "test/c/bits/test_memset_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/test_memset_fail.c", 9, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/test_memset_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0, 3096));
