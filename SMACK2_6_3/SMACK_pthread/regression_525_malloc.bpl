...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/regression_525_malloc.c -bpl ./regression_525_malloc.bpl
  ...
  returns ($r: ref)
{
  ...
  var $p4: ref;
$bb0:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 13, 12} true;
  ...
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.ref($p2, $0.ref);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 16, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 1);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 17, 16} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($p4);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 15, 5} true;
  assume {:verifier.code 0} true;
  ...
  returns ($r: ref)
{
  ...
  var $p4: ref;
$bb0:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 22, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 22, 12} true;
  assume {:verifier.code 0} true;
  call $p1 := malloc(4);
  ...
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.ref($p2, $0.ref);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 23, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb3;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 25, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p2, 2);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 26, 16} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p2);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($p4);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 27, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 24, 5} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 24, 5} true;
  assume {:verifier.code 0} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 31, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 32, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := pthread_create(tid2, $0.ref, t2, $0.ref);
  assume true;
  assume true;
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 35, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $M.2;
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 35, 22} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p0);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := pthread_join($i4, $p5);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 36, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $M.3;
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 36, 22} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := pthread_join($i7, $p8);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 37, 3} true;
...
$bb6:
  ...
  goto $bb4;
$bb7:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 38, 3} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 38, 3} true;
...
$bb13:
  ...
  goto $bb11;
$bb14:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $p20 := $load.ref($M.4, $p0);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 39, 7} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i21 == 1);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 40, 10} true;
  assume {:verifier.code 0} true;
  $p22 := $load.ref($M.4, $p0);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 40, 10} true;
  assume {:verifier.code 0} true;
  $p23 := $bitcast.ref.ref($p22);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 40, 5} true;
  assume {:verifier.code 0} true;
  call free_($p23);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 40, 5} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 41, 7} true;
  assume {:verifier.code 0} true;
  $p24 := $load.ref($M.6, $p1);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 41, 7} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume ($i25 == 1);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 42, 10} true;
  assume {:verifier.code 0} true;
  $p26 := $load.ref($M.6, $p1);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 42, 10} true;
  assume {:verifier.code 0} true;
  $p27 := $bitcast.ref.ref($p26);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 42, 5} true;
  assume {:verifier.code 0} true;
  call free_($p27);
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 42, 5} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb20;
$bb20:
  assume {:sourceloc "test/c/pthread/regression_525_malloc.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
