...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/pack_struct.c -bpl ./pack_struct.bpl
  ...
  returns ($r: i1)
{
  ...
  var $i10: i1;
$bb0:
  assume {:sourceloc "test/c/bits/pack_struct.c", 14, 47} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.0, $p6);
  assume {:sourceloc "test/c/bits/pack_struct.c", 14, 55} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p3, $mul.ref(0, 8)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/bits/pack_struct.c", 14, 55} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i32($M.1, $p8);
  assume {:sourceloc "test/c/bits/pack_struct.c", 14, 49} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i7, $i9);
  assume {:sourceloc "test/c/bits/pack_struct.c", 14, 37} true;
  assume {:verifier.code 0} true;
  $r := $i10;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/pack_struct.c", 20, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/bits/pack_struct.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/pack_struct.c", 21, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/bits/pack_struct.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
