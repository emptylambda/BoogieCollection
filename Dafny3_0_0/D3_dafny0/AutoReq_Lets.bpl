...
axiom 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    Lets.__default.f1#canCall(x#0) || (0 != $FunctionContextHeight && x#0 > 3)
       ==> true);
...
procedure CheckWellformed$$Lets.__default.f1(x#0: int);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall x'#0: int :: 
    ...
    Lets.__default.test1#canCall(x'#0)
         || (1 != $FunctionContextHeight && (var y'#0 := Mul(LitInt(3), x'#0); y'#0 > 3))
       ==> true);
...
procedure {:autoReq} CheckWellformed$$Lets.__default.test1(x'#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$Lets.__default.test1(x'#0: int)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(204,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    havoc y'#Z#0;
    assume true;
    assume let#0#0#0 == Mul(LitInt(3), x'#0);
    assume true;
    // CheckWellformedWithResult: any expression
    assume $Is(let#0#0#0, TInt);
    assume y'#Z#0 == let#0#0#0;
    assume (var y'#5 := Mul(LitInt(3), x'#0); y'#5 > 3);
    if (*)
    {
        assume false;
    }
    else
    {
        ...
        havoc y'#Z#1;
        assume true;
        assume let#1#0#0 == Mul(LitInt(3), x'#0);
        assume true;
        // CheckWellformedWithResult: any expression
        ...
        assume Lets.__default.test1(x'#0) == Lets.__default.f1(y'#Z#1);
        assume Lets.__default.f1#canCall(y'#Z#1);
        // CheckWellformedWithResult: any expression
