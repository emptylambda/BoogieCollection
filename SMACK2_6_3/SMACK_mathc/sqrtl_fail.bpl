...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/sqrtl_fail.c -bpl ./sqrtl_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 14, 3} true;
...
$bb1:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call $f0 := sqrtl($fp(0, 0, 140720757952528));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrtl_fail.c:14:3: warning: over-approximating floating-point arithmetic fsub; */
  $f1 := $fsub.float($fp(0, 0, 140720757953896), $f0);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrtl_fail.c:14:3: warning: over-approximating call to llvm.fabs.f80; */
  call $f2 := llvm.fabs.f80($f1);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i3 := (if $folt.float.bool($f2, $fp(0, 0, 140720757953936)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call $f4 := sqrtl($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrtl_fail.c:15:3: warning: over-approximating floating-point arithmetic fsub; */
  $f5 := $fsub.float($fp(0, 0, 7749591458892433408), $f4);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/sqrtl_fail.c:15:3: warning: over-approximating call to llvm.fabs.f80; */
  call $f6 := llvm.fabs.f80($f5);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i7 := (if $folt.float.bool($f6, $fp(0, 0, 140720308486152)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $f8 := sqrtl($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := __isnanl($f8);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 16, 3} true;
...
$bb14:
  ...
  goto $bb13;
$bb15:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call $f11 := sqrtl($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $i12 := (if $foeq.float.bool($f11, $fp(0, 0, 38388608)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  goto $bb18;
$bb20:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call $f13 := sqrtl($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  $i14 := (if $foeq.float.bool($f13, $fp(0, 0, 39144352)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
...
$bb24:
  ...
  goto $bb23;
$bb25:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 20, 26} true;
  assume {:verifier.code 0} true;
  call $f15 := sqrtl($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 20, 15} true;
  assume {:verifier.code 0} true;
  call $i16 := __signbitl($f15);
  call {:cexpr "isNeg"} boogie_si_record_i32($i16);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb26:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 21, 3} true;
...
$bb29:
  ...
  goto $bb30;
$bb30:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call $f18 := sqrtl($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $i19 := (if $foeq.float.bool($f18, $fp(0, 0, 39186272)) then 1 else 0);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 23, 3} true;
  assume {:verifier.code 0} true;
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $f20 := sqrtl($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i21 := __isnanl($f20);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i22 := $ne.i32($i21, 0);
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 24, 3} true;
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call $f23 := sqrtl($fp(0, 0, 48));
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 26, 3} true;
  assume {:verifier.code 0} true;
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/sqrtl_fail.c", 28, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const sqrtl: ref;
axiom (sqrtl == $sub.ref(0, 2064));
procedure {:inline 1} sqrtl($f0: float)
  returns ($r: float);
