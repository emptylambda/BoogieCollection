...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/nondet.c -bpl ./nondet.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/nondet.c", 8, 7} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/basic/nondet.c", 9, 6} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32(1, 1);
  call {:cexpr "x"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/basic/nondet.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/basic/nondet.c", 11, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32(1, $sub.i32(0, 1));
  call {:cexpr "x"} boogie_si_record_i32($i4);
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb3:
  assume {:sourceloc "test/c/basic/nondet.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/nondet.c", 14, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/basic/nondet.c", 14, 3} true;
...
$bb9:
  ...
  goto $bb6;
$bb10:
  assume {:sourceloc "test/c/basic/nondet.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
