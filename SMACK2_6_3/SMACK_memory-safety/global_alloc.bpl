...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/global_alloc.c -bpl ./global_alloc.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/global_alloc.c", 10, 11} true;
  ...
  assume {:sourceloc "test/c/memory-safety/global_alloc.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
