...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/array1_fail.c -bpl ./array1_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/array1_fail.c", 7, 12} true;
  ...
  assume {:sourceloc "test/c/memory-safety/array1_fail.c", 8, 11} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(10, 4));
  assume {:sourceloc "test/c/memory-safety/array1_fail.c", 8, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, $p2);
  call {:cexpr "b"} boogie_si_record_i32($i3);
  assume {:sourceloc "test/c/memory-safety/array1_fail.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/array1_fail.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call free_($p4);
  assume {:sourceloc "test/c/memory-safety/array1_fail.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
