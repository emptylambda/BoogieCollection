...
axiom (forall a#19#0#0: Box, a#19#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.List.Cons(a#19#0#0, a#19#1#0) } 
  DatatypeCtorId(#MatchExpressionsInArbitraryPositions.List.Cons(a#19#0#0, a#19#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  MatchExpressionsInArbitraryPositions.List.Cons_q(d)
     ==> (exists a#20#0#0: Box, a#20#1#0: DatatypeType :: 
      d == #MatchExpressionsInArbitraryPositions.List.Cons(a#20#0#0, a#20#1#0)));

// Constructor $Is
axiom (forall MatchExpressionsInArbitraryPositions.List$T: Ty, 
    a#21#0#0: Box, 
    a#21#1#0: DatatypeType :: 
  { $Is(#MatchExpressionsInArbitraryPositions.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.MatchExpressionsInArbitraryPositions.List(MatchExpressionsInArbitraryPositions.List$T)) } 
  $Is(#MatchExpressionsInArbitraryPositions.List.Cons(a#21#0#0, a#21#1#0), 
      Tclass.MatchExpressionsInArbitraryPositions.List(MatchExpressionsInArbitraryPositions.List$T))
     <==> $IsBox(a#21#0#0, MatchExpressionsInArbitraryPositions.List$T)
       && $Is(a#21#1#0, 
        Tclass.MatchExpressionsInArbitraryPositions.List(MatchExpressionsInArbitraryPositions.List$T)));
...
axiom (forall MatchExpressionsInArbitraryPositions.List$T: Ty, 
    ...
    $h: Heap :: 
  { $IsAlloc(#MatchExpressionsInArbitraryPositions.List.Cons(a#22#0#0, a#22#1#0), 
      Tclass.MatchExpressionsInArbitraryPositions.List(MatchExpressionsInArbitraryPositions.List$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#MatchExpressionsInArbitraryPositions.List.Cons(a#22#0#0, a#22#1#0), 
        Tclass.MatchExpressionsInArbitraryPositions.List(MatchExpressionsInArbitraryPositions.List$T), 
        $h)
       <==> $IsAllocBox(a#22#0#0, MatchExpressionsInArbitraryPositions.List$T, $h)
         && $IsAlloc(a#22#1#0, 
          Tclass.MatchExpressionsInArbitraryPositions.List(MatchExpressionsInArbitraryPositions.List$T), 
          $h)));
...
axiom (forall a#23#0#0: Box, a#23#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.List.Cons(Lit(a#23#0#0), Lit(a#23#1#0)) } 
  #MatchExpressionsInArbitraryPositions.List.Cons(Lit(a#23#0#0), Lit(a#23#1#0))
     == Lit(#MatchExpressionsInArbitraryPositions.List.Cons(a#23#0#0, a#23#1#0)));

function MatchExpressionsInArbitraryPositions.List.head(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#24#0#0: Box, a#24#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.List.Cons(a#24#0#0, a#24#1#0) } 
  MatchExpressionsInArbitraryPositions.List.head(#MatchExpressionsInArbitraryPositions.List.Cons(a#24#0#0, a#24#1#0))
     == a#24#0#0);

// Inductive rank
axiom (forall a#25#0#0: Box, a#25#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.List.Cons(a#25#0#0, a#25#1#0) } 
  BoxRank(a#25#0#0)
     < DtRank(#MatchExpressionsInArbitraryPositions.List.Cons(a#25#0#0, a#25#1#0)));
...
axiom (forall a#26#0#0: Box, a#26#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.List.Cons(a#26#0#0, a#26#1#0) } 
  MatchExpressionsInArbitraryPositions.List.tail(#MatchExpressionsInArbitraryPositions.List.Cons(a#26#0#0, a#26#1#0))
     == a#26#1#0);

// Inductive rank
axiom (forall a#27#0#0: Box, a#27#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.List.Cons(a#27#0#0, a#27#1#0) } 
  DtRank(a#27#1#0)
     < DtRank(#MatchExpressionsInArbitraryPositions.List.Cons(a#27#0#0, a#27#1#0)));
...
axiom (forall a#33#0#0: Box, a#33#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.AList.ACons(a#33#0#0, a#33#1#0) } 
  DatatypeCtorId(#MatchExpressionsInArbitraryPositions.AList.ACons(a#33#0#0, a#33#1#0))
...
axiom (forall d: DatatypeType :: 
  { MatchExpressionsInArbitraryPositions.AList.ACons_q(d) } 
  MatchExpressionsInArbitraryPositions.AList.ACons_q(d)
     ==> (exists a#34#0#0: Box, a#34#1#0: DatatypeType :: 
      d == #MatchExpressionsInArbitraryPositions.AList.ACons(a#34#0#0, a#34#1#0)));

// Constructor $Is
axiom (forall MatchExpressionsInArbitraryPositions.AList$T: Ty, 
    a#35#0#0: Box, 
    a#35#1#0: DatatypeType :: 
  { $Is(#MatchExpressionsInArbitraryPositions.AList.ACons(a#35#0#0, a#35#1#0), 
      Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T)) } 
  $Is(#MatchExpressionsInArbitraryPositions.AList.ACons(a#35#0#0, a#35#1#0), 
      Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T))
     <==> $IsBox(a#35#0#0, MatchExpressionsInArbitraryPositions.AList$T)
       && $Is(a#35#1#0, 
        Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T)));
...
axiom (forall MatchExpressionsInArbitraryPositions.AList$T: Ty, 
    a#36#0#0: Box, 
    a#36#1#0: DatatypeType, 
    $h: Heap :: 
  { $IsAlloc(#MatchExpressionsInArbitraryPositions.AList.ACons(a#36#0#0, a#36#1#0), 
      Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#MatchExpressionsInArbitraryPositions.AList.ACons(a#36#0#0, a#36#1#0), 
        Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T), 
        $h)
       <==> $IsAllocBox(a#36#0#0, MatchExpressionsInArbitraryPositions.AList$T, $h)
         && $IsAlloc(a#36#1#0, 
          Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T), 
          $h)));
...
axiom (forall a#37#0#0: Box, a#37#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.AList.ACons(Lit(a#37#0#0), Lit(a#37#1#0)) } 
  #MatchExpressionsInArbitraryPositions.AList.ACons(Lit(a#37#0#0), Lit(a#37#1#0))
     == Lit(#MatchExpressionsInArbitraryPositions.AList.ACons(a#37#0#0, a#37#1#0)));

function MatchExpressionsInArbitraryPositions.AList.head(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#38#0#0: Box, a#38#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.AList.ACons(a#38#0#0, a#38#1#0) } 
  MatchExpressionsInArbitraryPositions.AList.head(#MatchExpressionsInArbitraryPositions.AList.ACons(a#38#0#0, a#38#1#0))
     == a#38#0#0);

// Inductive rank
axiom (forall a#39#0#0: Box, a#39#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.AList.ACons(a#39#0#0, a#39#1#0) } 
  BoxRank(a#39#0#0)
     < DtRank(#MatchExpressionsInArbitraryPositions.AList.ACons(a#39#0#0, a#39#1#0)));
...
axiom (forall a#40#0#0: Box, a#40#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.AList.ACons(a#40#0#0, a#40#1#0) } 
  MatchExpressionsInArbitraryPositions.AList.tail(#MatchExpressionsInArbitraryPositions.AList.ACons(a#40#0#0, a#40#1#0))
     == a#40#1#0);

// Inductive rank
axiom (forall a#41#0#0: Box, a#41#1#0: DatatypeType :: 
  { #MatchExpressionsInArbitraryPositions.AList.ACons(a#41#0#0, a#41#1#0) } 
  DtRank(a#41#1#0)
     < DtRank(#MatchExpressionsInArbitraryPositions.AList.ACons(a#41#0#0, a#41#1#0)));
...
// Constructor identifier
axiom (forall a#42#0#0: bool :: 
  { #MatchExpressionsInArbitraryPositions.AList.Appendix(a#42#0#0) } 
  DatatypeCtorId(#MatchExpressionsInArbitraryPositions.AList.Appendix(a#42#0#0))
...
axiom (forall d: DatatypeType :: 
  { MatchExpressionsInArbitraryPositions.AList.Appendix_q(d) } 
  MatchExpressionsInArbitraryPositions.AList.Appendix_q(d)
     ==> (exists a#43#0#0: bool :: 
      d == #MatchExpressionsInArbitraryPositions.AList.Appendix(a#43#0#0)));

// Constructor $Is
axiom (forall MatchExpressionsInArbitraryPositions.AList$T: Ty, a#44#0#0: bool :: 
  { $Is(#MatchExpressionsInArbitraryPositions.AList.Appendix(a#44#0#0), 
      Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T)) } 
  $Is(#MatchExpressionsInArbitraryPositions.AList.Appendix(a#44#0#0), 
      Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T))
     <==> $Is(a#44#0#0, TBool));
...
// Constructor $IsAlloc
axiom (forall MatchExpressionsInArbitraryPositions.AList$T: Ty, a#45#0#0: bool, $h: Heap :: 
  { $IsAlloc(#MatchExpressionsInArbitraryPositions.AList.Appendix(a#45#0#0), 
      Tclass.MatchExpressionsInArbitraryPositions.AList(MatchExpressionsInArbitraryPositions.AList$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#MatchExpressionsInArbitraryPositions.AList.Appendix(a#45#0#0), 
...
// Constructor literal
axiom (forall a#46#0#0: bool :: 
  { #MatchExpressionsInArbitraryPositions.AList.Appendix(Lit(a#46#0#0)) } 
  #MatchExpressionsInArbitraryPositions.AList.Appendix(Lit(a#46#0#0))
     == Lit(#MatchExpressionsInArbitraryPositions.AList.Appendix(a#46#0#0)));

function MatchExpressionsInArbitraryPositions.AList.b(DatatypeType) : bool;

// Constructor injectivity
axiom (forall a#47#0#0: bool :: 
  { #MatchExpressionsInArbitraryPositions.AList.Appendix(a#47#0#0) } 
  MatchExpressionsInArbitraryPositions.AList.b(#MatchExpressionsInArbitraryPositions.AList.Appendix(a#47#0#0))
     == a#47#0#0);
...
procedure CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.M(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt))
         && $IsAlloc(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt), $Heap)
         && $IsA#MatchExpressionsInArbitraryPositions.AList(xs#0))
   returns (y#0: int);
...
procedure Call$$MatchExpressionsInArbitraryPositions.__default.M(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt))
         && $IsAlloc(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt), $Heap)
         && $IsA#MatchExpressionsInArbitraryPositions.AList(xs#0))
   returns (y#0: int);
...
procedure Impl$$MatchExpressionsInArbitraryPositions.__default.M(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt))
         && $IsAlloc(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt), $Heap)
         && $IsA#MatchExpressionsInArbitraryPositions.AList(xs#0))
...
implementation Impl$$MatchExpressionsInArbitraryPositions.__default.M(xs#0: DatatypeType) returns (y#0: int, $_reverifyPost: bool)
{
  ...
  var let#0#0#0: int;
    ...
    // AddMethodImpl: M, Impl$$MatchExpressionsInArbitraryPositions.__default.M
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(296,2): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(297,5)
    if (*)
    {
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(298,9)
        assume true;
        havoc a#0_0#0#0;
        if (xs#0 == #MatchExpressionsInArbitraryPositions.AList.ANil())
        {
        }
        else if (xs#0
           == #MatchExpressionsInArbitraryPositions.AList.ACons($Box(_mcc#0#0_0), _mcc#1#0_0))
        {
            assume $Is(_mcc#1#0_0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt));
            havoc x#Z#0_0;
            assume true;
            ...
            assume x#Z#0_0 == let#0_0#0#0;
        }
        else if (xs#0 == #MatchExpressionsInArbitraryPositions.AList.Appendix(a#0_0#0#0))
        {
            assert false;
        }
        else
        ...
        assume true;
        y#0 := (if MatchExpressionsInArbitraryPositions.AList.ANil_q(xs#0)
           then 0
           else (var x#0_1 := $Unbox(MatchExpressionsInArbitraryPositions.AList.head(xs#0)): int; 
            x#0_1));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(300,32)"} true;
    }
    else
    {
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(302,9)
        assume true;
        assume true;
        y#0 := LitInt(0);
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(302,12)"} true;
        // ----- assignment statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(303,19)
        assume true;
        // Begin Comprehension WF check
        havoc tl#0;
        if ($Is(tl#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt)))
        {
            havoc a#1#0#0;
            if (#MatchExpressionsInArbitraryPositions.AList.ACons($Box(LitInt(8)), tl#0)
               == #MatchExpressionsInArbitraryPositions.AList.ACons($Box(_mcc#3#0), _mcc#4#0))
            {
                assume $Is(_mcc#4#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt));
                havoc w#Z#0;
                assume true;
            ...
            else if (#MatchExpressionsInArbitraryPositions.AList.ACons($Box(LitInt(8)), tl#0)
               == #MatchExpressionsInArbitraryPositions.AList.Appendix(a#1#0#0))
            {
                assert false;
            }
            else if (#MatchExpressionsInArbitraryPositions.AList.ACons($Box(LitInt(8)), tl#0)
        ...
        assume true;
        b#0 := (forall tl#1: DatatypeType :: 
          { #MatchExpressionsInArbitraryPositions.AList.ACons($Box(8), tl#1) } 
          $Is(tl#1, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt))
             ==> (var w#1 := $Unbox(MatchExpressionsInArbitraryPositions.AList.head(#MatchExpressionsInArbitraryPositions.AList.ACons($Box(LitInt(8)), tl#1))): int; 
              w#1 <= LitInt(16)));
        assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(305,50)"} true;
        // ----- assert statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(306,7)
        assume true;
        assert b#0;
    }
}
       ...
       ==> MatchExpressionsInArbitraryPositions.__default.F(xs#0, ys#0)
         == (if MatchExpressionsInArbitraryPositions.List.Nil_q(xs#0)
           then (if MatchExpressionsInArbitraryPositions.List.Nil_q(ys#0)
             then 0
             else (var y#0 := $Unbox(MatchExpressionsInArbitraryPositions.List.head(ys#0)): int; 
              y#0))
           else (var x#0 := $Unbox(MatchExpressionsInArbitraryPositions.List.head(xs#0)): int; 
            (if MatchExpressionsInArbitraryPositions.List.Nil_q(ys#0)
               then x#0
               else (var y#1 := $Unbox(MatchExpressionsInArbitraryPositions.List.head(ys#0)): int; 
                x#0 + y#1)))));
       ...
       ==> MatchExpressionsInArbitraryPositions.__default.F(Lit(xs#0), Lit(ys#0))
         == (if MatchExpressionsInArbitraryPositions.List.Nil_q(Lit(xs#0))
           then (if MatchExpressionsInArbitraryPositions.List.Nil_q(Lit(ys#0))
             then 0
             else (var y#4 := LitInt($Unbox(MatchExpressionsInArbitraryPositions.List.head(Lit(ys#0))): int); 
              y#4))
           else (var x#2 := LitInt($Unbox(MatchExpressionsInArbitraryPositions.List.head(Lit(xs#0))): int); 
            (if MatchExpressionsInArbitraryPositions.List.Nil_q(Lit(ys#0))
               then x#2
               else (var y#5 := LitInt($Unbox(MatchExpressionsInArbitraryPositions.List.head(Lit(ys#0))): int); 
                LitInt(x#2 + y#5))))));

procedure CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.F(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    ys#0: DatatypeType
       where $Is(ys#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)));
...
procedure CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.G(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    ys#0: DatatypeType
       where $Is(ys#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    k#0: int);
...
procedure CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.H(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    ys#0: DatatypeType
       where $Is(ys#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    k#0: int);
...
procedure CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.J(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)));
...
implementation CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.J(xs#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var a#1#0#0: Box;
  var a#1#1#0: DatatypeType;


    // AddWellformednessCheck for function J
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(347,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        havoc a#1#0#0, a#1#1#0;
        if (xs#0 == #MatchExpressionsInArbitraryPositions.List.Cons(a#1#0#0, a#1#1#0))
        {
            assert false;
        }
        else if (xs#0 == #MatchExpressionsInArbitraryPositions.List.Nil())
        {
            assert false;
        }
        else
   ...
   ==> (forall xs#0: DatatypeType :: 
    ...
    MatchExpressionsInArbitraryPositions.__default.K#canCall(xs#0)
       ...
       ==> MatchExpressionsInArbitraryPositions.__default.K(xs#0)
         == (if MatchExpressionsInArbitraryPositions.List.Nil_q(xs#0)
           then 0
           else (var ys#0 := MatchExpressionsInArbitraryPositions.List.tail(xs#0); 
            $Unbox($ArbitraryBoxValue): int)));
   ...
   ==> (forall xs#0: DatatypeType :: 
    ...
    MatchExpressionsInArbitraryPositions.__default.K#canCall(Lit(xs#0))
       ...
       ==> MatchExpressionsInArbitraryPositions.__default.K(Lit(xs#0))
         == (if MatchExpressionsInArbitraryPositions.List.Nil_q(Lit(xs#0))
           then 0
           else (var ys#2 := Lit(MatchExpressionsInArbitraryPositions.List.tail(Lit(xs#0))); 
            $Unbox($ArbitraryBoxValue): int)));

procedure CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.K(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)));
...
implementation CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.K(xs#0: DatatypeType)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var _mcc#0#0: int;
  ...
  var a#1#1#0: DatatypeType;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Datatypes.dfy(352,11): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        if (xs#0 == #MatchExpressionsInArbitraryPositions.List.Nil())
        {
            assume MatchExpressionsInArbitraryPositions.__default.K(xs#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(MatchExpressionsInArbitraryPositions.__default.K(xs#0), TInt);
        }
        else if (xs#0
           == #MatchExpressionsInArbitraryPositions.List.Cons($Box(_mcc#0#0), _mcc#1#0))
        {
            assume $Is(_mcc#1#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt));
            havoc ys#Z#0;
            assume $Is(ys#Z#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt));
            assume let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt));
            assume ys#Z#0 == let#0#0#0;
            havoc a#1#0#0, a#1#1#0;
            if (ys#Z#0 == #MatchExpressionsInArbitraryPositions.List.Cons(a#1#0#0, a#1#1#0))
            {
                assert false;
            }
            else if (ys#Z#0 == #MatchExpressionsInArbitraryPositions.List.Nil())
            {
                assert false;
            }
            else
