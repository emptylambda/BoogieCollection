...
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    CorrectReqOrdering.__default.f1#canCall(x#0)
         || (1 != $FunctionContextHeight && x#0 > 3)
       ==> true);
...
procedure CheckWellformed$$CorrectReqOrdering.__default.f1(x#0: int);
...
axiom 0 <= $FunctionContextHeight
   ==> (forall b#0: bool :: 
    ...
    CorrectReqOrdering.__default.f2#canCall(b#0)
         || (0 != $FunctionContextHeight && b#0)
       ==> true);
...
procedure CheckWellformed$$CorrectReqOrdering.__default.f2(b#0: bool);
...
axiom 2 <= $FunctionContextHeight
   ==> (forall z#0: int :: 
    ...
    CorrectReqOrdering.__default.f3#canCall(z#0)
         || (2 != $FunctionContextHeight && z#0 > 3 && CorrectReqOrdering.__default.f1(z#0))
       ==> true);
...
procedure {:autoReq} CheckWellformed$$CorrectReqOrdering.__default.f3(z#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$CorrectReqOrdering.__default.f3(z#0: int)
{
  ...
  var b$reqreads#2: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(170,22): initial state"} true;
    ...
    assume CorrectReqOrdering.__default.f1(z#0);
    assert b$reqreads#0;
    if (*)
    {
        assume false;
    ...
    else
    {
        ...
        assume CorrectReqOrdering.__default.f3(z#0)
           == CorrectReqOrdering.__default.f2(CorrectReqOrdering.__default.f1(z#0));
        assume CorrectReqOrdering.__default.f1#canCall(z#0)
           && CorrectReqOrdering.__default.f2#canCall(CorrectReqOrdering.__default.f1(z#0));
