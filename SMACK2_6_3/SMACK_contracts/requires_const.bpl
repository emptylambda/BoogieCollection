...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/contracts/requires_const.c -bpl ./requires_const.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 17544));
...
axiom (__SMACK_decls == $sub.ref(0, 13416));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 14448));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 15480));
...
axiom (llvm.dbg.value == $sub.ref(0, 16512));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 17544));
