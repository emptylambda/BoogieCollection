...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/fmaxf.c -bpl ./fmaxf.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/fmaxf.c", 11, 13} true;
  ...
  assume {:sourceloc "test/c/mathc/fmaxf.c", 12, 13} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 8} true;
  assume {:verifier.code 0} true;
  call $i2 := __isnanf($f0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 20} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 25, 8} true;
  assume {:verifier.code 0} true;
  call $i18 := __isnanf($f1);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 25, 8} true;
  assume {:verifier.code 0} true;
  $i19 := $ne.i32($i18, 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 25, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  goto $bb28, $bb30;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 24} true;
  assume {:verifier.code 0} true;
  call $i4 := __isinff($f0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 24} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i4, 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 36} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 40} true;
  assume {:verifier.code 0} true;
  call $i6 := __iszerof($f0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 40} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i32($i6, 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 14, 7} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume !(($i7 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call $i8 := __isnanf($f1);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8, 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 22} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb10:
  assume !(($i9 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 26} true;
  assume {:verifier.code 0} true;
  call $i10 := __isinff($f1);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 26} true;
  assume {:verifier.code 0} true;
  $i11 := $ne.i32($i10, 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 38} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume !(($i11 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 42} true;
  assume {:verifier.code 0} true;
  call $i12 := __iszerof($f1);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 42} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12, 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 15, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume !(($i13 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 16, 22} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmaxf.c:16:22: warning: over-approximating call to llvm.maxnum.f32; */
  call $f14 := llvm.maxnum.f32($f0, $f1);
  call {:cexpr "maxVal"} boogie_si_record_float($f14);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 17, 13} true;
  assume {:verifier.code 0} true;
  $i15 := (if $fogt.float.bool($f0, $f1) then 1 else 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 17, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb15, $bb16;
$bb15:
  assume ($i15 == 1);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 18, 9} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !(($i15 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 20, 9} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb17:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 18, 9} true;
...
$bb20:
  ...
  goto $bb19;
$bb21:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 19, 7} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb22:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 22, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb23:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 20, 9} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 31, 8} true;
  assume {:verifier.code 0} true;
  call $i26 := __isnanf($f0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 31, 8} true;
  assume {:verifier.code 0} true;
  $i27 := $ne.i32($i26, 0);
  assume {:sourceloc "test/c/mathc/fmaxf.c", 31, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i27} true;
  goto $bb46, $bb48;
$bb30:
  assume !(($i19 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 26, 5} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb31:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 26, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmaxf.c:26:5: warning: over-approximating call to llvm.maxnum.f32; */
...
$bb34:
  ...
  goto $bb33;
$bb35:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb36:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 27, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmaxf.c:27:5: warning: over-approximating call to llvm.maxnum.f32; */
...
$bb39:
  ...
  goto $bb38;
$bb40:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 28, 5} true;
  assume {:verifier.code 0} true;
  goto $bb41;
$bb41:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 28, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmaxf.c:28:5: warning: over-approximating call to llvm.maxnum.f32; */
...
$bb44:
  ...
  goto $bb43;
$bb45:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 29, 3} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb46:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 31, 7} true;
  ...
  goto $bb47;
$bb47:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb64;
$bb48:
  assume !(($i27 == 1));
  assume {:sourceloc "test/c/mathc/fmaxf.c", 32, 5} true;
  assume {:verifier.code 0} true;
  goto $bb49;
$bb49:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 32, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmaxf.c:32:5: warning: over-approximating call to llvm.maxnum.f32; */
...
$bb52:
  ...
  goto $bb51;
$bb53:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 33, 5} true;
  assume {:verifier.code 0} true;
  goto $bb54;
$bb54:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 33, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmaxf.c:33:5: warning: over-approximating call to llvm.maxnum.f32; */
...
$bb57:
  ...
  goto $bb56;
$bb58:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 34, 5} true;
  assume {:verifier.code 0} true;
  goto $bb59;
$bb59:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 34, 5} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmaxf.c:34:5: warning: over-approximating call to llvm.maxnum.f32; */
...
$bb62:
  ...
  goto $bb61;
$bb63:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 35, 3} true;
  assume {:verifier.code 0} true;
  goto $bb47;
$bb64:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 37, 3} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/mathc/fmaxf.c:37:3: warning: over-approximating call to llvm.maxnum.f32; */
...
$bb67:
  ...
  goto $bb66;
$bb68:
  assume {:sourceloc "test/c/mathc/fmaxf.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
