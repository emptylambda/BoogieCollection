...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/two_arrays3.c -bpl ./two_arrays3.bpl
...
procedure {:inline 1} resetArray($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays3.c", 21, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/two_arrays3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays3.c", 21, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays3.c", 21, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i1, $i2);
  assume {:sourceloc "test/c/data/two_arrays3.c", 21, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 22, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0, $mul.ref($i4, 12));
  assume {:sourceloc "test/c/data/two_arrays3.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref($i4, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays3.c", 22, 21} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p6, 0);
  assume {:sourceloc "test/c/data/two_arrays3.c", 23, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/two_arrays3.c", 24, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays3.c", 21, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
...
procedure {:inline 1} setArray($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays3.c", 29, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays3.c", 29, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/data/two_arrays3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays3.c", 29, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays3.c", 29, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i1, $i2);
  assume {:sourceloc "test/c/data/two_arrays3.c", 29, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 30, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0, $mul.ref($i4, 12));
  assume {:sourceloc "test/c/data/two_arrays3.c", 30, 14} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref($i4, 12)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/two_arrays3.c", 30, 21} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i8($M.1, $p6, 1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 31, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/two_arrays3.c", 32, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays3.c", 29, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/data/two_arrays3.c", 29, 3} true;
...
procedure {:inline 1} initializeCount($p0: ref)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "test/c/data/two_arrays3.c", 37, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays3.c", 37, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  assume {:sourceloc "test/c/data/two_arrays3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays3.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays3.c", 37, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i1, $i2);
  assume {:sourceloc "test/c/data/two_arrays3.c", 37, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 38, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 38, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0, $mul.ref($i4, 12));
  assume {:sourceloc "test/c/data/two_arrays3.c", 38, 14} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref($i4, 12)), $mul.ref(4, 1));
  assume {:sourceloc "test/c/data/two_arrays3.c", 38, 20} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p6, 0);
  assume {:sourceloc "test/c/data/two_arrays3.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/data/two_arrays3.c", 40, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "test/c/data/two_arrays3.c", 37, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1, 1);
  call {:cexpr "i"} boogie_si_record_i32($i7);
  assume {:sourceloc "test/c/data/two_arrays3.c", 37, 3} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/two_arrays3.c", 45, 15} true;
  ...
  assume {:sourceloc "test/c/data/two_arrays3.c", 45, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $i0;
  call {:cexpr "arraySize"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/data/two_arrays3.c", 46, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/two_arrays3.c", 46, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/two_arrays3.c", 48, 35} true;
  assume {:verifier.code 0} true;
  $i3 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays3.c", 48, 35} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "test/c/data/two_arrays3.c", 48, 45} true;
  assume {:verifier.code 0} true;
  $i5 := $mul.i64($i4, 12);
  assume {:sourceloc "test/c/data/two_arrays3.c", 48, 28} true;
  assume {:verifier.code 0} true;
  call $p6 := malloc($i5);
  assume {:sourceloc "test/c/data/two_arrays3.c", 48, 20} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p6);
  assume {:sourceloc "test/c/data/two_arrays3.c", 49, 35} true;
  assume {:verifier.code 0} true;
  $i8 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays3.c", 49, 35} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i8);
  assume {:sourceloc "test/c/data/two_arrays3.c", 49, 45} true;
  assume {:verifier.code 0} true;
  $i10 := $mul.i64($i9, 12);
  assume {:sourceloc "test/c/data/two_arrays3.c", 49, 28} true;
  assume {:verifier.code 0} true;
  call $p11 := malloc($i10);
  assume {:sourceloc "test/c/data/two_arrays3.c", 49, 20} true;
  assume {:verifier.code 0} true;
  $p12 := $bitcast.ref.ref($p11);
  assume {:sourceloc "test/c/data/two_arrays3.c", 51, 3} true;
  assume {:verifier.code 0} true;
  call resetArray($p7);
  assume {:sourceloc "test/c/data/two_arrays3.c", 52, 3} true;
  assume {:verifier.code 0} true;
  call setArray($p12);
  assume {:sourceloc "test/c/data/two_arrays3.c", 53, 3} true;
  assume {:verifier.code 0} true;
  call initializeCount($p12);
  assume {:sourceloc "test/c/data/two_arrays3.c", 55, 8} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/data/two_arrays3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays3.c", 55, 19} true;
  assume {:verifier.code 0} true;
  $i14 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays3.c", 55, 17} true;
  assume {:verifier.code 0} true;
  $i15 := $slt.i32($i13, $i14);
  assume {:sourceloc "test/c/data/two_arrays3.c", 55, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb7, $bb8;
$bb7:
  assume ($i15 == 1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 56, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !(($i15 == 1));
  assume {:sourceloc "test/c/data/two_arrays3.c", 61, 3} true;
  assume {:verifier.code 0} true;
  call initializeCount($p7);
  assume {:sourceloc "test/c/data/two_arrays3.c", 62, 3} true;
  assume {:verifier.code 0} true;
  call setArray($p7);
  assume {:sourceloc "test/c/data/two_arrays3.c", 63, 3} true;
  assume {:verifier.code 0} true;
  call resetArray($p12);
  assume {:sourceloc "test/c/data/two_arrays3.c", 65, 8} true;
  assume {:verifier.code 0} true;
  $i34 := 0;
  goto $bb25;
$bb9:
...
$bb12:
  ...
  goto $bb11;
$bb13:
  assume {:sourceloc "test/c/data/two_arrays3.c", 57, 5} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "test/c/data/two_arrays3.c", 57, 5} true;
...
$bb17:
  ...
  goto $bb16;
$bb18:
  assume {:sourceloc "test/c/data/two_arrays3.c", 58, 5} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb19:
  assume {:sourceloc "test/c/data/two_arrays3.c", 58, 5} true;
...
$bb22:
  ...
  goto $bb21;
$bb23:
  assume {:sourceloc "test/c/data/two_arrays3.c", 59, 3} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb24:
  assume {:sourceloc "test/c/data/two_arrays3.c", 55, 31} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i13, 1);
...
$bb25:
  assume {:sourceloc "test/c/data/two_arrays3.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/data/two_arrays3.c", 65, 19} true;
  assume {:verifier.code 0} true;
  $i35 := $M.0;
  assume {:sourceloc "test/c/data/two_arrays3.c", 65, 17} true;
  assume {:verifier.code 0} true;
  $i36 := $slt.i32($i34, $i35);
  assume {:sourceloc "test/c/data/two_arrays3.c", 65, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i36} true;
  goto $bb26, $bb27;
$bb26:
  assume ($i36 == 1);
  assume {:sourceloc "test/c/data/two_arrays3.c", 66, 5} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb27:
  assume !(($i36 == 1));
  assume {:sourceloc "test/c/data/two_arrays3.c", 71, 8} true;
  assume {:verifier.code 0} true;
  $p55 := $bitcast.ref.ref($p7);
  assume {:sourceloc "test/c/data/two_arrays3.c", 71, 3} true;
  assume {:verifier.code 0} true;
  call free_($p55);
  assume {:sourceloc "test/c/data/two_arrays3.c", 72, 8} true;
  assume {:verifier.code 0} true;
  $p56 := $bitcast.ref.ref($p12);
  assume {:sourceloc "test/c/data/two_arrays3.c", 72, 3} true;
  assume {:verifier.code 0} true;
  call free_($p56);
  assume {:sourceloc "test/c/data/two_arrays3.c", 73, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
$bb31:
  ...
  goto $bb30;
$bb32:
  assume {:sourceloc "test/c/data/two_arrays3.c", 67, 5} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb33:
  assume {:sourceloc "test/c/data/two_arrays3.c", 67, 5} true;
...
$bb36:
  ...
  goto $bb35;
$bb37:
  assume {:sourceloc "test/c/data/two_arrays3.c", 68, 5} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb38:
  assume {:sourceloc "test/c/data/two_arrays3.c", 68, 5} true;
...
$bb41:
  ...
  goto $bb40;
$bb42:
  assume {:sourceloc "test/c/data/two_arrays3.c", 69, 3} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb43:
  assume {:sourceloc "test/c/data/two_arrays3.c", 65, 31} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i32($i34, 1);
