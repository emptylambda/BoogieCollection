...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/uninterpreted_fail.c -bpl ./uninterpreted_fail.bpl
...
procedure {:inline 1} foo($i0: i32)
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 6, 11} true;
  assume {:verifier.code 1} true;
  call {:cexpr "foo:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 6, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 7, 3} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 8, 3} true;
  assume {:verifier.code 1} true;
  $i1 := FOO($i0);
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 9, 3} true;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 13, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 14, 11} true;
  assume {:verifier.code 0} true;
  call $i1 := foo(43);
  call {:cexpr "y"} boogie_si_record_i32($i1);
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 15, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 15, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/basic/uninterpreted_fail.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
