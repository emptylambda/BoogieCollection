...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/data/struct_const_return_fail.c -bpl ./struct_const_return_fail.bpl
...
const __const.foo.x: ref;
axiom (__const.foo.x == $sub.ref(0, 1040));
const foo: ref;
  ...
  returns ($r: ref)
{
  ...
  var $p8: ref;
$bb0:
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 12, 5} true;
  ...
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 12, 5} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const.foo.x, 16, false);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 13, 3} true;
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  ...
  $i4 := $load.i32($M.1, $p3);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 14, 3} true;
  assume ($extractvalue.i64($p5, 1) == $extractvalue.i64($u0, 1));
  assume ($extractvalue.i32($p5, 0) == $i4);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 14, 3} true;
  $p6 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 14, 3} true;
  $i7 := $load.i64($M.1, $p6);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 14, 3} true;
  assume ($extractvalue.i32($p8, 0) == $extractvalue.i32($p5, 0));
  assume ($extractvalue.i64($p8, 1) == $i7);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := $p8;
  $exn := false;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $extractvalue.i32($p1, 0);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p3, $i4);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $extractvalue.i64($p1, 1);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i64($M.3, $p5, $i6);
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 19, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 19, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/data/struct_const_return_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assert == $sub.ref(0, 9296));
...
axiom (__SMACK_and32 == $sub.ref(0, 10328));
...
axiom (__SMACK_and64 == $sub.ref(0, 11360));
...
axiom (__SMACK_and16 == $sub.ref(0, 12392));
...
axiom (__SMACK_and8 == $sub.ref(0, 13424));
...
axiom (__SMACK_or32 == $sub.ref(0, 14456));
...
axiom (__SMACK_or64 == $sub.ref(0, 15488));
...
axiom (__SMACK_or16 == $sub.ref(0, 16520));
...
axiom (__SMACK_or8 == $sub.ref(0, 17552));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18584));
...
{
$bb0:
  $M.0 := $store.i32($M.0, __const.foo.x, 1);
  $M.0 := $store.i64($M.0, $add.ref($add.ref(__const.foo.x, $mul.ref(0, 16)), $mul.ref(8, 1)), 2);
  $exn := false;
  return;
}
