...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/simd/add.c -bpl ./add.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/simd/add.c", 7, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "test/c/simd/add.c", 7, 15} true;
  assume {:verifier.code 0} true;
  $v0 := $insertelement.vec.2xi64.i32($u0, 2, 0);
  assume {:sourceloc "test/c/simd/add.c", 7, 15} true;
  assume {:verifier.code 0} true;
  $v1 := $insertelement.vec.2xi64.i32($v0, 1, 1);
  call {:cexpr "a"} boogie_si_record_vec.2xi64($v1);
  assume {:sourceloc "test/c/simd/add.c", 8, 15} true;
  assume {:verifier.code 0} true;
  $v2 := $insertelement.vec.2xi64.i32($u0, 10, 0);
  assume {:sourceloc "test/c/simd/add.c", 8, 15} true;
  assume {:verifier.code 0} true;
  $v3 := $insertelement.vec.2xi64.i32($v2, 10, 1);
  call {:cexpr "b"} boogie_si_record_vec.2xi64($v3);
  assume {:sourceloc "test/c/simd/add.c", 9, 15} true;
  assume {:verifier.code 0} true;
  $v4 := $add.vec.2xi64($v1, $v3);
  call {:cexpr "c"} boogie_si_record_vec.2xi64($v4);
  assume {:sourceloc "test/c/simd/add.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/simd/add.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $extractelement.vec.2xi64.i32($v4, 0);
  assume {:sourceloc "test/c/simd/add.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i64($i5, 12);
  assume {:sourceloc "test/c/simd/add.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/simd/add.c", 11, 3} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "test/c/simd/add.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $extractelement.vec.2xi64.i32($v4, 1);
  assume {:sourceloc "test/c/simd/add.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i64($i7, 11);
  assume {:sourceloc "test/c/simd/add.c", 11, 3} true;
...
$bb9:
  ...
  goto $bb8;
$bb10:
  assume {:sourceloc "test/c/simd/add.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
function $add.vec.2xi64(v1: vec.2xi64, v2: vec.2xi64) returns (vec.2xi64) { mk.vec.2xi64($add.i64(i0#mk.vec.2xi64(v1), i0#mk.vec.2xi64(v2)), $add.i64(i1#mk.vec.2xi64(v1), i1#mk.vec.2xi64(v2))) }
function $extractelement.vec.2xi64.i32(v: vec.2xi64, i: i32) returns (i64);
axiom (forall v: vec.2xi64 :: ($extractelement.vec.2xi64.i32(v, 0) == i0#mk.vec.2xi64(v)));
axiom (forall v: vec.2xi64 :: ($extractelement.vec.2xi64.i32(v, 1) == i1#mk.vec.2xi64(v)));
function $insertelement.vec.2xi64.i32(v: vec.2xi64, x: i64, i: i32) returns (vec.2xi64);
axiom (forall v: vec.2xi64, x: i64 :: ($insertelement.vec.2xi64.i32(v, x, 0) == mk.vec.2xi64(x, i1#mk.vec.2xi64(v))));
axiom (forall v: vec.2xi64, x: i64 :: ($insertelement.vec.2xi64.i32(v, x, 1) == mk.vec.2xi64(i0#mk.vec.2xi64(v), x)));
const $u0: vec.2xi64;
...
procedure {:inline 1} boogie_si_record_vec.2xi64(x: vec.2xi64);
function {:constructor} mk.vec.2xi64(i0: i64, i1: i64) returns (vec.2xi64);
type {:datatype} vec.2xi64;
