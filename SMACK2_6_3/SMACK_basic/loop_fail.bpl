...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/basic/loop_fail.c -bpl ./loop_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 20636));
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/basic/loop_fail.c", 16, 5} true;
  ...
  assume {:sourceloc "test/c/basic/loop_fail.c", 18, 8} true;
  assume {:verifier.code 0} true;
  $i0 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/basic/loop_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/basic/loop_fail.c", 18, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 10);
  assume {:sourceloc "test/c/basic/loop_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "test/c/basic/loop_fail.c", 19, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $i0;
  call {:cexpr "x"} boogie_si_record_i32($i0);
  assume {:sourceloc "test/c/basic/loop_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "test/c/basic/loop_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/basic/loop_fail.c", 18, 29} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, 1);
...
$bb8:
  ...
  goto $bb7;
$bb9:
  assume {:sourceloc "test/c/basic/loop_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_dummy == $sub.ref(0, 5156));
...
axiom (__VERIFIER_assert == $sub.ref(0, 6188));
...
axiom (__SMACK_and32 == $sub.ref(0, 7220));
...
axiom (__SMACK_and64 == $sub.ref(0, 8252));
...
axiom (__SMACK_and16 == $sub.ref(0, 9284));
...
axiom (__SMACK_and8 == $sub.ref(0, 10316));
...
axiom (__SMACK_or32 == $sub.ref(0, 11348));
...
axiom (__SMACK_or64 == $sub.ref(0, 12380));
...
axiom (__SMACK_or16 == $sub.ref(0, 13412));
...
axiom (__SMACK_or8 == $sub.ref(0, 14444));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 15476));
...
axiom (__SMACK_decls == $sub.ref(0, 16508));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 17540));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 18572));
...
axiom (llvm.dbg.value == $sub.ref(0, 19604));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 20636));
