...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/bits/countlz_zero_fail.c -bpl ./countlz_zero_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 40, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 40, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, 2);
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 40, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 41, 20} true;
  assume {:verifier.code 0} true;
  /* llvm2bpl: test/c/bits/countlz_zero_fail.c:41:20: warning: over-approximating call to llvm.cttz.i32; */
  call $i4 := llvm.cttz.i32($i1, 1);
  call {:cexpr "leadingZeros"} boogie_si_record_i32($i4);
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, $sub.i32(0, 1));
  call {:cexpr "x32"} boogie_si_record_i32($i5);
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 44, 3} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 40, 26} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i2, 1);
...
$bb8:
  ...
  goto $bb7;
$bb9:
  assume {:sourceloc "test/c/bits/countlz_zero_fail.c", 45, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.cttz.i32 == $sub.ref(0, 2064));
