...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/pthread/join_fail.c -bpl ./join_fail.bpl
  ...
  returns ($r: ref)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "test/c/pthread/join_fail.c", 10, 4} true;
  ...
  assume {:sourceloc "test/c/pthread/join_fail.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call pthread_exit($0.ref);
  assume {:sourceloc "test/c/pthread/join_fail.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $r := $0.ref;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/pthread/join_fail.c", 18, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join_fail.c", 19, 4} true;
  assume {:verifier.code 0} true;
  $i2 := $M.0;
  assume {:sourceloc "test/c/pthread/join_fail.c", 19, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/pthread/join_fail.c", 20, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i32($M.1, $p0);
  assume {:sourceloc "test/c/pthread/join_fail.c", 20, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := pthread_join($i4, $0.ref);
  assume {:sourceloc "test/c/pthread/join_fail.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/pthread/join_fail.c", 21, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/pthread/join_fail.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
