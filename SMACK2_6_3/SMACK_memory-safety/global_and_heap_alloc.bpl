...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/global_and_heap_alloc.c -bpl ./global_and_heap_alloc.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc.c", 10, 12} true;
  ...
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc.c", 11, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call free_($p4);
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
