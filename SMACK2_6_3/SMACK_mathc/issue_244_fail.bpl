...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/mathc/issue_244_fail.c -bpl ./issue_244_fail.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/mathc/issue_244_fail.c", 7, 18} true;
...
$bb1:
  assume {:sourceloc "test/c/mathc/issue_244_fail.c", 7, 18} true;
  assume {:verifier.code 0} true;
  call $f0 := remainder($fp(0, 0, 0), $fp(1, 0, 0));
  assume {:sourceloc "test/c/mathc/issue_244_fail.c", 7, 18} true;
  assume {:verifier.code 0} true;
  call $i1 := __signbit($f0);
  assume {:sourceloc "test/c/mathc/issue_244_fail.c", 7, 18} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "test/c/mathc/issue_244_fail.c", 7, 18} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/mathc/issue_244_fail.c", 7, 58} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
