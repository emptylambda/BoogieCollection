...
procedure CheckWellformed$$ShortCircuiting.__default.f1(x#0: int);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    ShortCircuiting.__default.f2#canCall(y#0)
         || (1 != $FunctionContextHeight && y#0 < 10)
       ==> true);
...
procedure CheckWellformed$$ShortCircuiting.__default.f2(y#0: int);
...
procedure {:autoReq} CheckWellformed$$ShortCircuiting.__default.test1(x'#0: int, y'#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$ShortCircuiting.__default.test1(x'#0: int, y'#0: int)
{
  ...
  var b$reqreads#2: bool;
    ...
    // AddWellformednessCheck for function test1
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(184,22): initial state"} true;
    ...
    if (*)
    {
        ...
        assume ShortCircuiting.__default.f1(x'#0);
        assume y'#0 < 10;
    }
    else
    {
        assume ShortCircuiting.__default.f1(x'#0) ==> y'#0 < 10;
    }
...
procedure {:autoReq} CheckWellformed$$ShortCircuiting.__default.test2(x'#0: int, y'#0: int);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$ShortCircuiting.__default.test2(x'#0: int, y'#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
  ...
  var b$reqreads#2: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(189,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume x'#0 > 3;
    if (*)
    ...
    else
    {
        ...
        assume ShortCircuiting.__default.test2(x'#0, y'#0)
           == (ShortCircuiting.__default.f1(x'#0) ==> ShortCircuiting.__default.f2(y'#0));
        assume ShortCircuiting.__default.f1#canCall(x'#0)
           && (ShortCircuiting.__default.f1(x'#0)
             ==> ShortCircuiting.__default.f2#canCall(y'#0));
...
procedure {:autoReq} CheckWellformed$$ShortCircuiting.__default.test3(x'#0: int, y'#0: int);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap, $Tick;



implementation {:autoReq} CheckWellformed$$ShortCircuiting.__default.test3(x'#0: int, y'#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##x#0: int;
  var b$reqreads#0: bool;
  ...
  var b$reqreads#2: bool;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/AutoReq.dfy(194,22): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume x'#0 > 3;
    if (*)
    ...
    else
    {
        ...
        assume ShortCircuiting.__default.test3(x'#0, y'#0)
           == (ShortCircuiting.__default.f1(x'#0) || ShortCircuiting.__default.f2(y'#0));
        assume ShortCircuiting.__default.f1#canCall(x'#0)
           && (!ShortCircuiting.__default.f1(x'#0)
             ==> ShortCircuiting.__default.f2#canCall(y'#0));
