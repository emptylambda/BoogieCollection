...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/reach/break.c -bpl ./break.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/reach/break.c", 5, 3} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/reach/break.c", 5, 12} true;
  assume {:verifier.code 0} true;
  $i0 := $ne.i32(1, 5);
  assume {:sourceloc "test/c/reach/break.c", 5, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i0 == 1);
  assume {:sourceloc "test/c/reach/break.c", 6, 6} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32(1, 1);
  call {:cexpr "a"} boogie_si_record_i32($i2);
  assume {:sourceloc "test/c/reach/break.c", 7, 5} true;
  assume {:verifier.code 0} true;
  $i1 := $i2;
  goto $bb4;
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "test/c/reach/break.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "test/c/reach/break.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
