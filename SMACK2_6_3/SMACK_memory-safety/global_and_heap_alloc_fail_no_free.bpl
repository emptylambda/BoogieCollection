...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/memory-safety/global_and_heap_alloc_fail_no_free.c -bpl ./global_and_heap_alloc_fail_no_free.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_no_free.c", 10, 12} true;
  ...
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_no_free.c", 14, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "test/c/memory-safety/global_and_heap_alloc_fail_no_free.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
