...
procedure CheckWellformed$$TerminationRefinement0.__default.M(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$TerminationRefinement0.__default.M(x#0: int);
  modifies $Heap, $Tick;
...
procedure Impl$$TerminationRefinement0.__default.M(x#0: int) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation Impl$$TerminationRefinement0.__default.M(x#0: int) returns ($_reverifyPost: bool)
{
  ...
  var x##0: int;
    ...
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy(440,2): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy(441,6)
    ...
    call Call$$TerminationRefinement0.__default.M(x##0);
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "/Users/jeffc/Desktop/boogie/Benchmarks/Dafny_ProgramCollection/dafny0/Termination.dfy(441,8)"} true;
}
