...
// via /usr/local/bin/smack -t --verifier boogie /home/user/smack/test/c/strings/strrchr.c -bpl ./strrchr.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "test/c/strings/strrchr.c", 8, 18} true;
  ...
  assume {:sourceloc "test/c/strings/strrchr.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "test/c/strings/strrchr.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call $i1 := strcmp($p0, .str.1);
  assume {:sourceloc "test/c/strings/strrchr.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "test/c/strings/strrchr.c", 10, 3} true;
...
$bb4:
  ...
  goto $bb3;
$bb5:
  assume {:sourceloc "test/c/strings/strrchr.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
const strrchr: ref;
axiom (strrchr == $sub.ref(0, 4120));
procedure {:inline 1} strrchr($p0: ref, $i1: i32)
  returns ($r: ref);
const strcmp: ref;
axiom (strcmp == $sub.ref(0, 5152));
